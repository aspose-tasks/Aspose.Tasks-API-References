...
| namn | Beskrivning |
| --- | --- |
| [View](view#constructor)() | Initierar en ny instans av[`View`](../view) class. |
| [View](view#constructor_1)(ViewScreen) | Initierar en ny instans av[`View`](../view) class. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo) { get; } | Hämtar en instans av[`PageInfo`](./pageinfo)klass. Representerar sidinställningar som finns i mpp-filformat. |
...
| [operator ==](../../aspose.tasks/view/op_equality) | Returnerar ett värde som anger om denna instans är lika med ett angivet objekt. |
| [operator &gt;](../../aspose.tasks/view/op_greaterthan) | Returnerar ett värde som anger om denna instans är större än ett angivet objekt. |
| [operator &gt;=](../../aspose.tasks/view/op_greaterthanorequal) | Returnerar ett värde som anger om denna instans är större än eller lika med ett angivet objekt. |
| [operator !=](../../aspose.tasks/view/op_inequality) | Returnerar ett värde som anger om denna instans inte är lika med ett angivet objekt. |
| [operator &lt;](../../aspose.tasks/view/op_lessthan) | Returnerar ett värde som anger om denna instans är mindre än ett angivet objekt. |
| [operator &lt;=](../../aspose.tasks/view/op_lessthanorequal) | Returnerar ett värde som anger om denna instans är mindre än eller lika med ett angivet objekt. |
