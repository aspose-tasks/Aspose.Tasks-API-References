...
description: Aspose.Tasks.Project klass. Representerar ett projekt.
type: docs
weight: 1190
...
| namn | Beskrivning |
| --- | --- |
| [Project](project/#constructor)() | Initierar en ny instans av`Project` class. |
| [Project](project/#constructor_1)(DbSettings) | Initierar en ny instans av`Project` klass för att läsa data från en databas som specificeras av instansen av[`DbSettings`](../../aspose.tasks.connectivity/dbsettings/) class. |
| [Project](project/#constructor_2)(Stream) | Initierar en ny instans av`Project` klass från en ström. |
| [Project](project/#constructor_7)(StreamReader) | Initierar en ny instans av`Project` klass från en StreamReader-instans. |
| [Project](project/#constructor_8)(string) | Initierar en ny instans av`Project` klass från en mall (befintlig mpp eller mpt-fil). |
| [Project](project/#constructor_3)(Stream, LoadOptions) | Initierar en ny instans av`Project` klass från Stream med den angivna instansen av[`LoadOptions`](../loadoptions/) class. |
| [Project](project/#constructor_4)(Stream, ParseErrorCallback) | Initierar en ny instans av`Project`klass från en mall (befintlig mpp- eller mpt-fil). |
| [Project](project/#constructor_5)(Stream, PrimaveraReadOptions) | Initierar en ny instans av`Project` klass från Stream med den angivna instansen av[`PrimaveraReadOptions`](../primaverareadoptions/) class. |
| [Project](project/#constructor_6)(Stream, string) | Initierar en ny instans av`Project`klass från en mall (befintlig mpp- eller mpt-fil). |
| [Project](project/#constructor_9)(string, LoadOptions) | Initierar en ny instans av`Project` klass från en mall (befintlig mpp- eller mpt-fil) med den angivna instansen av[`LoadOptions`](../loadoptions/) class. |
| [Project](project/#constructor_10)(string, ParseErrorCallback) | Initierar en ny instans av`Project` klass från en mall (befintlig mpp eller mpt-fil). |
| [Project](project/#constructor_11)(string, PrimaveraReadOptions) | Initierar en ny instans av`Project` klass från en mall (befintlig MPP- eller MPT-fil) med den angivna instansen av[`PrimaveraReadOptions`](../primaverareadoptions/) class. |
| [Project](project/#constructor_12)(string, string) | Initierar en ny instans av`Project` klass från en lösenordsskyddad mall (befintlig mpp- eller mpt-fil). |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [ActualsInSync](../../aspose.tasks/project/actualsinsync/) { get; set; } | Hämtar eller ställer in ett värde som anger om ActualsInSync är inställt eller inte. |
| [AdminProject](../../aspose.tasks/project/adminproject/) { get; set; } | Hämtar eller ställer in ett värde som anger om AdminProject är inställt eller inte. |
| [AreEditableActualCosts](../../aspose.tasks/project/areeditableactualcosts/) { get; set; } | Hämtar eller ställer in ett värde som anger om AreEditableActualCosts är inställt eller inte. |
| [Author](../../aspose.tasks/project/author/) { get; set; } | Hämtar eller ställer in värdet Author. |
| [AutoAddNewResourcesAndTasks](../../aspose.tasks/project/autoaddnewresourcesandtasks/) { get; set; } | Hämtar eller ställer in ett värde som anger om AutoAddNewResourcesAndTasks är inställt eller inte. |
| [Autolink](../../aspose.tasks/project/autolink/) { get; set; } | Hämtar eller ställer in ett värde som anger om Autolänk är inställt eller inte. |
| [BaselineForEarnedValue](../../aspose.tasks/project/baselineforearnedvalue/) { get; set; } | Hämtar eller ställer in värdet BaselineForEarnedValue. |
...
| [Calendar](../../aspose.tasks/project/calendar/) { get; set; } | Hämtar eller ställer in värdet på Kalender. |
| [Calendars](../../aspose.tasks/project/calendars/) { get; } | Blir[`CalendarCollection`](../calendarcollection/) objekt för denna projektinstans. |
| [Category](../../aspose.tasks/project/category/) { get; set; } | Hämtar eller ställer in värdet Category. |
| [Comments](../../aspose.tasks/project/comments/) { get; set; } | Hämtar eller ställer in värdet Kommentarer. |
| [Company](../../aspose.tasks/project/company/) { get; set; } | Hämtar eller ställer in ett värde på Company. |
| [CreationDate](../../aspose.tasks/project/creationdate/) { get; set; } | Hämtar eller ställer in värdet CreationDate. |
...
| [CriticalSlackLimit](../../aspose.tasks/project/criticalslacklimit/) { get; set; } | Hämtar eller ställer in värdet CriticalSlackLimit. |
| [CurrencyCode](../../aspose.tasks/project/currencycode/) { get; set; } | Hämtar eller ställer in värdet CurrencyCode. |
| [CurrencyDigits](../../aspose.tasks/project/currencydigits/) { get; set; } | Hämtar eller ställer in värdet CurrencyDigits. |
| [CurrencySymbol](../../aspose.tasks/project/currencysymbol/) { get; set; } | Hämtar eller ställer in värdet CurrencySymbol. |
| [CurrencySymbolPosition](../../aspose.tasks/project/currencysymbolposition/) { get; set; } | Hämtar eller ställer in värdet CurrencySymbolPosition. |
| [CurrentDate](../../aspose.tasks/project/currentdate/) { get; set; } | Hämtar eller ställer in värdet CurrentDate. |
| [CustomDateFormat](../../aspose.tasks/project/customdateformat/) { get; set; } | Hämtar eller ställer in värdet CustomDateFormat. |
| [CustomProps](../../aspose.tasks/project/customprops/) { get; } | Hämtar projektets samling av anpassade egenskaper. |
| [DateFormat](../../aspose.tasks/project/dateformat/) { get; set; } | Hämtar eller ställer in värdet DateFormat. |
| [DaysPerMonth](../../aspose.tasks/project/dayspermonth/) { get; set; } | Hämtar eller ställer in värdet DaysPerMonth. |
| [DefaultFinishTime](../../aspose.tasks/project/defaultfinishtime/) { get; set; } | Hämtar eller ställer in värdet DefaultFinishTime. |
| [DefaultFixedCostAccrual](../../aspose.tasks/project/defaultfixedcostaccrual/) { get; set; } | Hämtar eller ställer in värdet DefaultFixedCostAccrual. |
| [DefaultOvertimeRate](../../aspose.tasks/project/defaultovertimerate/) { get; set; } | Hämtar eller ställer in värdet DefaultOvertimeRate. |
| [DefaultStandardRate](../../aspose.tasks/project/defaultstandardrate/) { get; set; } | Hämtar eller ställer in värdet DefaultStandardRate. |
| [DefaultStartTime](../../aspose.tasks/project/defaultstarttime/) { get; set; } | Hämtar eller ställer in värdet DefaultStartTime. |
| [DefaultTaskEVMethod](../../aspose.tasks/project/defaulttaskevmethod/) { get; set; } | Hämtar eller ställer in värdet DefaultTaskEVMethod. |
| [DefaultTaskType](../../aspose.tasks/project/defaulttasktype/) { get; set; } | Hämtar eller ställer in värdet DefaultTaskType. |
...
| [DurationFormat](../../aspose.tasks/project/durationformat/) { get; set; } | Hämtar eller ställer in värdet DurationFormat. |
| [EarnedValueMethod](../../aspose.tasks/project/earnedvaluemethod/) { get; set; } | Hämtar eller ställer in värdet EarnedValueMethod. |
...
| [ExtendedCreationDate](../../aspose.tasks/project/extendedcreationdate/) { get; set; } | Hämtar eller ställer in värdet ExtendedCreationDate. |
| [FinishDate](../../aspose.tasks/project/finishdate/) { get; set; } | Hämtar eller ställer in värdet FinishDate. |
| [FiscalYearStart](../../aspose.tasks/project/fiscalyearstart/) { get; set; } | Hämtar eller ställer in ett värde som anger om FiscalYearStart är inställt eller inte. |
| [FyStartDate](../../aspose.tasks/project/fystartdate/) { get; set; } | Hämtar eller ställer in värdet FyStartDate. |
| [Guid](../../aspose.tasks/project/guid/) { get; set; } | Hämtar eller ställer in värdet Guid. |
| [HonorConstraints](../../aspose.tasks/project/honorconstraints/) { get; set; } | Hämtar eller ställer in ett värde som anger om HonorConstraints är inställt eller inte. |
| [HyperlinkBase](../../aspose.tasks/project/hyperlinkbase/) { get; set; } | Hämtar eller ställer in värdet HyperlinkBase. |
| [InsertedProjectsLikeSummary](../../aspose.tasks/project/insertedprojectslikesummary/) { get; set; } | Hämtar eller ställer in ett värde som anger om InsertedProjectsLikeSummary är satt eller inte. |
| [KeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled](../../aspose.tasks/project/keeptaskonnearestworkingtimewhenmadeautoscheduled/) { get; set; } | Hämtar eller ställer in ett värde som anger om KeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled är inställt eller inte. |
| [Keywords](../../aspose.tasks/project/keywords/) { get; set; } | Hämtar eller ställer in värdet på sökord. |
| [LastAuthor](../../aspose.tasks/project/lastauthor/) { get; set; } | Hämtar eller ställer in värdet LastAuthor. |
| [LastPrinted](../../aspose.tasks/project/lastprinted/) { get; set; } | Hämtar eller ställer in värdet LastPrinted. |
| [LastSaved](../../aspose.tasks/project/lastsaved/) { get; set; } | Hämtar eller ställer in värdet LastSaved. |
| [Manager](../../aspose.tasks/project/manager/) { get; set; } | Hämtar eller ställer in värdet Manager. |
| [MicrosoftProjectServerURL](../../aspose.tasks/project/microsoftprojectserverurl/) { get; set; } | Hämtar eller ställer in ett värde som anger om MicrosoftProjectServerURL är inställd eller inte. |
| [MinutesPerDay](../../aspose.tasks/project/minutesperday/) { get; set; } | Hämtar eller ställer in värdet MinutesPerDay. |
| [MinutesPerWeek](../../aspose.tasks/project/minutesperweek/) { get; set; } | Hämtar eller ställer in värdet MinutesPerWeek. |
| [MoveCompletedEndsBack](../../aspose.tasks/project/movecompletedendsback/) { get; set; } | Hämtar eller ställer in ett värde som anger om MoveCompletedEndsBack är satt eller inte. |
| [MoveCompletedEndsForward](../../aspose.tasks/project/movecompletedendsforward/) { get; set; } | Hämtar eller ställer in ett värde som anger om MoveCompletedEndsForward är inställt eller inte. |
| [MoveRemainingStartsBack](../../aspose.tasks/project/moveremainingstartsback/) { get; set; } | Hämtar eller ställer in ett värde som anger om MoveRemainingStartsBack är inställt eller inte. |
| [MoveRemainingStartsForward](../../aspose.tasks/project/moveremainingstartsforward/) { get; set; } | Hämtar eller ställer in ett värde som anger om MoveRemainingStartsForward är inställt eller inte. |
| [MultipleCriticalPaths](../../aspose.tasks/project/multiplecriticalpaths/) { get; set; } | Hämtar eller ställer in ett värde som anger om MultipleCriticalPaths är inställt eller inte. |
| [Name](../../aspose.tasks/project/name/) { get; set; } | Hämtar eller ställer in värdet Namn. |
| [NewTasksAreManual](../../aspose.tasks/project/newtasksaremanual/) { get; set; } | Hämtar eller ställer in ett värde som anger om NewTasksAreManual är inställt eller inte. |
| [NewTasksEffortDriven](../../aspose.tasks/project/newtaskseffortdriven/) { get; set; } | Hämtar eller ställer in ett värde som anger om NewTasksEffortDriven är inställt eller inte. |
| [NewTasksEstimated](../../aspose.tasks/project/newtasksestimated/) { get; set; } | Hämtar eller ställer in ett värde som anger om NewTasksEstimated är satt eller inte. |
| [NewTaskStartDate](../../aspose.tasks/project/newtaskstartdate/) { get; set; } | Hämtar eller ställer in värdet NewTaskStartDate. |
...
| [ProjectExternallyEdited](../../aspose.tasks/project/projectexternallyedited/) { get; set; } | Hämtar eller ställer in ett värde som anger om ProjectExternallyEdited är inställt eller inte. |
| [RemoveFileProperties](../../aspose.tasks/project/removefileproperties/) { get; set; } | Hämtar eller ställer in ett värde som anger om RemoveFileProperties är inställt eller inte. |
...
| [Revision](../../aspose.tasks/project/revision/) { get; set; } | Hämtar eller ställer in värdet Revision. |
| [RootTask](../../aspose.tasks/project/roottask/) { get; } | Hämtar roten till uppgiftsträdet. |
| [SaveVersion](../../aspose.tasks/project/saveversion/) { get; set; } | Hämtar eller ställer in värdet SaveVersion. |
| [ScheduleFromStart](../../aspose.tasks/project/schedulefromstart/) { get; set; } | Hämtar eller ställer in ett värde som anger om ScheduleFromStart är inställt eller inte. |
| [ShowProjectSummaryTask](../../aspose.tasks/project/showprojectsummarytask/) { get; set; } | Hämtar eller ställer in ett värde som anger om ShowProjectSummaryTask är inställt eller inte. |
| [SplitsInProgressTasks](../../aspose.tasks/project/splitsinprogresstasks/) { get; set; } | Hämtar eller ställer in ett värde som anger om SplitsInProgressTasks är inställt eller inte. |
| [SpreadActualCost](../../aspose.tasks/project/spreadactualcost/) { get; set; } | Hämtar eller ställer in ett värde som anger om SpreadActualCost är inställt eller inte. |
| [SpreadPercentComplete](../../aspose.tasks/project/spreadpercentcomplete/) { get; set; } | Hämtar eller ställer in ett värde som anger om SpreadPercentComplete är inställt eller inte. |
| [StartDate](../../aspose.tasks/project/startdate/) { get; set; } | Hämtar eller ställer in värdet StartDate. |
| [StatusDate](../../aspose.tasks/project/statusdate/) { get; set; } | Hämtar eller ställer in värdet StatusDate. |
| [Subject](../../aspose.tasks/project/subject/) { get; set; } | Hämtar eller ställer in värdet Subject. |
...
| [TaskUpdatesResource](../../aspose.tasks/project/taskupdatesresource/) { get; set; } | Hämtar eller ställer in ett värde som anger om TaskUpdatesResource är inställt eller inte. |
| [Template](../../aspose.tasks/project/template/) { get; set; } | Hämtar eller ställer in värdet Template. |
| [TimescaleFinish](../../aspose.tasks/project/timescalefinish/) { get; set; } | Hämtar eller ställer in värdet TimescaleFinish. |
| [TimescaleStart](../../aspose.tasks/project/timescalestart/) { get; set; } | Hämtar eller ställer in värdet TimescaleStart. |
| [Title](../../aspose.tasks/project/title/) { get; set; } | Hämtar eller ställer in värdet Titel. |
| [Uid](../../aspose.tasks/project/uid/) { get; set; } | Hämtar eller ställer in värdet Uid. |
| [UpdateManuallyScheduledTasksWhenEditingLinks](../../aspose.tasks/project/updatemanuallyscheduledtaskswheneditinglinks/) { get; set; } | Hämtar eller ställer in ett värde som anger om UpdateManuallyScheduledTasksWhenEditingLinks är inställt eller inte. |
...
| [WeekStartDay](../../aspose.tasks/project/weekstartday/) { get; set; } | Hämtar eller ställer in värdet WeekStartDay. |
| [WorkFormat](../../aspose.tasks/project/workformat/) { get; set; } | Hämtar eller ställer in värdet WorkFormat. |
