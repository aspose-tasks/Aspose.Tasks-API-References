...
| protectionPassword | String | Skyddslösenord. |

### Anmärkningar

Läser lösenordsskyddade filer som för närvarande endast stöds för MSP 2003-filformat.
...
| --- | --- | --- |
| projectTemplate | String | Sökväg till mall att skapa projekt från. |
| parseErrorHandler | ParseErrorCallback | den angivna återuppringningsmetoden för att hantera xml-tolkningsfel. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | Stream | Streama för att ladda en mall från. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| reader | StreamReader | Strömläsaren varifrån en mall ska laddas. |
