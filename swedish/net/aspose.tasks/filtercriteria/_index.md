...
description: Definierar kriterierna som uppgifter eller resurser måste uppfylla för att visas i MSP-vy.
type: docs
weight: 620
...
| namn | Beskrivning |
| --- | --- |
| override [ToString](../../aspose.tasks/filtercriteria/tostring)() | Returnerar strängrepresentation av instansen av[`FilterCriteria`](../filtercriteria) class. |
