...
| --- | --- | --- |
| textValue | String | Det angivna textvärdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| numericValue | Decimal | Det angivna numeriska värdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| dateTimeValue | DateTime | Det angivna värdet för datum och tid. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| durationValue | Duration | Det angivna varaktighetsvärdet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| flagValue | Boolean | Det angivna flaggvärdet. |
