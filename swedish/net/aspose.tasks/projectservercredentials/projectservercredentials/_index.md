...
description: Initierar en ny instans avProjectServerCredentialsaspose.tasks/projectservercredentials klass med URL till SharePoint-webbplats och giltig SPOIDCRL-auktoriseringstoken för SharePoints PWA-webbplats Project Web Access.
type: docs
weight: 10
...
Initierar en ny instans av[`ProjectServerCredentials`](../../projectservercredentials) klass med URL till SharePoint-webbplats och giltig SPOIDCRL-auktoriseringstoken för SharePoints PWA-webbplats (Project Web Access).
...
Initierar en ny instans av[`ProjectServerCredentials`](../../projectservercredentials) klass med URL till SharePoint-webbplats, användarnamn och lösenord.
...
Initierar en ny instans av[`ProjectServerCredentials`](../../projectservercredentials) klass med hjälp av URL till Project Web Access-slutpunkt och nätverksuppgifter.
