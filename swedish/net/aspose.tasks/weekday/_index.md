...
description: Representerar en veckodag som antingen definierar vanliga veckodagar eller undantagsdagar i en kalender.
type: docs
weight: 3160
...
| namn | Beskrivning |
| --- | --- |
| [WeekDay](weekday#constructor)() | Initierar en ny instans av[`WeekDay`](../weekday) class. |
| [WeekDay](weekday#constructor_1)(DayType) | Initierar en ny instans av[`WeekDay`](../weekday) klass med angiven dagtyp. |
| [WeekDay](weekday#constructor_2)(DayType, IEnumerable&lt;WorkingTime&gt;) | Initierar en ny instans av[`WeekDay`](../weekday) klass med angiven dagtyp och lista över arbetstidsperioder. |
...
| override [GetHashCode](../../aspose.tasks/weekday/gethashcode)() | Returnerar ett hashkodvärde för instansen av[`WeekDay`](../weekday) class. |
