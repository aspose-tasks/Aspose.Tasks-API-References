...
description: Aspose.Tasks.ResourceUsageView klass. Representerar resursanvändningsvy i ett projekt.
type: docs
weight: 1560
url: /sv/net/aspose.tasks/resourceusageview/
---
## ResourceUsageView class

Representerar resursanvändningsvy i ett projekt.
...
| namn | Beskrivning |
| --- | --- |
| [AlignDetailsData](../../aspose.tasks/usageview/aligndetailsdata/) { get; set; } | Hämtar eller ställer in detaljerad datajustering. |
| [BottomTimescaleTier](../../aspose.tasks/usageview/bottomtimescaletier/) { get; set; } | Hämtar eller ställer in inställningar för vyns nedre tidsskalanivå. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) |
| [DisplayDetailsHeaderColumn](../../aspose.tasks/usageview/displaydetailsheadercolumn/) { get; set; } | Hämtar eller ställer in ett värde som anger om informationshuvudkolumnen ska visas i vyn eller inte. |
| [DisplayShortDetailHeaderNames](../../aspose.tasks/usageview/displayshortdetailheadernames/) { get; set; } | Hämtar eller ställer in ett värde som anger om korta detaljhuvudnamn ska visas eller inte. |
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | Får[`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) objekt för denna ResourceUsageView. |
...
| [MiddleTimescaleTier](../../aspose.tasks/usageview/middletimescaletier/) { get; set; } | Hämtar eller ställer in inställningar för vyns mellantidsskalanivå. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) . |
...
| [RepeatDetailsHeaderOnAllRows](../../aspose.tasks/usageview/repeatdetailsheaderonallrows/) { get; set; } | Hämtar eller ställer in ett värde som anger om informationshuvudet ska upprepas på alla tilldelningsrader eller inte. |
...
| [TopTimescaleTier](../../aspose.tasks/usageview/toptimescaletier/) { get; set; } | Hämtar eller ställer in inställningar för vyns högsta tidsskalanivå. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) . |
