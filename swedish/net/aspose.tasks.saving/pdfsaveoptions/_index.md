...
description: Aspose.Tasks.Saving.PdfSaveOptions klass. Gör det möjligt att ange ytterligare alternativ när projektsidor renderas till PDF.
type: docs
weight: 1860
...
| namn | Beskrivning |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | Initierar en ny instans av`PdfSaveOptions`klass som kan användas för att spara ett dokument i[`PDF`](../savefileformat/) formatera. |
