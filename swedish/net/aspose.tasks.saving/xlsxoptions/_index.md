...
description: Tillåter att ange ytterligare alternativ när projektsidor renderas till XLSX.
type: docs
weight: 1970
...
| namn | Beskrivning |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | Initierar en ny instans av[`XlsxOptions`](../xlsxoptions)klass som kan användas för att spara projekt i XLSX-format. |
