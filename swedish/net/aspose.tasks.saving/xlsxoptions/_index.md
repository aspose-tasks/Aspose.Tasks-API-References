...
description: Aspose.Tasks.Saving.XlsxOptions klass. Tillåter att ange ytterligare alternativ när projektsidor renderas till XLSX.
type: docs
weight: 1980
url: /sv/net/aspose.tasks.saving/xlsxoptions/
---
## XlsxOptions class

Tillåter att ange ytterligare alternativ när projektsidor renderas till XLSX.
...
| namn | Beskrivning |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Initierar en ny instans av`XlsxOptions`klass som kan användas för att spara projekt i XLSX-format. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | Hämtar eller ställer in en lista över de uppdragsvykolumner som ska renderas ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Hämtar eller ställer in kodningen för den resulterande XLSX-filen. Standardvärdet ärUTF8 . |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | Hämtar eller ställer in en lista över de resursvykolumner som ska renderas ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
