...
description: Aspose.Tasks.Saving.CsvOptions klass. Tillåter att ange ytterligare alternativ när du sparar projekt till CSV.
type: docs
weight: 1720
...
| namn | Beskrivning |
| --- | --- |
| [CsvOptions](csvoptions/)() | Initierar en ny instans av`CsvOptions` klass som kan användas för att spara projekt i CSV-format. |
