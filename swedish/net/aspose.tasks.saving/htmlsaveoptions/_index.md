...
description: Tillåter att ange ytterligare alternativ när projektsidor renderas till HTML.
type: docs
weight: 1740
...
| namn | Beskrivning |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions)() | Initierar en ny instans av[`HtmlSaveOptions`](../htmlsaveoptions) class. |
