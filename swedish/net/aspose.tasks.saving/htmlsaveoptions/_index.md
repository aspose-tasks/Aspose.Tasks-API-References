...
description: Aspose.Tasks.Saving.HtmlSaveOptions klass. Tillåter att ange ytterligare alternativ när projektsidor renderas till HTML.
type: docs
weight: 1750
url: /sv/net/aspose.tasks.saving/htmlsaveoptions/
---
...
| namn | Beskrivning |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | Initierar en ny instans av`HtmlSaveOptions` class. |
...
| [CssSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/csssavingcallback/) { get; set; } | Hämtar eller ställer in återuppringningen som anropas för att skapa resurs för att lagra CSS. |
| [CssStylePrefix](../../aspose.tasks.saving/htmlsaveoptions/cssstyleprefix/) { get; set; } | Hämtar eller ställer in CSS-stilprefix. |
...
| [DefaultFontName](../../aspose.tasks.saving/htmlsaveoptions/defaultfontname/) { get; set; } | Hämtar eller ställer in standardteckensnittet för rendering. |
...
| [ExportCss](../../aspose.tasks.saving/htmlsaveoptions/exportcss/) { get; set; } | Hämtar eller ställer in hur CSS exporteras. |
| [ExportFonts](../../aspose.tasks.saving/htmlsaveoptions/exportfonts/) { get; set; } | Hämtar eller ställer in hur teckensnitt exporteras. |
| [ExportImages](../../aspose.tasks.saving/htmlsaveoptions/exportimages/) { get; set; } | Hämtar eller ställer in hur bilder exporteras. |
...
| [FontFaceTypes](../../aspose.tasks.saving/htmlsaveoptions/fontfacetypes/) { get; set; } | Hämtar eller ställer in teckensnittstyper. |
| [FontResolveCallback](../../aspose.tasks.saving/htmlsaveoptions/fontresolvecallback/) { get; set; } | Hämtar eller ställer in en återuppringning som kan användas för att anpassa lösta teckensnitt. |
| [FontSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/fontsavingcallback/) { get; set; } | Hämtar eller ställer in återuppringningen som anropas för att skapa resurs för att lagra teckensnitt. |
...
| [ImageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/imagesavingcallback/) { get; set; } | Hämtar eller ställer in återuppringningen som anropas för att skapa resurs för att lagra teckensnitt. |
| [IncludeProjectNameInPageHeader](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameinpageheader/) { get; set; } | Hämtar eller ställer in ett värde som anger om projektnamnet ska inkluderas i HTML-sidans sidhuvud. |
| [IncludeProjectNameInTitle](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameintitle/) { get; set; } | Hämtar eller ställer in ett värde som anger om projektnamn ska inkluderas i HTML-titel. |
...
| [Pages](../../aspose.tasks.saving/htmlsaveoptions/pages/) { get; set; } | Hämtar eller ställer in en lista med sidnummer som ska sparas vid rendering av projektlayout. Alla projektsidor kommer att sparas om denna lista är tom. |
| [PageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/pagesavingcallback/) { get; set; } | Hämtar eller ställer in en användardefinierad callback som används för att få en utdataström för varje renderad sida. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/htmlsaveoptions/reducefootergap/) { get; set; } | Hämtar eller ställer in ett värde som indikerar om ett gap mellan den senaste uppgiften och sidfoten måste minskas. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/htmlsaveoptions/usegradientbrush/) { get; set; } | Hämtar eller ställer in ett värde som anger om övertoningspensel ska användas vid rendering av projektlayout. För närvarande stöds inte användning av gradientborste vid rendering till HTML. |
| [UseProjectDefaultFont](../../aspose.tasks.saving/htmlsaveoptions/useprojectdefaultfont/) { get; set; } | Hämtar eller ställer in ett värde som anger om standardteckensnittet måste användas för rendering. |
