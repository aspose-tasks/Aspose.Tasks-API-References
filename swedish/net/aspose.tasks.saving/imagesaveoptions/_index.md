...
description: Gör det möjligt att ange ytterligare alternativ när projektsidor renderas till bilder.
type: docs
weight: 1760
...
| namn | Beskrivning |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | Initierar en ny instans av[`ImageSaveOptions`](../imagesaveoptions) klass som kan användas för att spara renderade bilder i TIFF-, PNG-, BMP- eller JPEG-format. |
