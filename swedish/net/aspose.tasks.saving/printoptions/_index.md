...
description: Aspose.Tasks.Saving.PrintOptions klass. Gör det möjligt att ange ytterligare alternativ vid utskrift av projekt.
type: docs
weight: 1900
...
| namn | Beskrivning |
| --- | --- |
| [PrintOptions](printoptions/)() | Initierar en ny instans av`PrintOptions` klass som kan användas för att ställa in olika alternativ för att skriva ut projekt. |
