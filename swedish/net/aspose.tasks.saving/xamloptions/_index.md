...
description: Aspose.Tasks.Saving.XamlOptions klass. /// Tillåter att ange ytterligare alternativ när projektsidor renderas till XAML.
type: docs
weight: 1970
url: /sv/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// Tillåter att ange ytterligare alternativ när projektsidor renderas till XAML.
...
| namn | Beskrivning |
| --- | --- |
| [XamlOptions](xamloptions/)() | Initierar en ny instans av`XamlOptions` klass som kan användas för att spara projekt i XAML-format. |
