...
description: /// Tillåter att ange ytterligare alternativ när projektsidor renderas till XAML.
type: docs
weight: 1960
...
| namn | Beskrivning |
| --- | --- |
| [XamlOptions](xamloptions)() | Initierar en ny instans av[`XamlOptions`](../xamloptions) klass som kan användas för att spara projekt i XAML-format. |
