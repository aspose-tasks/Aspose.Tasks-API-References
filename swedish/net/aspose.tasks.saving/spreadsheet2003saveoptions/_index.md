...
description: Aspose.Tasks.Saving.Spreadsheet2003SaveOptions klass. Tillåter att ange ytterligare alternativ när projektsidor renderas till Spreadsheet2003.
type: docs
weight: 1940
url: /sv/net/aspose.tasks.saving/spreadsheet2003saveoptions/
---
## Spreadsheet2003SaveOptions class

Tillåter att ange ytterligare alternativ när projektsidor renderas till Spreadsheet2003.
...
| namn | Beskrivning |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | Initierar en ny instans av`Spreadsheet2003SaveOptions` klass. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | Hämtar eller ställer in en lista över de uppdragsvykolumner som ska renderas ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | Hämtar eller ställer in en lista över de resursvykolumner som ska renderas ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
