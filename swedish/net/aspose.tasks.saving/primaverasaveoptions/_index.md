...
description: Gör det möjligt att ange ytterligare alternativ när du sparar projekt i Primavera XER-format.
type: docs
weight: 1870
...
| namn | Beskrivning |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | Initierar en ny instans av[`PrimaveraSaveOptions`](../primaverasaveoptions) class. |
