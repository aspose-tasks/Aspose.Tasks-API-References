...
description: Aspose.Tasks.Saving.PrimaveraSaveOptions klass. Gör det möjligt att ange ytterligare alternativ när du sparar projekt i Primavera XERformat.
type: docs
weight: 1880
url: /sv/net/aspose.tasks.saving/primaverasaveoptions/
---
## PrimaveraSaveOptions class

Gör det möjligt att ange ytterligare alternativ när du sparar projekt i Primavera XER-format.
...
| namn | Beskrivning |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | Initierar en ny instans av`PrimaveraSaveOptions` class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | Hämtar eller ställer in ökningen som används vid omnumrering av aktivitets-ID:n. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | Hämtar eller ställer in prefixet som används vid omnumrering av aktivitets-ID:n. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | Hämtar eller ställer in suffixet som används vid omnumrering av aktivitets-ID:n. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids/) { get; set; } | Hämtar eller ställer in ett värde som anger om aktivitets-ID:n måste omnumreras. |
