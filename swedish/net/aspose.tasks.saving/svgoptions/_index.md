...
description: Aspose.Tasks.Saving.SvgOptions klass. Tillåter att ange ytterligare alternativ när projektsidor renderas till SVG.
type: docs
weight: 1950
url: /sv/net/aspose.tasks.saving/svgoptions/
---
## SvgOptions class
...
| namn | Beskrivning |
| --- | --- |
| [SvgOptions](svgoptions/)() | Initierar en ny instans av`SvgOptions` klass som kan användas för att spara projekt i SVG-format. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Hämtar eller ställer in en användardefinierad implementeringscallback som används för att få en utdataström för varje renderad sida. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Avgör om övertoningspensel ska användas vid rendering av projektlayout. För närvarande stöds inte användning av gradientborste för rendering till SVG. |
