...
description: Aspose.Tasks.Saving.XpsOptions klass. Tillåter att ange ytterligare alternativ när projektsidor renderas till XPS.
type: docs
weight: 1990
url: /sv/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Tillåter att ange ytterligare alternativ när projektsidor renderas till XPS.
...
| namn | Beskrivning |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Initierar en ny instans av`XpsOptions` class. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Hämtar eller ställer in ett värde som anger om en metafil ska renderas som bitmapp. |
