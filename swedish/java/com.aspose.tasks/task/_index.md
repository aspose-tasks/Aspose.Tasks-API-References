...
type: docs
weight: 289
url: /sv/java/com.aspose.tasks/task/
---
...
Den **Task** representerar en enskild atomär arbetsenhet.

Man kan använda **Task** för att planera ett projekt genom att skapa uppgifter och tilldela lämpliga resurser till dem. Uppgifter i ett projekt är organiserade som en rotad hierarkisk trädstruktur, med en rotuppgift och underträd av barnuppgifter.

För att bygga ett träd av uppgifter kan man använda en specialiserad samling [TaskCollection](../../com.aspose.tasks/taskcollection) genom att komma åt `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) egenskap t.ex.:
...
Task task1 = project.RootTask.Children.Add(); // en föräldrauppgift med tomt namn läggs till
...
// spara projektet i ett av de tillgängliga formaten
