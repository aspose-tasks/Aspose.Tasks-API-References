...
type: docs
weight: 287
url: /sv/java/com.aspose.tasks/tablefieldcollection/
---
...
Innehåller en lista med [TableField](../../com.aspose/tasks/tablefield) objekt. Implementerar IList&lt;TableField&gt; gränssnittet.
## Metoder
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | Returnerar index för det angivna objektet i denna samling. |
...
Returnerar index för det angivna objektet i denna samling.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | det angivna objektet. |

**Returns:**
int - index för objektet.
### indexOf(Object o) {#indexOf-java.lang.Object-}
```
