...
description: "Representerar en basklass för upprepningar i dagligt återkommande mönster."
type: docs
weight: 65
url: /sv/java/com.aspose.tasks/dailyrepetitionbase/
---
...
Representerar en basklass för upprepningar i dagligt återkommande mönster.
## Metoder
...
| [getRepetitionInterval()](#getRepetitionInterval--) | Hämtar ett antal dagar som representerar intervallet i dagar mellan förekomster. |
| [getValidator(Calendar calendar)](#getValidator-com.aspose.tasks.Calendar-) | \{@inheritDoc\} |
| [setRepetitionInterval(int value)](#setRepetitionInterval-int-) | Ställer in ett antal dagar som representerar intervallet i dagar mellan förekomster. |
...
Hämtar ett antal dagar som representerar intervallet i dagar mellan förekomster.

**Returns:**
int - ett antal dagar som representerar intervallet i dagar mellan förekomster.
...
Ställer in ett antal dagar som representerar intervallet i dagar mellan förekomster.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | int | ett antal dagar som representerar intervallet i dagar mellan förekomster. |
