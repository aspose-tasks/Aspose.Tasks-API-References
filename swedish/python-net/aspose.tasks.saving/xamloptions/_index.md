...
type: docs
weight: 180
url: /sv/python-net/aspose.tasks.saving/xamloptions/
---
...
Typen XamlOptions visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| XamlOptions() | Initierar en ny instans av klassen [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) som kan användas för att spara projekt i XAML-format. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format |  |
