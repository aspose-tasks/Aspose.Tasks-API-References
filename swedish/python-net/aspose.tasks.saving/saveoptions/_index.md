...
type: docs
weight: 130
url: /sv/python-net/aspose.tasks.saving/saveoptions/
---

## SaveOptions class

Detta är en abstrakt basklass för klasser som tillåter användaren att ange ytterligare alternativ när ett projekt sparas<br/>            i ett specifikt format.

Typen SaveOptions visar följande medlemmar:
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format | Hämtar eller anger formatet som dokumentet kommer att sparas i om detta sparalternativobjekt används. |
