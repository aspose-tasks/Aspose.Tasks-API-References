...
type: docs
weight: 120
url: /sv/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Tillåter att ange ytterligare alternativ när projektet skrivs ut.

Typen PrintOptions visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| PrintOptions() | Initierar en ny instans av klassen [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) som kan användas för att ställa in olika alternativ för att skriva ut projektet. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format |  |
