...
type: docs
weight: 170
url: /sv/python-net/aspose.tasks.saving/svgoptions/
---
...
Typen SvgOptions visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| SvgOptions() | Initierar en ny instans av klassen [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) som kan användas för att spara projektet i SVG-format. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Bestämmer om en gradientpensel ska användas vid rendering av projektlayouten. |
...
| page_saving_callback | Hämtar eller anger ett användardefinierat återuppringnings‑implementering som används för att få en utdataström för varje renderad sida. |
