...
type: docs
weight: 200
url: /sv/python-net/aspose.tasks.saving/xpsoptions/
---
...
Typen XpsOptions visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| XpsOptions() | Initierar en ny instans av klassen [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Hämtar eller anger ett värde som indikerar om en metafil ska renderas som bitmap. |
