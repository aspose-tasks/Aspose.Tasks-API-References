...
type: docs
weight: 40
url: /sv/python-net/aspose.tasks.saving/imagesaveoptions/
---

## ImageSaveOptions class

Tillåter att ange ytterligare alternativ när projektsidor renderas till bilder.

Typen ImageSaveOptions exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| ImageSaveOptions(save_format) | Initierar en ny instans av klassen [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) som kan användas för att spara renderade bilder i TIFF, PNG, BMP eller JPEG-format. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
| save_format |  |
...
| pages | Hämtar eller anger en lista med sidnummer som ska sparas när projektlayout sparas till separata filer. |
| jpeg_quality | Hämtar eller anger en JPEG-kvalitet. Tillåtet värdeintervall är 0..100. |
| reduce_footer_gap | Hämtar eller anger ett värde som indikerar om ett gap mellan sista uppgiften och sidfoten ska minskas. |
| tiff_compression | Hämtar eller anger kompressionstypen som ska tillämpas när genererade bilder sparas i TIFF-format. |
| pixel_format | Hämtar eller anger formatet för färgdata för varje pixel i bilden. |
| horizontal_resolution | Hämtar eller anger den horisontella upplösningen i dpi. |
| vertical_resolution | Hämtar eller anger den vertikala upplösningen i dpi. |
