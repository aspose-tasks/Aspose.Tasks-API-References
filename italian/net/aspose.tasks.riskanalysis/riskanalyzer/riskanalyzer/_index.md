...
description: "RiskAnalyzer costruttore. Inizializza una nuova istanza della classe RiskAnalyzer."
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`RiskAnalyzer`](../).
...
| --- | --- | --- |
| settings | RiskAnalysisSettings | l'istanza specificata della classe [`RiskAnalysisSettings`](../../riskanalysissettings/). |
