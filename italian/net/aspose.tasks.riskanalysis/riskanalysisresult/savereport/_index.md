...
description: "RiskAnalysisResult metodo. Salva il report di analisi del rischio nello stream in formato PDF."
type: docs
weight: 20
...
Salva il report dell'analisi del rischio nello stream in formato PDF.
...
| --- | --- | --- |
| flusso | Flusso | Lo stream su cui salvare il report di analisi del rischio. |
...
Salva il report dell'analisi del rischio nel percorso file specificato in formato PDF.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | Stringa | Il nome file specificato. |
