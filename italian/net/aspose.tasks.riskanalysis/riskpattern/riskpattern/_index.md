...
description: "Costruttore RiskPattern. Inizializza una nuova istanza della classe RiskPattern"
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`RiskPattern`](../).
...
| --- | --- | --- |
| attività | Attività | l'attività di progetto specificata per la quale questo rischio sarà applicato nella simulazione Monte Carlo. |
