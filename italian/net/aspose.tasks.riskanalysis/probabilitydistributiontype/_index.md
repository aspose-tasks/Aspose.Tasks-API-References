...
description: "Enum Aspose.Tasks.RiskAnalysis.ProbabilityDistributionType. Specifica i tipi di distribuzioni di probabilità supportate"
type: docs
weight: 1860
...
| --- | --- | --- |
| Uniform | `0` | La distribuzione in cui ogni valore è scelto con uguale probabilità. |
| Normal | `1` | La distribuzione talvolta informalmente chiamata curva a campana (distribuzione gaussiana). |
