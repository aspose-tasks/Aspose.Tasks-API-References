...
description: "Aspose.Tasks.RiskAnalysis.ConfidenceLevel enum. Specifica i livelli di confidenza supportati utilizzati nell'analisi del rischio che corrispondono alla percentuale di volte in cui i valori effettivi saranno compresi tra le stime ottimistiche e pessimistiche"
type: docs
weight: 1850
...
Specifica i livelli di confidenza supportati utilizzati nell'analisi del rischio che corrispondono alla percentuale di tempo in cui i valori effettivi saranno compresi tra le stime ottimistiche e pessimistiche.
...
| --- | --- | --- |
| CL99 | `99` | Livello di confidenza 99 %. |
| CL95 | `95` | Livello di confidenza 95 %. |
| CL90 | `90` | Livello di confidenza 90 %. |
| CL85 | `85` | Livello di confidenza 85 %. |
| CL75 | `75` | Livello di confidenza 75 %. |
