...
description: Contiene classi per la creazione di report di analisi dei rischi.
type: docs
weight: 40
url: /it/net/aspose.tasks.riskanalysis/
---
Contiene classi per la creazione di report di analisi dei rischi.
...
| [RiskAnalysisSettings](./riskanalysissettings) | Specifica le impostazioni per l'esecuzione dell'analisi del rischio. |
| [RiskAnalyzer](./riskanalyzer) | Esegue una simulazione Monte Carlo in base alle impostazioni di analisi del rischio specificate. |
...
| [RiskItemType](./riskitemtype) | Specifica i campi delle attività per i quali vengono raccolte le informazioni statistiche durante l'analisi del rischio. |
