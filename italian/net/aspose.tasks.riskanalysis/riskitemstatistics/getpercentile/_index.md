...
description: "Metodo RiskItemStatistics. Restituisce un valore al di sotto del quale cade una percentuale specificata di campioni generati"
type: docs
weight: 60
...
| --- | --- | --- |
| percentuale | Int32 | La percentuale specificata tra 0 e 100. |

### Valore di ritorno

Un valore al di sotto del quale cade una percentuale specificata di campioni generati.
