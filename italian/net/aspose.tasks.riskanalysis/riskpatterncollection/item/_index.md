...
description: "RiskPatternCollection proprietà. Ottiene l'istanza della classe RiskPattern per l'attività specificata."
type: docs
weight: 30
...
Ottiene l'istanza della classe [`RiskPattern`](../../riskpattern/) per l'attività specificata.
...
| --- | --- |
| attività | l'attività specificata. |
