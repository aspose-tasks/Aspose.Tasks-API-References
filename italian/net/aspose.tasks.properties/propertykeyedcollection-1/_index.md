...
description: Una classe base di raccolta di proprietà.
type: docs
weight: 1340
...
| abstract [IsReadOnly](../../aspose.tasks.properties/propertykeyedcollection`1/isreadonly) { get; } | Ottiene un valore che indica se questa raccolta è di sola lettura; in caso contrario, falso. |
...
| [Contains](../../aspose.tasks.properties/propertykeyedcollection`1/contains)(string) | Determina se il[`PropertyCollection`](../propertycollection-1) contiene una proprietà con il nome specificato. |
