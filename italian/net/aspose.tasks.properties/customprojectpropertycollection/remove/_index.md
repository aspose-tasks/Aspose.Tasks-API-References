...
description: "Metodo CustomProjectPropertyCollection. Rimuove una proprietà con il nome specificato dalla raccolta"
type: docs
weight: 50
...
| --- | --- | --- |
| nome | Stringa | Il nome della proprietà, senza distinzione tra maiuscole e minuscole. |

### Valore di ritorno

Vero se l'elemento è stato trovato e rimosso con successo; altrimenti, falso.
