...
description: "Metodo ITextStyleModificationCallback. Il metodo da chiamare prima del rendering di una cella della tabella per una riga attività nelle seguenti visualizzazioni Gantt Chart Task Sheet Task Usage"
type: docs
weight: 10
...
| --- | --- | --- |
| args | TaskTextStyleEventArgs | L'oggetto [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/). |
