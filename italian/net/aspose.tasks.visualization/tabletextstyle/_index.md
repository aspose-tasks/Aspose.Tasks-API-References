...
| Nome | Descrizione |
| --- | --- |
| [TableTextStyle](tabletextstyle#constructor)(int) | Inizializza una nuova istanza di[`TableTextStyle`](../tabletextstyle) classe. |
| [TableTextStyle](tabletextstyle#constructor_1)(int, FontDescriptor) | Inizializza una nuova istanza di[`TableTextStyle`](../tabletextstyle) classe con il font specificato. |
| [TableTextStyle](tabletextstyle#constructor_2)(int, FontStyles) | Inizializza una nuova istanza di[`TableTextStyle`](../tabletextstyle) classe con le impostazioni del carattere predefinite e lo stile del carattere specificato. |
| [TableTextStyle](tabletextstyle#constructor_3)(int, float, FontStyles) | Inizializza una nuova istanza di[`TableTextStyle`](../tabletextstyle) classe con la dimensione del carattere e lo stile del carattere specificati. |
