...
description: "Proprietà TableTextStyle. Ottiene o imposta un campo a cui lo stile deve essere applicato. Field"
type: docs
weight: 20
...
Ottiene o imposta un campo a cui lo stile deve essere applicato. `Field`.
