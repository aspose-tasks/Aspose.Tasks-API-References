...
description: "Enum Aspose.Tasks.Visualization.GanttBarType. Specifica il tipo di barra"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Indica il tipo di barra Gantt tratteggiata. |
| Framed | `1` | Indica il tipo di barra Gantt incorniciata. |
