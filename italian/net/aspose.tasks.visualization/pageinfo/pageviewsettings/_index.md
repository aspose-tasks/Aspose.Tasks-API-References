...
description: "PageInfo proprietà. Ottiene un'istanza della classe PageViewSettings che specifica le impostazioni di stampa della visualizzazione della pagina"
type: docs
weight: 80
...
Ottiene un'istanza della classe `PageViewSettings` che specifica le impostazioni di stampa della visualizzazione della pagina.
