...
description: "Proprietà PageInfo. Ottiene o imposta un'istanza della classe HeaderFooterInfo che rappresenta i dati del piè di pagina"
type: docs
weight: 20
...
Ottiene o imposta un'istanza della classe [`HeaderFooterInfo`](../../headerfooterinfo/) che rappresenta i dati del piè di pagina.
