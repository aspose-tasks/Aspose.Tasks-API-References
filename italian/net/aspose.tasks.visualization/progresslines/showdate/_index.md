...
description: "ProgressLines proprietà. Ottiene o imposta un valore che indica se mostrare la data per ogni linea di avanzamento"
type: docs
weight: 200
...
Ottiene o imposta un valore che indica se mostrare la data per ogni linea di avanzamento.
