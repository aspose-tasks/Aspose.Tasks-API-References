...
description: "ProgressLines proprietà. Ottiene o imposta un valore che indica se visualizzare le linee di avanzamento per il piano di base o reale"
type: docs
weight: 90
url: /it/net/aspose.tasks.visualization/progresslines/isbaselineplan/
---
## ProgressLines.IsBaselinePlan property

Ottiene o imposta un valore che indica se visualizzare le linee di avanzamento per il piano di base o quello reale.
