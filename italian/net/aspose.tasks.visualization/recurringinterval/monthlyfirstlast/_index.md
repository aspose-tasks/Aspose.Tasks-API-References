...
description: "RecurringInterval proprietà. Ottiene o imposta un valore che indica se mostrare le linee di avanzamento per il primo o l'ultimo giorno predefinito"
type: docs
weight: 80
...
Ottiene o imposta un valore che indica se mostrare le linee di avanzamento per il primo o l'ultimo giorno predefinito.
