...
description: "RecurringInterval proprietà. Ottiene o imposta l'intervallo ricorrente. Può essere qualsiasi valore del tipo Interval"
type: docs
weight: 40
...
Ottiene o imposta l'intervallo ricorrente. Può essere qualsiasi valore del tipo `Interval`.
