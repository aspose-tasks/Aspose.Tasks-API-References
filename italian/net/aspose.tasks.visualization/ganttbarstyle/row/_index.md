...
description: "GanttBarStyle proprietà. Ottiene o imposta un numero di riga. Può essere da 1 a 4, 1 è il valore predefinito"
type: docs
weight: 190
...
Ottiene o imposta un numero di riga. Può essere da 1 a 4 (1 è il valore predefinito).
