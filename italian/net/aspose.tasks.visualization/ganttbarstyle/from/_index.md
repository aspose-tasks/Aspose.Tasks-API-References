...
description: "GanttBarStyle proprietà. Ottiene o imposta la posizione del punto di partenza della barra Gantt. Campo"
type: docs
weight: 70
...
Ottiene o imposta la posizione del punto di partenza della barra Gantt. [`Field`](../../../aspose.tasks/field/).
