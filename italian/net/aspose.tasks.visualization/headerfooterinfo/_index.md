...
description: Rappresenta i dati di intestazione o piè di pagina presenti nelle viste e utilizzati per la stampa.
type: docs
weight: 2780
...
| Nome | Descrizione |
| --- | --- |
| [HeaderFooterInfo](headerfooterinfo)() | Inizializza una nuova istanza di[`HeaderFooterInfo`](../headerfooterinfo) classe. |
...
| [RightImageSize](../../aspose.tasks.visualization/headerfooterinfo/rightimagesize) { get; set; } | Ottiene o imposta la dimensione visualizzata dell'immagine corretta. |
