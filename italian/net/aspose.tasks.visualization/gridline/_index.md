...
description: La linea orizzontale o verticale che appare nella vista del progetto.
type: docs
weight: 2750
...
| Nome | Descrizione |
| --- | --- |
| [Gridline](gridline)() | Inizializza una nuova istanza di[`Gridline`](../gridline) classe. |
...
| override [GetHashCode](../../aspose.tasks.visualization/gridline/gethashcode)() | Restituisce un valore di codice hash per l'istanza di[`Gridline`](../gridline) classe. |
