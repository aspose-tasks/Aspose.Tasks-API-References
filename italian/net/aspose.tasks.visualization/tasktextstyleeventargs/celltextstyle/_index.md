...
description: "Proprietà TaskTextStyleEventArgs. Ottiene o imposta TextStyle che verrà usato per disegnare il contenuto delle celle. Questo oggetto può essere usato per personalizzare l'aspetto di una cella della tabella."
type: docs
weight: 10
...
Ottiene o imposta TextStyle che verrà usato per disegnare il contenuto della cella. Questo oggetto può essere usato per personalizzare l'aspetto di una cella di tabella.
