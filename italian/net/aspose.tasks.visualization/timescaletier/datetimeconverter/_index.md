...
description: "TimescaleTier proprietà. Ottiene o imposta una funzione di callback per gestire il rendering del segno di data in questo livello"
type: docs
weight: 40
...
Ottiene o imposta una funzione di callback per gestire il rendering del segno di data in questo livello.
