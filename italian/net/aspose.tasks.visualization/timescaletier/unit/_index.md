...
description: "TimescaleTier proprietà. Ottiene o imposta l'unità di scala temporale TimescaleUnit per il livello della scala temporale. Il valore predefinito è Days"
type: docs
weight: 80
...
Ottiene o imposta l'unità di scala temporale [`TimescaleUnit`](../../timescaleunit/) per il livello della scala temporale. Il valore predefinito è [`Days`](../../timescaleunit/).
