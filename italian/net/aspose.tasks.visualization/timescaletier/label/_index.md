...
description: "TimescaleTier proprietà. Ottiene o imposta l'etichetta data DateLabel per il livello della scala temporale"
type: docs
weight: 50
...
Ottiene o imposta l'etichetta data [`DateLabel`](../../datelabel/) per il livello della scala temporale.
