...
description: "TimescaleTier proprietà. Ottiene o imposta come allineare le etichette all'interno di ogni periodo di tempo del livello HorizontalStringAlignment"
type: docs
weight: 20
...
Ottiene o imposta come allineare le etichette all'interno di ogni periodo di tempo del livello ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
