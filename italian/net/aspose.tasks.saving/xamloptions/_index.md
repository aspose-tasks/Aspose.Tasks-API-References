...
description: "Classe Aspose.Tasks.Saving.XamlOptions. /// Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in XAML"
type: docs
weight: 2260
...
| Nome | Descrizione |
| --- | --- |
| [XamlOptions](xamloptions/)() | Inizializza una nuova istanza della classe `XamlOptions` che può essere utilizzata per salvare il progetto in formato XAML. |
