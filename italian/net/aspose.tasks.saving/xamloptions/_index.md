...
description: /// Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto in XAML.
type: docs
weight: 1960
...
/// Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto in XAML.
...
| Nome | Descrizione |
| --- | --- |
| [XamlOptions](xamloptions)() | Inizializza una nuova istanza di[`XamlOptions`](../xamloptions) classe che può essere utilizzata per salvare il progetto in formato XAML. |
