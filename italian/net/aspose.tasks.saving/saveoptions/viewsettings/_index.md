...
description: Ottiene o imposta una vista Viewaspose.tasks.saving/saveoptions/view per rendere. È possibile utilizzare queste opzioni per specificare in modo esplicito quale vista deve essere salvata nei formati PDF HTML o immagine. Se questa proprietà è impostataPresentationFormataspose.tasks.visualization/presentationformat la proprietà viene ignorata quando il progetto viene salvato. La vista dovrebbe provenire da una delle seguenti schermate Screenaspose.tasks/view/screen  Gantt TaskSheet TaskUsage ResourceSheet ResourceUsage
type: docs
weight: 230
