...
description: "Proprietà SaveOptions. Ottiene o imposta un elenco di Gridline che appare nella vista del progetto"
type: docs
weight: 60
...
Ottiene o imposta un elenco di [`Gridline`](../../../aspose.tasks.visualization/gridline/) che appare nella vista del progetto.
