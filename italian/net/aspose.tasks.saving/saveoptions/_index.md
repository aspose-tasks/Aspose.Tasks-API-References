...
description: Questa è una classe base astratta per classi che consentono allutente di specificare opzioni aggiuntive durante il salvataggio di un progetto in un formato particolare.
type: docs
weight: 1910
...
Questa è una classe base astratta per classi che consentono all'utente di specificare opzioni aggiuntive durante il salvataggio di un progetto in un formato particolare.
...
| [Timescale](../../aspose.tasks.saving/saveoptions/timescale) { get; set; } | Ottiene o imposta il[`Timescale`](./timescale) valore che viene utilizzato per controllare la modalità di rendering della scala temporale (se presente) quando il progetto viene salvato in formato grafico. |
