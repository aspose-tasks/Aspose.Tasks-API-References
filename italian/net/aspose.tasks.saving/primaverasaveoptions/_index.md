...
description: Aspose.Tasks.Saving.PrimaveraSaveOptions classe. Consente di specificare opzioni aggiuntive durante il salvataggio del progetto nel formato Primavera XER.
type: docs
weight: 1880
...
| Nome | Descrizione |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | Inizializza una nuova istanza di`PrimaveraSaveOptions` classe. |
