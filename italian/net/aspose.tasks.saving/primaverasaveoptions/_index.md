...
description: Consente di specificare opzioni aggiuntive durante il salvataggio del progetto in formato Primavera XER.
type: docs
weight: 1870
...
Consente di specificare opzioni aggiuntive durante il salvataggio del progetto in formato Primavera XER.
...
| Nome | Descrizione |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | Inizializza una nuova istanza di[`PrimaveraSaveOptions`](../primaverasaveoptions) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement) { get; set; } | Ottiene o imposta l'incremento utilizzato nella rinumerazione degli ID attività. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix) { get; set; } | Ottiene o imposta il prefisso utilizzato nella rinumerazione degli ID attività. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix) { get; set; } | Ottiene o imposta il suffisso utilizzato nella rinumerazione degli ID attività. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids) { get; set; } | Ottiene o imposta un valore che indica se è necessario rinumerare gli ID attività. |
