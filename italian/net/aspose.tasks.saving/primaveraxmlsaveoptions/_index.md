...
description: Consente di specificare opzioni aggiuntive durante il salvataggio del progetto in formato Primavera xml.
type: docs
weight: 1880
...
Consente di specificare opzioni aggiuntive durante il salvataggio del progetto in formato Primavera xml.
...
| Nome | Descrizione |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions)() | Inizializza una nuova istanza di[`PrimaveraXmlSaveOptions`](../primaveraxmlsaveoptions) classe. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask) { get; set; } | Ottiene o imposta un valore che indica se salvare o meno un'attività di root. |
