...
description: "Costruttore di SvgOptions. Inizializza una nuova istanza della classe SvgOptions che può essere usata per salvare il progetto in formato SVG"
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`SvgOptions`](../) che può essere usata per salvare il progetto in formato SVG.
