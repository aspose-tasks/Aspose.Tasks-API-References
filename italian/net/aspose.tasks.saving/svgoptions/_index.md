...
description: Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto in formato SVG.
type: docs
weight: 1940
...
Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto in formato SVG.
...
| Nome | Descrizione |
| --- | --- |
| [SvgOptions](svgoptions)() | Inizializza una nuova istanza di[`SvgOptions`](../svgoptions) classe che può essere utilizzata per salvare il progetto in formato SVG. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback) { get; set; } | Ottiene o imposta un callback di implementazione definito dall'utente che viene utilizzato per ottenere un flusso di output per ogni pagina sottoposta a rendering. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush) { get; set; } | Determina se utilizzare il pennello sfumatura durante il rendering del layout del progetto. Attualmente l'uso del pennello sfumato non è supportato per il rendering in SVG. |
