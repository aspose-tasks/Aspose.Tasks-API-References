...
description: Aspose.Tasks.Saving.SvgOptions classe. Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in SVG.
type: docs
weight: 1950
...
| Nome | Descrizione |
| --- | --- |
| [SvgOptions](svgoptions/)() | Inizializza una nuova istanza di`SvgOptions` class che può essere utilizzata per salvare il progetto in formato SVG. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Ottiene o imposta un callback di implementazione definito dall'utente utilizzato per ottenere un flusso di output per ogni pagina sottoposta a rendering. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Determina se utilizzare il pennello sfumatura durante il rendering del layout del progetto. Attualmente l'utilizzo del pennello sfumato non è supportato per il rendering in SVG. |
