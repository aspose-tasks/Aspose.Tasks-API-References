---
title: "Classe XpsOptions"
second_title: "Riferimento API di Aspose.Tasks per .NET"
description: "Classe Aspose.Tasks.Saving.XpsOptions. Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in XPS"
type: docs
weight: 2280
url: /it/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in XPS.
...
| Nome | Descrizione |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Inizializza una nuova istanza della classe `XpsOptions`. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Ottiene o imposta un valore che indica se un metafile deve essere renderizzato come bitmap. |
