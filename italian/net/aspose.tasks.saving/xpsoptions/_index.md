...
description: Aspose.Tasks.Saving.XpsOptions classe. Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in XPS.
type: docs
weight: 1990
...
| Nome | Descrizione |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Inizializza una nuova istanza di`XpsOptions` classe. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Ottiene o imposta un valore che indica se un metafile deve essere visualizzato come bitmap. |
