...
description: Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto su XPS.
type: docs
weight: 1980
...
Consente di specificare opzioni aggiuntive durante il rendering di pagine di progetto su XPS.
...
| Nome | Descrizione |
| --- | --- |
| [XpsOptions](xpsoptions)() | Inizializza una nuova istanza di[`XpsOptions`](../xpsoptions) classe. |
