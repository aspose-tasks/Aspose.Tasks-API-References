...
description: "Proprietà MPPSaveOptions. Ottiene o imposta un valore che indica se scrivere i dati dei gruppi durante il salvataggio di un progetto in formato MPP. I dati dei gruppi includono le collezioni Project.TaskGroups e Project.ResourceGroups."
type: docs
weight: 60
url: /it/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Ottiene o imposta un valore che indica se scrivere i dati dei gruppi durante il salvataggio di un progetto in formato MPP. I dati dei gruppi includono le collezioni Project.TaskGroups e Project.ResourceGroups.
