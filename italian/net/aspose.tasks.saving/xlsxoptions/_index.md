...
description: Aspose.Tasks.Saving.XlsxOptions classe. Consente di specificare opzioni aggiuntive durante il rendering delle pagine del progetto in XLSX.
type: docs
weight: 1980
...
| Nome | Descrizione |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Inizializza una nuova istanza di`XlsxOptions`class che può essere utilizzata per salvare il progetto in formato XLSX. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | Ottiene o imposta un elenco delle colonne della vista delle assegnazioni di cui eseguire il rendering ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
