...
description: "Costruttore XlsxOptions. Inizializza una nuova istanza della classe XlsxOptions che può essere utilizzata per salvare il progetto in formato XLSX"
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`XlsxOptions`](../) che può essere utilizzata per salvare il progetto in formato XLSX.
