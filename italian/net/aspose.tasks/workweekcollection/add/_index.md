...
description: "Metodo WorkWeekCollection. Aggiunge un'istanza di WorkWeek a questo oggetto collezione."
type: docs
weight: 40
...
Aggiunge un'istanza di WorkWeek a questo oggetto di raccolta.
...
| --- | --- | --- |
| elemento | WorkWeek | L'elemento da aggiungere. |
