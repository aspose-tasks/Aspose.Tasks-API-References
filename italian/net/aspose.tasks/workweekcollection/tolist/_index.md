...
description: "Metodo WorkWeekCollection. Converte l'oggetto WorkWeekCollection in un elenco di oggetti WorkWeek"
type: docs
weight: 60
...
Converte l'oggetto WorkWeekCollection in un elenco di oggetti [`WorkWeek`](../../workweek/).
...
Elenco di oggetti [`WorkWeek`](../../workweek/).
