...
description: "Metodo GroupCollection. Converte una raccolta di gruppi in un elenco di oggetti Group"
type: docs
weight: 90
...
Converte una raccolta di gruppi in un elenco di oggetti [`Group`](../../group/).
...
Elenco generico di oggetti [`Group`](../../group/).
