...
description: "Proprietà ExtendedAttributeDefinition. Ottiene un Guid della tabella di ricerca associata a un campo personalizzato"
type: docs
weight: 180
...
Ottiene il GUID della tabella di ricerca associata a un campo personalizzato.
...
Per creare un campo personalizzato con ricerca, utilizza uno dei metodi factory: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) o [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
