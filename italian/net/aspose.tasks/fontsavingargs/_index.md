...
description: "Classe Aspose.Tasks.FontSavingArgs. Questa classe rappresenta un insieme di dati relativi al salvataggio di file di font esterni che avviene durante la conversione in formato HTML."
type: docs
weight: 680
...
Questa classe rappresenta un insieme di dati relativi al salvataggio di file di font esterni che avviene durante la conversione in formato HTML.
...
| Nome | Descrizione |
| --- | --- |
| [FontSavingArgs](fontsavingargs/)() | Il costruttore predefinito. |
