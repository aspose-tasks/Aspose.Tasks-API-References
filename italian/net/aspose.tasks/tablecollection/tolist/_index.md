...
description: "Metodo TableCollection. Converte una collezione di tabelle in un elenco di oggetti Table"
type: docs
weight: 90
...
Converte una collezione di tabelle in un elenco di oggetti [`Table`](../../table/).
...
Lista generica di oggetti [`Table`](../../table/).
