...
description: "Metodo FilterCollection. Rimuove la prima occorrenza di un oggetto specifico da questa collezione"
type: docs
weight: 80
...
| --- | --- | --- |
| elemento | Filter | l'oggetto specificato da rimuovere. |
