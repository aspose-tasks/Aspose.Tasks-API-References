...
description: "Metodo TaskCollection. Converte l'oggetto TaskCollection in un elenco di oggetti Task."
type: docs
weight: 120
...
Converte l'oggetto TaskCollection in un elenco di oggetti [`Task`](../../task/).
...
restituisce un elenco che contiene le istanze della classe [`Task`](../../task/) di questa collezione.
