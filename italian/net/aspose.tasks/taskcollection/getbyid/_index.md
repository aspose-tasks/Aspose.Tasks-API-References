...
description: "Metodo TaskCollection. Restituisce un'attività con l'Id specificato il cui antenato è l'attività genitore di questa raccolta."
type: docs
weight: 70
...
| --- | --- | --- |
| id | Int32 | Id di TaskEntity |

### Valore di ritorno

restituisce l'istanza della classe [`Task`](../../task/) con l'ID specificato il cui antenato è il task genitore di questa collezione.
