...
description: "Metodo TaskCollection. Restituisce un'attività con l'Uid specificato il cui antenato è l'attività genitore di questa raccolta."
type: docs
weight: 80
...
| --- | --- | --- |
| uid | Int32 | Uid di TaskEntity. |

### Valore di ritorno

restituisce l'istanza della classe [`Task`](../../task/) con l'uid specificato il cui antenato è l'attività genitore di questa raccolta.
