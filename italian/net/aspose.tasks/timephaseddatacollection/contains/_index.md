...
description: "Metodo TimephasedDataCollection. Determina se il TimephasedDataCollection contiene un valore specifico"
type: docs
weight: 70
...
Determina se il [`TimephasedDataCollection`](../) contiene un valore specifico.
...
| --- | --- | --- |
| elemento | TimephasedData | L'oggetto da individuare nella collezione. |

### Valore di ritorno

true se *item* è trovato nella collezione; altrimenti, false.
