...
description: "TimephasedDataCollection metodo. Copia gli elementi di TimephasedDataCollection in un Array a partire da un indice specifico dell'Array"
type: docs
weight: 80
...
Copia gli elementi di [`TimephasedDataCollection`](../) in un Array, a partire da un indice specifico dell'Array.
...
| --- | --- | --- |
| array | TimephasedData[] | L'Array monodimensionale che è la destinazione degli elementi copiati da [`TimephasedDataCollection`](../). L'Array deve avere indicizzazione a base zero. |
| arrayIndex | Int32 | L'indice a base zero in *array* a cui inizia la copia. |
...
| ArgumentException | Il numero di elementi nella sorgente [`TimephasedDataCollection`](../) è maggiore dello spazio disponibile da *arrayIndex* fino alla fine dell'*array* di destinazione. |
