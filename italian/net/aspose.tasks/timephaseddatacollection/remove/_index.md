...
description: "TimephasedDataCollection metodo. Rimuove l'istanza di TimephasedData da questo oggetto collezione."
type: docs
weight: 100
...
Rimuove l'istanza [`TimephasedData`](../../timephaseddata/) da questo oggetto collezione.
...
| --- | --- | --- |
| elemento | TimephasedData | L'elemento da rimuovere. |

### Valore di ritorno

true se *item* è stato rimosso con successo da [`TimephasedDataCollection`](../); altrimenti, false. Questo metodo restituisce anche false se *item* non è trovato in [`TimephasedDataCollection`](../).
