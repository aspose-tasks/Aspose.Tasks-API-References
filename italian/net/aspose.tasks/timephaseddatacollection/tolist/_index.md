...
description: "Metodo TimephasedDataCollection. Converte l'oggetto TimephasedDataCollection in un elenco di oggetti TimephasedData"
type: docs
weight: 120
...
Converte l'oggetto [`TimephasedDataCollection`](../) in un elenco di oggetti [`TimephasedData`](../../timephaseddata/).
...
Elenco di oggetti [`TimephasedData`](../../timephaseddata/).
