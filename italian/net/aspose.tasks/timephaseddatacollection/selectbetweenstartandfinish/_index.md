...
description: "TimephasedDataCollection metodo. Seleziona tutte le fasi temporali tra startTime e finishTime. Ha una complessità Olog n nel caso medio."
type: docs
weight: 110
...
Restituisce una nuova istanza di lista dei dati [`TimephasedDataCollection`](../) ordinati per la proprietà Start.
