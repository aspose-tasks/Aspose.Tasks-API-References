...
description: "Proprietà ExtendedAttribute. Ottiene o imposta un valore per gli attributi di tipo Testo"
type: docs
weight: 80
...
Ottiene o imposta un valore per gli attributi con tipo 'Text'.
...
| --- | --- |
| InvalidOperationException | Generato se la proprietà [`AttributeDefinition`](../attributedefinition/) non è inizializzata o l'attributo corrente non è un attributo di tipo testo. |
