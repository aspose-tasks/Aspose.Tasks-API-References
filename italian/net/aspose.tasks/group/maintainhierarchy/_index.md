...
description: "Proprietà Group. Ottiene o imposta un valore che indica se mostrare tutti i livelli delle attività di riepilogo per le sottoattività all'interno del gruppo"
type: docs
weight: 40
...
Ottiene o imposta un valore che indica se mostrare tutti i livelli dei task di riepilogo per i sotto-task all'interno del gruppo.
