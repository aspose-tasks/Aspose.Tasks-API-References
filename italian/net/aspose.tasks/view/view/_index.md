...
description: "Costruttore View. Inizializza una nuova istanza della classe View"
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`View`](../).
...
| --- | --- | --- |
| viewScreen | ViewScreen | Il tipo di schermo per il quale la vista può essere visualizzata. |
