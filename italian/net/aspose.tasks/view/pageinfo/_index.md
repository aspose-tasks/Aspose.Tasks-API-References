...
description: "Proprietà View. Ottiene un'istanza della classe PageInfo. Rappresenta i dati di configurazione della pagina presenti nel formato file mpp"
type: docs
weight: 60
...
Ottiene un'istanza della classe `PageInfo`. Rappresenta i dati di configurazione della pagina presenti nel formato file mpp.
