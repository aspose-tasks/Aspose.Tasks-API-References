...
| Nome | Descrizione |
| --- | --- |
| [View](view#constructor)() | Inizializza una nuova istanza di[`View`](../view) classe. |
| [View](view#constructor_1)(ViewScreen) | Inizializza una nuova istanza di[`View`](../view) classe. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo) { get; } | Ottiene un'istanza di[`PageInfo`](./pageinfo)classe. Rappresenta i dati di configurazione della pagina che sono presenti nel formato file MPP. |
