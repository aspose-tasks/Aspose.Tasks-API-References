...
description: "Proprietà View. Ottiene il tipo di schermo per la vista singola. Solo lettura ViewScreen"
type: docs
weight: 80
...
Ottiene il tipo di schermo per la vista singola. Solo lettura [`ViewScreen`](../../viewscreen/).
