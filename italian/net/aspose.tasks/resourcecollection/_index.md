...
description: Rappresenta una raccolta diResource./resource oggetti.
type: docs
weight: 1510
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.tasks/resourcecollection/add#add)() | Aggiunge una nuova risorsa nell'ultima posizione di una raccolta di risorse del progetto. |
| [Add](../../aspose.tasks/resourcecollection/add#add_1)(string) | Aggiunge una nuova risorsa nell'ultima posizione di una raccolta di risorse del progetto. |
...
| [Clear](../../aspose.tasks/resourcecollection/clear)() | La cancellazione diretta non è supportata, questo metodo genera semplicemente NotSupportedException. |
