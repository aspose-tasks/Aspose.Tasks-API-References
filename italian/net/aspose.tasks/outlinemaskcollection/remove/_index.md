...
description: "Metodo OutlineMaskCollection. Rimuove la prima occorrenza di un oggetto specifico da questa collezione"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | OutlineMask | l'oggetto specificato da rimuovere. |
