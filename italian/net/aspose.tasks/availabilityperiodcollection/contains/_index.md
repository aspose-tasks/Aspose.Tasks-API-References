...
description: "AvailabilityPeriodCollection metodo. Restituisce true se l'elemento specificato è trovato in questa collezione, altrimenti false"
type: docs
weight: 70
...
| --- | --- | --- |
| elemento | AvailabilityPeriod | l'elemento specificato da trovare. |
