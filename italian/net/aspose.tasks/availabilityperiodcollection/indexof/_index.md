...
description: "AvailabilityPeriodCollection metodo. Determina l'indice dell'elemento specificato in questa collezione"
type: docs
weight: 100
...
| --- | --- | --- |
| elemento | AvailabilityPeriod | l'elemento specificato da individuare in questa collezione. |
