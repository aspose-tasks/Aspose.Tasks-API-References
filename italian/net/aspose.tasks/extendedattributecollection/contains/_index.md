...
description: "Metodo ExtendedAttributeCollection. Restituisce true se l'elemento specificato è trovato in questa collezione, altrimenti false"
type: docs
weight: 60
...
| --- | --- | --- |
| elemento | ExtendedAttribute | l'elemento specificato da trovare. |
