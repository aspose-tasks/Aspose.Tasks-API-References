...
description: "Metodo ExtendedAttributeCollection. Determina l'indice dell'elemento specificato in questa collezione"
type: docs
weight: 90
...
| --- | --- | --- |
| elemento | ExtendedAttribute | l'elemento specificato da individuare in questa collezione. |
