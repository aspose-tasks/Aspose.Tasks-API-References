...
description: "Metodo ExtendedAttributeCollection. Inserisce l'elemento specificato all'indice specificato"
type: docs
weight: 100
...
| elemento | ExtendedAttribute | l'elemento specificato da inserire in questa collezione. |
