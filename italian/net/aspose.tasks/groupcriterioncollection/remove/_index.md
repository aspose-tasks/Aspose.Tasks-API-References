...
description: "GroupCriterionCollection metodo. Rimuove la prima occorrenza di un oggetto specifico da questa collezione"
type: docs
weight: 80
url: /it/net/aspose.tasks/groupcriterioncollection/remove/
---
...
| --- | --- | --- |
| elemento | GroupCriterion | l'oggetto specificato da rimuovere. |
