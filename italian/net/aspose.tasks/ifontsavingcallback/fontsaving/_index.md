...
description: "Metodo IFontSavingCallback. Il metodo da chiamare durante il salvataggio dei font"
type: docs
weight: 10
...
| --- | --- | --- |
| args | FontSavingArgs | Gli argomenti per il salvataggio del carattere. |
