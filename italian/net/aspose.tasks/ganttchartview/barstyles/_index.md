...
description: "Proprietà GanttChartView. Ottiene un elenco di stili di barra comuni padre della vista Gantt Chart. GanttBarStyle"
type: docs
weight: 50
...
Ottiene un elenco di stili di barra (comuni) padre della vista Gantt Chart. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
