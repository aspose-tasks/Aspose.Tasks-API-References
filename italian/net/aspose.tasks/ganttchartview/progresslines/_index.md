...
description: "Proprietà GanttChartView. Ottiene o imposta le linee di avanzamento per la vista Gantt Chart. ProgressLines"
type: docs
weight: 120
...
Ottiene o imposta le linee di avanzamento per la vista Gantt Chart. `ProgressLines`.
