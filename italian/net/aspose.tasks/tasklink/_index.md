...
| [LagFormat](../../aspose.tasks/tasklink/lagformat) { get; set; } | Ottiene o imposta il formato per esprimere il formato del ritardo. |
| [LinkLag](../../aspose.tasks/tasklink/linklag) { get; set; } | Ottiene o imposta la quantità di ritardo in decimi di minuto. |
...
| override [GetHashCode](../../aspose.tasks/tasklink/gethashcode)() | Restituisce un valore di codice hash per l'istanza di[`TaskLink`](../tasklink) classe. |
| override [ToString](../../aspose.tasks/tasklink/tostring)() | Restituisce la rappresentazione di stringa di un TaskLink. I dettagli esatti della rappresentazione non sono specificati e sono soggetti a modifiche. |
