...
description: "Proprietà OutlineValue. Ottiene o imposta l'Id di un nodo genitore di un codice outline"
type: docs
weight: 50
...
Ottiene o imposta l'Id di un nodo genitore di un codice outline.
