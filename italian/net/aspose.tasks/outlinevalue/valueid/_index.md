...
description: "Proprietà OutlineValue. Ottiene o imposta l'Id univoco di un valore di codice outline all'interno di un progetto"
type: docs
weight: 90
...
Ottiene o imposta l'Id univoco di un valore di codice outline all'interno di un progetto.
