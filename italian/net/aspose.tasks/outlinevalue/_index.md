...
description: Rappresenta un valore di struttura.
type: docs
weight: 1070
...
Rappresenta un valore di struttura.
...
| Nome | Descrizione |
| --- | --- |
| [Description](../../aspose.tasks/outlinevalue/description) { get; set; } | Ottiene o imposta la descrizione di un valore di struttura. |
| [DurationValue](../../aspose.tasks/outlinevalue/durationvalue) { get; set; } | Ottiene o imposta la durata se Tipo è Durata. |
| [IsCollapsed](../../aspose.tasks/outlinevalue/iscollapsed) { get; set; } | Ottiene o imposta un valore che indica se il valore della struttura è compresso o meno. |
