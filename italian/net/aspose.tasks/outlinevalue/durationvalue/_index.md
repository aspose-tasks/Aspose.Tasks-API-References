...
description: "Proprietà OutlineValue. Ottiene o imposta la durata se Type è Duration"
type: docs
weight: 30
...
Ottiene o imposta la durata se il Tipo è Durata.
...
Preferisci questa proprietà rispetto a [`Value`](../value/), quando devi impostare il valore per OutlineValues con tipo Duration.
