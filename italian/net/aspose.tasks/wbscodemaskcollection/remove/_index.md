...
description: "Metodo WBSCodeMaskCollection. Rimuove la prima occorrenza di un oggetto specifico da questa collezione"
type: docs
weight: 80
...
| --- | --- | --- |
| elemento | WBSCodeMask | l'oggetto specificato da rimuovere. |
