...
description: "WBSCodeMaskCollection metodo. Converte una WBSCodeMaskCollection in un elenco di oggetti WBSCodeMask"
type: docs
weight: 90
...
Converte una WBSCodeMaskCollection in un elenco di oggetti [`WBSCodeMask`](../../wbscodemask/).
...
Elenco generico di oggetti [`WBSCodeMask`](../../wbscodemask/).
