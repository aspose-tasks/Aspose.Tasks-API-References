...
description: "Metodo Baseline. Restituisce un valore che indica se questa istanza è minore di un oggetto specificato"
type: docs
weight: 140
url: /it/net/aspose.tasks/baseline/op_lessthan/
---
...
| --- | --- | --- |
| a | Baseline | Il primo baseline. |
| b | Baseline | Il secondo baseline. |
