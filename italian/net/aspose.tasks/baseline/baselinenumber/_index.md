...
description: "Proprietà Baseline. Ottiene o imposta il numero univoco di un record di dati di baseline"
type: docs
weight: 20
...
Ottiene o imposta il numero univoco di un record di dati di baseline.
