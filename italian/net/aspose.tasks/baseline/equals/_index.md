...
description: "Metodo Baseline. Restituisce un valore che indica se questa istanza è uguale a un oggetto specificato"
type: docs
weight: 80
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| altro | Baseline | l'oggetto specificato con cui confrontare questa istanza. |
