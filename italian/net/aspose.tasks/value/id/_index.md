...
description: "Proprietà Value. Ottiene o imposta l'identificatore univoco di un valore in tutto il progetto"
type: docs
weight: 50
...
Ottiene o imposta l'identificatore univoco di un valore all'interno di un progetto.

È importante non avere gli stessi identificatori per diverse istanze di [`Value`](../).

Il valore minimo di `Id` è `1`.
