...
description: "Proprietà Value. Ottiene o imposta il valore effettivo che viene usato per rappresentare un valore numerico o di costo"
type: docs
weight: 60
...
Ottiene o imposta il valore effettivo utilizzato per rappresentare un valore numerico o di costo.
...
Preferisci questa proprietà rispetto a [`Val`](../val/), quando devi impostare il valore Number o Cost.
