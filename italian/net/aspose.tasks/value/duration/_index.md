...
description: "Proprietà Value. Ottiene o imposta il valore effettivo che viene usato per rappresentare la Duration."
type: docs
weight: 40
...
Preferisci questa proprietà rispetto a [`Val`](../val/), quando devi impostare il valore Duration.
