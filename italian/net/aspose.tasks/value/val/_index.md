...
description: "Proprietà Value. Ottiene o imposta il valore effettivo nella rappresentazione interna. Preferisci usare le proprietà tipizzate fortemente elencate di seguito"
type: docs
weight: 90
...
Ottiene o imposta il valore effettivo nella rappresentazione interna. Si consiglia di utilizzare le proprietà tipizzate fortemente elencate di seguito.
...
Se vuoi impostare il valore Text, preferisci usare la proprietà tipizzata fortemente [`StringValue`](../stringvalue/).

Se vuoi impostare il valore Number o Cost, preferisci usare la proprietà tipizzata fortemente [`NumericValue`](../numericvalue/).

Se vuoi impostare valori Date/Start/Finish, preferisci usare la proprietà tipizzata fortemente [`DateTimeValue`](../datetimevalue/).

Se vuoi impostare il valore Duration, preferisci usare la proprietà tipizzata fortemente [`Duration`](../duration/).

Se il tuo tipo non è elencato, usa la proprietà `Val`.
