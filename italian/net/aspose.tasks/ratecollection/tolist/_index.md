...
description: "Metodo RateCollection. Converte l'oggetto RateCollection in un elenco di oggetti Rate."
type: docs
weight: 80
...
Converte l'oggetto [`RateCollection`](../) in un elenco di oggetti [`Rate`](../../rate/).
...
Converte l'oggetto [`RateCollection`](../) in un elenco di oggetti [`Rate`](../../rate/) filtrati per il tipo [`RateType`](../../ratetype/) specificato.
...
| --- | --- | --- |
| tipo | RateType | Il tipo su cui filtrare. |

### Valore di ritorno

un elenco di oggetti [`Rate`](../../rate/).
