...
description: Rappresenta una raccolta che contieneRate./rate oggetti.
type: docs
weight: 1370
...
| Nome | Descrizione |
| --- | --- |
| [Count](../../aspose.tasks/ratecollection/count) { get; } | Ottiene il numero di elementi contenuti in RateCollection. |
...
| [ToList](../../aspose.tasks/ratecollection/tolist#tolist)() | Converte il[`RateCollection`](../ratecollection) opporsi a un elenco di[`Rate`](../rate) oggetti. |
| [ToList](../../aspose.tasks/ratecollection/tolist#tolist_1)(RateType) | Converte il[`RateCollection`](../ratecollection) opporsi a un elenco di[`Rate`](../rate) oggetti filtrati per specificato[`RateType`](../ratetype) digita. |
