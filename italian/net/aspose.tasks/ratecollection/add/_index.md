...
description: "Metodo RateCollection. Aggiunge una nuova istanza di Rate a questa collezione"
type: docs
weight: 50
...
Aggiunge una nuova istanza di [`Rate`](../../rate/) a questa collezione.
...
| --- | --- | --- |
| ratesFrom | DateTime | La data in cui la nuova tariffa entra in vigore. |

### Valore di ritorno

Aggiunta istanza di [`Rate`](../../rate/).
...
| --- | --- | --- |
| ratesFrom | DateTime | La data in cui la nuova tariffa entra in vigore. |
| tipo | RateType | La tabella delle tariffe in cui aggiungere. |
