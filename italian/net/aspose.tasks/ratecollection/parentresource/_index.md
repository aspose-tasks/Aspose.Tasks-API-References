...
description: "Proprietà RateCollection. Restituisce l'oggetto Resource padre per questa collezione."
type: docs
weight: 40
...
Restituisce l'oggetto [`Resource`](../../resource/) padre per questa collezione.
