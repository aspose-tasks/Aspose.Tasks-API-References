...
description: "Metodo RateCollection. Rimuove l'istanza di Rate da questa collezione"
type: docs
weight: 70
...
Rimuove l'istanza di Rate da questa collezione.
...
| --- | --- | --- |
| elemento | Rate | L'elemento da rimuovere. |

### Valore di ritorno

true se la Rate specificata è stata rimossa con successo; altrimenti, false.
