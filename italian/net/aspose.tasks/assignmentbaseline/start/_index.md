...
description: "AssignmentBaseline property. Ottiene o imposta la data di inizio programmata dell'assegnazione della risorsa quando la baseline è stata salvata. La data di inizio dell'assegnazione della risorsa quando questa baseline è stata salvata"
type: docs
weight: 30
...
Ottiene o imposta la data di inizio programmata dell'assegnazione della risorsa quando la baseline è stata salvata. La data di inizio dell'assegnazione della risorsa quando questa baseline è stata salvata.
