...
description: "Proprietà ProjectDisplayOptions. Ottiene o imposta un valore che indica se mostrare avvisi quando Project identifica un possibile conflitto di pianificazione con un'attività programmata manualmente. Questa opzione è disponibile per la versione Project 2010 e successive"
type: docs
weight: 90
...
Ottiene o imposta un valore che indica se mostrare avvisi quando Project identifica un possibile conflitto di pianificazione con un'attività programmata manualmente. Questa opzione è disponibile per la versione Project 2010 e successive.
