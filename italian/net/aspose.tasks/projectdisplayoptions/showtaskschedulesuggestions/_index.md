...
description: "Proprietà ProjectDisplayOptions. Ottiene o imposta un valore che indica se mostrare suggerimenti quando Project identifica un possibile conflitto di pianificazione con un'attività programmata manualmente. Questa opzione è disponibile per la versione Project 2010 e successive"
type: docs
weight: 80
url: /it/net/aspose.tasks/projectdisplayoptions/showtaskschedulesuggestions/
---
## ProjectDisplayOptions.ShowTaskScheduleSuggestions property

Ottiene o imposta un valore che indica se mostrare suggerimenti quando Project identifica un possibile conflitto di pianificazione con un'attività programmata manualmente. Questa opzione è disponibile per la versione Project 2010 e successive.
