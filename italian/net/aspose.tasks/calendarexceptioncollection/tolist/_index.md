...
description: "Metodo CalendarExceptionCollection. Converte l'oggetto CalendarExceptionCollection in un elenco di oggetti CalendarException"
type: docs
weight: 90
...
Converte l'oggetto CalendarExceptionCollection in un elenco di oggetti [`CalendarException`](../../calendarexception/).
...
Elenco di oggetti [`CalendarException`](../../calendarexception/).
