...
description: "Metodo OutlineValueCollection. Rimuove la prima occorrenza di un oggetto specifico da questa collezione"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | OutlineValue | l'oggetto specificato da rimuovere. |
