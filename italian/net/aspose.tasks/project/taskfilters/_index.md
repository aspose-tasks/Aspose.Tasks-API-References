...
description: "Proprietà di Project. Ottiene tutte le definizioni dei filtri basati su attività. TaskFilters è una collezione di oggetti Filter"
type: docs
weight: 910
...
Ottiene tutte le definizioni dei filtri basati su attività. TaskFilters è una collezione di oggetti [`Filter`](../../filter/).
...
Mostra come leggere i filtri delle attività del progetto.
