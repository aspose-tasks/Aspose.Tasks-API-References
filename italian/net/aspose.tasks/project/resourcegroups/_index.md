...
description: "Proprietà di Project. Ottiene tutte le definizioni di gruppi basate sulle risorse. ResourceGroups è una raccolta di oggetti Group"
type: docs
weight: 770
...
Ottiene tutte le definizioni di gruppi basati sulle risorse. ResourceGroups è una raccolta di oggetti [`Group`](../../group/).
...
Mostra come leggere i gruppi di risorse.
