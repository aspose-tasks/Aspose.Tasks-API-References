...
description: "Metodo TimephasedData. Crea e inizializza una nuova istanza della classe TimephasedData per dati temporizzati basati su unità di un'assegnazione di una risorsa materiale"
type: docs
weight: 30
...
Crea e inizializza una nuova istanza della classe [`TimephasedData`](../) per dati temporizzati basati su unità di un'assegnazione di una risorsa materiale.
...
| inizio | DateTime | Data e ora di inizio. |
...
Un'istanza della classe [`TimephasedData`](../) per dati a intervalli di tempo basati sui costi.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| ArgumentException | Se è stata specificata una quantità negativa di unità. |
