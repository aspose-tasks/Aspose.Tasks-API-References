...
description: "TimephasedData proprietà. Ottiene o imposta il valore per unità di tempo per un periodo di dati a fasi temporali"
type: docs
weight: 100
...
Ottiene o imposta il valore per unità di tempo per un periodo di dati a fasi temporali.
...
| --- | --- |
| [TasksException](../../tasksexception/) | Quando il valore è errato per il [`TimephasedDataType`](../timephaseddatatype/) specificato o ha valore negativo. |
