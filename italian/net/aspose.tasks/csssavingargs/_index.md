---
title: "Classe CssSavingArgs"
second_title: "Riferimento API di Aspose.Tasks per .NET"
description: "Classe Aspose.Tasks.CssSavingArgs. Questa classe rappresenta un insieme di dati relativi al salvataggio di file CSS esterni che avviene durante la conversione in formato HTML"
type: docs
weight: 360
...
Questa classe rappresenta un insieme di dati relativi al salvataggio di file CSS esterni che avviene durante la conversione al formato HTML.
...
| Nome | Descrizione |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Inizializza una nuova istanza della classe `CssSavingArgs`. |
...
Mostra come specificare i parametri di salvataggio CSS.
