...
description: "Proprietà TimelineView. Ottiene o imposta un valore che indica quante linee sono usate per visualizzare le attività in una timeline"
type: docs
weight: 80
url: /it/net/aspose.tasks/timelineview/textlinescount/
---
## TimelineView.TextLinesCount property

Ottiene o imposta un valore che indica quante linee sono usate per visualizzare le attività in una timeline.
