...
description: Rappresenta una vista della sequenza temporale di un progetto.
type: docs
weight: 2250
...
Rappresenta una vista della sequenza temporale di un progetto.
...
| Nome | Descrizione |
| --- | --- |
| [TimelineView](timelineview)() | Inizializza una nuova istanza di[`TimelineView`](../timelineview) classe. |
...
| [DisplayOverlapped](../../aspose.tasks/timelineview/displayoverlapped) { get; set; } | Ottiene o imposta un valore che indica se visualizzare le attività sovrapposte su più righe. |
...
| [ShowPanZoom](../../aspose.tasks/timelineview/showpanzoom) { get; set; } | Ottiene o imposta un valore che indica se mostrare il controllo di panoramica e zoom. |
| [ShowTimescale](../../aspose.tasks/timelineview/showtimescale) { get; set; } | Ottiene o imposta un valore che indica se visualizzare la scala temporale. |
| [ShowToday](../../aspose.tasks/timelineview/showtoday) { get; set; } | Ottiene o imposta un valore che indica se visualizzare una riga che rappresenta oggi. |
| [Table](../../aspose.tasks/view/table) { get; set; } | Ottiene o imposta una tabella della vista singola. |
| [TextLinesCount](../../aspose.tasks/timelineview/textlinescount) { get; set; } | Ottiene o imposta un valore che indica quante righe vengono utilizzate per visualizzare l'attività in una sequenza temporale. |
