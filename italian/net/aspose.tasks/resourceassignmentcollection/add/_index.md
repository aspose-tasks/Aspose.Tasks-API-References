...
description: "Metodo ResourceAssignmentCollection. Aggiunge una nuova assegnazione alla ResourceAssignmentCollection"
type: docs
weight: 50
url: /it/net/aspose.tasks/resourceassignmentcollection/add/
---
...
| --- | --- | --- |
| attività | Attività | Un'attività da assegnare. |
| risorsa | Risorsa | Una risorsa da assegnare. |
...
| --- | --- | --- |
| attività | Attività | Un'attività da assegnare. |
| risorsa | Risorsa | Una risorsa di costo da assegnare. |
| costo | Decimal | Il costo per una nuova assegnazione. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| elemento | ResourceAssignment | L'elemento da rimuovere. |
