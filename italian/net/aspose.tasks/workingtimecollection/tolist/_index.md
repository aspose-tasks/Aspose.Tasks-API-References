...
description: "WorkingTimeCollection metodo. Converte l'oggetto WorkingTimeCollection in un elenco di oggetti WorkingTime"
type: docs
weight: 90
...
Converte l'oggetto WorkingTimeCollection in un elenco di oggetti [`WorkingTime`](../../workingtime/).
...
Elenco di oggetti [`WorkingTime`](../../workingtime/).
