...
description: "Metodo WorkingTimeCollection. Aggiunge una nuova istanza di WorkingTime a questa collezione"
type: docs
weight: 30
...
Aggiunge una nuova istanza di WorkingTime a questa collezione.
...
| --- | --- | --- |
| elemento | WorkingTime | L'elemento da aggiungere. |

### Valore di ritorno

true se l'oggetto WorkingTime è stato aggiunto correttamente; altrimenti, false.
