...
description: "Metodo WeekDayCollection. Aggiunge un'istanza di WeekDay a questo oggetto"
type: docs
weight: 30
...
Aggiunge un'istanza di [`WeekDay`](../../weekday/) a questo oggetto.
...
| --- | --- | --- |
| elemento | WeekDay | L'elemento da aggiungere. |
