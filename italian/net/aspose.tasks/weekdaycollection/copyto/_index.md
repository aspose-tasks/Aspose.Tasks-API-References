...
description: "Metodo WeekDayCollection. Copia il contenuto della collezione in un array all'indice specificato."
type: docs
weight: 60
...
Copia il contenuto della raccolta in un array all'indice specificato.
...
| --- | --- | --- |
| array | WeekDay[] | Array di destinazione di [`WeekDay`](../../weekday/) in cui copiare. |
| arrayIndex | Int32 | Indice di partenza per l'operazione di copia. |
