...
description: Listanza della classe contiene informazioni sul formato del file di progetto e sulla versione di Microsoft Project in cui è stato creato il file.
type: docs
weight: 1200
...
| override [GetHashCode](../../aspose.tasks/projectfileinfo/gethashcode)() | Restituisce un valore di codice hash per l'istanza di[`ProjectFileInfo`](../projectfileinfo) classe. |
