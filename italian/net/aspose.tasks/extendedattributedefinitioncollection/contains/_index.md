...
description: "Metodo ExtendedAttributeDefinitionCollection. Restituisce true se l'elemento specificato è presente in questa raccolta, altrimenti false"
type: docs
weight: 70
...
| --- | --- | --- |
| elemento | ExtendedAttributeDefinition | l'elemento specificato da trovare. |
