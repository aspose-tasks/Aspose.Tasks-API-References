...
description: "Proprietà RecurringTaskInfo. Ottiene o imposta un mese del modello di ricorrenza annuale quando si utilizza il giorno ordinal. Può essere uno dei valori dell'enumerazione Month"
type: docs
weight: 200
...
Ottiene o imposta un mese del modello di ricorrenza annuale quando si utilizza il giorno ordinal. Può essere uno dei valori dell'enumerazione [`Month`](../../month/).
