...
description: "Proprietà RecurringTaskInfo. Ottiene o imposta un numero di ripetizioni per il modello di ricorrenza mensile quando si usa il giorno ordinal"
type: docs
weight: 80
url: /it/net/aspose.tasks/recurringtaskinfo/monthlyordinalrepetitions/
---
## RecurringTaskInfo.MonthlyOrdinalRepetitions property

Ottiene o imposta un numero di ripetizioni per il modello di ricorrenza mensile quando si utilizza il giorno ordinal.
