...
description: "Proprietà RecurringTaskInfo. Ottiene o imposta un modello di ricorrenza dell'attività ricorrente. Può essere uno dei valori dell'enumerazione RecurrencePattern"
type: docs
weight: 120
...
Ottiene o imposta un modello di ricorrenza dell'attività ricorrente. Può essere uno dei valori dell'enumerazione `RecurrencePattern`.
