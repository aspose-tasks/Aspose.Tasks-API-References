...
description: "Proprietà RecurringTaskInfo. Ottiene l'attività padre di questa istanza della classe RecurringTaskInfo"
type: docs
weight: 140
...
Ottiene l'attività padre di questa istanza della classe [`RecurringTaskInfo`](../).
