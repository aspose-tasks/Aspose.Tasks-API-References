...
description: "Proprietà RecurringTaskInfo. Ottiene o imposta un numero ordinal del modello di ricorrenza mensile. Può essere uno dei valori dell'enumerazione OrdinalNumber"
type: docs
weight: 70
...
Ottiene o imposta un numero ordinal del modello di ricorrenza mensile. Può essere uno dei valori dell'enumerazione [`OrdinalNumber`](../../ordinalnumber/).
