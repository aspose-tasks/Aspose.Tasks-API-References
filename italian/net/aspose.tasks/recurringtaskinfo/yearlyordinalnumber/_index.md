...
description: "Proprietà RecurringTaskInfo. Ottiene o imposta un numero ordinal del modello di ricorrenza annuale. Può essere uno dei valori dell'enumerazione OrdinalNumber"
type: docs
weight: 210
...
Ottiene o imposta un numero ordinal del modello di ricorrenza annuale. Può essere uno dei valori dell'enumerazione [`OrdinalNumber`](../../ordinalnumber/).
