...
description: "Campo Asn. La data di fine effettiva di un'assegnazione"
type: docs
weight: 20
url: /it/net/aspose.tasks/asn/actualfinish/
---
## Asn.ActualFinish field

La data di fine effettiva di un'assegnazione.
