...
description: Rappresenta uno schema basato sulla posizione di un giorno della settimana in un mese.
type: docs
weight: 190
...
| Nome | Descrizione |
| --- | --- |
| [ByYearWeekDayRepetition](byyearweekdayrepetition)() | Inizializza una nuova istanza di[`ByYearWeekDayRepetition`](../byyearweekdayrepetition) classe. |
