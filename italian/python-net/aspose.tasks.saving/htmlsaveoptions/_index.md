...
type: docs
weight: 20
url: /it/python-net/aspose.tasks.saving/htmlsaveoptions/
---
...
| Nome | Descrizione |
| :- | :- |
| HtmlSaveOptions() | Inizializza una nuova istanza della classe [HtmlSaveOptions](/tasks/python-net/aspose.tasks.saving/htmlsaveoptions/) . |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Ottiene o imposta un valore che indica se utilizzare un pennello gradiente durante il rendering del layout del progetto. |
...
| css_style_prefix | Ottiene o imposta il prefisso dello stile CSS. |
...
| include_project_name_in_page_header | Ottiene o imposta un valore che indica se includere il nome del progetto nell'intestazione della pagina HTML. |
| include_project_name_in_title | Ottiene o imposta un valore che indica se includere il nome del progetto nel titolo HTML. |
| pages | Ottiene o imposta un elenco di numeri di pagina da salvare durante il rendering del layout del progetto. |
| export_css | Ottiene o imposta il modo in cui il CSS viene esportato. |
| export_images | Ottiene o imposta il modo in cui le immagini vengono esportate. |
| export_fonts | Ottiene o imposta il modo in cui i caratteri vengono esportati. |
| css_saving_callback | Ottiene o imposta il callback che viene chiamato per creare la risorsa in cui memorizzare il CSS. |
| font_saving_callback | Ottiene o imposta il callback che viene chiamato per creare la risorsa in cui memorizzare il carattere. |
| image_saving_callback | Ottiene o imposta il callback che viene chiamato per creare la risorsa in cui memorizzare il carattere. |
| font_face_types | Ottiene o imposta i tipi di carattere. |
| page_saving_callback | Ottiene o imposta una callback definita dall'utente che viene utilizzata per ottenere un flusso di output per ogni pagina renderizzata. |
