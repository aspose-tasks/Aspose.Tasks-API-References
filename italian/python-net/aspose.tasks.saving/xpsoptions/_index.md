...
type: docs
weight: 200
url: /it/python-net/aspose.tasks.saving/xpsoptions/
---
...
| Nome | Descrizione |
| :- | :- |
| XpsOptions() | Inizializza una nuova istanza della classe [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Ottiene o imposta un valore che indica se un metafile deve essere renderizzato come bitmap. |
