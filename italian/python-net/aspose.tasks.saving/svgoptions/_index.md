...
type: docs
weight: 170
url: /it/python-net/aspose.tasks.saving/svgoptions/
---
...
| Nome | Descrizione |
| :- | :- |
| SvgOptions() | Inizializza una nuova istanza della classe [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) che può essere utilizzata per salvare il progetto in formato SVG. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Determina se utilizzare un pennello gradiente durante il rendering del layout del progetto. |
...
| page_saving_callback | Ottiene o imposta una callback di implementazione definita dall'utente che viene utilizzata per ottenere un flusso di output per ogni pagina renderizzata. |
