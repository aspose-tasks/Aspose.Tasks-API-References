...
type: docs
weight: 40
url: /it/python-net/aspose.tasks.saving/imagesaveoptions/
---
...
Il tipo ImageSaveOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ImageSaveOptions(save_format) | Inizializza una nuova istanza della classe [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) che può essere utilizzata per salvare immagini renderizzate nei formati TIFF, PNG, BMP o JPEG. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| save_format |  |
...
| pages | Ottiene o imposta un elenco di numeri di pagina da salvare quando si salva il layout del progetto in file separati. |
| jpeg_quality | Ottiene o imposta la qualità JPEG. L'intervallo di valori consentito è 0..100. |
...
| tiff_compression | Ottiene o imposta il tipo di compressione da applicare quando si salvano le immagini generate nel formato TIFF. |
| pixel_format | Ottiene o imposta il formato dei dati di colore per ogni pixel nell'immagine. |
| horizontal_resolution | Ottiene o imposta la risoluzione orizzontale in dpi. |
| vertical_resolution | Ottiene o imposta la risoluzione verticale in dpi. |
