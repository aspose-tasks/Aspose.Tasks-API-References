...
type: docs
weight: 120
url: /it/python-net/aspose.tasks.saving/printoptions/
---
...
Il tipo PrintOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| PrintOptions() | Inizializza una nuova istanza della classe [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) che può essere utilizzata per impostare diverse opzioni per stampare il progetto. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| save_format |  |
