...
type: docs
weight: 200
url: /it/python-net/aspose.tasks/csssavingargs/
---

## CssSavingArgs class

Questa classe rappresenta un insieme di dati relativi al salvataggio di file CSS esterni che<br/>              avviene durante la conversione al formato HTML.

Il tipo CssSavingArgs espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| CssSavingArgs() | Inizializza una nuova istanza della classe [CssSavingArgs](/tasks/python-net/aspose.tasks/csssavingargs/). |
## Proprietà
| Nome | Descrizione |
| :- | :- |
