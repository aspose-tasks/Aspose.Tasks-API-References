...
description: "Rappresenta una classe base per le ripetizioni in un modello di ricorrenza settimanale."
type: docs
weight: 358
url: /it/java/com.aspose.tasks/weeklyrepetitionbase/
---
...
| [getRepetitionInterval()](#getRepetitionInterval--) | Restituisce un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze. |
| [getValidator(Calendar calendar)](#getValidator-com.aspose.tasks.Calendar-) | \{@inheritDoc\} |
| [setRepetitionInterval(int value)](#setRepetitionInterval-int-) | Imposta un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze. |
...
Restituisce un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze.

**Returns:**
int - un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze.
...
Imposta un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | int | un numero di settimane che rappresenta l'intervallo in settimane tra le occorrenze. |
