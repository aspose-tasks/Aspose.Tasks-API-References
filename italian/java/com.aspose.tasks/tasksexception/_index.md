...
description: "Rappresenta il tipo di eccezione interno standard."
type: docs
weight: 309
url: /it/java/com.aspose.tasks/tasksexception/
---
...
```
public class TasksException extends System.ApplicationException
```
