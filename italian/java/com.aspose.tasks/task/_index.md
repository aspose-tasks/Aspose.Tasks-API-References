...
type: docs
weight: 289
url: /it/java/com.aspose.tasks/task/
---
...
È possibile utilizzare **Task** per pianificare un progetto creando attività e assegnando loro le risorse appropriate. Le attività in un progetto sono organizzate come una struttura ad albero gerarchico radicato, con un'attività radice e sottoalberi di attività figlie.

Per costruire un albero di attività è possibile utilizzare una collezione specializzata [TaskCollection](../../com.aspose.tasks/taskcollection) accedendo alla proprietà `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) ad esempio:
...
Task task1 = project.RootTask.Children.Add(); // viene aggiunta un'attività padre con nome vuoto
