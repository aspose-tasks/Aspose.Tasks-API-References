...
description: "Rappresenta una raccolta di oggetti ExtendedAttributeDefinition."
type: docs
weight: 10
url: /it/cpp/aspose.tasks/extendedattributedefinitioncollection/
---

## ExtendedAttributeDefinitionCollection class

Rappresenta una raccolta di oggetti ExtendedAttributeDefinition.
...
| [get_IsReadOnly](./get_isreadonly/) | Ottiene un valore che indica se questa collezione è di sola lettura. |
| [get_ParentProject](./get_parentproject/) | Ottiene un progetto padre per l'istanza di ExtendedAttributeDefinitionCollection. |
| [GetById](./getbyid/) | Restituisce una definizione di attributo esteso per ID. |
...
| [ToList](./tolist/) | Converte questo oggetto ExtendedAttributeDefinitionCollection in un elenco contenente istanze della classe ExtendedAttributeDefinition. |
