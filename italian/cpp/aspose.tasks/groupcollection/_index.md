...
description: "Contiene un elenco di oggetti Group."
type: docs
weight: 10
url: /it/cpp/aspose.tasks/groupcollection/
---

## GroupCollection class

Contiene un elenco di oggetti Group. Implementa l'interfaccia ICollection< Group >.
...
| [ToList](./tolist/) | Converte una raccolta di gruppi in un elenco di oggetti Group. |
