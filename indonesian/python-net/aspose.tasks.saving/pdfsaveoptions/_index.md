...
type: docs
weight: 90
url: /id/python-net/aspose.tasks.saving/pdfsaveoptions/
---
...
Tipe PdfSaveOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| PdfSaveOptions() | Menginisialisasi instance baru dari kelas [PdfSaveOptions](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) yang dapat digunakan untuk menyimpan dokumen dalam |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
...
| compliance | Mendapatkan atau mengatur tingkat kepatuhan yang diinginkan untuk dokumen PDF yang dihasilkan.<br/>            Default adalah [PDF15](/tasks/python-net/aspose.tasks.saving/pdfcompliance/). |
| encryption_details | Mendapatkan atau mengatur detail enkripsi. Jika tidak diatur, maka tidak ada enkripsi yang akan dilakukan. |
| text_compression | Mendapatkan atau mengatur jenis kompresi yang akan digunakan untuk semua aliran konten kecuali gambar.<br/>            Default adalah [FLATE](/tasks/python-net/aspose.tasks.saving/pdftextcompression/). |
| digital_signature_details | Mendapatkan atau mengatur detail tanda tangan digital. Jika tidak diatur, maka tidak ada penandatanganan yang akan dilakukan. |
| save_to_separate_files | Mendapatkan atau mengatur nilai yang menunjukkan apakah halaman proyek harus disimpan ke file terpisah. |
| page_saving_callback | Mendapatkan atau mengatur callback yang didefinisikan pengguna yang digunakan untuk mendapatkan aliran output untuk setiap halaman yang dirender.<br/>            Berlaku ketika opsi [save_to_separate_files](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) digunakan. |
| pages | Mendapatkan atau mengatur daftar nomor halaman yang akan disimpan saat menyimpan tata letak proyek ke file terpisah. |
