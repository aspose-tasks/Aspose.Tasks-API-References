...
type: docs
weight: 120
url: /id/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Memungkinkan untuk menentukan opsi tambahan saat mencetak proyek.

Jenis PrintOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| PrintOptions() | Memulai sebuah instance baru dari kelas [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) yang dapat digunakan untuk mengatur berbagai opsi mencetak proyek. |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
