...
type: docs
weight: 180
url: /id/python-net/aspose.tasks.saving/xamloptions/
---
...
Tipe XamlOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| XamlOptions() | Menginisialisasi instance baru dari kelas [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) yang dapat digunakan untuk menyimpan proyek dalam format XAML. |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
