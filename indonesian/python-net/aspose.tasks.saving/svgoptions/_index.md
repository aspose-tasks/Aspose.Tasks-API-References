...
type: docs
weight: 170
url: /id/python-net/aspose.tasks.saving/svgoptions/
---
...
Jenis SvgOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| SvgOptions() | Memulai sebuah instance baru dari kelas [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) yang dapat digunakan untuk menyimpan proyek dalam format SVG. |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Menentukan apakah akan menggunakan kuas gradien saat merender tata letak proyek. |
...
| page_saving_callback | Mendapatkan atau mengatur callback implementasi yang didefinisikan pengguna yang digunakan untuk memperoleh aliran output untuk setiap halaman yang dirender. |
