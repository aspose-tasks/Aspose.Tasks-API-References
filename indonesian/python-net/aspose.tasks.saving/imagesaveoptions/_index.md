...
type: docs
weight: 40
url: /id/python-net/aspose.tasks.saving/imagesaveoptions/
---
...
Tipe ImageSaveOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| ImageSaveOptions(save_format) | Menginisialisasi instance baru dari kelas [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) yang dapat digunakan untuk menyimpan gambar yang dirender dalam format TIFF, PNG, BMP, atau JPEG. |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
...
| jpeg_quality | Mendapatkan atau mengatur kualitas JPEG. Rentang nilai yang diizinkan adalah 0..100. |
...
| tiff_compression | Mendapatkan atau mengatur jenis kompresi yang diterapkan saat menyimpan gambar yang dihasilkan ke format TIFF. |
| pixel_format | Mendapatkan atau mengatur format data warna untuk setiap piksel dalam gambar. |
| horizontal_resolution | Mendapatkan atau mengatur resolusi horizontal dalam dpi. |
| vertical_resolution | Mendapatkan atau mengatur resolusi vertikal dalam dpi. |
