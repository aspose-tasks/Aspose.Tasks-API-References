...
type: docs
weight: 200
url: /id/python-net/aspose.tasks.saving/xpsoptions/
---
...
Tipe XpsOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| XpsOptions() | Menginisialisasi instance baru dari kelas [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## Properti
| Nama | Deskripsi |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Mendapatkan atau mengatur nilai yang menunjukkan apakah metafile harus dirender sebagai bitmap. |
