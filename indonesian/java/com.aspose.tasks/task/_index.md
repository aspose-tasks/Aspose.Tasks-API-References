...
description: "Mewakili tugas dalam sebuah proyek."
type: docs
weight: 289
url: /id/java/com.aspose.tasks/task/
---
...
Mewakili tugas dalam sebuah proyek.

--------------------

**Task** mewakili satu potongan kerja atomik.

Anda dapat menggunakan **Task** untuk merencanakan proyek dengan membuat tugas dan menetapkan sumber daya yang sesuai ke dalamnya. Tugas dalam sebuah proyek diatur sebagai struktur pohon hierarki berakar, dengan tugas akar dan subpohon tugas anak.

Untuk membangun pohon tugas, Anda dapat menggunakan koleksi khusus [TaskCollection](../../com.aspose.tasks/taskcollection) dengan mengakses properti `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) misalnya:
...
```
public final void setActive(NullableBool nilai)
```
...
```
public final void setActivityId(String nilai)
```
...
```
public final void setActualCost(BigDecimal nilai)
```
...
```
public final void setActualDuration(Duration nilai)
```
...
```
public final void setActualFinish(Date nilai)
```
...
```
public final void setActualOvertimeCost(BigDecimal nilai)
```
...
```
public final void setActualOvertimeWork(Duration nilai)
```
...
```
public final void setActualOvertimeWorkProtected(Duration nilai)
```
...
```
public final void setActualStart(Date nilai)
```
...
```
public final void setActualWork(Duration nilai)
```
...
```
public final void setActualWorkProtected(Duration nilai)
```
...
```
public final void setBCWP(double nilai)
```
...
```
public final void setBCWS(double nilai)
```
...
```
public final void setBaselines(TaskBaselineCollection nilai)
```
...
```
public final void setBudgetCost(BigDecimal nilai)
```
...
```
public final void setBudgetWork(Duration nilai)
```
...
```
public final void setCV(double nilai)
```
...
```
public final void setCommitmentFinish(Date nilai)
```
...
```
public final void setCommitmentStart(Date nilai)
```
...
```
public final void setCommitmentType(int nilai)
```
...
```
public final void setConstraintDate(Date nilai)
```
...
```
public final void setConstraintType(int nilai)
```
...
```
public final void setContact(String nilai)
```
...
```
public final void setCost(BigDecimal nilai)
```
...
```
public final void setCostVariance(double nilai)
```
