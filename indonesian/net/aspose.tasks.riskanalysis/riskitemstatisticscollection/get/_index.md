...
description: "Metode RiskItemStatisticsCollection. Mengembalikan sebuah instance dari kelas RiskItemStatistics yang terdapat dalam koleksi ini yang terkait dengan objek Task yang ditentukan, null jika item tidak ditemukan."
type: docs
weight: 10
...
Mengembalikan sebuah instance dari kelas [`RiskItemStatistics`](../../riskitemstatistics/) yang terdapat dalam koleksi ini yang terkait dengan objek Task yang ditentukan; null jika item tidak ditemukan.
...
| --- | --- | --- |
| task | Task | instance yang ditentukan dari kelas [`Task`](../../../aspose.tasks/task/). |

### Nilai Kembali

item risiko yang terkait dengan objek task yang ditentukan jika ditemukan; null jika tidak.
