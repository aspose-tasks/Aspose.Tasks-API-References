...
description: "Metode RiskPatternCollection. Menambahkan sebuah instance dari kelas RiskPattern ke dalam koleksi ini."
type: docs
weight: 40
...
Menambahkan sebuah instance dari kelas [`RiskPattern`](../../riskpattern/) ke dalam koleksi ini.
...
| --- | --- | --- |
| item | RiskPattern | sebuah instance dari kelas [`RiskPattern`](../../riskpattern/) untuk ditambahkan ke dalam koleksi ini. |

### Pengecualian

| pengecualian | kondisi |
| --- | --- |
| ArgumentNullException | *item* task bernilai null. |
