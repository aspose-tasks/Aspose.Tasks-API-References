...
description: "Metode RiskPatternCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 60
...
| --- | --- | --- |
| item | RiskPattern | item yang ditentukan untuk dicari. |
