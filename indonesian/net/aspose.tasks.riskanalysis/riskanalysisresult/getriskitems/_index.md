...
description: "Metode RiskAnalysisResult. Mengembalikan instance dari RiskItemStatisticsCollection untuk tipe risiko yang ditentukan."
type: docs
weight: 10
...
Mengembalikan sebuah instance dari [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) untuk tipe risiko yang ditentukan.
...
| --- | --- | --- |
| itemType | RiskItemType | tipe risiko yang ditentukan; dapat menjadi salah satu nilai dari enumerasi [`RiskItemType`](../../riskitemtype/). |

### Nilai Kembali

sebuah instance dari [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) untuk tipe risiko yang ditentukan.
