...
description: "Konstruktor RiskAnalyzer. Menginisialisasi instance baru dari kelas RiskAnalyzer."
type: docs
weight: 10
...
Menginisialisasi instance baru dari kelas [`RiskAnalyzer`](../).
...
| --- | --- | --- |
| settings | RiskAnalysisSettings | instance yang ditentukan dari kelas [`RiskAnalysisSettings`](../../riskanalysissettings/). |
