...
description: "Metode GroupCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 50
...
| --- | --- | --- |
| item | Group | item yang ditentukan untuk dicari. |
