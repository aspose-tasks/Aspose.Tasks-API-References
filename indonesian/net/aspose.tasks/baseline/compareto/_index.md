...
description: "Metode Baseline. Implementasi antarmuka IComparable. Membandingkan instance ini dengan objek Baseline yang ditentukan"
type: docs
weight: 70
...
| --- | --- | --- |
| lain | Baseline | objek Baseline yang ditentukan untuk dibandingkan dengan instance ini. |
