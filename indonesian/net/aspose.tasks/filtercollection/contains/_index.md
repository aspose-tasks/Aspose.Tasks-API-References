...
description: "Metode FilterCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 50
...
| --- | --- | --- |
| item | Filter | item yang ditentukan untuk dicari. |
