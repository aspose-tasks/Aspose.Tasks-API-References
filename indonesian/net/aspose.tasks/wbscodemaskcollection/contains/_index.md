...
description: "Metode WBSCodeMaskCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 50
url: /id/net/aspose.tasks/wbscodemaskcollection/contains/
---
...
| --- | --- | --- |
| item | WBSCodeMask | item yang ditentukan untuk dicari. |
