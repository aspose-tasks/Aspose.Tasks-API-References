...
description: "Properti ExtendedAttribute. Mendapatkan atau mengatur nilai untuk atribut dengan tipe tanggal Date Start Finish"
type: docs
weight: 20
...
Mendapatkan atau mengatur nilai untuk atribut dengan tipe tanggal (Date, Start, Finish).
...
| --- | --- |
| InvalidOperationException | Dilemparkan jika properti [`AttributeDefinition`](../attributedefinition/) tidak diinisialisasi atau atribut saat ini bukan atribut tanggal. |
