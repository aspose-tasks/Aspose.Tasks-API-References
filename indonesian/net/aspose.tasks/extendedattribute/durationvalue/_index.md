...
description: "Properti ExtendedAttribute. Mendapatkan atau mengatur nilai untuk atribut dengan tipe Durasi"
type: docs
weight: 30
...
Mendapatkan atau mengatur nilai untuk atribut dengan tipe 'Duration'.
...
| --- | --- |
| InvalidOperationException | Dilempar jika properti [`AttributeDefinition`](../attributedefinition/) tidak diinisialisasi atau tipe bidang khusus dari properti [`AttributeDefinition`](../attributedefinition/) bukan sebuah instance [`Duration`](../../duration/). |
