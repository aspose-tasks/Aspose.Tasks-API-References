...
description: "OutlineCodeCollection method. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineCode | item yang ditentukan untuk ditemukan dalam koleksi ini. |
