...
description: "Kelas Aspose.Tasks.Value. Mewakili nilai dalam daftar nilai"
type: docs
weight: 2800
...
| Nama | Deskripsi |
| --- | --- |
| [Value](value/)() | Menginisialisasi instance baru dari kelas `Value`. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [DateTimeValue](../../aspose.tasks/value/datetimevalue/) { get; set; } | Mendapatkan atau mengatur nilai aktual jika dapat direpresentasikan sebagai DateTime. Nilai default adalah MinValue. |
| [Description](../../aspose.tasks/value/description/) { get; set; } | Mendapatkan atau mengatur deskripsi sebuah nilai. |
| [Duration](../../aspose.tasks/value/duration/) { get; set; } | Mendapatkan atau mengatur nilai aktual yang digunakan untuk merepresentasikan Durasi. |
| [Id](../../aspose.tasks/value/id/) { get; set; } | Mendapatkan atau mengatur pengidentifikasi unik sebuah nilai di seluruh proyek. |
| [NumericValue](../../aspose.tasks/value/numericvalue/) { get; set; } | Mendapatkan atau mengatur nilai aktual yang digunakan untuk merepresentasikan nilai angka atau biaya. |
| [Phonetic](../../aspose.tasks/value/phonetic/) { get; set; } | Mendapatkan atau mengatur informasi fonetik tentang nama bidang khusus. |
| [StringValue](../../aspose.tasks/value/stringvalue/) { get; set; } | Mendapatkan atau mengatur nilai aktual yang digunakan untuk merepresentasikan string Teks. |
| [Val](../../aspose.tasks/value/val/) { get; set; } | Mendapatkan atau mengatur nilai aktual dalam representasi internal. Lebih disarankan menggunakan properti bertipe kuat yang tercantum di bawah. |
| [ValueGuid](../../aspose.tasks/value/valueguid/) { get; } | Mendapatkan GUID yang mengidentifikasi nilai ini di antara nilai lain dalam seluruh proyek. |

## Contoh

Menunjukkan cara membaca pekerjaan dengan nilai lookup.

```csharp
var project = new Project(DataDir + "ReadTaskExtendedAttributes.mpp");

// Buat Definisi Atribut Ekstended tipe Teks
...
// Buat Definisi Atribut Ekstended tipe Durasi
...
// Buat Definisi Atribut Ekstended tipe Tanggal
...
// Buat Definisi Atribut Ekstended tipe Angka
