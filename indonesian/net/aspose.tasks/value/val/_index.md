...
description: "Properti Value. Mendapatkan atau mengatur nilai aktual dalam representasi internal. Lebih baik gunakan properti bertipe kuat yang tercantum di bawah ini."
type: docs
weight: 90
...
Mendapatkan atau mengatur nilai aktual dalam representasi internal. Lebih disarankan menggunakan properti bertipe kuat yang tercantum di bawah.
...
Jika Anda ingin mengatur nilai Text, lebih baik gunakan properti bertipe kuat [`StringValue`](../stringvalue/).

Jika Anda ingin mengatur nilai Number atau Cost, lebih baik gunakan properti bertipe kuat [`NumericValue`](../numericvalue/).

Jika Anda ingin mengatur nilai Date/Start/Finish, lebih baik gunakan properti bertipe kuat [`DateTimeValue`](../datetimevalue/).

Jika Anda ingin mengatur nilai Duration, lebih baik gunakan properti bertipe kuat [`Duration`](../duration/).

Jika tipe Anda tidak tercantum, gunakan properti `Val`.
