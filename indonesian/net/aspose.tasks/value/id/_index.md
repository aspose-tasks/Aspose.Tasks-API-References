...
description: "Properti Value. Mendapatkan atau mengatur pengidentifikasi unik dari sebuah nilai di seluruh proyek"
type: docs
weight: 50
...
Mendapatkan atau mengatur pengidentifikasi unik sebuah nilai di seluruh proyek.

Penting untuk tidak memiliki pengidentifikasi yang sama untuk instance [`Value`](../) yang berbeda.

Nilai minimal `Id` adalah `1`.
