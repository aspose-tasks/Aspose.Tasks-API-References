...
description: "Properti Value. Mendapatkan atau mengatur nilai aktual yang digunakan untuk merepresentasikan string Teks"
type: docs
weight: 80
...
Mendapatkan atau mengatur nilai aktual yang digunakan untuk merepresentasikan string Teks.
...
Gunakan properti ini daripada [`Val`](../val/), ketika Anda perlu mengatur nilai Teks.
