...
description: "OutlineCodeDefinition property. Mendapatkan objek OutlineMaskCollection. Tabel entri yang mendefinisikan mask kode outline. Instansi OutlineMaskCollection hanya-baca"
type: docs
weight: 100
...
Mendapatkan objek OutlineMaskCollection. Tabel entri yang mendefinisikan mask kode outline. Instansi Read-only [`OutlineMaskCollection`](../../outlinemaskcollection/).
