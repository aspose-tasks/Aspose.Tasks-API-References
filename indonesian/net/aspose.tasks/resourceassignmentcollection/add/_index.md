...
description: "Metode ResourceAssignmentCollection. Menambahkan penugasan baru ke ResourceAssignmentCollection"
type: docs
weight: 50
...
| --- | --- | --- |
| tugas | Tugas | Sebuah tugas yang akan ditugaskan. |
| sumber daya | Sumber Daya | Sebuah sumber daya yang akan ditugaskan. |
| unit | Double | Jumlah unit untuk penugasan baru. |

### Nilai Kembali

Penugasan ditambahkan.
...
| --- | --- | --- |
| tugas | Tugas | Sebuah tugas yang akan ditugaskan. |
| sumber daya | Sumber Daya | Sebuah sumber daya biaya yang akan ditugaskan. |
| biaya | Decimal | Biaya untuk penugasan baru. |
