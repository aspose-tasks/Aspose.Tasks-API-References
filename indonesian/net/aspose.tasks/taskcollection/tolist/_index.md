...
description: "Metode TaskCollection. Mengonversi objek TaskCollection menjadi daftar objek Task"
type: docs
weight: 120
...
Mengonversi objek TaskCollection menjadi daftar objek [`Task`](../../task/).
...
mengembalikan daftar yang berisi instance kelas [`Task`](../../task/) dari koleksi ini.
