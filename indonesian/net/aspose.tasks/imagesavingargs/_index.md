---
title: "Kelas ImageSavingArgs"
second_title: "Referensi API Aspose.Tasks untuk .NET"
description: "Kelas Aspose.Tasks.ImageSavingArgs. Kelas ini mewakili sekumpulan data yang terkait dengan penyimpanan file gambar eksternal yang terjadi selama konversi ke format HTML."
type: docs
weight: 900
...
Kelas ini mewakili sekumpulan data yang terkait dengan penyimpanan file gambar eksternal yang terjadi selama konversi ke format HTML.
...
| Nama | Deskripsi |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | Menginisialisasi sebuah instance baru dari kelas `ImageSavingArgs`. |
...
| [ImageType](../../aspose.tasks/imagesavingargs/imagetype/) { get; } | Mendapatkan tipe gambar HTML. |
...
Menampilkan cara bekerja dengan argumen penyimpanan gambar.
