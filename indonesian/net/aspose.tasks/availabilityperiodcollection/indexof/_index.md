...
description: "AvailabilityPeriodCollection metode. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 100
...
| --- | --- | --- |
| item | AvailabilityPeriod | item yang ditentukan untuk ditemukan dalam koleksi ini. |
