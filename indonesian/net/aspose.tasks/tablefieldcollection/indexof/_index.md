...
description: "Metode TableFieldCollection. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 90
...
| --- | --- | --- |
| item | TableField | item yang ditentukan untuk ditemukan dalam koleksi ini. |
