...
description: "Metode OutlineValueCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 60
...
| --- | --- | --- |
| item | OutlineValue | item yang ditentukan untuk dicari. |
