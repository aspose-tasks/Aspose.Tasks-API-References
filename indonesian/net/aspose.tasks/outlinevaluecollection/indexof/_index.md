...
description: "Metode OutlineValueCollection. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineValue | item yang ditentukan untuk ditemukan dalam koleksi ini. |
