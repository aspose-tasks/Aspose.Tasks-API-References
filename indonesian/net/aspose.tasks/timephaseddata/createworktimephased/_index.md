...
description: "Metode TimephasedData. Membuat dan menginisialisasi instance baru dari kelas TimephasedData untuk data berwaktu fase berbasis kerja"
type: docs
weight: 40
...
Membuat dan menginisialisasi instance baru dari kelas [`TimephasedData`](../) untuk data berwaktu fase berbasis kerja.
...
Instance dari kelas [`TimephasedData`](../) untuk data berwaktu fase berbasis kerja.

### Pengecualian

| pengecualian | kondisi |
| --- | --- |
| ArgumentException | Jika nilai kerja negatif telah ditentukan. |
