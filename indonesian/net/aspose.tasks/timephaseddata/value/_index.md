...
description: "TimephasedData property. Mendapatkan atau mengatur nilai per satuan waktu untuk periode data berfase waktu"
type: docs
weight: 100
...
Mendapatkan atau mengatur nilai per satuan waktu untuk periode data berfase waktu.
...
| --- | --- |
| [TasksException](../../tasksexception/) | Ketika nilai tidak benar untuk [`TimephasedDataType`](../timephaseddatatype/) yang ditentukan atau memiliki nilai negatif. |
