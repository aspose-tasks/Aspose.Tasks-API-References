...
description: "TimephasedDataCollection metode. Menghapus instance TimephasedData dari objek koleksi ini"
type: docs
weight: 100
...
Menghapus instance [`TimephasedData`](../../timephaseddata/) dari objek koleksi ini.
...
true jika *item* berhasil dihapus dari [`TimephasedDataCollection`](../); jika tidak, false. Metode ini juga mengembalikan false jika *item* tidak ditemukan dalam [`TimephasedDataCollection`](../).
