...
description: "TimephasedDataCollection metode. Memilih semua fase waktu antara startTime dan finishTime. Memiliki kompleksitas Olog n dalam kasus rata-rata"
type: docs
weight: 110
...
| finishTime | DateTime | Akhir interval. |

### Nilai Kembali

Mengembalikan instance daftar baru dari data [`TimephasedDataCollection`](../) yang diurutkan berdasarkan properti Start.
