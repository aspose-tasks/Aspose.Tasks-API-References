...
description: "DayTypeCollection method. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 90
...
| --- | --- | --- |
| item | DayType | item yang ditentukan untuk ditemukan dalam koleksi ini. |
