...
description: "DayTypeCollection method. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 60
...
| --- | --- | --- |
| item | DayType | item yang ditentukan untuk dicari. |
