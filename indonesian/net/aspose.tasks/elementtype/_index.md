...
description: "Enum Aspose.Tasks.ElementType. Menentukan tipe sebuah elemen"
type: docs
weight: 490
...
| Task | `1` | Menunjukkan tipe elemen Task. |
| Resource | `2` | Menunjukkan tipe elemen Resource. |
| Calendar | `3` | Menunjukkan tipe elemen Calendar. |
