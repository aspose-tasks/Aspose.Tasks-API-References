...
description: "Metode View. Mengembalikan nilai yang menunjukkan apakah instance ini lebih besar dari atau sama dengan objek yang ditentukan"
type: docs
weight: 190
...
| --- | --- | --- |
| a | View | Tampilan pertama. |
| b | View | Tampilan kedua. |
