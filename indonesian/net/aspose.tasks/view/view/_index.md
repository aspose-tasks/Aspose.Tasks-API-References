...
description: "Konstruktor View. Menginisialisasi sebuah instance baru dari kelas View."
type: docs
weight: 10
...
Menginisialisasi sebuah instance baru dari kelas [`View`](../).
...
| --- | --- | --- |
| viewScreen | ViewScreen | Tipe layar untuk tampilan yang dapat ditampilkan. |
