...
description: "Properti View. Mengambil sebuah instance dari kelas PageInfo. Mewakili data pengaturan halaman yang terdapat dalam format file mpp."
type: docs
weight: 60
...
Mengambil sebuah instance dari kelas `PageInfo`. Mewakili data pengaturan halaman yang terdapat dalam format file mpp.
