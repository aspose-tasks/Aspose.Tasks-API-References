...
description: "Bidang Tsk. Menunjukkan apakah tugas memiliki sumber daya yang ditugaskan yang memiliki pekerjaan lebih pada tugas yang ditugaskan daripada yang dapat diselesaikan dalam kapasitas kerja normal"
type: docs
weight: 470
...
Menunjukkan apakah tugas memiliki sumber daya yang ditugaskan yang memiliki pekerjaan lebih pada tugas yang ditugaskan daripada yang dapat diselesaikan dalam kapasitas kerja normal.
...
Menampilkan cara membaca Tsk.IsOverallocated, Tsk.HasOverallocatedResource,

```csharp
// Properti Rsc.Overallocated dan Asn.Overallocated.
