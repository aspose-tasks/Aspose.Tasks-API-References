...
description: "Metode RateCollection. Menambahkan instance Rate baru ke koleksi ini"
type: docs
weight: 50
...
Menambahkan instance [`Rate`](../../rate/) baru ke koleksi ini.
...
| --- | --- | --- |
| ratesFrom | DateTime | Tanggal mulai berlakunya tarif baru. |

### Nilai Kembali

Instance [`Rate`](../../rate/) ditambahkan.
...
| --- | --- | --- |
| ratesFrom | DateTime | Tanggal mulai berlakunya tarif baru. |
| tipe | RateType | Tabel tarif untuk ditambahkan. |
