...
description: "Metode RateCollection. Mengonversi objek RateCollection menjadi daftar objek Rate"
type: docs
weight: 80
...
Mengonversi objek [`RateCollection`](../) menjadi daftar objek [`Rate`](../../rate/).
...
Mengonversi objek [`RateCollection`](../) menjadi daftar objek [`Rate`](../../rate/) yang difilter berdasarkan tipe [`RateType`](../../ratetype/) yang ditentukan.
...
| --- | --- | --- |
| tipe | RateType | Tipe yang akan difilter. |
