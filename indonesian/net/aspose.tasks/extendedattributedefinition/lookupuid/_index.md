...
description: "Properti ExtendedAttributeDefinition. Mendapatkan Guid dari tabel lookup yang terkait dengan bidang khusus"
type: docs
weight: 180
...
Mendapatkan Guid dari tabel lookup yang terkait dengan bidang khusus.
...
Untuk membuat bidang khusus dengan lookup, gunakan salah satu metode pabrik: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) atau [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
