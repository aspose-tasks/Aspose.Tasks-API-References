...
description: "Properti ExtendedAttributeDefinition. Mendapatkan atau mengatur yang sesuai dengan id proyek dari bidang khusus. Gunakan representasi string dari konstanta kelas ExtendedAttributeTask untuk menentukan properti FieldId"
type: docs
weight: 130
...
Mendapatkan atau mengatur yang sesuai dengan id proyek dari bidang khusus. Gunakan representasi string dari konstanta kelas [`ExtendedAttributeTask`](../../extendedattributetask/) untuk menentukan properti `FieldId`.
...
Cara yang disarankan untuk mengatur properti `FieldId` adalah dengan membuat [`ExtendedAttributeDefinition`](../) menggunakan salah satu metode pabrik khusus seperti [`CreateTaskDefinition`](../createtaskdefinition/) atau [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/).
...
Menampilkan cara membaca informasi umum definisi atribut ekstensi.

```csharp
var project = new Project(DataDir + "MultipleOutlineValues2016.mpp");

// baca informasi definisi atribut ekstensi
