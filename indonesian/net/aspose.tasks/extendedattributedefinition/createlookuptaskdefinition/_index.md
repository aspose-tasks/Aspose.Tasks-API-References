...
description: "Metode ExtendedAttributeDefinition. Metode pabrik yang membuat definisi atribut ekstended dengan lookup. Memiliki CalculationType yang sama dengan Lookup dan hanya dapat digunakan dalam Tasks. Anda harus menentukan fieldId dan alias saat memanggil metode ini. Tipe bidang diambil dari field id."
type: docs
weight: 20
...
Metode pabrik yang membuat definisi atribut ekstended dengan lookup. Memiliki [`CalculationType`](../calculationtype/) yang sama dengan Lookup dan hanya dapat digunakan dalam Tasks. Anda harus menentukan *fieldId* dan *alias* saat memanggil metode ini. Tipe bidang diambil dari field id.
...
Gunakan contoh ini untuk membuat definisi bidang khusus untuk tugas dengan lookup, lalu mengisinya dengan nilai teks:
...
Metode pabrik yang membuat definisi atribut ekstended dengan lookup. Memiliki [`CalculationType`](../calculationtype/) yang sama dengan Lookup dan hanya dapat digunakan dalam Tasks. Anda harus menentukan *customFieldType*, *fieldId*, dan *alias* saat memanggil metode ini.
