...
description: "Metode ExtendedAttributeCollection. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 90
...
| --- | --- | --- |
| item | ExtendedAttribute | item yang ditentukan untuk ditemukan dalam koleksi ini. |
