...
description: "Metode TableCollection. Mengonversi koleksi tabel menjadi daftar objek Table"
type: docs
weight: 90
...
Mengonversi koleksi tabel menjadi daftar objek [`Table`](../../table/).
...
Daftar generik objek [`Table`](../../table/).
