...
description: "Metode TableCollection. Mengembalikan true jika item yang ditentukan ditemukan dalam koleksi ini, jika tidak false"
type: docs
weight: 50
...
| --- | --- | --- |
| item | Table | item yang ditentukan untuk dicari. |
