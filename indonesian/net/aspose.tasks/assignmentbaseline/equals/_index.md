...
description: "AssignmentBaseline metode. Mengembalikan nilai yang menunjukkan apakah instance ini sama dengan objek yang ditentukan"
type: docs
weight: 60
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| lain | AssignmentBaseline | objek AssignmentBaseline yang ditentukan untuk dibandingkan dengan instance ini. |
