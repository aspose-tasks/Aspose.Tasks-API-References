...
description: "Metode ExtendedAttributeDefinitionCollection. Menentukan indeks dari item yang ditentukan dalam koleksi ini"
type: docs
weight: 110
...
Menentukan indeks dari item yang ditentukan dalam koleksi ini.
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | item yang ditentukan untuk ditemukan dalam koleksi ini. |

### Nilai Kembali

indeks dari item yang ditentukan jika ditemukan; jika tidak, -1.
