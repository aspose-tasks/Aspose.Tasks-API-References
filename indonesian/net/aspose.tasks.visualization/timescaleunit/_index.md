...
description: "Enum Aspose.Tasks.Visualization.TimescaleUnit. Menentukan satuan waktu untuk setiap tingkat skala waktu dalam diagram Gantt atau tampilan berfase waktu lainnya."
type: docs
weight: 3460
...
Menentukan satuan waktu untuk setiap tingkat skala waktu dalam Gantt chart atau tampilan berfase waktu lainnya.
...
| --- | --- | --- |
| None | `-1` | Menunjukkan None. Tingkat skala waktu disembunyikan. |
| Minutes | `0` | Menunjukkan satuan skala waktu Menit. |
| Hours | `1` | Menunjukkan satuan skala waktu Jam. |
| Days | `2` | Menunjukkan satuan skala waktu Hari. |
| Weeks | `3` | Menunjukkan satuan skala waktu Minggu. |
