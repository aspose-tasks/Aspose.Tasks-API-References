...
description: "Properti GanttBarStyle. Mendapatkan atau mengatur data yang akan ditampilkan di dalam bar. Field"
type: docs
weight: 90
...
Mendapatkan atau mengatur data yang akan ditampilkan di dalam bar. [`Field`](../../../aspose.tasks/field/).
