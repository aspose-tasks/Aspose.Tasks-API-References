...
description: "Metode ITextStyleModificationCallback. Metode yang akan dipanggil sebelum merender sel tabel untuk baris tugas dalam tampilan berikut: Gantt Chart, Task Sheet, Task Usage."
type: docs
weight: 10
...
| --- | --- | --- |
| args | TaskTextStyleEventArgs | Objek [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/). |
