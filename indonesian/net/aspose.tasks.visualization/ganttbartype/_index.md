...
description: "Aspose.Tasks.Visualization.GanttBarType enum. Menentukan jenis bar"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Menunjukkan tipe bar Gantt Dashed. |
| Framed | `1` | Menunjukkan tipe bar Gantt Framed. |
| Solid | `0` | Menunjukkan tipe bar Gantt Solid. |
