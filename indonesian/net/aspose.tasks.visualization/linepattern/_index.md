...
description: "Aspose.Tasks.Visualization.LinePattern enum. Pola garis"
type: docs
weight: 3190
...
| --- | --- | --- |
| None | `0` | Menunjukkan bahwa garis tidak akan ditampilkan. |
| Solid | `1` | Menunjukkan pola garis Solid. |
| CloseDot | `3` | Menunjukkan pola garis Titik rapat. |
| Dotted | `4` | Menunjukkan pola garis Dotted. |
| Dashed | `2` | Menunjukkan pola garis Dashed. |
