...
| Nama | Keterangan |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | Menginisialisasi instance baru dari`PrimaveraSaveOptions` kelas. |

## Properti

| Nama | Keterangan |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | Mendapat atau menyetel peningkatan yang digunakan dalam penomoran ulang ID aktivitas. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | Mendapatkan atau menyetel awalan yang digunakan dalam penomoran ulang ID aktivitas. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | Mendapat atau menyetel akhiran yang digunakan dalam penomoran ulang ID aktivitas. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah perlu menomori ulang ID aktivitas. |
