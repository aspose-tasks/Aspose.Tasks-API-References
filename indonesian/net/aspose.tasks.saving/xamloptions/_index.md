...
description: /// Memungkinkan untuk menentukan opsi tambahan saat merender halaman proyek ke XAML.
type: docs
weight: 1970
...
| Nama | Keterangan |
| --- | --- |
| [XamlOptions](xamloptions/)() | Menginisialisasi instance baru dari`XamlOptions` kelas yang dapat digunakan untuk menyimpan proyek dalam format XAML. |
