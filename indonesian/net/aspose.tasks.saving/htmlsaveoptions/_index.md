...
type: docs
weight: 1750
url: /id/net/aspose.tasks.saving/htmlsaveoptions/
---
...
| Nama | Keterangan |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | Menginisialisasi instance baru dari`HtmlSaveOptions` kelas. |
...
| [CssSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/csssavingcallback/) { get; set; } | Mendapat atau menyetel callback yang dipanggil untuk membuat sumber daya untuk menyimpan CSS. |
| [CssStylePrefix](../../aspose.tasks.saving/htmlsaveoptions/cssstyleprefix/) { get; set; } | Mendapat atau menyetel awalan gaya CSS. |
...
| [DefaultFontName](../../aspose.tasks.saving/htmlsaveoptions/defaultfontname/) { get; set; } | Mendapat atau menyetel font default untuk rendering. |
...
| [ExportCss](../../aspose.tasks.saving/htmlsaveoptions/exportcss/) { get; set; } | Mendapat atau mengatur cara CSS diekspor. |
| [ExportFonts](../../aspose.tasks.saving/htmlsaveoptions/exportfonts/) { get; set; } | Mendapatkan atau menyetel cara font diekspor. |
| [ExportImages](../../aspose.tasks.saving/htmlsaveoptions/exportimages/) { get; set; } | Mendapat atau mengatur cara gambar diekspor. |
...
| [FontFaceTypes](../../aspose.tasks.saving/htmlsaveoptions/fontfacetypes/) { get; set; } | Mendapat atau menyetel jenis tampilan font. |
| [FontResolveCallback](../../aspose.tasks.saving/htmlsaveoptions/fontresolvecallback/) { get; set; } | Mendapat atau menyetel panggilan balik yang dapat digunakan untuk menyesuaikan font yang diselesaikan. |
| [FontSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/fontsavingcallback/) { get; set; } | Mendapat atau menyetel panggilan balik yang dipanggil untuk membuat sumber daya untuk menyimpan font. |
...
| [ImageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/imagesavingcallback/) { get; set; } | Mendapat atau menyetel panggilan balik yang dipanggil untuk membuat sumber daya untuk menyimpan font. |
| [IncludeProjectNameInPageHeader](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameinpageheader/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah akan menyertakan nama proyek di header halaman HTML. |
| [IncludeProjectNameInTitle](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameintitle/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah akan menyertakan nama proyek dalam judul HTML. |
...
| [Pages](../../aspose.tasks.saving/htmlsaveoptions/pages/) { get; set; } | Mendapat atau menyetel daftar nomor halaman untuk disimpan saat merender tata letak proyek. Semua halaman proyek akan disimpan jika daftar ini kosong. |
| [PageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/pagesavingcallback/) { get; set; } | Mendapat atau menetapkan panggilan balik yang ditentukan pengguna yang digunakan untuk mendapatkan aliran keluaran untuk setiap halaman yang dirender. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/htmlsaveoptions/reducefootergap/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah jarak antara tugas terakhir dan footer harus dikurangi. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/htmlsaveoptions/usegradientbrush/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah akan menggunakan kuas gradien saat merender tata letak proyek. Saat ini penggunaan kuas gradien tidak didukung saat merender ke HTML. |
| [UseProjectDefaultFont](../../aspose.tasks.saving/htmlsaveoptions/useprojectdefaultfont/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah font default harus digunakan untuk rendering. |
