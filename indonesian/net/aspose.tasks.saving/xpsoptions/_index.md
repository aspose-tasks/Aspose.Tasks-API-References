...
description: Memungkinkan untuk menentukan opsi tambahan saat merender halaman proyek ke XPS.
type: docs
weight: 1990
...
| Nama | Keterangan |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Menginisialisasi instance baru dari`XpsOptions` kelas. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah metafile harus dirender sebagai bitmap. |
