...
description: Memungkinkan untuk menentukan opsi tambahan saat merender halaman proyek ke SVG.
type: docs
weight: 1950
...
| Nama | Keterangan |
| --- | --- |
| [SvgOptions](svgoptions/)() | Menginisialisasi instance baru dari`SvgOptions` kelas yang dapat digunakan untuk menyimpan proyek dalam format SVG. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Mendapat atau menyetel callback implementasi yang ditentukan pengguna yang digunakan untuk mendapatkan aliran output untuk setiap halaman yang dirender. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Menentukan apakah menggunakan kuas gradien saat merender tata letak proyek. Saat ini penggunaan kuas gradien tidak didukung untuk merender ke SVG. |
