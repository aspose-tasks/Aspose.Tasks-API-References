---
title: "Kelas SvgOptions"
second_title: "Referensi API Aspose.Tasks untuk .NET"
description: "Kelas Aspose.Tasks.Saving.SvgOptions. Memungkinkan untuk menentukan opsi tambahan saat merender halaman proyek ke SVG."
type: docs
weight: 2230
url: /id/net/aspose.tasks.saving/svgoptions/
---
## SvgOptions class

Memungkinkan untuk menentukan opsi tambahan saat merender halaman proyek ke SVG.
...
| Nama | Deskripsi |
| --- | --- |
| [SvgOptions](svgoptions/)() | Menginisialisasi instance baru dari kelas `SvgOptions` yang dapat digunakan untuk menyimpan proyek dalam format SVG. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Mendapatkan atau mengatur callback implementasi yang didefinisikan pengguna yang digunakan untuk memperoleh aliran output untuk setiap halaman yang dirender. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Menentukan apakah akan menggunakan kuas gradien saat merender tata letak proyek. Saat ini penggunaan kuas gradien tidak didukung untuk merender ke SVG. |
