...
description: "Properti MPPSaveOptions. Mendapatkan atau mengatur nilai yang menunjukkan apakah data grup harus ditulis saat menyimpan proyek ke format MPP. Data grup mencakup koleksi Project.TaskGroups dan Project.ResourceGroups."
type: docs
weight: 60
url: /id/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Mendapatkan atau mengatur nilai yang menunjukkan apakah akan menulis data grup saat menyimpan proyek ke format MPP. Data grup mencakup koleksi Project.TaskGroups dan Project.ResourceGroups.
