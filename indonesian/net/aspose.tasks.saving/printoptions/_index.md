...
description: Memungkinkan untuk menentukan opsi tambahan saat mencetak proyek.
type: docs
weight: 1900
...
| Nama | Keterangan |
| --- | --- |
| [PrintOptions](printoptions/)() | Menginisialisasi instance baru dari`PrintOptions` kelas yang dapat digunakan untuk mengatur opsi berbeda untuk mencetak proyek. |
