...
type: docs
weight: 40
url: /tr/python-net/aspose.tasks.saving/imagesaveoptions/
---

## ImageSaveOptions class

Proje sayfalarını görüntülere render ederken ek seçenekler belirtmeye izin verir.

ImageSaveOptions türü aşağıdaki üyeleri içerir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| ImageSaveOptions(save_format) | TIFF, PNG, BMP veya JPEG formatlarında oluşturulmuş görüntüleri kaydetmek için kullanılabilen [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) sınıfının yeni bir örneğini başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
...
| jpeg_quality | JPEG kalitesini alır veya ayarlar. İzin verilen değer aralığı 0..100'tür. |
...
| tiff_compression | Oluşturulan görüntüleri TIFF formatında kaydederken uygulanacak sıkıştırma türünü alır veya ayarlar. |
| pixel_format | Görüntüdeki her piksel için renk verisinin biçimini alır veya ayarlar. |
| horizontal_resolution | Yatay çözünürlüğü dpi cinsinden alır veya ayarlar. |
| vertical_resolution | Dikey çözünürlüğü dpi cinsinden alır veya ayarlar. |
