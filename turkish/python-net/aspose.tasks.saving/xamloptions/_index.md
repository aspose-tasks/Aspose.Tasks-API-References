...
type: docs
weight: 180
url: /tr/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// Proje sayfalarını XAML'e render ederken ek seçenekler belirtmeye izin verir.

XamlOptions türü aşağıdaki üyeleri ortaya çıkar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| XamlOptions() | Projeyi XAML formatında kaydetmek için kullanılabilecek bir [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) sınıfının yeni bir örneğini başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
