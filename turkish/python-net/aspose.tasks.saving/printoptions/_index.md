...
type: docs
weight: 120
url: /tr/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Projeyi yazdırırken ek seçenekler belirtmeye izin verir.

PrintOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PrintOptions() | [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) sınıfının yeni bir örneğini başlatır; bu örnek proje yazdırma için farklı seçenekler ayarlamakta kullanılabilir. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
