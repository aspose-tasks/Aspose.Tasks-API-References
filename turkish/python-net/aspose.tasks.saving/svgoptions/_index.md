...
type: docs
weight: 170
url: /tr/python-net/aspose.tasks.saving/svgoptions/
---
...
| Ad | Açıklama |
| :- | :- |
| SvgOptions() | [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) sınıfının yeni bir örneğini başlatır; bu örnek proje dosyasını SVG formatında kaydetmek için kullanılabilir. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Proje düzeni render edilirken degrade fırçası kullanılıp kullanılmayacağını belirler. |
...
| page_saving_callback | Her render edilen sayfa için bir çıktı akışı elde etmek amacıyla kullanılan, kullanıcı tanımlı bir uygulama geri çağrısını alır veya ayarlar. |
