...
type: docs
weight: 200
url: /tr/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

Proje sayfalarını XPS'e render ederken ek seçenekler belirtmeye izin verir.

XpsOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| XpsOptions() | Yeni bir [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/) sınıfı örneği başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Bir metafilenin bitmap olarak işlenip işlenmeyeceğini gösteren bir değeri alır veya ayarlar. |
