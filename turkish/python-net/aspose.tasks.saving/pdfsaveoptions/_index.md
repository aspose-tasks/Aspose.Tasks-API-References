...
type: docs
weight: 90
url: /tr/python-net/aspose.tasks.saving/pdfsaveoptions/
---

## PdfSaveOptions class

Proje sayfalarını PDF'ye render ederken ek seçenekler belirtmeye izin verir.

PdfSaveOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PdfSaveOptions() | Bir belgeyi kaydetmek için kullanılabilecek [PdfSaveOptions](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
...
| compliance | Oluşturulan PDF belgesi için istenen uyumluluk seviyesini alır veya ayarlar.<br/>            Varsayılan [PDF15](/tasks/python-net/aspose.tasks.saving/pdfcompliance/) dir. |
| encryption_details | Şifreleme ayrıntılarını alır veya ayarlar. Ayarlanmamışsa, şifreleme yapılmaz. |
| text_compression | Görseller dışındaki tüm içerik akışları için kullanılacak sıkıştırma türünü alır veya ayarlar.<br/>            Varsayılan [FLATE](/tasks/python-net/aspose.tasks.saving/pdftextcompression/) dir. |
| digital_signature_details | Dijital imza ayrıntılarını alır veya ayarlar. Ayarlanmamışsa, imzalama yapılmaz. |
| save_to_separate_files | Proje sayfalarının ayrı dosyalara kaydedilip kaydedilmeyeceğini belirten bir değeri alır veya ayarlar. |
| page_saving_callback | Her işlenen sayfa için bir çıktı akışı almakta kullanılan kullanıcı tanımlı geri çağırmayı alır veya ayarlar.<br/>            [save_to_separate_files](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) seçeneği kullanıldığında uygulanır. |
| pages | Proje düzenini ayrı dosyalara kaydederken kaydedilecek sayfa numaralarının listesini alır veya ayarlar. |
