...
type: docs
weight: 20
url: /tr/python-net/aspose.tasks.saving/htmlsaveoptions/
---

## HtmlSaveOptions class

Proje sayfalarını HTML'ye render ederken ek seçenekler belirtmeye izin verir.

HtmlSaveOptions türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| HtmlSaveOptions() | Yeni bir [HtmlSaveOptions](/tasks/python-net/aspose.tasks.saving/htmlsaveoptions/) sınıfı örneği başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Proje düzeni render edilirken gradient fırça kullanılıp kullanılmayacağını belirten bir değeri alır veya ayarlar. |
...
| css_style_prefix | CSS stil önekini alır veya ayarlar. |
| font_settings | Proje görünümünün render edilmesinde kullanılan yazı tipi ayarlarını belirtir. |
| reduce_footer_gap | Son görev ile alt bilgi arasındaki boşluğun azaltılıp azaltılmayacağını belirten bir değeri alır veya ayarlar. |
| include_project_name_in_page_header | HTML sayfa başlığında proje adının dahil edilip edilmeyeceğini belirten bir değeri alır veya ayarlar. |
| include_project_name_in_title | HTML başlıkta proje adının dahil edilip edilmeyeceğini belirten bir değeri alır veya ayarlar. |
| pages | Proje düzeni render edilirken kaydedilecek sayfa numaralarının bir listesini alır veya ayarlar. |
| export_css | CSS'nin dışa aktarım şeklini alır veya ayarlar. |
| export_images | Görüntülerin dışa aktarım şeklini alır veya ayarlar. |
| export_fonts | Yazı tiplerinin dışa aktarım şeklini alır veya ayarlar. |
| css_saving_callback | CSS'yi depolamak için kaynak oluşturacak geri çağırmayı alır veya ayarlar. |
| font_saving_callback | Yazı tipini depolamak için kaynak oluşturacak geri çağırmayı alır veya ayarlar. |
| image_saving_callback | Yazı tipini depolamak için kaynak oluşturacak geri çağırmayı alır veya ayarlar. |
| font_face_types | Yazı tipi yüz tiplerini alır veya ayarlar. |
| page_saving_callback | Her işlenmiş sayfa için bir çıktı akışı elde etmek amacıyla kullanılan, kullanıcı tanımlı bir geri çağırma işlevini alır veya ayarlar. |
