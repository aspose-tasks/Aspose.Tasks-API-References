...
description: "RiskPattern yapıcı. RiskPattern sınıfının yeni bir örneğini başlatır."
type: docs
weight: 10
...
[`RiskPattern`](../) sınıfının yeni bir örneğini başlatır.
...
| --- | --- | --- |
| görev | Görev | Monte Carlo simülasyonunda bu riskin uygulanacağı belirtilen proje görevi. |
