...
description: "RiskPattern özelliği. Monte Carlo simülasyonunda kullanılan olasılık dağılımını alır veya ayarlar. Varsayılan değer ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
Monte Carlo simülasyonunda kullanılan olasılık dağılımını alır veya ayarlar. Varsayılan değer ProbabilityDistributionType.Normal'dur.
...
[`ProbabilityDistributionType`](../../probabilitydistributiontype/) sayımında tanımlanan değerlerden biri olabilir.
