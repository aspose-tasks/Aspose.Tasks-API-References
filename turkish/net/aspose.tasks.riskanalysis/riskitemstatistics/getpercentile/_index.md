...
description: "RiskItemStatistics yöntemi. Oluşturulan örneklerin belirli bir yüzdesinin altında kalan bir değeri alır."
type: docs
weight: 60
...
Üretilen örneklerin belirli bir yüzdesinin altında kalan bir değeri alır.
...
| --- | --- | --- |
| yüzde | Int32 | 0 ile 100 arasında belirtilen yüzde. |

### Dönüş Değeri

oluşturulan örneklerin belirli bir yüzdesinin altında kalan bir değer.
