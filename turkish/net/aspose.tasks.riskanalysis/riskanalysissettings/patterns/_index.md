...
description: "RiskAnalysisSettings özelliği. RiskPattern sınıfının örneklerini içeren bir koleksiyon alır."
type: docs
weight: 30
...
[`RiskPattern`](../../riskpattern/) sınıfının örneklerini içeren bir koleksiyon alır.
