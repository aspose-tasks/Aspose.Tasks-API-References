...
description: "RiskAnalysisSettings özelliği. Monte Carlo simülasyonunda kullanılacak yineleme sayısını alır veya ayarlar. Varsayılan değer 100'dür."
type: docs
weight: 20
...
Monte Carlo simülasyonunda kullanılacak yineleme sayısını alır veya ayarlar. Varsayılan değer 100'dür.
