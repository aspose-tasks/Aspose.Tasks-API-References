---
title: "Sınıf RiskAnalysisResult"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.RiskAnalysis.RiskAnalysisResult sınıfı. Bir risk analizinin sonucunu temsil eder"
type: docs
weight: 1870
...
| Ad | Açıklama |
| --- | --- |
| [GetRiskItems](../../aspose.tasks.riskanalysis/riskanalysisresult/getriskitems/)(RiskItemType) | Belirtilen risk türü için [`RiskItemStatisticsCollection`](../riskitemstatisticscollection/) sınıfının bir örneğini döndürür. |
| [SaveReport](../../aspose.tasks.riskanalysis/riskanalysisresult/savereport/#savereport)(Stream) | Risk analizi raporunu PDF formatında akışa kaydeder. |
| [SaveReport](../../aspose.tasks.riskanalysis/riskanalysisresult/savereport/#savereport_1)(string) | Risk analizi raporunu belirtilen dosya yoluna PDF formatında kaydeder. |
