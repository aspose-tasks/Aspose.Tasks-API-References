...
description: "RiskAnalyzer özelliği. Risk analizi için gerekli ayarları tanımlayan RiskAnalysisSettings sınıfının örneğini alır veya ayarlar."
type: docs
weight: 20
...
[`RiskAnalysisSettings`](../../riskanalysissettings/) sınıfının örneğini alır veya ayarlar; bu sınıf risk analizi için gerekli ayarları tanımlar.
