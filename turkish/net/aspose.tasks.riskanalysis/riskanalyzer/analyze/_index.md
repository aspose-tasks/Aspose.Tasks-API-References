...
description: "RiskAnalyzer yöntemi. Belirtilen proje için risk analizi gerçekleştirir. Analiz Monte Carlo simülasyonuna dayanır ve sonuç RiskAnalysisResult sınıfının bir örneğidir."
type: docs
weight: 30
...
Belirtilen proje için risk analizi gerçekleştirir. Analiz Monte Carlo simülasyonuna dayanır ve sonuç [`RiskAnalysisResult`](../../riskanalysisresult/) sınıfının bir örneğidir.
...
| --- | --- | --- |
| project | Project | analiz edilecek belirtilen [`Project`](../../../aspose.tasks/project/) sınıfı örneği. |

### Dönüş Değeri

analizin sonucunu temsil eden [`RiskAnalysisResult`](../../riskanalysisresult/) örneği.
