...
description: "RiskPatternCollection yöntemi. Bu koleksiyona RiskPattern sınıfının bir örneğini ekler."
type: docs
weight: 40
...
Bu koleksiyona [`RiskPattern`](../../riskpattern/) sınıfının bir örneğini ekler.
...
| --- | --- | --- |
| item | RiskPattern | Bu koleksiyona eklemek için [`RiskPattern`](../../riskpattern/) sınıfının bir örneği. |

### İstisnalar

| istisna | koşul |
| --- | --- |
| ArgumentNullException | *item* görevi null. |
