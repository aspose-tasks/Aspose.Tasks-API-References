...
description: "RiskPatternCollection özelliği. Belirtilen görev için RiskPattern sınıfının örneğini alır."
type: docs
weight: 30
...
Belirtilen görev için [`RiskPattern`](../../riskpattern/) sınıfının örneğini alır.
