...
description: "RiskItemStatisticsCollection yöntemi. Belirtilen Task nesnesiyle ilişkili bu koleksiyonda bulunan RiskItemStatistics sınıfının bir örneğini döndürür; öğe bulunamazsa null."
type: docs
weight: 10
...
Bu koleksiyonda bulunan ve belirtilen Task nesnesiyle ilişkili [`RiskItemStatistics`](../../riskitemstatistics/) sınıfının bir örneğini döndürür; öğe bulunamazsa null.
...
| --- | --- | --- |
| task | Task | belirtilen [`Task`](../../../aspose.tasks/task/) sınıfının örneği. |

### Dönüş Değeri

belirtilen görev nesnesiyle ilişkili risk öğesi, bulunursa; aksi takdirde null.
