...
description: "Aspose.Tasks.Visualization.Interval enum. İlerleme çizgilerini görüntülemek için yinelenen aralıkları belirtir"
type: docs
weight: 3170
...
İlerleme çizgilerinin gösterileceği yinelenen aralıkları belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Daily | `0` | Günlük aralığı gösterir. |
| Weekly | `1` | Haftalık aralığı gösterir. |
| Monthly | `2` | Aylık aralığı gösterir. |
