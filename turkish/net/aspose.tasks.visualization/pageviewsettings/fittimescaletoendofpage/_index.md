...
description: "PageViewSettings özelliği. Yazdırma sırasında zaman ölçeğini sayfanın sonuna sığdırıp sığdırmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 30
...
Yazdırma sırasında zaman ölçeğinin bir sayfanın sonuna sığdırılıp sığdırılmayacağını gösteren bir değeri alır veya ayarlar.
