...
description: "PageViewSettings özelliği. Tüm sayfalarda belirli sayıda ilk sütunu yazdırıp yazdırmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 60
...
Tüm sayfalarda belirtilen sayıda ilk sütunun yazdırılıp yazdırılmayacağını gösteren bir değeri alır veya ayarlar.
