...
description: "ProgressLines özelliği. Tekrarlayan aralığı alınır veya ayarlanır. RecurringInterval"
type: docs
weight: 180
...
Tekrarlayan aralığı alınır veya ayarlanır. `RecurringInterval`.
