...
description: "ProgressLines özelliği. İlerleme satırının mevcut tarihte görüntülenip görüntülenmeyeceğini belirten bir değer alınır veya ayarlanır."
type: docs
weight: 50
...
Mevcut tarihte ilerleme çizgisini gösterip göstermeyeceğini belirten bir değeri alır veya ayarlar.
