...
description: "Aspose.Tasks.Visualization.TimescaleUnit enum. Bir Gantt şemasında veya diğer zaman aşamalı görünümlerde bir zaman ölçeğinin herhangi bir katmanı için zaman birimini belirtir."
type: docs
weight: 3460
...
Gantt şemasında veya diğer zaman aşamalı görünümlerde bir zaman ölçeğinin herhangi bir katmanı için zaman birimini belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| None | `-1` | Hiçbirini gösterir. Zaman ölçeği katmanı gizlidir. |
...
| ThirdsOfMonths | `4` | Ayların üçte birleri zaman ölçeği birimini gösterir. |
| Months | `5` | Ay zaman ölçeği birimini gösterir. |
| Quarters | `6` | Yılların çeyrekleri zaman ölçeği birimini gösterir. |
| HalfYears | `7` | Altı aylık zaman ölçeği birimini gösterir. |
