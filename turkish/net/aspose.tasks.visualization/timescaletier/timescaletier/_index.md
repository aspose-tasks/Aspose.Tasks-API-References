...
description: "TimescaleTier yapıcı. TimescaleTier sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
[`TimescaleTier`](../) sınıfının yeni bir örneğini başlatır.
...
| count | Int32 | [`TimescaleUnit`](../../timescaleunit/) birimlerinin sayısı. |
