...
description: "ITextStyleModificationCallback yöntemi. Aşağıdaki görünümlerde (Gantt Chart, Task Sheet, Task Usage) bir görev satırı için tablo hücresi işlenmeden önce çağrılacak yöntem."
type: docs
weight: 10
...
Aşağıdaki görünümlerde görev satırı için bir tablo hücresinin işlenmesinden önce çağrılacak yöntem: 'Gantt Chart', 'Task Sheet', 'Task Usage'.
...
| --- | --- | --- |
| args | TaskTextStyleEventArgs | [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/) nesnesi. |
