...
description: "Aspose.Tasks.Visualization.LinePattern enum. Çizgi deseni"
type: docs
weight: 3190
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| None | `0` | Bir çizginin gösterilmeyeceğini belirtir. |
| Solid | `1` | Düz çizgi desenini belirtir. |
| CloseDot | `3` | Kapalı nokta çizgi desenini belirtir. |
| Dotted | `4` | Noktalı çizgi desenini belirtir. |
| Dashed | `2` | Kesikli çizgi desenini belirtir. |
