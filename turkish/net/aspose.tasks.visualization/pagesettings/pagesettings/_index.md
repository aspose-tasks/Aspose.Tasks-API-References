...
description: "PageSettings yapıcı. PageSettings sınıfının yeni bir örneğini başlatır. Proje görünümünün bir sayfası için yazdırma ayarlarını temsil eder."
type: docs
weight: 10
...
## PageSettings constructor
 ...
 [`PageSettings`](../) sınıfının yeni bir örneğini başlatır. Proje görünümünün bir sayfası için yazdırma ayarlarını temsil eder.
