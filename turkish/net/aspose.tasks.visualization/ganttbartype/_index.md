...
description: "Aspose.Tasks.Visualization.GanttBarType enum. Çubuk tipini belirtir."
type: docs
weight: 3080
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Dashed | `2` | Kesikli Gantt çubuk tipini gösterir. |
| Framed | `1` | Çerçeveli Gantt çubuk tipini gösterir. |
| Solid | `0` | Düz Gantt çubuk tipini gösterir. |
