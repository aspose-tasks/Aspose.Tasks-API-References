...
description: "RecurringInterval özelliği. Yinelenen aralığı alır veya ayarlar. Interval tipinin herhangi bir değeri olabilir"
type: docs
weight: 40
...
Yinelenen aralığı alır veya ayarlar. `Interval` tipinin herhangi bir değeri olabilir.
