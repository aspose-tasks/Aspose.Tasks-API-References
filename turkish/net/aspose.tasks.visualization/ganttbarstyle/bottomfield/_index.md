...
description: "GanttBarStyle özelliği. Çubuğun alt kısmında gösterilecek veriyi alır veya ayarlar. Field"
type: docs
weight: 30
...
Çubuğun alt kısmında gösterilecek veriyi alır veya ayarlar. [`Field`](../../../aspose.tasks/field/).
