...
description: "GanttBarStyle özelliği. Görev çubuğunun içinde render edilecek metni elde etmek için kullanıcı tanımlı dönüştürücüyü alır veya ayarlar. InsideField özelliğinin değerini geçersiz kılar"
type: docs
weight: 80
