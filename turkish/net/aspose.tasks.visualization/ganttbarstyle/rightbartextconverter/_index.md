...
description: "GanttBarStyle özelliği. Görev çubuğunun sağında görüntülenecek metni almak için kullanıcı tanımlı dönüştürücüyü alır veya ayarlar. RightField özelliğinin değerini geçersiz kılar."
type: docs
weight: 170
...
Görev çubuğunun sağında görüntülenecek metni almak için kullanıcı tanımlı dönüştürücüyü alır veya ayarlar. [`RightField`](../rightfield/) özelliğinin değerini geçersiz kılar.
