...
description: "GanttBarStyle özelliği. Özel görev‑özel stil için üst veya ortak stili alır veya ayarlar"
type: docs
weight: 160
...
Özel görev‑spesifik stil için üst (veya ortak) stili alır veya ayarlar.
...
Görev, farklı üst stillere sahip birden fazla özel stile sahip olabilir. Örneğin, "Critical" üst stiline sahip bir özel stil ve "Normal" üst stiline sahip başka bir stil olan bir görevi düşünün. Kısacası, görev kritik ise ilk stil uygulanır. Görev kritik olmadığında, ikinci stil uygulanır (bu mantık Microsoft Project Professional'dan miras alınmıştır).

## Örnekler

Bir görünümün özel çubuk stillerinin nasıl okunacağını gösterir.
