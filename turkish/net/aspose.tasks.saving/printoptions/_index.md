---
title: "Sınıf PrintOptions"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.Saving.PrintOptions sınıfı. Projeyi yazdırırken ek seçenekler belirtmeye olanak tanır."
type: docs
weight: 2170
url: /tr/net/aspose.tasks.saving/printoptions/
---
## PrintOptions class

Projeyi yazdırırken ek seçenekleri belirtmeye izin verir.
...
| Ad | Açıklama |
| --- | --- |
| [PrintOptions](printoptions/)() | `PrintOptions` sınıfının yeni bir örneğini başlatır; bu örnek, projeyi yazdırmak için farklı seçenekleri ayarlamakta kullanılabilir. |
