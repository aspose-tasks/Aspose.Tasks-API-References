...
description: Proje yazdırılırken ek seçeneklerin belirtilmesine izin verir.
type: docs
weight: 1890
...
| İsim | Tanım |
| --- | --- |
| [PrintOptions](printoptions)() | Yeni bir örneğini başlatır[`PrintOptions`](../printoptions) proje yazdırmak için farklı seçenekler ayarlamak için kullanılabilecek sınıf. |
