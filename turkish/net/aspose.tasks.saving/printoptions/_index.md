...
description: Aspose.Tasks.Saving.PrintOptions sınıf. Proje yazdırılırken ek seçeneklerin belirtilmesine izin verir.
type: docs
weight: 1900
...
Proje yazdırılırken ek seçeneklerin belirtilmesine izin verir.
...
| İsim | Tanım |
| --- | --- |
| [PrintOptions](printoptions/)() | Yeni bir örneğini başlatır.`PrintOptions` Project. yazdırmak için farklı seçenekler ayarlamak için kullanılabilecek sınıf |
