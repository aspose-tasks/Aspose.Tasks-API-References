...
description: "SaveTemplateOptions özelliği. Bir proje şablonundaki tüm sabit maliyetlerin kaldırılıp kaldırılmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 40
...
Bir proje şablonundaki tüm sabit maliyetlerin kaldırılıp kaldırılmayacağını gösteren bir değeri alır veya ayarlar.
