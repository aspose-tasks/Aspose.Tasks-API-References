...
description: "SaveTemplateOptions özelliği. Bir proje şablonundaki tüm gerçek değerlerin kaldırılıp kaldırılmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 20
...
Bir proje şablonundaki tüm gerçek değerlerin kaldırılıp kaldırılmayacağını gösteren bir değeri alır veya ayarlar.
