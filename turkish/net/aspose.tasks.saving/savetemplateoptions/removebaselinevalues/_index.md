...
description: "SaveTemplateOptions özelliği. Bir proje şablonundaki tüm temel değerlerin kaldırılıp kaldırılmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 30
...
Bir proje şablonundaki tüm temel değerlerin kaldırılıp kaldırılmayacağını gösteren bir değeri alır veya ayarlar.
