...
description: Aspose.Tasks.Saving.PrimaveraXmlSaveOptions sınıf. Projeyi Primavera xml biçiminde kaydederken ek seçenekler belirlemeye izin verir.
type: docs
weight: 1890
...
Projeyi Primavera xml biçiminde kaydederken ek seçenekler belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Yeni bir örneğini başlatır.`PrimaveraXmlSaveOptions` sınıf. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | Bir kök görevinin kaydedilip kaydedilmeyeceğini belirten bir değer alır veya ayarlar. |
