...
description: Projeyi Primavera xml formatına kaydederken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1880
...
Projeyi Primavera xml formatına kaydederken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions)() | Yeni bir örneğini başlatır[`PrimaveraXmlSaveOptions`](../primaveraxmlsaveoptions) sınıf. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask) { get; set; } | Bir kök görevin kaydedilip kaydedilmeyeceğini belirten bir değer alır veya ayarlar. |
