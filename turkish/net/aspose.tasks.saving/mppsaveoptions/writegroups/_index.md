...
description: "MPPSaveOptions özelliği. Bir projeyi MPP formatında kaydederken grup verilerinin yazılıp yazılmayacağını gösteren bir değeri alır veya ayarlar. Grup verileri Project.TaskGroups ve Project.ResourceGroups koleksiyonlarını içerir."
type: docs
weight: 60
url: /tr/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Projeyi MPP formatında kaydederken grup verilerinin yazılıp yazılmayacağını gösteren bir değeri alır veya ayarlar. Grup verileri Project.TaskGroups ve Project.ResourceGroups koleksiyonlarını içerir.
