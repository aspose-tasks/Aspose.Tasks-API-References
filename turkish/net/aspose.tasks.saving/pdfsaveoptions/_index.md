---
title: "Sınıf PdfSaveOptions"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.Saving.PdfSaveOptions sınıfı. Proje sayfalarını PDF'ye render ederken ek seçenekler belirtmeye olanak tanır"
type: docs
weight: 2130
...
Proje sayfalarını PDF'ye render ederken ek seçenekleri belirtmeye izin verir.
...
| Ad | Açıklama |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | Bir belgeyi [`PDF`](../savefileformat/) formatında kaydetmek için kullanılabilecek `PdfSaveOptions` sınıfının yeni bir örneğini başlatır. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance/) { get; set; } | Oluşturulan PDF belgesi için istenen uyumluluk seviyesini alır veya ayarlar. Varsayılan Pdf15'tir. |
...
| [DigitalSignatureDetails](../../aspose.tasks.saving/pdfsaveoptions/digitalsignaturedetails/) { get; set; } | Dijital imza ayrıntılarını alır veya ayarlar. Ayarlanmamışsa, imzalama yapılmaz. |
...
| [EncryptionDetails](../../aspose.tasks.saving/pdfsaveoptions/encryptiondetails/) { get; set; } | Şifreleme ayrıntılarını alır veya ayarlar. Ayarlanmamışsa, şifreleme yapılmaz. |
...
| [FontSettings](../../aspose.tasks.saving/pdfsaveoptions/fontsettings/) { get; } | Projenin görünümü render edilirken kullanılan yazı tipi ayarlarını belirtir. |
...
| [Pages](../../aspose.tasks.saving/pdfsaveoptions/pages/) { get; set; } | Proje düzeni ayrı dosyalara kaydedilirken kaydedilecek sayfa numaralarının listesini alır veya ayarlar. Liste boşsa tüm sayfalar kaydedilir. |
| [PageSavingCallback](../../aspose.tasks.saving/pdfsaveoptions/pagesavingcallback/) { get; set; } | Her render edilen sayfa için bir çıktı akışı almakta kullanılan kullanıcı tanımlı geri çağırma işlevini alır veya ayarlar. [`SaveToSeparateFiles`](./savetoseparatefiles/) seçeneği kullanıldığında geçerlidir. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/pdfsaveoptions/reducefootergap/) { get; set; } | Son görev ile alt bilgi arasındaki boşluğun azaltılıp azaltılmayacağını gösteren bir değeri alır veya ayarlar. |
...
| [SaveToSeparateFiles](../../aspose.tasks.saving/pdfsaveoptions/savetoseparatefiles/) { get; set; } | Proje sayfalarının ayrı dosyalara kaydedilip kaydedilmeyeceğini belirten bir değeri alır veya ayarlar. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression/) { get; set; } | Görseller dışındaki tüm içerik akışları için kullanılacak sıkıştırma türünü alır veya ayarlar. Varsayılan Flate'tir. |
