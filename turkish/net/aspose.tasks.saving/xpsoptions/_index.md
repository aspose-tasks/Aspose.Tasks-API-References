---
title: "XpsOptions sınıfı"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.Saving.XpsOptions sınıfı. Proje sayfalarını XPS olarak render ederken ek seçenekler belirtmeye olanak tanır."
type: docs
weight: 2280
url: /tr/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Proje sayfalarını XPS olarak oluştururken ek seçenekler belirtmeye izin verir.
...
| Ad | Açıklama |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Yeni bir `XpsOptions` sınıfı örneği başlatır. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Bir metafilenin bitmap olarak render edilip edilmemesi gerektiğini gösteren bir değeri alır veya ayarlar. |
