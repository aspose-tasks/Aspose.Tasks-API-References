...
description: Proje sayfalarını XPSde işlerken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1980
...
Proje sayfalarını XPS'de işlerken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [XpsOptions](xpsoptions)() | Yeni bir örneğini başlatır[`XpsOptions`](../xpsoptions) sınıf. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap) { get; set; } | Bir meta dosyasının bitmap olarak işlenmesi gerekip gerekmediğini belirten bir değer alır veya ayarlar. |
