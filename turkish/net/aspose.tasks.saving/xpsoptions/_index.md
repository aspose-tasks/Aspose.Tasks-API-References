...
description: Aspose.Tasks.Saving.XpsOptions sınıf. Proje sayfalarını XPS. olarak işlerken ek seçenekler belirlemeye izin verir.
type: docs
weight: 1990
...
Proje sayfalarını XPS. olarak işlerken ek seçenekler belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Yeni bir örneğini başlatır.`XpsOptions` sınıf. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Bir meta dosyasının bitmap olarak işlenip işlenmeyeceğini belirten bir değer alır veya ayarlar. |
