...
description: Proje sayfalarını XLSXe işlerken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1970
...
Proje sayfalarını XLSX'e işlerken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | Yeni bir örneğini başlatır[`XlsxOptions`](../xlsxoptions)projeyi XLSX formatında kaydetmek için kullanılabilecek sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview) { get; set; } | Oluşturulacak atama görünümü sütunlarının bir listesini alır veya ayarlar ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding) { get; set; } | Elde edilen XLSX dosyasının kodlamasını alır veya ayarlar. Varsayılan değerUTF8 . |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview) { get; set; } | İşlenecek kaynak görünümü sütunlarının bir listesini alır veya ayarlar ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn) ). |
