...
description: Aspose.Tasks.Saving.XlsxOptions sınıf. Proje sayfalarını XLSX. olarak işlerken ek seçenekler belirlemeye izin verir
type: docs
weight: 1980
...
| İsim | Tanım |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Yeni bir örneğini başlatır.`XlsxOptions`projeyi XLSX biçiminde kaydetmek için kullanılabilecek sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | İşlenecek atama görünümü sütunlarının bir listesini alır veya ayarlar ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Ortaya çıkan XLSX dosyasının kodlamasını alır veya ayarlar. varsayılan değerUTF8 . |
