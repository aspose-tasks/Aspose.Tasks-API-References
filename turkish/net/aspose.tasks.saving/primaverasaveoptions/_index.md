...
description: Projeyi Primavera XER biçimine kaydederken ek seçenekler belirlemeye izin verir.
type: docs
weight: 1870
...
Projeyi Primavera XER biçimine kaydederken ek seçenekler belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | Yeni bir örneğini başlatır[`PrimaveraSaveOptions`](../primaverasaveoptions) sınıf. |
...
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix) { get; set; } | Etkinlik kimliklerinin yeniden numaralandırılmasında kullanılan son eki alır veya ayarlar. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids) { get; set; } | Etkinlik kimliklerini yeniden numaralandırmanın gerekip gerekmediğini belirten bir değer alır veya ayarlar. |
