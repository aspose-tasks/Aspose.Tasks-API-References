...
description: "SaveOptions özelliği. Proje görünümünde görünen BarStyle sınıfının örneklerinin listesini alır veya ayarlar."
type: docs
weight: 10
...
Proje görünümünde görünen [`BarStyle`](../../../aspose.tasks.visualization/barstyle/) sınıfının örneklerinin listesini alır veya ayarlar.
