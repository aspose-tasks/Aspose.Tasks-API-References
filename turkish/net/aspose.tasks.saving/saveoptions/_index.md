...
description: Bu kullanıcının bir proje belirli bir biçime kaydederken ek seçenekler belirlemesine izin veren sınıflar için soyut bir temel sınıftır.
type: docs
weight: 1910
...
| [PresentationFormat](../../aspose.tasks.saving/saveoptions/presentationformat) { get; set; } | Alır veya ayarlar[`PresentationFormat`](./presentationformat) belgenin kaydedileceği yer. |
...
| [Timescale](../../aspose.tasks.saving/saveoptions/timescale) { get; set; } | Alır veya ayarlar[`Timescale`](./timescale) proje grafik biçiminde kaydedildiğinde zaman ölçeğinin (varsa) nasıl oluşturulacağını kontrol etmek için kullanılan değer. |
