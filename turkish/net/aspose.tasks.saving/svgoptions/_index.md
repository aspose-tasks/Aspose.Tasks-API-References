---
title: "Sınıf SvgOptions"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.Saving.SvgOptions sınıfı. Proje sayfalarını SVG'ye render ederken ek seçenekler belirtmeye olanak tanır."
type: docs
weight: 2230
...
Proje sayfalarını SVG olarak oluştururken ek seçenekler belirtmeye izin verir.
...
| Ad | Açıklama |
| --- | --- |
| [SvgOptions](svgoptions/)() | `SvgOptions` sınıfının yeni bir örneğini başlatır; bu örnek, projeyi SVG formatında kaydetmekte kullanılabilir. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Her render edilen sayfa için bir çıktı akışı elde etmek amacıyla kullanılan, kullanıcı tanımlı bir uygulama geri çağrısını alır veya ayarlar. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Proje düzenini render ederken gradyan fırça kullanılıp kullanılmayacağını belirler. Şu anda gradyan fırçanın SVG'ye render edilmesi desteklenmemektedir. |
