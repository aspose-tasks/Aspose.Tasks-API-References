...
description: Aspose.Tasks.Saving.SvgOptions sınıf. Proje sayfalarını SVG. olarak işlerken ek seçenekler belirlemeye izin verir
type: docs
weight: 1950
...
Proje sayfalarını SVG. olarak işlerken ek seçenekler belirlemeye izin verir
...
| İsim | Tanım |
| --- | --- |
| [SvgOptions](svgoptions/)() | Yeni bir örneğini başlatır.`SvgOptions` projeyi SVG formatında kaydetmek için kullanılabilecek sınıf. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Proje düzenini işlerken gradyan fırçasının kullanılıp kullanılmayacağını belirler. Şu anda SVG'ye dönüştürme için degrade fırçasının kullanılması desteklenmiyor. |
