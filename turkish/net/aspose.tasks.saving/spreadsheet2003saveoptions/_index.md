...
description: Proje sayfalarını Spreadsheet2003e işlerken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1930
...
Proje sayfalarını Spreadsheet2003'e işlerken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions)() | Yeni bir örneğini başlatır[`Spreadsheet2003SaveOptions`](../spreadsheet2003saveoptions) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview) { get; set; } | Oluşturulacak atama görünümü sütunlarının bir listesini alır veya ayarlar ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn) ). |
