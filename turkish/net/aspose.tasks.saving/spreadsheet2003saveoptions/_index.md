...
description: Aspose.Tasks.Saving.Spreadsheet2003SaveOptions sınıf. Proje sayfalarını Spreadsheet2003. olarak işlerken ek seçenekler belirlemeye izin verir
type: docs
weight: 1940
...
Proje sayfalarını Spreadsheet2003. olarak işlerken ek seçenekler belirlemeye izin verir
...
| İsim | Tanım |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | Yeni bir örneğini başlatır.`Spreadsheet2003SaveOptions` sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | İşlenecek atama görünümü sütunlarının bir listesini alır veya ayarlar ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | İşlenecek kaynak görünümü sütunlarının bir listesini alır veya ayarlar ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
