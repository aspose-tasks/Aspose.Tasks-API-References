...
description: Proje sayfalarını görüntülere dönüştürürken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1760
...
Proje sayfalarını görüntülere dönüştürürken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | Yeni bir örneğini başlatır[`ImageSaveOptions`](../imagesaveoptions) işlenen görüntüleri TIFF, PNG, BMP veya JPEG formatlarında kaydetmek için kullanılabilen sınıf. |
...
| [FontResolveCallback](../../aspose.tasks.saving/imagesaveoptions/fontresolvecallback) { get; set; } | Çözümlenen yazı tiplerini özelleştirmek için kullanılabilecek bir geri arama alır veya ayarlar. |
...
| [HorizontalResolution](../../aspose.tasks.saving/imagesaveoptions/horizontalresolution) { get; set; } | Yatay çözünürlüğü dpi olarak alır veya ayarlar. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages) { get; set; } | Proje düzenini ayrı dosyalara kaydederken kaydedilecek sayfa numaralarının listesini alır veya ayarlar. Bu liste boşsa tüm sayfalar kaydedilecektir. |
| [PageSavingCallback](../../aspose.tasks.saving/imagesaveoptions/pagesavingcallback) { get; set; } | Oluşturulan her sayfa için bir çıktı akışı almak için kullanılan kullanıcı tanımlı bir geri aramayı alır veya ayarlar. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap) { get; set; } | Son görev ile alt bilgi arasındaki boşluğun azaltılması gerekip gerekmediğini belirten bir değer alır veya ayarlar. |
...
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution) { get; set; } | Dikey çözünürlüğü dpi olarak alır veya ayarlar. |
