...
description: Aspose.Tasks.Saving.XamlOptions sınıf. /// Proje sayfalarını XAML. olarak işlerken ek seçenekler belirlemeye izin verir
type: docs
weight: 1970
...
/// Proje sayfalarını XAML. olarak işlerken ek seçenekler belirlemeye izin verir
...
| İsim | Tanım |
| --- | --- |
| [XamlOptions](xamloptions/)() | Yeni bir örneğini başlatır.`XamlOptions` projeyi XAML formatında kaydetmek için kullanılabilecek sınıf. |
