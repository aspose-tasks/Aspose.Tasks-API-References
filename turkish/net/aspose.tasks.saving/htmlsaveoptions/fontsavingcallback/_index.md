...
description: "HtmlSaveOptions özelliği. Yazı tipini depolamak için kaynak oluşturmak üzere çağrılan geri aramayı alır veya ayarlar"
type: docs
weight: 80
...
Yazı tipini depolamak için kaynak oluşturacak geri çağırmayı alır veya ayarlar.
