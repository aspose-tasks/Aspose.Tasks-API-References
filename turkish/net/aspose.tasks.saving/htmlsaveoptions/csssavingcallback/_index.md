...
description: "HtmlSaveOptions özelliği. CSS'yi depolamak için kaynak oluşturmak üzere çağrılan geri aramayı alır veya ayarlar."
type: docs
weight: 20
...
CSS depolamak için kaynak oluşturacak geri çağırmayı alır veya ayarlar.
