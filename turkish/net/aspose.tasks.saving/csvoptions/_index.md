...
description: Projeyi CSVye kaydederken ek seçenekleri belirlemeye izin verir.
type: docs
weight: 1710
...
Projeyi CSV'ye kaydederken ek seçenekleri belirlemeye izin verir.
...
| İsim | Tanım |
| --- | --- |
| [CsvOptions](csvoptions)() | Yeni bir örneğini başlatır[`CsvOptions`](../csvoptions) projeyi CSV formatında kaydetmek için kullanılabilecek sınıf. |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders) { get; set; } | Başlıkların dahil edilip edilmeyeceğini belirten bir değer alır veya ayarlar (varsayılan değer DOĞRU'dur). |
