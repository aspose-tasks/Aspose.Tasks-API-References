...
description: "OleObject özelliği. Proje dosyasının yalnızca bağlantı kaynağında depolanan gerçek veriye bir bağlantı içerip içermediğini gösteren bir değer alır."
type: docs
weight: 90
url: /tr/net/aspose.tasks/oleobject/linked/
---
## OleObject.Linked property

Proje dosyasının yalnızca bağlantı kaynağında depolanan gerçek veriye bir bağlantı içerip içermediğini gösteren bir değeri alır.
