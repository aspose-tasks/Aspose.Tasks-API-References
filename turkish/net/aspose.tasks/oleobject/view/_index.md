...
description: "OleObject özelliği. Eklenen nesnenin ait olduğu View sınıfının örneğini alır veya ayarlar"
type: docs
weight: 120
...
`View` sınıfının, eklenen nesnenin ait olduğu örneğini alır veya ayarlar.
