...
description: Aspose.Tasks.AvailabilityPeriod sınıf. Bir kaynağın kullanılabilir olduğu bir dönemi temsil eder.
type: docs
weight: 80
...
| [AvailableUnits](../../aspose.tasks/availabilityperiod/availableunits/) { get; set; } | Belirtilen süre boyunca kullanılabilir olan bir kaynağın yüzdesini alır veya ayarlar. |
