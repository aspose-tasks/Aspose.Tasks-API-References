...
description: "Duration özelliği. Zaman biriminin geçtiğini gösteren bir değer alır. Bu Duration örneğinin geçip geçmediğini belirleyen bayrak."
type: docs
weight: 20
...
Zaman biriminin geçmiş olup olmadığını gösteren bir değer alır. Bu Duration örneğinin geçmiş olup olmadığını belirleyen bayrak.
