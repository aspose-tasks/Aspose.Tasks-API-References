...
| [TimeSpan](../../aspose.tasks/duration/timespan) { get; } | Alır[`TimeSpan`](./timespan) bu Duration nesnesinin örneği. Bu Duration nesnesinin TimeSpan örneği. |
...
| İsim | Tanım |
| --- | --- |
| static [Parse](../../aspose.tasks/duration/parse)(Project, string) | Belirtilen dizeyi örneğine dönüştürür[`Duration`](../duration) yapı. |
...
| [ToDouble](../../aspose.tasks/duration/todouble)() | Süre nesnesiniDouble değer. |
| override [ToString](../../aspose.tasks/duration/tostring)() | Bu örneğin dize temsilini döndürür. |
