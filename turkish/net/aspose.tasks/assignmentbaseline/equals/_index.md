...
description: "AssignmentBaseline yöntemi. Bu örneğin belirtilen bir nesneye eşit olup olmadığını gösteren bir değer döndürür"
type: docs
weight: 60
...
bu örnek belirtilen nesneye eşitse true, aksi takdirde false döndürür.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| diğer | AssignmentBaseline | bu örnekle karşılaştırmak için belirtilen AssignmentBaseline nesnesi. |
