...
description: "AssignmentBaseline yöntemi. IComparable arayüzünün uygulanması. Bu örneği belirtilen Baseline nesnesiyle karşılaştırır"
type: docs
weight: 50
...
| --- | --- | --- |
| diğer | AssignmentBaseline | bu örneğin karşılaştırılacağı belirtilen Baseline nesnesi. |
