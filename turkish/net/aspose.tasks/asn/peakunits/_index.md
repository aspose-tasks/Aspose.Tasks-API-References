...
description: "Asn alanı. Bir kaynağın bir görev için atandığı maksimum birim sayısı"
type: docs
weight: 390
...
Bir kaynağın bir görev için atandığı maksimum birim sayısı.
...
Ortak özelliklerin nasıl okunup yazılacağını gösterir.
