...
description: "Asn alanı. Atama ile ilişkili bir köprünün başlığı veya açıklayıcı metni"
type: docs
weight: 280
...
Bir atama ile ilişkili bir köprü bağlantısının başlığı veya açıklayıcı metni.
