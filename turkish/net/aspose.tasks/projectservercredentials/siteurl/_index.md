...
description: "ProjectServerCredentials özelliği. SharePoint sitesindeki PWA'nın URL'sini veya şirket içi Project Server'ın URL'sini alır. Örneğin https//your_company_name.sharepoint.com/sites/pwa"
type: docs
weight: 30
...
SharePoint sitesindeki PWA'nın URL'sini veya yerel Project Server'ın URL'sini alır. Örneğin, https://your_company_name.sharepoint.com/sites/pwa\";
