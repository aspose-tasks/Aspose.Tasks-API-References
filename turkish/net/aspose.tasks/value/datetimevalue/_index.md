...
description: "Value özelliği. Değer DateTime olarak temsil edilebiliyorsa gerçek değeri alır veya ayarlar. Varsayılan değer MinValue'dir."
type: docs
weight: 20
...
DateTime olarak temsil edilebiliyorsa gerçek değeri alır veya ayarlar. Varsayılan değer MinValue'dir.
...
DateTime değerini ayarlamanız gerektiğinde, bu özelliği [`Val`](../val/) yerine tercih edin.
