...
description: "Value özelliği. Bir proje içinde bir değerin benzersiz tanımlayıcısını alır veya ayarlar."
type: docs
weight: 50
...
Bir proje içinde bir değerin benzersiz tanımlayıcısını alır veya ayarlar.

Farklı [`Value`](../) örnekleri için aynı tanımlayıcıların olmaması önemlidir.

Minimum `Id` değeri `1`'dir.
