...
description: "Aspose.Tasks.Value sınıfı. Bir değer listesindeki bir değeri temsil eder"
type: docs
weight: 2800
...
| Ad | Açıklama |
| --- | --- |
| [Value](value/)() | `Value` sınıfının yeni bir örneğini başlatır. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [DateTimeValue](../../aspose.tasks/value/datetimevalue/) { get; set; } | DateTime olarak temsil edilebiliyorsa gerçek değeri alır veya ayarlar. Varsayılan değer MinValue'dir. |
...
| [Id](../../aspose.tasks/value/id/) { get; set; } | Bir proje içinde bir değerin benzersiz tanımlayıcısını alır veya ayarlar. |
...
| [Phonetic](../../aspose.tasks/value/phonetic/) { get; set; } | Özel alan adının fonetik bilgilerini alır veya ayarlar. |
...
| [Val](../../aspose.tasks/value/val/) { get; set; } | İç temsildeki gerçek değeri alır veya ayarlar. Aşağıda listelenen güçlü tipli özellikleri kullanmayı tercih edin. |
| [ValueGuid](../../aspose.tasks/value/valueguid/) { get; } | Bu değeri tüm projedeki diğer değerler arasında tanımlayan bir GUID alır. |
