...
description: "Value özelliği. İç temsilde gerçek değeri alır veya ayarlar. Aşağıda listelenen güçlü tipli özellikleri kullanmayı tercih edin."
type: docs
weight: 90
...
İç temsildeki gerçek değeri alır veya ayarlar. Aşağıda listelenen güçlü tipli özellikleri kullanmayı tercih edin.
...
Metin değerini ayarlamak istiyorsanız, güçlü tipli [`StringValue`](../stringvalue/) özelliğini kullanmayı tercih edin.

Numara veya Maliyet değerini ayarlamak istiyorsanız, güçlü tipli [`NumericValue`](../numericvalue/) özelliğini kullanmayı tercih edin.

Tarih/Başlangıç/Bitiş değerlerini ayarlamak istiyorsanız, güçlü tipli [`DateTimeValue`](../datetimevalue/) özelliğini kullanmayı tercih edin.

Süre değerini ayarlamak istiyorsanız, güçlü tipli [`Duration`](../duration/) özelliğini kullanmayı tercih edin.

Tipiniz listelenmemişse, `Val` özelliğini kullanın.
