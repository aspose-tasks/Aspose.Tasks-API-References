...
description: "Value özelliği. Sayı veya maliyet değerini temsil etmek için kullanılan gerçek değeri alır veya ayarlar"
type: docs
weight: 60
...
Sayı veya maliyet değerini temsil etmek için kullanılan gerçek değeri alır veya ayarlar.
...
Numara veya Maliyet değerini ayarlamanız gerektiğinde, bu özelliği [`Val`](../val/) yerine tercih edin.
