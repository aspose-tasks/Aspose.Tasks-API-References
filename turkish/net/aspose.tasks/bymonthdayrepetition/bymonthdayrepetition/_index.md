...
description: "ByMonthDayRepetition yapıcı. ByMonthDayRepetition sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
[`ByMonthDayRepetition`](../) sınıfının yeni bir örneğini başlatır.
