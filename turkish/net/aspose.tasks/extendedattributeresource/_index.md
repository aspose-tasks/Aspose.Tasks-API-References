...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Cost1 | `205521019` | Maliyet1 (Kaynak) özel alanı. |
| Cost2 | `205521020` | Maliyet2 (Kaynak) özel alanı. |
| Cost3 | `205521021` | Maliyet3 (Kaynak) özel alanı. |
| Cost4 | `205521062` | Maliyet4 (Kaynak) özel alanı. |
| Cost5 | `205521063` | Maliyet5 (Kaynak) özel alanı. |
| Cost6 | `205521064` | Maliyet6 (Kaynak) özel alanı. |
| Cost7 | `205521065` | Maliyet7 (Kaynak) özel alanı. |
| Cost8 | `205521066` | Maliyet8 (Kaynak) özel alanı. |
| Cost9 | `205521067` | Maliyet9 (Kaynak) özel alanı. |
| Cost10 | `205521068` | Maliyet10 (Kaynak) özel alanı. |
| Date1 | `205521069` | Tarih1 (Kaynak) özel alanı. |
| Date2 | `205521070` | Date2 (Kaynak) özel alanı. |
| Date3 | `205521071` | Date3 (Kaynak) özel alanı. |
| Date4 | `205521072` | Date4 (Kaynak) özel alanı. |
| Date5 | `205521073` | Date5 (Kaynak) özel alanı. |
| Date6 | `205521074` | Date6 (Kaynak) özel alanı. |
| Date7 | `205521075` | Date7 (Kaynak) özel alanı. |
| Date8 | `205521076` | Date8 (Kaynak) özel alanı. |
| Date9 | `205521077` | Date9 (Kaynak) özel alanı. |
| Date10 | `205521078` | Date10 (Kaynak) özel alanı. |
| Duration1 | `205521013` | Süre1 (Kaynak) özel alanı. |
| Duration2 | `205521014` | Süre2 (Kaynak) özel alanı. |
| Duration3 | `205521015` | Süre3 (Kaynak) özel alanı. |
| Duration4 | `205521079` | Süre4 (Kaynak) özel alanı. |
| Duration5 | `205521080` | Süre5 (Kaynak) özel alanı. |
| Duration6 | `205521081` | Süre6 (Kaynak) özel alanı. |
| Duration7 | `205521082` | Süre7 (Kaynak) özel alanı. |
...
| Finish5 | `205521007` | Finish5 (Kaynak) özel alanı. |
| Finish6 | `205521086` | Finish6 (Kaynak) özel alanı. |
| Finish7 | `205521087` | Finish7 (Kaynak) özel alanı. |
| Finish8 | `205521088` | Finish8 (Kaynak) özel alanı. |
...
| Flag10 | `205521022` | Flag10 (Kaynak) özel alanı. |
| Flag11 | `205521091` | Flag11 (Kaynak) özel alanı. |
| Flag12 | `205521092` | Flag12 (Kaynak) özel alanı. |
| Flag13 | `205521093` | Flag13 (Kaynak) özel alanı. |
| Flag14 | `205521094` | Flag14 (Kaynak) özel alanı. |
| Flag15 | `205521095` | Flag15 (Kaynak) özel alanı. |
| Flag16 | `205521096` | Flag16 (Kaynak) özel alanı. |
| Flag17 | `205521097` | Flag17 (Kaynak) özel alanı. |
...
| Number7 | `205521102` | Number7 (Kaynak) özel alanı. |
| Number8 | `205521103` | Number8 (Kaynak) özel alanı. |
| Number9 | `205521104` | Number9 (Kaynak) özel alanı. |
| Number10 | `205521105` | Number10 (Kaynak) özel alanı. |
| Number11 | `205521106` | Number11 (Kaynak) özel alanı. |
| Number12 | `205521107` | Number12 (Kaynak) özel alanı. |
| Number13 | `205521108` | Number13 (Kaynak) özel alanı. |
| Number14 | `205521109` | Number14 (Kaynak) özel alanı. |
| Number15 | `205521110` | Number15 (Kaynak) özel alanı. |
| Number16 | `205521111` | Number16 (Kaynak) özel alanı. |
| Number17 | `205521112` | Number17 (Kaynak) özel alanı. |
| Number18 | `205521113` | Number18 (Kaynak) özel alanı. |
| Number19 | `205521114` | Number19 (Kaynak) özel alanı. |
| Number20 | `205521115` | Number20 (Kaynak) özel alanı. |
| Start1 | `205520998` | Başlangıç1 (Kaynak) özel alanı. |
| Start2 | `205520999` | Start2 (Kaynak) özel alanı. |
| Start3 | `205521000` | Start3 (Kaynak) özel alanı. |
| Start4 | `205521001` | Start4 (Kaynak) özel alanı. |
| Start5 | `205521002` | Start5 (Kaynak) özel alanı. |
| Start6 | `205521116` | Start6 (Kaynak) özel alanı. |
| Start7 | `205521117` | Start7 (Kaynak) özel alanı. |
| Start8 | `205521118` | Start8 (Kaynak) özel alanı. |
| Start9 | `205521119` | Start9 (Kaynak) özel alanı. |
| Start10 | `205521120` | Start10 (Kaynak) özel alanı. |
...
| Text23 | `205521133` | Text23 (Kaynak) özel alanı. |
| Text24 | `205521134` | Text24 (Kaynak) özel alanı. |
| Text25 | `205521135` | Text25 (Kaynak) özel alanı. |
| Text26 | `205521136` | Text26 (Kaynak) özel alanı. |
| Text27 | `205521137` | Text27 (Kaynak) özel alanı. |
