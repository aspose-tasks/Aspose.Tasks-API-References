...
description: "Tsk alanı. Göreve atanan bir kaynağın, atanmış görevlerde normal çalışma kapasitesinde tamamlanabilecek olandan daha fazla iş yüküne sahip olup olmadığını gösterir"
type: docs
weight: 470
...
Görevin, normal çalışma kapasitesi içinde tamamlanamayacak kadar fazla işe sahip atanmış bir kaynağı olup olmadığını gösterir.
...
Tsk.IsOverallocated, Tsk.HasOverallocatedResource öğelerinin nasıl okunacağını gösterir,

```csharp
// Rsc.Overallocated ve Asn.Overallocated özellikleri.
