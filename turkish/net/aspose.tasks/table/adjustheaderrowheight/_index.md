...
description: "Table özelliği. Tablo başlık satırının yüksekliğinin ayarlanıp ayarlanamayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 20
...
Tablonun başlık satırı yüksekliğinin ayarlanıp ayarlanamayacağını gösteren bir değeri alır veya ayarlar.
