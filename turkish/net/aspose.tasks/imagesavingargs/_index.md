---
title: "Sınıf ImageSavingArgs"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.ImageSavingArgs sınıfı. Bu sınıf, HTML formatına dönüştürme sırasında gerçekleşen harici görüntü dosyalarının kaydedilmesiyle ilgili veri kümesini temsil eder."
type: docs
weight: 900
...
Bu sınıf, HTML formatına dönüştürme sırasında gerçekleşen harici görüntü dosyasının kaydedilmesiyle ilgili veri kümesini temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | `ImageSavingArgs` sınıfının yeni bir örneğini başlatır. |
...
| [ImageType](../../aspose.tasks/imagesavingargs/imagetype/) { get; } | Bir HTML görüntü türü alır. |
...
Görüntü kaydetme argümanlarıyla nasıl çalışılacağını gösterir.
