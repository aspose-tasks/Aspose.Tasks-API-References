...
description: Yeni bir örneğini başlatırProjectServerManageraspose.tasks/projectservermanager sınıf.
type: docs
weight: 10
...
Yeni bir örneğini başlatır[`ProjectServerManager`](../../projectservermanager) sınıf.
