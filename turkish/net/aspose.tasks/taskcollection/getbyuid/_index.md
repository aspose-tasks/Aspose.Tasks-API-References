...
description: "TaskCollection yöntemi. Bu koleksiyonun üst görevi olan, belirtilen Uid'ye sahip bir görevi döndürür."
type: docs
weight: 80
...
Bu koleksiyonun üst görevi olan ve belirtilen Uid'ye sahip bir görevi döndürür.
...
belirtilen uid'ye sahip ve bu koleksiyonun üst görevi olan [`Task`](../../task/) sınıfının örneğini döndürür.
