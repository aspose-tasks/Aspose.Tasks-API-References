...
description: "TaskCollection yöntemi. Bu koleksiyonun üst görevi olan, belirtilen Id'ye sahip bir görevi döndürür."
type: docs
weight: 70
url: /tr/net/aspose.tasks/taskcollection/getbyid/
---
## TaskCollection.GetById method

Bu koleksiyonun üst görevi olan ve belirtilen Id'ye sahip bir görevi döndürür.
...
| --- | --- | --- |
| kimlik | Int32 | TaskEntity Id |

### Dönüş Değeri

belirtilen kimliğe sahip ve üst öğesi bu koleksiyonun ana görevi olan [`Task`](../../task/) sınıfının bir örneğini döndürür.
