...
description: "Project özelliği. Tüm kaynak tabanlı grup tanımlarını alır. ResourceGroups, Group nesnelerinden oluşan bir koleksiyondur."
type: docs
weight: 770
...
Tüm kaynak tabanlı grup tanımlarını alır. ResourceGroups, [`Group`](../../group/) nesnelerinden oluşan bir koleksiyondur.
...
Kaynak gruplarının nasıl okunacağını gösterir.
