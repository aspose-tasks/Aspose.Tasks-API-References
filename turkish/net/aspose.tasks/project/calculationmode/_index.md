...
description: "Project özelliği. Bir projenin hesaplama modunu alır veya ayarlar. CalculationMode enumerasyonunun değerlerinden biri olabilir."
type: docs
weight: 110
...
Bir projenin hesaplama modunu alır veya ayarlar. `CalculationMode` enumerasyonunun değerlerinden biri olabilir.
...
Proje hesaplama modunun nasıl kullanılacağını gösterir.
