...
description: "Project özelliği. Tüm görev tabanlı filtre tanımlarını alır. TaskFilters, Filter nesnelerinden oluşan bir koleksiyondur."
type: docs
weight: 910
...
Tüm görev tabanlı filtre tanımlarını alır. TaskFilters, [`Filter`](../../filter/) nesnelerinden oluşan bir koleksiyondur.
...
Proje görev filtrelerinin nasıl okunacağını gösterir.
