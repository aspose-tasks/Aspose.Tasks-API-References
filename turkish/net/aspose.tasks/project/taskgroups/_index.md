...
description: "Project özelliği. Tüm görev tabanlı grup tanımlarını alır. TaskGroups, Group nesnelerinden oluşan bir koleksiyondur"
type: docs
weight: 920
...
Görev tabanlı grup tanımlarının tümünü alır. TaskGroups, [`Group`](../../group/) nesnelerinden oluşan bir koleksiyondur.
...
Görev gruplarının nasıl okunacağını gösterir.
