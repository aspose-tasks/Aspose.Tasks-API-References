...
description: "Project yöntemi. Tamamlanmamış proje işini belirtilen bir tarihten sonra başlayacak şekilde yeniden zamanlar."
type: docs
weight: 1190
...
Tamamlanmamış proje işini belirtilen tarihten sonra başlayacak şekilde yeniden zamanlar.
...
| --- | --- | --- |
| sonra | DateTime | Tamamlanmamış işi yeniden zamanlamak için tarih. |
...
Belirtilen görev listesi için tamamlanmamış işi, belirtilen tarihten sonra başlayacak şekilde yeniden zamanlar.
...
| --- | --- | --- |
| sonra | DateTime | Tamamlanmamış işi yeniden zamanlamak için tarih. |
| taskCollection | List`1 | Tamamlanmamış işi yeniden zamanlamak için görevlerin List&lt;Task&gt;. |
