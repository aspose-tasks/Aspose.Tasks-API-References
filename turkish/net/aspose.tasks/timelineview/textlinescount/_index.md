...
description: "TimelineView özelliği. Zaman çizelgesinde görevi görüntülemek için kaç satır kullanılacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 80
...
Zaman çizelgesinde görevi görüntülemek için kaç satır kullanılacağını belirten bir değeri alır veya ayarlar.
