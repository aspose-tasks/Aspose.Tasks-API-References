...
description: "OutlineValue özelliği. Outline değerinin daraltılmış olup olmadığını gösteren bir değeri alır veya ayarlar."
type: docs
weight: 40
...
Taslak değerinin daraltılmış olup olmadığını gösteren bir değeri alır veya ayarlar.
