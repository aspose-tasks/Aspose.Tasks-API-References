...
description: "OutlineValue özelliği. Bu değeri tüm projedeki diğerlerinden ayırt eden bir GUID alır."
type: docs
weight: 80
...
Bu değeri tüm projedeki diğer değerler arasında tanımlayan bir GUID alır.
