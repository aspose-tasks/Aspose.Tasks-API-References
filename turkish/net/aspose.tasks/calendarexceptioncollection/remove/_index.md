...
description: "CalendarExceptionCollection metodu. Bu koleksiyondan CalendarException örneğini kaldırır"
type: docs
weight: 80
...
Bu koleksiyondan [`CalendarException`](../../calendarexception/) örneğini kaldırır.
...
| --- | --- | --- |
| öğe | CalendarException | Kaldırılacak öğe. |

### Dönüş Değeri

Belirtilen istisna başarıyla kaldırıldıysa doğru.
