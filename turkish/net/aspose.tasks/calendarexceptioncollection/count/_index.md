...
description: "CalendarExceptionCollection özelliği. Bu CalendarExceptionCollection nesnesinde bulunan nesne sayısını alır"
type: docs
weight: 10
...
Bu [`CalendarExceptionCollection`](../) nesnesinde bulunan nesne sayısını alır.
