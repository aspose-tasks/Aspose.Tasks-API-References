...
description: "CalendarExceptionCollection metodu. İstisnalar aralığını iç listeye ekler."
type: docs
weight: 50
...
İç listeye istisna aralığını ekler.
...
| --- | --- | --- |
| exceptionList | IEnumerable`1 | Eklenecek istisnalar aralığı. |
