...
description: "WBSCodeMaskCollection yöntemi. Bir WBSCodeMaskCollection'ı WBSCodeMask nesnelerinden oluşan bir listeye dönüştürür"
type: docs
weight: 90
...
WBSCodeMaskCollection'ı [`WBSCodeMask`](../../wbscodemask/) nesnelerinden oluşan bir listeye dönüştürür.
...
Genel bir [`WBSCodeMask`](../../wbscodemask/) nesnesi listesi.
