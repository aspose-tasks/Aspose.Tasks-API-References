...
description: "TimephasedDataCollection yöntemi. Bu koleksiyon nesnesine bir TimephasedData örneği ekler."
type: docs
weight: 40
...
Bu koleksiyon nesnesine [`TimephasedData`](../../timephaseddata/) örneğini ekler.
...
| --- | --- | --- |
| öğe | TimephasedData | Eklenecek öğe. |

### İstisnalar

| istisna | koşul |
| --- | --- |
| ArgumentNullException | eğer td parametresi null ise. |
