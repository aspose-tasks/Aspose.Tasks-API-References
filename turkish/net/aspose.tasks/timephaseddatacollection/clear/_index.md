...
description: "TimephasedDataCollection yöntemi. TimephasedDataCollection içindeki tüm öğeleri kaldırır."
type: docs
weight: 60
...
[`TimephasedDataCollection`](../) içindeki tüm öğeleri kaldırır.
