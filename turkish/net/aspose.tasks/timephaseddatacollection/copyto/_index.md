...
description: "TimephasedDataCollection yöntemi. TimephasedDataCollection öğelerini belirli bir Array indeksinden başlayarak bir Array'e kopyalar."
type: docs
weight: 80
...
[`TimephasedDataCollection`](../) öğelerini bir Array'e, belirli bir Array indeksinden başlayarak kopyalar.
...
| --- | --- | --- |
| array | TimephasedData[] | [`TimephasedDataCollection`](../) öğelerinin kopyalandığı hedef tek boyutlu Array. Array sıfır tabanlı indekslemeye sahip olmalıdır. |
...
| ArgumentException | Kaynak [`TimephasedDataCollection`](../) içindeki öğe sayısı, hedef *array*'ın *arrayIndex* konumundan sonuna kadar olan kullanılabilir alandan daha fazladır. |
