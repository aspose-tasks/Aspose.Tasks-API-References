...
description: "TimephasedDataCollection özelliği. Bu TimephasedDataCollection nesnesinde bulunan nesne sayısını alır."
type: docs
weight: 10
...
Bu [`TimephasedDataCollection`](../) nesnesinde bulunan nesne sayısını alır.
