...
description: "TimephasedDataCollection yöntemi. Bu koleksiyon nesnesinden TimephasedData örneğini kaldırır."
type: docs
weight: 100
...
[`TimephasedData`](../../timephaseddata/) örneğini bu koleksiyon nesnesinden kaldırır.
...
| --- | --- | --- |
| öğe | TimephasedData | Kaldırılacak öğe. |

### Dönüş Değeri

Eğer *item* başarıyla [`TimephasedDataCollection`](../) koleksiyonundan kaldırıldıysa true; aksi takdirde false. Bu yöntem ayrıca *item* [`TimephasedDataCollection`](../) içinde bulunamazsa false döndürür.
