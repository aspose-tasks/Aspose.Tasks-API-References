...
description: "TimephasedDataCollection yöntemi. startTime ve finishTime arasındaki tüm zaman aşamalarını seçer. Ortalama durumda Olog n karmaşıklığa sahiptir."
type: docs
weight: 110
...
*startTime* ve *finishTime* arasındaki tüm zaman aşamalarını seçer. Ortalama durumda O(log n) karmaşıklığa sahiptir.
...
| --- | --- | --- |
| timephasedDataType | TimephasedDataType | Seçilecek zaman aşamalarının türü. |
| startTime | DateTime | Aralığın başlangıcı. |
| finishTime | DateTime | Aralığın sonu. |

### Dönüş Değeri

Start özelliğine göre sıralanmış yeni bir [`TimephasedDataCollection`](../) veri listesi döndürür.
