...
description: "TimephasedDataCollection yapıcı. TimephasedDataCollection sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
[`TimephasedDataCollection`](../) sınıfının yeni bir örneğini başlatır.
