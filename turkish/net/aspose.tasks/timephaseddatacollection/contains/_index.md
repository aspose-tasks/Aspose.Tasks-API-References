...
description: "TimephasedDataCollection yöntemi. TimephasedDataCollection içinde belirli bir değerin olup olmadığını belirler"
type: docs
weight: 70
...
[`TimephasedDataCollection`](../) içinde belirli bir değerin olup olmadığını belirler.
...
| --- | --- | --- |
| öğe | TimephasedData | Koleksiyonda bulunacak nesne. |

### Dönüş Değeri

Eğer *item* koleksiyonda bulunursa true; aksi takdirde false.
