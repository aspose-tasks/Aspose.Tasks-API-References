...
description: "TimephasedDataCollection özelliği. ICollection'ın yalnızca okunur olup olmadığını gösteren bir değer alır."
type: docs
weight: 20
...
ICollection'ın yalnızca okunur olup olmadığını gösteren bir değeri alır.
