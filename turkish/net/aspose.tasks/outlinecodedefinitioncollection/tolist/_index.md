...
description: "OutlineCodeDefinitionCollection yöntemi. Bu OutlineCodeDefinitionCollection nesnesini OutlineCodeDefinition nesnelerinin bir listesine dönüştürür"
type: docs
weight: 130
url: /tr/net/aspose.tasks/outlinecodedefinitioncollection/tolist/
---
## OutlineCodeDefinitionCollection.ToList method

Bu OutlineCodeDefinitionCollection nesnesini bir [`OutlineCodeDefinition`](../../outlinecodedefinition/) nesneleri listesine dönüştürür.
...
[`OutlineCodeDefinition`](../../outlinecodedefinition/) nesnelerinin listesi.
