...
description: "Aspose.Tasks.FontFaceType enum. Yazı tipi yüzü türlerini sıralar"
type: docs
weight: 650
...
Yazı tipi yüzü türlerini sıralar
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| NotSpecified | `0` | Yazı tipi belirtilmemiştir. |
| Ttf | `1` | TrueType yazı tipi. |
| Eot | `2` | EOT yazı tipi. |
