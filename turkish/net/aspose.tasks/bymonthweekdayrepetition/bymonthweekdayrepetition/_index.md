...
description: "ByMonthWeekDayRepetition yapıcı. ByMonthWeekDayRepetition sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
[`ByMonthWeekDayRepetition`](../) sınıfının yeni bir örneğini başlatır.
