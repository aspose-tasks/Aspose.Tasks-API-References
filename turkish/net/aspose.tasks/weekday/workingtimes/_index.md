...
description: "WeekDay özelliği. Bu WeekDay örneği için WorkingTimeCollection'ı alır. Hafta günü üzerinde çalışılan zamanı tanımlayan çalışma süreleri koleksiyonu."
type: docs
weight: 70
...
Bu WeekDay örneği için WorkingTimeCollection'ı alır. Hafta içi çalışılan zamanı tanımlayan çalışma zamanları koleksiyonu.
