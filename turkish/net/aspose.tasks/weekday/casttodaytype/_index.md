...
description: "WeekDay yöntemi. .Nets DayOfWeek değerini DayType'a dönüştürür"
type: docs
weight: 120
...
.Net'in DayOfWeek değerini [`DayType`](../daytype/) tipine dönüştürür.
...
| --- | --- | --- |
| dw | DayOfWeek | Dönüştürülecek hafta günü. |

### Dönüş Değeri

Bir dönüştürme gün tipi.
