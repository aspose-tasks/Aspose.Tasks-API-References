...
description: "TimephasedData özelliği. Bu nesnenin dize değerini temsil eden TimeSpan örneğini alır"
type: docs
weight: 120
...
Bu nesnenin string değerini temsil eden TimeSpan örneğini alır.
...
nesnenin bir zaman aralığı temsili.
