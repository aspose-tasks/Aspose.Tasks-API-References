...
description: "TimephasedData yöntemi. Bir malzeme kaynağının atamasına ait birim tabanlı zaman aşamalı veri için TimephasedData sınıfının yeni bir örneğini oluşturur ve başlatır."
type: docs
weight: 30
...
Yeni bir örnek oluşturur ve başlatır; bu, bir malzeme kaynağının atamasına ait birim tabanlı zaman aşamalı veri için [`TimephasedData`](../) sınıfıdır.
...
Maliyet temelli zaman aşamalı veri için [`TimephasedData`](../) sınıfının bir örneği.

### İstisnalar

| istisna | koşul |
| --- | --- |
| ArgumentException | Negatif bir birim miktarı belirtilmişse. |
