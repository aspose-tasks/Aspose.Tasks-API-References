...
description: "TimephasedData özelliği. Zaman aşamalı veri dönemi için birim zaman başına değeri alır veya ayarlar"
type: docs
weight: 100
...
Zaman aşamalı veri dönemi için birim zaman başına değeri alır veya ayarlar.
...
| istisna | koşul |
| --- | --- |
| [TasksException](../../tasksexception/) | Belirtilen [`TimephasedDataType`](../timephaseddatatype/) için değer yanlış olduğunda veya negatif bir değer içeriyorsa. |
