...
description: "TimephasedData özelliği. Bu nesnenin string değerini temsil eden Double örneğini alır."
type: docs
weight: 110
...
Bu nesnenin string değerini temsil eden Double örneğini alır.
