...
description: "TimephasedData özelliği. Birim tabanlı zaman aşamalı veri için bu nesnenin dize değerini temsil eden Double örneğini alır"
type: docs
weight: 130
...
Birim tabanlı zaman aşamalı veri için bu nesnenin string değerini temsil eden Double örneğini alır.
...
bu nesnenin kayan nokta temsili.
