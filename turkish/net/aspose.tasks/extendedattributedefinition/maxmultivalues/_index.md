...
description: "ExtendedAttributeDefinition özelliği. Bir seçim listesinde ayarlayabileceğiniz maksimum değer sayısını alır veya ayarlar"
type: docs
weight: 190
...
Seçim listesinde ayarlayabileceğiniz maksimum değer sayısını alır veya ayarlar.
