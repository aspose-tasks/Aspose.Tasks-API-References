...
description: "ExtendedAttributeDefinition yöntemi. Arama (lookup) içeren bir genişletilmiş nitelik tanımı oluşturan fabrika yöntemi. CalculationType değeri Lookup olarak ayarlanmıştır ve yalnızca Kaynaklarda kullanılabilir. Bu yöntemi çağırırken fieldId ve alias belirtmeniz gerekir. Alan türü field id’den çıkarılır."
type: docs
weight: 10
...
Arama içeren bir genişletilmiş nitelik tanımı oluşturan fabrika yöntemi. [`CalculationType`](../calculationtype/) değeri Lookup olarak ayarlanmıştır ve yalnızca Kaynaklarda kullanılabilir. Bu yöntemi çağırırken *fieldId* ve *alias* belirtmeniz gerekir. Alan türü field id’den çıkarılır.
...
Kaynak için arama içeren bir özel alan tanımı oluşturmak ve ardından metin değerleriyle doldurmak için bu örneği kullanın:
...
Arama içeren bir genişletilmiş nitelik tanımı oluşturan fabrika yöntemi. [`CalculationType`](../calculationtype/) değeri Lookup olarak ayarlanmıştır ve yalnızca Kaynaklarda kullanılabilir. Bu yöntemi çağırırken *customFieldType*, *fieldId* ve *alias* belirtmeniz gerekir.
