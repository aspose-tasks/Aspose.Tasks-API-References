...
description: "ExtendedAttributeDefinition özelliği. Atamalara otomatik aşağı kaydırmanın etkin olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 70
...
Atamalara otomatik olarak aşağı doğru yayılmanın etkin olup olmadığını gösteren bir değeri alır veya ayarlar.
