...
description: "ExtendedAttributeDefinition özelliği. Özel bir alanın alias (takma ad) değerini alır veya ayarlar"
type: docs
weight: 50
url: /tr/net/aspose.tasks/extendedattributedefinition/alias/
---
## ExtendedAttributeDefinition.Alias property

Özel alanın takma adını alır veya ayarlar.
