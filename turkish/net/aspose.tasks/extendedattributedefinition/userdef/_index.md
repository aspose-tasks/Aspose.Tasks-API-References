...
description: "ExtendedAttributeDefinition özelliği. Özel bir alanın kullanıcı tanımlı olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 270
...
Özel bir alanın kullanıcı tanımlı olup olmadığını gösteren bir değeri alır veya ayarlar.
