...
description: "ExtendedAttributeDefinition yöntemi. İç dahili arama listesine bir değer ekler. Bu, ValueList ile manipülasyonlar için tercih edilen bir yoldur"
type: docs
weight: 300
...
İç dahili arama listesine bir değer ekler. Bu, [`ValueList`](../valuelist/) ile manipülasyonlar için tercih edilen bir yoldur.
...
| --- | --- | --- |
| value | Değer | Aramaya eklenmek üzere değer. |
