...
description: "ExtendedAttributeDefinition özelliği. Özel bir alanın proje kimliğine karşılık gelen değeri alır veya ayarlar. FieldId özelliğini belirtmek için ExtendedAttributeTask sınıfındaki bir sabitin string temsilini kullanın"
type: docs
weight: 130
...
Özel bir alanın proje kimliğine karşılık gelen değeri alır veya ayarlar. `FieldId` özelliğini belirtmek için [`ExtendedAttributeTask`](../../extendedattributetask/) sınıfındaki bir sabitin string temsilini kullanın.
...
`FieldId` özelliğini ayarlamanın tercih edilen yolu, [`ExtendedAttributeDefinition`](../) sınıfını, [`CreateTaskDefinition`](../createtaskdefinition/) veya [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) gibi özel fabrika yöntemlerinden birini kullanarak oluşturmaktır.
