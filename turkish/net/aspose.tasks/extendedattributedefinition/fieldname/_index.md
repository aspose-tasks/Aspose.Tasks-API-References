...
description: "ExtendedAttributeDefinition özelliği. Özel bir alanın adını alır"
type: docs
weight: 140
...
Doğrudan ayarlanmamalıdır, bunun yerine Create*Definition() gibi adlandırılmış güçlü tipli statik fabrika yöntemlerini kullanarak ExtendedAttributeDefinition oluşturun.
