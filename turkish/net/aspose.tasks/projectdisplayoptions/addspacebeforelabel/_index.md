...
description: "ProjectDisplayOptions özelliği. Sayı değerinden ve zaman kısaltması 1 wk'den önce bir boşluk eklenip eklenmeyeceğini belirten bir değeri alır veya ayarlar (1wk yerine)."
type: docs
weight: 20
...
Sayı değeri ve zaman kısaltması (1 wk yerine 1wk) önüne boşluk eklenip eklenmeyeceğini gösteren bir değeri alır veya ayarlar.
