...
description: "ProjectDisplayOptions yapıcı. ProjectDisplayOptions sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
[`ProjectDisplayOptions`](../) sınıfının yeni bir örneğini başlatır.
