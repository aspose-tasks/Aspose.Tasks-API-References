...
description: "ProjectDisplayOptions özelliği. Tüm proje hakkında özet bilgiyi Gantt Chart view'in üst kısmındaki kendi özet görev çubuğu ile tek bir satırda gösterilip gösterilmeyeceğini belirten bir değeri alır veya ayarlar"
type: docs
weight: 70
...
Gantt Şeması görünümünün üst kısmında kendi özet görev çubuğuna sahip tek bir satırda tüm proje hakkında özet bilgilerin görüntülenip görüntülenmeyeceğini gösteren bir değeri alır veya ayarlar.
