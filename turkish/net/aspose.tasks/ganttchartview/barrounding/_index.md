...
description: "GanttChartView özelliği. Çubukların en yakın güne yuvarlanıp yuvarlanmayacağını belirten bir değeri alır veya ayarlar. Varsayılan değer True'tir"
type: docs
weight: 30
...
Çubukların en yakın güne yuvarlanıp yuvarlanmayacağını belirten bir değeri alır veya ayarlar. Varsayılan değer True'tır.
