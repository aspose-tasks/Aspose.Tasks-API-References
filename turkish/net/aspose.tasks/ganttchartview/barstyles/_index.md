...
description: "GanttChartView özelliği. Gantt Chart görünümünün üst ortak çubuk stillerinin listesini alır. GanttBarStyle"
type: docs
weight: 50
url: /tr/net/aspose.tasks/ganttchartview/barstyles/
---
## GanttChartView.BarStyles property

Gantt Chart görünümünün üst (ortak) çubuk stillerinin listesini alır. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
