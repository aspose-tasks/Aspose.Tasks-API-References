...
description: "Baseline yöntemi. Bu örneğin belirtilen bir nesneden daha küçük olup olmadığını gösteren bir değer döndürür"
type: docs
weight: 140
url: /tr/net/aspose.tasks/baseline/op_lessthan/
---
## Baseline LessThan operator

Bu örneğin belirtilen nesneden küçük olup olmadığını gösteren bir değer döndürür.
...
Bu örneğin belirtilen bir nesneden daha küçük olup olmadığını gösteren bir değer
