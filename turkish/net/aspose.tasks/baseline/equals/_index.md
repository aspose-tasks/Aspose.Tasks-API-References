...
description: "Baseline yöntemi. Bu örneğin belirtilen bir nesneye eşit olup olmadığını gösteren bir değer döndürür"
type: docs
weight: 80
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| diğer | Baseline | bu örnekle karşılaştırılacak belirtilen nesne. |
