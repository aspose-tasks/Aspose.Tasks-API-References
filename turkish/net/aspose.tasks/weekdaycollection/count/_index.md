...
description: "WeekDayCollection özelliği. Bu WeekDayCollection nesnesinde bulunan nesne sayısını alır"
type: docs
weight: 10
...
Bu [`WeekDayCollection`](../) nesnesinde bulunan nesne sayısını alır.
