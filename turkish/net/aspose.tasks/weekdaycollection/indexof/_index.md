...
description: "WeekDayCollection yöntemi. Belirtilen WeekDay'in dizinini döndürür"
type: docs
weight: 80
...
Belirtilen [`WeekDay`](../../weekday/) öğesinin dizinini döndürür.
...
Belirtilen [`WeekDay`](../../weekday/) öğesinin sıfır tabanlı dizini, mevcutsa, aksi takdirde -1.
