...
description: "WeekDayCollection yöntemi. Koleksiyonun belirtilen WeekDay'i içerip içermediğini kontrol eder"
type: docs
weight: 50
...
Koleksiyonun [`WeekDay`](../../weekday/) belirtilen öğesini içerip içermediğini kontrol eder.
...
| --- | --- | --- |
| öğe | WeekDay | Kontrol edilecek öğe. |

### Dönüş Değeri

Koleksiyon belirtilen öğeyi içeriyorsa true, aksi takdirde false.
