...
description: "WeekDayCollection yöntemi. Belirtilen WeekDay'ı varsa kaldırır"
type: docs
weight: 100
...
Belirtilen [`WeekDay`](../../weekday/) varsa kaldırır.
...
| --- | --- | --- |
| öğe | WeekDay | Kaldırılacak öğe. |

### Dönüş Değeri

Doğru, eğer [`WeekDay`](../../weekday/) kaldırıldıysa; bulunamadıysa yanlış.
