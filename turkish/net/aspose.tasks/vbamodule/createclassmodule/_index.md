...
description: "VbaModule yöntemi. VbaModuleType.ClassModule türüyle bir VbaModule örneği oluşturur."
type: docs
weight: 10
url: /tr/net/aspose.tasks/vbamodule/createclassmodule/
---
## VbaModule.CreateClassModule method

[`VbaModule`](../) örneğini VbaModuleType.ClassModule türüyle oluşturur.
