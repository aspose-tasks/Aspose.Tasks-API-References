...
description: "OutlineMask özelliği. Çizim kodu değerlerinin karakter cinsinden maksimum uzunluğunu alır veya ayarlar. Uzunluk tanımlı değilse 0."
type: docs
weight: 20
...
Taslak kod değerlerinin maksimum uzunluğunu (karakter cinsinden) alır veya ayarlar. Uzunluk tanımlı değilse 0.
