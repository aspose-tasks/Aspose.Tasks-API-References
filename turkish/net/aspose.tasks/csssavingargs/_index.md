---
title: "Sınıf CssSavingArgs"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.CssSavingArgs sınıfı. Bu sınıf, HTML formatına dönüşüm sırasında gerçekleşen harici CSS dosyalarının kaydedilmesiyle ilgili veri kümesini temsil eder"
type: docs
weight: 360
...
Bu sınıf, HTML formatına dönüştürme sırasında gerçekleşen harici CSS dosyasının kaydedilmesiyle ilgili veri kümesini temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Yeni bir `CssSavingArgs` sınıfının örneğini başlatır. |
...
CSS kaydetme argümanlarının nasıl belirtileceğini gösterir.
