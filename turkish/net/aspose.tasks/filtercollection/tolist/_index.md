...
description: "FilterCollection yöntemi. Bir filtre koleksiyonunu Filter nesnelerinden oluşan bir listeye dönüştürür"
type: docs
weight: 90
...
Bir filtre koleksiyonunu [`Filter`](../../filter/) nesnelerinden oluşan bir listeye dönüştürür.
...
Genel bir liste [`Filter`](../../filter/) nesnelerinin.
