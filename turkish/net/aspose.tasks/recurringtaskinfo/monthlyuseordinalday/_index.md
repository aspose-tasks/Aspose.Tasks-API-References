...
description: "RecurringTaskInfo özelliği. Aylık yineleme deseninde sıralı gün kullanılıp kullanılmayacağını gösteren bir değeri alır veya ayarlar."
type: docs
weight: 100
...
Aylık yineleme deseni için ordinal gün kullanılacağını gösteren bir değeri alır veya ayarlar.
