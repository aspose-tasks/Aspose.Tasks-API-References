...
description: "RecurringTaskInfo özelliği. Yinelenen görev için bitiş tarihini mi yoksa gerçekleşme sayısını mı kullanacağını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 150
...
Yinelenen görev için bitiş tarihini mi yoksa bir tekrar sayısını mı kullanacağını gösteren bir değeri alır veya ayarlar.
