...
description: "RecurringTaskInfo özelliği. Aylık yinelenme deseninin sıralı numarasını alır veya ayarlar. OrdinalNumber enumeration değerlerinden biri olabilir"
type: docs
weight: 70
...
Aylık yinelenme deseninin sıralı numarasını alır veya ayarlar. [`OrdinalNumber`](../../ordinalnumber/) enumeration değerlerinden biri olabilir
