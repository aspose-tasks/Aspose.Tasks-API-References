...
description: "RecurringTaskInfo özelliği. Sıralı gün kullanıldığında aylık yineleme deseninin bir gününü alır veya ayarlar. DayOfWeek enum değerlerinden biri olabilir."
type: docs
weight: 60
...
Ordinal gün kullanıldığında aylık yineleme deseninin gününü alır veya ayarlar. DayOfWeek enumarasyonunun değerlerinden biri olabilir.
