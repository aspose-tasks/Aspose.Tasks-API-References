...
description: "RecurringTaskInfo özelliği. Sıralı gün kullanıldığında aylık yineleme deseninin tekrar sayısını alır veya ayarlar."
type: docs
weight: 80
...
Ordinal gün kullanıldığında aylık yineleme deseninin tekrar sayısını alır veya ayarlar.
