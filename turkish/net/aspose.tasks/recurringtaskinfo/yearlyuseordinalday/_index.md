...
description: "RecurringTaskInfo özelliği. Yıllık yinelenme deseninde sıralı günü kullanıp kullanmayacağını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 220
...
Yıllık yineleme deseni için ordinal gün kullanılacağını gösteren bir değeri alır veya ayarlar.
