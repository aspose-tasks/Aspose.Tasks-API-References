...
description: "RecurringTaskInfo özelliği. Sıralı gün kullanıldığında yıllık yinelenme deseninin ayını alır veya ayarlar. Month enumeration değerlerinden biri olabilir"
type: docs
weight: 200
...
Sıralı gün kullanıldığında yıllık yinelenme deseninin ayını alır veya ayarlar. [`Month`](../../month/) enumeration değerlerinden biri olabilir
