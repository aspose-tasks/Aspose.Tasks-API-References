...
description: "RecurringTaskInfo özelliği. Tekrarlayan görevin bir yineleme desenini alır veya ayarlar. RecurrencePattern sayımının değerlerinden biri olabilir"
type: docs
weight: 120
...
Tekrarlayan görevin bir yineleme desenini alır veya ayarlar. `RecurrencePattern` sayımının değerlerinden biri olabilir.
