...
description: "RecurringTaskInfo özelliği. Yıllık yinelenme deseninin sıralı numarasını alır veya ayarlar. OrdinalNumber enumeration değerlerinden biri olabilir"
type: docs
weight: 210
...
Yıllık yinelenme deseninin sıralı numarasını alır veya ayarlar. [`OrdinalNumber`](../../ordinalnumber/) enumeration değerlerinden biri olabilir
