...
description: "OutlineCodeDefinition özelliği. Özelleştirilmiş ana hat kodunun Microsoft Project'teki Kaynak Değiştirme Sihirbazı tarafından kullanılabilir olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 130
...
Özel outline kodunun Microsoft Project'teki Kaynak Değiştirme Sihirbazı tarafından kullanılabilir olup olmadığını gösteren bir değeri alır veya ayarlar.
