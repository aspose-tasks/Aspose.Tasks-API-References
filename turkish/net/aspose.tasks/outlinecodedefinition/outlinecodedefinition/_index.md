...
description: "OutlineCodeDefinition yapıcı. OutlineCodeDefinition sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
Yeni bir [`OutlineCodeDefinition`](../) sınıfının örneğini başlatır.
