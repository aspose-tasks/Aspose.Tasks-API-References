...
description: "OutlineCodeDefinition özelliği. Özel bir outline kodunun kurumsal özel outline kodu olup olmadığını belirten bir değeri alır veya ayarlar"
type: docs
weight: 40
...
Özel bir outline kodunun kurumsal özel outline kodu olup olmadığını gösteren bir değeri alır veya ayarlar.
