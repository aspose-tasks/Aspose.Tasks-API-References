...
description: "OutlineCodeDefinition özelliği. Yeni kodların tüm seviyelere sahip olması gerekip gerekmediğini belirten bir değeri alır veya ayarlar. Kurumsal kodlar için mevcut değildir"
type: docs
weight: 30
...
Yeni kodların tüm seviyelere sahip olup olmadığını gösteren bir değeri alır veya ayarlar. Enterprise Kodları için mevcut değildir.
