...
description: "ExtendedAttributeDefinitionCollection özelliği. Bu koleksiyonun yalnızca okunur olup olmadığını gösteren bir değer alır."
type: docs
weight: 20
...
Bu koleksiyonun yalnızca okunur olup olmadığını gösteren bir değeri alır.
