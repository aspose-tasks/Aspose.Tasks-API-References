...
description: "ExtendedAttributeDefinitionCollection yöntemi. Bu ExtendedAttributeDefinitionCollection nesnesini ExtendedAttributeDefinition sınıfının örneklerini içeren bir listeye dönüştürür"
type: docs
weight: 150
...
Bu ExtendedAttributeDefinitionCollection nesnesini [`ExtendedAttributeDefinition`](../../extendedattributedefinition/) sınıfının örneklerini içeren bir listeye dönüştürür.
...
[`ExtendedAttributeDefinition`](../../extendedattributedefinition/) sınıfının örneklerini içeren liste.
