...
description: "ExtendedAttributeDefinitionCollection yöntemi. Bu koleksiyonun öğelerini belirtilen diziye, belirtilen dizi indeksinden başlayarak kopyalar"
type: docs
weight: 80
...
| --- | --- | --- |
| dizi | ExtendedAttributeDefinition[] | Elemanların kopyalanacağı belirtilen tek boyutlu dizi. |
