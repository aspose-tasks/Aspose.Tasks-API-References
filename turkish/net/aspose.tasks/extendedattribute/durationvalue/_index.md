...
description: "ExtendedAttribute özelliği. Süre tipindeki öznitelikler için değer alır veya ayarlar"
type: docs
weight: 30
...
'Duration' türündeki öznitelikler için değeri alır veya ayarlar.
...
| istisna | koşul |
| --- | --- |
| InvalidOperationException | Eğer [`AttributeDefinition`](../attributedefinition/) özelliği başlatılmamışsa veya [`AttributeDefinition`](../attributedefinition/) özelliğinin özel alan türü bir [`Duration`](../../duration/) örneği değilse fırlatılır. |
