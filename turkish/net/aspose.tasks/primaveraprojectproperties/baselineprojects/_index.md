...
description: "PrimaveraProjectProperties özelliği. Mevcut projenin temel projeler dizisini alır. Dışa aktarılmış temel verileri içeren Primavera XML dosyalarından okunan projeler için geçerlidir."
type: docs
weight: 10
url: /tr/net/aspose.tasks/primaveraprojectproperties/baselineprojects/
---
## PrimaveraProjectProperties.BaselineProjects property

Mevcut projenin temel proje dizisini alır. Dışa aktarılmış temel verileri içeren Primavera XML dosyalarından okunan projeler için geçerlidir.
