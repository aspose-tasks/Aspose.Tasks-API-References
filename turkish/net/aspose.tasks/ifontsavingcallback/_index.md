---
title: "Arayüz IFontSavingCallback"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.IFontSavingCallback arayüzü. Fontları depolamak için kaynak oluşturmak üzere çağrılan bir geri aramayı temsil eder."
type: docs
weight: 860
...
| Ad | Açıklama |
| --- | --- |
| [FontSaving](../../aspose.tasks/ifontsavingcallback/fontsaving/)(FontSavingArgs) | Fontları kaydederken çağrılacak yöntem. |

## Örnekler

Font kaydetme geri aramalarıyla nasıl çalışılacağını gösterir.
