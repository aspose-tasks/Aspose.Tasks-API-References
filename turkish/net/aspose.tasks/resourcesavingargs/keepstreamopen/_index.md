...
description: "ResourceSavingArgs özelliği. Kaynak kaydetme tamamlandıktan sonra akışın açık kalıp kalmayacağını belirten bir değeri alır veya ayarlar"
type: docs
weight: 30
...
Kaynak kaydedildikten sonra akışın açık kalıp kalmayacağını gösteren bir değeri alır veya ayarlar.
