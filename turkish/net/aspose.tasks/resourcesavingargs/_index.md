---
title: "Sınıf ResourceSavingArgs"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.ResourceSavingArgs sınıfı. Bu sınıf, HTML formatına dönüştürme sırasında gerçekleşen dış kaynak dosyalarının kaydedilmesiyle ilgili veri kümesini temsil eder."
type: docs
weight: 1790
...
| Ad | Açıklama |
| --- | --- |
| [ResourceSavingArgs](resourcesavingargs/)() | Varsayılan yapıcı. |
