...
description: "View özelliği. PageInfo sınıfının bir örneğini alır. mpp dosya formatında bulunan sayfa ayarı verilerini temsil eder."
type: docs
weight: 60
...
`PageInfo` sınıfının bir örneğini alır. mpp dosya formatında bulunan sayfa ayarı verilerini temsil eder.
