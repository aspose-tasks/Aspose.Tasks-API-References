...
description: Bir koleksiyonu temsil ederWorkingTimeCollection./workingtimecollection nesneler.
type: docs
weight: 3290
...
Bir koleksiyonu temsil eder[`WorkingTimeCollection`](../workingtimecollection) nesneler.
...
| İsim | Tanım |
| --- | --- |
| [Count](../../aspose.tasks/workingtimecollection/count) { get; } | Burada bulunan nesnelerin sayısını alır[`WorkingTimeCollection`](../workingtimecollection) nesne. |
...
| [CopyTo](../../aspose.tasks/workingtimecollection/copyto)(WorkingTime[], int) | , belirli bir index 'den başlayarak bir koleksiyon içeriğini bir Diziye kopyalar. |
