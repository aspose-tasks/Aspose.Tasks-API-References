...
description: "WorkingTimeCollection yöntemi. Bu koleksiyondan WorkingTime örneğini kaldırır."
type: docs
weight: 80
...
Bu koleksiyondan [`WorkingTime`](../../workingtime/) örneğini kaldırır.
...
| --- | --- | --- |
| öğe | WorkingTime | Kaldırılacak öğe. |

### Dönüş Değeri

Bu koleksiyondan WorkingTime örneği başarıyla kaldırıldıysa true; aksi takdirde false.
