...
description: "RateCollection yöntemi. Bu koleksiyona yeni bir Rate örneği ekler"
type: docs
weight: 50
...
Bu koleksiyona yeni bir [`Rate`](../../rate/) örneği ekler.
...
| --- | --- | --- |
| ratesFrom | DateTime | Yeni oranın yürürlüğe girdiği tarih. |
| tür | RateType | Eklenecek oran tablosu. |
