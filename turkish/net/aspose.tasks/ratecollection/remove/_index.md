...
description: "RateCollection yöntemi. Bu koleksiyondan Rate örneğini kaldırır"
type: docs
weight: 70
...
| --- | --- | --- |
| öğe | Rate | Kaldırılacak öğe. |

### Dönüş Değeri

Belirtilen Rate başarıyla kaldırıldıysa true; aksi takdirde false.
