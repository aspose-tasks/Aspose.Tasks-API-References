...
description: Aspose.Tasks.ResourceUsageView sınıf. Bir projede kaynak kullanım görünümünü temsil eder.
type: docs
weight: 1560
url: /tr/net/aspose.tasks/resourceusageview/
---
## ResourceUsageView class

Bir projede kaynak kullanım görünümünü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [AlignDetailsData](../../aspose.tasks/usageview/aligndetailsdata/) { get; set; } | Ayrıntılar veri hizalamasını alır veya ayarlar. |
...
| [DisplayDetailsHeaderColumn](../../aspose.tasks/usageview/displaydetailsheadercolumn/) { get; set; } | Görünümde ayrıntılar başlık sütununun görüntülenip görüntülenmeyeceğini belirten bir değer alır veya ayarlar. |
| [DisplayShortDetailHeaderNames](../../aspose.tasks/usageview/displayshortdetailheadernames/) { get; set; } | Kısa ayrıntılı başlık adlarının görüntülenip görüntülenmeyeceğini belirten bir değer alır veya ayarlar. |
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | Şunu alır:[`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) bu ResourceUsageView. nesnesi |
...
| [PageInfo](../../aspose.tasks/view/pageinfo/) { get; } | Bir örneğini alır[`PageInfo`](../view/pageinfo/)sınıf. mpp dosya biçiminde mevcut olan sayfa kurulum verilerini temsil eder. |
| [ParentProject](../../aspose.tasks/view/parentproject/) { get; } | View nesnesinin üst öğesini alır. Salt okunur[`Project`](../project/) . |
| [RepeatDetailsHeaderOnAllRows](../../aspose.tasks/usageview/repeatdetailsheaderonallrows/) { get; set; } | Ayrıntılar başlığının tüm atama satırında tekrarlanıp tekrarlanmayacağını belirten bir değer alır veya ayarlar. |
...
| [TopTimescaleTier](../../aspose.tasks/usageview/toptimescaletier/) { get; set; } | Görünümün en üst zaman ölçeği katmanının ayarlarını alır veya ayarlar. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) . |
