---
title: "Sınıf ResourceUsageView"
second_title: "Aspose.Tasks for .NET API Referansı"
description: "Aspose.Tasks.ResourceUsageView sınıfı. Bir projedeki kaynak kullanım görünümünü temsil eder"
type: docs
weight: 1810
...
Bir projedeki kaynak kullanım görünümünü temsil eder.
...
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | Bu ResourceUsageView'in [`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) nesnesini alır. |
...
Kaynak kullanım görünümünün nasıl oluşturulacağını gösterir.
...
SaveOptions options = new PdfSaveOptions
{
    ...
    // Presentation formatını ResourceUsage olarak ayarlayın
