...
description: Aspose.Tasks.SplitPartCollection sınıf. Bir görevin bölümlerini temsil eden koleksiyon.
type: docs
weight: 2010
...
| [Item](../../aspose.tasks/splitpartcollection/item/) { get; set; } | Verilen dizinde bir görevin bölünmüş kısmını alır. |
