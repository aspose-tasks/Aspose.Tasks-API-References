...
description: "TableCollection yöntemi. Bir tablo koleksiyonunu Table nesnelerinden oluşan bir listeye dönüştürür."
type: docs
weight: 90
...
Bir tablo koleksiyonunu [`Table`](../../table/) nesnelerinden oluşan bir listeye dönüştürür.
...
Genel bir [`Table`](../../table/) nesneleri listesi.
