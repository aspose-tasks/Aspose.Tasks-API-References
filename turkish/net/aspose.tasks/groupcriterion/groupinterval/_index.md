...
description: "GroupCriterion özelliği. Bir grup tanımında kriter olarak kullanılan bir alan için aralığı alır veya ayarlar"
type: docs
weight: 70
...
Bir grup tanımında kriter olarak kullanılan bir alanın aralığını alır veya ayarlar.
