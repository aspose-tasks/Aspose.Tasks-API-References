...
| ResourceBaseline1Finish | `205521245` | Temel1 Bitiş (Kaynak) alanını temsil eder. |
| ResourceBaseline1Start | `205521244` | Temel1 Başlangıç (Kaynak) alanını temsil eder. |
| ResourceBaseline1Work | `205521238` | Temel1 Çalışma (Kaynak) alanını temsil eder. |
| ResourceBaseline2BudgetCost | `205521661` | Temel2 Bütçe Maliyeti (Kaynak) alanını temsil eder. |
| ResourceBaseline2BudgetWork | `205521660` | Temel2 Bütçe Çalışması (Kaynak) alanını temsil eder. |
| ResourceBaseline2Cost | `205521249` | Temel2 Maliyet (Kaynak) alanını temsil eder. |
| ResourceBaseline2Finish | `205521255` | Temel2 Bitiş (Kaynak) alanını temsil eder. |
...
| ResourceBaselineCost | `205520913` | Temel Maliyet (Kaynak) alanını temsil eder. |
| ResourceBaselineFinish | `205521156` | Temel Bitiş (Kaynak) alanını temsil eder. |
...
| ResourceCost2 | `205521020` | Maliyet2 (Kaynak) alanını temsil eder. |
| ResourceCost3 | `205521021` | Maliyet3 (Kaynak) alanını temsil eder. |
| ResourceCost4 | `205521062` | Maliyet4 (Kaynak) alanını temsil eder. |
| ResourceCost5 | `205521063` | Maliyet5 (Kaynak) alanını temsil eder. |
| ResourceCost6 | `205521064` | Maliyet6 (Kaynak) alanını temsil eder. |
| ResourceCost7 | `205521065` | Maliyet7 (Kaynak) alanını temsil eder. |
| ResourceCost8 | `205521066` | Maliyet8 (Kaynak) alanını temsil eder. |
| ResourceCost9 | `205521067` | Maliyet9 (Kaynak) alanını temsil eder. |
| ResourceCostCenter | `205521697` | Maliyet Merkezi (Kaynak) alanını temsil eder. |
| ResourceCostPerUse | `205520914` | Kullanım Başına Maliyet (Kaynak) alanını temsil eder. |
...
| ResourceDate7 | `205521075` | Date7 (Kaynak) alanını temsil eder. |
...
| ResourceDuration3 | `205521015` | Süre3 (Kaynak) alanını temsil eder. |
| ResourceDuration4 | `205521079` | Süre4 (Kaynak) alanını temsil eder. |
| ResourceDuration5 | `205521080` | Süre5 (Kaynak) alanını temsil eder. |
| ResourceDuration6 | `205521081` | Süre6 (Kaynak) alanını temsil eder. |
| ResourceDuration7 | `205521082` | Süre7 (Kaynak) alanını temsil eder. |
...
| ResourceEnterpriseCost3 | `205521344` | Kurumsal Maliyet3 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseCost4 | `205521345` | Kurumsal Maliyet4 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseCost5 | `205521346` | Kurumsal Maliyet5 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseCost6 | `205521347` | Kurumsal Maliyet6 (Kaynak) alanını temsil eder. |
...
| ResourceEnterpriseFlag13 | `205521414` | Enterprise Flag13 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag14 | `205521415` | Enterprise Flag14 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag15 | `205521416` | Enterprise Flag15 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag16 | `205521417` | Enterprise Flag16 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag17 | `205521418` | Enterprise Flag17 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag18 | `205521419` | Enterprise Flag18 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag19 | `205521420` | Enterprise Flag19 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag2 | `205521403` | Enterprise Flag2 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag20 | `205521421` | Enterprise Flag20 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag3 | `205521404` | Enterprise Flag3 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag4 | `205521405` | Enterprise Flag4 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag5 | `205521406` | Enterprise Flag5 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseFlag6 | `205521407` | Enterprise Flag6 (Kaynak) alanını temsil eder. |
...
| ResourceEnterpriseMultiValue23 | `205521602` | Enterprise MultiValue23 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseMultiValue24 | `205521604` | Enterprise MultiValue24 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseMultiValue25 | `205521606` | Enterprise MultiValue25 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseMultiValue26 | `205521608` | Enterprise MultiValue26 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseMultiValue27 | `205521610` | Enterprise MultiValue27 (Kaynak) alanını temsil eder. |
...
| ResourceEnterpriseText12 | `205521553` | Kurumsal Metin12 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText13 | `205521554` | Kurumsal Metin13 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText14 | `205521555` | Kurumsal Metin14 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText15 | `205521556` | Kurumsal Metin15 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText16 | `205521557` | Kurumsal Metin16 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText17 | `205521558` | Kurumsal Metin17 (Kaynak) alanını temsil eder. |
| ResourceEnterpriseText18 | `205521559` | Kurumsal Metin18 (Kaynak) alanını temsil eder. |
...
| ResourceFinish4 | `205521006` | Finish4 (Kaynak) alanını temsil eder. |
| ResourceFinish5 | `205521007` | Finish5 (Kaynak) alanını temsil eder. |
| ResourceFinish6 | `205521086` | Finish6 (Kaynak) alanını temsil eder. |
| ResourceFinish7 | `205521087` | Finish7 (Kaynak) alanını temsil eder. |
...
| ResourceHyperlinkHref | `205521037` | Köprü HRef (Kaynak) alanını temsil eder. |
| ResourceHyperlinkScreenTip | `205521208` | Köprü Ekran İpucu (Kaynak) alanını temsil eder. |
| ResourceHyperlinkSubAddress | `205521036` | Köprü Alt Adresi (Kaynak) alanını temsil eder. |
| ResourceID | `205520896` | Kimlik (Kaynak) alanını temsil eder. |
...
| ResourcePhonetics | `205521148` | Fonetik (Kaynak) alanını temsil eder. |
| ResourceProject | `205521169` | Proje (Kaynak) alanını temsil eder. |
| ResourceRegularWork | `205520934` | Normal Çalışma (Kaynak) alanını temsil eder. |
| ResourceRemainingCost | `205520917` | Kalan Maliyet (Kaynak) alanını temsil eder. |
...
| ResourceText12 | `205521122` | Metin12 (Kaynak) alanını temsil eder. |
| ResourceText13 | `205521123` | Metin13 (Kaynak) alanını temsil eder. |
| ResourceText14 | `205521124` | Metin14 (Kaynak) alanını temsil eder. |
| ResourceText15 | `205521125` | Metin15 (Kaynak) alanını temsil eder. |
| ResourceText16 | `205521126` | Metin16 (Kaynak) alanını temsil eder. |
| ResourceText17 | `205521127` | Metin17 (Kaynak) alanını temsil eder. |
...
| TaskAssignmentPeakUnits | `188745015` | Atama Tepe Birimleri (Görev) alanını temsil eder. |
| TaskAssignmentUnits | `188744047` | Atama Birimleri (Görev) alanını temsil eder. |
...
| TaskBaseline1DeliverableFinish | `188744862` | Temel1 Teslim Edilebilir Bitiş (Görev) alanını temsil eder. |
| TaskBaseline1DeliverableStart | `188744861` | Temel1 Teslim Edilebilir Başlangıç (Görev) alanını temsil eder. |
| TaskBaseline1Duration | `188744167` | Temel1 Süre (Görev) alanını temsil eder. |
| TaskBaseline1DurationEstimated | `188744519` | Temel1 Tahmini Süre (Görev) alanını temsil eder. |
...
| TaskBaseline2BudgetCost | `188744871` | Temel2 Bütçe Maliyeti (Görev) alanını temsil eder. |
| TaskBaseline2BudgetWork | `188744870` | Temel2 Bütçe Çalışması (Görev) alanını temsil eder. |
| TaskBaseline2Cost | `188744175` | Temel2 Maliyet (Görev) alanını temsil eder. |
| TaskBaseline2DeliverableFinish | `188744869` | Temel2 Teslim Edilebilir Bitiş (Görev) alanını temsil eder. |
| TaskBaseline2DeliverableStart | `188744868` | Temel2 Teslim Edilebilir Başlangıç (Görev) alanını temsil eder. |
| TaskBaseline2Duration | `188744178` | Temel2 Süre (Görev) alanını temsil eder. |
| TaskBaseline2DurationEstimated | `188744520` | Temel2 Tahmini Süre (Görev) alanını temsil eder. |
...
| TaskBaseline3BudgetCost | `188744878` | Temel3 Bütçe Maliyeti (Görev) alanını temsil eder. |
| TaskBaseline3BudgetWork | `188744877` | Temel3 Bütçe Çalışması (Görev) alanını temsil eder. |
| TaskBaseline3Cost | `188744186` | Temel3 Maliyet (Görev) alanını temsil eder. |
| TaskBaseline3DeliverableFinish | `188744876` | Temel3 Teslim Edilebilir Bitiş (Görev) alanını temsil eder. |
| TaskBaseline3DeliverableStart | `188744875` | Temel3 Teslim Edilebilir Başlangıç (Görev) alanını temsil eder. |
| TaskBaseline3Duration | `188744189` | Temel3 Süre (Görev) alanını temsil eder. |
| TaskBaseline3DurationEstimated | `188744521` | Temel3 Tahmini Süre (Görev) alanını temsil eder. |
...
| TaskBaselineBudgetWork | `188744856` | Temel Bütçe Çalışması (Görev) alanını temsil eder. |
| TaskBaselineCost | `188743686` | Temel Maliyet (Görev) alanını temsil eder. |
...
| TaskCalendarGuid | `188744824` | Takvim GUID (Görev) alanını temsil eder. |
| TaskConfirmed | `188743790` | Onaylandı (Görev) alanını temsil eder. |
| TaskConstraintDate | `188743698` | Kısıtlama Tarihi (Görev) alanını temsil eder. |
| TaskConstraintType | `188743697` | Kısıtlama Türü (Görev) alanını temsil eder. |
| TaskContact | `188743792` | Kişi (Görev) alanını temsil eder. |
| TaskCost | `188743685` | Maliyet (Görev) alanını temsil eder. |
| TaskCost1 | `188743786` | Maliyet1 (Görev) alanını temsil eder. |
| TaskCost10 | `188743944` | Maliyet10 (Görev) alanını temsil eder. |
| TaskCost2 | `188743787` | Maliyet2 (Görev) alanını temsil eder. |
| TaskCost3 | `188743788` | Maliyet3 (Görev) alanını temsil eder. |
| TaskCost4 | `188743938` | Maliyet4 (Görev) alanını temsil eder. |
| TaskCost5 | `188743939` | Maliyet5 (Görev) alanını temsil eder. |
| TaskCost6 | `188743940` | Maliyet6 (Görev) alanını temsil eder. |
| TaskCost7 | `188743941` | Maliyet7 (Görev) alanını temsil eder. |
| TaskCost8 | `188743942` | Maliyet8 (Görev) alanını temsil eder. |
| TaskCost9 | `188743943` | Maliyet9 (Görev) alanını temsil eder. |
| TaskCostRateTable | `188744048` | Maliyet Oranı Tablosu (Görev) alanını temsil eder. |
| TaskCostVariance | `188743689` | Maliyet Farkı (Görev) alanını temsil eder. |
...
| TaskDate8 | `188743952` | Date8 (Görev) alanını temsil eder. |
| TaskDate9 | `188743953` | Date9 (Görev) alanını temsil eder. |
| TaskDeadline | `188744117` | Son Tarih (Görev) alanını temsil eder. |
| TaskDelay | `188743700` | Gecikme (Görev) alanını temsil eder. |
| TaskDeliverableFinish | `188744833` | Teslim Edilebilir Bitiş (Görev) alanını temsil eder. |
| TaskDeliverableGuid | `188744826` | Teslim Edilebilir GUID (Görev) alanını temsil eder. |
...
| TaskDuration10Estimated | `188744092` | Süre10 Tahmini (Görev) alanını temsil eder. |
| TaskDuration1Estimated | `188744083` | Süre11 Tahmini (Görev) alanını temsil eder. |
| TaskDuration2 | `188743784` | Süre2 (Görev) alanını temsil eder. |
| TaskDuration2Estimated | `188744084` | Süre2 Tahmini (Görev) alanını temsil eder. |
| TaskDuration3 | `188743785` | Süre3 (Görev) alanını temsil eder. |
| TaskDuration3Estimated | `188744085` | Süre3 Tahmini (Görev) alanını temsil eder. |
| TaskDuration4 | `188743955` | Süre4 (Görev) alanını temsil eder. |
| TaskDuration4Estimated | `188744086` | Süre4 Tahmini (Görev) alanını temsil eder. |
| TaskDuration5 | `188743956` | Süre5 (Görev) alanını temsil eder. |
| TaskDuration5Estimated | `188744087` | Süre5 (Tahmini Görev) alanını temsil eder. |
| TaskDuration6 | `188743957` | Süre6 (Görev) alanını temsil eder. |
| TaskDuration6Estimated | `188744088` | Süre6 Tahmini (Görev) alanını temsil eder. |
| TaskDuration7 | `188743958` | Süre7 (Görev) alanını temsil eder. |
| TaskDuration7Estimated | `188744089` | Süre7 Tahmini (Görev) alanını temsil eder. |
| TaskDuration8 | `188743959` | Süre8 (Görev) alanını temsil eder. |
| TaskDuration8Estimated | `188744090` | Süre8 Tahmini (Görev) alanını temsil eder. |
| TaskDuration9 | `188743960` | Süre9 (Görev) alanını temsil eder. |
| TaskDuration9Estimated | `188744091` | Süre9 Tahmini (Görev) alanını temsil eder. |
| TaskDurationText | `188744967` | Görev Süresi Metni (Görev) alanını temsil eder. |
| TaskDurationVariance | `188743710` | Süre Farkı (Görev) alanını temsil eder. |
| TaskEAC | `188744221` | EAC (Görev) alanını temsil eder. |
...
| TaskEnterpriseCost3 | `188744281` | Kurumsal Maliyet3 (Görev) alanını temsil eder. |
| TaskEnterpriseCost4 | `188744282` | Kurumsal Maliyet4 (Görev) alanını temsil eder. |
| TaskEnterpriseCost5 | `188744283` | Kurumsal Maliyet5 (Görev) alanını temsil eder. |
| TaskEnterpriseCost6 | `188744284` | Kurumsal Maliyet6 (Görev) alanını temsil eder. |
...
| TaskEnterpriseFlag12 | `188744350` | Enterprise Flag12 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag13 | `188744351` | Enterprise Flag13 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag14 | `188744352` | Enterprise Flag14 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag15 | `188744353` | Enterprise Flag15 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag16 | `188744354` | Enterprise Flag16 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag17 | `188744355` | Enterprise Flag17 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag18 | `188744356` | Enterprise Flag18 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag19 | `188744357` | Enterprise Flag19 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag2 | `188744340` | Enterprise Flag2 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag20 | `188744358` | Enterprise Flag20 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag3 | `188744341` | Enterprise Flag3 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag4 | `188744342` | Enterprise Flag4 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag5 | `188744343` | Enterprise Flag5 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag6 | `188744344` | Enterprise Flag6 (Görev) alanını temsil eder. |
| TaskEnterpriseFlag7 | `188744345` | Enterprise Flag7 (Görev) alanını temsil eder. |
...
| TaskEnterpriseOutlineCode12 | `188744441` | Enterprise OutlineCode12 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode13 | `188744443` | Enterprise OutlineCode13 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode14 | `188744445` | Enterprise OutlineCode14 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode15 | `188744447` | Enterprise OutlineCode15 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode16 | `188744449` | Enterprise OutlineCode16 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode17 | `188744451` | Enterprise OutlineCode17 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode18 | `188744453` | Enterprise OutlineCode18 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode19 | `188744455` | Enterprise OutlineCode19 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode2 | `188744421` | Enterprise OutlineCode2 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode20 | `188744457` | Enterprise OutlineCode20 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode21 | `188744459` | Enterprise OutlineCode21 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode22 | `188744461` | Enterprise OutlineCode22 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode23 | `188744463` | Enterprise OutlineCode23 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode24 | `188744465` | Enterprise OutlineCode24 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode25 | `188744467` | Enterprise OutlineCode25 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode26 | `188744469` | Enterprise OutlineCode26 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode27 | `188744471` | Enterprise OutlineCode27 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode28 | `188744473` | Enterprise OutlineCode28 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode29 | `188744475` | Enterprise OutlineCode29 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode3 | `188744423` | Enterprise OutlineCode3 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode30 | `188744477` | Enterprise OutlineCode30 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode4 | `188744425` | Enterprise OutlineCode4 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode5 | `188744427` | Enterprise OutlineCode5 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode6 | `188744429` | Enterprise OutlineCode6 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode7 | `188744431` | Enterprise OutlineCode7 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode8 | `188744433` | Enterprise OutlineCode8 (Görev) alanını temsil eder. |
| TaskEnterpriseOutlineCode9 | `188744435` | Enterprise OutlineCode9 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost1 | `188744529` | Kurumsal Proje Maliyeti1 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost10 | `188744538` | Kurumsal Proje Maliyeti10 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost2 | `188744530` | Kurumsal Proje Maliyeti2 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost3 | `188744531` | Kurumsal Proje Maliyeti3 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost4 | `188744532` | Kurumsal Proje Maliyeti4 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost5 | `188744533` | Kurumsal Proje Maliyeti5 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectCost6 | `188744534` | Kurumsal Proje Maliyeti6 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectDuration3 | `188744571` | Kurumsal Proje Süresi3 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectDuration4 | `188744572` | Kurumsal Proje Süresi4 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectDuration5 | `188744573` | Kurumsal Proje Süresi5 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectDuration6 | `188744574` | Kurumsal Proje Süresi6 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectFlag13 | `188744661` | Enterprise Project Flag13 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag14 | `188744662` | Enterprise Project Flag14 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag15 | `188744663` | Enterprise Project Flag15 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag16 | `188744664` | Enterprise Project Flag16 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag17 | `188744665` | Enterprise Project Flag17 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag18 | `188744666` | Enterprise Project Flag18 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag19 | `188744667` | Enterprise Project Flag19 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag2 | `188744650` | Enterprise Project Flag2 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag20 | `188744668` | Enterprise Project Flag20 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag3 | `188744651` | Enterprise Project Flag3 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag4 | `188744652` | Enterprise Project Flag4 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag5 | `188744653` | Enterprise Project Flag5 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag6 | `188744654` | Enterprise Project Flag6 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag7 | `188744655` | Enterprise Project Flag7 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag8 | `188744656` | Enterprise Project Flag8 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectFlag9 | `188744657` | Enterprise Project Flag9 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectNumber26 | `188744714` | Enterprise Project Number26 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectNumber27 | `188744715` | Enterprise Project Number27 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectNumber28 | `188744716` | Enterprise Project Number28 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectNumber35 | `188744723` | Enterprise Project Number35 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectNumber36 | `188744724` | Enterprise Project Number36 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectNumber7 | `188744695` | Enterprise Project Number7 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectNumber8 | `188744696` | Enterprise Project Number8 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectNumber9 | `188744697` | Enterprise Project Number9 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode1 | `188744589` | Enterprise Project OutlineCode1 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode10 | `188744598` | Enterprise Project OutlineCode10 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode11 | `188744599` | Enterprise Project OutlineCode11 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode12 | `188744600` | Enterprise Project OutlineCode12 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode13 | `188744601` | Enterprise Project OutlineCode13 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode14 | `188744602` | Enterprise Project OutlineCode14 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode15 | `188744603` | Enterprise Project OutlineCode15 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode16 | `188744604` | Enterprise Project OutlineCode16 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode17 | `188744605` | Enterprise Project OutlineCode17 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode18 | `188744606` | Enterprise Project OutlineCode18 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode19 | `188744607` | Enterprise Project OutlineCode19 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode2 | `188744590` | Enterprise Project OutlineCode2 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode20 | `188744608` | Enterprise Project OutlineCode2 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode21 | `188744609` | Enterprise Project OutlineCode21 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode22 | `188744610` | Enterprise Project OutlineCode22 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode23 | `188744611` | Enterprise Project OutlineCode23 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode24 | `188744612` | Enterprise Project OutlineCode24 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode25 | `188744613` | Enterprise Project OutlineCode25 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode26 | `188744614` | Enterprise Project OutlineCode26 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode27 | `188744615` | Enterprise Project OutlineCode27 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode28 | `188744616` | Enterprise Project OutlineCode28 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode29 | `188744617` | Enterprise Project OutlineCode29 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode3 | `188744591` | Enterprise Project OutlineCode3 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode30 | `188744618` | Enterprise Project OutlineCode30 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode4 | `188744592` | Enterprise Project OutlineCode4 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode5 | `188744593` | Enterprise Project OutlineCode5 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode6 | `188744594` | Enterprise Project OutlineCode6 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode7 | `188744595` | Enterprise Project OutlineCode7 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode8 | `188744596` | Enterprise Project OutlineCode8 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectOutlineCode9 | `188744597` | Enterprise Project OutlineCode9 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText1 | `188744729` | Kurumsal Proje Metni1 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText10 | `188744738` | Enterprise Project Text10 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText11 | `188744739` | Enterprise Project Text11 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText12 | `188744740` | Enterprise Project Text12 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText13 | `188744741` | Enterprise Project Text13 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText14 | `188744742` | Enterprise Project Text14 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText15 | `188744743` | Kurumsal Proje Metni15 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectText25 | `188744753` | Enterprise Project Text25 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText26 | `188744754` | Enterprise Project Text26 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText27 | `188744755` | Enterprise Project Text27 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText28 | `188744756` | Enterprise Project Text28 (Görev) alanını temsil eder. |
...
| TaskEnterpriseProjectText37 | `188744765` | Enterprise Project Text37 (Görev) alanını temsil eder. |
| TaskEnterpriseProjectText38 | `188744766` | Enterprise Project Text38 (Görev) alanını temsil eder. |
...
| TaskFinish6 | `188743963` | Finish6 (Görev) alanını temsil eder. |
...
| TaskFlag16 | `188743977` | Bayrak16 (Görev) alanını temsil eder. |
| TaskFlag17 | `188743978` | Bayrak17 (Görev) alanını temsil eder. |
...
| TaskHyperlinkHref | `188743900` | Köprü HRef (Görev) alanını temsil eder. |
...
| TaskNotes | `188743695` | Notlar (Görev) alanını temsil eder. |
...
| TaskRemainingDuration | `188743711` | Kalan Süre (Görev) alanını temsil eder. |
| TaskRemainingOvertimeCost | `188743850` | Kalan Fazla Mesai Maliyeti (Görev) alanını temsil eder. |
| TaskRemainingOvertimeWork | `188743845` | Kalan Fazla Mesai (Görev) alanını temsil eder. |
| TaskRemainingWork | `188743684` | Kalan Çalışma (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode20 | `188744809` | Enterprise Resource MultiValue Code20 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode21 | `188744810` | Enterprise Resource MultiValue Code21 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode22 | `188744811` | Enterprise Resource MultiValue Code22 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode23 | `188744812` | Enterprise Resource MultiValue Code23 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode24 | `188744813` | Enterprise Resource MultiValue Code24 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode25 | `188744814` | Enterprise Resource MultiValue Code25 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode26 | `188744815` | Enterprise Resource MultiValue Code26 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseMultiValueCode27 | `188744816` | Enterprise Resource MultiValue Code27 (Görev) alanını temsil eder. |
...
| TaskResourceEnterpriseOutlineCode14 | `188744782` | Kurumsal Kaynak Anahat Kodu14 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseOutlineCode15 | `188744783` | Kurumsal Kaynak Anahat Kodu15 (Görev) alanını temsil eder. |
| TaskResourceEnterpriseOutlineCode16 | `188744784` | Kurumsal Kaynak Anahat Kodu16 (Görev) alanını temsil eder. |
...
| TaskText12 | `188743998` | Metin12 (Görev) alanını temsil eder. |
| TaskText13 | `188743999` | Metin13 (Görev) alanını temsil eder. |
| TaskText14 | `188744000` | Metin14 (Görev) alanını temsil eder. |
| TaskText15 | `188744001` | Metin15 (Görev) alanını temsil eder. |
| TaskText16 | `188744002` | Metin16 (Görev) alanını temsil eder. |
| TaskText17 | `188744003` | Metin17 (Görev) alanını temsil eder. |
...
| ResourceAssignmentBaseLineFinish | `255852691` | Temel Bitiş (Atama) alanını temsil eder. |
| ResourceAssignmentBaseLineCost | `255852576` | Temel Maliyet (Atama) alanını temsil eder. |
| ResourceAssignmentBaseLineWork | `255852560` | Temel Çalışma (Atama) alanını temsil eder. |
| ResourceAssignmentBaseLineCostPerUse | `255852811` | Temel Kullanım Başına Maliyet (Atama) alanını temsil eder. |
