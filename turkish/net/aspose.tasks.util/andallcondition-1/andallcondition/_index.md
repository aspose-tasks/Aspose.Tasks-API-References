...
description: "AndAllCondition yapıcı. AndAllCondition sınıfının yeni bir örneğini başlatır."
type: docs
weight: 10
...
[`AndAllCondition`](../) sınıfının yeni bir örneğini başlatır.
...
| --- | --- | --- |
| koşullar | List`1 | Koşulların listesi. |
