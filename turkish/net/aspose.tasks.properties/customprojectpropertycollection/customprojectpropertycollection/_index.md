...
description: "CustomProjectPropertyCollection yapıcı. CustomProjectPropertyCollection sınıfının yeni bir örneğini başlatır."
type: docs
weight: 10
...
Yeni bir örnek oluşturur [`CustomProjectPropertyCollection`](../) sınıfını.
