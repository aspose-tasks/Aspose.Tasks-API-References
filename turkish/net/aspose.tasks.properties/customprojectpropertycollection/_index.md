...
description: Aspose.Tasks.Properties.CustomProjectPropertyCollection sınıf. Özel proje özellikleri koleksiyonunu temsil eder.
type: docs
weight: 1300
...
| İsim | Tanım |
| --- | --- |
| [CustomProjectPropertyCollection](customprojectpropertycollection/)() | Yeni bir örneğini başlatır.`CustomProjectPropertyCollection` sınıf. |
