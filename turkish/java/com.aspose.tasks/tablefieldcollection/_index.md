...
type: docs
weight: 287
url: /tr/java/com.aspose.tasks/tablefieldcollection/
---
...
[TableField](../../com.aspose.tasks/tablefield) nesnelerinden oluşan bir liste içerir. IList&lt;TableField&gt; arayüzünü uygular.
## Yöntemler
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | Bu koleksiyondaki belirtilen öğenin indeksini döndürür. |
...
Bu koleksiyondaki belirtilen öğenin indeksini döndürür.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | belirtilen öğe. |
