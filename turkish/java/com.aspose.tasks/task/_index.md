...
description: "Bir projedeki bir görevi temsil eder."
type: docs
weight: 289
url: /tr/java/com.aspose.tasks/task/
---
...
Bir projedeki bir görevi temsil eder.

--------------------

The **Task** bir işin tek atomik parçasını temsil eder.

Bir proje planlamak için **Task** kullanılabilir; görevler oluşturarak ve uygun kaynakları onlara atayarak. Bir projedeki görevler, kök bir görev ve alt görev ağaçlarıyla köklü hiyerarşik bir ağaç yapısı olarak düzenlenir.

Görev ağacı oluşturmak için, `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) özelliğine erişilerek özel bir koleksiyon olan [TaskCollection](../../com.aspose.tasks/taskcollection) kullanılabilir, örnek:
...
Task childTask2 = task1.Children.Add("Child 2", 2); // childTask3'den önce bir görev ekler
