...
description: "MPPSaveOptions プロパティ。 プロジェクトを MPP 形式で保存する際にグループ データを書き込むかどうかを示す値を取得または設定します。 グループ データには Project.TaskGroups および Project.ResourceGroups コレクションが含まれます"
type: docs
weight: 60
url: /ja/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

プロジェクトを MPP 形式で保存する際にグループ データを書き込むかどうかを示す値を取得または設定します。 グループ データには Project.TaskGroups および Project.ResourceGroups コレクションが含まれます。
