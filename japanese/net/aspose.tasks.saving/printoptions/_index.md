...
description: プロジェクトの印刷時に追加オプションを指定できます
type: docs
weight: 1900
url: /ja/net/aspose.tasks.saving/printoptions/
---
## PrintOptions class

プロジェクトの印刷時に追加オプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [PrintOptions](printoptions/)() | の新しいインスタンスを初期化します`PrintOptions`プロジェクトを印刷するためのさまざまなオプションを設定するために使用できるクラス. |
