...
description: プロジェクト ページを Spreadsheet2003. にレンダリングするときに追加のオプションを指定できます
type: docs
weight: 1940
url: /ja/net/aspose.tasks.saving/spreadsheet2003saveoptions/
---
## Spreadsheet2003SaveOptions class

プロジェクト ページを Spreadsheet2003. にレンダリングするときに、追加のオプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | の新しいインスタンスを初期化します`Spreadsheet2003SaveOptions`クラス。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | レンダリングする割り当てビュー列のリストを取得または設定します ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | レンダリングするリソース ビュー列のリストを取得または設定します ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
