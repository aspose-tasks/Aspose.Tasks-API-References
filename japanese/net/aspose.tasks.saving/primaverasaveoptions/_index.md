...
description: プロジェクトを Primavera XER 形式で保存するときに追加オプションを指定できます
type: docs
weight: 1880
url: /ja/net/aspose.tasks.saving/primaverasaveoptions/
---
## PrimaveraSaveOptions class

プロジェクトを Primavera XER 形式で保存するときに追加オプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | の新しいインスタンスを初期化します`PrimaveraSaveOptions`class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | アクティビティ ID の再番号付けに使用される増分を取得または設定します。 |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | アクティビティ ID の再番号付けに使用されるプレフィックスを取得または設定します。 |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | アクティビティ ID の再番号付けに使用されるサフィックスを取得または設定します。 |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids/) { get; set; } | アクティビティ ID の再番号付けが必要かどうかを示す値を取得または設定します。 |
