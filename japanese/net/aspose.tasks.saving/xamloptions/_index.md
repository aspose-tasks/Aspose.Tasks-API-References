...
description: /// プロジェクト ページを XAML にレンダリングするときに追加オプションを指定できます
type: docs
weight: 1970
url: /ja/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// プロジェクト ページを XAML にレンダリングするときに追加オプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [XamlOptions](xamloptions/)() | の新しいインスタンスを初期化します`XamlOptions`プロジェクトを XAML 形式で保存するために使用できるクラス. |
