...
description: "PrimaveraXmlSaveOptions プロパティ。エクスポート時にリソースのサマリータスクへの割り当てをスキップするかどうかを示す値を取得または設定します"
type: docs
weight: 30
url: /ja/net/aspose.tasks.saving/primaveraxmlsaveoptions/skipsummaryassignments/
---
