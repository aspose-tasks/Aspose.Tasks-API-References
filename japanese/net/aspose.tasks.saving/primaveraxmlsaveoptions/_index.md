...
description: プロジェクトを Primavera xml 形式で保存するときに追加オプションを指定できます
type: docs
weight: 1890
url: /ja/net/aspose.tasks.saving/primaveraxmlsaveoptions/
---
## PrimaveraXmlSaveOptions class

プロジェクトを Primavera xml 形式で保存するときに追加オプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | の新しいインスタンスを初期化します`PrimaveraXmlSaveOptions`class. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | ルート タスクを保存するかどうかを示す値を取得または設定します。 |
