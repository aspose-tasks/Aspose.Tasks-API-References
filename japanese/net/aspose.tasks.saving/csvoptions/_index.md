...
description: プロジェクトを CSV に保存するときに追加オプションを指定できます
type: docs
weight: 1720
url: /ja/net/aspose.tasks.saving/csvoptions/
---
## CsvOptions class

プロジェクトを CSV に保存するときに追加オプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [CsvOptions](csvoptions/)() | の新しいインスタンスを初期化します`CsvOptions`プロジェクトをCSV形式で保存するために使用できるクラス。 |
...
| [DataCategory](../../aspose.tasks.saving/csvoptions/datacategory/) { get; set; } | 保存するデータ カテゴリを取得または設定します。 |
...
| [Encoding](../../aspose.tasks.saving/csvoptions/encoding/) { get; set; } | CSV を保存するためのエンコードを取得または設定します。 |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | ヘッダーを含めるかどうかを示す値を取得または設定します (デフォルト値は TRUE)。 |
...
| [TextDelimiter](../../aspose.tasks.saving/csvoptions/textdelimiter/) { get; set; } | テキスト区切り文字を取得または設定します。 |
