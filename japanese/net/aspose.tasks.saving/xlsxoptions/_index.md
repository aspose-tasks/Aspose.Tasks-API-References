...
description: プロジェクト ページを XLSX. にレンダリングするときに追加のオプションを指定できます
type: docs
weight: 1980
url: /ja/net/aspose.tasks.saving/xlsxoptions/
---
## XlsxOptions class

プロジェクト ページを XLSX. にレンダリングするときに、追加のオプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | の新しいインスタンスを初期化します`XlsxOptions`プロジェクトを XLSX 形式で保存するために使用できるクラス。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | レンダリングする割り当てビュー列のリストを取得または設定します ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | 結果の XLSX ファイルのエンコーディングを取得または設定します。デフォルト値はUTF8. |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | レンダリングするリソース ビュー列のリストを取得または設定します ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
