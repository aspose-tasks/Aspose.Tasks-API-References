...
description: プロジェクト ページを XPS にレンダリングするときに追加のオプションを指定できます
type: docs
weight: 1990
url: /ja/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

プロジェクト ページを XPS にレンダリングするときに、追加のオプションを指定できます。
...
| 名前 | 説明 |
| --- | --- |
| [XpsOptions](xpsoptions/)() | の新しいインスタンスを初期化します`XpsOptions`class. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | メタファイルをビットマップとしてレンダリングするかどうかを示す値を取得または設定します。 |
