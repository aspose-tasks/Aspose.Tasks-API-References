...
description: KeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled が設定されているかどうかを示す値を取得または設定します
type: docs
weight: 490
url: /ja/net/aspose.tasks/project/keeptaskonnearestworkingtimewhenmadeautoscheduled/
---
