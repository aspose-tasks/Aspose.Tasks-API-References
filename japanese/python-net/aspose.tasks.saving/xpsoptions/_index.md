...
type: docs
weight: 200
url: /ja/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

プロジェクトページを XPS にレンダリングする際に、追加オプションを指定できます。

XpsOptions 型は次のメンバーを公開します：
## コンストラクタ
| 名前 | 説明 |
| :- | :- |
| XpsOptions() | 新しい [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/) クラスのインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | メタファイルをビットマップとしてレンダリングするかどうかを示す値を取得または設定します。 |
