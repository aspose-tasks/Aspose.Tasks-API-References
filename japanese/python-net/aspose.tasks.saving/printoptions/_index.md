...
type: docs
weight: 120
url: /ja/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

プロジェクトを印刷する際に、追加オプションを指定できます。

PrintOptions 型は次のメンバーを公開します:
## コンストラクタ
| 名前 | 説明 |
| :- | :- |
| PrintOptions() | [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) クラスの新しいインスタンスを初期化します。このインスタンスはプロジェクトを印刷するためのさまざまなオプションを設定するのに使用できます。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
| save_format |  |
