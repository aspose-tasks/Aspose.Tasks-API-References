...
type: docs
weight: 180
url: /ja/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// プロジェクトページを XAML にレンダリングする際に、追加オプションを指定できます。

XamlOptions 型は次のメンバーを公開します:
## コンストラクタ
| 名前 | 説明 |
| :- | :- |
| XamlOptions() | プロジェクトを XAML 形式で保存するために使用できる [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) クラスの新しいインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
| save_format |  |
