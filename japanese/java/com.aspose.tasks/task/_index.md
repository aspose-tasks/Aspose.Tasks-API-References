...
type: docs
weight: 289
url: /ja/java/com.aspose.tasks/task/
---
...
この **Task** は、作業の単一の原子的なチャンクを表します。

プロジェクトを計画するために **Task** を使用してタスクを作成し、適切なリソースを割り当てることができます。プロジェクト内のタスクは、ルートタスクと子タスクのサブツリーを持つ階層的なツリーストラクチャとして構成されます。

タスクのツリーを構築するには、`Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) プロパティにアクセスして、専門のコレクション [TaskCollection](../../com.aspose.tasks/taskcollection) を使用します。例:
...
// 新しいタスクを追加
Task task1 = project.RootTask.Children.Add(); // 空の名前の親タスクが追加されます
...
```
public final void setActualWork(Duration 値)
```
...
```
public final void setActualWorkProtected(Duration 値)
```
...
```
public final void setBCWP(double 値)
```
...
```
public final void setBCWS(double 値)
```
...
```
public final void setBaselines(TaskBaselineCollection 値)
```
...
```
public final void setBudgetCost(BigDecimal 値)
```
...
```
public final void setBudgetWork(Duration 値)
```
...
```
public final void setCV(double 値)
```
...
```
public final void setCommitmentFinish(Date 値)
```
...
```
public final void setCommitmentStart(Date 値)
```
...
```
public final void setCommitmentType(int 値)
```
...
```
public final void setConstraintDate(Date 値)
```
...
```
public final void setConstraintType(int 値)
```
...
```
public final void setContact(String 値)
```
...
```
public final void setCost(BigDecimal 値)
```
...
```
public final void setCostVariance(double 値)
```
...
```
public final void setCreated(Date 値)
```
...
```
public final void setCritical(NullableBool 値)
```
...
```
public final void setDeadline(Date 値)
```
...
```
public final void setDisplayAsSummary(NullableBool 値)
```
...
```
public final void setDisplayOnTimeline(boolean 値)
```
...
```
public final void setDuration(Duration 値)
```
...
```
public final void setDurationText(String 値)
```
...
```
public final void setDurationVariance(Duration 値)
```
...
```
public final void setEarlyFinish(Date 値)
```
