---
title: "Aspose::Tasks::Baseline::CompareTo метод"
linktitle: "CompareTo"
articleTitle: "CompareTo"
second_title: "Aspose.Tasks для C++"
description: "Реализация интерфейса IComparable."
type: docs
weight: 10
url: /ru/cpp/aspose.tasks/baseline/compareto/
---
...
| Параметр | Описание |
| --- | --- |
| другой | указанный объект Baseline, с которым сравнивается данный экземпляр. |
