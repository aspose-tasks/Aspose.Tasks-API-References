...
description: Aspose.Tasks.Saving.XpsOptions сорт. Позволяет указать дополнительные параметры при рендеринге страниц проекта в XPS.
type: docs
weight: 1990
...
| Имя | Описание |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Инициализирует новый экземпляр`XpsOptions` класс. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Получает или задает значение, указывающее, следует ли отображать метафайл как растровое изображение. |
