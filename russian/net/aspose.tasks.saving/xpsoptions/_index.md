...
description: Позволяет указать дополнительные параметры при рендеринге страниц проекта в XPS.
type: docs
weight: 1980
...
| Имя | Описание |
| --- | --- |
| [XpsOptions](xpsoptions)() | Инициализирует новый экземпляр класса[`XpsOptions`](../xpsoptions). |
