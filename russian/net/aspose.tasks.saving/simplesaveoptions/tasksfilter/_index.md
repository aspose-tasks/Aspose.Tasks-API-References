...
description: "Свойство SimpleSaveOptions. Получает или задает условие, используемое для фильтрации задач, отображаемых на листе Gantt Task Sheet и диаграммах использования задач."
type: docs
weight: 30
url: /ru/net/aspose.tasks.saving/simplesaveoptions/tasksfilter/
---
