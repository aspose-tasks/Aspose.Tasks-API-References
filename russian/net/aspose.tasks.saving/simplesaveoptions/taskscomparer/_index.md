...
description: "Свойство SimpleSaveOptions. Получает или задает компаратор для сортировки задач на диаграмме Ганта и листе задач."
type: docs
weight: 20
url: /ru/net/aspose.tasks.saving/simplesaveoptions/taskscomparer/
---
