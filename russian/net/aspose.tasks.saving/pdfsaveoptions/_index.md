...
description: Aspose.Tasks.Saving.PdfSaveOptions сорт. Позволяет указать дополнительные параметры при рендеринге страниц проекта в PDF.
type: docs
weight: 1860
...
| Имя | Описание |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | Инициализирует новый экземпляр`PdfSaveOptions`класс, который можно использовать для сохранения документа в[`PDF`](../savefileformat/) формат. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance/) { get; set; } | Получает или задает желаемый уровень соответствия для сгенерированного PDF-документа. Значение по умолчанию:Pdf15 . |
...
| [DefaultFontName](../../aspose.tasks.saving/pdfsaveoptions/defaultfontname/) { get; set; } | Получает или задает шрифт по умолчанию для рендеринга. |
| [DigitalSignatureDetails](../../aspose.tasks.saving/pdfsaveoptions/digitalsignaturedetails/) { get; set; } | Получает или задает данные цифровой подписи. Если не установлено, то подписание производиться не будет. |
...
| [EncryptionDetails](../../aspose.tasks.saving/pdfsaveoptions/encryptiondetails/) { get; set; } | Получает или задает сведения о шифровании. Если не установлено, то шифрование выполняться не будет. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression/) { get; set; } | Получает или задает тип сжатия, который будет использоваться для всех потоков содержимого, кроме изображений. Значение по умолчанию:Flate . |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/pdfsaveoptions/useprojectdefaultfont/) { get; set; } | Получает или задает значение, указывающее, должен ли использоваться шрифт по умолчанию для рендеринга. |
