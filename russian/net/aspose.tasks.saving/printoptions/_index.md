...
description: Позволяет указать дополнительные параметры при печати проекта.
type: docs
weight: 1890
...
| Имя | Описание |
| --- | --- |
| [PrintOptions](printoptions)() | Инициализирует новый экземпляр класса[`PrintOptions`](../printoptions), который можно использовать для установки различных параметров печати проекта. . |
