...
| Имя | Описание |
| --- | --- |
| [PrintOptions](printoptions)() | Инициализирует новый экземпляр[`PrintOptions`](../printoptions) класс, который можно использовать для установки различных параметров печати проекта. |
