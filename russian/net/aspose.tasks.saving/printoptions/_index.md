---
title: "Класс PrintOptions"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Класс Aspose.Tasks.Saving.PrintOptions. Позволяет задавать дополнительные параметры при печати проекта"
type: docs
weight: 2170
url: /ru/net/aspose.tasks.saving/printoptions/
---
## PrintOptions class

Позволяет указать дополнительные параметры при печати проекта.
...
| Имя | Описание |
| --- | --- |
| [PrintOptions](printoptions/)() | Инициализирует новый экземпляр класса `PrintOptions`, который можно использовать для установки различных параметров печати проекта. |
