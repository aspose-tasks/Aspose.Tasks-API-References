...
description: Aspose.Tasks.Saving.PrintOptions сорт. Позволяет указать дополнительные параметры при печати проекта.
type: docs
weight: 1900
...
| Имя | Описание |
| --- | --- |
| [PrintOptions](printoptions/)() | Инициализирует новый экземпляр`PrintOptions` класс, который можно использовать для установки различных параметров печати проекта. |
