...
| Имя | Описание |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | Инициализирует новый экземпляр класса[`XlsxOptions`](../xlsxoptions), который можно использовать для сохранения проекта в формате XLSX. |
