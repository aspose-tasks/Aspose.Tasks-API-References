...
description: Позволяет указать дополнительные параметры при рендеринге страниц проекта в XLSX.
type: docs
weight: 1970
...
| Имя | Описание |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | Инициализирует новый экземпляр[`XlsxOptions`](../xlsxoptions)класс, который можно использовать для сохранения проекта в формате XLSX. |
