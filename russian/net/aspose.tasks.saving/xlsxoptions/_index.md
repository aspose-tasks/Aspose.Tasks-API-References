...
description: Aspose.Tasks.Saving.XlsxOptions сорт. Позволяет указать дополнительные параметры при рендеринге страниц проекта в XLSX.
type: docs
weight: 1980
...
| Имя | Описание |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Инициализирует новый экземпляр`XlsxOptions`класс, который можно использовать для сохранения проекта в формате XLSX. |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Получает или задает кодировку результирующего файла XLSX. Значение по умолчаниюUTF8 . |
