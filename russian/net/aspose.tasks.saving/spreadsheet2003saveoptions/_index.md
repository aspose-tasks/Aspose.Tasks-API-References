...
description: Aspose.Tasks.Saving.Spreadsheet2003SaveOptions сорт. Позволяет указать дополнительные параметры при рендеринге страниц проекта в Spreadsheet2003.
type: docs
weight: 1940
...
| Имя | Описание |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | Инициализирует новый экземпляр`Spreadsheet2003SaveOptions` сорт. |
