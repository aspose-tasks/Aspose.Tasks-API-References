...
description: Позволяет указать дополнительные параметры при сохранении проекта в формате Primavera XER.
type: docs
weight: 1870
...
| Имя | Описание |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | Инициализирует новый экземпляр класса[`PrimaveraSaveOptions`](../primaverasaveoptions). |
