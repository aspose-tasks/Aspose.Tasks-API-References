...
| Имя | Описание |
| --- | --- |
| [PdfEncryptionDetails](pdfencryptiondetails)(string, string, PdfEncryptionAlgorithm) | Инициализирует новый экземпляр[`PdfEncryptionDetails`](../pdfencryptiondetails) класс. |
...
| [UserPassword](../../aspose.tasks.saving/pdfencryptiondetails/userpassword) { get; set; } | Получает или устанавливает пароль пользователя. |
