...
description: "Свойство HtmlSaveOptions. Получает или задает значение, указывающее, включать ли имя проекта в заголовок HTML-страницы"
type: docs
weight: 110
...
Получает или задает значение, указывающее, включать ли название проекта в заголовок HTML‑страницы.
