...
description: Aspose.Tasks.Saving.HtmlSaveOptions сорт. Позволяет указать дополнительные параметры при рендеринге страниц проекта в HTML.
type: docs
weight: 1750
...
| Имя | Описание |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | Инициализирует новый экземпляр`HtmlSaveOptions` класс. |
