...
description: "Свойство MPPSaveOptions. Возвращает или задает значение, указывающее, следует ли записывать данные групп при сохранении проекта в формат MPP. Данные групп включают коллекции Project.TaskGroups и Project.ResourceGroups."
type: docs
weight: 60
url: /ru/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Получает или задает значение, указывающее, следует ли записывать данные групп при сохранении проекта в формат MPP. Данные групп включают коллекции Project.TaskGroups и Project.ResourceGroups.
