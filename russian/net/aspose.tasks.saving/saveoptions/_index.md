...
description: Это абстрактный базовый класс для классов которые позволяют пользователю указывать дополнительные параметры при сохранении проекта в определенном формате.
type: docs
weight: 1910
...
Экземпляр любого производного класса от класса SaveOptions передается в поток Сохранить или строку Сохранить перегрузки , чтобы пользователь мог определить пользовательские параметры при сохранении документа.
