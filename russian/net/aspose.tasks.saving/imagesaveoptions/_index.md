...
description: Позволяет указать дополнительные параметры при рендеринге страниц проекта в изображения.
type: docs
weight: 1760
...
| Имя | Описание |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | Инициализирует новый экземпляр класса[`ImageSaveOptions`](../imagesaveoptions), который можно использовать для сохранения обработанных изображений в формате TIFF, Форматы PNG, BMP или JPEG. |
...
| [DefaultFontName](../../aspose.tasks.saving/imagesaveoptions/defaultfontname) { get; set; } | Получает или задает шрифт по умолчанию для визуализации. |
...
| [HorizontalResolution](../../aspose.tasks.saving/imagesaveoptions/horizontalresolution) { get; set; } | Получает или задает горизонтальное разрешение в dpi. |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/imagesaveoptions/useprojectdefaultfont) { get; set; } | Получает или задает значение, указывающее, должен ли использоваться шрифт по умолчанию для визуализации. |
