...
| Имя | Описание |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | Инициализирует новый экземпляр[`ImageSaveOptions`](../imagesaveoptions) класс, который можно использовать для сохранения обработанных изображений в форматах TIFF, PNG, BMP или JPEG. |
