...
description: Aspose.Tasks.Saving.XamlOptions сорт. /// Позволяет указать дополнительные параметры при рендеринге страниц проекта в XAML.
type: docs
weight: 1970
...
| Имя | Описание |
| --- | --- |
| [XamlOptions](xamloptions/)() | Инициализирует новый экземпляр`XamlOptions` класс, который можно использовать для сохранения проекта в формате XAML. |
