...
description: "Свойство PrimaveraXmlSaveOptions. Получает или задает значение, указывающее, следует ли пропускать назначения ресурсов к сводным задачам при экспорте"
type: docs
weight: 30
url: /ru/net/aspose.tasks.saving/primaveraxmlsaveoptions/skipsummaryassignments/
---
