...
| Имя | Описание |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions)() | Инициализирует новый экземпляр класса[`PrimaveraXmlSaveOptions`](../primaveraxmlsaveoptions). |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask) { get; set; } | Получает или задает значение, указывающее, следует ли сохранять корневую задачу или нет. |
