...
description: Aspose.Tasks.Connectivity.MpdSettings сорт. Позволяет установить необходимые параметры для чтения данных проекта из формата MPD формат файла базы данных MS Access.
type: docs
weight: 300
...
| Имя | Описание |
| --- | --- |
| [MpdSettings](mpdsettings/)(string, int) | Инициализирует новый экземпляр`MpdSettings` класс. |
