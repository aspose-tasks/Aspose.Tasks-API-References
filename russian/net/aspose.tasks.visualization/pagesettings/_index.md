...
description: Aspose.Tasks.Visualization.PageSettings сорт. Представляет параметры печати для страницы представления проекта.
type: docs
weight: 2890
...
| Имя | Описание |
| --- | --- |
| [PageSettings](pagesettings/)() | Инициализирует новый экземпляр`PageSettings` сорт. Представляет параметры печати для страницы представления проекта. |
