...
description: Включает Uid имя ресурса тип метку материала инициалы группу максимальное количество единиц стандартную ставку ставку сверхурочных стоимость за использование накопление в базовый календарь и столбцы ресурсов кода.
type: docs
weight: 40
