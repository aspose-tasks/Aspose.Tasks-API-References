...
description: Aspose.Tasks.Visualization.DateLabel перечисление. Задает формат отображения меток даты и времени на шкале времени.
type: docs
weight: 2650
...
| DayDddMmDd | `108` | Примеры: Пн 30 сентября, Вт 1/10 |
...
| DayDiMDd | `114` | Примеры МС 30, ТО 1 |
...
| DayFromStartDayDd | `40` | Примеры: День -2, День -1, День 1, День 2 с момента запуска проекта. |
...
| HalfYearH | `128` | Примеры: 1, 2. Требуется, чтобы единицей времени было TimescaleHalfYears. |
...
| HalfYearFromStartH | `132` | Примеры: -2, -1, 1, 2. Полгода с даты начала проекта. |
| HalfYearFromStartHalfH | `130` | Примеры: Half-2, Half-1, Half 1, Half 2 |
| HalfYearFromStartHh | `131` | Примеры: H-2, H-1, H1, H2 |
| HourDddMmmDdHhAm | `28` | Примеры: среда, 18 марта, 8:00; Ср, 18 марта, 9:00. Требуется, чтобы единицей времени было TimescaleHours. |
| HourHh | `32` | Примеры: 8, 9, 10, 11 |
| HourHhMmAm | `30` | Примеры: 8:00, 9:00 |
| HourHhAm | `31` | Примеры: 8:00, 9:00 |
| HourMmDdHhAm | `120` | Примеры: 18 марта 8:00, 18 марта 9:00 |
| HourMmmDdHhAm | `29` | Примеры: 18 марта, 8:00; 18 марта, 9:00 |
| HourFromEndHh | `77` | Примеры: 3, 2, 1, -1, -2 часа после окончания проекта. |
...
| MinuteHhMmAm | `33` | Примеры: 8:00, 8:01, 8:02. Требуется, чтобы единицей времени было TimescaleMinutes. |
...
| MonthMmmYyy | `8` | Примеры: 10 марта, 10 апреля, 10 мая |
...
| QuarterQ | `62` | Примеры: 3, 4, 1. Требует, чтобы единица измерения времени была TimescaleQuarters. |
...
| ThirdsOfMonthsMmmDdYy | `147` | Примеры: 1 марта 2010 г.; 11 марта 2010 г .; 21 марта 2010 г .; 1 апр. 10 |
| ThirdsOfMonthsMmmDdd | `143` | Примеры: март B, март M, март E, апрель B |
| ThirdsOfMonthsMmmDddYy | `148` | Примеры: Mar B, '10; март М., 2010 г.; март 2010 г.; Апр Б '10 |
...
| ThirdsOfMonthsMmmmDdddYyyy | `150` | Примеры: начало марта 2010 г.; середина марта 2010 г.; Конец марта 2010 г .; Начало апреля, 2010 |
...
| WeekDddMmDd | `90` | Примеры: вс 21.03, вс 28.03, вс 4/4 |
| WeekDddMmDdYy | `100` | Примеры: вс 21.03.10, вс 28.03.10, вс 4/4/10 |
| WeekDddMmmDd | `93` | Примеры: вс 21 марта, вс 28 марта, вс 4 апр |
| WeekDddMmmDdYyy | `101` | Примеры: воскресенье, 21 марта 2010 г.; Вс, 28 марта 2010 г.; Вс, 4 апр., '10 |
| WeekDddMmmmDd | `96` | Примеры: вс 21 марта, вс 28 марта, вс 4 апр |
| WeekDddMmmmDdYyy | `102` | Примеры: воскресенье, 21 марта 2010 г.; Вс, 28 марта 2010 г.; Вс, 4 апреля '10 |
| WeekDddWw | `103` | Примеры: вс 12, вс 13, вс 14 |
| WeekDdiMDd | `98` | Примеры Su M 21, Su M 28, Su A 4 |
| WeekDdiMmDd | `91` | Примеры Су 3/21. Вс 3/28, Вс 4/4 |
| WeekDdiMmmDd | `94` | Примеры: Воскресенье, 21 марта, Воскресенье, 28 марта, Воскресенье, 4 апреля |
...
| WeekMmmDdYyy | `13` | Примеры: 21 марта 2010 г.; 28 марта 2010 г .; 4 апр, '10 |
...
| WeekFromStartWeekWw | `42` | Примеры: неделя -1, неделя 1, неделя 2 с момента запуска проекта. |
...
| YearFromStartYearYy | `48` | Примеры: Год -1, Год 1, Год 2 от начала проекта. |
