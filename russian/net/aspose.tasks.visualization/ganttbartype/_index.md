---
title: "Перечисление GanttBarType"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.Visualization.GanttBarType. Указывает тип полосы"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Указывает тип пунктирной полосы Gantt. |
| Framed | `1` | Указывает тип рамочной полосы Gantt. |
| Solid | `0` | Указывает тип сплошной полосы Gantt. |
