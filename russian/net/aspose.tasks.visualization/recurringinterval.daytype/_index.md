---
title: "Перечисление RecurringInterval.DayType"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.Visualization.RecurringIntervalDayType. Представляет тип дня, используемый в линиях прогресса"
type: docs
weight: 3320
...
Представляет тип дня, используемый в линиях прогресса.
...
| NonworkingDay | `10` | Обозначает нерабочий день. |
