...
description: "Свойство ViewColumn. Получает или задает выравнивание текста; может быть одним из значений перечисления HorizontalStringAlignment."
type: docs
weight: 30
...
Получает или задает выравнивание текста (может быть одним из значений перечисления [`HorizontalStringAlignment`](../../horizontalstringalignment/)).
...
Показывает, как установить выравнивание текста в столбце (может быть одним из значений перечисления <see cref=\"P:Aspose.Tasks.Visualization.ViewColumn.StringAlignment\" />).
