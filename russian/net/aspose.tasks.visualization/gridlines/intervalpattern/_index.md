...
description: "Свойство Gridlines. Возвращает или задает шаблон линии для вторичных линий сетки"
type: docs
weight: 40
...
Получает или задает шаблон линии для вспомогательных линий сетки.
