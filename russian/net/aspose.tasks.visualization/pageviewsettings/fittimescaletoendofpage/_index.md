...
description: "Свойство PageViewSettings. Получает или задает значение, указывающее, следует ли подгонять шкалу времени к концу страницы при печати"
type: docs
weight: 30
...
Получает или задает значение, указывающее, следует ли подгонять временную шкалу к концу страницы при печати.
