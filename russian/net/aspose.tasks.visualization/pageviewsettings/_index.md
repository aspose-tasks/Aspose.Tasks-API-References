...
description: Представляет параметры печати для представления проекта.
type: docs
weight: 2890
...
Представляет параметры печати для представления проекта.
...
| Имя | Описание |
| --- | --- |
| [FirstColumnsCount](../../aspose.tasks.visualization/pageviewsettings/firstcolumnscount) { get; set; } | Получает или задает количество первых столбцов для печати на всех страницах. |
| [FitTimescaleToEndOfPage](../../aspose.tasks.visualization/pageviewsettings/fittimescaletoendofpage) { get; set; } | Получает или задает значение, указывающее, следует ли подгонять шкалу времени до конца страницы при печати. |
