---
title: "Перечисление LinePattern"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.Visualization.LinePattern. Шаблон линии"
type: docs
weight: 3190
...
| --- | --- | --- |
| None | `0` | Указывает, что линия не будет отображаться. |
| Solid | `1` | Указывает сплошной шаблон линии. |
| CloseDot | `3` | Указывает шаблон линии с закрытыми точками. |
| Dotted | `4` | Указывает пунктирный шаблон линии. |
| Dashed | `2` | Указывает штриховой шаблон линии. |
