...
description: "Свойство PageLegend. Получает или задает центрированный текст, отображаемый в легенде страницы."
type: docs
weight: 30
...
Получает или задает центрированный текст, отображаемый в легенде страницы.
