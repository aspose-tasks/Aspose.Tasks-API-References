...
description: "Свойство HeaderFooterInfo. Получает или задает выровненное по правому краю изображение для отображения в родительском элементе"
type: docs
weight: 80
...
Получает или задает изображение, выровненное по правому краю, которое будет отображаться в родительском элементе.
