...
description: "Свойство HeaderFooterInfo. Получает или задает выровненный по правому краю текст для отображения в родительском элементе"
type: docs
weight: 100
...
Получает или задает текст, выровненный по правому краю, для отображения в родительском элементе.
