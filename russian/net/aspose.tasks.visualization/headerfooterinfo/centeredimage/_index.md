...
description: "Свойство HeaderFooterInfo. Получает или задает центрированное изображение для отображения в родительском элементе"
type: docs
weight: 20
...
Получает или задает центрированное изображение, отображаемое в родительском элементе.
