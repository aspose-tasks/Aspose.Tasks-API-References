...
description: "Свойство HeaderFooterInfo. Получает или задает выровненный по левому краю текст для отображения в родительском элементе"
type: docs
weight: 70
...
Получает или задает текст, выровненный по левому краю, для отображения в родительском элементе.
