...
description: "Свойство HeaderFooterInfo. Получает или задает выровненное по левому краю изображение для отображения в родительском элементе"
type: docs
weight: 50
...
Получает или задает изображение, выровненное по левому краю, которое будет отображаться в родительском элементе.
