...
description: "Свойство GanttBarStyle. Получает или задает пользовательский конвертер для получения текста, отображаемого в верхней части полосы задачи. Переопределяет значение свойства TopField."
type: docs
weight: 260
