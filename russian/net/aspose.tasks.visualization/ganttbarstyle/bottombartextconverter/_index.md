...
description: "Свойство GanttBarStyle. Получает или задает пользовательский конвертер для получения текста, отображаемого в нижней части полосы задач. Переопределяет значение свойства BottomField."
type: docs
weight: 20
