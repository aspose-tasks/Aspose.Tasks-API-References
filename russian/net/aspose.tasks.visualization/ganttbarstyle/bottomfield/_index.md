...
description: "Свойство GanttBarStyle. Получает или задает данные, отображаемые в нижней части полосы. Field"
type: docs
weight: 30
...
Получает или задает данные, отображаемые в нижней части полосы. [`Field`](../../../aspose.tasks/field/).
