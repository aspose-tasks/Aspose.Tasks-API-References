...
description: "Свойство GanttBarStyle. Получает или задает данные, отображаемые справа от полосы. Field"
type: docs
weight: 180
...
Получает или задает данные, отображаемые справа от полосы. [`Field`](../../../aspose.tasks/field/).
