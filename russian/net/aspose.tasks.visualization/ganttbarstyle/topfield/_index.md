...
description: "Свойство GanttBarStyle. Получает или задает данные, отображаемые в верхней части полосы"
type: docs
weight: 270
...
Получает или задает данные, отображаемые в верхней части полосы.
