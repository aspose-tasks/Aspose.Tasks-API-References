...
description: "Свойство GanttBarStyle. Получает или задает позицию начальной точки полосы ганта. Field"
type: docs
weight: 70
...
Получает или задает позицию начальной точки полосы ганта. [`Field`](../../../aspose.tasks/field/).
