...
description: "Свойство GanttBarStyle. Получает или задает пользовательский конвертер для получения текста, отображаемого слева от полосы задач. Переопределяет значение свойства LeftField. Не сохраняется в формате MPP."
type: docs
weight: 100
...
Получает или задает пользовательский конвертер для получения текста, отображаемого слева от полосы задачи. Переопределяет значение свойства [`LeftField`](../leftfield/). Не сохраняется в формате MPP.
