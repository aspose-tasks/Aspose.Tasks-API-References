...
description: "Свойство GanttBarStyle. Получает или задает номер строки. Может быть от 1 до 4, 1 — значение по умолчанию."
type: docs
weight: 190
...
Получает или задает номер строки. Может быть от 1 до 4 (по умолчанию 1).
