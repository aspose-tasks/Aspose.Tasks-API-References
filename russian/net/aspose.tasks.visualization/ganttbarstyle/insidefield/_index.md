...
description: "Свойство GanttBarStyle. Получает или задает данные, отображаемые внутри полосы. Field"
type: docs
weight: 90
...
Получает или задает данные, отображаемые внутри полосы. [`Field`](../../../aspose.tasks/field/).
