...
description: "Свойство GanttBarStyle. Получает или задает данные, отображаемые слева от полосы. Field"
type: docs
weight: 110
...
Получает или задает данные, отображаемые слева от полосы. [`Field`](../../../aspose.tasks/field/).
