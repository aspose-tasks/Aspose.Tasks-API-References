...
description: "Свойство TimescaleTier. Получает или задает интервал единицы времени, в котором отображаются метки уровня. Значение по умолчанию — 1"
type: docs
weight: 30
...
Получает или задает интервал единицы времени, в котором отображаются метки уровня. Значение по умолчанию — 1.
