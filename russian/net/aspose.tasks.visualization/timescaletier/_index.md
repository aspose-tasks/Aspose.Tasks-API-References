...
description: Aspose.Tasks.Visualization.TimescaleTier сорт. Представляет один уровень временной шкалы на диаграмме Ганта.
type: docs
weight: 3090
...
| Имя | Описание |
| --- | --- |
| [TimescaleTier](timescaletier/#constructor)() | Инициализирует новый экземпляр`TimescaleTier` класс. |
| [TimescaleTier](timescaletier/#constructor_1)(TimescaleUnit, int) | Инициализирует новый экземпляр`TimescaleTier` класс. |
