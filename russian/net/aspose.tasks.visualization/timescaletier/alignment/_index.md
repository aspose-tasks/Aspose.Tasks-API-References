...
description: "Свойство TimescaleTier. Получает или задает способ выравнивания меток внутри каждого временного периода уровня HorizontalStringAlignment."
type: docs
weight: 20
...
Получает или задает способ выравнивания меток внутри каждого временного периода уровня ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
