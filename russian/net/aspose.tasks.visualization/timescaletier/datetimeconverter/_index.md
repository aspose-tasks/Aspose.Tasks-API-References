...
description: "Свойство TimescaleTier. Получает или задает функцию обратного вызова для обработки отрисовки деления даты в этом уровне."
type: docs
weight: 40
...
Получает или задает функцию обратного вызова для обработки отрисовки отметки даты в этом уровне.
