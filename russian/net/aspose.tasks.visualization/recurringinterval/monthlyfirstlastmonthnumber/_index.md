...
description: "Свойство RecurringInterval. Возвращает или задает номер месяца линий прогресса, которые отображаются по первому или последнему предопределённому дню"
type: docs
weight: 100
...
Получает или задает номер месяца линий прогресса, которые отображаются по первому или последнему предопределенному дню.
