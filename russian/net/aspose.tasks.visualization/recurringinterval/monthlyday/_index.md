...
description: "Свойство RecurringInterval. Возвращает или задает значение, указывающее, показывать ли ежемесячные линии прогресса по дню"
type: docs
weight: 50
...
Получает или задает значение, указывающее, показывать ли ежемесячные линии прогресса по дням.
