...
description: "Свойство RecurringInterval. Возвращает или задает номер дня ежемесячных линий прогресса"
type: docs
weight: 60
...
Получает или задает номер дня ежемесячных линий прогресса.
