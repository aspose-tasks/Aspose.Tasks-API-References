...
description: "Свойство RecurringInterval. Возвращает или задает номер недели для еженедельных линий прогресса"
type: docs
weight: 120
...
Получает или задает номер недели для еженедельных линий прогресса.
