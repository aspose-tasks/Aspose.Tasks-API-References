...
description: "Свойство TableTextStyle. Получает уникальный идентификатор строки. Возвращает 1, если стиль применяется ко всем строкам представления."
type: docs
weight: 40
...
Получает уникальный идентификатор строки. Возвращает -1, если стиль применяется ко всем строкам представления.
