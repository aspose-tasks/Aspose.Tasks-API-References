...
description: "Свойство PageInfo. Получает экземпляр класса PageViewSettings, который определяет параметры печати представления страницы"
type: docs
weight: 80
...
Получает экземпляр класса `PageViewSettings`, который определяет параметры печати представления страницы.
