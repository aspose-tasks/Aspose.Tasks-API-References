...
description: "Свойство ProgressLines. Получает список выбранных дат, для которых отображаются линии прогресса."
type: docs
weight: 190
...
Получает список выбранных дат для отображения линий прогресса.
