...
description: "Свойство ProgressLines. Получает или задает цвет линии для текущей линии прогресса"
type: docs
weight: 100
...
Получает или задает цвет линии для текущей линии прогресса.
