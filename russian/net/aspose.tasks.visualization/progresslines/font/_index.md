...
description: "Свойство ProgressLines. Получает или задает шрифт, используемый для подписи линии прогресса"
type: docs
weight: 80
...
Получает или задает шрифт, используемый для подписи линии прогресса.
