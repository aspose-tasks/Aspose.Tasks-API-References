...
description: "Свойство ProgressLines. Получает или задает значение, указывающее, следует ли отображать линии прогресса в выбранные даты."
type: docs
weight: 70
...
Получает или задает значение, указывающее, следует ли отображать линии прогресса в выбранные даты.
