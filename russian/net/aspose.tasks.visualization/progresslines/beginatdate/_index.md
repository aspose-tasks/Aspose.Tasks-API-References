...
description: "Свойство ProgressLines. Получает или задает дату, с которой отображать линии прогресса."
type: docs
weight: 20
...
Получает или задает дату, с которой отображаются линии прогресса.
