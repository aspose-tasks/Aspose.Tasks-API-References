...
description: "Свойство ProgressLines. Получает или задает значение, указывающее, следует ли отображать линии прогресса с начала даты начала проекта"
type: docs
weight: 30
...
Получает или задает значение, указывающее, следует ли отображать линии прогресса с начала даты начала проекта.
