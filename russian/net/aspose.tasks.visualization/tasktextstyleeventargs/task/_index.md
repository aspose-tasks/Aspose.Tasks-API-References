...
description: "Свойство TaskTextStyleEventArgs. Получает Task, соответствующий текущей отрисованной строке."
type: docs
weight: 30
...
Получает `Task`, который соответствует текущей отрисованной строке.
