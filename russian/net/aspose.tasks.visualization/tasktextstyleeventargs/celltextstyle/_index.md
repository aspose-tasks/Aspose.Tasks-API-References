...
description: "Свойство TaskTextStyleEventArgs. Получает или задает TextStyle, который будет использоваться для отрисовки содержимого ячеек. Этот объект можно использовать для настройки внешнего вида ячейки таблицы."
type: docs
weight: 10
