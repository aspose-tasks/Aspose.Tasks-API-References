...
description: "Свойство TaskTextStyleEventArgs. Получает ViewColumn, к которому принадлежит текущая отрисованная ячейка."
type: docs
weight: 20
...
Получает [`ViewColumn`](../../viewcolumn/), к которому принадлежит текущая отрисованная ячейка.
