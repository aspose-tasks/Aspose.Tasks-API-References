...
description: Aspose.Tasks.Util.RemoveTask сорт. Удаляет указанную задачу из дерева задач.
type: docs
weight: 2440
...
| Имя | Описание |
| --- | --- |
| [RemoveTask](removetask/)(Task) | Инициализирует новый экземпляр`RemoveTask` класс. |
