...
description: "Конструктор GenericProperty. Инициализирует новый экземпляр структуры GenericProperty"
type: docs
weight: 10
...
Инициализирует новый экземпляр структуры [`GenericProperty`](../).
