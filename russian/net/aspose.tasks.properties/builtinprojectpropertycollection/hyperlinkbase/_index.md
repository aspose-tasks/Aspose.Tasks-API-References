...
description: "BuiltInProjectPropertyCollection property. Возвращает или задает базу гиперссылки проекта"
type: docs
weight: 50
...
Получает или задает базовый URL гиперссылок проекта.
