...
description: "Конструктор CustomProjectPropertyCollection. Инициализирует новый экземпляр класса CustomProjectPropertyCollection"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`CustomProjectPropertyCollection`](../).
