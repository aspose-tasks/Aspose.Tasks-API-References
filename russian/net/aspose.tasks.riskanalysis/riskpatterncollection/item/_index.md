...
description: "Свойство RiskPatternCollection. Возвращает экземпляр класса RiskPattern для указанной задачи"
type: docs
weight: 30
...
Возвращает экземпляр класса [`RiskPattern`](../../riskpattern/) для указанной задачи.
