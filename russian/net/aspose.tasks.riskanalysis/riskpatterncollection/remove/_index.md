...
description: "Метод RiskPatternCollection. Удаляет первое вхождение указанного объекта из этой коллекции."
type: docs
weight: 90
url: /ru/net/aspose.tasks.riskanalysis/riskpatterncollection/remove/
---
...
| --- | --- | --- |
| элемент | RiskPattern | указанный объект для удаления. |
