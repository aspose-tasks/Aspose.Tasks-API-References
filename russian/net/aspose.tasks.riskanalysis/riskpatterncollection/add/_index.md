...
description: "Метод RiskPatternCollection. Добавляет экземпляр класса RiskPattern в эту коллекцию."
type: docs
weight: 40
...
| --- | --- | --- |
| item | RiskPattern | экземпляр класса [`RiskPattern`](../../riskpattern/), который нужно добавить в эту коллекцию. |

### Исключения

| исключение | условие |
| --- | --- |
| ArgumentNullException | *item* задача равна null. |
