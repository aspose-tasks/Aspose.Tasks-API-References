---
title: "Перечисление ProbabilityDistributionType"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Aspose.Tasks.RiskAnalysis.ProbabilityDistributionType перечисление. Указывает типы поддерживаемых вероятностных распределений."
type: docs
weight: 1860
...
Указывает типы поддерживаемых распределений вероятностей.
...
| --- | --- | --- |
| Uniform | `0` | Распределение, при котором каждое значение выбирается с одинаковой вероятностью. |
| Normal | `1` | Распределение, которое иногда неформально называют колоколообразной кривой (гауссово распределение). |
