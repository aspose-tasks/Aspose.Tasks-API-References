---
title: "Класс RiskItemStatisticsCollection"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Aspose.Tasks.RiskAnalysis.RiskItemStatisticsCollection class. Представляет коллекцию, содержащую экземпляры класса RiskItemStatistics"
type: docs
weight: 1910
...
| Имя | Описание |
| --- | --- |
| [Get](../../aspose.tasks.riskanalysis/riskitemstatisticscollection/get/)(Task) | Возвращает экземпляр класса [`RiskItemStatistics`](../riskitemstatistics/), содержащийся в этой коллекции и связанный с указанным объектом Task; null, если элемент не найден. |
