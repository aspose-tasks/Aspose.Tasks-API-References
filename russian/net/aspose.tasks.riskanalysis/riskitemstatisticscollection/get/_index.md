...
description: "Метод RiskItemStatisticsCollection. Возвращает экземпляр класса RiskItemStatistics, содержащийся в этой коллекции и связанный с указанным объектом Task, null если элемент не найден."
type: docs
weight: 10
...
Возвращает экземпляр класса [`RiskItemStatistics`](../../riskitemstatistics/), содержащийся в этой коллекции и связанный с указанным объектом Task; null если элемент не найден.
...
элемент риска, связанный с указанным объектом задачи, если найден; null в противном случае.
