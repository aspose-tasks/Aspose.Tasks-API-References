---
title: "Класс RiskAnalysisResult"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Aspose.Tasks.RiskAnalysis.RiskAnalysisResult класс. Представляет результат анализа рисков."
type: docs
weight: 1870
...
Представляет результат анализа рисков.
...
| [SaveReport](../../aspose.tasks.riskanalysis/riskanalysisresult/savereport/#savereport_1)(string) | Сохраняет отчет анализа рисков по указанному пути к файлу в формате PDF. |
