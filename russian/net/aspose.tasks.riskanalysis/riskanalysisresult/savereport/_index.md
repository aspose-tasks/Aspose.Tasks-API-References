...
description: "Метод RiskAnalysisResult. Сохраняет отчет анализа риска в поток в формате PDF"
type: docs
weight: 20
...
| --- | --- | --- |
| поток | Поток | Поток, в который сохраняется отчет анализа риска. |
...
Сохраняет отчет анализа рисков по указанному пути к файлу в формате PDF.
