...
description: "Свойство RiskPattern. Получает задачу проекта, к которой применяется данный шаблон риска"
type: docs
weight: 60
...
Получает задачу проекта, к которой применяется данный шаблон риска.
