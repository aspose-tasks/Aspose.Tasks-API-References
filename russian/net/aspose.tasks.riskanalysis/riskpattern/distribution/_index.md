...
description: "Свойство RiskPattern. Получает или задает распределение вероятностей, используемое в моделировании Монте‑Карло. Значение по умолчанию — ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
Получает или задает распределение вероятностей, используемое в моделировании Монте‑Карло. Значение по умолчанию — ProbabilityDistributionType.Normal.
...
Может быть одним из значений, определённых в перечислении [`ProbabilityDistributionType`](../../probabilitydistributiontype/).
