...
description: "Конструктор RiskPattern. Инициализирует новый экземпляр класса RiskPattern"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`RiskPattern`](../).
...
| --- | --- | --- |
| задача | Задача | указанная задача проекта, для которой этот риск будет применён в моделировании Монте‑Карло. |
