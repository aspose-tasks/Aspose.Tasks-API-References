...
description: "Свойство RiskPattern. Получает или задает уровень доверия, который соответствует проценту времени, когда фактически сгенерированные значения будут находиться в пределах оптимистичных и пессимистичных оценок. Значение по умолчанию — CL99"
type: docs
weight: 20
...
Получает или задает уровень доверия, соответствующий проценту времени, когда фактические сгенерированные значения будут находиться в пределах оптимистических и пессимистических оценок. Значение по умолчанию — CL99.
...
Может быть одним из значений, определённых в перечислении `ConfidenceLevel`.
