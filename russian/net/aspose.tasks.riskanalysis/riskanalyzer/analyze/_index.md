...
description: RiskAnalyzer метод. Выполняет анализ рисков для указанного проекта. Анализ основан на моделировании МонтеКарло и результатом является примерRiskAnalysisResult класс.
type: docs
weight: 30
