...
description: Выполняет моделирование методом Монте-Карло на основе указанных настроек анализа рисков.
type: docs
weight: 1620
...
| Имя | Описание |
| --- | --- |
| [RiskAnalyzer](riskanalyzer)(RiskAnalysisSettings) | Инициализирует новый экземпляр[`RiskAnalyzer`](../riskanalyzer) класс. |
