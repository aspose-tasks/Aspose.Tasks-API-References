...
description: "Свойство RiskAnalysisSettings. Возвращает или задает количество итераций, используемых в моделировании Монте‑Карло. Значение по умолчанию — 100"
type: docs
weight: 20
...
Получает или задает количество итераций, используемых в моделировании Монте-Карло. Значение по умолчанию — 100.
