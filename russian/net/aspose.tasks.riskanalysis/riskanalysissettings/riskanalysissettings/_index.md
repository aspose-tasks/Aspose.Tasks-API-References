...
description: "Конструктор RiskAnalysisSettings. Инициализирует новый экземпляр класса RiskAnalysisSettings"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`RiskAnalysisSettings`](../).
