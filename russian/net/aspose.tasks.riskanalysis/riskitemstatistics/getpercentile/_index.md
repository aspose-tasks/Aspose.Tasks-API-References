...
description: "Метод RiskItemStatistics. Возвращает значение, ниже которого находится указанный процент сгенерированных образцов"
type: docs
weight: 60
...
Получает значение, ниже которого находится указанный процент сгенерированных образцов.
...
| --- | --- | --- |
| процент | Int32 | указанный процент от 0 до 100. |

### Возвращаемое значение

значение, ниже которого находится указанный процент сгенерированных образцов.
