...
description: "Свойство RiskItemStatistics. Возвращает минимальное значение, сгенерированное в ходе моделирования Монте‑Карло"
type: docs
weight: 40
...
Получает минимальное значение, сгенерированное во время моделирования Монте‑Карло.
