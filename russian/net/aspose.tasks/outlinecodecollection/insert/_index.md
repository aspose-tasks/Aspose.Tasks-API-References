...
description: "Метод OutlineCodeCollection. Вставляет указанный элемент в указанный индекс."
type: docs
weight: 100
...
| элемент | OutlineCode | указанный элемент для вставки в эту коллекцию. |
