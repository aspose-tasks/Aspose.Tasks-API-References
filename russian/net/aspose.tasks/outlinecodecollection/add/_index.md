...
description: "Метод OutlineCodeCollection. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 40
...
| --- | --- | --- |
| элемент | OutlineCode | указанный элемент для добавления в эту коллекцию. |
