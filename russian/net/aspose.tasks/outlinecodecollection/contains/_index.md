...
description: "OutlineCodeCollection метод. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 60
...
| --- | --- | --- |
| элемент | OutlineCode | указанный элемент для поиска. |
