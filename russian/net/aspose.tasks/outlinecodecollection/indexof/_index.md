...
description: "OutlineCodeCollection метод. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 90
...
| --- | --- | --- |
| элемент | OutlineCode | указанный элемент для поиска в этой коллекции. |
