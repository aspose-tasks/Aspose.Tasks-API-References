...
description: "OutlineCodeCollection метод. Удаляет первое вхождение конкретного объекта из этой коллекции"
type: docs
weight: 110
...
| --- | --- | --- |
| элемент | OutlineCode | указанный объект для удаления. |
