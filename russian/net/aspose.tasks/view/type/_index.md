...
description: "Свойство View. Получает тип элемента в единственном представлении, например задачи или ресурсы. Только для чтения ItemType"
type: docs
weight: 110
...
Получает тип элемента в единственном представлении, например задачи или ресурсы. Только для чтения [`ItemType`](../../itemtype/).
