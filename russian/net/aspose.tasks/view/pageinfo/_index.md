...
description: "Свойство View. Возвращает экземпляр класса PageInfo. Представляет данные настройки страницы, присутствующие в формате файлов mpp."
type: docs
weight: 60
...
Возвращает экземпляр класса `PageInfo`. Представляет данные настройки страницы, присутствующие в формате файлов mpp.
