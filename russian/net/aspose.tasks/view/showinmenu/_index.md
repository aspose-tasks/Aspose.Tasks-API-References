...
description: "Свойство View. Получает или задает значение, указывающее, отображает ли Microsoft Project имя отдельного представления в списках выпадающих меню View или Other Views на ленте."
type: docs
weight: 90
url: /ru/net/aspose.tasks/view/showinmenu/
---
## View.ShowInMenu property

Получает или задает значение, указывающее, отображает ли Microsoft Project имя отдельного представления в выпадающих списках View или Other Views на ленте.
