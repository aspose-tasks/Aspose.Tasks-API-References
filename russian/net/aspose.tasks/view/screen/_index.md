...
description: "Свойство View. Возвращает тип экрана для одиночного представления. Только для чтения ViewScreen."
type: docs
weight: 80
...
Возвращает тип экрана для одиночного представления. Только для чтения [`ViewScreen`](../../viewscreen/).
