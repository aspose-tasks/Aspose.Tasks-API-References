...
description: Aspose.Tasks.View сорт. Представляет представление в Project.
type: docs
weight: 2560
...
| Имя | Описание |
| --- | --- |
| [View](view/#constructor)() | Инициализирует новый экземпляр`View` класс. |
| [View](view/#constructor_1)(ViewScreen) | Инициализирует новый экземпляр`View` класс. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo/) { get; } | Получает экземпляр[`PageInfo`](./pageinfo/)сорт. Представляет данные настройки страницы, представленные в формате файла mpp. |
