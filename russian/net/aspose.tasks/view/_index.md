...
| Имя | Описание |
| --- | --- |
| [View](view#constructor)() | Инициализирует новый экземпляр класса[`View`](../view). |
| [View](view#constructor_1)(ViewScreen) | Инициализирует новый экземпляр класса[`View`](../view). |
...
| [PageInfo](../../aspose.tasks/view/pageinfo) { get; } | Получает экземпляр класса[`PageInfo`](./pageinfo). Представляет данные настройки страницы, представленные в формате файла mpp. |
...
| [operator &lt;=](../../aspose.tasks/view/op_lessthanorequal) | Возвращает значение, указывающее, меньше ли этот экземпляр указанного объекта или равен ему. |
