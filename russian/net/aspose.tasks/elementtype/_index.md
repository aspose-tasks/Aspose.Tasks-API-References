---
title: "Перечисление ElementType"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.ElementType. Указывает тип элемента."
type: docs
weight: 490
...
| --- | --- | --- |
| Null | `0` | Указывает тип элемента Null. |
| Task | `1` | Указывает тип элемента Task. |
| Resource | `2` | Указывает тип элемента Resource. |
| Calendar | `3` | Указывает тип элемента Calendar. |
| Assignment | `4` | Указывает тип элемента Assignment. |
