...
description: "Конструктор CalendarException. Инициализирует новый экземпляр класса CalendarException"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`CalendarException`](../).
