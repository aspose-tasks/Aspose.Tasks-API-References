...
description: "Свойство Project. Получает все определения групп, основанных на ресурсах. ResourceGroups представляет собой коллекцию объектов Group"
type: docs
weight: 770
...
Получает все определения групп, основанных на ресурсах. ResourceGroups представляет собой коллекцию объектов [`Group`](../../group/).
...
Показывает, как читать группы ресурсов.
