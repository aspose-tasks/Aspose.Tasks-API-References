...
description: "Метод Project. Пересчитывает Id, Start и Finish ресурсов"
type: docs
weight: 1160
...
Пересчитывает идентификатор, дату начала и окончания ресурсов.
...
Показывает, как пересчитать общие поля ресурсов.
...
// Пересчитывает Id, Start и Finish ресурсов
