...
description: "Свойство Project. Получает объект OutlineCodeDefinitionCollection. Коллекция определений кодов структуры, связанных с проектом"
type: docs
weight: 710
...
Получает объект OutlineCodeDefinitionCollection. Коллекция определений контурных кодов, связанных с проектом.
...
Показывает, как читать коды структуры.
...
foreach (var ocd in project.OutlineCodes)
{
    ...
    // Отобразить маски кодов структуры
    ...
    // Отобразить значения кодов структуры
