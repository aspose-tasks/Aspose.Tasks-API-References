...
description: "Свойство Project. Получает все определения групп, основанных на задачах. TaskGroups представляет собой коллекцию объектов Group."
type: docs
weight: 920
...
Получает все определения групп, основанные на задачах. TaskGroups — это коллекция объектов [`Group`](../../group/).
...
Показывает, как читать группы задач.
