...
description: "Метод OutlineMaskCollection. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 40
...
| --- | --- | --- |
| элемент | OutlineMask | указанный элемент для добавления в эту коллекцию. |
