...
description: "Метод OutlineMaskCollection. Вставляет указанный элемент в указанный индекс"
type: docs
weight: 100
...
| элемент | OutlineMask | указанный элемент для вставки в эту коллекцию. |
