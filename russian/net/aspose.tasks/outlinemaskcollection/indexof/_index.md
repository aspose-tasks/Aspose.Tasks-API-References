...
description: "Метод OutlineMaskCollection. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 90
...
| --- | --- | --- |
| элемент | OutlineMask | указанный элемент для поиска в этой коллекции. |
