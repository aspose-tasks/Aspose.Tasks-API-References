...
description: "Метод OutlineMaskCollection. Копирует элементы этой коллекции в указанный массив, начиная с указанного индекса массива"
type: docs
weight: 70
...
| --- | --- | --- |
| массив | OutlineMask[] | указанный одномерный массив, в который копировать элементы |
