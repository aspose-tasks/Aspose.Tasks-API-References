...
description: "Метод AvailabilityPeriodCollection. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 50
...
| --- | --- | --- |
| элемент | AvailabilityPeriod | указанный элемент для добавления в эту коллекцию. |
