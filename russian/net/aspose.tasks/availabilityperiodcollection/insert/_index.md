...
description: "Метод AvailabilityPeriodCollection. Вставляет указанный элемент в указанный индекс"
type: docs
weight: 110
...
| --- | --- | --- |
| индекс | Int32 | указанный нулевой индекс, по которому должен быть вставлен элемент. |
| элемент | AvailabilityPeriod | указанный элемент для вставки в эту коллекцию. |
