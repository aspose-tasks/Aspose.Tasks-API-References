...
description: "Свойство AvailabilityPeriodCollection. Возвращает значение, указывающее, является ли эта коллекция только для чтения; в противном случае — false"
type: docs
weight: 20
url: /ru/net/aspose.tasks/availabilityperiodcollection/isreadonly/
---
