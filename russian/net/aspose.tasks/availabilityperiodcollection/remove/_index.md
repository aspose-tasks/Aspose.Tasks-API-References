...
description: "AvailabilityPeriodCollection метод. Удаляет первое вхождение конкретного объекта из этой коллекции"
type: docs
weight: 120
...
| --- | --- | --- |
| элемент | AvailabilityPeriod | указанный объект для удаления. |
