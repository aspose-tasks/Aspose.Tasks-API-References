...
description: "AvailabilityPeriodCollection метод. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 70
...
| --- | --- | --- |
| элемент | AvailabilityPeriod | указанный элемент для поиска. |
