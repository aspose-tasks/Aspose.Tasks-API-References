...
description: "AvailabilityPeriodCollection метод. Копирует элементы этой коллекции в указанный массив, начиная с указанного индекса массива"
type: docs
weight: 80
url: /ru/net/aspose.tasks/availabilityperiodcollection/copyto/
---
...
| --- | --- | --- |
| массив | AvailabilityPeriod[] | указанный одномерный массив, в который копировать элементы |
