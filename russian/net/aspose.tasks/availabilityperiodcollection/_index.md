---
title: "Класс AvailabilityPeriodCollection"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Aspose.Tasks.AvailabilityPeriodCollection class. Представляет коллекцию, содержащую объекты AvailabilityPeriod"
type: docs
weight: 90
...
Представляет коллекцию, содержащую объекты [`AvailabilityPeriod`](../availabilityperiod/).
...
| [IsReadOnly](../../aspose.tasks/availabilityperiodcollection/isreadonly/) { get; } | Возвращает значение, указывающее, является ли эта коллекция только для чтения; в противном случае — false. |
| [Item](../../aspose.tasks/availabilityperiodcollection/item/) { get; set; } | Возвращает или задает элемент по указанному индексу. |
| [ParentResource](../../aspose.tasks/availabilityperiodcollection/parentresource/) { get; } | Получает родительский [`Resource`](../resource/) для этого объекта. Родительский объект [`Resource`](../resource/) для этой коллекции. |
...
| [Insert](../../aspose.tasks/availabilityperiodcollection/insert/)(int, AvailabilityPeriod) | Вставляет указанный элемент в указанный индекс. |
| [Remove](../../aspose.tasks/availabilityperiodcollection/remove/)(AvailabilityPeriod) | Удаляет первое вхождение конкретного объекта из этой коллекции. |
| [RemoveAt](../../aspose.tasks/availabilityperiodcollection/removeat/)(int) | Удаляет элемент по указанному индексу. |

## Примеры

Показывает, как работать с коллекцией периодов доступности ресурса.
...
public void WorkWithAvailabilityPeriodCollection()
{
    ...
    // Добавьте периоды доступности (2012 и 2014 годы) к новому ресурсу
    ...
    // Обновите доступные единицы для периода 2014 года
    otherResource.AvailabilityPeriods[otherResource.AvailabilityPeriods.Count - 2].AvailableUnits = 0.90;

    // Удалите период 2013 года
    otherResource.AvailabilityPeriods.Remove(period2013);

    // Удалите период 2011 года
