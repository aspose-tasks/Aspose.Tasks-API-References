...
| [Insert](../../aspose.tasks/availabilityperiodcollection/insert)(int, AvailabilityPeriod) | Вставляет указанный элемент по указанному индексу. |
| [Remove](../../aspose.tasks/availabilityperiodcollection/remove)(AvailabilityPeriod) | Удаляет первое вхождение определенного объекта из этой коллекции. |
