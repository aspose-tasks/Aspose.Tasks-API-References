---
title: "Перечисление ViewScreen"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.ViewScreen. Указывает тип экрана для представления"
type: docs
weight: 2910
...
Указывает тип экрана для представления.
...
| --- | --- | --- |
| Calendar | `13` | Вид календаря. |
| Gantt | `1` | Вид Ганта. |
| NetworkDiagram | `2` | Вид сетевой диаграммы. |
| RelationshipDiagram | `3` | Вид диаграммы взаимосвязей. |
| ResourceForm | `6` | Вид формы ресурса. |
| ResourceGraph | `8` | Вид графика ресурса. |
| ResourceNameForm | `12` | Вид формы имени ресурса. |
| ResourceSheet | `7` | Вид листа ресурса. |
| ResourceUsage | `15` | Вид использования ресурса. |
| TaskDetailsForm | `10` | Вид формы деталей задачи. |
| TaskForm | `4` | Вид формы задачи. |
| TaskNameForm | `11` | Вид формы имени задачи. |
| TaskSheet | `5` | Вид листа задачи. |
| TaskUsage | `14` | Вид использования задачи. |
