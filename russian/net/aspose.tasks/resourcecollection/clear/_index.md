...
description: "Метод ResourceCollection. Прямое удаление не поддерживается, этот метод просто бросает NotSupportedException"
type: docs
weight: 50
...
Прямое очищение не поддерживается, этот метод просто бросает NotSupportedException.
