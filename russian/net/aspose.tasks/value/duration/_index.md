...
description: "Свойство Value. Получает или задает фактическое значение, которое используется для представления Duration."
type: docs
weight: 40
...
Возвращает или задает фактическое значение, используемое для представления длительности.
...
Предпочтите это свойство вместо [`Val`](../val/), когда нужно установить значение Duration.
