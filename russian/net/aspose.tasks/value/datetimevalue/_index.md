...
description: "Свойство Value. Получает или задает фактическое значение, если оно может быть представлено как DateTime. Значение по умолчанию — MinValue."
type: docs
weight: 20
...
Возвращает или задает фактическое значение, если оно может быть представлено как DateTime. Значение по умолчанию — MinValue.
...
Предпочтительно использовать это свойство вместо [`Val`](../val/), когда необходимо установить значение DateTime.
