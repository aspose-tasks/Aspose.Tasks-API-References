...
description: "Свойство Value. Получает или задает уникальный идентификатор значения в рамках проекта."
type: docs
weight: 50
...
Возвращает или задает уникальный идентификатор значения в рамках проекта.

Важно, чтобы разные экземпляры [`Value`](../) не имели одинаковых идентификаторов.
