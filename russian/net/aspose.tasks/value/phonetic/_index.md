...
description: "Свойство Value. Получает или задает фонетическую информацию о названии пользовательского поля."
type: docs
weight: 70
url: /ru/net/aspose.tasks/value/phonetic/
---
## Value.Phonetic property

Возвращает или задает фонетическую информацию о названии пользовательского поля.
