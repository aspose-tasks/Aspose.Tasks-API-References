...
description: "Свойство Value. Получает или задает фактическое значение, используемое для представления текстовой строки."
type: docs
weight: 80
...
Возвращает или задает фактическое значение, используемое для представления текстовой строки.
...
Предпочтительно использовать это свойство вместо [`Val`](../val/), когда необходимо установить текстовое значение.
