...
description: "Свойство Value. Получает или задает фактическое значение во внутреннем представлении. Предпочтительно использовать строго типизированные свойства, перечисленные ниже"
type: docs
weight: 90
...
Возвращает или задает фактическое значение во внутреннем представлении. Предпочтительно использовать строго типизированные свойства, перечисленные ниже.
...
Если вы хотите установить значение Text, предпочтительно использовать строго типизированное свойство [`StringValue`](../stringvalue/).

Если вы хотите установить значение Number или Cost, предпочтительно использовать строго типизированное свойство [`NumericValue`](../numericvalue/).

Если вы хотите установить значения Date/Start/Finish, предпочтительно использовать строго типизированное свойство [`DateTimeValue`](../datetimevalue/).

Если вы хотите установить значение Duration, предпочтительно использовать строго типизированное свойство [`Duration`](../duration/).

Если ваш тип не указан, используйте свойство `Val`.
