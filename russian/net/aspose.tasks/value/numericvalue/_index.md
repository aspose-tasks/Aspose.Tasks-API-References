...
description: "Свойство Value. Получает или задает фактическое значение, которое используется для представления числового или стоимостного значения"
type: docs
weight: 60
...
Возвращает или задает фактическое значение, используемое для представления числового или стоимостного значения.
...
Предпочтите это свойство вместо [`Val`](../val/), когда нужно установить значение Number или Cost.
