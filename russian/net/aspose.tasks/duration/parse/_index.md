...
description: "Метод Duration. Преобразует указанную строку в экземпляр структуры Duration"
type: docs
weight: 10
...
Преобразует указанную строку в экземпляр структуры [`Duration`](../).
...
| value | Строка | указанную строку для преобразования. |

### Возвращаемое значение

Возвращает преобразованный экземпляр структуры [`Duration`](../).
