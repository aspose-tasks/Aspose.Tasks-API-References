...
description: "Свойство Duration. Получает значение, указывающее, истекла ли единица времени. Флаг, определяющий, истек ли данный экземпляр Duration."
type: docs
weight: 20
...
Возвращает значение, указывающее, является ли единица времени прошедшей. Флаг, определяющий, является ли данный экземпляр Duration прошедшим.
