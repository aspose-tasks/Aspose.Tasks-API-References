...
description: Aspose.Tasks.Duration структура. Представляет длительность проекта.
type: docs
weight: 470
...
| Имя | Описание |
| --- | --- |
| static [Parse](../../aspose.tasks/duration/parse/)(Project, string) | Преобразует указанную строку в экземпляр`Duration` структура. |
