...
description: "Поле Tsk. Указывает, назначен ли задаче ресурс, у которого больше работы по назначенным задачам, чем может быть выполнено в рамках нормальной рабочей нагрузки"
type: docs
weight: 470
...
Указывает, назначен ли для задачи ресурс, у которого больше работы по назначенным задачам, чем может быть выполнено в рамках обычной рабочей нагрузки.
