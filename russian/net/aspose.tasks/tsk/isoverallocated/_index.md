...
description: "Поле Tsk. Указывает, назначен ли любой из ресурсов задачи на больше работы, чем может быть выполнено в пределах нормальной рабочей нагрузки"
type: docs
weight: 650
...
Указывает, назначен ли какой-либо из ресурсов задачи на большее количество работы, чем может быть выполнено в рамках обычной рабочей нагрузки.
