...
description: "WBSCodeMaskCollection метод. Удаляет первое вхождение указанного объекта из этой коллекции"
type: docs
weight: 80
...
| --- | --- | --- |
| элемент | WBSCodeMask | указанный объект для удаления. |
