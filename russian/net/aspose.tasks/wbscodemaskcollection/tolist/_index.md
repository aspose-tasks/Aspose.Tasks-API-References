...
description: "Метод WBSCodeMaskCollection. Преобразует WBSCodeMaskCollection в список объектов WBSCodeMask"
type: docs
weight: 90
...
Обобщённый список объектов [`WBSCodeMask`](../../wbscodemask/).
