...
description: "Метод WBSCodeMaskCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 50
...
| --- | --- | --- |
| элемент | WBSCodeMask | указанный элемент для поиска. |
