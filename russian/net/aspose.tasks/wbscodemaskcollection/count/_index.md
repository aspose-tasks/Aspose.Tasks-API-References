...
description: "WBSCodeMaskCollection свойство. Возвращает количество элементов, содержащихся в этой коллекции"
type: docs
weight: 10
url: /ru/net/aspose.tasks/wbscodemaskcollection/count/
---
