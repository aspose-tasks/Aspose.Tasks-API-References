...
description: "Свойство UsageView. Получает или задает значение, указывающее, повторять ли заголовок деталей на каждой строке назначения или нет"
type: docs
weight: 60
...
Получает или задает значение, указывающее, повторять ли заголовок деталей во всех строках назначений или нет.
