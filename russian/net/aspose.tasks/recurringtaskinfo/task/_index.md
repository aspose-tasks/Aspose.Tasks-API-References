...
description: "Свойство RecurringTaskInfo. Получает родительскую задачу этого экземпляра класса RecurringTaskInfo"
type: docs
weight: 140
...
Получает родительскую задачу этого экземпляра класса [`RecurringTaskInfo`](../).
