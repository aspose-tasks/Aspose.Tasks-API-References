...
description: "Свойство RecurringTaskInfo. Получает или задает количество повторений для ежемесячного шаблона повторения."
type: docs
weight: 90
...
Получает или задает количество повторений для месячного шаблона повторения.
