...
description: "Свойство RecurringTaskInfo. Получает или задает количество повторений для еженедельного шаблона повторения."
type: docs
weight: 170
...
Получает или задает количество повторений для недельного шаблона повторения.
