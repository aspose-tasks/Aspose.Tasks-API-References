...
description: "Свойство RecurringTaskInfo. Получает или задает коллекцию дней, используемых в еженедельном шаблоне повторения."
type: docs
weight: 160
...
Получает или задает коллекцию дней, используемых в недельном шаблоне повторения.
