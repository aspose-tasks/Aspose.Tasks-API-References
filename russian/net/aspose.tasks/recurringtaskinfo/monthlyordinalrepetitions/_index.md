...
description: "Свойство RecurringTaskInfo. Получает или задает количество повторений ежемесячного шаблона при использовании порядкового дня."
type: docs
weight: 80
...
Получает или задает количество повторений для месячного шаблона повторения при использовании порядкового дня.
