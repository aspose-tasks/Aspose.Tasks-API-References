...
description: "Свойство RecurringTaskInfo. Получает или задает номер дня в ежемесячном шаблоне повторения."
type: docs
weight: 50
...
Получает или задает количество дней в месячном шаблоне повторения.
