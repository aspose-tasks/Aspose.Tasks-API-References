...
description: "Свойство RecurringTaskInfo. Получает или задает количество повторений повторяющейся задачи."
type: docs
weight: 110
...
Получает или задает количество появлений повторяющейся задачи.
