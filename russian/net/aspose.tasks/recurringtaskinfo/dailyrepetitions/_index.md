...
description: "Свойство RecurringTaskInfo. Получает или задает количество повторений для ежедневного шаблона повторения."
type: docs
weight: 10
...
Получает или задает количество повторений для ежедневного шаблона повторения.
