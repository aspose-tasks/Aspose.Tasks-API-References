...
description: "Свойство RecurringTaskInfo. Получает или задает порядковый номер ежегодного шаблона повторения. Может быть одним из значений перечисления OrdinalNumber."
type: docs
weight: 210
...
Получает или задает порядковый номер ежегодного шаблона повторения. Может быть одним из значений перечисления [`OrdinalNumber`](../../ordinalnumber/).
