...
description: "Свойство RecurringTaskInfo. Получает или задает значение, указывающее, использовать ли порядковый день для ежегодного шаблона повторения."
type: docs
weight: 220
...
Получает или задает значение, указывающее, использовать ли порядковый день для годового шаблона повторения.
