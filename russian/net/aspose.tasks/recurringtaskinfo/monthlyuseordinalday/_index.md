...
description: "Свойство RecurringTaskInfo. Получает или задает значение, указывающее, использовать ли порядковый день для ежемесячного шаблона повторения."
type: docs
weight: 100
...
Получает или задает значение, указывающее, использовать ли порядковый день для месячного шаблона повторения.
