...
description: "Свойство RecurringTaskInfo. Получает или задает шаблон повторения задачи. Может быть одним из значений перечисления RecurrencePattern"
type: docs
weight: 120
...
Получает или задает шаблон повторения задачи. Может быть одним из значений перечисления `RecurrencePattern`.
