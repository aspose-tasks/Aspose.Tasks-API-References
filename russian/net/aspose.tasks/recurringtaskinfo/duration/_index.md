...
description: "Свойство RecurringTaskInfo. Получает или задает продолжительность одного повторения задачи. экземпляр класса Duration"
type: docs
weight: 30
...
Получает или задает продолжительность одного повторения задачи. экземпляр класса `Duration`.
