...
description: "Свойство RecurringTaskInfo. Получает или задает дату для ежегодного шаблона повторения"
type: docs
weight: 180
...
Получает или задает дату для годового шаблона повторения.
