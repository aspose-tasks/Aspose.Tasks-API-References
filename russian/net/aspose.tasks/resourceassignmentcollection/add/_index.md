...
description: "Метод ResourceAssignmentCollection. Добавляет новое назначение в ResourceAssignmentCollection"
type: docs
weight: 50
...
| --- | --- | --- |
| задача | Задача | Задача для назначения. |
| ресурс | Ресурс | Ресурс для назначения. |
| единицы | Double | Количество единиц для нового назначения. |
...
| --- | --- | --- |
| задача | Задача | Задача для назначения. |
| ресурс | Ресурс | Ресурс стоимости для назначения. |
| стоимость | Decimal | Стоимость нового назначения. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| элемент | ResourceAssignment | Элемент для удаления. |
