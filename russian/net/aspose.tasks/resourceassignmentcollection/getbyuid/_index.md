...
description: "Метод ResourceAssignmentCollection. Возвращает назначение с указанным uid"
type: docs
weight: 60
...
Возвращает назначение с указанным uid.
...
ResourceAssignment с указанным uid, если он присутствует; иначе null.
