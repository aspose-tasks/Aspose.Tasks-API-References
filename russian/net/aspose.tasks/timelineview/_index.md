...
description: Aspose.Tasks.TimelineView сорт. Представляет временную шкалу проекта.
type: docs
weight: 2270
...
| Имя | Описание |
| --- | --- |
| [TimelineView](timelineview/)() | Инициализирует новый экземпляр`TimelineView` сорт. |
