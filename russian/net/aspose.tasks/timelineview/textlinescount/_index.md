...
description: "Свойство TimelineView. Возвращает или задает значение, указывающее, сколько строк используется для отображения задачи на временной шкале"
type: docs
weight: 80
...
Получает или задает значение, указывающее, сколько линий используется для отображения задач во временной шкале.
