...
description: "Свойство TimelineView. Получает или задает значение, указывающее, как форматировать даты в представлении Timeline."
type: docs
weight: 20
...
Получает или задает значение, указывающее, как форматировать даты во view Timeline.
