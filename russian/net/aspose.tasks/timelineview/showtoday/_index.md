...
description: "Свойство TimelineView. Возвращает или задает значение, указывающее, отображать ли линию, представляющую сегодняшний день"
type: docs
weight: 70
...
Получает или задает значение, указывающее, отображать ли линию, представляющую текущий день.
