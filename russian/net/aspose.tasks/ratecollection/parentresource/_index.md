...
description: "Свойство RateCollection. Возвращает родительский объект Resource для этой коллекции"
type: docs
weight: 40
...
Возвращает родительский объект [`Resource`](../../resource/) для этой коллекции.
