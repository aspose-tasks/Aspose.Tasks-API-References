...
description: "Метод RateCollection. Удаляет экземпляр Rate из этой коллекции"
type: docs
weight: 70
...
| --- | --- | --- |
| элемент | Rate | Элемент для удаления. |

### Возвращаемое значение

true, если указанный Rate был успешно удалён; иначе — false.
