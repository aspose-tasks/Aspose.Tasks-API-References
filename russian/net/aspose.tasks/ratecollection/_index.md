...
description: Aspose.Tasks.RateCollection сорт. Представляет коллекцию содержащуюRate объекты.
type: docs
weight: 1380
...
| [ToList](../../aspose.tasks/ratecollection/tolist/#tolist)() | Преобразует`RateCollection` возражать против списка[`Rate`](../rate/) объекты. |
| [ToList](../../aspose.tasks/ratecollection/tolist/#tolist_1)(RateType) | Преобразует`RateCollection` возражать против списка[`Rate`](../rate/) объекты, отфильтрованные по указанным[`RateType`](../ratetype/) тип. |
