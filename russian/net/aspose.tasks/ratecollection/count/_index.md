...
description: "Свойство RateCollection. Возвращает количество элементов, содержащихся в RateCollection"
type: docs
weight: 10
...
Возвращает количество элементов, содержащихся в RateCollection.
