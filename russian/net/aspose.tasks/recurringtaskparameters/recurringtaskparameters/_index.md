...
description: "Конструктор RecurringTaskParameters. Инициализирует новый экземпляр класса RecurringTaskParameters."
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`RecurringTaskParameters`](../).
