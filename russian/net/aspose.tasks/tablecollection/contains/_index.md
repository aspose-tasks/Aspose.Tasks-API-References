...
description: "Метод TableCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false."
type: docs
weight: 50
...
| --- | --- | --- |
| элемент | Table | указанный элемент для поиска. |
