...
description: "Метод TaskCollection. Возвращает задачу с указанным Uid, чей предок является родительской задачей этой коллекции"
type: docs
weight: 80
...
Возвращает задачу с указанным Uid, чей предок является родительской задачей этой коллекции.
...
возвращает экземпляр класса [`Task`](../../task/) с указанным uid, чей предок является родительской задачей этой коллекции.
