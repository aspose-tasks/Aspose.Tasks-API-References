...
description: "Метод TaskCollection. Возвращает задачу с указанным Id, чей предок является родительской задачей этой коллекции"
type: docs
weight: 70
...
Возвращает задачу с указанным Id, чей предок является родительской задачей этой коллекции.
...
| --- | --- | --- |
| идентификатор | Int32 | Идентификатор TaskEntity |

### Возвращаемое значение

возвращает экземпляр класса [`Task`](../../task/) с указанным идентификатором, чей предок является родительской задачей этой коллекции.
