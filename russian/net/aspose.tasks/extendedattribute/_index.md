...
description: Aspose.Tasks.ExtendedAttribute сорт. Представляет расширенные атрибуты.
type: docs
weight: 520
...
| [ValueReadOnly](../../aspose.tasks/extendedattribute/valuereadonly/) { get; } | Получает значение, указывающее, является ли значение этого`ExtendedAttribute` экземпляр доступен только для чтения.  возвращает true, если формула или сводка определены в[`ExtendedAttributeDefinition`](../extendedattributedefinition/) для этого объекта. |
