...
description: "Свойство ExtendedAttribute. Получает или задает значение для атрибутов типа Text"
type: docs
weight: 80
...
Получает или задает значение для атрибутов типа 'Text'.
...
| исключение | условие |
| --- | --- |
| InvalidOperationException | Выбрасывается, если свойство [`AttributeDefinition`](../attributedefinition/) не инициализировано или текущий атрибут не является текстовым атрибутом. |
