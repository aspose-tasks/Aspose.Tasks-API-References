...
description: Представляет список поддерживаемых полей задачи.
type: docs
weight: 2100
url: /ru/net/aspose.tasks/taskkey/
---
## TaskKey enumeration

Представляет список поддерживаемых полей задачи.
...
| IsEffortDriven | `21` | Представляет поле IsEffortDriven (задача). |
| IsRecurring | `22` | Представляет поле IsRecurring (задача). |
| IsOverallocated | `23` | Представляет поле IsOverallocated (задача). |
| HasOverallocatedResource | `24` | Представляет поле HasOverallocatedResource (задача). |
| IsEstimated | `25` | Представляет поле IsEstimated (задача). |
| IsMilestone | `26` | Представляет поле IsMilestone (задача). |
| IsCritical | `27` | Представляет поле IsCritical (задача). |
| IsSubproject | `28` | Представляет поле IsSubproject (задача). |
| IsSubprojectReadOnly | `29` | Представляет поле IsSubprojectReadOnly (задача). |
...
| EarlyFinish | `39` | Представляет поле EarlyFinish (задача). |
| LateStart | `40` | Представляет поле LateStart (задача). |
| LateFinish | `41` | Представляет поле LateFinish (задача). |
...
| FinishSlack | `49` | Представляет поле FinishSlack (задача). |
| FixedCost | `50` | Представляет поле FixedCost (задача). |
...
| ActualDuration | `58` | Представляет поле ActualDuration (Task). |
| ActualCost | `59` | Представляет поле ActualCost (задача). |
| ActualOvertimeCost | `60` | Представляет поле ActualOvertimeCost (задача). |
| ActualWork | `61` | Представляет поле ActualWork (задача). |
| ActualOvertimeWork | `62` | Представляет поле ActualOvertimeWork (задача). |
| OvertimeWork | `63` | Представляет поле OvertimeWork (задача). |
| RegularWork | `64` | Представляет поле RegularWork (задача). |
| RemainingDuration | `65` | Представляет поле RemainingDuration (Task). |
| RemainingCost | `66` | Представляет поле RemainingCost (задача). |
| RemainingWork | `67` | Представляет поле RemainingWork (Task). |
| RemainingOvertimeWork | `68` | Представляет поле RemainingOvertimeWork (задача). |
| RemainingOvertimeCost | `69` | Представляет поле RemainingOvertimeCost (задача). |
| ACWP | `70` | Представляет поле ACWP (задача). |
| CV | `71` | Представляет поле CV (задача). |
| SV | `72` | Представляет поле SV (задача). |
...
| HideBar | `87` | Представляет поле HideBar (задача). |
| IsRollup | `88` | Представляет поле IsRollup (задача). |
| BCWS | `89` | Представляет поле BCWS (задача). |
| BCWP | `90` | Представляет поле БСВР (задача). |
| PhysicalPercentComplete | `91` | Представляет поле PhysicalPercentComplete (задача). |
| EarnedValueMethod | `92` | Представляет поле EarnedValueMethod (задача). |
| ActualWorkProtected | `93` | Представляет поле ActualWorkProtected (задача). |
...
| IsManual | `101` | Представляет поле IsManual (задача). |
| IsExpanded | `102` | Представляет поле IsExpanded (задача). |
| Guid | `103` | Представляет поле Guid (Task). |
| NotesText | `104` | Представляет поле NotesText (задача). |
| NotesRTF | `105` | Представляет поле NotesRTF (задача). |
| ManualStart | `106` | Представляет поле ManualStart (задача). |
| ManualFinish | `107` | Представляет поле ManualFinish (задача). |
| ManualDuration | `108` | Представляет поле ManualDuration (Task). |
| BudgetWork | `109` | Представляет поле BudgetWork (задача). |
| BudgetCost | `110` | Представляет поле BudgetCost (задача). |
| DisplayAsSummary | `111` | Представляет поле DisplayAsSummary (задача). |
| SummaryProgress | `112` | Представляет поле "Сводка хода выполнения (задачи)". |
| IsActive | `113` | Представляет поле IsActive (задача). |
| StartText | `114` | Представляет поле StartText (задача). |
| FinishText | `115` | Представляет поле FinishText (задача). |
| DurationText | `116` | Представляет поле DurationText (задача). |
...
| FreeSlackTimeSpan | `127` | Представляет поле FreeSlack (задача). |
| TotalSlackTimeSpan | `128` | Представляет поле TotalSlack (задача). |
| StartSlackTimeSpan | `129` | Представляет поле StartSlack (задача). |
| FinishSlackTimeSpan | `130` | Представляет поле FinishSlack (задача). |
