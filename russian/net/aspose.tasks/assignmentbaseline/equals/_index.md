...
description: "Метод AssignmentBaseline. Возвращает значение, указывающее, равен ли этот экземпляр указанному объекту."
type: docs
weight: 60
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| другой | AssignmentBaseline | указанный объект AssignmentBaseline для сравнения с этим экземпляром. |
