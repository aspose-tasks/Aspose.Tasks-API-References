...
description: "Свойство AssignmentBaseline. Получает или задает экземпляр TimephasedDataCollection для этого объекта. Временные данные, связанные с базовой линией назначения ресурса. Возвращает экземпляр TimephasedDataCollection для этого объекта. Коллекция временных данных, связанных с этой базовой линией."
type: docs
weight: 40
...
Получает или задает экземпляр [`TimephasedDataCollection`](../../timephaseddatacollection/) для этого объекта. Временные данные, связанные с базовой линией назначения ресурса. Возвращает экземпляр [`TimephasedDataCollection`](../../timephaseddatacollection/) для этого объекта. Коллекция временных данных, связанных с этой базовой линией.
