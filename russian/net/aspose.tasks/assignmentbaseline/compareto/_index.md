...
description: "Метод AssignmentBaseline. Реализация интерфейса IComparable. Сравнивает этот экземпляр с указанным объектом Baseline."
type: docs
weight: 50
...
| --- | --- | --- |
| другой | AssignmentBaseline | указанный объект Baseline, с которым сравнивается этот экземпляр. |
