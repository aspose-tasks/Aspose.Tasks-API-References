...
description: "Свойство Baseline. Получает или задает бюджетную стоимость работы, запланированной для ресурса"
type: docs
weight: 40
url: /ru/net/aspose.tasks/baseline/bcws/
---
## Baseline.Bcws property

Получает или задает бюджетную стоимость запланированной работы для ресурса.
