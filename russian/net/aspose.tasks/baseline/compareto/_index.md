...
description: "Baseline метод. Реализация интерфейса IComparable. Сравнивает данный экземпляр с указанным объектом Baseline"
type: docs
weight: 70
...
| --- | --- | --- |
| другой | Baseline | указанный объект Baseline, с которым сравнивается этот экземпляр. |
