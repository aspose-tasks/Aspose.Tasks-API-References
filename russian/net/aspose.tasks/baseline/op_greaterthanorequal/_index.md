...
description: "Baseline метод. Возвращает значение, указывающее, больше ли данный экземпляр или равен указанному объекту"
type: docs
weight: 120
...
значение, указывающее, больше ли этот экземпляр или равен указанному объекту
