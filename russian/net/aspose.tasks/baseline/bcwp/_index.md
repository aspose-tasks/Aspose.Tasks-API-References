...
description: "Baseline свойство. Получает или задает запланированную стоимость работы, выполненной ресурсом для проекта на текущую дату"
type: docs
weight: 30
url: /ru/net/aspose.tasks/baseline/bcwp/
---
## Baseline.Bcwp property

Получает или задает запланированную стоимость работы, выполненной ресурсом для проекта на текущую дату.
