...
description: Содержит списокGroup./group objects. Реализует интерфейс ICollectionltGroupgt.
type: docs
weight: 710
...
Содержит список[`Group`](../group) objects. Реализует интерфейс ICollection&lt;Group&gt;.
...
| [ParentProject](../../aspose.tasks/groupcollection/parentproject) { get; } | Получает родителя объекта Group. Только для чтения[`Project`](../project) . |
...
| [ToList](../../aspose.tasks/groupcollection/tolist)() | Преобразует коллекцию групп в список[`Group`](../group) объекты. |
