...
description: Aspose.Tasks.TaskLinkCollection сорт. Представляет наборTask объекты.
type: docs
weight: 2130
...
| Имя | Описание |
| --- | --- |
| [Count](../../aspose.tasks/tasklinkcollection/count/) { get; } | Получает количество объектов, содержащихся в этом`TaskLinkCollection` объект. |
