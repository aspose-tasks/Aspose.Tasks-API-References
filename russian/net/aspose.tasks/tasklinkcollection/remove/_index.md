...
description: "Метод TaskLinkCollection. Удаляет ссылку задачи из проекта."
type: docs
weight: 60
...
Удаляет связь задачи из проекта.
...
| --- | --- | --- |
| элемент | TaskLink | Ссылка задачи для удаления. |

### Возвращаемое значение

Удалённая ссылка задачи.
