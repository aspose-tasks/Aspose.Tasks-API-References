...
description: "Свойство TaskLinkCollection. Возвращает родительский проект объекта ResourceAssignmentCollection. Родительский проект для этого объекта."
type: docs
weight: 30
...
Получает родительский проект объекта ResourceAssignmentCollection. Родительский [`Project`](../../project/) для этого объекта.
