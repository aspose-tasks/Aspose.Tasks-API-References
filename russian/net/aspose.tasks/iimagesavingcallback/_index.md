---
title: "Интерфейс IImageSavingCallback"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Интерфейс Aspose.Tasks.IImageSavingCallback. Представляет обратный вызов, который вызывается для создания ресурса для хранения изображений"
type: docs
weight: 870
...
Показывает, как работать с обратными вызовами сохранения изображений.
