...
description: "Метод OutlineCodeDefinitionCollection. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 90
...
| --- | --- | --- |
| элемент | OutlineCodeDefinition | указанный элемент для поиска в этой коллекции. |
