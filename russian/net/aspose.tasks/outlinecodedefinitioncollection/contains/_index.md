...
description: "Метод OutlineCodeDefinitionCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 60
...
| --- | --- | --- |
| элемент | OutlineCodeDefinition | указанный элемент для поиска. |
