...
description: "Метод OutlineCodeDefinitionCollection. Вставляет указанный элемент в указанный индекс."
type: docs
weight: 100
...
| элемент | OutlineCodeDefinition | указанный элемент для вставки в эту коллекцию. |
