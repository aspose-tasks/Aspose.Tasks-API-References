...
description: "Метод OutlineCodeDefinitionCollection. Преобразует объект OutlineCodeDefinitionCollection в список объектов OutlineCodeDefinition"
type: docs
weight: 130
...
Преобразует объект OutlineCodeDefinitionCollection в список объектов [`OutlineCodeDefinition`](../../outlinecodedefinition/).
