...
description: Aspose.Tasks.WBSCodeDefinition сорт. Представляет определение кода WBS.
type: docs
weight: 3130
...
| Имя | Описание |
| --- | --- |
| [WBSCodeDefinition](wbscodedefinition/)() | Инициализирует новый экземпляр`WBSCodeDefinition` сорт. |
