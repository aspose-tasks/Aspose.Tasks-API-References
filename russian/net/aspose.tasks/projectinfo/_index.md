...
description: Aspose.Tasks.ProjectInfo сорт. Краткая информация об опубликованном проекте доступна в Project Online.
type: docs
weight: 1220
...
| Имя | Описание |
| --- | --- |
| [ProjectInfo](projectinfo/)() | Инициализирует новый экземпляр`ProjectInfo` сорт. |
