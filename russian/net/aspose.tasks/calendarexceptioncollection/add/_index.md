...
description: "Метод CalendarExceptionCollection. Добавляет экземпляр CalendarException в этот объект коллекции"
type: docs
weight: 40
...
| --- | --- | --- |
| элемент | CalendarException | Элемент для добавления. |
