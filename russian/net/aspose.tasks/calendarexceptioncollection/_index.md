---
title: "Класс CalendarExceptionCollection"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Класс Aspose.Tasks.CalendarExceptionCollection. Представляет коллекцию объектов CalendarException"
type: docs
weight: 260
...
Представляет коллекцию объектов [`CalendarException`](../calendarexception/).
...
| Имя | Описание |
| --- | --- |
| [Count](../../aspose.tasks/calendarexceptioncollection/count/) { get; } | Получает количество объектов, содержащихся в этом объекте `CalendarExceptionCollection`. |
...
| [Clear](../../aspose.tasks/calendarexceptioncollection/clear/)() | Удаляет все элементы из `CalendarExceptionCollection`. |
...
Показывает, как использовать коллекцию исключений календаря для определения исключений календаря.
