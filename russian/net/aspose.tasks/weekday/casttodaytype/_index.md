...
description: "Метод WeekDay. Преобразует .Nets DayOfWeek в DayType"
type: docs
weight: 120
...
Преобразует DayOfWeek из .Net в [`DayType`](../daytype/).
...
| --- | --- | --- |
| dw | DayOfWeek | День недели, из которого происходит преобразование. |
