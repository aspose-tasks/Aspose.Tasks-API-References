...
description: "Метод GroupCriterionCollection. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 30
...
| --- | --- | --- |
| элемент | GroupCriterion | указанный элемент для добавления в эту коллекцию. |
