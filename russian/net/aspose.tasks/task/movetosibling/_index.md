...
| Параметр | Тип | Описание |
| --- | --- | --- |
| beforeTaskId | Int32 | Идентификатор ([`Id`](../../tsk/id/)) задачи, перед которой будет вставлена текущая задача. |
