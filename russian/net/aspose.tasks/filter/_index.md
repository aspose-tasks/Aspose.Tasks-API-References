...
description: Aspose.Tasks.Filter сорт. Представляет фильтр в Project.
type: docs
weight: 600
...
| [Index](../../aspose.tasks/filter/index/) { get; } | Получает индекс`Filter` объект в Фильтрах, содержащий object. |
...
| Имя | Описание |
| --- | --- |
| [CompareTo](../../aspose.tasks/filter/compareto/)(Filter) | Сравнивает этот экземпляр с указанным экземпляром`Filter` class и возвращает указание их относительного порядка. |
