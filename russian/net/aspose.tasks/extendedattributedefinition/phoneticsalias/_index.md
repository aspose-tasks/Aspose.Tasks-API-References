...
description: "ExtendedAttributeDefinition свойство. Возвращает или задает фонетическое произношение псевдонима пользовательского поля."
type: docs
weight: 210
...
Получает или задает фонетическое произношение псевдонима пользовательского поля.
