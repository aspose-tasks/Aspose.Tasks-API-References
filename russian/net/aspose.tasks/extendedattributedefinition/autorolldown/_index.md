...
description: "Свойство ExtendedAttributeDefinition. Возвращает или задает значение, указывающее, включено ли автоматическое распространение на назначения"
type: docs
weight: 70
...
Получает или задает значение, указывающее, включено ли автоматическое распространение на назначения.
