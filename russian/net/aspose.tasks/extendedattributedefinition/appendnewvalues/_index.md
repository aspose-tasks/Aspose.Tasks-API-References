...
description: "Свойство ExtendedAttributeDefinition. Получает или задает значение, указывающее, добавляются ли новые значения, внесённые в проект, автоматически в список."
type: docs
weight: 60
...
Получает или задает значение, указывающее, добавляются ли новые значения, внесённые в проект, автоматически в список.
