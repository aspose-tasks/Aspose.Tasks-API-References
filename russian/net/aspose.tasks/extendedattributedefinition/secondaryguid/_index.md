...
description: "Свойство ExtendedAttributeDefinition. Получает или задает вторичный GUID расширенного атрибута"
type: docs
weight: 240
...
Получает или задает вторичный guid расширенного атрибута.
