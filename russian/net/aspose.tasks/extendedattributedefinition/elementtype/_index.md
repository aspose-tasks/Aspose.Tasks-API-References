...
description: "ExtendedAttributeDefinition свойство. Возвращает или задает, к какой задаче, ресурсу или назначению относится расширенный атрибут."
type: docs
weight: 120
...
Получает или задает, с какой сущностью (задачей, ресурсом или назначением) связан расширенный атрибут.
