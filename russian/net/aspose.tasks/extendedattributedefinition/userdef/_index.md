...
description: "ExtendedAttributeDefinition свойство. Возвращает или задает значение, указывающее, является ли пользовательское поле пользовательским."
type: docs
weight: 270
...
Получает или задает значение, указывающее, является ли пользовательское поле определённым пользователем.
