...
description: "ExtendedAttributeDefinition свойство. Возвращает или задает псевдоним пользовательского поля."
type: docs
weight: 50
...
Получает или задает псевдоним пользовательского поля.
