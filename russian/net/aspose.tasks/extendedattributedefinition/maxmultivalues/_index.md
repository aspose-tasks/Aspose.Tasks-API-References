...
description: "Свойство ExtendedAttributeDefinition. Возвращает или задает максимальное количество значений, которое можно установить в списке выбора"
type: docs
weight: 190
...
Получает или задает максимальное количество значений, которое можно установить в списке выбора.
...
В настоящее время поддерживается только формат Xml.
