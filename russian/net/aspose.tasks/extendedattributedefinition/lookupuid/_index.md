...
description: "Свойство ExtendedAttributeDefinition. Получает Guid таблицы поиска, связанной с пользовательским полем"
type: docs
weight: 180
...
Получает Guid таблицы поиска, связанной с пользовательским полем.
...
Чтобы создать пользовательское поле с поиском, используйте один из фабричных методов: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) или [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
