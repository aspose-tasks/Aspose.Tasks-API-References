...
description: "Метод FilterCriteria. Возвращает строковое представление экземпляра класса FilterCriteria."
type: docs
weight: 90
...
Возвращает строковое представление экземпляра класса [`FilterCriteria`](../).
