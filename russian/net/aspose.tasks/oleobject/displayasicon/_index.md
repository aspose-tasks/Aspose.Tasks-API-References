...
description: "Свойство OleObject. Возвращает или задает флаг, указывающий, что OLE-объект должен отображаться либо как значок, либо как обычное изображение"
type: docs
weight: 40
...
Получает или задает флаг, указывающий, должно ли объект OLE отображаться в виде значка или в виде обычного изображения.
