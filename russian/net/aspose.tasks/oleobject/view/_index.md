...
description: "Свойство OleObject. Получает или задает экземпляр класса View, к которому принадлежит вставленный объект"
type: docs
weight: 120
...
Получает или задает экземпляр класса `View`, к которому принадлежит вставленный объект.
