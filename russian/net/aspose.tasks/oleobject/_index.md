...
description: Aspose.Tasks.OleObject сорт. Представляет объект OLE который можно вставить в представление диаграммы Ганта файла MPP.
type: docs
weight: 990
...
| Имя | Описание |
| --- | --- |
| [OleObject](oleobject/)() | Инициализирует новый экземпляр`OleObject` класс. |
