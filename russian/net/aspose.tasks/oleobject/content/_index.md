...
description: "Свойство OleObject. Возвращает или задает данные встроенных файлов, null если данные не были встроены"
type: docs
weight: 30
...
Получает или задает данные встроенного файла; null, если данные не были встроены.
