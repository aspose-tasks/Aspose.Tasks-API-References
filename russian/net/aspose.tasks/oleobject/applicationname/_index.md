...
description: "Свойство OleObject. Возвращает или задает имя приложения, с помощью которого открывается встроенный объект"
type: docs
weight: 20
...
Получает или задает имя приложения, с помощью которого открывается встроенный объект.
