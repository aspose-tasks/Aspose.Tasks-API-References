...
description: "Поле Asn. Оставшаяся сверхурочная работа, запланированная для завершения назначения"
type: docs
weight: 450
url: /ru/net/aspose.tasks/asn/remainingovertimework/
---
## Asn.RemainingOvertimeWork field

Оставшаяся работа сверхурочная, запланированная для завершения назначения.
