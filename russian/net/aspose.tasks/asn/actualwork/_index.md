...
description: "Поле Asn. Фактическое количество работы, затраченной на назначение"
type: docs
weight: 70
url: /ru/net/aspose.tasks/asn/actualwork/
---
## Asn.ActualWork field

Фактическое количество работы, понесённое по назначению.
