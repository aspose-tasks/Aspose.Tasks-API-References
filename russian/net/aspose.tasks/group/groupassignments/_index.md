...
description: "Свойство Group. Возвращает или задает значение, указывающее, должны ли назначения группироваться вместо задач"
type: docs
weight: 20
url: /ru/net/aspose.tasks/group/groupassignments/
---
## Group.GroupAssignments property

Получает или задает значение, указывающее, должны ли назначения группироваться вместо задач.
