...
description: Aspose.Tasks.LoadOptions сорт. Позволяет указать дополнительные параметры загрузки при загрузке проекта из файла или потока.
type: docs
weight: 870
...
| Имя | Описание |
| --- | --- |
| [LoadOptions](loadoptions/)() | Инициализирует новый экземпляр`LoadOptions` класс. |
