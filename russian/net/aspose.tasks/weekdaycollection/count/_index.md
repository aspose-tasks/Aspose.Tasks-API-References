...
description: "Свойство WeekDayCollection. Получает количество объектов, содержащихся в этом объекте WeekDayCollection."
type: docs
weight: 10
...
Получает количество объектов, содержащихся в этом объекте [`WeekDayCollection`](../).
