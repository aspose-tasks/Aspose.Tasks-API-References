...
description: "Метод WeekDayCollection. Копирует содержимое коллекции в массив по указанному индексу."
type: docs
weight: 60
...
| --- | --- | --- |
| array | WeekDay[] | Целевой массив [`WeekDay`](../../weekday/) для копирования. |
