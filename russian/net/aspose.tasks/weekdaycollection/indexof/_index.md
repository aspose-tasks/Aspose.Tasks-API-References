...
description: "Метод WeekDayCollection. Возвращает индекс указанного WeekDay"
type: docs
weight: 80
...
Возвращает индекс указанного [`WeekDay`](../../weekday/).
...
| --- | --- | --- |
| элемент | WeekDay | Элемент, с которым следует сравнить. |

### Возвращаемое значение

Индекс, начинающийся с нуля, указанного [`WeekDay`](../../weekday/), если он присутствует, иначе -1.
