...
description: "Метод WeekDayCollection. Добавляет экземпляр WeekDay в этот объект."
type: docs
weight: 30
...
Добавляет экземпляр [`WeekDay`](../../weekday/) в этот объект.
...
| --- | --- | --- |
| элемент | WeekDay | Элемент для добавления. |
