...
description: Aspose.Tasks.OutlineMask сорт. Представляет четыре элемента маски которая определяет формат кода схемы.
type: docs
weight: 1060
...
| Имя | Описание |
| --- | --- |
| [OutlineMask](outlinemask/)() | Инициализирует новый экземпляр`OutlineMask` сорт. |
