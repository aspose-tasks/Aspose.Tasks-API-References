...
description: "Свойство TaskBaseline. Получает или задает запланированную дату завершения задачи, когда была сохранена базовая линия"
type: docs
weight: 40
...
Получает или задает запланированную дату завершения задачи, когда базовый план был сохранён.
