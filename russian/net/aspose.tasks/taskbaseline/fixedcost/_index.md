...
description: "Свойство TaskBaseline. Получает или задает фиксированную стоимость задачи, когда базовый план был сохранён"
type: docs
weight: 50
...
Получает или задает фиксированную стоимость задачи, когда базовый план был сохранён.
