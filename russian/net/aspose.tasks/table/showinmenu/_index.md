...
description: "Свойство Table. Возвращает или задает значение, указывающее, отображает ли проект имя таблицы в выпадающем списке Tables на вкладке View ленты"
type: docs
weight: 80
...
Получает или задает значение, указывающее, отображает ли проект имя таблицы в выпадающем списке Tables на вкладке View ленты.
