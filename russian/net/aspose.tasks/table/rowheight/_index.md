...
description: "Table property. Получает или задает высоту строки в таблице, где высота строки определяется количеством строк текста"
type: docs
weight: 60
...
Получает или задает высоту строки в таблице, где высота строки измеряется количеством строк текста.
