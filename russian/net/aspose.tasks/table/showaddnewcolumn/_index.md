...
description: "Свойство Table. Возвращает или задает значение, указывающее, показывать ли интерфейс Add New Column. Поддерживается в версии MSP 2010 и позже"
type: docs
weight: 70
...
Получает или задает значение, указывающее, показывать ли интерфейс «Add New Column». Поддерживается версиями MSP 2010 и новее.
