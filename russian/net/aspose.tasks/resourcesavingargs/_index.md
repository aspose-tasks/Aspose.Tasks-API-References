---
title: "Класс ResourceSavingArgs"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Класс Aspose.Tasks.ResourceSavingArgs. Этот класс представляет набор данных, связанных с сохранением внешних файлов ресурсов, которое происходит при конвертации в формат HTML."
type: docs
weight: 1790
url: /ru/net/aspose.tasks/resourcesavingargs/
---
...
| Имя | Описание |
| --- | --- |
| [ResourceSavingArgs](resourcesavingargs/)() | Конструктор по умолчанию. |
