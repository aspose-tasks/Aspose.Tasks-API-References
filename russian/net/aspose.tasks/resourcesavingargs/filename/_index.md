...
description: "Свойство ResourceSavingArgs. Получает или задаёт предполагаемое имя файла, которое передаётся от конвертера к коду пользовательского метода. Может использоваться в пользовательском коде для решения, как обрабатывать файл или куда его сохранять"
type: docs
weight: 20
...
Получает или задает предполагаемое имя файла, которое передаётся от конвертера к коду пользовательского метода. Может использоваться в пользовательском коде для решения, как обрабатывать файл или куда его сохранять.
...
Показывает, как настроить использование обратных вызовов сохранения CSS.
