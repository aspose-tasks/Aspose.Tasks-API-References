...
description: "ResourceSavingArgs метод. Закрыть поток, если KeepStreamOpen равно false, иначе выполнить сброс."
type: docs
weight: 60
url: /ru/net/aspose.tasks/resourcesavingargs/closestreamifrequired/
---
## ResourceSavingArgs.CloseStreamIfRequired method

Закрыть поток, если KeepStreamOpen равно false, иначе выполнить его сброс.
