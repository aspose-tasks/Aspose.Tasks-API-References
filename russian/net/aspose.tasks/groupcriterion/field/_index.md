...
description: "GroupCriterion свойство. Получает или задает поле, по которому происходит группировка."
type: docs
weight: 40
...
Получает или задает поле, по которому производится группировка.
