...
description: "TableFieldCollection метод. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 60
...
| --- | --- | --- |
| элемент | TableField | указанный элемент для поиска. |
