...
description: "Метод TableFieldCollection. Вставляет указанный элемент по указанному индексу"
type: docs
weight: 100
...
| элемент | TableField | указанный элемент для вставки в эту коллекцию. |
