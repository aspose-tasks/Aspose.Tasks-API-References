...
description: "TableFieldCollection метод. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 90
...
| --- | --- | --- |
| элемент | TableField | указанный элемент для поиска в этой коллекции. |
