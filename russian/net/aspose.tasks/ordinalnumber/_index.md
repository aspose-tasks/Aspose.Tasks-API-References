---
title: "Перечисление OrdinalNumber"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.OrdinalNumber. Представляет порядковый номер в экземпляре класса RecurringTaskInfo."
type: docs
weight: 1140
