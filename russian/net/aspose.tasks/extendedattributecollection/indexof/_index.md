...
description: "Метод ExtendedAttributeCollection. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 90
...
| --- | --- | --- |
| элемент | ExtendedAttribute | указанный элемент для поиска в этой коллекции. |
