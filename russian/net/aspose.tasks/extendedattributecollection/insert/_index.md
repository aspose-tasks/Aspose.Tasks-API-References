...
description: "ExtendedAttributeCollection метод. Вставляет указанный элемент в указанный индекс."
type: docs
weight: 100
...
| элемент | ExtendedAttribute | указанный элемент для вставки в эту коллекцию. |
