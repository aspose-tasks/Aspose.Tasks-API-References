...
description: "Метод ExtendedAttributeCollection. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 40
...
| --- | --- | --- |
| элемент | ExtendedAttribute | указанный элемент для добавления в эту коллекцию. |
