...
description: "Метод ExtendedAttributeCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 60
...
| --- | --- | --- |
| элемент | ExtendedAttribute | указанный элемент для поиска. |
