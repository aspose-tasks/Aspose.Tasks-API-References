...
description: "Метод ExtendedAttributeCollection. Удаляет первое вхождение конкретного объекта из этой коллекции"
type: docs
weight: 110
...
| --- | --- | --- |
| элемент | ExtendedAttribute | указанный объект для удаления. |
