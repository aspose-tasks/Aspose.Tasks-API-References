...
description: "ExtendedAttributeDefinitionCollection method. Удаляет первое вхождение конкретного объекта из этой коллекции"
type: docs
weight: 130
...
| --- | --- | --- |
| элемент | ExtendedAttributeDefinition | указанный объект для удаления. |
