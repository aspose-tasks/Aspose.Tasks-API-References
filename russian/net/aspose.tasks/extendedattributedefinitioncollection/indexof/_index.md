...
description: "Метод ExtendedAttributeDefinitionCollection. Определяет индекс указанного элемента в этой коллекции"
type: docs
weight: 110
...
| --- | --- | --- |
| элемент | ExtendedAttributeDefinition | указанный элемент для поиска в этой коллекции. |
