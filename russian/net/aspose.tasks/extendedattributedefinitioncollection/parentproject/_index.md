...
description: "ExtendedAttributeDefinitionCollection property. Возвращает родительский проект для экземпляра ExtendedAttributeDefinitionCollection. возвращает родительский проект для этой коллекции"
type: docs
weight: 40
...
Возвращает родительский проект для экземпляра [`ExtendedAttributeDefinitionCollection`](../). возвращает родительский проект для этой коллекции.
