...
description: "Метод ExtendedAttributeDefinitionCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 70
...
| --- | --- | --- |
| элемент | ExtendedAttributeDefinition | указанный элемент для поиска. |
