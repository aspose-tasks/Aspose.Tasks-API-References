...
description: "Свойство ExtendedAttributeDefinitionCollection. Возвращает значение, указывающее, является ли эта коллекция только для чтения"
type: docs
weight: 20
url: /ru/net/aspose.tasks/extendedattributedefinitioncollection/isreadonly/
---
