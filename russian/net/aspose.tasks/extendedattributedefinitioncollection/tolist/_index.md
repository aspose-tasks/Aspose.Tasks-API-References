...
description: "Метод ExtendedAttributeDefinitionCollection. Преобразует этот объект ExtendedAttributeDefinitionCollection в список, содержащий экземпляры класса ExtendedAttributeDefinition"
type: docs
weight: 150
