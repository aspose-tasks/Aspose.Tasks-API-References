...
description: Представляет наборExtendedAttributeDefinition./extendedattributedefinition объекты.
type: docs
weight: 540
...
| [ParentProject](../../aspose.tasks/extendedattributedefinitioncollection/parentproject) { get; } | Получает родительский проект для[`ExtendedAttributeDefinitionCollection`](../extendedattributedefinitioncollection) экземпляр. возвращает родительский проект для этой коллекции. |
