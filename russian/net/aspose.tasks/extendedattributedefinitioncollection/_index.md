...
description: Aspose.Tasks.ExtendedAttributeDefinitionCollection сорт. Представляет наборExtendedAttributeDefinition объекты.
type: docs
weight: 550
...
Представляет набор[`ExtendedAttributeDefinition`](../extendedattributedefinition/) объекты.
...
| [ParentProject](../../aspose.tasks/extendedattributedefinitioncollection/parentproject/) { get; } | Получает родительский проект для`ExtendedAttributeDefinitionCollection` экземпляр. возвращает родительский проект для этой коллекции. |
...
| [GetById](../../aspose.tasks/extendedattributedefinitioncollection/getbyid/)(int) | Возвращает расширенное определение атрибута по id |
...
| [ToList](../../aspose.tasks/extendedattributedefinitioncollection/tolist/)() | Преобразует этот объект ExtendedAttributeDefinitionCollection в список, содержащий экземпляры[`ExtendedAttributeDefinition`](../extendedattributedefinition/) класс. |
