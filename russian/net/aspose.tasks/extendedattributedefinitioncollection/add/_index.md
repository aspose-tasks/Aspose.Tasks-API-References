...
description: "ExtendedAttributeDefinitionCollection method. Добавляет указанный элемент в эту коллекцию"
type: docs
weight: 50
...
| --- | --- | --- |
| элемент | ExtendedAttributeDefinition | указанный элемент для добавления в эту коллекцию. |
