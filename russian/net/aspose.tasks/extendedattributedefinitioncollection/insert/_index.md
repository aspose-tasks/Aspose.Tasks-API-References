...
description: "Метод ExtendedAttributeDefinitionCollection. Вставляет указанный элемент в указанный индекс"
type: docs
weight: 120
...
| элемент | ExtendedAttributeDefinition | указанный элемент для вставки в эту коллекцию. |
