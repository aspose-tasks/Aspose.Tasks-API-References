...
description: "ExtendedAttributeDefinitionCollection method. Возвращает определение расширенного атрибута по идентификатору"
type: docs
weight: 90
...
Возвращает определение расширенного атрибута по идентификатору
...
| --- | --- | --- |
| идентификатор | Int32 | указанный идентификатор |
