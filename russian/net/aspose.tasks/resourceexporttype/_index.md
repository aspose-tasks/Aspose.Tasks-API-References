---
title: "Перечисление ResourceExportType"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Перечисление Aspose.Tasks.ResourceExportType. Указывает тип экспорта ресурса для формата HTML"
type: docs
weight: 1780
...
Указывает тип экспорта ресурсов для формата HTML.
