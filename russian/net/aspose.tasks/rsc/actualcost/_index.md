...
description: Rsc поле. Затраты понесенные за работу уже выполненную ресурсами по их задачам вместе с любыми другими зарегистрированными затратами связанными с задачей.
type: docs
weight: 30
