...
description: "Rsc field. Указывает, назначен ли ресурс на большее количество работы в конкретной задаче или во всех задачах, чем может быть выполнено в рамках нормальной рабочей нагрузки"
type: docs
weight: 490
...
Указывает, назначен ли ресурс на большее количество работы в конкретной задаче или во всех задачах, чем может быть выполнено в рамках нормальной рабочей нагрузки.
...
Показывает, как читать Tsk.IsOverallocated, Tsk.HasOverallocatedResource,

```csharp
// свойства Rsc.Overallocated и Asn.Overallocated.
