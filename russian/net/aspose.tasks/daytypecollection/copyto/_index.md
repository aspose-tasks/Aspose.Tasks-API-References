...
description: "DayTypeCollection метод. Копирует элементы этой коллекции в указанный массив, начиная с указанного индекса массива"
type: docs
weight: 70
url: /ru/net/aspose.tasks/daytypecollection/copyto/
---
...
| --- | --- | --- |
| массив | DayType[] | указанный одномерный массив, в который копировать элементы |
