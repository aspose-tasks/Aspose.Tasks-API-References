...
description: "Свойство DayTypeCollection. Возвращает значение, указывающее, является ли эта коллекция только для чтения, иначе false"
type: docs
weight: 20
url: /ru/net/aspose.tasks/daytypecollection/isreadonly/
---
## DayTypeCollection.IsReadOnly property

Возвращает значение, указывающее, является ли эта коллекция только для чтения; иначе — false.
