...
description: "Свойство OutlineValue. Получает GUID, который идентифицирует это значение среди других во всём проекте."
type: docs
weight: 80
...
Возвращает GUID, который идентифицирует это значение среди остальных во всём проекте.
