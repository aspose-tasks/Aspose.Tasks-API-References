...
description: "Свойство OutlineValue. Получает или задает уникальный Id значения кода контура в рамках проекта."
type: docs
weight: 90
...
Получает или задает уникальный Id значения кода контура в проекте.
