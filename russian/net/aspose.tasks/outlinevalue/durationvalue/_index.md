...
description: "Свойство OutlineValue. Получает или задает продолжительность, если Type имеет значение Duration"
type: docs
weight: 30
...
Предпочтите это свойство вместо [`Value`](../value/), когда необходимо установить значение для OutlineValues с типом Duration.
