...
description: "Свойство OutlineValue. Получает или задает значение, указывающее, свернуто ли значение контура, или нет."
type: docs
weight: 40
...
Получает или задает значение, указывающее, свернуто ли значение контура или нет.
