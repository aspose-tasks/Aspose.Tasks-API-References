---
title: "Класс CssSavingArgs"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Класс Aspose.Tasks.CssSavingArgs. Этот класс представляет набор данных, связанных с сохранением внешних файлов CSS, происходящим при конвертации в формат HTML."
type: docs
weight: 360
...
Этот класс представляет набор данных, связанных с сохранением внешнего CSS‑файла, которое происходит во время преобразования в формат HTML.
...
| Имя | Описание |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Инициализирует новый экземпляр класса `CssSavingArgs`. |
...
Показывает, как указать параметры сохранения CSS.
