...
description: Aspose.Tasks.CssSavingArgs сорт. Этот класс представляет собой набор данных связанных с сохранением внешнего файла CSS который происходит при преобразовании в формат HTML.
type: docs
weight: 360
...
| Имя | Описание |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Инициализирует новый экземпляр`CssSavingArgs` класс. |
