...
description: "OutlineCodeDefinition свойство. Получает или задает значение, указывающее, должны ли указанные в этом поле кода структуры значения быть листовыми"
type: docs
weight: 90
...
Возвращает или задает значение, указывающее, должны ли значения, указанные в этом поле кода структуры, быть конечными (leaf) значениями.
