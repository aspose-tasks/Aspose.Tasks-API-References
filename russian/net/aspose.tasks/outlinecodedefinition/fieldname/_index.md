...
description: "OutlineCodeDefinition свойство. Получает или задает имя пользовательского кода структуры"
type: docs
weight: 70
...
Возвращает или задает имя пользовательского кода структуры.
