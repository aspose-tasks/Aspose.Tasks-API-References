...
description: "Конструктор OutlineCodeDefinition. Инициализирует новый экземпляр класса OutlineCodeDefinition"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`OutlineCodeDefinition`](../).
