...
description: "Свойство OutlineCodeDefinition. Возвращает или задает значение, указывающее, должны ли отображаться отступы этого кода структуры"
type: docs
weight: 140
url: /ru/net/aspose.tasks/outlinecodedefinition/showindent/
---
## OutlineCodeDefinition.ShowIndent property

Возвращает или задает значение, указывающее, должны ли отступы этого кода структуры отображаться.
