...
description: "OutlineCodeDefinition свойство. Получает объект OutlineMaskCollection. Таблица записей, определяющих маску кода структуры. Экземпляр OutlineMaskCollection только для чтения"
type: docs
weight: 100
...
Получает объект OutlineMaskCollection. Таблица записей, определяющих маску кода структуры. Экземпляр только для чтения [`OutlineMaskCollection`](../../outlinemaskcollection/).
