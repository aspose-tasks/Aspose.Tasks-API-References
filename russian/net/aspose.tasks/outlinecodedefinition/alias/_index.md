...
description: "OutlineCodeDefinition свойство. Получает или задает псевдоним пользовательского кода структуры"
type: docs
weight: 20
...
Возвращает или задает псевдоним пользовательского кода структуры.
