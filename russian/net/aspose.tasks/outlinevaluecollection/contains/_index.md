...
description: "Метод OutlineValueCollection. Возвращает true, если указанный элемент найден в этой коллекции, иначе false"
type: docs
weight: 60
...
| --- | --- | --- |
| элемент | OutlineValue | указанный элемент для поиска. |
