...
| [IsReadOnly](../../aspose.tasks/outlinevaluecollection/isreadonly) { get; } | Получает значение, указывающее, доступна ли эта коллекция только для чтения. |
| [Item](../../aspose.tasks/outlinevaluecollection/item) { get; set; } | Возвращает или устанавливает элемент по указанному индексу. |
...
| [Insert](../../aspose.tasks/outlinevaluecollection/insert)(int, OutlineValue) | Вставляет указанный элемент по указанному индексу. |
| [Remove](../../aspose.tasks/outlinevaluecollection/remove)(OutlineValue) | Удаляет первое вхождение определенного объекта из этой коллекции. |
