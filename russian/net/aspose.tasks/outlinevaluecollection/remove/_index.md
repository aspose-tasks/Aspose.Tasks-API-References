...
description: "Метод OutlineValueCollection. Удаляет первое вхождение указанного объекта из этой коллекции"
type: docs
weight: 110
...
| --- | --- | --- |
| элемент | OutlineValue | указанный объект для удаления. |
