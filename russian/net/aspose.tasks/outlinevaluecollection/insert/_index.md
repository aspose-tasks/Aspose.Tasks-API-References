...
description: "Метод OutlineValueCollection. Вставляет указанный элемент в указанную позицию"
type: docs
weight: 100
...
| элемент | OutlineValue | указанный элемент для вставки в эту коллекцию. |
