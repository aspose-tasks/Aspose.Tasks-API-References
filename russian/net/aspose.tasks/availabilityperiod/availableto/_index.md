...
description: "Свойство AvailabilityPeriod. Возвращает или задает последнюю дату, когда ресурс доступен в указанный период"
type: docs
weight: 30
...
Получает или задает последнюю дату, когда ресурс доступен для указанного периода.
