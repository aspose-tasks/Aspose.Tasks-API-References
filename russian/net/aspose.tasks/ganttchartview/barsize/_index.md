...
description: "GanttChartView свойство. Получает или задает высоту в пунктах полос диаграммы Ганта"
type: docs
weight: 40
...
Получает или задает высоту, в пунктах, полос диаграммы Ганта.
