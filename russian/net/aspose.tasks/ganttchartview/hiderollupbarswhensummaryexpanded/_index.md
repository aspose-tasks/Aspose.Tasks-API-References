...
description: "Свойство GanttChartView. Получает или задает значение, указывающее, будут ли скрыты сводные полосы при разворачивании задачи‑сводки"
type: docs
weight: 90
...
Получает или задает значение, указывающее, будут ли скрыты сводные полосы при раскрытии сводной задачи.
