...
description: "Метод TimephasedDataCollection. Удаляет экземпляр TimephasedData из этого объекта коллекции."
type: docs
weight: 100
...
| --- | --- | --- |
| элемент | TimephasedData | Элемент для удаления. |

### Возвращаемое значение

true, если *item* был успешно удалён из [`TimephasedDataCollection`](../); в противном случае — false. Этот метод также возвращает false, если *item* не найден в [`TimephasedDataCollection`](../).
