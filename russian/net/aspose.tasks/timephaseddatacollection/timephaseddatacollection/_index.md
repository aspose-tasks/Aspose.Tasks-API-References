...
description: "Конструктор TimephasedDataCollection. Инициализирует новый экземпляр класса TimephasedDataCollection"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`TimephasedDataCollection`](../).
