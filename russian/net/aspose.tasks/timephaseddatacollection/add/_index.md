...
description: "Метод TimephasedDataCollection. Добавляет экземпляр TimephasedData в этот объект коллекции."
type: docs
weight: 40
...
Добавляет экземпляр [`TimephasedData`](../../timephaseddata/) в этот объект коллекции.
...
| --- | --- | --- |
| элемент | TimephasedData | Элемент для добавления. |

### Исключения

| исключение | условие |
| --- | --- |
| ArgumentNullException | если параметр td равен null. |
