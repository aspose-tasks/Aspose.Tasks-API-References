...
description: "Свойство TimephasedDataCollection. Возвращает значение, указывающее, является ли ICollection только для чтения."
type: docs
weight: 20
...
Возвращает значение, указывающее, является ли ICollection только для чтения.
...
true, если ICollection только для чтения; иначе false.
