...
description: "Метод TimephasedDataCollection. Выбирает все временные фазы между startTime и finishTime. Имеет сложность Olog n в среднем случае"
type: docs
weight: 110
...
Выбирает все временные фазы между *startTime* и *finishTime*. Имеет сложность O(log n) в среднем случае.
...
| finishTime | DateTime | Конец интервала. |

### Возвращаемое значение

Возвращает новый экземпляр списка данных [`TimephasedDataCollection`](../), упорядоченных по свойству Start.
