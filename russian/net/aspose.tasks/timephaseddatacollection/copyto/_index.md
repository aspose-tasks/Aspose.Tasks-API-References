...
description: "Метод TimephasedDataCollection. Копирует элементы TimephasedDataCollection в массив, начиная с определённого индекса массива"
type: docs
weight: 80
...
Копирует элементы [`TimephasedDataCollection`](../) в массив, начиная с определённого индекса массива.
...
| --- | --- | --- |
| array | TimephasedData[] | Одномерный массив, который является получателем элементов, скопированных из [`TimephasedDataCollection`](../). Массив должен иметь нулевую индексацию. |
...
| ArgumentException | Количество элементов в исходном [`TimephasedDataCollection`](../) превышает доступное пространство от *arrayIndex* до конца целевого *array*. |
