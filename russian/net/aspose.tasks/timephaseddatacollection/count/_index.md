...
description: "Свойство TimephasedDataCollection. Возвращает количество объектов, содержащихся в этом объекте TimephasedDataCollection"
type: docs
weight: 10
...
Возвращает количество объектов, содержащихся в этом объекте [`TimephasedDataCollection`](../).
