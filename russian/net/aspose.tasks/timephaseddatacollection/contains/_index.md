...
description: "Метод TimephasedDataCollection. Определяет, содержит ли TimephasedDataCollection конкретное значение"
type: docs
weight: 70
...
Определяет, содержит ли [`TimephasedDataCollection`](../) конкретное значение.
...
| --- | --- | --- |
| элемент | TimephasedData | Объект, который нужно найти в коллекции. |
