...
description: "Метод TimephasedDataCollection. Добавляет коллекцию экземпляров TimephasedData в этот объект коллекции"
type: docs
weight: 50
...
Добавляет коллекцию экземпляров [`TimephasedData`](../../timephaseddata/) в этот объект коллекции.
...
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | Коллекция объектов [`TimephasedData`](../../timephaseddata/) для добавления. |
