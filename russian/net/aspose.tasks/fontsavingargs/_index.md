...
description: Этот класс представляет собой набор данных связанных с сохранением файла внешних шрифтов который происходит при преобразовании в формат HTML.
type: docs
weight: 670
...
Этот класс представляет собой набор данных, связанных с сохранением файла внешних шрифтов, который происходит при преобразовании в формат HTML.
