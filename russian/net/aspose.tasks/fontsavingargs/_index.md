---
title: "Класс FontSavingArgs"
second_title: "Справочник API Aspose.Tasks for .NET"
description: "Класс Aspose.Tasks.FontSavingArgs. Этот класс представляет набор данных, связанных с сохранением внешних файлов шрифтов, происходящим при конвертации в формат HTML."
type: docs
weight: 680
url: /ru/net/aspose.tasks/fontsavingargs/
---
## FontSavingArgs class

Этот класс представляет набор данных, связанных с сохранением внешних файлов шрифтов, которое происходит при конвертации в формат HTML.
...
| Имя | Описание |
| --- | --- |
| [FontSavingArgs](fontsavingargs/)() | Конструктор по умолчанию. |
...
Показывает, как работать с аргументами сохранения шрифтов.
