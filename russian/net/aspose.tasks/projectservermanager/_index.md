...
description: Класс предоставляющий методы для чтения и выполнения операций над проектами в указанной учетной записи Project Online или в указанном локальном проекте. Экземпляр сервера поддерживаются версии Project Server 2016 и 2019.
type: docs
weight: 1240
...
Класс, предоставляющий методы для чтения и выполнения операций над проектами в указанной учетной записи Project Online или в указанном локальном проекте. Экземпляр сервера (поддерживаются версии Project Server 2016 и 2019).
...
| Имя | Описание |
| --- | --- |
| [ProjectServerManager](projectservermanager)(ProjectServerCredentials) | Инициализирует новый экземпляр класса[`ProjectServerManager`](../projectservermanager). |
...
| [GetProjectList](../../aspose.tasks/projectservermanager/getprojectlist)() | Получает список проектов из «Рабочего» хранилища текущей учетной записи Project Online \ экземпляра Project Server. |
