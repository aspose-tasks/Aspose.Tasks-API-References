...
description: "Метод TimephasedData. Создаёт и инициализирует новый экземпляр класса TimephasedData для данных с фазировкой во времени, основанных на работе"
type: docs
weight: 40
...
Создаёт и инициализирует новый экземпляр класса [`TimephasedData`](../) для данных с фазировкой во времени, основанных на работе.
...
Экземпляр класса [`TimephasedData`](../) для данных с фазировкой во времени, основанных на работе.
