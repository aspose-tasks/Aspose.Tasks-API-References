...
description: "TimephasedData свойство. Получает или задает дату начала периода данных с фазированием во времени"
type: docs
weight: 60
...
Получает или задает дату начала периода данных, разбитых по времени.
