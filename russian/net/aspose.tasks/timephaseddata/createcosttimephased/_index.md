...
description: "Метод TimephasedData. Создаёт и инициализирует новый экземпляр класса TimephasedData для данных с фазировкой во времени, основанных на стоимости"
type: docs
weight: 20
...
Создаёт и инициализирует новый экземпляр класса [`TimephasedData`](../) для данных с фазировкой во времени, основанных на стоимости.
