...
description: "Свойство TimephasedData. Получает или задает единицу времени периода данных с фазировкой во времени"
type: docs
weight: 90
...
Получает или задает единицу измерения времени периода данных, разбитых по времени.
