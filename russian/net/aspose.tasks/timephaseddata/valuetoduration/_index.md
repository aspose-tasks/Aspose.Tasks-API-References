...
description: "Свойство TimephasedData. Получает экземпляр TimeSpan, который представляет строковое значение этого объекта"
type: docs
weight: 120
...
Получает экземпляр TimeSpan, который представляет строковое значение этого объекта.
...
Представление объекта в виде временного интервала.
