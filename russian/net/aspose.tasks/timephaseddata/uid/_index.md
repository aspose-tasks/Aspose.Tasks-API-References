...
description: "TimephasedData свойство. Получает или задает уникальный идентификатор данных с фазированием во времени"
type: docs
weight: 80
...
Получает или задает уникальный идентификатор данных, разбитых по времени
