...
description: "TimephasedData свойство. Получает экземпляр Double, который представляет строковое значение этого объекта для единичных данных с фазированием во времени"
type: docs
weight: 130
...
Получает экземпляр Double, который представляет строковое значение этого объекта для данных, разбитых по времени на основе единиц.
...
представление этого объекта в виде числа с плавающей точкой.
