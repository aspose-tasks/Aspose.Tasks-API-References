...
description: "TimephasedData свойство. Получает или задает значение за единицу времени для периода данных с фазированием во времени"
type: docs
weight: 100
...
Получает или задает значение за единицу времени для периода данных, разбитых по времени.
...
| исключение | условие |
| --- | --- |
| [TasksException](../../tasksexception/) | Когда значение некорректно для указанного [`TimephasedDataType`](../timephaseddatatype/) или имеет отрицательное значение. |
