...
description: "TimephasedData свойство. Получает или задает дату завершения периода данных с фазированием во времени"
type: docs
weight: 50
...
Получает или задает дату завершения периода данных, разбитых по времени.
