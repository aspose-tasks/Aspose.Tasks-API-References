...
description: "Метод TimephasedData. Создает и инициализирует новый экземпляр класса TimephasedData для данных, разбитых по времени по единицам, назначения материального ресурса"
type: docs
weight: 30
...
Создает и инициализирует новый экземпляр класса [`TimephasedData`](../) для данных, разбитых по времени по единицам, назначения материального ресурса.
...
| завершение | DateTime | Дата и время завершения. |
| единицы | Double | Количество единиц. |
| тип | TimephasedDataType | Тип данных с фазировкой во времени. |

### Возвращаемое значение

Экземпляр класса [`TimephasedData`](../) для данных с фазировкой во времени, основанных на стоимости.

### Исключения

| исключение | условие |
| --- | --- |
| ArgumentException | Если указано отрицательное количество единиц. |
