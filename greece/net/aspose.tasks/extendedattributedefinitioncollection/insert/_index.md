...
description: "ExtendedAttributeDefinitionCollection μέθοδος. Εισάγει το καθορισμένο στοιχείο στον καθορισμένο δείκτη"
type: docs
weight: 120
...
| item | ExtendedAttributeDefinition | το καθορισμένο στοιχείο για εισαγωγή σε αυτή τη συλλογή. |
