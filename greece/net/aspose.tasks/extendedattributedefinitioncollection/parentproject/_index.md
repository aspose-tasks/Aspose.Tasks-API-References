...
description: "ExtendedAttributeDefinitionCollection ιδιότητα. Παρέχει ένα γονικό έργο για το παράδειγμα ExtendedAttributeDefinitionCollection. Επιστρέφει ένα γονικό έργο για αυτή τη συλλογή"
type: docs
weight: 40
...
Παρέχει ένα γονικό έργο για το παράδειγμα [`ExtendedAttributeDefinitionCollection`](../). επιστρέφει ένα γονικό έργο για αυτή τη συλλογή.
