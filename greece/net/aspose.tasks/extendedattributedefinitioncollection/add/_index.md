...
description: "ExtendedAttributeDefinitionCollection μέθοδος. Προσθέτει το καθορισμένο στοιχείο σε αυτή τη συλλογή"
type: docs
weight: 50
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
