---
title: "ExtendedAttributeDefinitionCollection.ToList"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "ExtendedAttributeDefinitionCollection μέθοδος. Μετατρέπει αυτό το αντικείμενο ExtendedAttributeDefinitionCollection σε λίστα που περιέχει στιγμιότυπα της κλάσης ExtendedAttributeDefinition"
type: docs
weight: 150
...
Μετατρέπει αυτό το αντικείμενο ExtendedAttributeDefinitionCollection σε λίστα που περιέχει στιγμιότυπα της κλάσης [`ExtendedAttributeDefinition`](../../extendedattributedefinition/)
...
Λίστα που περιέχει στιγμιότυπα της κλάσης [`ExtendedAttributeDefinition`](../../extendedattributedefinition/)
