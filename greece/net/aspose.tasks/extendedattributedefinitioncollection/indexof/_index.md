...
description: "ExtendedAttributeDefinitionCollection μέθοδος. Καθορίζει τον δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 110
...
Καθορίζει το δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή.
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |

### Τιμή Επιστροφής

ο δείκτης του καθορισμένου στοιχείου αν βρεθεί· διαφορετικά, -1.
