...
description: "ExtendedAttributeDefinitionCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 130
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | το καθορισμένο αντικείμενο προς αφαίρεση. |
