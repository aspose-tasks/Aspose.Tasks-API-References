...
description: "Μέθοδος Baseline. Επιστρέφει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι μεγαλύτερη από ένα καθορισμένο αντικείμενο"
type: docs
weight: 110
url: /el/net/aspose.tasks/baseline/op_greaterthan/
---
