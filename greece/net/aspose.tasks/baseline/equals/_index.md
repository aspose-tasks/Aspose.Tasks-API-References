...
description: "Μέθοδος Baseline. Επιστρέφει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι ίση με ένα καθορισμένο αντικείμενο"
type: docs
weight: 80
...
| --- | --- | --- |
| obj | Αντικείμενο | το καθορισμένο αντικείμενο για σύγκριση με αυτήν την περίπτωση. |

### Τιμή Επιστροφής

επιστρέφει true εάν αυτή η περίπτωση είναι ίση με το καθορισμένο αντικείμενο· διαφορετικά, false.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| άλλο | Baseline | το καθορισμένο αντικείμενο για σύγκριση με αυτήν την περίπτωση. |
