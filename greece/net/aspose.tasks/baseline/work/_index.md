...
description: "Ιδιότητα Baseline. Λαμβάνει ή ορίζει την εργασία που έχει ανατεθεί σε έναν πόρο όταν αποθηκεύεται η βάση. Το ποσό της ανατεθειμένης εργασίας σε έναν πόρο όταν η βάση αποθηκεύτηκε."
type: docs
weight: 60
...
Αποκτά ή ορίζει την εργασία που έχει ανατεθεί σε έναν πόρο όταν η βάση αποθηκεύεται. Το ποσό της ανατεθειμένης εργασίας σε έναν πόρο όταν η βάση αποθηκεύτηκε.
