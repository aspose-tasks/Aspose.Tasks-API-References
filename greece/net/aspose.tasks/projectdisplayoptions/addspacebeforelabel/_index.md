...
description: "ProjectDisplayOptions ιδιότητα. Λαμβάνει ή ορίζει τιμή που υποδεικνύει αν θα προστεθεί κενό πριν από την αριθμητική τιμή και τη συντομογραφία χρόνου 1 wk αντί για 1wk"
type: docs
weight: 20
...
Αποκτά ή ορίζει μια τιμή που υποδεικνύει αν θα προστεθεί κενό πριν από την αριθμητική τιμή και τη συντομογραφία χρόνου (1 wk αντί για 1wk).
