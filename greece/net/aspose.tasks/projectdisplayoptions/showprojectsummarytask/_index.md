...
description: "ProjectDisplayOptions ιδιότητα. Λαμβάνει ή ορίζει τιμή που υποδεικνύει αν θα εμφανίζεται συνοπτική πληροφορία για ολόκληρο το έργο σε μία μόνο γραμμή με τη δική του γραμμή σύνοψης εργασίας στην κορυφή της προβολής Gantt Chart view"
type: docs
weight: 70
...
Αποκτά ή ορίζει μια τιμή που υποδεικνύει αν θα εμφανίζεται συνοπτική πληροφορία για ολόκληρο το έργο σε μία γραμμή με τη δική του γραμμή περίληψης εργασίας στην κορυφή της προβολής Gantt Chart.
