...
description: "ProjectDisplayOptions ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα υπογραμμιστούν οι υπερσύνδεσμοι"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα υπογραμμίζονται οι υπερσυνδέσεις.
