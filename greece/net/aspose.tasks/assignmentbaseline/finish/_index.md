...
description: "Ιδιότητα AssignmentBaseline. Λαμβάνει ή ορίζει την προγραμματισμένη ημερομηνία λήξης της ανάθεσης πόρου όταν η βάση αποθηκεύτηκε. Η ημερομηνία λήξης της ανάθεσης πόρου όταν αυτή η βάση αποθηκεύτηκε."
type: docs
weight: 20
...
Αποκτά ή ορίζει την προγραμματισμένη ημερομηνία λήξης της ανάθεσης πόρου όταν η βάση αποθηκεύτηκε. Η ημερομηνία λήξης της ανάθεσης πόρου όταν αυτή η βάση αποθηκεύτηκε.
