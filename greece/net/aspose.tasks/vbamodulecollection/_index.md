---
title: "Κλάση VbaModuleCollection"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Κλάση Aspose.Tasks.VbaModuleCollection. Αντιπροσωπεύει μια συλλογή αντικειμένων VbaModule."
type: docs
weight: 2840
...
Αντιπροσωπεύει μια συλλογή αντικειμένων [`VbaModule`](../vbamodule/).
...
| [Item](../../aspose.tasks/vbamodulecollection/item/) { get; } | Λαμβάνει τη μονάδα στο καθορισμένο δείκτη. (2 δείκτες) |
...
| [ToList](../../aspose.tasks/vbamodulecollection/tolist/)() | Μετατρέπει το αντικείμενο συλλογής σε λίστα αντικειμένων [`VbaModule`](../vbamodule/). |
