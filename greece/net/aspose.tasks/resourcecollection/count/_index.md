...
description: "Ιδιότητα ResourceCollection. Λαμβάνει τον αριθμό των στοιχείων που περιέχονται στο ResourceCollection. Μόνο για ανάγνωση Int32"
type: docs
weight: 10
...
Λαμβάνει τον αριθμό των στοιχείων που περιέχονται στη ResourceCollection. Μόνο για ανάγνωση Int32.
