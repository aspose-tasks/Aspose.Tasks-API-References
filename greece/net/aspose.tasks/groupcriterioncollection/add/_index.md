...
description: "GroupCriterionCollection μέθοδος. Προσθέτει το καθορισμένο στοιχείο σε αυτή τη συλλογή"
type: docs
weight: 30
...
| --- | --- | --- |
| item | GroupCriterion | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
