...
description: "GroupCriterionCollection μέθοδος. Αντιγράφει τα στοιχεία αυτής της συλλογής στον καθορισμένο πίνακα ξεκινώντας από το καθορισμένο δείκτη του πίνακα"
type: docs
weight: 60
url: /el/net/aspose.tasks/groupcriterioncollection/copyto/
---
...
| --- | --- | --- |
| array | GroupCriterion[] | ο καθορισμένος μονοδιάστατος πίνακας για αντιγραφή των στοιχείων σε αυτόν |
