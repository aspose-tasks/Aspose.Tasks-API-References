...
description: "TimephasedData ιδιότητα. Λαμβάνει ή ορίζει τη μονάδα χρόνου μιας περιόδου χρονικού φάσματος δεδομένων"
type: docs
weight: 90
...
Λαμβάνει ή ορίζει τη μονάδα χρόνου μιας περιόδου δεδομένων χρονικής φάσης.
