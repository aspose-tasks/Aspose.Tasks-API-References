...
description: "Ιδιότητα TimephasedData. Επιστρέφει μια παρουσία Double που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου"
type: docs
weight: 110
...
Λαμβάνει την παρουσία Double που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου.
