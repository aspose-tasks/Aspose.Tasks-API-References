...
description: "TimephasedData μέθοδος. Δημιουργεί και αρχικοποιεί μια νέα παρουσία της κλάσης TimephasedData για δεδομένα χρονικού φάσματος με βάση το κόστος"
type: docs
weight: 20
...
Δημιουργεί και αρχικοποιεί μια νέα παρουσία της κλάσης [`TimephasedData`](../) για δεδομένα χρονικού φάσματος με βάση το κόστος.
...
| εξαίρεση | συνθήκη |
| --- | --- |
| ArgumentException | Εάν έχει καθοριστεί αρνητική τιμή κόστους. |
