...
description: "TimephasedData property. Λαμβάνει ή ορίζει την τιμή ανά μονάδα χρόνου για μια περίοδο δεδομένων χρονικής φάσης"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει την τιμή ανά μονάδα χρόνου για μια περίοδο δεδομένων χρονικής φάσης.
...
| εξαίρεση | συνθήκη |
| --- | --- |
| [TasksException](../../tasksexception/) | Όταν η τιμή είναι λανθασμένη για τον καθορισμένο [`TimephasedDataType`](../timephaseddatatype/) ή έχει αρνητική τιμή. |
