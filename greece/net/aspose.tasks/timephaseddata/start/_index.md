...
description: "TimephasedData property. Λαμβάνει ή ορίζει την ημερομηνία έναρξης μιας περιόδου δεδομένων χρονικής φάσης"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει την ημερομηνία έναρξης μιας περιόδου δεδομένων χρονικής φάσης.
