...
description: "TimephasedData ιδιότητα. Λαμβάνει ή ορίζει τον τύπο ενός χρονικού φάσματος δεδομένων"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει τον τύπο ενός δεδομένου χρονικής φάσης.
