...
description: "TimephasedData ιδιότητα. Λαμβάνει την παρουσία του TimeSpan που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου"
type: docs
weight: 120
...
Λαμβάνει την παρουσία TimeSpan που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου.
