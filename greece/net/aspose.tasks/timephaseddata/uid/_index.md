...
description: "TimephasedData property. Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό ενός δεδομένου χρονικής φάσης"
type: docs
weight: 80
...
Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό ενός δεδομένου χρονικής φάσης
