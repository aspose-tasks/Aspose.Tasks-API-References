...
description: "TimephasedData property. Λαμβάνει μια παρουσία Double που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου για δεδομένα χρονικής φάσης βάσει μονάδας"
type: docs
weight: 130
...
Λαμβάνει την παρουσία Double που αντιπροσωπεύει τη συμβολοσειρά τιμής αυτού του αντικειμένου για δεδομένα χρονικής φάσης βάσει μονάδας.
