...
description: "TimephasedData μέθοδος. Δημιουργεί και αρχικοποιεί μια νέα παρουσία της κλάσης TimephasedData για δεδομένα χρονικά φάσεων μονάδας μιας ανάθεσης υλικού πόρου"
type: docs
weight: 30
...
Δημιουργεί και αρχικοποιεί μια νέα παρουσία της κλάσης [`TimephasedData`](../) για δεδομένα χρονικά φάσεων μονάδας μιας ανάθεσης υλικού πόρου.
...
| έναρξη | DateTime | Ημερομηνία και ώρα έναρξης. |
...
Μια παρουσία της κλάσης [`TimephasedData`](../) για δεδομένα χρονικού φάσματος με βάση το κόστος.

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| ArgumentException | Εάν έχει καθοριστεί αρνητική ποσότητα μονάδων. |
