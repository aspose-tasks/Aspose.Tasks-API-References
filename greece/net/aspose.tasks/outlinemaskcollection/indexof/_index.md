...
description: "OutlineMaskCollection μέθοδος. Καθορίζει το ευρετήριο του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineMask | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
