...
description: "Μέθοδος OutlineMaskCollection. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 110
...
| --- | --- | --- |
| item | OutlineMask | το καθορισμένο αντικείμενο προς αφαίρεση. |
