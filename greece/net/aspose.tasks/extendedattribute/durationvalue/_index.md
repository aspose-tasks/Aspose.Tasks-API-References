...
description: "Ιδιότητα ExtendedAttribute. Λαμβάνει ή ορίζει τιμή για χαρακτηριστικά με τύπο Duration"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει τιμή για χαρακτηριστικά τύπου 'Duration'.
...
| εξαίρεση | συνθήκη |
| --- | --- |
| InvalidOperationException | Εκτοπίζεται εάν η ιδιότητα [`AttributeDefinition`](../attributedefinition/) δεν έχει αρχικοποιηθεί ή ο τύπος προσαρμοσμένου πεδίου της ιδιότητας [`AttributeDefinition`](../attributedefinition/) δεν είναι μια παρουσία [`Duration`](../../duration/). |
