...
description: "Μέθοδος WeekDayCollection. Αφαιρεί το καθορισμένο WeekDay, εάν υπάρχει"
type: docs
weight: 100
...
Αφαιρεί το καθορισμένο [`WeekDay`](../../weekday/), εάν υπάρχει.
...
| --- | --- | --- |
| item | WeekDay | Το στοιχείο προς αφαίρεση. |

### Τιμή Επιστροφής

True, εάν το [`WeekDay`](../../weekday/) αφαιρέθηκε, false εάν το στοιχείο δεν βρέθηκε.
