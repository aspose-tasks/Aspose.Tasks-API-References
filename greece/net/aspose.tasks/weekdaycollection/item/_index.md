...
description: "Ιδιότητα WeekDayCollection. Λαμβάνει ή ορίζει την τιμή του στοιχείου στον καθορισμένο δείκτη"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την τιμή του στοιχείου στο καθορισμένο δείκτη.
