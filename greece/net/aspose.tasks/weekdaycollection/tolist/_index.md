...
description: "Μέθοδος WeekDayCollection. Μετατρέπει το αντικείμενο WeekDayCollection σε λίστα αντικειμένων WeekDay"
type: docs
weight: 120
...
Μετατρέπει το αντικείμενο WeekDayCollection σε λίστα από αντικείμενα [`WeekDay`](../../weekday/).
...
Λίστα από αντικείμενα [`WeekDay`](../../weekday/).
