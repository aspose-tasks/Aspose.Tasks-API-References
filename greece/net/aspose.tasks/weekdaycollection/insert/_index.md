...
description: "Μέθοδος WeekDayCollection. Εισάγει WeekDay στον καθορισμένο δείκτη"
type: docs
weight: 90
...
Εισάγει [`WeekDay`](../../weekday/) στον καθορισμένο δείκτη.
...
| --- | --- | --- |
| index | Int32 | Δείκτης για εισαγωγή. |
| item | WeekDay | Το στοιχείο για εισαγωγή. |
