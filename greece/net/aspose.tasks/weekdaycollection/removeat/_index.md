...
description: "Μέθοδος WeekDayCollection. Αφαιρεί ένα στοιχείο στον καθορισμένο δείκτη"
type: docs
weight: 110
...
Αφαιρεί ένα στοιχείο στο καθορισμένο δείκτη.
...
| --- | --- | --- |
| index | Int32 | Δείκτης του στοιχείου προς διαγραφή. |
