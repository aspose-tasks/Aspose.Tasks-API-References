...
description: "Μέθοδος WeekDayCollection. Αντιγράφει το περιεχόμενο της συλλογής σε έναν πίνακα στον καθορισμένο δείκτη"
type: docs
weight: 60
...
Αντιγράφει το περιεχόμενο της συλλογής σε έναν πίνακα στο καθορισμένο δείκτη.
...
| --- | --- | --- |
| array | WeekDay[] | Πίνακας προορισμού των [`WeekDay`](../../weekday/) για αντιγραφή |
| arrayIndex | Int32 | Αρχικός δείκτης για τη λειτουργία αντιγραφής. |
