...
description: "Μέθοδος WeekDayCollection. Προσθέτει ένα στιγμιότυπο WeekDay σε αυτό το αντικείμενο"
type: docs
weight: 30
...
Προσθέτει ένα στιγμιότυπο [`WeekDay`](../../weekday/) σε αυτό το αντικείμενο.
...
| --- | --- | --- |
| item | WeekDay | Το στοιχείο προς προσθήκη. |
