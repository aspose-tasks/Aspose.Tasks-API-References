...
description: "Ιδιότητα WeekDayCollection. Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται σε αυτό το αντικείμενο WeekDayCollection"
type: docs
weight: 10
...
Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται σε αυτό το αντικείμενο [`WeekDayCollection`](../).
