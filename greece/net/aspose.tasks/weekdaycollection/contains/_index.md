...
description: "Μέθοδος WeekDayCollection. Ελέγχει αν η συλλογή περιέχει το καθορισμένο WeekDay."
type: docs
weight: 50
...
Ελέγχει αν η συλλογή περιέχει το καθορισμένο [`WeekDay`](../../weekday/).
...
αληθές, εάν η συλλογή περιέχει το καθορισμένο στοιχείο, ή ψευδές διαφορετικά.
