...
description: "Asn field. Η πραγματική ποσότητα εργασίας που προκύπτει από μια ανάθεση"
type: docs
weight: 70
url: /el/net/aspose.tasks/asn/actualwork/
---
## Asn.ActualWork field

Το πραγματικό ποσό εργασίας που προκύπτει από μια ανάθεση.
