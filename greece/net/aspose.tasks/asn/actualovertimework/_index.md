...
description: "Πεδίο Asn. Η πραγματική ποσότητα υπερωριακής εργασίας που προκλήθηκε σε μια ανάθεση"
type: docs
weight: 40
...
Το πραγματικό ποσό υπερωριακής εργασίας που προκύπτει από μια ανάθεση.
...
Δείχνει πώς να διαβάσετε/γράψετε τις πραγματικές ιδιότητες.
