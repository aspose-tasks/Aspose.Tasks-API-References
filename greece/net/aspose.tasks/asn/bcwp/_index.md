...
description: "Πεδίο Asn. Το προϋπολογισμένο κόστος μιας εργασίας που εκτελέστηκε στην ανάθεση μέχρι σήμερα"
type: docs
weight: 120
...
Το προϋπολογισμένο κόστος μιας εργασίας που εκτελέστηκε στην ανάθεση μέχρι σήμερα.
