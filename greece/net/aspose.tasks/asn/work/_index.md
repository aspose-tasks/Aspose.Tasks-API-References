...
description: "Πεδίο Asn. Η ποσότητα προγραμματισμένης εργασίας για μια ανάθεση"
type: docs
weight: 600
url: /el/net/aspose.tasks/asn/work/
---
## Asn.Work field

Το ποσό της προγραμματισμένης εργασίας για μια ανάθεση.
