...
description: "Asn field. Ο μέγιστος αριθμός μονάδων που έχει ανατεθεί σε έναν πόρο για μια εργασία"
type: docs
weight: 390
...
Ο μέγιστος αριθμός μονάδων που έχει ανατεθεί σε έναν πόρο για μια εργασία.
...
Εμφανίζει πώς να διαβάσετε/γράψετε κοινές ιδιότητες.
