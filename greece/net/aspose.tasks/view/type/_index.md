...
description: "Ιδιότητα View. Λαμβάνει τον τύπο του αντικειμένου στη μοναδική προβολή, όπως εργασίες ή πόρους. Μόνο για ανάγνωση ItemType"
type: docs
weight: 110
...
Λαμβάνει τον τύπο του αντικειμένου στη μοναδική προβολή, όπως εργασίες ή πόρους. Μόνο για ανάγνωση [`ItemType`](../../itemtype/).
