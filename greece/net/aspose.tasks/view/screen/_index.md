...
description: "Ιδιότητα View. Λαμβάνει τον τύπο οθόνης για τη μοναδική προβολή. Ανάγνωση μόνο ViewScreen."
type: docs
weight: 80
...
Λαμβάνει τον τύπο οθόνης για τη μοναδική προβολή. Μόνο ανάγνωση [`ViewScreen`](../../viewscreen/).
