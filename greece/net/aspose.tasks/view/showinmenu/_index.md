...
description: "View property. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το Microsoft Project εμφανίζει το όνομα της μοναδικής προβολής στο View ή στις λίστες αναπτυσσόμενων μενού Other Views στη Ribbon"
type: docs
weight: 90
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το Microsoft Project εμφανίζει το όνομα της μοναδικής προβολής στη λίστα προβολών View ή Other Views στο Ribbon.
