...
description: "Ιδιότητα View. Λαμβάνει μια παρουσία της κλάσης PageInfo. Αντιπροσωπεύει δεδομένα ρύθμισης σελίδας που υπάρχουν σε μορφή αρχείου mpp."
type: docs
weight: 60
...
Λαμβάνει μια παρουσία της κλάσης `PageInfo`. Αντιπροσωπεύει δεδομένα ρύθμισης σελίδας που υπάρχουν σε μορφή αρχείου mpp.
