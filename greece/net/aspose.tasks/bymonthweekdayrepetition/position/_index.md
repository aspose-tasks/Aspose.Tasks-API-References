...
description: "ByMonthWeekDayRepetition property. Λαμβάνει ή ορίζει μια θέση της ημέρας της εβδομάδας σε ένα μήνα στην οποία η εργασία πρέπει να επαναλαμβάνεται"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει μια θέση της ημέρας της εβδομάδας σε ένα μήνα στην οποία η εργασία πρέπει να επαναλαμβάνεται.
