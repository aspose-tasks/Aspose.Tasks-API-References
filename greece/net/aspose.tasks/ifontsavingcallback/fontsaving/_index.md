...
description: "Μέθοδος IFontSavingCallback. Η μέθοδος που καλείται κατά την αποθήκευση των γραμματοσειρών."
type: docs
weight: 10
...
Η μέθοδος που θα κληθεί κατά την αποθήκευση των γραμματοσειρών.
...
| --- | --- | --- |
| args | FontSavingArgs | Τα επιχειρήματα αποθήκευσης γραμματοσειράς. |
