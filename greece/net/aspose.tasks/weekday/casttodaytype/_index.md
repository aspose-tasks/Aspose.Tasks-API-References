...
description: "WeekDay μέθοδος. Μετατρέπει το .Nets DayOfWeek σε DayType"
type: docs
weight: 120
...
Μετατρέπει το DayOfWeek του .Net σε [`DayType`](../daytype/).
...
| --- | --- | --- |
| dw | DayOfWeek | Η ημέρα της εβδομάδας για μετατροπή. |

### Τιμή Επιστροφής

Ένας τύπος ημέρας μετατροπής.
