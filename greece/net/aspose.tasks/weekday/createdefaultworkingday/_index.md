...
description: "Μέθοδος WeekDay. Δημιουργεί προεπιλεγμένη εργάσιμη ημέρα"
type: docs
weight: 20
...
| --- | --- | --- |
| dayType | DayType | Ο τύπος ημέρας από τον οποίο θα δημιουργηθεί η προεπιλεγμένη εργάσιμη ημέρα. |
