...
description: "WeekDay ιδιότητα. Λαμβάνει το WorkingTimeCollection για αυτήν την παρουσία του WeekDay. Η συλλογή των χρόνων εργασίας που ορίζουν τον χρόνο που εργάστηκε στην ημέρα της εβδομάδας"
type: docs
weight: 70
...
Λαμβάνει το WorkingTimeCollection για αυτήν την παρουσία WeekDay. Η συλλογή των ωρών εργασίας που ορίζουν τον χρόνο εργασίας στην ημέρα της εβδομάδας.
