...
description: "TableCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 80
...
| --- | --- | --- |
| item | Table | το καθορισμένο αντικείμενο προς αφαίρεση. |
