...
description: "OutlineCodeDefinition property. Λαμβάνει ή ορίζει την φωνητική προφορά του ψευδώνυμου του προσαρμοσμένου κώδικα περιγράμματος"
type: docs
weight: 120
...
Λαμβάνει ή ορίζει τη φωνητική προφορά του ψευδώνυμου του προσαρμοσμένου κώδικα περιγράμματος.
