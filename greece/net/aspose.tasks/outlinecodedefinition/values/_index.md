...
description: "OutlineCodeDefinition ιδιότητα. Λαμβάνει το αντικείμενο OutlineValueCollection. Οι τιμές του πίνακα που σχετίζονται με αυτόν τον κώδικα περιγράμματος"
type: docs
weight: 150
...
Λαμβάνει το αντικείμενο OutlineValueCollection. Οι τιμές του πίνακα που σχετίζονται με αυτόν τον κώδικα περιγράμματος.
...
Δείχνει πώς να δημιουργήσετε νέους κώδικες περιγράμματος.

```csharp
var project = new Project(DataDir + "project.mpp");

// Ορίστε κώδικα περιγράμματος και τη μάσκα περιγράμματος του
...
// Προσθήκη κώδικα περιγράμματος στο έργο
