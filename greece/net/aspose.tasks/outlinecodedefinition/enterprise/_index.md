...
description: "OutlineCodeDefinition property. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ένας προσαρμοσμένος κώδικας περιγράμματος είναι επιχειρηματικός προσαρμοσμένος κώδικας περιγράμματος"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ένας προσαρμοσμένος κώδικας περιγράμματος είναι enterprise προσαρμοσμένος κώδικας περιγράμματος.
