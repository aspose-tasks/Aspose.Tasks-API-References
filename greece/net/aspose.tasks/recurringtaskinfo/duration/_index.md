...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει τη διάρκεια για μία εμφάνιση της επαναλαμβανόμενης εργασίας. η παρουσία της κλάσης Duration"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει τη διάρκεια για μία εμφάνιση της επαναλαμβανόμενης εργασίας. η παρουσία της κλάσης `Duration`.
