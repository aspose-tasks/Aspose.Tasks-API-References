...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει μια ημερομηνία για το ετήσιο μοτίβο επανάληψης"
type: docs
weight: 180
...
Λαμβάνει ή ορίζει μια ημερομηνία για το ετήσιο πρότυπο επανάληψης.
