...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα χρησιμοποιηθεί η αριθμητική ημέρα για το ετήσιο πρότυπο επανάληψης"
type: docs
weight: 220
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα χρησιμοποιηθεί η διατεταγμένη ημέρα για το ετήσιο πρότυπο επανάληψης.
