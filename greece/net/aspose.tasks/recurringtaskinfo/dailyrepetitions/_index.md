...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει τον αριθμό των επαναλήψεων για το ημερήσιο πρότυπο επανάληψης"
type: docs
weight: 10
...
Λαμβάνει ή ορίζει έναν αριθμό επαναλήψεων για το καθημερινό πρότυπο επανάληψης.
