...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει ένα μοτίβο επανάληψης της επαναλαμβανόμενης εργασίας. Μπορεί να είναι μία από τις τιμές της απαρίθμησης RecurrencePattern"
type: docs
weight: 120
...
Λαμβάνει ή ορίζει ένα μοτίβο επανάληψης της επαναλαμβανόμενης εργασίας. Μπορεί να είναι μία από τις τιμές της απαρίθμησης `RecurrencePattern`.
