...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει έναν αριθμητικό αριθμό του μηνιαίου προτύπου επανάληψης. Μπορεί να είναι μία από τις τιμές της απαρίθμησης OrdinalNumber"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει έναν αριθμητικό αριθμό του μηνιαίου προτύπου επανάληψης. Μπορεί να είναι μία από τις τιμές της απαρίθμησης [`OrdinalNumber`](../../ordinalnumber/).
