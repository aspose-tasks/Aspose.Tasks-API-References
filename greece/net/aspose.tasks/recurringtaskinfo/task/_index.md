...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει την γονική εργασία αυτής της παρουσίας της κλάσης RecurringTaskInfo"
type: docs
weight: 140
...
Λαμβάνει την γονική εργασία αυτής της παρουσίας της κλάσης [`RecurringTaskInfo`](../).
