...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει τον αριθμό των επαναλήψεων για το εβδομαδιαίο πρότυπο επανάληψης"
type: docs
weight: 170
...
Λαμβάνει ή ορίζει έναν αριθμό επαναλήψεων για το εβδομαδιαίο πρότυπο επανάληψης.
