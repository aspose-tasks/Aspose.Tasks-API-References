...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει ένα μήνα του ετήσιου προτύπου επανάληψης όταν χρησιμοποιείται η αριθμητική ημέρα. Μπορεί να είναι μία από τις τιμές της απαρίθμησης Month"
type: docs
weight: 200
...
Λαμβάνει ή ορίζει ένα μήνα του ετήσιου προτύπου επανάληψης όταν χρησιμοποιείται η αριθμητική ημέρα. Μπορεί να είναι μία από τις τιμές της απαρίθμησης [`Month`](../../month/).
