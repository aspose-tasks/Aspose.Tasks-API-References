...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει έναν αριθμό ημέρας του μηνιαίου προτύπου επανάληψης"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει έναν αριθμό ημερών του μηνιαίου προτύπου επανάληψης.
