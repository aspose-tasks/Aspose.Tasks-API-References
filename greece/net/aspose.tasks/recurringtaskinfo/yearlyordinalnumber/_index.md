...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει έναν αριθμητικό αριθμό του ετήσιου προτύπου επανάληψης. Μπορεί να είναι μία από τις τιμές της απαρίθμησης OrdinalNumber"
type: docs
weight: 210
...
Λαμβάνει ή ορίζει έναν αριθμητικό αριθμό του ετήσιου προτύπου επανάληψης. Μπορεί να είναι μία από τις τιμές της απαρίθμησης [`OrdinalNumber`](../../ordinalnumber/).
