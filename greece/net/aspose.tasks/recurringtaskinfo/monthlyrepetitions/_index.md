...
description: "Ιδιότητα RecurringTaskInfo. Λαμβάνει ή ορίζει τον αριθμό των επαναλήψεων για το μηνιαίο πρότυπο επανάληψης"
type: docs
weight: 90
...
Λαμβάνει ή ορίζει έναν αριθμό επαναλήψεων για το μηνιαίο πρότυπο επανάληψης.
