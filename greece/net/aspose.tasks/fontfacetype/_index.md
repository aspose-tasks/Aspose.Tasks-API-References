---
title: "Απαρίθμηση FontFaceType"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.FontFaceType enum. Καταγράφει τους τύπους γραμματοσειράς"
type: docs
weight: 650
...
Απαριθμεί τους τύπους γραμματοσειράς
...
| Ttf | `1` | Η γραμματοσειρά TrueType. |
