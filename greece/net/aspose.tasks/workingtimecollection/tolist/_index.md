...
description: "WorkingTimeCollection μέθοδος. Μετατρέπει το αντικείμενο WorkingTimeCollection σε λίστα αντικειμένων WorkingTime"
type: docs
weight: 90
...
Μετατρέπει το αντικείμενο WorkingTimeCollection σε λίστα αντικειμένων [`WorkingTime`](../../workingtime/).
...
Λίστα αντικειμένων [`WorkingTime`](../../workingtime/).
