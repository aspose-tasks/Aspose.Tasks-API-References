...
description: "WorkingTimeCollection μέθοδος. Αφαιρεί το αντικείμενο WorkingTime από αυτή τη συλλογή"
type: docs
weight: 80
...
Αφαιρεί το αντικείμενο [`WorkingTime`](../../workingtime/) από αυτή τη συλλογή.
...
| --- | --- | --- |
| item | WorkingTime | Το στοιχείο προς αφαίρεση. |

### Τιμή Επιστροφής

αληθές εάν το αντικείμενο WorkingTime αφαιρέθηκε επιτυχώς από αυτή τη συλλογή· διαφορετικά, ψευδές.
