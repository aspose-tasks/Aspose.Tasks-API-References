...
description: "GanttChartView ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν πρέπει να εμφανίζονται οι διαχωρισμοί εργασιών στο Gantt Chart"
type: docs
weight: 140
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν τα διαχωρισμένα τμήματα εργασιών στο Gantt Chart πρέπει να εμφανίζονται.
