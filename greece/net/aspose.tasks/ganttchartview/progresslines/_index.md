...
description: "GanttChartView ιδιότητα. Λαμβάνει ή ορίζει γραμμές προόδου για την προβολή Gantt Chart. ProgressLines"
type: docs
weight: 120
...
Λαμβάνει ή ορίζει γραμμές προόδου για την προβολή Gantt Chart. `ProgressLines`.
