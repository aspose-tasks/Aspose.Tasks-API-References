...
description: "Ιδιότητα GanttChartView. Λαμβάνει μια λίστα από κοινά bar styles γονέων της προβολής Gantt Chart. GanttBarStyle"
type: docs
weight: 50
...
Λαμβάνει μια λίστα από γονικές (κοινές) bar styles της προβολής Gantt Chart. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
