...
description: "Ιδιότητα GanttChartView. Λαμβάνει ή ορίζει τις ρυθμίσεις του ανώτερου επιπέδου κλίμακας χρόνου της προβολής. TimescaleTier"
type: docs
weight: 190
...
Λαμβάνει ή ορίζει τις ρυθμίσεις του ανώτερου επιπέδου κλίμακας χρόνου της προβολής. [`TimescaleTier`](../../../aspose.tasks.visualization/timescaletier/).
