...
description: "Ιδιότητα GanttChartView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν τα rollup bars θα κρύβονται όταν επεκτείνεται η εργασία σύνοψης."
type: docs
weight: 90
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι ράβδοι συγκέντρωσης θα κρύβονται κατά την επέκταση της συνοπτικής εργασίας.
