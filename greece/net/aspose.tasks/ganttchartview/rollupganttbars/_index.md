...
description: "Ιδιότητα GanttChartView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι μπάρες στο Gantt Chart πρέπει να συγκεντρωθούν"
type: docs
weight: 130
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι ράβδοι στο Gantt Chart πρέπει να συγκεντρώνονται.
