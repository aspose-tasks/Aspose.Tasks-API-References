...
description: "Μέθοδος VbaModule. Δημιουργεί μια παρουσία του VbaModule με τύπο VbaModuleType.ProceduralModule"
type: docs
weight: 20
url: /el/net/aspose.tasks/vbamodule/createproceduralmodule/
---
## VbaModule.CreateProceduralModule method

Δημιουργεί μια παρουσία του [`VbaModule`](../) με τύπο VbaModuleType.ProceduralModule.
