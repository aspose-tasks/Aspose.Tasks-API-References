...
description: "Μέθοδος OutlineValueCollection. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 110
...
| --- | --- | --- |
| item | OutlineValue | το καθορισμένο αντικείμενο προς αφαίρεση. |
