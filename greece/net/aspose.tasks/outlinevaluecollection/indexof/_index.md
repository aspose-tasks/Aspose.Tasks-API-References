...
description: "Μέθοδος OutlineValueCollection. Καθορίζει τον δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineValue | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
