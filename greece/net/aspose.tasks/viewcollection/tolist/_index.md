...
description: "Μέθοδος ViewCollection. Μετατρέπει μια συλλογή προβολών σε λίστα αντικειμένων View"
type: docs
weight: 120
...
Μετατρέπει μια συλλογή προβολών σε λίστα αντικειμένων [`View`](../../view/).
...
Γενική λίστα αντικειμένων [`View`](../../view/).
