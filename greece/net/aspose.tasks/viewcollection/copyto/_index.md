...
description: "Μέθοδος ViewCollection. Αντιγράφει τα στοιχεία αυτής της συλλογής στον καθορισμένο πίνακα αρχίζοντας από το καθορισμένο δείκτη πίνακα"
type: docs
weight: 70
url: /el/net/aspose.tasks/viewcollection/copyto/
---
...
| --- | --- | --- |
| array | View[] | ο καθορισμένος μονοδιάστατος πίνακας για αντιγραφή των στοιχείων σε αυτόν |
