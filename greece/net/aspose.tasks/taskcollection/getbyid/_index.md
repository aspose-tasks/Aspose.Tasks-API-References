...
description: "Μέθοδος TaskCollection. Επιστρέφει μια εργασία με το καθορισμένο Id του οποίου ο πρόγονος είναι η γονική εργασία αυτής της συλλογής."
type: docs
weight: 70
...
επιστρέφει το στιγμιότυπο της κλάσης [`Task`](../../task/) με το καθορισμένο id του οποίου ο πρόγονος είναι η γονική εργασία αυτής της συλλογής.
