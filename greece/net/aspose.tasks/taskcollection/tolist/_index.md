...
description: "TaskCollection μέθοδος. Μετατρέπει το αντικείμενο TaskCollection σε λίστα αντικειμένων Task."
type: docs
weight: 120
...
Μετατρέπει το αντικείμενο TaskCollection σε λίστα αντικειμένων [`Task`](../../task/).
...
επιστρέφει μια λίστα που περιέχει τις στιγμιότυπα της κλάσης [`Task`](../../task/) αυτής της συλλογής.
