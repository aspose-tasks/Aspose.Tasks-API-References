...
description: "Ιδιότητα OleObject. Λαμβάνει ή ορίζει το όνομα της εφαρμογής με την οποία ανοίγεται το ενσωματωμένο αντικείμενο"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει το όνομα της εφαρμογής με την οποία θα ανοίξει το ενσωματωμένο αντικείμενο.
