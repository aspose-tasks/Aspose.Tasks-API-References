...
description: "Ιδιότητα OleObject. Λαμβάνει ή ορίζει μια σημαία που υποδεικνύει ότι το αντικείμενο OLE πρέπει να εμφανίζεται είτε ως εικονίδιο είτε ως η κανονική του εικόνα"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει μια σημαία που υποδεικνύει ότι το αντικείμενο OLE πρέπει να εμφανίζεται είτε ως εικονίδιο είτε ως κανονική του εικόνα.
