...
description: "Ιδιότητα OleObject. Λαμβάνει ή ορίζει τη διαδρομή του προσωρινού αρχείου του εισαχθέντος αντικειμένου"
type: docs
weight: 110
...
Λαμβάνει ή ορίζει τη διαδρομή προς το προσωρινό αρχείο του εισαχθέντος αντικειμένου.
