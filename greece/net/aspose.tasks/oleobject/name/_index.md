...
description: "Ιδιότητα OleObject. Λαμβάνει ή ορίζει το όνομα του αντιγράφου του αντικειμένου OLE"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει το όνομα της παρουσίασης του αντικειμένου OLE.
