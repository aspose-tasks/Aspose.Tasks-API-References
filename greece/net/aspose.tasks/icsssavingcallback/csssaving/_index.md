...
description: "Μέθοδος ICssSavingCallback. Η μέθοδος που θα κληθεί κατά την αποθήκευση του CSS"
type: docs
weight: 10
...
Η μέθοδος που καλείται κατά την αποθήκευση του CSS.
...
| --- | --- | --- |
| args | CssSavingArgs | Τα επιχειρήματα αποθήκευσης του CSS. |
