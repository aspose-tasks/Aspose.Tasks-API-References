---
title: "Διεπαφή ICssSavingCallback"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Διεπαφή Aspose.Tasks.ICssSavingCallback. Αντιπροσωπεύει μια κλήση επιστροφής που καλείται για τη δημιουργία πόρου αποθήκευσης CSS."
type: docs
weight: 850
...
Αναπαριστά μια κλήση επιστροφής που καλείται για τη δημιουργία πόρου για αποθήκευση CSS.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [CssSaving](../../aspose.tasks/icsssavingcallback/csssaving/)(CssSavingArgs) | Η μέθοδος που καλείται κατά την αποθήκευση του CSS. |
