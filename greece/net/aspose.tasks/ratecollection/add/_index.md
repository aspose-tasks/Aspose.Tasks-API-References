...
description: "Μέθοδος RateCollection. Προσθέτει ένα νέο αντικείμενο Rate σε αυτή τη συλλογή"
type: docs
weight: 50
...
Προσθέτει ένα νέο αντικείμενο [`Rate`](../../rate/) σε αυτή τη συλλογή.
...
| --- | --- | --- |
| ratesFrom | DateTime | Η ημερομηνία έναρξης ισχύος της νέας τιμής. |

### Τιμή Επιστροφής

Προστέθηκε αντικείμενο [`Rate`](../../rate/).
...
| --- | --- | --- |
| ratesFrom | DateTime | Η ημερομηνία έναρξης ισχύος της νέας τιμής. |
| type | RateType | Ο πίνακας τιμών στον οποίο θα προστεθεί. |
