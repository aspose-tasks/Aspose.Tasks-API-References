...
description: "Μέθοδος RateCollection. Μετατρέπει το αντικείμενο RateCollection σε λίστα αντικειμένων Rate"
type: docs
weight: 80
...
Μετατρέπει το αντικείμενο [`RateCollection`](../) σε λίστα αντικειμένων [`Rate`](../../rate/).
...
Μετατρέπει το αντικείμενο [`RateCollection`](../) σε λίστα αντικειμένων [`Rate`](../../rate/) φιλτραρισμένη κατά τον καθορισμένο τύπο [`RateType`](../../ratetype/).
...
μια λίστα αντικειμένων [`Rate`](../../rate/).
