...
description: "Ιδιότητα RateCollection. Επιστρέφει το γονικό αντικείμενο Resource για αυτή τη συλλογή"
type: docs
weight: 40
...
Επιστρέφει το γονικό αντικείμενο [`Resource`](../../resource/) για αυτή τη συλλογή.
