...
description: "Ιδιότητα OutlineValue. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η τιμή περιγράμματος είναι συμπτυγμένη ή όχι"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει αν η τιμή περιγράμματος είναι συμπτυγμένη ή όχι.
