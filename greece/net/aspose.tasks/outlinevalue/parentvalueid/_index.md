...
description: "Ιδιότητα OutlineValue. Λαμβάνει ή ορίζει το Id ενός γονικού κόμβου ενός κώδικα περιγράμματος"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει το Id ενός γονικού κόμβου ενός κώδικα περιγράμματος.
