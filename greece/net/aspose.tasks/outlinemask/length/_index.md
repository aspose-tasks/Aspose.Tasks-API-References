...
description: "Ιδιότητα OutlineMask. Λαμβάνει ή ορίζει το μέγιστο μήκος σε χαρακτήρες των τιμών κώδικα περιγράμματος. 0 εάν το μήκος δεν έχει οριστεί"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει το μέγιστο μήκος (σε χαρακτήρες) των τιμών του κώδικα περιγράμματος. 0 εάν το μήκος δεν ορίζεται.
