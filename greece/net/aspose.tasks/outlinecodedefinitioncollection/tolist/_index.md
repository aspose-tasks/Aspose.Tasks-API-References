...
description: "OutlineCodeDefinitionCollection μέθοδος. Μετατρέπει αυτό το αντικείμενο OutlineCodeDefinitionCollection σε λίστα αντικειμένων OutlineCodeDefinition"
type: docs
weight: 130
...
Μετατρέπει αυτό το αντικείμενο OutlineCodeDefinitionCollection σε λίστα αντικειμένων [`OutlineCodeDefinition`](../../outlinecodedefinition/).
...
Λίστα αντικειμένων [`OutlineCodeDefinition`](../../outlinecodedefinition/).
