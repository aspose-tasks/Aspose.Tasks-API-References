...
description: "OutlineCodeDefinitionCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 110
...
| --- | --- | --- |
| item | OutlineCodeDefinition | το καθορισμένο αντικείμενο προς αφαίρεση. |
