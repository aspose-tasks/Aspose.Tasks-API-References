...
description: "OutlineCodeDefinitionCollection μέθοδος. Προσδιορίζει τον δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineCodeDefinition | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
