...
description: "Μέθοδος OutlineCodeDefinitionCollection. Προσθέτει το καθορισμένο στοιχείο σε αυτή τη συλλογή."
type: docs
weight: 40
...
| --- | --- | --- |
| item | OutlineCodeDefinition | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
