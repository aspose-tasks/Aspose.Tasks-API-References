...
description: "Μέθοδος OutlineCodeDefinitionCollection. Εισάγει το καθορισμένο στοιχείο στη συγκεκριμένη θέση."
type: docs
weight: 100
...
| item | OutlineCodeDefinition | το καθορισμένο στοιχείο για εισαγωγή σε αυτή τη συλλογή. |
