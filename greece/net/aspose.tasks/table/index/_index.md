...
description: "Ιδιότητα Table. Λαμβάνει τον δείκτη ενός αντικειμένου Table στο αντικείμενο που περιέχει τις Tables"
type: docs
weight: 40
...
Λαμβάνει τον δείκτη ενός αντικειμένου Table στο αντικείμενο που περιέχει τις Tables.
