...
description: "Table ιδιότητα. Παίρνει ή ορίζει μια τιμή που υποδεικνύει εάν το έργο εμφανίζει το όνομα του πίνακα στη λίστα επιλογής Πίνακες στην καρτέλα Προβολή της κορδέλας"
type: docs
weight: 80
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το έργο εμφανίζει το όνομα του πίνακα στη λίστα αναπτυσσόμενων πινάκων στην καρτέλα Προβολή της κορδέλας.
