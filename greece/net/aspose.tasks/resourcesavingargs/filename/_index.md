...
description: "ResourceSavingArgs ιδιότητα. Λαμβάνει ή ορίζει το υποτιθέμενο όνομα αρχείου που περνά από τον μετατροπέα στον κώδικα της προσαρμοσμένης μεθόδου. Μπορεί να χρησιμοποιηθεί σε προσαρμοσμένο κώδικα για να αποφασίσει πώς να επεξεργαστεί ή πού να αποθηκεύσει αυτό το αρχείο."
type: docs
weight: 20
...
Λαμβάνει ή ορίζει το υποτιθέμενο όνομα αρχείου που περνά από τον μετατροπέα στον κώδικα της προσαρμοσμένης μεθόδου. Μπορεί να χρησιμοποιηθεί σε προσαρμοσμένο κώδικα για να αποφασίσει πώς θα επεξεργαστεί ή πού θα αποθηκεύσει το αρχείο.
...
Δείχνει πώς να ορίσετε τη χρήση callbacks αποθήκευσης CSS.
