---
title: "Κλάση ResourceSavingArgs"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.ResourceSavingArgs κλάση. Αυτή η κλάση αντιπροσωπεύει ένα σύνολο δεδομένων που σχετίζονται με την αποθήκευση εξωτερικών αρχείων πόρων που συμβαίνει κατά τη μετατροπή σε μορφή HTML."
type: docs
weight: 1790
url: /el/net/aspose.tasks/resourcesavingargs/
---
## ResourceSavingArgs class

Αυτή η κλάση αντιπροσωπεύει ένα σύνολο δεδομένων που σχετίζονται με την αποθήκευση εξωτερικού αρχείου πόρου που συμβαίνει κατά τη μετατροπή σε μορφή HTML.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ResourceSavingArgs](resourcesavingargs/)() | Ο προεπιλεγμένος κατασκευαστής. |
