...
description: "TimephasedDataCollection μέθοδος. Αντιγράφει τα στοιχεία του TimephasedDataCollection σε έναν Πίνακα που ξεκινά σε συγκεκριμένο δείκτη Πίνακα"
type: docs
weight: 80
...
Αντιγράφει τα στοιχεία του [`TimephasedDataCollection`](../) σε έναν Πίνακα, ξεκινώντας από έναν συγκεκριμένο δείκτη Πίνακα.
...
| --- | --- | --- |
| array | TimephasedData[] | Ο μονοδιάστατος Πίνακας που είναι ο προορισμός των στοιχείων που αντιγράφονται από το [`TimephasedDataCollection`](../). Ο Πίνακας πρέπει να έχει μηδενική αρίθμηση. |
| arrayIndex | Int32 | Ο μηδενικός δείκτης στο *array* όπου ξεκινά η αντιγραφή. |
...
| ArgumentException | Ο αριθμός των στοιχείων στην πηγή [`TimephasedDataCollection`](../) είναι μεγαλύτερος από τον διαθέσιμο χώρο από το *arrayIndex* μέχρι το τέλος του προορισμού *array*. |
