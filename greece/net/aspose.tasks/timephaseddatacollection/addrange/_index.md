...
description: "TimephasedDataCollection μέθοδος. Προσθέτει μια συλλογή από στιγμιότυπα TimephasedData σε αυτό το αντικείμενο συλλογής"
type: docs
weight: 50
...
Προσθέτει μια συλλογή από στιγμιότυπα [`TimephasedData`](../../timephaseddata/) σε αυτό το αντικείμενο συλλογής.
...
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | Μια συλλογή από αντικείμενα [`TimephasedData`](../../timephaseddata/) προς προσθήκη. |
