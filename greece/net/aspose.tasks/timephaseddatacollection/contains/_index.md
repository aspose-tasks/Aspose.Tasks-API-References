...
description: "TimephasedDataCollection μέθοδος. Καθορίζει εάν το TimephasedDataCollection περιέχει μια συγκεκριμένη τιμή."
type: docs
weight: 70
...
| --- | --- | --- |
| item | TimephasedData | Το αντικείμενο προς εντοπισμό στη συλλογή. |
