...
description: "TimephasedDataCollection μέθοδος. Μετατρέπει το αντικείμενο TimephasedDataCollection σε λίστα αντικειμένων TimephasedData."
type: docs
weight: 120
...
Μετατρέπει το αντικείμενο [`TimephasedDataCollection`](../) σε λίστα αντικειμένων [`TimephasedData`](../../timephaseddata/).
...
Λίστα αντικειμένων [`TimephasedData`](../../timephaseddata/).
