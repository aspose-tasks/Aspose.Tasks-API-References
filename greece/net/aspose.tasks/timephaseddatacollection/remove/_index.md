...
description: "TimephasedDataCollection μέθοδος. Αφαιρεί το στιγμιότυπο TimephasedData από αυτό το αντικείμενο συλλογής."
type: docs
weight: 100
...
Αφαιρεί το στιγμιότυπο [`TimephasedData`](../../timephaseddata/) από αυτό το αντικείμενο συλλογής.
...
| --- | --- | --- |
| item | TimephasedData | Το στοιχείο προς αφαίρεση. |

### Τιμή Επιστροφής

true εάν το *item* αφαιρεθεί επιτυχώς από το [`TimephasedDataCollection`](../); διαφορετικά, false. Αυτή η μέθοδος επίσης επιστρέφει false εάν το *item* δεν βρεθεί στο [`TimephasedDataCollection`](../).
