...
description: "Μέθοδος TimephasedDataCollection. Προσθέτει παρουσία TimephasedData σε αυτό το αντικείμενο συλλογής"
type: docs
weight: 40
...
Προσθέτει την παρουσία [`TimephasedData`](../../timephaseddata/) σε αυτό το αντικείμενο συλλογής.
...
| --- | --- | --- |
| item | TimephasedData | Το στοιχείο προς προσθήκη. |

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| ArgumentNullException | εάν η παράμετρος td είναι null. |
