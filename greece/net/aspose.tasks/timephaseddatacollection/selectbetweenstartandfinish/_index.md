...
description: "TimephasedDataCollection μέθοδος. Επιλέγει όλες τις φάσεις χρόνου μεταξύ startTime και finishTime. Έχει πολυπλοκότητα Olog n στην μέση περίπτωση."
type: docs
weight: 110
...
Επιλέγει όλες τις χρονικές φάσεις μεταξύ *startTime* και *finishTime*. Έχει πολυπλοκότητα O(log n) σε μέση περίπτωση.
...
| --- | --- | --- |
| timephasedDataType | TimephasedDataType | Τύπος των φάσεων χρόνου προς επιλογή. |
| startTime | DateTime | Αρχή του διαστήματος. |
| finishTime | DateTime | Τέλος του διαστήματος. |

### Τιμή Επιστροφής

Επιστρέφει νέο αντικείμενο λίστας των δεδομένων [`TimephasedDataCollection`](../) ταξινομημένα κατά την ιδιότητα Start.
