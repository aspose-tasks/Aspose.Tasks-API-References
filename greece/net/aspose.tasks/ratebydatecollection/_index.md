---
title: "Κλάση RateByDateCollection"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Κλάση Aspose.Tasks.RateByDateCollection. Αντιπροσωπεύει μια συλλογή που αντιστοιχίζει DateTime σε αντικείμενα Rate"
type: docs
weight: 1620
...
Αντιπροσωπεύει μια συλλογή που αντιστοιχίζει DateTime σε αντικείμενα [`Rate`](../rate/).
