...
description: "TableFieldCollection method. Αντιγράφει τα στοιχεία αυτής της συλλογής στον καθορισμένο πίνακα ξεκινώντας από τον καθορισμένο δείκτη του πίνακα"
type: docs
weight: 70
url: /el/net/aspose.tasks/tablefieldcollection/copyto/
---
...
| --- | --- | --- |
| array | TableField[] | ο καθορισμένος μονοδιάστατος πίνακας για αντιγραφή των στοιχείων σε αυτόν |
