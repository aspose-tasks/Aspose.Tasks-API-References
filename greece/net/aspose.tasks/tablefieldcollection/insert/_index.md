...
description: "TableFieldCollection μέθοδος. Εισάγει το καθορισμένο στοιχείο στον καθορισμένο δείκτη"
type: docs
weight: 100
...
| item | TableField | το καθορισμένο στοιχείο για εισαγωγή σε αυτή τη συλλογή. |
