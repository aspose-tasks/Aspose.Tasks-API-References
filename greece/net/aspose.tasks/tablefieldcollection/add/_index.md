...
description: "TableFieldCollection μέθοδος. Προσθέτει το καθορισμένο στοιχείο σε αυτή τη συλλογή"
type: docs
weight: 40
...
| --- | --- | --- |
| item | TableField | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
