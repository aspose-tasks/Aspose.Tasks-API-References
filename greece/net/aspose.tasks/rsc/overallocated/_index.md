...
description: "Πεδίο Rsc. Δείχνει εάν ένας πόρος έχει ανατεθεί σε περισσότερη εργασία σε μια συγκεκριμένη εργασία ή σε όλες τις εργασίες από ό,τι μπορεί να ολοκληρωθεί εντός της κανονικής εργασιακής δυναμικότητας"
type: docs
weight: 490
...
Δείχνει εάν ένας πόρος έχει ανατεθεί σε περισσότερη εργασία σε μια συγκεκριμένη εργασία ή σε όλες τις εργασίες από ό,τι μπορεί να ολοκληρωθεί εντός της κανονικής εργασιακής χωρητικότητας.
...
Δείχνει πώς να διαβάσετε Tsk.IsOverallocated, Tsk.HasOverallocatedResource,

```csharp
// Ιδιότητες Rsc.Overallocated και Asn.Overallocated.
