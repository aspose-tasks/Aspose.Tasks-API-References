...
description: "Ιδιότητα ExtendedAttributeDefinition. Λαμβάνει το όνομα ενός προσαρμοσμένου πεδίου"
type: docs
weight: 140
...
Λαμβάνει το όνομα ενός προσαρμοσμένου πεδίου.
...
Δεν πρέπει να ορίζεται απευθείας· αντί αυτού δημιουργήστε ExtendedAttributeDefinition χρησιμοποιώντας στατικά εργοστασιακά μεθόδους με ισχυρά τυποποιημένες ονομασίες όπως Create*Definition().
