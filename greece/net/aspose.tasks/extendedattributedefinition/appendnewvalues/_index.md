...
description: "Ιδιότητα ExtendedAttributeDefinition. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι νέες τιμές που προστίθενται σε ένα έργο προστίθενται αυτόματα στη λίστα."
type: docs
weight: 60
...
Προς το παρόν υποστηρίζεται για μορφές MSP 2003/2007 Xml και MSP 2003 mpp.
