...
description: "Ιδιότητα ExtendedAttributeDefinition. Λαμβάνει ή ορίζει το Guid της προεπιλεγμένης καταχώρησης πίνακα αναζήτησης"
type: docs
weight: 110
...
Λαμβάνει ή ορίζει το Guid της προεπιλεγμένης καταχώρησης πίνακα αναζήτησης.
