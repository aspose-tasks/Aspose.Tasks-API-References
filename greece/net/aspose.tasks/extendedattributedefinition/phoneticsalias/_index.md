...
description: "ExtendedAttributeDefinition property. Λαμβάνει ή ορίζει την φωνητική προφορά του ψευδώνυμου ενός προσαρμοσμένου πεδίου."
type: docs
weight: 210
...
Λαμβάνει ή ορίζει τη φωνητική προφορά του ψευδώνυμου ενός προσαρμοσμένου πεδίου.
