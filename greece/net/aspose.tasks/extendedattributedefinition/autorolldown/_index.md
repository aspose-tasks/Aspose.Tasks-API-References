...
description: "Ιδιότητα ExtendedAttributeDefinition. Επιστρέφει ή ορίζει μια τιμή που υποδεικνύει εάν είναι ενεργοποιημένο το αυτόματο roll down προς τις εκχωρήσεις"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν είναι ενεργοποιημένη η αυτόματη μετάδοση σε εκχωρήσεις.
