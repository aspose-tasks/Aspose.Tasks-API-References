...
description: "Ιδιότητα ExtendedAttributeDefinition. Λαμβάνει ένα Guid του πίνακα αναζήτησης που σχετίζεται με ένα προσαρμοσμένο πεδίο"
type: docs
weight: 180
...
Λαμβάνει ένα Guid του πίνακα αναζήτησης που σχετίζεται με ένα προσαρμοσμένο πεδίο.
...
Για να δημιουργήσετε ένα προσαρμοσμένο πεδίο με αναζήτηση, χρησιμοποιήστε μία από τις μεθόδους κατασκευής: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) ή [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
