...
description: "Ιδιότητα ExtendedAttributeDefinition. Επιστρέφει το γονικό έργο για το αντικείμενο ExtendedAttributeDefinition"
type: docs
weight: 200
...
Επιστρέφει το γονικό έργο για το αντικείμενο [`ExtendedAttributeDefinition`](../).
