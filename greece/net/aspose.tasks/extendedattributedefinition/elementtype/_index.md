...
description: "ExtendedAttributeDefinition property. Λαμβάνει ή ορίζει το εκτεταμένο χαρακτηριστικό που συσχετίζεται με μια εργασία, έναν πόρο ή μια ανάθεση"
type: docs
weight: 120
...
Λαμβάνει ή ορίζει εάν το επεκτατικό χαρακτηριστικό συνδέεται με μια εργασία, έναν πόρο ή μια εκχώρηση.
