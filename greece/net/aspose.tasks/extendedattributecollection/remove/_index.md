...
description: "Μέθοδος ExtendedAttributeCollection. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 110
...
| --- | --- | --- |
| item | ExtendedAttribute | το καθορισμένο αντικείμενο προς αφαίρεση. |
