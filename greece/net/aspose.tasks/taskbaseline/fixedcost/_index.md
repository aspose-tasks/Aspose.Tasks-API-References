...
description: "TaskBaseline property. Λαμβάνει ή ορίζει ένα σταθερό κόστος της εργασίας όταν η βάση αποθηκεύτηκε"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει ένα σταθερό κόστος της εργασίας όταν αποθηκεύτηκε η βάση αναφοράς.
