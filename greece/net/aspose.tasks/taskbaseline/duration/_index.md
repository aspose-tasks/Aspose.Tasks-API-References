...
description: "TaskBaseline property. Λαμβάνει ή ορίζει τη προγραμματισμένη διάρκεια της εργασίας όταν η βάση αποθηκεύτηκε"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει τη προγραμματισμένη διάρκεια της εργασίας όταν αποθηκεύτηκε η βάση αναφοράς.
