...
description: "FilterCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 80
...
| --- | --- | --- |
| item | Filter | το καθορισμένο αντικείμενο προς αφαίρεση. |
