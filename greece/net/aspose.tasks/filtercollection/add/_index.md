...
description: "FilterCollection μέθοδος. Προσθέτει το καθορισμένο στοιχείο σε αυτήν τη συλλογή."
type: docs
weight: 30
...
| --- | --- | --- |
| item | Filter | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
