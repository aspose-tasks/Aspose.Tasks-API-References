...
description: "Μέθοδος GroupCollection. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 80
...
| --- | --- | --- |
| item | Group | το καθορισμένο αντικείμενο προς αφαίρεση. |
