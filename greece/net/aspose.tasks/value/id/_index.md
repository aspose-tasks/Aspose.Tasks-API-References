...
description: "Value property. Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό μιας τιμής σε όλο το έργο"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό μιας τιμής σε όλο το έργο.

Είναι σημαντικό να μην υπάρχουν ίδια αναγνωριστικά για διαφορετικές παρουσίες του [`Value`](../).

Η ελάχιστη τιμή `Id` είναι `1`.
