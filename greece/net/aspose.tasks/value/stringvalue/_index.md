...
description: "Value property. Λαμβάνει ή ορίζει την πραγματική τιμή που χρησιμοποιείται για την αναπαράσταση του κειμένου"
type: docs
weight: 80
...
Προτιμήστε αυτή την ιδιότητα αντί του [`Val`](../val/), όταν χρειάζεται να ορίσετε την τιμή κειμένου.
