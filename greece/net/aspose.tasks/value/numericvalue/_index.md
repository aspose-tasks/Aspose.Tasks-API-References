...
description: "Ιδιότητα Value. Λαμβάνει ή ορίζει την πραγματική τιμή που χρησιμοποιείται για την αναπαράσταση αριθμού ή τιμής κόστους"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει την πραγματική τιμή που χρησιμοποιείται για την αναπαράσταση αριθμητικής ή τιμής κόστους.
...
Προτιμήστε αυτήν την ιδιότητα αντί του [`Val`](../val/), όταν χρειάζεται να ορίσετε την τιμή Number ή Cost.
