...
description: "Ιδιότητα Value. Λαμβάνει ή ορίζει τις φωνητικές πληροφορίες για το όνομα προσαρμοσμένου πεδίου."
type: docs
weight: 70
...
Λαμβάνει ή ορίζει τις φωνητικές πληροφορίες σχετικά με το όνομα του προσαρμοσμένου πεδίου.
