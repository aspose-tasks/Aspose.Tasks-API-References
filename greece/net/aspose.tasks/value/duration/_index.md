...
description: "Ιδιότητα Value. Λαμβάνει ή ορίζει την πραγματική τιμή που χρησιμοποιείται για την αναπαράσταση Duration."
type: docs
weight: 40
...
Προτιμήστε αυτήν την ιδιότητα αντί του [`Val`](../val/), όταν χρειάζεται να ορίσετε την τιμή Duration.
