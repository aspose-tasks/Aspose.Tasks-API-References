...
description: "Value property. Λαμβάνει ή ορίζει την πραγματική τιμή εάν μπορεί να αναπαρασταθεί ως DateTime. Η προεπιλεγμένη τιμή είναι MinValue"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την πραγματική τιμή εάν μπορεί να αναπαρασταθεί ως DateTime. Η προεπιλεγμένη τιμή είναι MinValue.
...
Προτιμήστε αυτή την ιδιότητα αντί του [`Val`](../val/), όταν χρειάζεται να ορίσετε την τιμή DateTime.
