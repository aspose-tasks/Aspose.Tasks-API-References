...
description: "Aspose.Tasks.Value κλάση. Αντιπροσωπεύει μια τιμή σε μια λίστα τιμών"
type: docs
weight: 2800
...
| Όνομα | Περιγραφή |
| --- | --- |
| [Value](value/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `Value`. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| [DateTimeValue](../../aspose.tasks/value/datetimevalue/) { get; set; } | Λαμβάνει ή ορίζει την πραγματική τιμή εάν μπορεί να αναπαρασταθεί ως DateTime. Η προεπιλεγμένη τιμή είναι MinValue. |
...
| [Id](../../aspose.tasks/value/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό μιας τιμής σε όλο το έργο. |
| [NumericValue](../../aspose.tasks/value/numericvalue/) { get; set; } | Λαμβάνει ή ορίζει την πραγματική τιμή που χρησιμοποιείται για την αναπαράσταση αριθμητικής ή τιμής κόστους. |
| [Phonetic](../../aspose.tasks/value/phonetic/) { get; set; } | Λαμβάνει ή ορίζει τις φωνητικές πληροφορίες σχετικά με το όνομα του προσαρμοσμένου πεδίου. |
...
| [Val](../../aspose.tasks/value/val/) { get; set; } | Λαμβάνει ή ορίζει την πραγματική τιμή στην εσωτερική αναπαράσταση. Προτιμήστε τη χρήση ιδιοτήτων με ισχυρούς τύπους που αναφέρονται παρακάτω. |
| [ValueGuid](../../aspose.tasks/value/valueguid/) { get; } | Λαμβάνει ένα GUID που αναγνωρίζει αυτήν την τιμή μεταξύ των άλλων σε ολόκληρο το έργο. |

## Παραδείγματα

Δείχνει πώς να εργαστείτε με τιμές αναζήτησης.

```csharp
var project = new Project(DataDir + "ReadTaskExtendedAttributes.mpp");

// Δημιουργήστε έναν ορισμό εκτεταμένου χαρακτηριστικού τύπου Κειμένου
...
// Δημιουργήστε έναν ορισμό εκτεταμένου χαρακτηριστικού τύπου Διάρκειας
...
// Δημιουργήστε έναν ορισμό εκτεταμένου χαρακτηριστικού τύπου Ημερομηνίας
...
// Δημιουργήστε έναν ορισμό εκτεταμένου χαρακτηριστικού τύπου Αριθμού
