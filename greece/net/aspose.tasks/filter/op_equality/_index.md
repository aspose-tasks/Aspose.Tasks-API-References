...
description: "Μέθοδος Filter. Επιστρέφει μια τιμή που υποδεικνύει εάν αυτή η παρουσίαση είναι ίση με ένα καθορισμένο αντικείμενο."
type: docs
weight: 120
url: /el/net/aspose.tasks/filter/op_equality/
---
