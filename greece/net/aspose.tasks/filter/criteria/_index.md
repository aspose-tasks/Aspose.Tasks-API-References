...
description: "Ιδιότητα Filter. Λαμβάνει ή ορίζει τα κριτήρια που πρέπει να πληρούν οι εργασίες ή οι πόροι για να εμφανιστούν στην προβολή MSP."
type: docs
weight: 20
...
Λαμβάνει ή ορίζει τα κριτήρια που πρέπει να πληρούν οι εργασίες ή οι πόροι για να εμφανιστούν στην προβολή MSP.
...
Εμφανίζει πώς να διαβάσετε τα φίλτρα εργασιών.
