...
description: "Μέθοδος Filter. Επιστρέφει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι μικρότερη από ένα καθορισμένο αντικείμενο"
type: docs
weight: 160
url: /el/net/aspose.tasks/filter/op_lessthan/
---
