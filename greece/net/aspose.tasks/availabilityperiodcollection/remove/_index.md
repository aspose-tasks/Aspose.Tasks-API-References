...
description: "AvailabilityPeriodCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 120
...
| --- | --- | --- |
| item | AvailabilityPeriod | το καθορισμένο αντικείμενο προς αφαίρεση. |
