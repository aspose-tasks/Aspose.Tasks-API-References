...
description: "Μέθοδος AvailabilityPeriodCollection. Προσθέτει το καθορισμένο στοιχείο σε αυτή τη συλλογή"
type: docs
weight: 50
...
| --- | --- | --- |
| item | AvailabilityPeriod | το καθορισμένο στοιχείο για προσθήκη σε αυτή τη συλλογή. |
