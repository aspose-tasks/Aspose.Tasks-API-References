...
description: "Μέθοδος AvailabilityPeriodCollection. Εισάγει το καθορισμένο στοιχείο στη συγκεκριμένη θέση"
type: docs
weight: 110
...
| item | AvailabilityPeriod | το καθορισμένο στοιχείο για εισαγωγή σε αυτή τη συλλογή. |
