...
description: "AvailabilityPeriodCollection μέθοδος. Προσδιορίζει τον δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 100
...
| --- | --- | --- |
| item | AvailabilityPeriod | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
