...
description: "Ιδιότητα TableField. Λαμβάνει ή ορίζει την ευθυγράμμιση των δεδομένων σε ένα πεδίο πίνακα"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την ευθυγράμμιση των δεδομένων σε ένα πεδίο πίνακα.
