...
description: "ResourceAssignmentCollection μέθοδος. Επιστρέφει μια ανάθεση με το καθορισμένο uid"
type: docs
weight: 60
...
ResourceAssignment με το καθορισμένο uid εάν υπάρχει· διαφορετικά, null.
