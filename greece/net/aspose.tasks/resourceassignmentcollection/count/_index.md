...
description: "ResourceAssignmentCollection ιδιότητα. Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται στη ResourceAssignmentCollection"
type: docs
weight: 10
...
Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται στη ResourceAssignmentCollection.
