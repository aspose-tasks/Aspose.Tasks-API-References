...
description: "Μέθοδος ResourceAssignmentCollection. Μετατρέπει το αντικείμενο ResourceAssignmentCollection σε λίστα αντικειμένων ResourceAssignment"
type: docs
weight: 100
...
Μετατρέπει το αντικείμενο ResourceAssignmentCollection σε λίστα αντικειμένων [`ResourceAssignment`](../../resourceassignment/).
...
Λίστα αντικειμένων [`ResourceAssignment`](../../resourceassignment/).
