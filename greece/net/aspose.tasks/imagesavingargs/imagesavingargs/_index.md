...
description: "ImageSavingArgs κατασκευαστής. Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης ImageSavingArgs"
type: docs
weight: 10
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [`ImageSavingArgs`](../).
