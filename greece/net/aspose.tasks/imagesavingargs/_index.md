---
title: "Κλάση ImageSavingArgs"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.ImageSavingArgs class. Αυτή η κλάση αντιπροσωπεύει ένα σύνολο δεδομένων που σχετίζονται με την αποθήκευση εξωτερικών αρχείων εικόνας που συμβαίνει κατά τη μετατροπή σε μορφή HTML."
type: docs
weight: 900
...
Αυτή η κλάση αντιπροσωπεύει ένα σύνολο δεδομένων που σχετίζονται με την αποθήκευση εξωτερικού αρχείου εικόνας που συμβαίνει κατά τη μετατροπή σε μορφή HTML.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `ImageSavingArgs`. |
...
Δείχνει πώς να εργαστείτε με τα επιχειρήματα αποθήκευσης εικόνας.
