...
description: "Μέθοδος CalendarExceptionCollection. Μετατρέπει το αντικείμενο CalendarExceptionCollection σε λίστα αντικειμένων CalendarException"
type: docs
weight: 90
...
Μετατρέπει το αντικείμενο CalendarExceptionCollection σε λίστα αντικειμένων [`CalendarException`](../../calendarexception/).
...
Λίστα αντικειμένων [`CalendarException`](../../calendarexception/).
