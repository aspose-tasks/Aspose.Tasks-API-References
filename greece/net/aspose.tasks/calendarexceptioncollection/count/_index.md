...
description: "CalendarExceptionCollection ιδιότητα. Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται σε αυτό το αντικείμενο CalendarExceptionCollection"
type: docs
weight: 10
...
Λαμβάνει τον αριθμό των αντικειμένων που περιέχονται σε αυτό το αντικείμενο [`CalendarExceptionCollection`](../).
