...
description: "Μέθοδος CalendarExceptionCollection. Προσθέτει μια σειρά εξαιρέσεων στην εσωτερική λίστα"
type: docs
weight: 50
...
| --- | --- | --- |
| exceptionList | IEnumerable`1 | Σειρά εξαιρέσεων προς προσθήκη. |
