...
description: "CalendarExceptionCollection μέθοδος. Αφαιρεί το στιγμιότυπο CalendarException από αυτή τη συλλογή"
type: docs
weight: 80
...
Αφαιρεί το στιγμιότυπο [`CalendarException`](../../calendarexception/) από αυτή τη συλλογή.
...
| --- | --- | --- |
| item | CalendarException | Το στοιχείο προς αφαίρεση. |

### Τιμή Επιστροφής

αληθές εάν η καθορισμένη εξαίρεση αφαιρέθηκε επιτυχώς.
