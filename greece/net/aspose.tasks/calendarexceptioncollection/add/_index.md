...
description: "CalendarExceptionCollection μέθοδος. Προσθέτει το στιγμιότυπο CalendarException σε αυτό το αντικείμενο συλλογής"
type: docs
weight: 40
...
| --- | --- | --- |
| item | CalendarException | Το στοιχείο προς προσθήκη. |
