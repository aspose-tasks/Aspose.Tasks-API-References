---
title: "Απαρίθμηση OutlineValueType"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.OutlineValueType enum. Καθορίζει τον τύπο μιας τιμής περιγράμματος"
type: docs
weight: 1230
...
Καθορίζει τον τύπο μιας τιμής περιγράμματος.
...
| --- | --- | --- |
| Null | `0` | Υποδεικνύει τύπο τιμής περιγράμματος Null. |
| Date | `1` | Υποδεικνύει τύπο τιμής περιγράμματος Date. |
| Duration | `2` | Υποδεικνύει τύπο τιμής περιγράμματος Duration. |
| Cost | `3` | Υποδεικνύει τύπο τιμής περιγράμματος Cost. |
| Number | `4` | Υποδεικνύει τύπο τιμής περιγράμματος Number. |
| Flag | `5` | Δείχνει τον τύπο τιμής περιγράμματος Flag. |
| Text | `6` | Δείχνει τον τύπο τιμής περιγράμματος Text. |
| FinishDate | `7` | Δείχνει τον τύπο τιμής περιγράμματος Finish Date. |
