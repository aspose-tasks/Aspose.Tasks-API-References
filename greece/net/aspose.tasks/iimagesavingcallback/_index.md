---
title: "Διεπαφή IImageSavingCallback"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Διεπαφή Aspose.Tasks.IImageSavingCallback. Αντιπροσωπεύει μια κλήση επιστροφής που καλείται για τη δημιουργία πόρου αποθήκευσης εικόνων"
type: docs
weight: 870
...
Αναπαριστά μια κλήση επιστροφής που καλείται για τη δημιουργία πόρου για αποθήκευση εικόνων.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ImageSaving](../../aspose.tasks/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | Η μέθοδος που καλείται κατά την αποθήκευση των εικόνων. |
