...
description: "EndAfterRecurrenceRange constructor. Αρχικοποιεί ένα νέο αντικείμενο της κλάσης EndAfterRecurrenceRange"
type: docs
weight: 10
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [`EndAfterRecurrenceRange`](../).
