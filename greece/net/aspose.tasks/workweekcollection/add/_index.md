...
description: "WorkWeekCollection μέθοδος. Προσθέτει ένα στιγμιότυπο WorkWeek σε αυτό το αντικείμενο συλλογής."
type: docs
weight: 40
...
Προσθέτει το στιγμιότυπο WorkWeek σε αυτό το αντικείμενο συλλογής.
...
| --- | --- | --- |
| item | WorkWeek | Το στοιχείο προς προσθήκη. |
