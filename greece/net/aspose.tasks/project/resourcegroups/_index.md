...
description: "Ιδιότητα Project. Λαμβάνει όλους τους ορισμούς ομάδων που βασίζονται σε πόρους. ResourceGroups είναι μια συλλογή αντικειμένων Group."
type: docs
weight: 770
...
Λαμβάνει όλους τους ορισμούς ομάδων που βασίζονται σε πόρους. ResourceGroups είναι μια συλλογή αντικειμένων [`Group`](../../group/).
...
Δείχνει πώς να διαβάσετε ομάδες πόρων.
