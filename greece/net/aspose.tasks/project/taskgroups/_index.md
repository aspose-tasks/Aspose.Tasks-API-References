...
description: "Ιδιότητα Project. Λαμβάνει όλες τις ορισμούς ομάδων βάσει εργασιών. Το TaskGroups είναι μια συλλογή αντικειμένων Group."
type: docs
weight: 920
...
Λαμβάνει όλους τους ορισμούς ομάδων βάσει εργασιών. Το TaskGroups είναι μια συλλογή από αντικείμενα [`Group`](../../group/).
...
Δείχνει πώς να διαβάσετε ομάδες εργασιών.
