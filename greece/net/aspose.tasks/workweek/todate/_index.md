...
description: "Ιδιότητα WorkWeek. Λαμβάνει ή ορίζει την ημερομηνία και ώρα λήξης της εβδομάδας εργασίας"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει την ημερομηνία λήξης DateTime της εβδομάδας εργασίας
