...
description: "Ιδιότητα WorkWeek. Λαμβάνει ή ορίζει την ημερομηνία και ώρα έναρξης της εβδομάδας εργασίας"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την ημερομηνία έναρξης DateTime της εβδομάδας εργασίας
