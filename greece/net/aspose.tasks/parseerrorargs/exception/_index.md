...
description: "Ιδιότητα ParseErrorArgs. Λαμβάνει την εξαίρεση που προέκυψε κατά την ανάλυση της τιμής συμβολοσειράς"
type: docs
weight: 10
...
Λαμβάνει την εξαίρεση που προέκυψε κατά την ανάλυση της τιμής της συμβολοσειράς.
