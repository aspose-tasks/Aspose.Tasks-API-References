...
description: "Tsk field. Δείχνει αν κάποιος από τους ανατεθειμένους πόρους σε μια εργασία έχει ανατεθεί σε περισσότερη εργασία από ό,τι μπορεί να εκτελεστεί με την κανονική εργασιακή χωρητικότητα."
type: docs
weight: 650
...
Δείχνει εάν κάποιο από τους ανατεθειμένους πόρους σε μια εργασία έχει ανατεθεί σε περισσότερη εργασία από ό,τι μπορεί να γίνει εντός της κανονικής εργασιακής δυναμικότητας.
