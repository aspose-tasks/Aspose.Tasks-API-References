...
description: "Πεδίο Tsk. Δείχνει εάν η εργασία έχει έναν πόρο που έχει περισσότερη εργασία στις ανατεθειμένες εργασίες από ό,τι μπορεί να ολοκληρωθεί εντός της κανονικής εργασιακής δυναμικότητας"
type: docs
weight: 470
...
Δείχνει εάν η εργασία έχει έναν πόρο που έχει περισσότερη εργασία στα ανατεθειμένα καθήκοντα από ό,τι μπορεί να ολοκληρωθεί εντός της κανονικής εργασιακής δυναμικότητας.
