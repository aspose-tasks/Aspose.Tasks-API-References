...
description: "WBSCodeMaskCollection μέθοδος. Μετατρέπει ένα WBSCodeMaskCollection σε λίστα αντικειμένων WBSCodeMask"
type: docs
weight: 90
...
Μετατρέπει ένα WBSCodeMaskCollection σε λίστα αντικειμένων [`WBSCodeMask`](../../wbscodemask/).
...
Γενική λίστα αντικειμένων [`WBSCodeMask`](../../wbscodemask/).
