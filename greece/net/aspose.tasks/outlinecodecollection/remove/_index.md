...
description: "OutlineCodeCollection μέθοδος. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή"
type: docs
weight: 110
...
| --- | --- | --- |
| item | OutlineCode | το καθορισμένο αντικείμενο προς αφαίρεση. |
