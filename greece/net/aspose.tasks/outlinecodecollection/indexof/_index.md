...
description: "OutlineCodeCollection μέθοδος. Προσδιορίζει τον δείκτη του συγκεκριμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineCode | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
