...
description: "OutlineCodeCollection ιδιότητα. Επιστρέφει ή ορίζει το στοιχείο στο καθορισμένο δείκτη"
type: docs
weight: 30
...
Επιστρέφει ή ορίζει το στοιχείο στη συγκεκριμένη θέση.
...
| --- | --- |
| index | Ο μηδενικός δείκτης του στοιχείου για λήψη ή ορισμό. |
