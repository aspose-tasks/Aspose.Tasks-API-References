...
description: "Ιδιότητα TimelineView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανιστεί μια γραμμή που αντιπροσωπεύει τη σημερινή ημέρα"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανίζεται μια γραμμή που αντιπροσωπεύει τη σημερινή ημέρα.
