...
description: "Ιδιότητα TimelineView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανίζεται ο έλεγχος μετακίνησης και ζουμ."
type: docs
weight: 50
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανίζεται ο έλεγχος μετακίνησης και ζουμ.
