...
description: "Ιδιότητα TimelineView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανιστούν επικαλυπτόμενες εργασίες σε πολλαπλές σειρές"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εμφανίζονται επικαλυπτόμενες εργασίες σε πολλές γραμμές.
