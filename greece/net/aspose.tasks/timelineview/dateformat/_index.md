...
description: "Ιδιότητα TimelineView. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει πώς να μορφοποιούνται οι ημερομηνίες στην προβολή Timeline."
type: docs
weight: 20
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει πώς να μορφοποιηθούν οι ημερομηνίες στην προβολή Timeline.
