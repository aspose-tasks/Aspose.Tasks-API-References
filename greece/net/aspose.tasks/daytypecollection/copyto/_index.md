...
description: "DayTypeCollection method. Αντιγράφει τα στοιχεία αυτής της συλλογής στον καθορισμένο πίνακα ξεκινώντας από το καθορισμένο δείκτη του πίνακα"
type: docs
weight: 70
...
| --- | --- | --- |
| array | DayType[] | ο καθορισμένος μονοδιάστατος πίνακας για αντιγραφή των στοιχείων σε αυτόν |
