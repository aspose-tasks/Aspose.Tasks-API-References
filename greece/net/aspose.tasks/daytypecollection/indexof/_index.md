...
description: "DayTypeCollection method. Καθορίζει το δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή"
type: docs
weight: 90
...
| --- | --- | --- |
| item | DayType | το καθορισμένο στοιχείο για εντοπισμό σε αυτή τη συλλογή. |
