...
description: "Μέθοδος DayTypeCollection. Εισάγει το καθορισμένο στοιχείο στο καθορισμένο δείκτη"
type: docs
weight: 100
...
| item | DayType | το καθορισμένο στοιχείο για εισαγωγή σε αυτή τη συλλογή. |
