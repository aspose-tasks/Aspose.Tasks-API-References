...
description: "GroupCriterion ιδιότητα. Λαμβάνει ή ορίζει τη γραμματοσειρά για ένα κριτήριο σε έναν ορισμό ομάδας"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει τη γραμματοσειρά για ένα κριτήριο σε ορισμό ομάδας.
