...
description: "GroupCriterion ιδιότητα. Λαμβάνει ή ορίζει την έναρξη των διαστημάτων για ένα πεδίο που χρησιμοποιείται ως κριτήριο σε έναν ορισμό ομάδας"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει την αρχή των διαστημάτων για ένα πεδίο που χρησιμοποιείται ως κριτήριο σε ορισμό ομάδας.
