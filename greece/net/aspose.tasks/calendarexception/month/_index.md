...
description: "CalendarException ιδιότητα. Λαμβάνει ή ορίζει το μήνα για το οποίο έχει προγραμματιστεί η επανάληψη μιας εξαίρεσης"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει το μήνα για τον οποίο προγραμματίζεται η επανάληψη της εξαίρεσης.
