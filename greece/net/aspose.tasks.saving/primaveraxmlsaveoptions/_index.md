...
| Ονομα | Περιγραφή |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Αρχικοποιεί μια νέα παρουσία του`PrimaveraXmlSaveOptions` τάξη. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα αποθηκευτεί μια ριζική εργασία ή όχι. |
