...
description: "Λαμβάνει ή ορίζει τη συνθήκη που χρησιμοποιείται για το φιλτράρισμα των εργασιών που αποδίδονται στο φύλλο εργασιών Gantt και στα διαγράμματα χρήσης εργασιών."
type: docs
weight: 190
