...
description: "Ιδιότητα HtmlSaveOptions. Λαμβάνει ή ορίζει το callback που καλείται για τη δημιουργία πόρου για την αποθήκευση της γραμματοσειράς"
type: docs
weight: 80
...
Αποκτά ή ορίζει την κλήση επιστροφής (callback) που καλείται για τη δημιουργία πόρου αποθήκευσης της γραμματοσειράς.
...
Δείχνει πώς να εργαστείτε με κλήσεις επιστροφής αποθήκευσης γραμματοσειρών.
