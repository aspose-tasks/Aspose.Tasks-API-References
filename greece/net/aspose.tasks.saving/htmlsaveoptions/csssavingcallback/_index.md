...
description: "Ιδιότητα HtmlSaveOptions. Λαμβάνει ή ορίζει το callback που καλείται για τη δημιουργία πόρου για αποθήκευση του CSS."
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την κλήση επιστροφής (callback) που καλείται για τη δημιουργία πόρου αποθήκευσης CSS.
