...
description: "Ιδιότητα HtmlSaveOptions. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα συμπεριληφθεί το όνομα του έργου στην κεφαλίδα σελίδας HTML"
type: docs
weight: 110
...
Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν θα συμπεριληφθεί το όνομα του έργου στην κεφαλίδα της HTML σελίδας.
