...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε XLSX.
type: docs
weight: 1980
...
Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε XLSX.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Αρχικοποιεί μια νέα παρουσία του`XlsxOptions`κλάση που μπορεί να χρησιμοποιηθεί για την αποθήκευση έργου σε μορφή XLSX. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | Λαμβάνει ή ορίζει μια λίστα με τις στήλες προβολής αναθέσεων προς απόδοση ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Λαμβάνει ή ορίζει την κωδικοποίηση του αρχείου XLSX που προκύπτει. Η προεπιλεγμένη τιμή είναιUTF8 . |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | Λαμβάνει ή ορίζει μια λίστα με τις στήλες προβολής πόρων προς απόδοση ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
