...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την αποθήκευση του έργου στο CSV.
type: docs
weight: 1720
...
Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την αποθήκευση του έργου στο CSV.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CsvOptions](csvoptions/)() | Αρχικοποιεί μια νέα παρουσία του`CsvOptions` κλάση που μπορεί να χρησιμοποιηθεί για την αποθήκευση έργου σε μορφή CSV. |
...
| [Encoding](../../aspose.tasks.saving/csvoptions/encoding/) { get; set; } | Λαμβάνει ή ορίζει μια κωδικοποίηση για αποθήκευση CSV με. |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα περιλαμβάνονται κεφαλίδες ή όχι (η προεπιλεγμένη τιμή είναι TRUE). |
...
| [TextDelimiter](../../aspose.tasks.saving/csvoptions/textdelimiter/) { get; set; } | Λαμβάνει ή ορίζει έναν οριοθέτη κειμένου. |
