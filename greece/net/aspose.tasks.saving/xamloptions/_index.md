...
description: /// Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου στο XAML.
type: docs
weight: 1970
...
/// Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου στο XAML.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XamlOptions](xamloptions/)() | Αρχικοποιεί μια νέα παρουσία του`XamlOptions` κλάση που μπορεί να χρησιμοποιηθεί για αποθήκευση έργου σε μορφή XAML. |
