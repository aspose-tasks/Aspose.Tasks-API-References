---
title: "Κλάση XamlOptions"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.Saving.XamlOptions κλάση. /// Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση των σελίδων του έργου σε XAML"
type: docs
weight: 2260
url: /el/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση των σελίδων του έργου σε XAML.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [XamlOptions](xamloptions/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `XamlOptions` που μπορεί να χρησιμοποιηθεί για την αποθήκευση του έργου σε μορφή XAML. |
