...
type: docs
weight: 1860
url: /el/net/aspose.tasks.saving/pdfsaveoptions/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | Αρχικοποιεί μια νέα παρουσία του`PdfSaveOptions`κλάση που μπορεί να χρησιμοποιηθεί για την αποθήκευση ενός εγγράφου στο[`PDF`](../savefileformat/) μορφή. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance/) { get; set; } | Λαμβάνει ή ορίζει ένα επιθυμητό επίπεδο συμμόρφωσης για το έγγραφο PDF που δημιουργείται. Η προεπιλογή είναιPdf15 . |
...
| [DefaultFontName](../../aspose.tasks.saving/pdfsaveoptions/defaultfontname/) { get; set; } | Λαμβάνει ή ορίζει την προεπιλεγμένη γραμματοσειρά για απόδοση. |
| [DigitalSignatureDetails](../../aspose.tasks.saving/pdfsaveoptions/digitalsignaturedetails/) { get; set; } | Λαμβάνει ή ορίζει λεπτομέρειες ψηφιακής υπογραφής. Εάν δεν έχει οριστεί, τότε δεν θα πραγματοποιηθεί υπογραφή. |
...
| [EncryptionDetails](../../aspose.tasks.saving/pdfsaveoptions/encryptiondetails/) { get; set; } | Λαμβάνει ή ορίζει λεπτομέρειες κρυπτογράφησης. Εάν δεν έχει οριστεί, τότε δεν θα εκτελεστεί κρυπτογράφηση. |
...
| [FontResolveCallback](../../aspose.tasks.saving/pdfsaveoptions/fontresolvecallback/) { get; set; } | Λαμβάνει ή ορίζει μια επανάκληση που μπορεί να χρησιμοποιηθεί για την προσαρμογή των επιλυμένων γραμματοσειρών. |
...
| [Pages](../../aspose.tasks.saving/pdfsaveoptions/pages/) { get; set; } | Λαμβάνει ή ορίζει τη λίστα των αριθμών σελίδων προς αποθήκευση κατά την αποθήκευση της διάταξης του έργου σε ξεχωριστά αρχεία. Όλες οι σελίδες θα αποθηκευτούν εάν αυτή η λίστα είναι κενή. |
| [PageSavingCallback](../../aspose.tasks.saving/pdfsaveoptions/pagesavingcallback/) { get; set; } | Λαμβάνει ή ορίζει μια επιστροφή κλήσης που ορίζεται από το χρήστη, η οποία χρησιμοποιείται για τη λήψη μιας ροής εξόδου για κάθε σελίδα που αποδίδεται. Ισχύει όταν[`SaveToSeparateFiles`](./savetoseparatefiles/) χρησιμοποιείται η επιλογή. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/pdfsaveoptions/reducefootergap/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν πρέπει να μειωθεί το κενό μεταξύ της τελευταίας εργασίας και του υποσέλιδου. |
...
| [SaveToSeparateFiles](../../aspose.tasks.saving/pdfsaveoptions/savetoseparatefiles/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα αποθηκεύονται οι σελίδες του έργου σε ξεχωριστά αρχεία. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression/) { get; set; } | Λαμβάνει ή ορίζει έναν τύπο συμπίεσης που θα χρησιμοποιείται για όλες τις ροές περιεχομένου εκτός από τις εικόνες. Η προεπιλογή είναιFlate . |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/pdfsaveoptions/useprojectdefaultfont/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η προεπιλεγμένη γραμματοσειρά πρέπει να χρησιμοποιηθεί για απόδοση. |
