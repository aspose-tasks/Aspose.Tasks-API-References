...
description: "Ιδιότητα MPPSaveOptions. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα γραφτούν τα δεδομένα ομάδων κατά την αποθήκευση ενός έργου σε μορφή MPP. Τα δεδομένα ομάδων περιλαμβάνουν τις συλλογές Project.TaskGroups και Project.ResourceGroups."
type: docs
weight: 60
url: /el/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα γραφτούν τα δεδομένα ομάδων κατά την αποθήκευση ενός έργου σε μορφή MPP. Τα δεδομένα ομάδων περιλαμβάνουν τις συλλογές Project.TaskGroups και Project.ResourceGroups.
