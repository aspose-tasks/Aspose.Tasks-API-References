---
title: "Κλάση XpsOptions"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Κλάση Aspose.Tasks.Saving.XpsOptions. Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση των σελίδων του έργου σε XPS"
type: docs
weight: 2280
url: /el/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση των σελίδων του έργου σε XPS.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `XpsOptions`. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ένα μετααρχείο πρέπει να αποδοθεί ως bitmap. |
