...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε XPS.
type: docs
weight: 1990
...
Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε XPS.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Αρχικοποιεί μια νέα παρουσία του`XpsOptions` τάξη. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ένα μετααρχείο θα πρέπει να αποδοθεί ως bitmap. |
