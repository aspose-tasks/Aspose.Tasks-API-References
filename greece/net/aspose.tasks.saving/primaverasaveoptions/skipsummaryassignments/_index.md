...
description: "Ιδιότητα PrimaveraSaveOptions. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι εκχωρήσεις πόρων σε εργασίες σύνοψης πρέπει να παραλειφθούν κατά την εξαγωγή"
type: docs
weight: 60
url: /el/net/aspose.tasks.saving/primaverasaveoptions/skipsummaryassignments/
---
