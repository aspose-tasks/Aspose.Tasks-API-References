...
description: "Ιδιότητα PrimaveraSaveOptions. Λαμβάνει ή ορίζει το βήμα που χρησιμοποιείται στην επανααρίθμηση των αναγνωριστικών δραστηριότητας"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την αύξηση που χρησιμοποιείται στην επανααρίθμηση των αναγνωριστικών δραστηριότητας.
