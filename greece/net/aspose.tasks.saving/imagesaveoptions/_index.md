...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε εικόνες.
type: docs
weight: 1770
url: /el/net/aspose.tasks.saving/imagesaveoptions/
---
## ImageSaveOptions class

Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου σε εικόνες.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | Αρχικοποιεί μια νέα παρουσία του`ImageSaveOptions` κλάση που μπορεί να χρησιμοποιηθεί για την αποθήκευση εικόνων απόδοσης σε μορφές TIFF, PNG, BMP ή JPEG. |
...
| [DefaultFontName](../../aspose.tasks.saving/imagesaveoptions/defaultfontname/) { get; set; } | Λαμβάνει ή ορίζει την προεπιλεγμένη γραμματοσειρά για απόδοση. |
...
| [FontResolveCallback](../../aspose.tasks.saving/imagesaveoptions/fontresolvecallback/) { get; set; } | Λαμβάνει ή ορίζει μια επανάκληση που μπορεί να χρησιμοποιηθεί για την προσαρμογή των επιλυμένων γραμματοσειρών. |
...
| [HorizontalResolution](../../aspose.tasks.saving/imagesaveoptions/horizontalresolution/) { get; set; } | Λαμβάνει ή ορίζει την οριζόντια ανάλυση σε dpi. |
| [JpegQuality](../../aspose.tasks.saving/imagesaveoptions/jpegquality/) { get; set; } | Λαμβάνει ή ορίζει ποιότητα JPEG. Το επιτρεπόμενο εύρος τιμών είναι 0..100. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | Λαμβάνει ή ορίζει μια λίστα με αριθμούς σελίδων προς αποθήκευση κατά την αποθήκευση της διάταξης του έργου σε ξεχωριστά αρχεία. Όλες οι σελίδες θα αποθηκευτούν εάν αυτή η λίστα είναι κενή. |
| [PageSavingCallback](../../aspose.tasks.saving/imagesaveoptions/pagesavingcallback/) { get; set; } | Λαμβάνει ή ορίζει μια επιστροφή κλήσης που ορίζεται από το χρήστη, η οποία χρησιμοποιείται για τη λήψη μιας ροής εξόδου για κάθε σελίδα που αποδίδεται. |
...
| [PixelFormat](../../aspose.tasks.saving/imagesaveoptions/pixelformat/) { get; set; } | Λαμβάνει ή ορίζει τη μορφή των δεδομένων χρώματος για κάθε pixel στην εικόνα. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν πρέπει να μειωθεί το κενό μεταξύ της τελευταίας εργασίας και του υποσέλιδου. |
...
| [TiffCompression](../../aspose.tasks.saving/imagesaveoptions/tiffcompression/) { get; set; } | Λαμβάνει ή ορίζει τον τύπο συμπίεσης που θα εφαρμόζεται κατά την αποθήκευση των δημιουργούμενων εικόνων στη μορφή TIFF. |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/imagesaveoptions/useprojectdefaultfont/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η προεπιλεγμένη γραμματοσειρά πρέπει να χρησιμοποιηθεί για απόδοση. |
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution/) { get; set; } | Λαμβάνει ή ορίζει την κατακόρυφη ανάλυση σε dpi. |
