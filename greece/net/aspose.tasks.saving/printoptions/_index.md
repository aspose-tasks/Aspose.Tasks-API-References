---
title: "Κλάση PrintOptions"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.Saving.PrintOptions κλάση. Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την εκτύπωση του έργου"
type: docs
weight: 2170
url: /el/net/aspose.tasks.saving/printoptions/
---
## PrintOptions class

Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την εκτύπωση του έργου.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [PrintOptions](printoptions/)() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PrintOptions` που μπορεί να χρησιμοποιηθεί για τον καθορισμό διαφορετικών επιλογών εκτύπωσης του έργου. |
