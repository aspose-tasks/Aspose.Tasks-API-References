...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την εκτύπωση έργου.
type: docs
weight: 1900
...
Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την εκτύπωση έργου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PrintOptions](printoptions/)() | Αρχικοποιεί μια νέα παρουσία του`PrintOptions` κλάση που μπορεί να χρησιμοποιηθεί για να ορίσετε διαφορετικές επιλογές για εκτύπωση έργου. |
