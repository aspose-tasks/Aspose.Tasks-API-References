...
description: Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου στο Spreadsheet2003.
type: docs
weight: 1940
...
Επιτρέπει τον καθορισμό πρόσθετων επιλογών κατά την απόδοση σελίδων έργου στο Spreadsheet2003.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | Αρχικοποιεί μια νέα παρουσία του`Spreadsheet2003SaveOptions` τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | Λαμβάνει ή ορίζει μια λίστα με τις στήλες προβολής αναθέσεων προς απόδοση ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | Λαμβάνει ή ορίζει μια λίστα με τις στήλες προβολής πόρων προς απόδοση ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
