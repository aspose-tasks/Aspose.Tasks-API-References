...
description: "Μέθοδος IAlgorithm. Επεξεργάζεται ένα αντικείμενο στη λίστα. Καλείται μετά το PreAlg"
type: docs
weight: 10
...
Επεξεργάζεται ένα αντικείμενο στη λίστα. Καλείται μετά το [`PreAlg`](../prealg/);
