...
description: "BuiltInProjectPropertyCollection property. Λαμβάνει ή ορίζει τη βάση υπερσυνδέσμου ενός έργου"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει τη βάση υπερσυνδέσμου ενός έργου.
