...
description: "Κατασκευαστής CustomProjectPropertyCollection. Αρχικοποιεί ένα νέο αντικείμενο της κλάσης CustomProjectPropertyCollection."
type: docs
weight: 10
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [`CustomProjectPropertyCollection`](../).
