---
title: "Κλάση CustomProjectProperty"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.Properties.CustomProjectProperty κλάση. Αντιπροσωπεύει μια προσαρμοσμένη ιδιότητα"
type: docs
weight: 1540
...
Αναπαριστά μια προσαρμοσμένη ιδιότητα.
...
| [Type](../../aspose.tasks.properties/customprojectproperty/type/) { get; } | Λαμβάνει έναν τύπο της ιδιότητας. |
