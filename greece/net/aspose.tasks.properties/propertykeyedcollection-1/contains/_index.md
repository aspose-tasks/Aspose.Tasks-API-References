...
description: "Μέθοδος PropertyKeyedCollection. Καθορίζει εάν η PropertyCollection περιέχει μια ιδιότητα με το καθορισμένο όνομα."
type: docs
weight: 60
...
Καθορίζει εάν η [`PropertyCollection`](../../propertycollection-1/) περιέχει μια ιδιότητα με το καθορισμένο όνομα.
...
| --- | --- | --- |
| name | String | Το όνομα μιας ιδιότητας |

### Τιμή Επιστροφής

αληθές εάν η [`PropertyCollection`](../../propertycollection-1/) περιέχει μια ιδιότητα με το καθορισμένο όνομα· διαφορετικά, ψευδές.
