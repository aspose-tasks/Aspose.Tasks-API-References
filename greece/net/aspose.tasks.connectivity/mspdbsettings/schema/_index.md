...
description: "MspDbSettings property. Λαμβάνει ή ορίζει το σχήμα του MS Project Server. Η προεπιλεγμένη τιμή είναι pub."
type: docs
weight: 30
...
Λαμβάνει ή ορίζει το σχήμα του MS Project Server. Η προεπιλεγμένη τιμή είναι "pub".
