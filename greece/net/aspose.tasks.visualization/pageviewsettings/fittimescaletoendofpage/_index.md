...
description: "Ιδιότητα PageViewSettings. Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν θα προσαρμοστεί η κλίμακα χρόνου στο τέλος μιας σελίδας κατά την εκτύπωση"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα προσαρμοστεί η κλίμακα χρόνου στο τέλος μιας σελίδας κατά την εκτύπωση.
