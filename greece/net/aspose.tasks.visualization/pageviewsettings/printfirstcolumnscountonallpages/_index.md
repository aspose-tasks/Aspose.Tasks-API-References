...
description: "Ιδιότητα PageViewSettings. Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν θα εκτυπωθεί καθορισμένος αριθμός των πρώτων στηλών σε όλες τις σελίδες"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν θα εκτυπωθεί καθορισμένος αριθμός των πρώτων στηλών σε όλες τις σελίδες.
