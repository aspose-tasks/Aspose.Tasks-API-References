...
description: "HeaderFooterInfo property. Λαμβάνει ή ορίζει την κεντραρισμένη εικόνα που θα εμφανίζεται στο γονικό στοιχείο"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει την κεντραρισμένη εικόνα που θα εμφανίζεται στο γονικό στοιχείο.
