...
description: "HeaderFooterInfo constructor. Δημιουργεί μια νέα παρουσία της κλάσης HeaderFooterInfo"
type: docs
weight: 10
...
Δημιουργεί μια νέα παρουσία της κλάσης [`HeaderFooterInfo`](../).
