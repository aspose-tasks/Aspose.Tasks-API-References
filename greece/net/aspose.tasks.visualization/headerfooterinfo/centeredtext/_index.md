...
description: "HeaderFooterInfo property. Λαμβάνει ή ορίζει το κεντραρισμένο κείμενο που θα εμφανίζεται στο γονικό στοιχείο"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει το κεντραρισμένο κείμενο που θα εμφανίζεται στο γονικό στοιχείο.
