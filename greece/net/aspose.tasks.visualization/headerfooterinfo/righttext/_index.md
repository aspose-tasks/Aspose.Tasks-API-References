...
description: "HeaderFooterInfo property. Λαμβάνει ή ορίζει το δεξιά ευθυγραμμισμένο κείμενο που θα εμφανίζεται στο γονικό στοιχείο"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει το δεξιά ευθυγραμμισμένο κείμενο που θα εμφανίζεται στο γονικό στοιχείο.
