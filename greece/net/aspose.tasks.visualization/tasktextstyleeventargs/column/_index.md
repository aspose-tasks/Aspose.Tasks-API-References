...
description: "Ιδιότητα TaskTextStyleEventArgs. Λαμβάνει το ViewColumn στο οποίο ανήκει το τρέχον αποδοθέν κελί."
type: docs
weight: 20
...
Λαμβάνει το [`ViewColumn`](../../viewcolumn/) στο οποίο ανήκει το τρέχον αποδοθέν κελί.
