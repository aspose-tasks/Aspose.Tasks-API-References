...
description: "Ιδιότητα Gridlines. Λαμβάνει ή ορίζει τον αριθμό από 0 έως 99 που καθορίζει το διάστημα μεταξύ των γραμμών πλέγματος"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει τον αριθμό από 0 έως 99 που καθορίζει το διάστημα μεταξύ των γραμμών πλέγματος.
