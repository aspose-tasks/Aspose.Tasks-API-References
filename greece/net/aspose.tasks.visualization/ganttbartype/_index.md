---
title: "Απαρίθμηση GanttBarType"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Απαρίθμηση Aspose.Tasks.Visualization.GanttBarType. Καθορίζει τον τύπο της μπάρας"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Υποδεικνύει τύπο μπάρας Gantt με διακεκομμένη γραμμή. |
| Framed | `1` | Υποδεικνύει τύπο μπάρας Gantt με πλαίσιο. |
| Solid | `0` | Υποδεικνύει τύπο μπάρας Gantt συμπαγής. |
