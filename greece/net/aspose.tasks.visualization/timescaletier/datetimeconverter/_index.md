...
description: "TimescaleTier ιδιότητα. Λαμβάνει ή ορίζει μια συνάρτηση callback για τη διαχείριση της απόδοσης του σημείου ημερομηνίας σε αυτό το επίπεδο."
type: docs
weight: 40
...
Λαμβάνει ή ορίζει μια συνάρτηση callback για τη διαχείριση της απόδοσης του χρονοδείκτη σε αυτό το επίπεδο.
