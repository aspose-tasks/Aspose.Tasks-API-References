...
description: "TimescaleTier ιδιότητα. Λαμβάνει ή ορίζει το διάστημα μονάδας χρόνου στο οποίο εμφανίζονται ετικέτες για το επίπεδο. Η προεπιλεγμένη τιμή είναι 1"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει το διάστημα μονάδας χρόνου στο οποίο θα εμφανίζονται οι ετικέτες για το επίπεδο. Η προεπιλεγμένη τιμή είναι 1.
