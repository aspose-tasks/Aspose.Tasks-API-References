...
description: "TimescaleTier ιδιότητα. Λαμβάνει ή ορίζει τη μονάδα χρονολόγησης TimescaleUnit για το επίπεδο χρονολόγησης. Η προεπιλεγμένη τιμή είναι Days"
type: docs
weight: 80
...
Λαμβάνει ή ορίζει τη μονάδα χρονολόγησης [`TimescaleUnit`](../../timescaleunit/) για το επίπεδο χρονολόγησης. Η προεπιλεγμένη τιμή είναι [`Days`](../../timescaleunit/).
