...
description: "TimescaleTier ιδιότητα. Λαμβάνει ή ορίζει την ετικέτα ημερομηνίας DateLabel για το επίπεδο χρονολόγησης"
type: docs
weight: 50
...
Λαμβάνει ή ορίζει την ετικέτα ημερομηνίας [`DateLabel`](../../datelabel/) για το επίπεδο χρονολόγησης.
