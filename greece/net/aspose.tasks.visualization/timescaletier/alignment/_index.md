...
description: "TimescaleTier ιδιότητα. Λαμβάνει ή ορίζει πώς θα ευθυγραμμιστούν οι ετικέτες εντός κάθε χρονικής περιόδου του επιπέδου HorizontalStringAlignment"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει πώς θα ευθυγραμμιστούν οι ετικέτες εντός κάθε χρονικής περιόδου του επιπέδου ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
