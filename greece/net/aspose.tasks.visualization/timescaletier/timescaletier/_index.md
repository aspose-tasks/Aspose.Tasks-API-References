...
description: "TimescaleTier constructor. Δημιουργεί μια νέα παρουσία της κλάσης TimescaleTier"
type: docs
weight: 10
...
Δημιουργεί μια νέα παρουσία της κλάσης [`TimescaleTier`](../).
...
| --- | --- | --- |
| unit | TimescaleUnit | Η μονάδα κλίμακας χρόνου [`TimescaleUnit`](../../timescaleunit/). |
| count | Int32 | Ο αριθμός των μονάδων [`TimescaleUnit`](../../timescaleunit/). |
