...
description: "Ιδιότητα PageInfo. Λαμβάνει ή ορίζει την παρουσία της κλάσης HeaderFooterInfo που αντιπροσωπεύει δεδομένα κεφαλίδας"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει την παρουσία της κλάσης [`HeaderFooterInfo`](../../headerfooterinfo/) που αντιπροσωπεύει δεδομένα κεφαλίδας.
