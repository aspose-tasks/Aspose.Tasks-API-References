...
description: "Ιδιότητα PageInfo. Λαμβάνει μια παρουσία της κλάσης PageViewSettings που καθορίζει τις ρυθμίσεις εκτύπωσης προβολής σελίδας"
type: docs
weight: 80
...
Λαμβάνει μια παρουσία της κλάσης `PageViewSettings` που καθορίζει τις ρυθμίσεις εκτύπωσης προβολής σελίδας.
