...
description: "Ιδιότητα PageInfo. Λαμβάνει μια παρουσία της κλάσης PageMargins η οποία καθορίζει τα περιθώρια της σελίδας"
type: docs
weight: 50
...
Λαμβάνει μια παρουσία της κλάσης [`PageMargins`](../../pagemargins/) η οποία καθορίζει τα περιθώρια της σελίδας.
