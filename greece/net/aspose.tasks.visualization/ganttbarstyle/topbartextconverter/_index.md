...
description: "Ιδιότητα GanttBarStyle. Λαμβάνει ή ορίζει μετατροπέα που ορίζεται από το χρήστη για την απόκτηση κειμένου που θα εμφανίζεται στην κορυφή της γραμμής εργασιών. Αντικαθιστά την τιμή της ιδιότητας TopField."
type: docs
weight: 260
...
Λαμβάνει ή ορίζει μετατροπέα που ορίζεται από το χρήστη για την απόκτηση κειμένου που θα εμφανίζεται στην κορυφή της γραμμής της εργασίας. Αντικαθιστά την τιμή της ιδιότητας [`TopField`](../topfield/).
