...
description: "GanttBarStyle ιδιότητα. Λαμβάνει ή ορίζει θέση του τελικού σημείου της γραμμής gantt"
type: docs
weight: 250
...
Λαμβάνει ή ορίζει τη θέση του σημείου λήξης της μπάρας gantt.
