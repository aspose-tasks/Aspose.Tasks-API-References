...
description: "GanttBarStyle ιδιότητα. Λαμβάνει ή ορίζει θέση του σημείου εκκίνησης της γραμμής gantt. Πεδίο"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει θέση του σημείου εκκίνησης της γραμμής gantt. [`Field`](../../../aspose.tasks/field/).
