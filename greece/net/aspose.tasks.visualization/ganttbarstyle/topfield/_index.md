...
description: "Ιδιότητα GanttBarStyle. Αποκτά ή ορίζει τα δεδομένα που θα εμφανιστούν στην κορυφή της γραμμής"
type: docs
weight: 270
...
Λαμβάνει ή ορίζει τα δεδομένα που θα εμφανιστούν στην κορυφή της γραμμής.
