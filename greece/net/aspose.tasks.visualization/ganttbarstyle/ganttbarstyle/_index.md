...
description: "Κατασκευαστής GanttBarStyle. Αρχικοποιεί ένα νέο αντικείμενο της κλάσης GanttBarStyle."
type: docs
weight: 10
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [`GanttBarStyle`](../).
