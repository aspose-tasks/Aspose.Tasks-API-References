...
description: "Ιδιότητα GanttBarStyle. Αποκτά ή ορίζει τα δεδομένα που θα εμφανιστούν μέσα στη γραμμή. Field"
type: docs
weight: 90
...
Αποκτά ή ορίζει τα δεδομένα που θα εμφανιστούν μέσα στη γραμμή. [`Field`](../../../aspose.tasks/field/).
