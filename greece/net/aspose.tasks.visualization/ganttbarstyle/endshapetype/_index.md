...
description: "Ιδιότητα GanttBarStyle. Λαμβάνει ή ορίζει έναν τύπο του τελικού σχήματος. GanttBarType"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει έναν τύπο του τελικού σχήματος. [`GanttBarType`](../../ganttbartype/).
