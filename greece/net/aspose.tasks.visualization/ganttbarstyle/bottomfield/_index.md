...
description: "Ιδιότητα GanttBarStyle. Λαμβάνει ή ορίζει τα δεδομένα που θα εμφανίζονται στο κάτω μέρος της μπάρας. Field"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει τα δεδομένα που θα εμφανίζονται στο κάτω μέρος της μπάρας. [`Field`](../../../aspose.tasks/field/).
