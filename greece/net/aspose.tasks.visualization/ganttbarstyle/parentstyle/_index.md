...
description: "Ιδιότητα GanttBarStyle. Λαμβάνει ή ορίζει το γονικό ή κοινό στυλ για προσαρμοσμένο στυλ συγκεκριμένου έργου."
type: docs
weight: 160
...
Λαμβάνει ή ορίζει το γονικό (ή κοινό) στυλ για προσαρμοσμένο στυλ ειδικό για εργασία.
