...
description: "Ιδιότητα BarStyle. Λαμβάνει ή ορίζει το χρώμα του σχήματος στο τέλος της μπάρας"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει το χρώμα του σχήματος στο τέλος της ράβδου.
