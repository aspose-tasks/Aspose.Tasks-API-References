...
description: "Ιδιότητα RecurringInterval. Λαμβάνει ή ορίζει τον αριθμό εβδομάδας για τις εβδομαδιαίες γραμμές προόδου"
type: docs
weight: 120
...
Λαμβάνει ή ορίζει τον αριθμό εβδομάδας για τις εβδομαδιαίες γραμμές προόδου.
