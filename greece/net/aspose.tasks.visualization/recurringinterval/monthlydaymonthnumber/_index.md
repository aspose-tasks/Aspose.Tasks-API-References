...
description: "Ιδιότητα RecurringInterval. Λαμβάνει ή ορίζει τον αριθμό μήνα των μηνιαίων γραμμών προόδου"
type: docs
weight: 70
...
Λαμβάνει ή ορίζει τον αριθμό μήνα των μηνιαίων γραμμών προόδου.
