...
description: "Ιδιότητα RecurringInterval. Λαμβάνει ή ορίζει τον αριθμό μήνα των γραμμών προόδου που εμφανίζονται με την πρώτη ή την τελευταία προκαθορισμένη ημέρα"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει τον αριθμό μήνα των γραμμών προόδου, που εμφανίζονται με την πρώτη ή την τελευταία προκαθορισμένη ημέρα.
