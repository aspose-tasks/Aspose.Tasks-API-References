...
description: "Ιδιότητα RecurringInterval. Λαμβάνει μια λίστα ημερών για τις εβδομαδιαίες γραμμές προόδου."
type: docs
weight: 110
...
Λαμβάνει μια λίστα ημερών για τις εβδομαδιαίες γραμμές προόδου.
