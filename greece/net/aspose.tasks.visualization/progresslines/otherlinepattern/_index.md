...
description: "Ιδιότητα ProgressLines. Λαμβάνει ή ορίζει το μοτίβο γραμμής για άλλες γραμμές προόδου"
type: docs
weight: 130
...
Λαμβάνει ή ορίζει το μοτίβο γραμμής για την άλλη γραμμή προόδου.
