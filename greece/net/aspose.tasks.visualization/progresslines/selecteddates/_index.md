...
description: "Ιδιότητα ProgressLines. Λαμβάνει τη λίστα των επιλεγμένων ημερομηνιών για τις οποίες θα εμφανίζονται οι γραμμές προόδου"
type: docs
weight: 190
...
Λαμβάνει τη λίστα των επιλεγμένων ημερομηνιών για τις οποίες θα εμφανιστούν γραμμές προόδου.
