...
description: "Ιδιότητα ProgressLines. Λαμβάνει ή ορίζει το σχήμα σημείου προόδου της άλλης γραμμής προόδου"
type: docs
weight: 150
...
Λαμβάνει ή ορίζει το σχήμα του σημείου προόδου της άλλης γραμμής προόδου.
