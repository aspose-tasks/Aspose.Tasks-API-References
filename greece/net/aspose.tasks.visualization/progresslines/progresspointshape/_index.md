...
description: "Ιδιότητα ProgressLines. Λαμβάνει ή ορίζει το σχήμα σημείου προόδου. GanttBarEndShape"
type: docs
weight: 170
...
Αποκτά ή ορίζει το σχήμα σημείου προόδου. [`GanttBarEndShape`](../../ganttbarendshape/).
