...
description: "Ιδιότητα ProgressLines. Αποκτά ή ορίζει το χρώμα της γραμμής για την τρέχουσα γραμμή προόδου"
type: docs
weight: 100
...
Λαμβάνει ή ορίζει το χρώμα της γραμμής για την τρέχουσα γραμμή προόδου.
