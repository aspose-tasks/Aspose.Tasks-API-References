...
description: "Ιδιότητα PageSettings. Λαμβάνει ή ορίζει έναν αριθμό πρώτης σελίδας για εκτύπωση"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει τον αριθμό της πρώτης σελίδας για εκτύπωση.
