...
description: "Ιδιότητα PageSettings. Λαμβάνει ή ορίζει έναν αριθμό σελίδων σε πλάτος που θα εκτυπωθούν"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει τον αριθμό των σελίδων σε πλάτος που θα εκτυπωθούν.
