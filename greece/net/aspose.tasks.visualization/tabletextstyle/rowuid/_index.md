...
description: "Ιδιότητα TableTextStyle. Λαμβάνει ένα μοναδικό αναγνωριστικό γραμμής. Επιστρέφει 1 εάν το στυλ πρέπει να εφαρμοστεί σε όλες τις γραμμές μιας προβολής."
type: docs
weight: 40
...
Λαμβάνει ένα μοναδικό αναγνωριστικό γραμμής. Επιστρέφει -1 εάν το στυλ θα εφαρμοστεί σε όλες τις γραμμές μιας προβολής.
