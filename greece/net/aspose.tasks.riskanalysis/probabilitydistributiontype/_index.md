---
title: "Απαρίθμηση ProbabilityDistributionType"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.RiskAnalysis.ProbabilityDistributionType απαρίθμηση. Καθορίζει τύπους των υποστηριζόμενων κατανομών πιθανότητας."
type: docs
weight: 1860
...
Καθορίζει τους τύπους των υποστηριζόμενων κατανομών πιθανότητας.
...
| Normal | `1` | Η κατανομή που μερικές φορές αποκαλείται ανεπίσημα η καμπύλη Bell (κατανομή Γκαουσιανής). |
