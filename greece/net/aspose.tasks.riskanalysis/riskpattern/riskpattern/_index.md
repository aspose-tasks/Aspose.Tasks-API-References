...
description: "Κατασκευαστής RiskPattern. Αρχικοποιεί μια νέα παρουσία της κλάσης RiskPattern"
type: docs
weight: 10
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [`RiskPattern`](../).
...
| --- | --- | --- |
| εργασία | Εργασία | η καθορισμένη εργασία έργου για την οποία αυτός ο κίνδυνος θα εφαρμοστεί στη προσομοίωση Monte Carlo. |
