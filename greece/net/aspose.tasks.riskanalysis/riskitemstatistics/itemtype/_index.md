...
description: "Ιδιότητα RiskItemStatistics. Λαμβάνει μια παρουσία της απαρίθμησης RiskItemType"
type: docs
weight: 20
...
Λαμβάνει μια παρουσία της απαρίθμησης [`RiskItemType`](../../riskitemtype/).
