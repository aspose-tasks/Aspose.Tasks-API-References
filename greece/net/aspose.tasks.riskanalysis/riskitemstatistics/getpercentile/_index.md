...
description: "Μέθοδος RiskItemStatistics. Λαμβάνει μια τιμή κάτω από την οποία πέφτει ένα καθορισμένο ποσοστό των παραγόμενων δειγμάτων"
type: docs
weight: 60
...
Λαμβάνει μια τιμή κάτω από την οποία ένα καθορισμένο ποσοστό των παραγόμενων δειγμάτων πέφτει.
...
| --- | --- | --- |
| ποσοστό | Int32 | το καθορισμένο ποσοστό μεταξύ 0 και 100. |
