...
description: "Ιδιότητα RiskItemStatistics. Λαμβάνει τη ελάχιστη τιμή που δημιουργήθηκε κατά τη διάρκεια της προσομοίωσης Monte Carlo"
type: docs
weight: 40
...
Λαμβάνει τη ελάχιστη τιμή που δημιουργήθηκε κατά τη διάρκεια της προσομοίωσης Monte Carlo.
