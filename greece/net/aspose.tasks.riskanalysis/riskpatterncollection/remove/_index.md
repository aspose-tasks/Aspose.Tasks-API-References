...
description: "Μέθοδος RiskPatternCollection. Αφαιρεί την πρώτη εμφάνιση ενός συγκεκριμένου αντικειμένου από αυτή τη συλλογή."
type: docs
weight: 90
...
| --- | --- | --- |
| item | RiskPattern | το καθορισμένο αντικείμενο προς αφαίρεση. |
