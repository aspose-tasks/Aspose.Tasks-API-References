...
description: "Μέθοδος RiskPatternCollection. Αντιγράφει τα στοιχεία αυτής της συλλογής στον καθορισμένο πίνακα ξεκινώντας από το καθορισμένο δείκτη πίνακα."
type: docs
weight: 70
...
| --- | --- | --- |
| array | RiskPattern[] | ο καθορισμένος μονοδιάστατος πίνακας για αντιγραφή των στοιχείων σε αυτόν |
