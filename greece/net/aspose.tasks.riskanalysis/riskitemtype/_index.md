---
title: "Απαρίθμηση RiskItemType"
second_title: "Aspose.Tasks for .NET Αναφορά API"
description: "Aspose.Tasks.RiskAnalysis.RiskItemType απαρίθμηση. Καθορίζει πεδία εργασιών για τα οποία συλλέγονται στατιστικές πληροφορίες κατά τη διάρκεια της ανάλυσης κινδύνου."
type: docs
weight: 1920
...
Καθορίζει τα πεδία εργασιών για τα οποία συλλέγονται στατιστικές πληροφορίες κατά την ανάλυση κινδύνου.
...
| LateStart | `4` | Καθυστερημένη έναρξη εργασίας. |
