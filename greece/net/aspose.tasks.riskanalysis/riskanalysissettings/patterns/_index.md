...
description: "Ιδιότητα RiskAnalysisSettings. Λαμβάνει μια συλλογή που περιέχει τα στιγμιότυπα της κλάσης RiskPattern"
type: docs
weight: 30
...
Λαμβάνει μια συλλογή που περιέχει τα στιγμιότυπα της κλάσης [`RiskPattern`](../../riskpattern/).
