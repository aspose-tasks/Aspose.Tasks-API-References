...
description: "Ιδιότητα RiskAnalysisSettings. Λαμβάνει ή ορίζει τον αριθμό των επαναλήψεων που θα χρησιμοποιηθούν στη προσομοίωση Monte Carlo. Η προεπιλεγμένη τιμή είναι 100"
type: docs
weight: 20
