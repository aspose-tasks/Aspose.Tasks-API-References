...
description: "RiskAnalyzer ιδιότητα. Λαμβάνει ή ορίζει το στιγμιότυπο της κλάσης RiskAnalysisSettings που ορίζει τις απαραίτητες ρυθμίσεις για την ανάλυση κινδύνου"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει το στιγμιότυπο της κλάσης [`RiskAnalysisSettings`](../../riskanalysissettings/) που ορίζει τις απαραίτητες ρυθμίσεις για την ανάλυση κινδύνου.
