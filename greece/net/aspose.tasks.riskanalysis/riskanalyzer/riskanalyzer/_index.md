...
description: "RiskAnalyzer κατασκευαστής. Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης RiskAnalyzer"
type: docs
weight: 10
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [`RiskAnalyzer`](../).
...
| --- | --- | --- |
| settings | RiskAnalysisSettings | το καθορισμένο στιγμιότυπο της κλάσης [`RiskAnalysisSettings`](../../riskanalysissettings/). |
