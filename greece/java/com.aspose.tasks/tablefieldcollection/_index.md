...
type: docs
weight: 287
url: /el/java/com.aspose.tasks/tablefieldcollection/
---
...
Περιέχει μια λίστα από αντικείμενα [TableField](../../com.aspose/tasks/tablefield). Υλοποιεί τη διεπαφή IList&lt;TableField&gt;.
## Μέθοδοι
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | Επιστρέφει το δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή. |
...
Επιστρέφει το δείκτη του καθορισμένου στοιχείου σε αυτή τη συλλογή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | το καθορισμένο στοιχείο. |

**Returns:**
int - δείκτης του στοιχείου.
### indexOf(Object o) {#indexOf-java.lang.Object-}
```
