...
type: docs
weight: 152
url: /el/java/com.aspose.tasks/metered/
---
...
Σε αυτό το παράδειγμα, θα γίνει προσπάθεια να οριστεί το μετρημένο δημόσιο και ιδιωτικό κλειδί στο αρχείο jar του στοιχείου:
