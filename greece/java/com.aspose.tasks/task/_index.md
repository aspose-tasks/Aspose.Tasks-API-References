...
type: docs
weight: 289
url: /el/java/com.aspose.tasks/task/
---
...
Το **Task** αντιπροσωπεύει ένα ατομικό κομμάτι εργασίας.

Μπορεί κανείς να χρησιμοποιήσει το **Task** για να προγραμματίσει ένα έργο δημιουργώντας εργασίες και αναθέτοντας κατάλληλους πόρους σε αυτές. Οι εργασίες σε ένα έργο οργανώνονται ως μια ιεραρχική δομή δέντρου με ρίζα, με μια ριζική εργασία και υποδέντρα παιδικών εργασιών.

Για να δημιουργήσετε ένα δέντρο εργασιών, μπορείτε να χρησιμοποιήσετε μια εξειδικευμένη συλλογή [TaskCollection](../../com.aspose.tasks/taskcollection) προσπερνώντας την ιδιότητα `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) ιδιότητας π.χ.:
...
Task task1 = project.RootTask.Children.Add(); // μια γονική εργασία με κενό όνομα προστέθηκε
...
// αποθηκεύει το έργο σε μία από τις διαθέσιμες μορφές
