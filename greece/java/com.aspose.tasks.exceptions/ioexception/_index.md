...
description: "Η εξαίρεση που προκαλείται όταν συμβαίνει σφάλμα I/O."
type: docs
weight: 38
url: /el/java/com.aspose.tasks.exceptions/ioexception/
---
...
Η εξαίρεση που προκαλείται όταν συμβαίνει σφάλμα I/O.
