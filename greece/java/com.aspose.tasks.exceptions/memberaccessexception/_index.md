...
description: "Η εξαίρεση που προκαλείται όταν αποτυγχάνει μια προσπάθεια πρόσβασης σε μέλος κλάσης."
type: docs
weight: 40
url: /el/java/com.aspose.tasks.exceptions/memberaccessexception/
---
...
Η εξαίρεση που προκαλείται όταν αποτυγχάνει μια προσπάθεια πρόσβασης σε μέλος κλάσης.
