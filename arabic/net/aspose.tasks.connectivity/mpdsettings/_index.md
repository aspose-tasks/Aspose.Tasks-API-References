...
description: يسمح بتعيين الخيارات الضرورية لقراءة بيانات المشروع من تنسيق MPD تنسيق ملف قاعدة بيانات MS Access .
type: docs
weight: 290
...
| اسم | وصف |
| --- | --- |
| [MpdSettings](mpdsettings)(string, int) | يقوم بتهيئة مثيل جديد لملف[`MpdSettings`](../mpdsettings) فئة . |
