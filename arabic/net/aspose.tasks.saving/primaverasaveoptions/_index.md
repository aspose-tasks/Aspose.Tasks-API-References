...
| اسم | وصف |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | يقوم بتهيئة مثيل جديد لملف[`PrimaveraSaveOptions`](../primaverasaveoptions) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement) { get; set; } | الحصول على الزيادة المستخدمة في إعادة ترقيم معرّفات النشاط أو تعيينها. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix) { get; set; } | الحصول على البادئة المستخدمة في إعادة ترقيم معرّفات النشاط أو تعيينها. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix) { get; set; } | الحصول على اللاحقة المستخدمة في إعادة ترقيم معرّفات النشاط أو تعيينها. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كانت هناك حاجة إلى إعادة ترقيم معرّفات النشاط. |
