...
description: "خاصية PrimaveraSaveOptions. تحصل أو تعين اللاحقة المستخدمة في إعادة ترقيم معرفات النشاط"
type: docs
weight: 40
...
يحصل أو يعيّن اللاحقة المستخدمة في إعادة ترقيم معرفات الأنشطة.
