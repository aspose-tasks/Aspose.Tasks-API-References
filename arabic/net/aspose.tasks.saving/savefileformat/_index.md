...
description: تعداد لحفظ اختيار تنسيق المشروع.
type: docs
weight: 1900
...
تعداد لحفظ اختيار تنسيق المشروع.
...
| Svg | `10` | تنسيق SVG. |
| Csv | `11` | تنسيق CSV . |
| Txt | `12` | تنسيق النص (محدد بعلامات جدولة) . |
| Spreadsheet2003 | `13` | جدول بيانات XML (Excel 2003) . |
