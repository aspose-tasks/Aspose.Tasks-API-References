...
description: "خاصية SaveTemplateOptions. تحصل أو تعيين قيمة تشير إلى ما إذا كان يجب إزالة جميع التكاليف الثابتة من قالب المشروع"
type: docs
weight: 40
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إزالة جميع التكاليف الثابتة من قالب المشروع.
