...
description: "خاصية SaveTemplateOptions. تحصل أو تعيين قيمة تشير إلى ما إذا كان يجب إزالة معدلات الموارد من قالب المشروع"
type: docs
weight: 50
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إزالة معدلات الموارد من قالب المشروع.
