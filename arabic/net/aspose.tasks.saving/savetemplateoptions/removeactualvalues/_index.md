...
description: "خاصية SaveTemplateOptions. تحصل أو تعيين قيمة تشير إلى ما إذا كان يجب إزالة جميع القيم الفعلية من قالب المشروع"
type: docs
weight: 20
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إزالة جميع القيم الفعلية من قالب المشروع.
