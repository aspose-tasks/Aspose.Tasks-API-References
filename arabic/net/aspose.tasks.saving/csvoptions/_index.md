...
description: يسمح بتحديد خيارات إضافية عند حفظ المشروع في ملف CSV.
type: docs
weight: 1710
...
يسمح بتحديد خيارات إضافية عند حفظ المشروع في ملف CSV.
...
| اسم | وصف |
| --- | --- |
| [CsvOptions](csvoptions)() | يقوم بتهيئة مثيل جديد لملف[`CsvOptions`](../csvoptions) فئة يمكن استخدامها لحفظ المشروع بتنسيق CSV. |
