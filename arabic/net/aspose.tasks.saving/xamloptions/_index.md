...
description: /// يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على XAML.
type: docs
weight: 1960
...
| اسم | وصف |
| --- | --- |
| [XamlOptions](xamloptions)() | يقوم بتهيئة مثيل جديد لملف[`XamlOptions`](../xamloptions) فئة يمكن استخدامها لحفظ المشروع بتنسيق XAML. |
