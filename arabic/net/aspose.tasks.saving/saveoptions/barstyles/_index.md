...
description: "خاصية SaveOptions. يحصل أو يضبط قائمة مثيلات فئة BarStyle التي تظهر في عرض المشروع"
type: docs
weight: 10
...
يحصل أو يضبط قائمة مثيلات الفئة [`BarStyle`](../../../aspose.tasks.visualization/barstyle/) التي تظهر في عرض المشروع.
