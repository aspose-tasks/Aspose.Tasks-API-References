...
description: هذه فئة أساسية مجردة للفئات التي تسمح للمستخدم بتحديد خيارات إضافية عند حفظ مشروع في تنسيق معين.
type: docs
weight: 1910
...
هذه فئة أساسية مجردة للفئات التي تسمح للمستخدم بتحديد خيارات إضافية عند حفظ مشروع في تنسيق معين.
...
| [PresentationFormat](../../aspose.tasks.saving/saveoptions/presentationformat) { get; set; } | يحصل أو يحدد ملف[`PresentationFormat`](./presentationformat) حيث سيتم حفظ المستند. |
...
| [Timescale](../../aspose.tasks.saving/saveoptions/timescale) { get; set; } | يحصل أو يحدد ملف[`Timescale`](./timescale) القيمة التي تُستخدم للتحكم في كيفية عرض المقياس الزمني (إن وجد) عند حفظ المشروع بتنسيق رسومي. |
...
يتم تمرير مثيل لأي فئة مشتقة من فئة SaveOptions إلى الدفق Save أو string Save overloads ليقوم المستخدم بتعريف الخيارات المخصصة عند حفظ مستند.
