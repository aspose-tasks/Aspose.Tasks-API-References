...
description: يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى SVG.
type: docs
weight: 1940
...
| اسم | وصف |
| --- | --- |
| [SvgOptions](svgoptions)() | يقوم بتهيئة مثيل جديد لملف[`SvgOptions`](../svgoptions) فئة يمكن استخدامها لحفظ المشروع بتنسيق SVG. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback) { get; set; } | الحصول على أو تعيين رد اتصال تنفيذ معرف من قبل المستخدم والذي يتم استخدامه للحصول على تدفق إخراج لكل صفحة مقدمة. |
