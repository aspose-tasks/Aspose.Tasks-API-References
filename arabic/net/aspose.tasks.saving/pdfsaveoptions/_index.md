...
description: يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى PDF .
type: docs
weight: 1850
...
| اسم | وصف |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions)() | يقوم بتهيئة مثيل جديد لملف[`PdfSaveOptions`](../pdfsaveoptions)فئة يمكن استخدامها لحفظ مستند بتنسيق[`بي دي إف`](../savefileformat) صيغة. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance) { get; set; } | الحصول على أو تحديد مستوى التوافق المطلوب لمستند PDF الذي تم إنشاؤه. الإعداد الافتراضي هوPdf15 . |
...
| [Pages](../../aspose.tasks.saving/pdfsaveoptions/pages) { get; set; } | الحصول على أو تعيين قائمة بأرقام الصفحات التي سيتم حفظها عند حفظ تخطيط المشروع إلى ملفات منفصلة.سيتم حفظ جميع الصفحات إذا كانت هذه القائمة فارغة. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression) { get; set; } | الحصول على نوع ضغط أو تعيينه ليتم استخدامه لجميع تدفقات المحتوى باستثناء الصور. الافتراضي هوFlate . |
