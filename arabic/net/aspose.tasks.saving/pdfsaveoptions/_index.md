...
description: Aspose.Tasks.Saving.PdfSaveOptions فصل. يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى PDF .
type: docs
weight: 1860
...
يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى PDF .
...
| اسم | وصف |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | يقوم بتهيئة مثيل جديد لملف`PdfSaveOptions`فئة يمكن استخدامها لحفظ مستند بتنسيق[`بي دي إف`](../savefileformat/) شكل. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance/) { get; set; } | الحصول على أو تحديد مستوى الامتثال المطلوب لمستند PDF الذي تم إنشاؤه. الإعداد الافتراضي هوPdf15 . |
...
| [DefaultFontName](../../aspose.tasks.saving/pdfsaveoptions/defaultfontname/) { get; set; } | الحصول على الخط الافتراضي للعرض أو تعيينه. |
| [DigitalSignatureDetails](../../aspose.tasks.saving/pdfsaveoptions/digitalsignaturedetails/) { get; set; } | الحصول على تفاصيل التوقيع الرقمي أو تعيينها. إذا لم يتم التعيين ، فلن يتم تنفيذ أي توقيع. |
...
| [EncryptionDetails](../../aspose.tasks.saving/pdfsaveoptions/encryptiondetails/) { get; set; } | الحصول على تفاصيل التشفير أو تعيينها. إذا لم يتم التعيين ، فلن يتم إجراء أي تشفير. |
...
| [FontResolveCallback](../../aspose.tasks.saving/pdfsaveoptions/fontresolvecallback/) { get; set; } | الحصول على رد اتصال أو تعيينه والذي يمكن استخدامه لتخصيص الخطوط التي تم حلها. |
...
| [Pages](../../aspose.tasks.saving/pdfsaveoptions/pages/) { get; set; } | الحصول على أو تعيين قائمة بأرقام الصفحات التي سيتم حفظها عند حفظ تخطيط المشروع لملفات منفصلة.سيتم حفظ جميع الصفحات إذا كانت هذه القائمة فارغة. |
| [PageSavingCallback](../../aspose.tasks.saving/pdfsaveoptions/pagesavingcallback/) { get; set; } | الحصول على أو تعيين رد اتصال محدد من قبل المستخدم والذي يتم استخدامه للحصول على تدفق إخراج لكل صفحة معروضة . يكون قابلاً للتطبيق عندما[`SaveToSeparateFiles`](./savetoseparatefiles/) الخيار المستخدم. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/pdfsaveoptions/reducefootergap/) { get; set; } | الحصول على قيمة أو تعيينها للإشارة إلى ما إذا كان يجب تقليل الفجوة بين المهمة الأخيرة والتذييل. |
...
| [SaveToSeparateFiles](../../aspose.tasks.saving/pdfsaveoptions/savetoseparatefiles/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان سيتم حفظ صفحات المشروع في ملفات منفصلة. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression/) { get; set; } | الحصول على نوع ضغط أو تعيينه لاستخدامه في جميع تدفقات المحتوى باستثناء الصور. الإعداد الافتراضي هوFlate . |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/pdfsaveoptions/useprojectdefaultfont/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان يجب استخدام الخط الافتراضي للعرض أم لا. |
