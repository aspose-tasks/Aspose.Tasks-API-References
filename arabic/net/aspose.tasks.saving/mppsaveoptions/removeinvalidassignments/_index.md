...
description: الحصول على أو تعيين قيمة تشير إلى ما إذا كان سيتم إزالة تعيينات الموارد غير الصالحة عند الحفظ في MPP.يقوم MS Project بإنشاء تخصيص موارد فارغ لكل مهمة. اضبط هذه العلامة على صواب لإزالتها عند الحفظ.
type: docs
weight: 30
