...
description: "خاصية MPPSaveOptions. تحصل أو تعين قيمة تشير إلى ما إذا كان يجب كتابة بيانات المجموعات عند حفظ مشروع بتنسيق MPP. تشمل بيانات المجموعات مجموعات Project.TaskGroups و Project.ResourceGroups."
type: docs
weight: 60
url: /ar/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب كتابة بيانات المجموعات عند حفظ المشروع إلى تنسيق MPP. تشمل بيانات المجموعات مجموعات Project.TaskGroups و Project.ResourceGroups.
