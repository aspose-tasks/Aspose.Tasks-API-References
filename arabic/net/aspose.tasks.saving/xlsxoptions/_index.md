...
description: يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى XLSX.
type: docs
weight: 1970
...
| اسم | وصف |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | يقوم بتهيئة مثيل جديد لملف[`XlsxOptions`](../xlsxoptions)فئة يمكن استخدامها لحفظ المشروع بتنسيق XLSX. |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding) { get; set; } | الحصول على أو تعيين ترميز ملف XLSX الناتج. النظام الأساسيUTF8 . |
