...
description: يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى Spreadsheet2003.
type: docs
weight: 1930
...
| اسم | وصف |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions)() | يقوم بتهيئة مثيل جديد لملف[`Spreadsheet2003SaveOptions`](../spreadsheet2003saveoptions) صف دراسي. |
