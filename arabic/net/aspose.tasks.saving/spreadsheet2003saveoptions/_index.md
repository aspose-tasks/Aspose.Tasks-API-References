...
description: Aspose.Tasks.Saving.Spreadsheet2003SaveOptions فصل. يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى Spreadsheet2003.
type: docs
weight: 1940
...
يسمح بتحديد خيارات إضافية عند تقديم صفحات المشروع إلى Spreadsheet2003.
...
| اسم | وصف |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | يقوم بتهيئة مثيل جديد لملف`Spreadsheet2003SaveOptions` فصل. |

## الخصائص

| اسم | وصف |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | الحصول على أو تعيين قائمة بأعمدة عرض المهام المراد عرضها ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ) . |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | الحصول على أو تعيين قائمة بأعمدة عرض الموارد لعرضها ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ) . |
