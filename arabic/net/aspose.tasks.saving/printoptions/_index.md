---
title: "فئة PrintOptions"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "Aspose.Tasks.Saving.PrintOptions فئة. يسمح بتحديد خيارات إضافية عند طباعة المشروع"
type: docs
weight: 2170
...
| الاسم | الوصف |
| --- | --- |
| [PrintOptions](printoptions/)() | ينشئ مثيلاً جديدًا من فئة `PrintOptions` التي يمكن استخدامها لتعيين خيارات مختلفة لطباعة المشروع. |
