...
description: يسمح بتحديد خيارات إضافية عند طباعة المشروع.
type: docs
weight: 1890
...
| اسم | وصف |
| --- | --- |
| [PrintOptions](printoptions)() | يقوم بتهيئة مثيل جديد لملف[`PrintOptions`](../printoptions) فئة يمكن استخدامها لتعيين خيارات مختلفة لطباعة المشروع. |
