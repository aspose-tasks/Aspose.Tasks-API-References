---
title: "الفئة XpsOptions"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "الفئة Aspose.Tasks.Saving.XpsOptions. تسمح بتحديد خيارات إضافية عند تحويل صفحات المشروع إلى XPS"
type: docs
weight: 2280
...
يسمح بتحديد خيارات إضافية عند تحويل صفحات المشروع إلى XPS.
...
| الاسم | الوصف |
| --- | --- |
| [XpsOptions](xpsoptions/)() | يُنشئ مثيلاً جديدًا من الفئة `XpsOptions`. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب عرض ملف ميتا كصورة نقطية. |
