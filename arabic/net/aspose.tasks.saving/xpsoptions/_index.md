...
description: Aspose.Tasks.Saving.XpsOptions فصل. يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على XPS.
type: docs
weight: 1990
...
| اسم | وصف |
| --- | --- |
| [XpsOptions](xpsoptions/)() | يقوم بتهيئة مثيل جديد لملف`XpsOptions` فئة . |
