...
description: Aspose.Tasks.Saving.ImageSaveOptions فصل. يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على الصور.
type: docs
weight: 1770
...
| اسم | وصف |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | يقوم بتهيئة مثيل جديد لملف`ImageSaveOptions` فئة يمكن استخدامها لحفظ الصور المقدمة بتنسيقات TIFF أو PNG أو BMP أو JPEG. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | الحصول على أو تعيين قائمة بأرقام الصفحات لحفظها عند حفظ تخطيط المشروع إلى ملفات منفصلة.سيتم حفظ جميع الصفحات إذا كانت هذه القائمة فارغة. |
...
| [PixelFormat](../../aspose.tasks.saving/imagesaveoptions/pixelformat/) { get; set; } | الحصول على أو تعيين تنسيق بيانات اللون لكل بكسل في الصورة. |
