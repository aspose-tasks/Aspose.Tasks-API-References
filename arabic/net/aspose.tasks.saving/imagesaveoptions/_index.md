...
description: "الفئة Aspose.Tasks.Saving.ImageSaveOptions. تسمح بتحديد خيارات إضافية عند عرض صفحات المشروع كصور"
type: docs
weight: 2030
...
| الاسم | الوصف |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | ينشئ مثيلاً جديداً من الفئة `ImageSaveOptions` التي يمكن استخدامها لحفظ الصور المعروضة بتنسيقات TIFF أو PNG أو BMP أو JPEG. |
...
| [FontSettings](../../aspose.tasks.saving/imagesaveoptions/fontsettings/) { get; } | يحدد إعدادات الخط المستخدمة عند عرض رؤية المشروع. |
...
| [HorizontalResolution](../../aspose.tasks.saving/imagesaveoptions/horizontalresolution/) { get; set; } | يحصل أو يعيّن الدقة الأفقية بوحدة dpi. |
...
| [JpegQuality](../../aspose.tasks.saving/imagesaveoptions/jpegquality/) { get; set; } | يحصل أو يعيّن جودة JPEG. النطاق المسموح به للقيمة هو 0..100. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | يحصل أو يعيّن قائمة أرقام الصفحات التي سيتم حفظها عند حفظ تخطيط المشروع إلى ملفات منفصلة. سيتم حفظ جميع الصفحات إذا كانت هذه القائمة فارغة. |
| [PageSavingCallback](../../aspose.tasks.saving/imagesaveoptions/pagesavingcallback/) { get; set; } | يحصل أو يعيّن رد نداء معرف من قبل المستخدم يُستخدم للحصول على تدفق إخراج لكل صفحة مُعروضة. |
...
| [PixelFormat](../../aspose.tasks.saving/imagesaveoptions/pixelformat/) { get; set; } | يحصل أو يعيّن تنسيق بيانات اللون لكل بكسل في الصورة. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب تقليل الفجوة بين المهمة الأخيرة وتذييل الصفحة. |
...
| [TiffCompression](../../aspose.tasks.saving/imagesaveoptions/tiffcompression/) { get; set; } | يحصل أو يعيّن نوع الضغط الذي سيُطبق عند حفظ الصور المُولَّدة بتنسيق TIFF. |
...
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution/) { get; set; } | يحصل أو يعيّن الدقة العمودية بوحدة dpi. |
