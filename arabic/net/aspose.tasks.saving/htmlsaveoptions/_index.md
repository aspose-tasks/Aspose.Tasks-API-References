...
description: يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على HTML.
type: docs
weight: 1740
...
| اسم | وصف |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions)() | يقوم بتهيئة مثيل جديد لملف[`HtmlSaveOptions`](../htmlsaveoptions) فئة . |
...
| [ExportCss](../../aspose.tasks.saving/htmlsaveoptions/exportcss) { get; set; } | الحصول على أو تحديد طريقة تصدير CSS. |
...
| [Pages](../../aspose.tasks.saving/htmlsaveoptions/pages) { get; set; } | الحصول على قائمة بأرقام الصفحات أو تعيينها لحفظها عند عرض تخطيط المشروع.سيتم حفظ جميع صفحات المشروع إذا كانت هذه القائمة فارغة. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/htmlsaveoptions/usegradientbrush) { get; set; } | الحصول على أو تعيين قيمة تشير إلى استخدام فرشاة التدرج عند عرض تخطيط المشروع.لا يتم دعم استخدام فرشاة التدرج حاليًا عند التقديم إلى HTML. |
