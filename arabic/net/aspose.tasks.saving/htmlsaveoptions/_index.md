...
description: Aspose.Tasks.Saving.HtmlSaveOptions فصل. يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على HTML.
type: docs
weight: 1750
url: /ar/net/aspose.tasks.saving/htmlsaveoptions/
---
## HtmlSaveOptions class

يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع على HTML.
...
| اسم | وصف |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | يقوم بتهيئة مثيل جديد لملف`HtmlSaveOptions` فئة . |
...
| [CssSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/csssavingcallback/) { get; set; } | الحصول على أو تعيين رد الاتصال المطلوب لإنشاء مورد لتخزين CSS. |
| [CssStylePrefix](../../aspose.tasks.saving/htmlsaveoptions/cssstyleprefix/) { get; set; } | الحصول على بادئة نمط CSS أو تعيينها. |
...
| [DefaultFontName](../../aspose.tasks.saving/htmlsaveoptions/defaultfontname/) { get; set; } | الحصول على الخط الافتراضي للعرض أو تعيينه. |
...
| [ExportCss](../../aspose.tasks.saving/htmlsaveoptions/exportcss/) { get; set; } | الحصول على أو تعيين طريقة تصدير CSS. |
| [ExportFonts](../../aspose.tasks.saving/htmlsaveoptions/exportfonts/) { get; set; } | الحصول على أو تحديد طريقة تصدير الخطوط . |
| [ExportImages](../../aspose.tasks.saving/htmlsaveoptions/exportimages/) { get; set; } | الحصول على أو تحديد الطريقة التي يتم بها تصدير الصور. |
...
| [FontFaceTypes](../../aspose.tasks.saving/htmlsaveoptions/fontfacetypes/) { get; set; } | الحصول على أنواع وجه الخط أو تعيينها. |
| [FontResolveCallback](../../aspose.tasks.saving/htmlsaveoptions/fontresolvecallback/) { get; set; } | الحصول على رد اتصال أو تعيينه والذي يمكن استخدامه لتخصيص الخطوط التي تم حلها. |
| [FontSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/fontsavingcallback/) { get; set; } | الحصول على أو تعيين رد الاتصال المطلوب لإنشاء مورد لتخزين الخط. |
...
| [ImageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/imagesavingcallback/) { get; set; } | الحصول على أو تعيين رد الاتصال المطلوب لإنشاء مورد لتخزين الخط. |
| [IncludeProjectNameInPageHeader](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameinpageheader/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان سيتم تضمين اسم المشروع في رأس صفحة HTML. |
| [IncludeProjectNameInTitle](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameintitle/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان سيتم تضمين اسم المشروع في عنوان HTML. |
...
| [Pages](../../aspose.tasks.saving/htmlsaveoptions/pages/) { get; set; } | الحصول على أو تعيين قائمة بأرقام الصفحات لحفظها عند عرض تخطيط المشروع.سيتم حفظ جميع صفحات المشروع إذا كانت هذه القائمة فارغة. |
| [PageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/pagesavingcallback/) { get; set; } | الحصول على أو تعيين رد اتصال محدد من قبل المستخدم والذي يتم استخدامه للحصول على تدفق إخراج لكل صفحة مقدمة. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/htmlsaveoptions/reducefootergap/) { get; set; } | الحصول على قيمة أو تعيينها للإشارة إلى ما إذا كان يجب تقليل الفجوة بين المهمة الأخيرة والتذييل. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/htmlsaveoptions/usegradientbrush/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كنت تريد استخدام فرشاة متدرجة عند عرض تخطيط المشروع.لا يتم دعم استخدام فرشاة التدرج حاليًا عند التقديم إلى HTML. |
| [UseProjectDefaultFont](../../aspose.tasks.saving/htmlsaveoptions/useprojectdefaultfont/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان يجب استخدام الخط الافتراضي للعرض أم لا. |
