...
description: "خاصية ProgressLines. تحصل أو تعين قيمة تشير إلى ما إذا كان يجب عرض خطوط التقدم من بداية تاريخ بدء المشروع"
type: docs
weight: 30
...
الحصول أو تعيين قيمة تشير إلى ما إذا كان سيتم عرض خطوط التقدم من بداية تاريخ بدء المشروع.
