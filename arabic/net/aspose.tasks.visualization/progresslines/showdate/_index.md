...
description: "خاصية ProgressLines. الحصول أو تعيين قيمة تشير إلى ما إذا كان يجب إظهار التاريخ لكل خط تقدم"
type: docs
weight: 200
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب عرض التاريخ لكل خط تقدم.
