...
description: "خاصية ProgressLines. الحصول أو تعيين لون نقطة التقدم الأخرى"
type: docs
weight: 140
url: /ar/net/aspose.tasks.visualization/progresslines/otherprogresspointcolor/
---
## ProgressLines.OtherProgressPointColor property

الحصول أو تعيين لون النقطة الأخرى للتقدم.
