...
description: "خاصية ProgressLines. الحصول أو تعيين قيمة تشير إلى ما إذا كان يجب عرض خط التقدم في التاريخ الحالي"
type: docs
weight: 50
...
الحصول أو تعيين قيمة تشير إلى ما إذا كان سيتم عرض خط التقدم في التاريخ الحالي.
