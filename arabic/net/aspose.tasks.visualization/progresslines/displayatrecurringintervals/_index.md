...
description: "خاصية ProgressLines. الحصول أو تعيين قيمة تشير إلى ما إذا كان يجب عرض خط التقدم في الفواصل المتكررة"
type: docs
weight: 60
url: /ar/net/aspose.tasks.visualization/progresslines/displayatrecurringintervals/
---
## ProgressLines.DisplayAtRecurringIntervals property

الحصول أو تعيين قيمة تشير إلى ما إذا كان سيتم عرض خط التقدم على فترات متكررة.
