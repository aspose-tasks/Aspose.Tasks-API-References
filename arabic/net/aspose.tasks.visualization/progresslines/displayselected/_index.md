...
description: "خاصية ProgressLines. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب عرض خطوط التقدم في التواريخ المختارة"
type: docs
weight: 70
...
الحصول أو تعيين قيمة تشير إلى ما إذا كان سيتم عرض خطوط التقدم في التواريخ المحددة.
