...
description: "خاصية ProgressLines. الحصول أو تعيين قيمة تشير إلى ما إذا كان يجب عرض خطوط التقدم للخطة الأساسية أو الفعلية"
type: docs
weight: 90
...
الحصول أو تعيين قيمة تشير إلى ما إذا كان سيتم عرض خطوط التقدم للخطة الأساسية أو الفعلية.
