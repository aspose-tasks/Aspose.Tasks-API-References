---
title: "تعداد LinePattern"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "تعداد Aspose.Tasks.Visualization.LinePattern. نمط الخط"
type: docs
weight: 3190
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| None | `0` | يشير إلى أن الخط لن يُعرض. |
| Solid | `1` | يشير إلى نمط الخط الصلب. |
| CloseDot | `3` | يشير إلى نمط الخط بنقطة مغلقة. |
