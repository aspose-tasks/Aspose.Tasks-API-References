...
description: "خاصية TimescaleTier. يحصل أو يضبط الفاصل الزمني لوحدة الوقت التي يتم فيها عرض التسميات للطبقة. القيمة الافتراضية هي 1"
type: docs
weight: 30
...
يحصل أو يضبط الفاصل الزمني لوحدة الوقت الذي تُظهر فيه التسميات للطبقة. القيمة الافتراضية هي 1.
