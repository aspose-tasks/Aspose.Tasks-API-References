...
description: "خاصية TimescaleTier. يحصل أو يضبط وحدة المقياس الزمني TimescaleUnit للطبقة الزمنية. القيمة الافتراضية هي Days"
type: docs
weight: 80
...
يحصل أو يضبط وحدة المقياس الزمني [`TimescaleUnit`](../../timescaleunit/) للطبقة الزمنية. القيمة الافتراضية هي [`Days`](../../timescaleunit/).
