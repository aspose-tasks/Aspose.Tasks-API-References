...
description: "خاصية TimescaleTier. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب إظهار علامات الفواصل التي تفصل فترات الوقت في الطبقة"
type: docs
weight: 70
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب إظهار علامات الفواصل التي تفصل الفترات الزمنية في الطبقة.
