...
description: "منشئ TimescaleTier. يهيئ نسخة جديدة من فئة TimescaleTier"
type: docs
weight: 10
...
يهيئ نسخة جديدة من الفئة [`TimescaleTier`](../).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| unit | TimescaleUnit | وحدة المقياس الزمني [`TimescaleUnit`](../../timescaleunit/). |
| count | Int32 | عدد وحدات [`TimescaleUnit`](../../timescaleunit/). |
