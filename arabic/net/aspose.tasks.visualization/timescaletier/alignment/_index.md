...
description: "خاصية TimescaleTier. يحصل أو يضبط طريقة محاذاة التسميات داخل كل فترة زمنية للطبقة HorizontalStringAlignment"
type: docs
weight: 20
...
يحصل أو يضبط طريقة محاذاة التسميات داخل كل فترة زمنية للطبقة ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
