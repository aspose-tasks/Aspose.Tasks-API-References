...
description: "خاصية TimescaleTier. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب اعتماد تسميات الطبقة على السنة المالية"
type: docs
weight: 90
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب اعتماد تسميات الطبقة على السنة المالية.
