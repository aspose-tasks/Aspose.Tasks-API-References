...
description: "طريقة ITextStyleModificationCallback. الطريقة التي تُستدعى قبل رسم خلية جدول لصف مهمة في العروض التالية Gantt Chart Task Sheet Task Usage."
type: docs
weight: 10
...
الطريقة التي سيتم استدعاؤها قبل رسم خلية جدول لصف مهمة في العروض التالية: 'Gantt Chart'، 'Task Sheet'، 'Task Usage'.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| args | TaskTextStyleEventArgs | الكائن [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/). |
