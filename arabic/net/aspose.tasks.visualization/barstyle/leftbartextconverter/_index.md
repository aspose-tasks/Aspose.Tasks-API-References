...
description: "خاصية BarStyle. يحصل أو يضبط محولًا معرفًا من قبل المستخدم للحصول على النص لعرضه على يسار شريط المهام. يتجاوز قيمة خاصية LeftField"
type: docs
weight: 130
...
يحصل أو يضبط محولًا معرفًا من قبل المستخدم للحصول على النص لعرضه على يسار شريط المهمة. يتجاوز قيمة خاصية [`LeftField`](../leftfield/)
