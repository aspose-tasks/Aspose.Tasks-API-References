...
description: "خاصية RecurringInterval. تحصل أو تعيين قيمة تشير إلى ما إذا كان يجب عرض خطوط التقدم باليوم المحدد الأول أو الأخير"
type: docs
weight: 80
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب عرض خطوط التقدم وفقًا لأول يوم أو آخر يوم محدد مسبقًا.
