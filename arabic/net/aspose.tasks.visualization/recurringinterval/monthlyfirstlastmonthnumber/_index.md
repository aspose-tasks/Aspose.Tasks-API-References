...
description: "خاصية RecurringInterval. تحصل أو تعيين رقم الشهر لخطوط التقدم التي تُعرض باليوم المحدد الأول أو الأخير"
type: docs
weight: 100
...
يحصل أو يعيّن رقم الشهر لخطوط التقدم، التي تُعرض وفقًا لأول يوم أو آخر يوم محدد مسبقًا.
