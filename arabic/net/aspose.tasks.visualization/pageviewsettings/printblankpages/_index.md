...
description: "خاصية PageViewSettings. يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب طباعة الصفحات الفارغة للعرض"
type: docs
weight: 50
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب طباعة الصفحات الفارغة للعرض.
