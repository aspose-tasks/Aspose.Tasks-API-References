...
description: "خاصية PageViewSettings. يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب ضبط مقياس الوقت إلى نهاية الصفحة عند الطباعة"
type: docs
weight: 30
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب ملاءمة مقياس الوقت إلى نهاية الصفحة عند الطباعة.
