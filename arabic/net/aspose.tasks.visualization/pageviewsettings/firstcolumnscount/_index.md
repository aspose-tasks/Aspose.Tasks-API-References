...
description: "خاصية PageViewSettings. يحصل أو يعيّن عدد الأعمدة الأولى التي سيتم طباعتها على جميع الصفحات"
type: docs
weight: 20
...
يحصل أو يعيّن عدد الأعمدة الأولى التي تُطبع في جميع الصفحات.
