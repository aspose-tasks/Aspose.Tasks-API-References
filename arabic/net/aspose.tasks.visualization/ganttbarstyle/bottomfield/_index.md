...
description: "خاصية GanttBarStyle. يحصل أو يعيّن البيانات التي تُعرض في أسفل العمود. Field"
type: docs
weight: 30
...
يحصل أو يعيّن البيانات التي تُعرض في أسفل العمود. [`Field`](../../../aspose.tasks/field/).
