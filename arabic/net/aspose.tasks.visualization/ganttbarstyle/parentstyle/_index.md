...
description: "خاصية GanttBarStyle. يحصل أو يعيّن النمط الأب أو النمط المشترك للنمط المخصص الخاص بالمهمة"
type: docs
weight: 160
...
يحصل أو يعيّن النمط الأب (أو المشترك) للنمط المخصص الخاص بالمهمة.
...
يمكن للمهمة أن تحتوي على أنماط مخصصة متعددة ذات أنماط أب مختلفة. على سبيل المثال، اعتبر مهمة لديها نمط مخصص بنمط أب "Critical" ونمط آخر بنمط أب "Normal". ببساطة، إذا كانت المهمة حرجة، يُطبق النمط الأول. إذا أصبحت المهمة غير حرجة، يُطبق النمط الثاني (هذا المنطق مُستمد من Microsoft Project Professional).
