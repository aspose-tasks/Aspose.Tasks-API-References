...
description: "خاصية GanttBarStyle. يحصل أو يضبط البيانات التي سيتم عرضها على يمين الشريط. الحقل"
type: docs
weight: 180
...
يحصل أو يضبط البيانات التي سيتم عرضها على يمين الشريط. [`Field`](../../../aspose.tasks/field/).
