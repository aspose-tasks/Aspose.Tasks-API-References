...
description: "خاصية GanttBarStyle. يحصل أو يعيّن محولًا معرفًا من قبل المستخدم للحصول على النص لتصييره داخل شريط المهام. يتجاوز قيمة خاصية InsideField"
type: docs
weight: 80
...
يحصل أو يعيّن محولًا معرفًا من قبل المستخدم للحصول على النص لتصييره داخل شريط المهمة. يتجاوز قيمة خاصية [`InsideField`](../insidefield/).
