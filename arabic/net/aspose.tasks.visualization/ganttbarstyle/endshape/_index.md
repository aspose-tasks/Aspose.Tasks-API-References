...
description: "خاصية GanttBarStyle. يحصل أو يضبط الشكل النهائي للعمود"
type: docs
weight: 40
url: /ar/net/aspose.tasks.visualization/ganttbarstyle/endshape/
---
## GanttBarStyle.EndShape property

يحصل أو يعيّن الشكل النهائي للشريط.
