...
description: "خاصية GanttBarStyle. يحصل أو يعيّن البيانات التي ستُعرض داخل الشريط. Field"
type: docs
weight: 90
...
يحصل أو يعيّن البيانات التي ستُعرض داخل الشريط. [`Field`](../../../aspose.tasks/field/).
