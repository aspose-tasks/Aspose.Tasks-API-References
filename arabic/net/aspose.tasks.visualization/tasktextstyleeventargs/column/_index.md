...
description: "خاصية TaskTextStyleEventArgs. تحصل على ViewColumn التي تنتمي إليها الخلية المُرَسَمة حالياً."
type: docs
weight: 20
...
يحصل على [`ViewColumn`](../../viewcolumn/) التي تنتمي إليها الخلية المُرَسَمة حالياً.
