...
description: "خاصية PageInfo. تحصل أو تعين نسخة من فئة HeaderFooterInfo التي تمثل بيانات رأس الصفحة"
type: docs
weight: 30
...
تحصل أو تعين نسخة من الفئة [`HeaderFooterInfo`](../../headerfooterinfo/) التي تمثل بيانات رأس الصفحة.
