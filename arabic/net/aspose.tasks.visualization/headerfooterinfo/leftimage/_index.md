...
description: "خاصية HeaderFooterInfo. تحصل أو تعيين الصورة المحاذاة إلى اليسار للعرض في العنصر الأصلي"
type: docs
weight: 50
url: /ar/net/aspose.tasks.visualization/headerfooterinfo/leftimage/
---
## HeaderFooterInfo.LeftImage property

يحصل أو يعيّن الصورة المحاذاة إلى اليسار التي تُعرض في العنصر الأب.
