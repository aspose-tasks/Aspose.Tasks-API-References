...
description: يمثل موضع ومظهرOleObject../aspose.tasks/oleobject في العرض .
type: docs
weight: 3100
...
| اسم | وصف |
| --- | --- |
| [VisualObjectPlacement](visualobjectplacement)() | يقوم بتهيئة مثيل جديد لملف[`VisualObjectPlacement`](../visualobjectplacement) فئة . |
...
| [OleObjectId](../../aspose.tasks.visualization/visualobjectplacement/oleobjectid) { get; set; } | الحصول على أو تعيين معرف[`OleObject`](../../aspose.tasks/oleobject) الكائن . |
...
| [VerticalOffset](../../aspose.tasks.visualization/visualobjectplacement/verticaloffset) { get; set; } | الحصول على أو تعيين الإزاحة الرأسية للكائن المرئي. |
