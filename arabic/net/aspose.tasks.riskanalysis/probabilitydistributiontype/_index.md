---
title: "التعداد ProbabilityDistributionType"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "التعداد Aspose.Tasks.RiskAnalysis.ProbabilityDistributionType. يحدد أنواع توزيعات الاحتمال المدعومة."
type: docs
weight: 1860
...
يحدد أنواع التوزيعات الاحتمالية المدعومة.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Uniform | `0` | التوزيع عندما يتم اختيار كل قيمة باحتمال متساوٍ. |
| Normal | `1` | التوزيع الذي يُطلق عليه أحيانًا غير رسميًا منحنى الجرس (توزيع غاوسي). |
