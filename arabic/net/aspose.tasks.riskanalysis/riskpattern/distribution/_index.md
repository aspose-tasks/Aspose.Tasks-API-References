...
description: "خاصية RiskPattern. تحصل أو تعيين توزيع الاحتمال المستخدم في محاكاة مونت كارلو. القيمة الافتراضية هي ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
يحصل أو يعيّن توزيع الاحتمال المستخدم في محاكاة مونت كارلو. القيمة الافتراضية هي ProbabilityDistributionType.Normal.
...
يمكن أن تكون واحدة من القيم المعرفة في تعداد [`ProbabilityDistributionType`](../../probabilitydistributiontype/).
