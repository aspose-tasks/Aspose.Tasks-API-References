...
description: الحصول على أو تحديد مستوى الثقة الذي يتوافق مع النسبة المئوية للوقت الذي ستكون فيه القيم الفعلية الناتجة ضمن التقديرات المتفائلة والمتشائمة. القيمة الافتراضية هي CL99.
type: docs
weight: 20
