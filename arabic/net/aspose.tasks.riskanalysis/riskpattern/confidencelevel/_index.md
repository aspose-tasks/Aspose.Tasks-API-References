...
description: "خاصية RiskPattern. تحصل أو تعيين مستوى الثقة الذي يتCorrespond إلى النسبة المئوية للوقت التي تكون فيها القيم المولدة الفعلية ضمن التقديرات المتفائلة والمتشائمة. القيمة الافتراضية هي CL99"
type: docs
weight: 20
...
يحصل أو يعيّن مستوى الثقة الذي يتطابق مع النسبة المئوية للوقت الذي تكون فيه القيم المولدة الفعلية ضمن التقديرات المتفائلة والمتشائمة. القيمة الافتراضية هي CL99.
...
يمكن أن تكون واحدة من القيم المعرفة في تعداد `ConfidenceLevel`.
