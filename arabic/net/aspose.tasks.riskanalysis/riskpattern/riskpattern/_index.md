...
description: "منشئ RiskPattern. يهيئ نسخة جديدة من فئة RiskPattern"
type: docs
weight: 10
...
يهيئ نسخة جديدة من الفئة [`RiskPattern`](../).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| مهمة | مهمة | المهمة المشروع المحددة التي سيُطبق عليها هذا الخطر في محاكاة مونت كارلو. |
