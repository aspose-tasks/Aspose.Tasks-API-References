...
description: "طريقة RiskItemStatistics. يحصل على قيمة يكون أقل منها نسبة مئوية محددة من العينات المولدة"
type: docs
weight: 60
...
يحصل على قيمة يكون أقل منها النسبة المئوية المحددة من العينات المولدة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| النسبة | Int32 | النسبة المحددة بين 0 و 100. |

### قيمة الإرجاع

قيمة يكون أقل منها نسبة مئوية محددة من العينات المولدة.
