...
description: "طريقة RiskItemStatistics. تُعيد تمثيلًا نصيًا قصيرًا لعنصر المخاطر. التفاصيل الدقيقة للتمثيل غير محددة وقد تتغير."
type: docs
weight: 70
...
يعيد تمثيلًا نصيًا قصيرًا لعنصر المخاطر. التفاصيل الدقيقة للتمثيل غير محددة وقد تتغير.
