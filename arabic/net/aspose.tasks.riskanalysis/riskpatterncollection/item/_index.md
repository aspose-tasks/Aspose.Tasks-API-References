...
description: "خاصية RiskPatternCollection. تحصل على نسخة من الفئة RiskPattern للمهمة المحددة"
type: docs
weight: 30
...
تحصل على نسخة من الفئة [`RiskPattern`](../../riskpattern/) للمهمة المحددة.
