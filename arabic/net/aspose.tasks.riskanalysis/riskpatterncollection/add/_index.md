...
description: "طريقة RiskPatternCollection. تُضيف نسخة من فئة RiskPattern إلى هذه المجموعة."
type: docs
weight: 40
...
تُضيف نسخة من فئة [`RiskPattern`](../../riskpattern/) إلى هذه المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| item | RiskPattern | نسخة من فئة [`RiskPattern`](../../riskpattern/) لإضافتها إلى هذه المجموعة. |

### استثناءات

| استثناء | شرط |
| --- | --- |
| ArgumentNullException | *item* المهمة فارغة. |
