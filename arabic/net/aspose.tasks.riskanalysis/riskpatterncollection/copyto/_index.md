...
description: "طريقة RiskPatternCollection. تنسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة."
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | RiskPattern[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
