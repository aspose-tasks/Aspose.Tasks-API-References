...
description: "منشئ RiskAnalyzer. يهيئ نسخة جديدة من الفئة RiskAnalyzer"
type: docs
weight: 10
...
يهيئ نسخة جديدة من الفئة [`RiskAnalyzer`](../).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| settings | RiskAnalysisSettings | النسخة المحددة من الفئة [`RiskAnalysisSettings`](../../riskanalysissettings/). |
