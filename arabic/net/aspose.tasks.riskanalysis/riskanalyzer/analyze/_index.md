...
description: "طريقة RiskAnalyzer. تُجري تحليل المخاطر للمشروع المحدد. يعتمد التحليل على محاكاة مونت كارلو والنتيجة هي نسخة من الفئة RiskAnalysisResult"
type: docs
weight: 30
...
تُجري تحليل المخاطر للمشروع المحدد. يعتمد التحليل على محاكاة مونت كارلو والنتيجة هي نسخة من الفئة [`RiskAnalysisResult`](../../riskanalysisresult/).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| project | Project | النسخة المحددة من الفئة [`Project`](../../../aspose.tasks/project/) للتحليل. |

### قيمة الإرجاع

النسخة من الفئة [`RiskAnalysisResult`](../../riskanalysisresult/) التي تمثل نتيجة التحليل.
