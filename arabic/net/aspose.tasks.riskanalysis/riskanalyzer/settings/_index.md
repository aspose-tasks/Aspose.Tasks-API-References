...
description: "خاصية RiskAnalyzer. تحصل أو تعيّن نسخة من الفئة RiskAnalysisSettings التي تحدد الإعدادات الضرورية لتحليل المخاطر"
type: docs
weight: 20
...
تحصل أو تعيّن نسخة من الفئة [`RiskAnalysisSettings`](../../riskanalysissettings/) التي تحدد الإعدادات الضرورية لتحليل المخاطر.
