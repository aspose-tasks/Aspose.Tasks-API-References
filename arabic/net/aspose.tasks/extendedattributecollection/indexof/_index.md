...
description: "طريقة ExtendedAttributeCollection. تحدد فهرس العنصر المحدد في هذه المجموعة"
type: docs
weight: 90
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttribute | العنصر المحدد لتحديد موقعه في هذه المجموعة. |
