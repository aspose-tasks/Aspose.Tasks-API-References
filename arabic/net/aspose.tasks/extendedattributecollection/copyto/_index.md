...
description: "طريقة ExtendedAttributeCollection. ينسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من فهرس المصفوفة المحدد"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | ExtendedAttribute[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
