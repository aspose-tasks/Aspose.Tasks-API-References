...
description: "طريقة ExtendedAttributeCollection. تُرجع true إذا تم العثور على العنصر المحدد في هذه المجموعة وإلا false"
type: docs
weight: 60
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttribute | العنصر المحدد للبحث عنه. |
