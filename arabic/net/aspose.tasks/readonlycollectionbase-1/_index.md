...
description: يمثل مجموعة من الكائنات للقراءة فقط.
type: docs
weight: 1410
...
يمثل مجموعة من الكائنات للقراءة فقط.
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.tasks/readonlycollectionbase`1/add)(T) | هذا هو تنفيذ كعب الروتين لطريقة إضافة ICollection ، والتي ترمي فقط NotSupportedException |
