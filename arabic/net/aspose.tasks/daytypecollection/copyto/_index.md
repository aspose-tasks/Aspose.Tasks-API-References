...
description: "طريقة DayTypeCollection. تنسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | DayType[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
