...
description: "خاصية GanttChartView. يحصل أو يعيّن قيمة تشير إلى ما إذا كانت أشرطة التجميع ستُخفى عند توسيع مهمة الملخص."
type: docs
weight: 90
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كانت أشرطة التجميع ستُخفى عند توسيع مهمة الملخص.
