...
description: "خاصية GanttChartView. يحصل أو يضبط ارتفاع أشرطة جانت بالنقاط في مخطط جانت"
type: docs
weight: 40
url: /ar/net/aspose.tasks/ganttchartview/barsize/
---
## GanttChartView.BarSize property

يحصل أو يعيّن ارتفاع الأشرطة في مخطط جانت بالنقاط.
