...
description: "خاصية ExtendedAttributeDefinition. تحصل أو تعين قيمة تشير إلى ما إذا كان الانحدار التلقائي إلى التعيينات مفعلاً"
type: docs
weight: 70
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان التوزيع التلقائي إلى التعيينات مفعلاً.
