...
description: "خاصية ExtendedAttributeDefinition. تحصل على اسم حقل مخصص"
type: docs
weight: 140
...
يجب عدم تعيينها مباشرةً، بل إنشاء ExtendedAttributeDefinition باستخدام طرق مصنع ثابتة ذات نوعية قوية تُسمى مثل Create*Definition().
