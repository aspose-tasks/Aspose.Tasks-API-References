...
description: "طريقة ExtendedAttributeDefinition. طريقة مصنع تنشئ تعريف سمة موسعة مع بحث. لديها CalculationType يساوي Lookup ويمكن استخدامها في المهام فقط. يُطلب منك تحديد fieldId و alias عند استدعاء هذه الطريقة. يتم استنتاج نوع الحقل من معرف الحقل"
type: docs
weight: 20
...
طريقة مصنع تنشئ تعريف سمة موسعة مع بحث. لديها [`CalculationType`](../calculationtype/) يساوي Lookup ويمكن استخدامها في المهام فقط. يُطلب منك تحديد *fieldId* و *alias* عند استدعاء هذه الطريقة. يتم استنتاج نوع الحقل من معرف الحقل.
...
طريقة مصنع تنشئ تعريف سمة موسعة مع بحث. لديها [`CalculationType`](../calculationtype/) يساوي Lookup ويمكن استخدامها في المهام فقط. يُطلب منك تحديد *customFieldType*، *fieldId* و *alias* عند استدعاء هذه الطريقة.
