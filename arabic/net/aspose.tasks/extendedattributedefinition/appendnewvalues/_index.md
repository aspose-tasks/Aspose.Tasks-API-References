...
description: "خاصية ExtendedAttributeDefinition. تحصل أو تعين قيمة تشير إلى ما إذا كانت القيم الجديدة المضافة إلى المشروع تُضاف تلقائيًا إلى القائمة."
type: docs
weight: 60
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كانت القيم الجديدة المضافة إلى مشروع تُضاف تلقائيًا إلى القائمة.
...
مدعومة حالياً لتنسيقات MSP 2003/2007 Xml و MSP 2003 mpp.
