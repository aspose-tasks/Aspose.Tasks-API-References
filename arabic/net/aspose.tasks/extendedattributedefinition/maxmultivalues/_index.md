...
description: "خاصية ExtendedAttributeDefinition. تحصل أو تعين الحد الأقصى لعدد القيم التي يمكنك تعيينها في قائمة اختيار"
type: docs
weight: 190
...
يحصل أو يضبط الحد الأقصى لعدد القيم التي يمكنك ضبطها في قائمة اختيار.
