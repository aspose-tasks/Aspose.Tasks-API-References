...
description: "طريقة ExtendedAttributeDefinition. تضيف قيمة إلى قائمة البحث الداخلية. هذه طريقة مفضلة للتعامل مع ValueList"
type: docs
weight: 300
...
تضيف قيمة إلى قائمة البحث الداخلية. هذه طريقة مفضلة للتعامل مع [`ValueList`](../valuelist/).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| value | القيمة | القيمة لإضافتها إلى البحث. |
