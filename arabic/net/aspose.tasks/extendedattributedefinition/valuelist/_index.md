...
description: "خاصية ExtendedAttributeDefinition. تحصل على ListValue ValueList"
type: docs
weight: 280
...
عند تحديد قيم الخصائص الموسعة كخصائص لعناصر في المخطط، يمكن إما تحديدها بالقيم أو بالإشارات إلى القيم الموجودة في هذه القائمة. قد تفترض التطبيقات ترتيب القائمة وفقًا للترتيب المحدد هنا. مدعوم حاليًا لتنسيقات MSP 2003/2007 Xml و MSP 2003 mpp. لا تقم بتغيير هذه القائمة مباشرة. استخدم طرق ExtendedAttributeDefinition.AddLookupValue/RemoveLookupValue بدلاً من ذلك.
