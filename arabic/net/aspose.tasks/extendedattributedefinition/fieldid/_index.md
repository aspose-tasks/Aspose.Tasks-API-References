...
description: "خاصية ExtendedAttributeDefinition. تحصل أو تعين ما يتوافق مع معرف المشروع لحقل مخصص. استخدم تمثيل السلسلة لثابت من فئة ExtendedAttributeTask لتحديد خاصية FieldId"
type: docs
weight: 130
...
تحصل أو تعين ما يتوافق مع معرف المشروع لحقل مخصص. استخدم تمثيل السلسلة لثابت من فئة [`ExtendedAttributeTask`](../../extendedattributetask/) لتحديد خاصية `FieldId`.
...
الطريقة المفضلة لتعيين خاصية `FieldId` هي إنشاء [`ExtendedAttributeDefinition`](../) باستخدام إحدى طرق المصنع المخصصة مثل [`CreateTaskDefinition`](../createtaskdefinition/) أو [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/).
...
يعرض كيفية قراءة المعلومات العامة لتعريف السمة الموسعة.

```csharp
var project = new Project(DataDir + "MultipleOutlineValues2016.mpp");

// قراءة معلومات تعريف السمة الموسعة
