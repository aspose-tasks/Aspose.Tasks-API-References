...
description: "خاصية ExtendedAttributeDefinition. تحصل أو تعين قيمة تشير إلى ما إذا كانت قيم الحقل المخصص مقيدة بالقيم في قائمة ValueList"
type: docs
weight: 220
...
تحصل أو تعين قيمة تشير إلى ما إذا كانت قيم الحقل المخصص مقيدة بالقيم في [`ValueList`](../valuelist/).
