...
description: ExtendedAttributeDefinition طريقة. طريقة المصنع التي تنشئ تعريف سمة موسع مع البحث. لديهاCalculationType يساويLookup ويمكن استخدامها في الموارد فقط. أنت مطالب بالتحديدfieldId وalias عند استدعاء هذه الطريقة. يتم استنتاج نوع الحقل من معرف الحقل.
type: docs
weight: 10
