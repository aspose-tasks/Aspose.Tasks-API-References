...
description: "خاصية ExtendedAttributeDefinition. يحصل على Guid لجدول البحث المرتبط بحقل مخصص"
type: docs
weight: 180
...
يحصل على Guid لجدول البحث المرتبط بحقل مخصص.
...
لإنشاء حقل مخصص مع بحث، استخدم إحدى طرق المصنع: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) أو [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
