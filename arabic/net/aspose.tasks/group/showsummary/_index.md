...
description: "خاصية Group. تحصل أو تعين قيمة تشير إلى ما إذا كانت صفوف الملخص تُعرض للمجموعة"
type: docs
weight: 70
...
يحصل أو يضبط قيمة تشير إلى ما إذا كانت صفوف الملخص معروضة للمجموعة.
