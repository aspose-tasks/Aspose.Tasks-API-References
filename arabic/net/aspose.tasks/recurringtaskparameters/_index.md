...
| اسم | وصف |
| --- | --- |
| [RecurringTaskParameters](recurringtaskparameters)() | يقوم بتهيئة مثيل جديد لملف[`RecurringTaskParameters`](../recurringtaskparameters) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Duration](../../aspose.tasks/recurringtaskparameters/duration) { get; set; } | الحصول على أو تعيين المدة لتكرار واحد للمهمة المتكررة. مثيل[`Duration`](./duration) صف دراسي. |
