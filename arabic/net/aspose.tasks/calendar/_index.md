...
description: يمثل التقويم المستخدم في مشروع .
type: docs
weight: 220
...
| اسم | وصف |
| --- | --- |
| [BaseCalendar](../../aspose.tasks/calendar/basecalendar) { get; set; } | الحصول على أو تعيين التقويم الأساسي الذي يعتمد عليه هذا التقويم. ينطبق فقط إذا لم يكن التقويم تقويمًا أساسيًا. قراءة / كتابة[`Calendar`](../calendar) . |
...
| [IsBaseCalendar](../../aspose.tasks/calendar/isbasecalendar) { get; } | يحصل على قيمة تشير إلى ما إذا كان التقويم تقويمًا أساسيًا. للقراءة فقطBoolean . |
| [IsBaselineCalendar](../../aspose.tasks/calendar/isbaselinecalendar) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان التقويم تقويمًا أساسيًا. قراءة / كتابةBoolean . |
| [Name](../../aspose.tasks/calendar/name) { get; set; } | الحصول على أو تحديد اسم التقويم. قراءة / كتابةString . |
| [ParentProject](../../aspose.tasks/calendar/parentproject) { get; } | الحصول على المشروع الرئيسي لهذا التقويم . |
| [Uid](../../aspose.tasks/calendar/uid) { get; set; } | الحصول على أو تحديد المعرف الفريد للتقويم. قراءة / كتابةInt32 . |
...
| override [GetHashCode](../../aspose.tasks/calendar/gethashcode)() | إرجاع رمز تجزئة لمثيل[`Calendar`](../calendar) فئة . |
...
| [GetWorkingTimes](../../aspose.tasks/calendar/getworkingtimes)(DateTime) | عوائد[`WorkingTimeCollection`](../workingtimecollection) من أوقات العمل. |
