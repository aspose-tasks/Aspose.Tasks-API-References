...
description: "طريقة WorkWeekCollection. تضيف نسخة WorkWeek إلى كائن هذه المجموعة"
type: docs
weight: 40
...
يضيف نسخة WorkWeek إلى كائن المجموعة هذا.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | WorkWeek | العنصر المراد إضافته. |
