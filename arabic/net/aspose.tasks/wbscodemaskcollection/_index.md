---
title: "الفئة WBSCodeMaskCollection"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "الفئة Aspose.Tasks.WBSCodeMaskCollection. تمثل مجموعة من كائنات WBSCodeMask."
type: docs
weight: 3510
...
| الاسم | الوصف |
| --- | --- |
| [Count](../../aspose.tasks/wbscodemaskcollection/count/) { get; } | يحصل على عدد العناصر الموجودة في هذه المجموعة. |
| [IsReadOnly](../../aspose.tasks/wbscodemaskcollection/isreadonly/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه المجموعة للقراءة فقط؛ وإلا، false. |

## الطرق

| الاسم | الوصف |
| --- | --- |
| [Add](../../aspose.tasks/wbscodemaskcollection/add/)(WBSCodeMask) | يضيف العنصر المحدد إلى هذه المجموعة. |
| [Clear](../../aspose.tasks/wbscodemaskcollection/clear/)() | يزيل جميع العناصر من هذه المجموعة. |
| [Contains](../../aspose.tasks/wbscodemaskcollection/contains/)(WBSCodeMask) | يرجع true إذا تم العثور على العنصر المحدد في هذه المجموعة؛ وإلا، false. |
| [CopyTo](../../aspose.tasks/wbscodemaskcollection/copyto/)(WBSCodeMask[], int) | ينسخ عناصر هذه المجموعة إلى المصفوفة المحددة، بدءًا من الفهرس المحدد للمصفوفة. |
| [GetEnumerator](../../aspose.tasks/wbscodemaskcollection/getenumerator/)() | يرجع عدادًا لهذه المجموعة. |
| [Remove](../../aspose.tasks/wbscodemaskcollection/remove/)(WBSCodeMask) | يزيل الظهور الأول لكائن محدد من هذه المجموعة. |
| [ToList](../../aspose.tasks/wbscodemaskcollection/tolist/)() | تحويل **WBSCodeMaskCollection** إلى قائمة من كائنات [`WBSCodeMask`](../wbscodemask/). |

## الأمثلة

يوضح كيفية العمل مع مجموعة أقنعة رمز WBS.
...
// نسخ أقنعة الرموز إلى مشروع آخر
