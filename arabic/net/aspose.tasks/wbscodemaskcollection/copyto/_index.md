...
description: "طريقة WBSCodeMaskCollection. تنسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة"
type: docs
weight: 60
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | WBSCodeMask[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
