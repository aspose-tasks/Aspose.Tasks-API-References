...
description: "طريقة AvailabilityPeriodCollection. تنسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة"
type: docs
weight: 80
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | AvailabilityPeriod[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
