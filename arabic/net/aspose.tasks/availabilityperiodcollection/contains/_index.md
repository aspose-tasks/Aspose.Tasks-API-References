...
description: "طريقة AvailabilityPeriodCollection. تُعيد true إذا تم العثور على العنصر المحدد في هذه المجموعة وإلا false"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | AvailabilityPeriod | العنصر المحدد للبحث عنه. |
