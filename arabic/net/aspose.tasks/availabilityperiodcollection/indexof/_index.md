...
description: "طريقة AvailabilityPeriodCollection. تحدد فهرس العنصر المحدد في هذه المجموعة"
type: docs
weight: 100
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | AvailabilityPeriod | العنصر المحدد لتحديد موقعه في هذه المجموعة. |
