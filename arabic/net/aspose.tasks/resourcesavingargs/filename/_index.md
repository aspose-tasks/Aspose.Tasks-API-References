...
description: "خاصية ResourceSavingArgs. تحصل أو تعيّن اسم الملف المفترض الذي ينتقل من المحول إلى كود الطريقة المخصصة. يمكن استخدامه في الكود المخصص لتحديد كيفية معالجة الملف أو أين يتم حفظه"
type: docs
weight: 20
...
يحصل أو يعيّن اسم الملف المفترض الذي ينتقل من المحوّل إلى شفرة الطريقة المخصّصة. يمكن استخدامه في الشفرة المخصّصة لتحديد كيفية معالجة الملف أو أين يتم حفظه.
