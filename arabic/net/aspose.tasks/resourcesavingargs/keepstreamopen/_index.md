...
description: "خاصية ResourceSavingArgs. تحصل أو تعيّن قيمة تشير إلى ما إذا كان سيتم إبقاء التدفق مفتوحًا بعد انتهاء حفظ المورد"
type: docs
weight: 30
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان سيتم إبقاء الدفق مفتوحًا بعد انتهاء حفظ المورد.
