...
description: "خاصية Value. يحصل أو يضبط القيمة الفعلية التي تُستخدم لتمثيل قيمة رقم أو تكلفة"
type: docs
weight: 60
...
يحصل أو يعيّن القيمة الفعلية المستخدمة لتمثيل الرقم أو قيمة التكلفة.
...
يفضل استخدام هذه الخاصية بدلاً من [`Val`](../val/)، عندما تحتاج إلى تعيين قيمة الرقم أو التكلفة.
