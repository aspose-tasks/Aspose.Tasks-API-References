...
description: "خاصية Value. تحصل أو تعيّن القيمة الفعلية إذا كان يمكن تمثيلها كـ DateTime. القيمة الافتراضية هي MinValue"
type: docs
weight: 20
...
يحصل أو يعيّن القيمة الفعلية إذا كان يمكن تمثيلها كـ DateTime. القيمة الافتراضية هي MinValue.
...
يفضل استخدام هذه الخاصية بدلاً من [`Val`](../val/)، عندما تحتاج إلى تعيين قيمة DateTime.
