...
description: "خاصية Value. تحصل أو تعيّن القيمة الفعلية المستخدمة لتمثيل سلسلة النص"
type: docs
weight: 80
...
يحصل أو يعيّن القيمة الفعلية المستخدمة لتمثيل سلسلة النص.
...
يفضل استخدام هذه الخاصية بدلاً من [`Val`](../val/)، عندما تحتاج إلى تعيين قيمة النص.
