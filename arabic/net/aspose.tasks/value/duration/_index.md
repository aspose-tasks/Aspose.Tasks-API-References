...
description: "خاصية Value. يحصل أو يضبط القيمة الفعلية التي تُستخدم لتمثيل المدة"
type: docs
weight: 40
...
يحصل أو يعيّن القيمة الفعلية المستخدمة لتمثيل المدة.
...
يفضل استخدام هذه الخاصية بدلاً من [`Val`](../val/)، عندما تحتاج إلى تعيين قيمة المدة.
