...
description: "خاصية Value. تحصل أو تعيّن المعرف الفريد لقيمة عبر مشروع"
type: docs
weight: 50
...
يحصل أو يعيّن المعرف الفريد للقيمة عبر المشروع.

من المهم عدم وجود معرفات متطابقة لمثيلات [`Value`](../) المختلفة.

القيمة الدنيا للـ `Id` هي `1`.
