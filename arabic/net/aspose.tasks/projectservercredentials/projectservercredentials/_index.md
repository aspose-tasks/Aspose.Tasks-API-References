...
description: يقوم بتهيئة مثيل جديد لملفProjectServerCredentialsaspose.tasks/projectservercredentials فئة باستخدام URL لموقع SharePoint ورمز ترخيص SPOIDCRL صالح لموقع PWA Project Web Access الخاص بـ SharePoint.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`ProjectServerCredentials`](../../projectservercredentials) فئة باستخدام URL لموقع SharePoint ورمز ترخيص SPOIDCRL صالح لموقع PWA (Project Web Access) الخاص بـ SharePoint.
...
يقوم بتهيئة مثيل جديد لملف[`ProjectServerCredentials`](../../projectservercredentials) فئة باستخدام URL لموقع SharePoint واسم المستخدم وكلمة المرور.
...
يقوم بتهيئة مثيل جديد لملف[`ProjectServerCredentials`](../../projectservercredentials) فئة باستخدام URL لنقطة نهاية Project Web Access وبيانات اعتماد الشبكة.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| siteUrl | String | عنوان URL لنقطة نهاية الوصول إلى الويب الخاص بالمشروع. |
