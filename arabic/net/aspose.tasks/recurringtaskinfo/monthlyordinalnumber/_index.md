...
description: "خاصية RecurringTaskInfo. يحصل أو يضبط رقم ترتيبي لنمط التكرار الشهري. يمكن أن يكون أحد قيم تعداد OrdinalNumber enumeration"
type: docs
weight: 70
...
يحصل أو يضبط رقم ترتيبي لنمط التكرار الشهري. يمكن أن يكون أحد قيم تعداد [`OrdinalNumber`](../../ordinalnumber/) enumeration.
