...
description: "خاصية RecurringTaskInfo. تحصل أو تعين نمط تكرار للمهمة المتكررة. يمكن أن يكون أحد قيم تعداد RecurrencePattern"
type: docs
weight: 120
...
تحصل أو تعين نمط تكرار للمهمة المتكررة. يمكن أن يكون أحد قيم تعداد `RecurrencePattern`.
