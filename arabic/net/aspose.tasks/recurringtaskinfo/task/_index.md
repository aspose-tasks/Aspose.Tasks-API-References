...
description: "خاصية RecurringTaskInfo. تحصل على المهمة الأصلية لهذه النسخة من فئة RecurringTaskInfo"
type: docs
weight: 140
...
تحصل على المهمة الأصلية لهذه النسخة من الفئة [`RecurringTaskInfo`](../).
