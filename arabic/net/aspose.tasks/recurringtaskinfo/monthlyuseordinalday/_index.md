...
description: "خاصية RecurringTaskInfo. تحصل أو تعين قيمة تشير إلى ما إذا كان سيتم استخدام اليوم الترتيبي لنمط التكرار الشهري"
type: docs
weight: 100
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب استخدام اليوم الترتيبي لنمط التكرار الشهري.
