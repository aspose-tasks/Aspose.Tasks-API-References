...
description: "خاصية RecurringTaskInfo. يحصل أو يضبط شهر نمط التكرار السنوي عند استخدام اليوم الترتيبي. يمكن أن يكون أحد قيم تعداد Month"
type: docs
weight: 200
...
يحصل أو يضبط شهر نمط التكرار السنوي عند استخدام اليوم الترتيبي. يمكن أن يكون أحد قيم تعداد [`Month`](../../month/) enumeration.
