...
description: "خاصية RecurringTaskInfo. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب استخدام تاريخ الانتهاء أو عدد مرات حدوث المهمة المتكررة"
type: docs
weight: 150
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب استخدام تاريخ الانتهاء أو عدد مرات التكرار للمهمة المتكررة.
