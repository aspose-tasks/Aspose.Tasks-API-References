...
description: "خاصية RecurringTaskInfo. تحصل أو تعين يوماً في نمط التكرار الشهري عند استخدام اليوم الترتيبي. يمكن أن يكون أحد قيم تعداد DayOfWeek"
type: docs
weight: 60
...
يحصل أو يعيّن يوماً لنمط التكرار الشهري عند استخدام اليوم الترتيبي. يمكن أن يكون أحد قيم تعداد DayOfWeek enumeration.
