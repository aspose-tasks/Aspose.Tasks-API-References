...
description: "خاصية RecurringTaskInfo. تحصل أو تعين المدة لتكرار واحد من المهمة المتكررة. نسخة من فئة Duration"
type: docs
weight: 30
...
تحصل أو تعين المدة لتكرار واحد من المهمة المتكررة. نسخة من الفئة `Duration`.
