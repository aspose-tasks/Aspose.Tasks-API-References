...
description: "OutlineCodeDefinitionCollection طريقة. يحدد فهرس العنصر المحدد في هذه المجموعة"
type: docs
weight: 90
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | OutlineCodeDefinition | العنصر المحدد لتحديد موقعه في هذه المجموعة. |
