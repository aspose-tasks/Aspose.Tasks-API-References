...
description: "طريقة OutlineCodeDefinitionCollection. تُضيف العنصر المحدد إلى هذه المجموعة."
type: docs
weight: 40
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | OutlineCodeDefinition | العنصر المحدد لإضافته إلى هذه المجموعة. |
