...
description: "OutlineCodeDefinitionCollection طريقة. ينسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | OutlineCodeDefinition[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
