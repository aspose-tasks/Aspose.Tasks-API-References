...
description: "Aspose.Tasks.FontSavingArgs class. تمثّل هذه الفئة مجموعة من البيانات المتعلقة بحفظ ملفات الخطوط الخارجية التي تحدث أثناء التحويل إلى صيغة HTML."
type: docs
weight: 680
...
هذه الفئة تمثل مجموعة من البيانات المتعلقة بحفظ ملفات الخطوط الخارجية التي تحدث أثناء التحويل إلى تنسيق HTML.
...
| الاسم | الوصف |
| --- | --- |
| [FontSavingArgs](fontsavingargs/)() | المنشئ الافتراضي. |
...
يعرض كيفية العمل مع معطيات حفظ الخط.
