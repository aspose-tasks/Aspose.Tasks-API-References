...
description: "خاصية AssignmentBaseline. يحصل أو يحدد تاريخ البدء المجدول لتعيين المورد عندما تم حفظ الخط الأساسي. تاريخ بدء تعيين المورد عندما تم حفظ هذا الخط الأساسي"
type: docs
weight: 30
...
يحصل أو يعيّن تاريخ البدء المجدول لتعيين المورد عندما تم حفظ الخط الأساسي. تاريخ البدء لتعيين المورد عندما تم حفظ هذا الخط الأساسي.
