...
description: "خاصية TimelineView. يحصل على أو يضبط قيمة تُشير إلى عدد الأسطر المستخدمة لعرض المهمة في المخطط الزمني"
type: docs
weight: 80
...
يحصل أو يضبط قيمة تشير إلى عدد الخطوط المستخدمة لعرض المهمة في المخطط الزمني.
