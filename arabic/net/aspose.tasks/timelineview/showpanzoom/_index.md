...
description: "خاصية TimelineView. تحصل أو تعيين قيمة تشير إلى ما إذا كان سيتم إظهار التحكم في التحريك والتكبير"
type: docs
weight: 50
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان سيتم إظهار التحكم في التحريك والتكبير.
