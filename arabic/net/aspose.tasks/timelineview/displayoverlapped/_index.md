...
description: "خاصية TimelineView. يحصل على أو يضبط قيمة تُشير إلى ما إذا كان يجب عرض المهام المتداخلة على عدة صفوف"
type: docs
weight: 30
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان سيتم عرض المهام المتداخلة على عدة صفوف.
