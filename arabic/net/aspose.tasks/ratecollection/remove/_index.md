...
description: "طريقة RateCollection. يزيل كائن Rate من هذه المجموعة"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | Rate | العنصر المراد إزالته. |

### قيمة الإرجاع

صحيح إذا تم إزالة Rate المحدد بنجاح؛ وإلا، خطأ.
