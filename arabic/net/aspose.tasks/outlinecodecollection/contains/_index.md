...
description: "طريقة OutlineCodeCollection. تُرجع true إذا تم العثور على العنصر المحدد في هذه المجموعة وإلا false"
type: docs
weight: 60
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | OutlineCode | العنصر المحدد للبحث عنه. |
