...
description: يمثل مجموعة منOutlineCode./outlinecode الكائنات .
type: docs
weight: 1020
...
| [CopyTo](../../aspose.tasks/outlinecodecollection/copyto)(OutlineCode[], int) | ينسخ عناصر هذه المجموعة إلى المصفوفة المحددة ، بدءًا من فهرس المصفوفة المحدد. |
