...
description: "طريقة Baseline. تُرجع قيمة تشير إلى ما إذا كانت هذه المثيلة مساوية لكائن محدد"
type: docs
weight: 80
url: /ar/net/aspose.tasks/baseline/equals/
---
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| obj | كائن | الكائن المحدد للمقارنة مع هذه الحالة. |

### قيمة الإرجاع

يرجع true إذا كانت هذه الحالة مساوية للكائن المحدد؛ وإلا، false.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| آخر | Baseline | الكائن المحدد للمقارنة مع هذه الحالة. |
