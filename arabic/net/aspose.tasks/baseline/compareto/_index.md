...
description: "طريقة Baseline. تنفيذ واجهة IComparable. يقارن هذه المثيلة بالكائن Baseline المحدد"
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| آخر | Baseline | الكيان Baseline المحدد للمقارنة مع هذه الحالة. |
