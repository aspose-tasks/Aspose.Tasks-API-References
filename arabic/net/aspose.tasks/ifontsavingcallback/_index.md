...
description: "واجهة Aspose.Tasks.IFontSavingCallback. تمثل رد نداء يتم استدعاؤه لإنشاء مورد لتخزين الخطوط"
type: docs
weight: 860
...
يمثل رد نداء يتم استدعاؤه لإنشاء مورد لتخزين الخطوط.
...
يوضح كيفية العمل مع ردود نداء حفظ الخطوط.
