...
| [CssSavingArgs](./csssavingargs) | تمثل هذه الفئة مجموعة من البيانات المتعلقة بحفظ ملف CSS الخارجي الذي يحدث أثناء التحويل إلى تنسيق HTML . |
...
| [ExtendedAttribute](./extendedattribute) | يمثل السمات الموسعة . |
...
| [ExtendedAttributeDefinition](./extendedattributedefinition) | يمثل تعريف السمة الممتد المقترن بالمشروع . |
...
| [FontResolveEventArgs](./fontresolveeventargs) | يوفر وسيطات لرد الاتصال التي يتم استدعاؤها عند حل الخط. |
...
| [OleObject](./oleobject) | يمثل كائن OLE يمكن إدراجه في عرض مخطط جانت لملف MPP. |
...
| [PrimaveraXerReader](./primaveraxerreader) | يمثل قارئًا لقراءة معرفات تعريف المشروع من ملف Primavera XER |
| [PrimaveraXmlReader](./primaveraxmlreader) | يمثل قارئًا يسمح باسترداد معرّفات UID الخاصة بالمشروع من ملف Primavera Xml. |
| [PrimaveraXmlReadingOptions](./primaveraxmlreadingoptions) | يسمح بتحديد خيارات إضافية عند قراءة ملفات Primavera Xml. |
| [Prj](./prj) | يمثل الخصائص المدعومة لـ[`Project`](../aspose.tasks/project) الكائن . |
| [Project](./project) | يمثل مشروعًا . |
| [ProjectDisplayOptions](./projectdisplayoptions) | يمثل خيارات العرض لمثيل المشروع. |
...
| [ProjectInfo](./projectinfo) | معلومات موجزة عن المشروع المنشور المتوفرة على Project Online . |
...
| [ProjectServerManager](./projectservermanager) | الفئة التي توفر طرق قراءة وتنفيذ العمليات على المشاريع في حساب Project Online المحدد أو في مثيل Project Server المحلي المحدد (يتم دعم إصدارات Project Server 2016 و 2019) . |
...
| [RateByDateCollection](./ratebydatecollection) | يمثل المجموعة التي تعييناتDateTime إلى[`Rate`](../aspose.tasks/rate) الكائنات . |
...
| [TaskCollection](./taskcollection) | يمثل مجموعة من[`Task`](../aspose.tasks/task) الكائنات . |
...
| [ViewCollection](./viewcollection) | يحتوي على قائمة[`View`](../aspose.tasks/view) objects. تطبيقات ICollection &lt;View&gt; interface. |
...
| [WeeklyRecurrencePattern](./weeklyrecurrencepattern) | يمثل مجموعة المعلمات المستخدمة لإنشاء مهمة متكررة أسبوعية في مشروع. |
...
| [WorkingTimeCollection](./workingtimecollection) | يمثل مجموعة من[`WorkingTimeCollection`](../aspose.tasks/workingtimecollection) الكائنات . |
...
| [ElementType](./elementtype) | يحدد نوع العنصر. |
| [ExtendedAttributeResource](./extendedattributeresource) | تحديد السمات الموسعة FieldId المستخدمة في مورد . |
| [ExtendedAttributeTask](./extendedattributetask) | يحدد السمات الموسعة FieldId المستخدمة في مهمة. |
| [Field](./field) | يحدد حقلاً في Microsoft Office Project . |
| [FileFormat](./fileformat) | يحدد تنسيق ملف المشروع. |
| [FilterComparisonType](./filtercomparisontype) | نوع المقارنة الذي تم إجراؤه بين FieldName والقيمة التي تعمل كمعايير اختيار لعامل التصفية. |
| [FilterOperation](./filteroperation) | يحدد كيفية ارتباط المعيار الذي تم إنشاؤه باستخدام FieldName و FilterComparisonType والقيمة بمعايير أخرى في عامل التصفية. |
...
| [TimephasedDataType](./timephaseddatatype) | يحدد نوع البيانات الزمنية على مراحل. |
...
| [ViewScreen](./viewscreen) | يحدد نوع الشاشة للمشاهدة . |
| [WBSSequence](./wbssequence) | يحدد تسلسل WBSCodeMask |
