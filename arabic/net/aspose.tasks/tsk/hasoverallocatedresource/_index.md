...
description: "حقل Tsk. يشير إلى ما إذا كانت المهمة لديها مورد معين لديه عمل أكثر على المهام المخصصة مما يمكن إكماله ضمن القدرة العمل العادية"
type: docs
weight: 470
...
يحدد ما إذا كانت المهمة لديها مورد مُعيّن لديه عمل أكثر على المهام المُعيّنة مما يمكن إنجازه ضمن القدرة العمل العادية.
...
يوضح كيفية قراءة Tsk.IsOverallocated, Tsk.HasOverallocatedResource،

```csharp
// خصائص Rsc.Overallocated و Asn.Overallocated.
