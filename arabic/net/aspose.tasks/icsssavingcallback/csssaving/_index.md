...
description: "طريقة ICssSavingCallback. الطريقة التي سيتم استدعاؤها أثناء حفظ CSS"
type: docs
weight: 10
...
الطريقة التي يتم استدعاؤها أثناء حفظ CSS.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| args | CssSavingArgs | معلمات حفظ CSS. |
