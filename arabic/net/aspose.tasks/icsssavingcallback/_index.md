...
description: "واجهة Aspose.Tasks.ICssSavingCallback. تمثل رد نداء يتم استدعاؤه لإنشاء مورد لتخزين CSS"
type: docs
weight: 850
...
يمثل رد نداء يتم استدعاؤه لإنشاء مورد لتخزين CSS.
...
| الاسم | الوصف |
| --- | --- |
| [CssSaving](../../aspose.tasks/icsssavingcallback/csssaving/)(CssSavingArgs) | الطريقة التي يتم استدعاؤها أثناء حفظ CSS. |
