...
description: "طريقة IImageSavingCallback. الطريقة التي يتم استدعاؤها أثناء حفظ الصور"
type: docs
weight: 10
...
الطريقة التي يتم استدعاؤها أثناء حفظ الصور.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| args | ImageSavingArgs | معلمات حفظ الصورة. |
