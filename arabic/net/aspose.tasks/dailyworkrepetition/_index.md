...
description: يمثل فئة للتكرار في نمط التكرار اليومي بناءً على أيام العمل.
type: docs
weight: 410
...
| اسم | وصف |
| --- | --- |
| [DailyWorkRepetition](dailyworkrepetition)() | يقوم بتهيئة مثيل جديد لملف[`DailyWorkRepetition`](../dailyworkrepetition) فئة . |
