...
description: "خاصية Table. تحصل أو تعيّن قيمة تشير إلى ما إذا كان المشروع يعرض اسم الجدول في قائمة الجداول المنسدلة في تبويب العرض على الشريط."
type: docs
weight: 80
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان المشروع يعرض اسم الجدول في القائمة المنسدلة Tables في تبويب View على الشريط.
