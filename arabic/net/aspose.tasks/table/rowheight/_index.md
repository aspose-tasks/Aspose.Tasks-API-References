...
description: "خاصية Table. تحصل أو تعين ارتفاع الصف في جدول حيث يكون ارتفاع الصف عدد أسطر النص"
type: docs
weight: 60
...
يحصل أو يعيّن ارتفاع الصف في جدول، حيث يكون ارتفاع الصف هو عدد أسطر النص.
