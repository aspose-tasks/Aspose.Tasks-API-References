...
description: "خاصية Table. تحصل أو تعين قيمة تشير إلى ما إذا كان العمود الأول في الجدول مقفلاً أو قابلاً للتحرير"
type: docs
weight: 40
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان العمود الأول في الجدول مقفلاً أو قابلاً للتحرير.
