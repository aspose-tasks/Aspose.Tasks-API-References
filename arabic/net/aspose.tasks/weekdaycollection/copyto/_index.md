...
description: "طريقة WeekDayCollection. تنسخ محتوى التجميع إلى مصفوفة في الفهرس المحدد"
type: docs
weight: 60
...
ينسخ محتوى المجموعة إلى مصفوفة في الفهرس المحدد.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| array | WeekDay[] | مصفوفة الوجهة من [`WeekDay`](../../weekday/) للنسخ إليها |
| arrayIndex | Int32 | الفهرس الابتدائي لعملية النسخ. |
