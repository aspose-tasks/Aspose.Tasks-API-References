...
description: "طريقة WeekDayCollection. تُزيل WeekDay المحدد إذا كان موجودًا"
type: docs
weight: 100
url: /ar/net/aspose.tasks/weekdaycollection/remove/
---
## WeekDayCollection.Remove method

تُزيل [`WeekDay`](../../weekday/) المحدد، إذا كان موجودًا.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | WeekDay | العنصر المراد إزالته. |

### قيمة الإرجاع

صحيح إذا تم إزالة [`WeekDay`](../../weekday/)، خطأ إذا لم يُعثر على هذا العنصر.
