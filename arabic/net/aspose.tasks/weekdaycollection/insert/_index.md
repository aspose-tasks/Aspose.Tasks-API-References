...
description: "طريقة WeekDayCollection. تُدرج WeekDay في الفهرس المحدد"
type: docs
weight: 90
...
تُدرج [`WeekDay`](../../weekday/) في الفهرس المحدد.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| الفهرس | Int32 | الفهرس للإدراج فيه. |
| العنصر | WeekDay | العنصر الذي سيتم إدراجه. |
