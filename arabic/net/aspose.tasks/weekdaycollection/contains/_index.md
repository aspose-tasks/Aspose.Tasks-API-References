...
description: "طريقة WeekDayCollection. تتحقق مما إذا كانت المجموعة تحتوي على الـ WeekDay المحدد"
type: docs
weight: 50
...
تتحقق مما إذا كانت المجموعة تحتوي على الـ [`WeekDay`](../../weekday/) المحدد.
...
صحيح إذا كانت المجموعة تحتوي على العنصر المحدد، وإلا خطأ.
