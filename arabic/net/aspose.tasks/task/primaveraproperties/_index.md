...
description: "خاصية Task. الحصول على كائن يحتوي على خصائص خاصة بـ Primavera لمهمة تم قراءتها من ملف Primavera"
type: docs
weight: 1010
...
يحصل على كائن يحتوي على خصائص خاصة بـ Primavera لمهمة تم قراءتها من ملف Primavera.
...
يوضح كيفية قراءة مشروع من ملف Primavera XML وفحص الخصائص الخاصة بـ Primavera للمهام.
