...
description: "خاصية Task. يحصل أو يضبط المعرف الفريد للمهام الخارجية عندما تكون المهمة خارجية"
type: docs
weight: 430
url: /ar/net/aspose.tasks/task/externaluid/
---
## Task.ExternalUid property

يحصل أو يعيّن المعرف الفريد للمهمة الخارجية عندما تكون المهمة خارجية.
