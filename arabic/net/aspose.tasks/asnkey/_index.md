...
description: Aspose.Tasks.AsnKey تعداد. يمثل قائمة بحقول المهمة المدعومة.
type: docs
weight: 40
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Guid | `0` | يمثل حقل الدليل (ResourceAssignment). |
...
| RegularWork | `35` | يمثل حقل العمل العادي (ResourceAssignment). |
...
| AssignmentOwner | `58` | يمثل الحقل "مالك التعيين" (ResourceAssignment). |
