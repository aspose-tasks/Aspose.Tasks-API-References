...
description: "خاصية المشروع. الحصول على جميع تعريفات المجموعات القائمة على الموارد. ResourceGroups هي مجموعة من كائنات Group"
type: docs
weight: 770
...
الحصول على جميع تعريفات المجموعات القائمة على الموارد. ResourceGroups هي مجموعة من [`Group`](../../group/) كائنات.
...
يعرض كيفية قراءة مجموعات الموارد.
