...
description: "طريقة Project. تعيد حساب Id البداية والنهاية للموارد"
type: docs
weight: 1160
...
يعيد حساب المعرف، بدء وانتهاء الموارد.
...
يوضح كيفية إعادة حساب حقول الموارد الشائعة.
...
// يعيد حساب Id، البداية والنهاية للموارد
