...
description: "خاصية WeekDay. تحصل على WorkingTimeCollection لهذا المثيل من WeekDay. مجموعة أوقات العمل التي تحدد الوقت الذي تم العمل فيه في يوم الأسبوع"
type: docs
weight: 70
...
يحصل على WorkingTimeCollection لهذا المثيل WeekDay. مجموعة أوقات العمل التي تحدد الوقت العامل في يوم الأسبوع.
