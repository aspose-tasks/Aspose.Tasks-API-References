...
description: يقوم بتهيئة مثيل جديد لملفWorkingTimeaspose.tasks/workingtime فئة مع فاصل زمني مع أوقات البدء والانتهاء المحددة .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`WorkingTime`](../../workingtime) فئة مع فاصل زمني مع أوقات البدء والانتهاء المحددة .
...
يقوم بتهيئة مثيل جديد لملف[`WorkingTime`](../../workingtime) فئة مع عنصر فاصل زمني مع أوقات البدء والانتهاء المحددة.
