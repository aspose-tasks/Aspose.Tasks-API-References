...
description: "طريقة ExtendedAttributeDefinitionCollection. تُرجِع true إذا تم العثور على العنصر المحدد في هذه المجموعة وإلا تُرجِع false."
type: docs
weight: 70
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttributeDefinition | العنصر المحدد للبحث عنه. |
