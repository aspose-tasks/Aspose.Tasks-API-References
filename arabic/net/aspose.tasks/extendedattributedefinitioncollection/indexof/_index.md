...
description: "طريقة ExtendedAttributeDefinitionCollection. تحدد فهرس العنصر المحدد في هذه المجموعة."
type: docs
weight: 110
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttributeDefinition | العنصر المحدد لتحديد موقعه في هذه المجموعة. |

### قيمة الإرجاع

فهرس العنصر المحدد إذا وُجد؛ وإلا، -1.
