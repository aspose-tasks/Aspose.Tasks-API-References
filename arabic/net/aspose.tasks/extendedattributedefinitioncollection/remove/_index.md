...
description: "طريقة ExtendedAttributeDefinitionCollection. يزيل أول تكرار لكائن محدد من هذه المجموعة"
type: docs
weight: 130
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttributeDefinition | الكائن المحدد لإزالته. |
