...
description: "خاصية ExtendedAttributeDefinitionCollection. تحصل على مشروع أب لِمثيل ExtendedAttributeDefinitionCollection. تُرجع مشروعًا أبًا لهذه المجموعة"
type: docs
weight: 40
...
يحصل على مشروع أب لِمثيل [`ExtendedAttributeDefinitionCollection`](../). تُرجع مشروعًا أبًا لهذه المجموعة.
