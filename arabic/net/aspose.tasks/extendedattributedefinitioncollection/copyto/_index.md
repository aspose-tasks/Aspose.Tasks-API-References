...
description: "طريقة ExtendedAttributeDefinitionCollection. ينسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد للمصفوفة"
type: docs
weight: 80
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | ExtendedAttributeDefinition[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
