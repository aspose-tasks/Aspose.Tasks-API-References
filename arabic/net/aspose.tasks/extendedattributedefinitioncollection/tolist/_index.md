...
description: "طريقة ExtendedAttributeDefinitionCollection. تُحوِّل كائن ExtendedAttributeDefinitionCollection هذا إلى قائمة تحتوي على مثيلات من فئة ExtendedAttributeDefinition"
type: docs
weight: 150
...
يحوِّل كائن ExtendedAttributeDefinitionCollection هذا إلى قائمة تحتوي على مثيلات من الفئة [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
...
قائمة تحتوي على مثيلات من الفئة [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
