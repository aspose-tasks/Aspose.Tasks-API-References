...
description: "طريقة ExtendedAttributeDefinitionCollection. يضيف العنصر المحدد إلى هذه المجموعة"
type: docs
weight: 50
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | ExtendedAttributeDefinition | العنصر المحدد لإضافته إلى هذه المجموعة. |
