...
description: "خاصية TimephasedData. تحصل على كائن Double الذي يمثل القيمة النصية لهذا الكائن لبيانات زمنية مرحلية تعتمد على الوحدات"
type: docs
weight: 130
...
يحصل على مثيل Double الذي يمثل القيمة النصية لهذا الكائن للبيانات الزمنية المرحلية المستندة إلى الوحدة.
