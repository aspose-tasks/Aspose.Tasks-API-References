...
description: "خاصية TimephasedData. تُعيد كائن Double يمثل القيمة النصية لهذا الكائن"
type: docs
weight: 110
...
يحصل على مثيل Double الذي يمثل القيمة النصية لهذا الكائن.
