...
description: "خاصية TimephasedData. تحصل أو تعيّن القيمة لكل وحدة زمنية لفترة بيانات زمنية مرحلية"
type: docs
weight: 100
...
يحصل أو يحدد القيمة لكل وحدة زمنية لفترة البيانات الزمنية المرحلية.
...
| استثناء | شرط |
| --- | --- |
| [TasksException](../../tasksexception/) | عندما تكون القيمة غير صحيحة للنوع المحدد [`TimephasedDataType`](../timephaseddatatype/) أو تكون القيمة سالبة. |
