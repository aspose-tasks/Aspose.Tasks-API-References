...
description: "خاصية TimephasedData. تحصل أو تعين وحدة الوقت لفترة البيانات ذات الطور الزمني"
type: docs
weight: 90
url: /ar/net/aspose.tasks/timephaseddata/unit/
---
## TimephasedData.Unit property

يحصل أو يحدد وحدة الوقت لفترة البيانات الزمنية المرحلية.
