...
description: "طريقة TimephasedData. تنشئ وتُهيئ نسخة جديدة من فئة TimephasedData لبيانات زمنية مرحلة بالوحدات لتعيين مورد مادي"
type: docs
weight: 30
...
تنشئ وتُهيئ نسخة جديدة من فئة [`TimephasedData`](../) لبيانات زمنية مرحلة مبنية على الوحدات لتعيين مورد مادي.
...
| استثناء | شرط |
| --- | --- |
| ArgumentException | إذا تم تحديد كمية سلبية من الوحدات. |
