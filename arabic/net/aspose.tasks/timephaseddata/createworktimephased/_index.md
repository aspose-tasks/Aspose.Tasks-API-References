...
description: "طريقة TimephasedData. تنشئ وتُهيئ نسخة جديدة من فئة TimephasedData للبيانات ذات الطور الزمني القائم على العمل."
type: docs
weight: 40
...
تنشئ وتُهيئ نسخة جديدة من فئة [`TimephasedData`](../) للبيانات ذات الطور الزمني القائم على العمل.
...
| value | TimeSpan | قيمة الفترة الزمنية. |
| timeUnit | TimeUnitType | نوع وحدة الوقت. |
| نوع | TimephasedDataType | نوع البيانات ذات الطور الزمني. |

### قيمة الإرجاع

نسخة من فئة [`TimephasedData`](../) للبيانات ذات الطور الزمني القائم على العمل.

### استثناءات

| استثناء | شرط |
| --- | --- |
| ArgumentException | إذا تم تحديد قيمة عمل سلبية. |
