...
description: "خاصية View. تُعيد أو تُعيّن قيمة تُشير إلى ما إذا كان Microsoft Project يعرض اسم العرض الفردي في View أو القوائم المنسدلة لــOther Views في الشريط"
type: docs
weight: 90
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان Microsoft Project يعرض اسم العرض الواحد في قائمة العرض أو قوائم العروض الأخرى المنسدلة في الشريط.
