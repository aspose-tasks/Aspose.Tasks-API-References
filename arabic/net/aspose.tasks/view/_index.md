...
description: Aspose.Tasks.View فصل. يمثل طريقة عرض في المشروع .
type: docs
weight: 2560
...
| اسم | وصف |
| --- | --- |
| [View](view/#constructor)() | يقوم بتهيئة مثيل جديد لملف`View` فئة . |
| [View](view/#constructor_1)(ViewScreen) | يقوم بتهيئة مثيل جديد لملف`View` فئة . |
...
| [PageInfo](../../aspose.tasks/view/pageinfo/) { get; } | يحصل على مثيل لملف[`PageInfo`](./pageinfo/)فصل. يمثل بيانات إعداد الصفحة الموجودة بتنسيق ملف mpp. |
