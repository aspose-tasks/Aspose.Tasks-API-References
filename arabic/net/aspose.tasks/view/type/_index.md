...
description: "خاصية View. تحصل على نوع العنصر في العرض الفردي مثل المهام أو الموارد. قراءة فقط ItemType"
type: docs
weight: 110
...
تحصل على نوع العنصر في العرض الفردي، مثل المهام أو الموارد. قراءة فقط [`ItemType`](../../itemtype/).
