...
description: "خاصية View. تُجلب مثيلة من فئة PageInfo. تمثل بيانات إعداد الصفحة الموجودة في تنسيق ملف mpp."
type: docs
weight: 60
...
تُجلب مثيلة من الفئة `PageInfo`. تمثل بيانات إعداد الصفحة الموجودة في تنسيق ملف mpp.
