...
description: "خاصية OleObject. تحصل على قيمة تشير إلى ما إذا كان ملف المشروع يحتوي فقط على رابط للبيانات الفعلية المخزنة في مصدر الرابط"
type: docs
weight: 90
...
يحصل على قيمة تشير إلى ما إذا كان ملف المشروع يحتوي فقط على رابط للبيانات الفعلية المخزنة في مصدر الرابط.
