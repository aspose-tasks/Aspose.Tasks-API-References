...
description: "خاصية OleObject. تحصل أو تعين بيانات الملفات المضمنة (null إذا لم يتم تضمين أي بيانات)"
type: docs
weight: 30
...
يحصل أو يضبط بيانات الملف المضمّن؛ null إذا لم يتم تضمين أي بيانات.
