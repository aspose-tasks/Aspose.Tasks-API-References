...
description: "خاصية OleObject. تحصل أو تعين علامة تشير إلى أن كائن OLE يجب أن يُعرض إما كأيقونة أو كصورته العادية"
type: docs
weight: 40
...
يحصل أو يضبط علامة تشير إلى أن كائن OLE يجب أن يُعرض إما كأيقونة أو كصورة عادية.
