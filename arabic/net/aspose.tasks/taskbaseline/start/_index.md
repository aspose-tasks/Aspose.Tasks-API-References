...
description: "خاصية TaskBaseline. يحصل أو يضبط تاريخ البدء المجدول للمهمة عندما تم حفظ الخط الأساسي"
type: docs
weight: 70
...
يحصل أو يعيّن تاريخ البدء المجدول للمهمة عندما تم حفظ الخط الأساسي.
