...
description: "خاصية OutlineCodeDefinition. يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب أن تحتوي الرموز الجديدة على جميع المستويات. غير متاح لرموز المؤسسة"
type: docs
weight: 30
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب أن تحتوي الرموز الجديدة على جميع المستويات. غير متوفر لرموز المؤسسة.
