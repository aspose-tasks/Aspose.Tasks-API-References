...
description: "خاصية OutlineCodeDefinition. تحصل على كائن OutlineMaskCollection. جدول الإدخالات التي تحدد قناع رمز المخطط. نسخة OutlineMaskCollection للقراءة فقط"
type: docs
weight: 100
...
تحصل على كائن OutlineMaskCollection. جدول الإدخالات التي تحدد قناع رمز المخطط. نسخة للقراءة فقط [`OutlineMaskCollection`](../../outlinemaskcollection/)
