...
description: "خاصية OutlineCodeDefinition. يحصل أو يعيّن إشارة إلى حقل مخصص آخر يكون تعريف رمز المخطط هذا اسمًا مستعارًا له"
type: docs
weight: 50
...
يحصل أو يعيّن إشارة إلى حقل مخصص آخر يكون هذا التعريف لرمز المخطط هو الاسم المستعار له.
