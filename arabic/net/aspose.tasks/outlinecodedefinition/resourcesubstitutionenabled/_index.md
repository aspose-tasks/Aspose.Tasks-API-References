...
description: "خاصية OutlineCodeDefinition. تحصل أو تعيين قيمة تشير إلى ما إذا كان يمكن استخدام رمز المخطط المخصص بواسطة معالج استبدال الموارد في Microsoft Project"
type: docs
weight: 130
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يمكن استخدام رمز المخطط المخصص بواسطة معالج استبدال الموارد في Microsoft Project.
