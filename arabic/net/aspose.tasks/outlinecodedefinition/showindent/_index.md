...
description: "خاصية OutlineCodeDefinition. يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إظهار مسافات البادئة لهذا رمز المخطط"
type: docs
weight: 140
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إظهار المسافات البادئة لهذا رمز المخطط.
