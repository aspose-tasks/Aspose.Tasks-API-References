...
description: "خاصية OutlineCodeDefinition. تحصل أو تعيين قيمة تشير إلى ما إذا كان يجب أن تكون القيم المحددة في حقل رمز المخطط هذا قيمًا نهائية"
type: docs
weight: 90
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب أن تكون القيم المحددة في حقل رمز المخطط هذا قيمًا نهائية.
