...
description: "طريقة ResourceAssignmentCollection. تُرجع تعيينًا بالمعرف الفريد المحدد"
type: docs
weight: 60
...
يرجع تعيينًا بالمعرف الفريد المحدد.
...
ResourceAssignment بالمعرف الفريد المحدد إذا كان موجودًا؛ وإلا، null.
