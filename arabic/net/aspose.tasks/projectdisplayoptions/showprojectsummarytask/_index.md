...
description: "خاصية ProjectDisplayOptions. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب عرض معلومات ملخص حول مشروع كامل في صف واحد مع شريط مهمة ملخص خاصة به في أعلى عرض Gantt Chart"
type: docs
weight: 70
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب عرض معلومات ملخص حول مشروع كامل في صف واحد مع شريط مهمة الملخص الخاص به في أعلى عرض مخطط جانت.
