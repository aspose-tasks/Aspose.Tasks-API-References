...
description: "خاصية ProjectDisplayOptions. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب إظهار الاقتراحات عندما يحدد Project تعارضًا محتملًا في الجدولة مع مهمة مجدولة يدويًا. هذا الخيار متاح لإصدار Project 2010 وما بعده"
type: docs
weight: 80
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إظهار الاقتراحات عندما يحدد Project تعارضًا محتملًا في الجدولة مع مهمة مجدولة يدويًا. هذا الخيار متاح لإصدار Project 2010 وما بعده.
