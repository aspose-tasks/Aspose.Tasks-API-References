...
description: "خاصية ProjectDisplayOptions. يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب إضافة مسافة قبل قيمة الرقم والاختصار الزمني 1 wk بالمقابل 1wk"
type: docs
weight: 20
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب إضافة مسافة قبل القيمة الرقمية واختصار الوقت (1 wk مقابل 1wk).
