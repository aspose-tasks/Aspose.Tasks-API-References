...
description: "خاصية ExtendedAttribute. يحصل أو يضبط قيمة للسمات ذات النوع Duration"
type: docs
weight: 30
...
يحصل أو يعيّن قيمة للسمات ذات النوع 'Duration'.
...
| استثناء | شرط |
| --- | --- |
| InvalidOperationException | يتم إلقاء الاستثناء إذا لم يتم تهيئة خاصية [`AttributeDefinition`](../attributedefinition/) أو إذا كان نوع الحقل المخصص لخاصية [`AttributeDefinition`](../attributedefinition/) ليس مثيلاً من [`Duration`](../../duration/). |
