...
description: "طريقة TimephasedDataCollection. ينسخ عناصر TimephasedDataCollection إلى مصفوفة بدءًا من فهرس مصفوفة محدد"
type: docs
weight: 80
...
ينسخ عناصر [`TimephasedDataCollection`](../) إلى مصفوفة، بدءًا من فهرس مصفوفة معين.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| array | TimephasedData[] | المصفوفة أحادية البعد التي تكون وجهة العناصر المنسوخة من [`TimephasedDataCollection`](../). يجب أن تكون المصفوفة ذات فهرسة تبدأ من الصفر. |
...
| ArgumentException | عدد العناصر في المصدر [`TimephasedDataCollection`](../) أكبر من المساحة المتاحة من *arrayIndex* إلى نهاية *array* الوجهة. |
