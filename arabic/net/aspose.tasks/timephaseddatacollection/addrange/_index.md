...
description: "طريقة TimephasedDataCollection. تُضيف مجموعة من كائنات TimephasedData إلى كائن هذه المجموعة"
type: docs
weight: 50
...
تضيف مجموعة من كائنات [`TimephasedData`](../../timephaseddata/) إلى كائن هذه المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | مجموعة من كائنات [`TimephasedData`](../../timephaseddata/) للإضافة. |
