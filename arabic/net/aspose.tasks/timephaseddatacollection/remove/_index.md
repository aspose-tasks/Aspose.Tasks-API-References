...
description: "طريقة TimephasedDataCollection. يزيل مثيل TimePhasedData من كائن التجميع هذا"
type: docs
weight: 100
...
يزيل مثيل [`TimephasedData`](../../timephaseddata/) من كائن التجميع هذا.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | TimephasedData | العنصر المراد إزالته. |

### قيمة الإرجاع

true إذا تم حذف *item* بنجاح من [`TimephasedDataCollection`](../)؛ وإلا، false. هذه الطريقة تُعيد أيضًا false إذا لم يتم العثور على *item* في [`TimephasedDataCollection`](../).
