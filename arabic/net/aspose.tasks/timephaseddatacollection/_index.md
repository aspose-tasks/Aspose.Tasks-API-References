---
title: "فئة TimephasedDataCollection"
second_title: "مرجع API لـ Aspose.Tasks لـ .NET"
description: "فئة Aspose.Tasks.TimephasedDataCollection. تمثل مجموعة من كائنات TimephasedData"
type: docs
weight: 2600
url: /ar/net/aspose.tasks/timephaseddatacollection/
---
## TimephasedDataCollection class

تمثل مجموعة من كائنات [`TimephasedData`](../timephaseddata/).
...
| الاسم | الوصف |
| --- | --- |
| [Count](../../aspose.tasks/timephaseddatacollection/count/) { get; } | يحصل على عدد الكائنات الموجودة في كائن `TimephasedDataCollection` هذا. |
| [IsReadOnly](../../aspose.tasks/timephaseddatacollection/isreadonly/) { get; } | يحصل على قيمة تشير إلى ما إذا كان ICollection للقراءة فقط. |
| [Item](../../aspose.tasks/timephaseddatacollection/item/) { get; set; } | يرجع العنصر في الفهرس المحدد. لا يتم دعم مُحدد الضبط. خاصية لتعيين بيانات timephased. |

## الطرق

| الاسم | الوصف |
| --- | --- |
| [Add](../../aspose.tasks/timephaseddatacollection/add/)(TimephasedData) | يضيف مثيل [`TimephasedData`](../timephaseddata/) إلى كائن المجموعة هذا. |
| [AddRange](../../aspose.tasks/timephaseddatacollection/addrange/)(IEnumerable&lt;TimephasedData&gt;) | يضيف مجموعة من مثيلات [`TimephasedData`](../timephaseddata/) إلى كائن المجموعة هذا. |
| [Clear](../../aspose.tasks/timephaseddatacollection/clear/)() | يزيل جميع العناصر من `TimephasedDataCollection`. |
| [Contains](../../aspose.tasks/timephaseddatacollection/contains/)(TimephasedData) | يحدد ما إذا كان `TimephasedDataCollection` يحتوي على قيمة محددة. |
| [CopyTo](../../aspose.tasks/timephaseddatacollection/copyto/)(TimephasedData[], int) | ينسخ عناصر `TimephasedDataCollection` إلى مصفوفة، بدءًا من فهرس مصفوفة معين. |
| [GetEnumerator](../../aspose.tasks/timephaseddatacollection/getenumerator/)() | يرجع عدادًا لهذه المجموعة. |
| [Remove](../../aspose.tasks/timephaseddatacollection/remove/)(TimephasedData) | يزيل مثيل [`TimephasedData`](../timephaseddata/) من كائن المجموعة هذا. |
| [SelectBetweenStartAndFinish](../../aspose.tasks/timephaseddatacollection/selectbetweenstartandfinish/)(TimephasedDataType, DateTime, DateTime) | يختار جميع مراحل الوقت بين *startTime* و *finishTime*. لديها تعقيد O(log n) في الحالة المتوسطة. |
| [ToList](../../aspose.tasks/timephaseddatacollection/tolist/)() | يحول كائن `TimephasedDataCollection` إلى قائمة من كائنات [`TimephasedData`](../timephaseddata/). |
