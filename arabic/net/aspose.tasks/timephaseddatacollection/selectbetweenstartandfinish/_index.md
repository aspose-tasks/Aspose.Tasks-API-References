...
description: تحديد جميع مراحل الوقت بينstartTime وfinishTime . لديه تعقيد O تسجيل الدخول في الحالة المتوسطة.
type: docs
weight: 120
...
إرجاع نسخة قائمة جديدة من[`TimephasedDataCollection`](../../timephaseddatacollection) البيانات مرتبة حسب خاصية البدء.
