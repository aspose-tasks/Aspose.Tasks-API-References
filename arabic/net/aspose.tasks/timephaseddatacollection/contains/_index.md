...
description: "طريقة TimephasedDataCollection. تحدد ما إذا كانت TimephasedDataCollection تحتوي على قيمة محددة."
type: docs
weight: 70
...
تحدد ما إذا كان [`TimephasedDataCollection`](../) يحتوي على قيمة محددة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | TimephasedData | الكائن المراد البحث عنه في المجموعة. |
