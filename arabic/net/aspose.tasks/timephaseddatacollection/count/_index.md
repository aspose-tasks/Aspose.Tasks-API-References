...
description: "خاصية TimephasedDataCollection. يحصل على عدد الكائنات المحتواة في كائن TimephasedDataCollection هذا"
type: docs
weight: 10
...
يحصل على عدد الكائنات المحتواة في كائن [`TimephasedDataCollection`](../) هذا.
