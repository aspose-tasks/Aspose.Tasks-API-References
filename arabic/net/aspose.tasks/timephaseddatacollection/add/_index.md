...
description: "طريقة TimephasedDataCollection. تُضيف نسخة TimephasedData إلى كائن التجميع هذا"
type: docs
weight: 40
...
تضيف نسخة [`TimephasedData`](../../timephaseddata/) إلى كائن التجميع هذا.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | TimephasedData | العنصر المراد إضافته. |

### استثناءات

| استثناء | شرط |
| --- | --- |
| ArgumentNullException | إذا كان المعامل td يساوي null. |
