...
description: "طريقة FilterCollection. تنسخ عناصر هذه المجموعة إلى المصفوفة المحددة بدءًا من الفهرس المحدد في المصفوفة"
type: docs
weight: 60
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| المصفوفة | Filter[] | المصفوفة الأحادية البعد المحددة لنسخ العناصر إليها |
