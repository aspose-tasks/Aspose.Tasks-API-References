...
description: "طريقة CalendarExceptionCollection. تزيل نسخة CalendarException من هذه المجموعة"
type: docs
weight: 80
...
يزيل نسخة [`CalendarException`](../../calendarexception/) من هذه المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | CalendarException | العنصر المراد إزالته. |

### قيمة الإرجاع

صحيح إذا تمت إزالة الاستثناء المحدد بنجاح.
