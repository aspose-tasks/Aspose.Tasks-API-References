...
description: "طريقة CalendarExceptionCollection. تُضيف مجموعة من الاستثناءات إلى القائمة الداخلية"
type: docs
weight: 50
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| exceptionList | IEnumerable`1 | مجموعة من الاستثناءات للإضافة. |
