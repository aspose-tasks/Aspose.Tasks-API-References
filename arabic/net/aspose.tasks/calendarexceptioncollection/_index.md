...
description: يمثل مجموعة منCalendarException./calendarexception الكائنات .
type: docs
weight: 250
...
| اسم | وصف |
| --- | --- |
| [Count](../../aspose.tasks/calendarexceptioncollection/count) { get; } | الحصول على عدد العناصر الموجودة في هذا[`CalendarExceptionCollection`](../calendarexceptioncollection) الكائن . |
...
| [Clear](../../aspose.tasks/calendarexceptioncollection/clear)() | يزيل كافة العناصر من ملف[`CalendarExceptionCollection`](../calendarexceptioncollection) . |
