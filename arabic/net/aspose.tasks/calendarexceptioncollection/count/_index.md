...
description: "خاصية CalendarExceptionCollection. تحصل على عدد الكائنات الموجودة في كائن CalendarExceptionCollection هذا"
type: docs
weight: 10
...
يحصل على عدد الكائنات الموجودة في كائن [`CalendarExceptionCollection`](../).
