...
description: "طريقة CalendarExceptionCollection. تضيف نسخة CalendarException إلى كائن المجموعة هذا"
type: docs
weight: 40
...
يضيف كائن CalendarException إلى كائن التجميع هذا.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| العنصر | CalendarException | العنصر المراد إضافته. |
