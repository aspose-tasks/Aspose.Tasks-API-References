...
description: "طريقة TaskCollection. تعيد مهمة بالمعرف الفريد المحدد (Uid) يكون سلفها مهمة أصل لهذه المجموعة."
type: docs
weight: 80
...
يرجع مهمة بالمعرف الفريد المحدد Uid يكون سلفها المهمة الأب لهذه المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| uid | Int32 | معرف TaskEntity (Uid). |

### قيمة الإرجاع

يعيد نسخة من الفئة [`Task`](../../task/) بالمعرف (uid) المحدد يكون سلفها مهمة أصل لهذه المجموعة.
