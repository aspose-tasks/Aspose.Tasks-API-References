...
description: "طريقة TaskCollection. تعيد مهمة بالمعرف (Id) المحدد يكون سلفها مهمة أصل لهذه المجموعة."
type: docs
weight: 70
...
يرجع مهمة بالمعرف المحدد Id يكون سلفها المهمة الأب لهذه المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| معرف | Int32 | معرف TaskEntity |

### قيمة الإرجاع

يعيد نسخة من الفئة [`Task`](../../task/) بالمعرف المحدد التي سلفها هو مهمة الأب لهذه المجموعة.
