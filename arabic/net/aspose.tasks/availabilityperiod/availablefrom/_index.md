...
description: "خاصية AvailabilityPeriod. تحصل أو تعين التاريخ الذي يصبح فيه المورد متاحًا للفترة المحددة"
type: docs
weight: 20
...
يحصل أو يضبط التاريخ الذي يصبح فيه المورد متاحًا للفترة المحددة.
