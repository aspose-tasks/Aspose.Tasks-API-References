...
description: "خاصية OutlineValue. تحصل أو تعين المدة إذا كان Type هو Duration"
type: docs
weight: 30
...
يحصل أو يعيّن المدة إذا كان النوع هو Duration.
...
يفضل استخدام هذه الخاصية بدلاً من [`Value`](../value/)، عندما تحتاج إلى تعيين القيمة لـ OutlineValues بنوع Duration.
