...
type: docs
weight: 120
url: /ar/python-net/aspose.tasks.saving/printoptions/
---
...
نوع PrintOptions يكشف عن الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| PrintOptions() | ينشئ مثيلًا جديدًا من الفئة [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) التي يمكن استخدامها لتعيين خيارات مختلفة لطباعة المشروع. |
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format |  |
