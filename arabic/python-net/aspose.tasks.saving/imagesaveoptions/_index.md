...
type: docs
weight: 40
url: /ar/python-net/aspose.tasks.saving/imagesaveoptions/
---

## ImageSaveOptions class

يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع إلى صور.

يعرض نوع ImageSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| ImageSaveOptions(save_format) | ينشئ مثيلاً جديداً من الفئة [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) التي يمكن استخدامها لحفظ الصور المرسومة بتنسيقات TIFF أو PNG أو BMP أو JPEG. |
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format |  |
...
| pages | يحصل أو يعيّن قائمة بأرقام الصفحات لحفظها عند حفظ تخطيط المشروع إلى ملفات منفصلة. |
| jpeg_quality | يحصل أو يعيّن جودة JPEG. النطاق المسموح للقيمة هو 0..100. |
| reduce_footer_gap | يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب تقليل الفجوة بين المهمة الأخيرة وتذييل الصفحة. |
| tiff_compression | يحصل أو يعيّن نوع الضغط لتطبيقه عند حفظ الصور المولدة بتنسيق TIFF. |
| pixel_format | يحصل أو يعيّن تنسيق بيانات اللون لكل بكسل في الصورة. |
| horizontal_resolution | يحصل أو يعيّن الدقة الأفقية بوحدة dpi. |
| vertical_resolution | يحصل أو يعيّن الدقة العمودية بوحدة dpi. |
