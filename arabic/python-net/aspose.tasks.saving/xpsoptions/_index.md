...
type: docs
weight: 200
url: /ar/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع إلى XPS.

يعرض نوع XpsOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| XpsOptions() | ينشئ مثيلاً جديداً من الفئة [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | يحصل أو يعيّن قيمة تشير إلى ما إذا كان يجب عرض ملف الميتا كصورة نقطية. |
