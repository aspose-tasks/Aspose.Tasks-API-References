...
type: docs
weight: 90
url: /ar/python-net/aspose.tasks.saving/pdfsaveoptions/
---

## PdfSaveOptions class

يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع إلى PDF.

يعرض نوع PdfSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| PdfSaveOptions() | يُنشئ مثلاً جديداً من الفئة [PdfSaveOptions](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) التي يمكن استخدامها لحفظ مستند في |
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | الحصول أو تعيين قيمة تشير إلى ما إذا كان يجب استخدام فرشاة التدرج عند تصوير مخطط جانت. |
...
| compliance | يحصل أو يضبط مستوى الامتثال المطلوب للمستند PDF المُولد.<br/>            الافتراضي هو [PDF15](/tasks/python-net/aspose.tasks.saving/pdfcompliance/). |
| encryption_details | يحصل أو يضبط تفاصيل التشفير. إذا لم يتم ضبطها، فلن يتم تنفيذ أي تشفير. |
| text_compression | يحصل أو يضبط نوع الضغط الذي سيُستخدم لجميع تدفقات المحتوى باستثناء الصور.<br/>            الافتراضي هو [FLATE](/tasks/python-net/aspose.tasks.saving/pdftextcompression/). |
| digital_signature_details | يحصل أو يضبط تفاصيل التوقيع الرقمي. إذا لم يتم ضبطها، فلن يتم تنفيذ أي توقيع. |
| save_to_separate_files | يحصل أو يضبط قيمة تشير إلى ما إذا كان يجب حفظ صفحات المشروع في ملفات منفصلة. |
| page_saving_callback | يحصل أو يضبط استدعاءً معرفاً من قبل المستخدم يُستخدم للحصول على تدفق إخراج لكل صفحة مُعالجة.<br/>            يُطبق عندما يتم استخدام خيار [save_to_separate_files](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/). |
| pages | يحصل أو يعيّن قائمة أرقام الصفحات لحفظها عند حفظ تخطيط المشروع إلى ملفات منفصلة. |
