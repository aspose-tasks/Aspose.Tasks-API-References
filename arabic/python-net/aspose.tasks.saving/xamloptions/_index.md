...
type: docs
weight: 180
url: /ar/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// يسمح بتحديد خيارات إضافية عند عرض صفحات المشروع إلى XAML.

يعرض نوع XamlOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| XamlOptions() | ينشئ مثيلاً جديداً من الفئة [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) التي يمكن استخدامها لحفظ المشروع بتنسيق XAML. |
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format |  |
