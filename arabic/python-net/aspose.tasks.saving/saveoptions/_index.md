...
type: docs
weight: 130
url: /ar/python-net/aspose.tasks.saving/saveoptions/
---

## SaveOptions class

هذه فئة أساسية مجردة للفئات التي تسمح للمستخدم بتحديد خيارات إضافية عند حفظ مشروع<br/>            إلى تنسيق معين.

يعرض نوع SaveOptions الأعضاء التالية:
## الخصائص
| الاسم | الوصف |
| :- | :- |
| save_format | يحصل أو يعيّن الصيغة التي سيُحفظ بها المستند إذا تم استخدام كائن خيارات الحفظ هذا. |
