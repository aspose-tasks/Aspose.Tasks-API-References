...
description: "يمثل مهمة في المشروع."
type: docs
weight: 289
url: /ar/java/com.aspose.tasks/task/
---
...
يمثل مهمة في المشروع.

--------------------

الـ **Task** تمثل جزءًا ذريًا واحدًا من العمل.

يمكن للمرء استخدام **Task** لتخطيط مشروع عن طريق إنشاء مهام وتعيين الموارد المناسبة إليها. تُنظم المهام في المشروع كهيكل شجري هرمي جذري، مع مهمة جذر وفروع من المهام الفرعية.

لبناء شجرة من المهام يمكن استخدام مجموعة متخصصة [TaskCollection](../../com.aspose.tasks/taskcollection) عن طريق الوصول إلى خاصية `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) على سبيل المثال:
...
// إضافة مهام جديدة
Task task1 = project.RootTask.Children.Add(); // مهمة أصلية باسم فارغ تم إضافتها
Task childTask1 = task1.Children.Add("Child 1");
childTask1.Set(Tsk.Start, new DateTime(2020, 2, 12, 8, 0, 0))
childTask1.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask1.Set(Tsk.Finish, new DateTime(2020, 2, 12, 17, 0, 0));
Task childTask3 = task1.Children.Add("الطفل 3");
childTask3.Set(Tsk.Start, new DateTime(2020, 2, 13, 8, 0, 0))
childTask3.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask3.Set(Tsk.Finish, new DateTime(2020, 2, 13, 17, 0, 0));
Task childTask2 = task1.Children.Add("الطفل 2", 2); // يدرج مهمة قبل childTask3
childTask2.Set(Tsk.Start, new DateTime(2020, 2, 14, 8, 0, 0))
childTask2.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask2.Set(Tsk.Finish, new DateTime(2020, 2, 14, 17, 0, 0));

// احفظ المشروع بأحد الصيغ المتاحة
project.Save("مشروع مملوء.xml", SaveFileFormat.Mpp);
...
```
عام نهائي ResourceAssignmentCollection getAssignments()
```
...
```
عام نهائي TaskBaselineCollection getBaselines()
```
...
```
عام نهائي BigDecimal getBudgetCost()
```
...
```
عام نهائي Duration getBudgetWork()
```
...
```
عام نهائي Calendar getCalendar()
```
...
```
عام نهائي TaskCollection getChildren()
```
...
```
عام نهائي Date getCommitmentFinish()
```
...
```
عام نهائي Date getCommitmentStart()
```
...
```
عام نهائي int getCommitmentType()
```
...
```
عام نهائي Date getConstraintDate()
```
...
```
عام نهائي int getConstraintType()
```
...
```
عام نهائي double getCostVariance()
```
...
```
عام نهائي NullableBool getDisplayAsSummary()
```
...
```
عام نهائي boolean getDisplayOnTimeline()
```
...
```
عام نهائي Duration getDuration()
```
...
```
عام نهائي byte getDurationFormat()
```
...
```
عام نهائي String getDurationText()
```
...
```
عام نهائي Duration getDurationVariance()
```
...
```
public final boolean لديهأطفال()
```
...
```
public final NullableBool مدفوعبالجهد()
```
...
```
public final NullableBool مقدر()
```
...
```
public final NullableBool موسع()
```
...
```
public final boolean مهمةخارجية()
```
...
### isManual() {#isManual--}
```
public final NullableBool يدوي()
```
...
```
public final NullableBool معلم()
```
...
### isNull() {#isNull--}
```
public final NullableBool خالي()
```
...
```
public final NullableBool مخصصبزيادة()
```
...
```
public final NullableBool منشور()
```
...
```
public final NullableBool متكرر()
```
...
```
public final NullableBool سيرةصحيحة()
```
...
### isRollup() {#isRollup--}
```
public final NullableBool تجميع()
```
...
```
public final boolean مشروعفرعي()
```
...
```
public final NullableBool مشروعفرعي_للقراءة_فقط()
```
...
```
public final void نقلإلىأخ(Task beforeTask)
```
...
```
public final void نقلإلىأخ(int beforeTaskId)
```
...
```
public final void إزالةإزاحةالمخطط()
```
...
```
public final Iterable<Task> اختياركلمهامالأطفال()
```
...
```
public final void تعيينACWP(double value)
```
