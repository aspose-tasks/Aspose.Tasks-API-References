...
type: docs
weight: 289
url: /zh/java/com.aspose.tasks/task/
---
...
可以使用 **Task** 通过创建任务来规划项目，并将适当的资源分配给它们。项目中的任务组织为一个根层次树结构，包含根任务和子任务的子树。

要构建任务树，可以使用专用集合 [TaskCollection](../../com.aspose.tasks/taskcollection)，通过访问 `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) 属性，例如：
...
// 添加新任务
Task task1 = project.RootTask.Children.Add(); // 添加了一个名称为空的父任务
...
```
公共 最终 可空布尔 getDisplayAsSummary()
```
...
```
公共 最终 持续时间 getDurationVariance()
```
...
```
公共 最终 扩展属性集合 getExtendedAttributes()
```
...
```
公共 最终 字符串 getExternalTaskProject()
```
...
```
public final void setLevelAssignments(NullableBool 值)
```
...
```
public final void setLevelingCanSplit(NullableBool 值)
```
...
```
public final void setLevelingDelay(Duration 值)
```
...
```
public final void setManual(NullableBool 值)
```
...
```
public final void setManualDuration(Duration 值)
```
...
```
public final void setManualFinish(Date 值)
```
...
```
public final void setManualStart(Date 值)
```
...
```
public final void setMarked(boolean 值)
```
...
```
public final void setMilestone(NullableBool 值)
```
...
```
public final void setNotesRTF(String 值)
```
...
```
public final void setNotesText(String 值)
```
...
```
public final void setNull(NullableBool 值)
```
...
```
public final void setOutlineCodes(OutlineCodeCollection 值)
```
...
```
public final void setOutlineLevel(int 值)
```
...
```
public final void setOutlineNumber(String 值)
```
...
```
public final void setOverallocated(NullableBool 值)
```
...
```
public final void setOvertimeCost(BigDecimal 值)
```
...
```
public final void setOvertimeWork(Duration 值)
```
...
```
public final void setPercentComplete(int 值)
```
...
```
public final void setPercentWorkComplete(int 值)
```
...
```
public final void setPhysicalPercentComplete(int 值)
```
...
```
public final void setPreleveledFinish(Date 值)
```
...
```
public final void setPreleveledStart(Date 值)
```
...
```
public final void setPriority(int 值)
```
...
```
public final void setPublished(NullableBool 值)
```
