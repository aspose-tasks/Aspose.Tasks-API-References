...
description: "表示每日重复模式中重复的基类。"
type: docs
weight: 65
url: /zh/java/com.aspose.tasks/dailyrepetitionbase/
---
...
| [getRepetitionInterval()](#getRepetitionInterval--) | 获取一个天数，表示发生之间的天数间隔。 |
| [getValidator(Calendar calendar)](#getValidator-com.aspose.tasks.Calendar-) | \{@inheritDoc\} |
| [setRepetitionInterval(int value)](#setRepetitionInterval-int-) | 设置一个天数，表示发生之间的天数间隔。 |
