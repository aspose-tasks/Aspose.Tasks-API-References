---
title: "Aspose::Tasks::ExtendedAttributeDefinitionCollection::virtualizeEndConstIterator 方法"
linktitle: "virtualizeEndConstIterator"
articleTitle: "virtualizeEndConstIterator"
second_title: "Aspose.Tasks for C++"
description: "获取指向集合的 const 限定实例中最后一个元素（如果有）之后的迭代器。"
type: docs
weight: 230
url: /zh/cpp/aspose.tasks/extendedattributedefinitioncollection/virtualizeendconstiterator/
---

## virtualizeEndConstIterator {#virtualizeendconstiterator}

获取指向集合的 const 限定实例中最后一个元素（如果有）之后的迭代器。
