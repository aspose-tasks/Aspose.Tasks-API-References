...
type: docs
weight: 180
url: /zh/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// 允许在将项目页面渲染为 XAML 时指定其他选项。

XamlOptions 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| XamlOptions() | 初始化一个新的 [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) 类实例，可用于以 XAML 格式保存项目。 |
## 属性
| 名称 | 描述 |
| :- | :- |
| save_format |  |
