...
type: docs
weight: 170
url: /zh/python-net/aspose.tasks.saving/svgoptions/
---
...
| 名称 | 描述 |
| :- | :- |
| SvgOptions() | 初始化一个新的 [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) 类实例，可用于以 SVG 格式保存项目。 |
## 属性
| 名称 | 描述 |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | 确定在渲染项目布局时是否使用渐变画刷。 |
...
| page_saving_callback | 获取或设置用户定义的实现回调，该回调用于获取每个渲染页面的输出流。 |
