...
type: docs
weight: 200
url: /zh/python-net/aspose.tasks.saving/xpsoptions/
---
...
| 名称 | 描述 |
| :- | :- |
| XpsOptions() | 初始化 [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/) 类的新实例。 |
## 属性
| 名称 | 描述 |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | 获取或设置一个值，指示是否应将元文件渲染为位图。 |
