...
| [CheckCircuit](./checkcircuit) | 检查（任务的）树是否包含电路。 |
| [ChildTasksCollector](./childtaskscollector) | 收集所有子任务。 |
| [ListUtils](./listutils) | 用于列表处理的实用程序类。 |
| [Not&lt;T&gt;](./not-1) | 对指定条件应用逻辑非。 |
| [RemoveTask](./removetask) | 从任务树中删除指定的任务。 |
| [TaskUtils](./taskutils) | Helper 类，它为任务提供有用的操作。 |
| [TreeAlgorithmBase&lt;T&gt;](./treealgorithmbase-1) | 实现的基类 [`ITreeAlgorithm`](../aspose.tasks.util/itreealgorithm-1) |
## 接口

| 界面 | 描述 |
| --- | --- |
| [IAlgorithm&lt;T&gt;](./ialgorithm-1) | 表示可以应用于对象列表&lt;typeparamref name="T" /&gt;的算法。 |
| [ICondition&lt;T&gt;](./icondition-1) | 表示过滤器或搜索方法可以使用的条件。 |
| [ITreeAlgorithm&lt;T&gt;](./itreealgorithm-1) | 表示可以应用于对象树 &lt;typeparamref name="T" /&gt; 的算法。 |
