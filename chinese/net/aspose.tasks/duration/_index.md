...
| 姓名 | 描述 |
| --- | --- |
| [IsElapsed](../../aspose.tasks/duration/iselapsed) { get; } | 获取一个值，该值指示是否经过时间单位。  确定此 Duration 实例是否已过的标志。 |
| [IsEstimated](../../aspose.tasks/duration/isestimated) { get; } | 获取是否估计时间单位的值。  确定是否估计此 Duration 实例的标志。 |
...
| 姓名 | 描述 |
| --- | --- |
| static [Parse](../../aspose.tasks/duration/parse)(Project, string) | 将指定字符串转换为[`Duration`](../duration)结构的实例。 |
