...
description: "Project 属性。获取或设置是否应使用任务工作量和资源费率自动计算分配成本和剩余成本"
type: docs
weight: 70
url: /zh/net/aspose.tasks/project/autocalculateassignmentcosts/
---
## Project.AutoCalculateAssignmentCosts property

获取或设置是否应使用任务的工作量和资源费率自动计算分配成本和剩余成本。
