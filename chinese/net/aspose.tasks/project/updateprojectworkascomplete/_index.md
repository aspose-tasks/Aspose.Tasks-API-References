...
description: Project 方法. 将整个项目的指定日期内的所有工作更新为已完成
type: docs
weight: 1250
...
| setZeroOrHundredPercentCompleteOnly | Boolean | 如果设置为 true，则仅更新那些完成日期早于指定完成日期的 100% 完成的任务。 否则，根据计划的开始日期和完成日期计算完成百分比值。 |
