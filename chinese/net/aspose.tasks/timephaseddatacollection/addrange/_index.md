...
description: "TimephasedDataCollection 方法。向此集合对象添加一组 TimephasedData 实例"
type: docs
weight: 50
...
向此集合对象添加一组 [`TimephasedData`](../../timephaseddata/) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | 要添加的 [`TimephasedData`](../../timephaseddata/) 对象集合。 |
