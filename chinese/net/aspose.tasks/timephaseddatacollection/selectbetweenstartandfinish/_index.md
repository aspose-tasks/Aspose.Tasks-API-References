...
description: "TimephasedDataCollection 方法。选择 startTime 与 finishTime 之间的所有时间阶段。平均情况下具有 Olog n 复杂度。"
type: docs
weight: 110
...
| startTime | DateTime | 区间的开始。 |
| finishTime | DateTime | 区间的结束。 |

### 返回值

返回按 Start 属性排序的 [`TimephasedDataCollection`](../) 数据的新列表实例。
