...
description: "TimephasedDataCollection 方法。从此集合对象中移除 TimephasedData 实例。"
type: docs
weight: 100
...
从此集合对象中移除 [`TimephasedData`](../../timephaseddata/) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| item | TimephasedData | 要移除的项。 |

### 返回值

如果成功地从 [`TimephasedDataCollection`](../) 中删除 *item*，则返回 true；否则返回 false。若在 [`TimephasedDataCollection`](../) 中未找到 *item*，此方法也返回 false。
