...
description: "TimephasedDataCollection 方法。将 TimephasedDataCollection 对象转换为 TimephasedData 对象的列表"
type: docs
weight: 120
...
将 [`TimephasedDataCollection`](../) 对象转换为 [`TimephasedData`](../../timephaseddata/) 对象的列表。
...
[`TimephasedData`](../../timephaseddata/) 对象的列表。
