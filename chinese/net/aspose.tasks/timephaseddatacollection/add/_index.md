...
description: "TimephasedDataCollection 方法。向此集合对象添加 TimephasedData 实例。"
type: docs
weight: 40
...
向此集合对象添加 [`TimephasedData`](../../timephaseddata/) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| item | TimephasedData | 要添加的项。 |

### 异常

| 异常 | 条件 |
| --- | --- |
| ArgumentNullException | 如果参数 td 为 null。 |
