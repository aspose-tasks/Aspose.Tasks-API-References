...
description: "RateCollection 方法。将 RateCollection 对象转换为 Rate 对象列表"
type: docs
weight: 80
...
将 [`RateCollection`](../) 对象转换为 [`Rate`](../../rate/) 对象列表。
...
将 [`RateCollection`](../) 对象转换为按指定 [`RateType`](../../ratetype/) 类型过滤的 [`Rate`](../../rate/) 对象列表。
