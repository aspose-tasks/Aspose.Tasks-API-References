...
description: 获取或设置一个值该值指示当 Project 识别出可能与手动计划任务的计划冲突时是否显示警告 此选项适用于 Project 2010 版本及更高版本
type: docs
weight: 90
...
获取或设置一个值，该值指示当 Project 识别出可能与手动计划任务的计划冲突时是否显示警告。 此选项适用于 Project 2010 版本及更高版本。
