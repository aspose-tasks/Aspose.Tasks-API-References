...
description: "ExtendedAttributeCollection 方法。如果在此集合中找到指定项则返回 true，否则返回 false"
type: docs
weight: 60
url: /zh/net/aspose.tasks/extendedattributecollection/contains/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| item | ExtendedAttribute | 要查找的指定项。 |
