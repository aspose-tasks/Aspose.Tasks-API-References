...
| static readonly [ActualCost](../../aspose.tasks/tsk/actualcost) | 资源已在其任务上执行的工作所产生的成本，以及与任务相关的任何其他记录成本。 |
| static readonly [ActualDuration](../../aspose.tasks/tsk/actualduration) | 任务的实际工作时间跨度，基于计划持续时间和当前剩余工作或完成百分比。 |
...
| static readonly [ACWP](../../aspose.tasks/tsk/acwp) | 在项目状态日期或今天日期之前已完成任务的工作所产生的成本。 |
| static readonly [BCWP](../../aspose.tasks/tsk/bcwp) | 任务完成百分比的累积值乘以时间分段基准成本。 |
| static readonly [BCWS](../../aspose.tasks/tsk/bcws) | 截至状态日期或今天日期的累计时间阶段性基准成本。 |
...
| static readonly [CommitmentType](../../aspose.tasks/tsk/commitmenttype) | 确定任务是否具有关联的交付或 对关联交付的依赖。  仅支持 XML 格式的读取。 Int32类型。 |
| static readonly [ConstraintDate](../../aspose.tasks/tsk/constraintdate) | 与约束类型关联的特定日期。 |
| static readonly [ConstraintType](../../aspose.tasks/tsk/constrainttype) | 为可应用于调度任务的约束类型提供选择。 |
| static readonly [Contact](../../aspose.tasks/tsk/contact) | 负责某项任务的个人姓名。 |
| static readonly [Cost](../../aspose.tasks/tsk/cost) | 一项任务的计划或预计总成本，基于分配给任务的资源执行的工作已经产生的成本，以及剩余工作的计划成本。 |
...
| static readonly [CV](../../aspose.tasks/tsk/cv) | 任务的基线成本和总成本之间的差异。 成本差异 = 成本 - 基准成本 |
...
| static readonly [Duration](../../aspose.tasks/tsk/duration) | Microsoft Project 根据开始日期、完成日期、日历和其他计划因素输入或计算的任务的活动工作时间的总跨度。 |
...
| static readonly [EarlyFinish](../../aspose.tasks/tsk/earlyfinish) | 任务可能完成的最早日期，基于前任和后继任务的提前完成日期、其他约束和任何升级延迟。 |
| static readonly [EarlyStart](../../aspose.tasks/tsk/earlystart) | 任务可能开始的最早日期，基于前任和后继任务的早期开始日期和其他限制。 |
...
| static readonly [HasOverallocatedResource](../../aspose.tasks/tsk/hasoverallocatedresource) | 指示任务是否分配了资源，该资源在分配的任务上的工作量超过了正常工作能力所能完成的工作量。 |
...
| static readonly [IsEffortDriven](../../aspose.tasks/tsk/iseffortdriven) | 确定任务的调度是否为努力驱动的调度。 |
...
| static readonly [IsManual](../../aspose.tasks/tsk/ismanual) | 确定是否手动计划任务。 |
| static readonly [IsMarked](../../aspose.tasks/tsk/ismarked) | 显示任务是否被标记为进一步操作或某种识别。 |
...
| static readonly [IsResumeValid](../../aspose.tasks/tsk/isresumevalid) | 确定是否可以恢复任务。 |
| static readonly [IsRollup](../../aspose.tasks/tsk/isrollup) | 确定是否将有关子任务甘特条的信息汇总到摘要任务条。 |
| static readonly [IsSubproject](../../aspose.tasks/tsk/issubproject) | 确定任务是否为插入项目。 |
...
| static readonly [LevelAssignments](../../aspose.tasks/tsk/levelassignments) | 确定调平功能是否可以延迟和拆分单个分配以解决过度分配。 |
| static readonly [LevelingCanSplit](../../aspose.tasks/tsk/levelingcansplit) | 确定资源平衡功能是否会导致此任务的剩余工作拆分。 |
...
| static readonly [NotesText](../../aspose.tasks/tsk/notestext) | Notes 从 RTF 数据中提取的纯文本。 |
...
| static readonly [PhysicalPercentComplete](../../aspose.tasks/tsk/physicalpercentcomplete) | 可用作计算已完成工作的预算成本 (BCWP) 的替代方法的百分比完成值。 |
| static readonly [PreleveledFinish](../../aspose.tasks/tsk/preleveledfinish) | 资源调配完成前任务的完成日期。 |
| static readonly [PreleveledStart](../../aspose.tasks/tsk/preleveledstart) | 资源调配完成前的任务开始日期。 |
| static readonly [Priority](../../aspose.tasks/tsk/priority) | 赋予任务的重要性级别，这反过来表明任务或分配在资源调配期间延迟或拆分的难易程度。 |
...
| static readonly [StartSlackTimeSpan](../../aspose.tasks/tsk/startslacktimespan) | Early Start 和 Late Start 日期之间的持续时间。 |
...
| static readonly [SV](../../aspose.tasks/tsk/sv) | 挣值进度差异，通过项目状态日期。 进度偏差 (SV) 是 BCWP 和 BCWS 之间的差异。 |
| static readonly [TotalSlackTimeSpan](../../aspose.tasks/tsk/totalslacktimespan) | 可以延迟任务完成日期而不延迟项目完成日期的时间。 |
