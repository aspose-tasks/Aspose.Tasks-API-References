...
description: "VbaModule 方法。创建一个 VbaModule 实例，类型为 VbaModuleType.ProceduralModule"
type: docs
weight: 20
url: /zh/net/aspose.tasks/vbamodule/createproceduralmodule/
---
## VbaModule.CreateProceduralModule method

创建一个 [`VbaModule`](../) 实例，类型为 VbaModuleType.ProceduralModule。
