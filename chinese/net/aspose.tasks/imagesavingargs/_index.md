...
description: "Aspose.Tasks.ImageSavingArgs 类。此类表示与在转换为 HTML 格式期间发生的外部图像文件保存相关的一组数据"
type: docs
weight: 900
...
此类表示在转换为 HTML 格式期间与外部图像文件保存相关的数据集。
...
| 名称 | 描述 |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | 初始化 `ImageSavingArgs` 类的新实例。 |
