...
description: 表示Resource./resource对象的支持属性
type: docs
weight: 1690
...
| 姓名 | 描述 |
| --- | --- |
| static readonly [AccrueAt](../../aspose.tasks/rsc/accrueat) | 确定将资源标准和加班成本计入或累积到任务成本的方式和时间。 |
| static readonly [ActiveDirectoryGuid](../../aspose.tasks/rsc/activedirectoryguid) | Active DirectoryGuid用于资源。 |
...
| static readonly [AvailableFrom](../../aspose.tasks/rsc/availablefrom) | 资源可用于在当前时间段指定的单位工作的开始日期。 |
| static readonly [AvailableTo](../../aspose.tasks/rsc/availableto) | 资源可用于当前时间段指定单位的工作的结束日期。 |
| static readonly [BCWP](../../aspose.tasks/rsc/bcwp) | 资源为项目迄今为止执行的工作的预算成本。 |
...
| static readonly [CanLevel](../../aspose.tasks/rsc/canlevel) | 确定是否可以对资源进行资源调平。 |
| static readonly [Code](../../aspose.tasks/rsc/code) | 有关资源的代码或其他信息。 |
| static readonly [Cost](../../aspose.tasks/rsc/cost) | 资源的计划或预计总成本，基于分配给任务的资源执行的工作已经发生的成本，以及剩余工作的计划成本. |
...
| static readonly [CostVariance](../../aspose.tasks/rsc/costvariance) | 资源的基准成本和总成本之间的差异。 |
| static readonly [Created](../../aspose.tasks/rsc/created) | 将资源添加到项目的日期和时间。 |
| static readonly [CV](../../aspose.tasks/rsc/cv) | 挣值成本差异，通过项目状态日期。 CV 是任务的 BCWP（已完成工作的预算成本）和 ACWP（已完成工作的实际成本）之间的差值。 |
| static readonly [EMailAddress](../../aspose.tasks/rsc/emailaddress) | 资源的电子邮件地址。 |
| static readonly [Finish](../../aspose.tasks/rsc/finish) | 资源计划完成所有已分配任务工作的日期。 |
...
| static readonly [IsBudget](../../aspose.tasks/rsc/isbudget) | 确定工作、材料或成本资源是否为预算资源。 |
...
| static readonly [IsGeneric](../../aspose.tasks/rsc/isgeneric) | 确定资源是否是通用的。 |
...
| static readonly [NotesRTF](../../aspose.tasks/rsc/notesrtf) | RTF 格式的文本注释。  仅支持 MPP 格式。 String类型。 |
| static readonly [NotesText](../../aspose.tasks/rsc/notestext) | Notes 从 RTF 数据中提取的纯文本。 |
| static readonly [Overallocated](../../aspose.tasks/rsc/overallocated) | 指示资源是否分配给特定任务或所有任务的工作量超过了正常工作能力所能完成的工作量。 |
| static readonly [OvertimeCost](../../aspose.tasks/rsc/overtimecost) | 资源在所有已分配任务上的总加班成本。 |
| static readonly [OvertimeRate](../../aspose.tasks/rsc/overtimerate) | 资源加班费率。 |
| static readonly [OvertimeRateFormat](../../aspose.tasks/rsc/overtimerateformat) | Microsoft Project 用来显示加班率的单位。 |
| static readonly [OvertimeWork](../../aspose.tasks/rsc/overtimework) | 资源计划在任务上执行的加班量，并按相关资源的加班费率收费。 |
| static readonly [PeakUnits](../../aspose.tasks/rsc/peakunits) | 资源分配到的所有任务在任一时间点的最大分配单位。 |
...
| static readonly [SV](../../aspose.tasks/rsc/sv) | 挣值进度差异，通过项目状态日期。 SV 是已完成工作的预算成本 (BCWP) 与计划工作的预算成本 (BCWS) 之间的差额。 |
