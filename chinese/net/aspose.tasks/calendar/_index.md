...
| 姓名 | 描述 |
| --- | --- |
| [BaseCalendar](../../aspose.tasks/calendar/basecalendar) { get; set; } | 获取或设置此日历所依赖的基准日历。 仅在日历不是基准日历时适用。 读/写[`Calendar`](../calendar). |
...
| 姓名 | 描述 |
| --- | --- |
| static [Make24HourCalendar](../../aspose.tasks/calendar/make24hourcalendar)(Calendar) | 使给定的日历成为 24 小时日历。 24 小时日历是一种日历，其中一周中的每一天都在全天候工作。 |
...
| [GetFinishDateByStartAndWork](../../aspose.tasks/calendar/getfinishdatebystartandwork#getfinishdatebystartandwork)(DateTime, Duration) | 根据日历计算指定工作时间的日期。 |
| [GetFinishDateByStartAndWork](../../aspose.tasks/calendar/getfinishdatebystartandwork#getfinishdatebystartandwork_1)(DateTime, TimeSpan) | 根据日历计算指定工作时间的日期。 |
| override [GetHashCode](../../aspose.tasks/calendar/gethashcode)() | 返回实例的哈希码[`Calendar`](../calendar)类. |
| [GetNextWorkingDayStart](../../aspose.tasks/calendar/getnextworkingdaystart)(DateTime) | 计算从日期开始的下一个工作日。 |
| [GetPreviousWorkingDayEnd](../../aspose.tasks/calendar/getpreviousworkingdayend)(DateTime) | 计算从指定日期开始的前一个工作日期结束。 |
...
| [GetTaskFinishDateFromDuration](../../aspose.tasks/calendar/gettaskfinishdatefromduration)(Task, TimeSpan) | 根据开始日期、拆分部分和持续时间计算任务完成日期和时间。 |
...
| [GetWorkingTimes](../../aspose.tasks/calendar/getworkingtimes)(DateTime) | 返回[`WorkingTimeCollection`](../workingtimecollection)工作时间。 |
| [IsDayWorking](../../aspose.tasks/calendar/isdayworking)(DateTime) | 判断当天是否为工作日。 |

### 评论

日历用于定义标准工作时间和非工作时间。 项目必须有一个基准日历。任务和资源可以有 自己的基于基准日历的非基准日历。
