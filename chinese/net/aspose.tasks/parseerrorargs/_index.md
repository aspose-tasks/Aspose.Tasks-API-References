...
description: 为ParseErrorCallback./parseerrorcallback委托.
type: docs
weight: 1100
...
为[`ParseErrorCallback`](../parseerrorcallback)委托.
...
| 姓名 | 描述 |
| --- | --- |
| [Exception](../../aspose.tasks/parseerrorargs/exception) { get; } | 获取解析字符串值时引发的异常。 |
