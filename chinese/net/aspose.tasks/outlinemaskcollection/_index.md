...
| 姓名 | 描述 |
| --- | --- |
| [Count](../../aspose.tasks/outlinemaskcollection/count) { get; } | 获取此集合中包含的元素数。 |
| [IsReadOnly](../../aspose.tasks/outlinemaskcollection/isreadonly) { get; } | 获取一个值，表示这个集合是否是只读的；否则为假。 |
...
| [Remove](../../aspose.tasks/outlinemaskcollection/remove)(OutlineMask) | 从此集合中删除特定对象的第一个匹配项。 |
| [RemoveAt](../../aspose.tasks/outlinemaskcollection/removeat)(int) | 删除指定索引处的项目。 |
