---
title: "类 CssSavingArgs"
second_title: "Aspose.Tasks for .NET API 参考"
description: "Aspose.Tasks.CssSavingArgs 类。此类表示在转换为 HTML 格式期间涉及外部 CSS 文件保存的一组数据。"
type: docs
weight: 360
...
此类表示在转换为 HTML 格式期间与外部 CSS 文件保存相关的数据集。
...
| 名称 | 描述 |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | 初始化 `CssSavingArgs` 类的新实例。 |
