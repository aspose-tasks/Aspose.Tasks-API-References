...
description: "ExtendedAttribute 属性。获取或设置 Duration 类型属性的值。"
type: docs
weight: 30
...
| 异常 | 条件 |
| --- | --- |
| InvalidOperationException | 如果 [`AttributeDefinition`](../attributedefinition/) 属性未初始化，或 [`AttributeDefinition`](../attributedefinition/) 属性的自定义字段类型不是 [`Duration`](../../duration/) 实例，则抛出异常。 |
