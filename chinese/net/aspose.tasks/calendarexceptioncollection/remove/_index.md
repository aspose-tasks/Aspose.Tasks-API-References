...
description: "CalendarExceptionCollection 方法。 从此集合中移除 CalendarException 实例。"
type: docs
weight: 80
...
从此集合中移除 [`CalendarException`](../../calendarexception/) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| item | CalendarException | 要移除的项。 |

### 返回值

如果成功删除了指定的异常，则返回 true。
