...
description: "TimephasedData 属性。获取或设置时间分段数据期间每单位时间的值"
type: docs
weight: 100
...
| 异常 | 条件 |
| --- | --- |
| [TasksException](../../tasksexception/) | 当指定的[`TimephasedDataType`](../timephaseddatatype/)的值不正确或为负值时。 |
