---
title: "接口 IImageSavingCallback"
second_title: "Aspose.Tasks for .NET API 参考"
description: "Aspose.Tasks.IImageSavingCallback 接口。表示一个回调，用于创建用于存储图像的资源。"
type: docs
weight: 870
...
| 名称 | 描述 |
| --- | --- |
| [ImageSaving](../../aspose.tasks/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | 在保存图像时要调用的方法。 |
