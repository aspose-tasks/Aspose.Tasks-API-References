...
description: "ExtendedAttributeDefinitionCollection property. 获取此 ExtendedAttributeDefinitionCollection 实例的父项目。返回此集合的父项目"
type: docs
weight: 40
...
获取 [`ExtendedAttributeDefinitionCollection`](../) 实例的父项目。返回此集合的父项目。
