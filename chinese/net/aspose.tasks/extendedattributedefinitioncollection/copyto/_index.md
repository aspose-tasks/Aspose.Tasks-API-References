...
description: "ExtendedAttributeDefinitionCollection method. 将此集合的元素复制到指定数组中，从指定的数组索引开始"
type: docs
weight: 80
url: /zh/net/aspose.tasks/extendedattributedefinitioncollection/copyto/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| array | ExtendedAttributeDefinition[] | 要复制元素到的指定一维数组。 |
