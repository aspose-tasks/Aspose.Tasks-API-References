...
description: "ExtendedAttributeDefinitionCollection 方法。将此 ExtendedAttributeDefinitionCollection 对象转换为包含 ExtendedAttributeDefinition 类实例的列表"
type: docs
weight: 150
...
包含 [`ExtendedAttributeDefinition`](../../extendedattributedefinition/) 类实例的列表。
