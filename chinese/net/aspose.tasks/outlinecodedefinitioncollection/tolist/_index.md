...
description: 将此 OutlineCodeDefinitionCollection 对象转换为OutlineCodeDefinitionaspose.tasks/outlinecodedefinition对象.
type: docs
weight: 130
...
将此 OutlineCodeDefinitionCollection 对象转换为[`OutlineCodeDefinition`](../../outlinecodedefinition)对象.
...
清单[`OutlineCodeDefinition`](../../outlinecodedefinition)对象。
