...
description: "FilterCriteria 属性。获取或设置在 FieldName 与 Value 之间进行比较的类型，该类型作为过滤器的选择条件。FilterComparisonType"
type: docs
weight: 50
...
获取或设置在 FieldName 与 Value 之间进行比较的类型，该类型作为过滤器的选择条件。[`FilterComparisonType`](../../filtercomparisontype/)
