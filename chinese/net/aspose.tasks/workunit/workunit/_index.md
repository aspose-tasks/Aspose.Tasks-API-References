...
description: 初始化WorkUnitaspose.tasks/workunit类的新实例 使用指定的 From 和 To 日期创建新的 WorkUnit 对象
type: docs
weight: 10
...
初始化[`WorkUnit`](../../workunit)类的新实例。 使用指定的 From 和 To 日期创建新的 WorkUnit 对象。
