---
title: "类 ResourceUsageView"
second_title: "Aspose.Tasks for .NET API 参考"
description: "Aspose.Tasks.ResourceUsageView 类。表示项目中的资源使用视图"
type: docs
weight: 1810
...
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | 获取此 ResourceUsageView 的 [`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) 对象。 |
...
// 将 SaveOptions 定义为所需的 TimeScale 设置为天
SaveOptions options = new PdfSaveOptions
{
    Timescale = Timescale.Days,

    // 将 Presentation 格式设置为 ResourceUsage
