...
| 姓名 | 描述 |
| --- | --- |
| [TextStyle](textstyle#constructor)() | 使用默认设置初始化[`TextStyle`](../textstyle)类的新实例。 |
| [TextStyle](textstyle#constructor_1)(FontDescriptor) | 使用指定的字体设置初始化[`TextStyle`](../textstyle)类的新实例。 |
| [TextStyle](textstyle#constructor_2)(FontStyles) | 使用默认字体和指定字体样式初始化[`TextStyle`](../textstyle)类的新实例。 |
| [TextStyle](textstyle#constructor_3)(float, FontStyles) | 使用默认字体和指定的字体大小和样式初始化[`TextStyle`](../textstyle)类的新实例。 |
