...
| [BarStyle](./barstyle) | 更改项目视图中项目的栏的视觉样式。 |
...
| [Gridline](./gridline) | 项目视图中出现的水平或垂直线。 |
...
| [TextStyle](./textstyle) | 更改项目视图中项目的文本视觉样式。 |
| [TimescaleTier](./timescaletier) | 表示甘特图上时间刻度的单层。 |
| [ViewColumn](./viewcolumn) | 表示项目视图中的列。 |
| [VisualObjectPlacement](./visualobjectplacement) | 表示[`OleObject`](../aspose.tasks/oleobject)在视图中的位置和外观。 |
## 接口
...
| 枚举 | 描述 |
| --- | --- |
| [BarItemType](./baritemtype) | 要更改条形样式的项目类型。 |
...
| [GanttBarEndShape](./ganttbarendshape) | 以条表示结束形状，以进度线表示进度点。 |
| [GanttBarFillPattern](./ganttbarfillpattern) | 形状的填充模式。 |
...
| [Shape](./shape) | 将视图数据保存到某些SaveFileFormat。 |
| [TextItemType](./textitemtype) | 更改文本样式的项目类型。 |
| [Timescale](./timescale) | 定义选项，用于指定当项目导出为图形格式时如何在甘特图、任务使用或资源使用视图中呈现时间刻度。 |
