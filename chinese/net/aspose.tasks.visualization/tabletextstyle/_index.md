...
| 姓名 | 描述 |
| --- | --- |
| [TableTextStyle](tabletextstyle#constructor)(int) | 初始化[`TableTextStyle`](../tabletextstyle)类. |
| [TableTextStyle](tabletextstyle#constructor_1)(int, FontDescriptor) | 初始化[`TableTextStyle`](../tabletextstyle)具有指定字体的类。 |
| [TableTextStyle](tabletextstyle#constructor_2)(int, FontStyles) | 初始化[`TableTextStyle`](../tabletextstyle)具有默认字体设置和指定字体样式的类。 |
| [TableTextStyle](tabletextstyle#constructor_3)(int, float, FontStyles) | 初始化[`TableTextStyle`](../tabletextstyle)具有指定字体大小和字体样式的类。 |
...
| override [ItemType](../../aspose.tasks.visualization/tabletextstyle/itemtype) { get; } | 返回的值[`TextItemType`](../textitemtype)枚举. |
| [RowUid](../../aspose.tasks.visualization/tabletextstyle/rowuid) { get; } | 获取行唯一id。 如果样式将应用于视图的所有行，则返回 -1。 |
