---
title: "枚举 GanttBarType"
second_title: "Aspose.Tasks for .NET API 参考"
description: "Aspose.Tasks.Visualization.GanttBarType 枚举。指定条形类型"
type: docs
weight: 3080
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Dashed | `2` | 指示虚线 Gantt 条形类型。 |
| Framed | `1` | 指示带框 Gantt 条形类型。 |
| Solid | `0` | 指示实线 Gantt 条形类型。 |
