...
description: "TimescaleTier 属性。获取或设置在层级的每个时间段内对齐标签的方式 HorizontalStringAlignment"
type: docs
weight: 20
...
获取或设置在层级的每个时间段内对齐标签的方式（[`HorizontalStringAlignment`](../../horizontalstringalignment/)）。
