...
| [DisplayAtCurrentDate](../../aspose.tasks.visualization/progresslines/displayatcurrentdate) { get; set; } | 获取或设置是否在当前日期显示进度线的值。 |
...
| [LineColor](../../aspose.tasks.visualization/progresslines/linecolor) { get; set; } | 获取或设置当前进度线的线颜色。 |
...
| [ProgressPointColor](../../aspose.tasks.visualization/progresslines/progresspointcolor) { get; set; } | 获取或设置进度点颜色。 |
