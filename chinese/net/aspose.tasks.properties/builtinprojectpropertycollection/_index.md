...
| [HyperlinkBase](../../aspose.tasks.properties/builtinprojectpropertycollection/hyperlinkbase) { get; set; } | 获取或设置项目的超链接基础。 |
| override [IsReadOnly](../../aspose.tasks.properties/builtinprojectpropertycollection/isreadonly) { get; } | 获取一个值，表示这个集合是否是只读的；否则为假。 |
...
| [Manager](../../aspose.tasks.properties/builtinprojectpropertycollection/manager) { get; set; } | 获取或设置项目的管理者。 |
