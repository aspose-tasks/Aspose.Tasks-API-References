...
description: "RiskPattern 属性。获取或设置在最坏项目情景下可能出现的最可能任务持续时间的百分比。默认值为 125，这意味着如果估计的任务持续时间为 4 天，则悲观持续时间将为 5 天。"
type: docs
weight: 50
...
获取或设置在最差项目情景下最可能的任务持续时间的百分比。默认值为 125，这意味着如果估计的任务持续时间为 4 天，则悲观持续时间为 5 天。
