...
description: "RiskPattern 属性。获取或设置在 Monte Carlo 仿真中使用的概率分布。默认值为 ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
获取或设置 Monte Carlo 仿真中使用的概率分布。默认值为 ProbabilityDistributionType.Normal。
