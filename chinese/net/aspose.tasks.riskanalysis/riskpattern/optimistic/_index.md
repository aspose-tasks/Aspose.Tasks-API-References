...
description: "RiskPattern 属性。获取或设置在最佳项目情景下可能出现的最可能任务持续时间的百分比。默认值为 75，这意味着如果估计的任务持续时间为 4 天，则乐观持续时间将为 3 天。"
type: docs
weight: 40
...
获取或设置在最佳项目情景下最可能的任务持续时间的百分比。默认值为 75，这意味着如果估计的任务持续时间为 4 天，则乐观持续时间为 3 天。
