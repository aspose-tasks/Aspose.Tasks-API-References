---
title: "枚举 ConfidenceLevel"
second_title: "Aspose.Tasks for .NET API 参考"
description: "Aspose.Tasks.RiskAnalysis.ConfidenceLevel 枚举。指定在风险分析中使用的受支持置信水平，这些水平对应实际值在乐观估计和悲观估计之间的时间百分比。"
type: docs
weight: 1850
...
指定风险分析中使用的受支持置信水平，这些水平对应实际值在乐观和悲观估计范围内出现的时间百分比。
