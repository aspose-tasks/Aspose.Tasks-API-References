...
description: 允许在将项目保存为 Primavera XER 格式时指定其他选项
type: docs
weight: 1870
...
| 姓名 | 描述 |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | 初始化[`PrimaveraSaveOptions`](../primaverasaveoptions)类. |
...
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix) { get; set; } | 获取或设置活动 ID 重新编号时使用的前缀。 |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids) { get; set; } | 获取或设置是否需要重新编号活动ID的值。 |
