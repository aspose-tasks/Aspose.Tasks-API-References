...
description: 允许在将项目页面呈现到 Spreadsheet2003 时指定其他选项
type: docs
weight: 1930
...
允许在将项目页面呈现到 Spreadsheet2003 时指定其他选项。
...
| 姓名 | 描述 |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions)() | 初始化[`Spreadsheet2003SaveOptions`](../spreadsheet2003saveoptions)类的新实例。 |
