...
description: Aspose.Tasks.Saving.PrimaveraXmlSaveOptions 班级. 允许在将项目保存为 Primavera xml 格式时指定其他选项
type: docs
weight: 1890
...
| 姓名 | 描述 |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | 初始化一个新的实例`PrimaveraXmlSaveOptions`类. |
