...
description: Aspose.Tasks.Saving.XlsxOptions 班级. 允许在将项目页面呈现为 XLSX 时指定其他选项
type: docs
weight: 1980
...
| 姓名 | 描述 |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | 初始化一个新的实例`XlsxOptions`可用于以 XLSX 格式保存项目的类。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | 获取或设置要呈现的分配视图列的列表（[`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | 获取或设置生成的 XLSX 文件的编码。默认值为UTF8. |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | 获取或设置要呈现的资源视图列的列表（[`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
