...
| 姓名 | 描述 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | 初始化[`ImageSaveOptions`](../imagesaveoptions)可用于以 TIFF、PNG、BMP 或 JPEG 格式保存渲染图像的类。 |
...
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution) { get; set; } | 获取或设置 dpi 中的垂直分辨率。 |
