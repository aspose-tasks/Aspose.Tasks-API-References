...
description: "Aspose.Tasks.Saving.XpsOptions 类。允许在将项目页面渲染为 XPS 时指定其他选项"
type: docs
weight: 2280
...
| 名称 | 描述 |
| --- | --- |
| [XpsOptions](xpsoptions/)() | 初始化 `XpsOptions` 类的新实例。 |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | 获取或设置一个值，指示是否将元文件渲染为位图。 |
