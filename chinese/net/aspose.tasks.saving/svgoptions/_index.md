...
| 姓名 | 描述 |
| --- | --- |
| [SvgOptions](svgoptions)() | 初始化[`SvgOptions`](../svgoptions)可用于以 SVG 格式保存项目的类。 |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush) { get; set; } | 确定在渲染项目布局时是否使用渐变画笔。 目前不支持使用渐变画笔渲染到 SVG。 |
