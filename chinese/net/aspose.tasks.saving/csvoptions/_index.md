...
description: Aspose.Tasks.Saving.CsvOptions 班级. 允许在将项目保存为 CSV 时指定其他选项
type: docs
weight: 1720
...
| 姓名 | 描述 |
| --- | --- |
| [CsvOptions](csvoptions/)() | 初始化一个新的实例`CsvOptions`可用于以 CSV 格式保存项目的类。 |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | 获取或设置一个值，指示是否包含标头（默认值为 TRUE）。 |
