...
| 姓名 | 描述 |
| --- | --- |
| [PdfDigitalSignatureDetails](pdfdigitalsignaturedetails)(X509Certificate2, string, string, DateTime, PdfDigitalSignatureHashAlgorithm) | 初始化[`PdfDigitalSignatureDetails`](../pdfdigitalsignaturedetails)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Certificate](../../aspose.tasks.saving/pdfdigitalsignaturedetails/certificate) { get; set; } | 获取或设置要签名的证书。 |
...
| [Reason](../../aspose.tasks.saving/pdfdigitalsignaturedetails/reason) { get; set; } | 获取或设置签名的原因。 |
