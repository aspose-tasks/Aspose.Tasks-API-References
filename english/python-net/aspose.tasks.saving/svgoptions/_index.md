...
| Name | Description |
| :- | :- |
|SvgOptions()|Initializes a new instance of the [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) class that can be used to save project in SVG format.|
## Properties
| Name | Description |
| :- | :- |
|save_format|  |
