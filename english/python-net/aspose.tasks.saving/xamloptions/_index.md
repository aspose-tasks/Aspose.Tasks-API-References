...
type: docs
weight: 180
url: /python-net/aspose.tasks.saving/xamloptions/
---
...
| Name | Description |
| :- | :- |
|XamlOptions()|Initializes a new instance of the [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) class that can be used to save project in XAML format.|
## Properties
| Name | Description |
| :- | :- |
|save_format|  |
