...
| Name | Description |
| :- | :- |
|CsvOptions()|Initializes a new instance of the [CsvOptions](/python-net/aspose.tasks.saving/csvoptions/) class which can be used to save project in CSV format.|
## Properties
| Name | Description |
| :- | :- |
