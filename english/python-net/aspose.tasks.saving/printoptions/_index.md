...
| Name | Description |
| :- | :- |
|PrintOptions()|Initializes a new instance of the [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) class that can be used to set different options to print project.|
## Properties
| Name | Description |
| :- | :- |
|save_format|  |
