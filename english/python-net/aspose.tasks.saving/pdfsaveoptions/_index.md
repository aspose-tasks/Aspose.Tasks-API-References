...
| Name | Description |
| :- | :- |
|PdfSaveOptions()|Initializes a new instance of the [PdfSaveOptions](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) class that can be used to save a document in the|
## Properties
| Name | Description |
| :- | :- |
|save_format|  |
...
|compliance|Gets or sets a desired compliance level for generated PDF document.<br/>            Default is [PDF15](/tasks/python-net/aspose.tasks.saving/pdfcompliance/).|
|encryption_details|Gets or sets a encryption details. If not set, then no encryption will be performed.|
|text_compression|Gets or sets a compression type to be used for all content streams except images.<br/>            Default is [FLATE](/tasks/python-net/aspose.tasks.saving/pdftextcompression/).|
...
|page_saving_callback|Gets or sets a user-defined callback which is used to get an output stream for each rendered page.<br/>            Is applicable when [save_to_separate_files](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) option is used.|
