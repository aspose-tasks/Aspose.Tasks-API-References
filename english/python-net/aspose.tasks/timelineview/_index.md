...
| Name | Description |
| :- | :- |
|TimelineView()|Initializes a new instance of the [TimelineView](/tasks/python-net/aspose.tasks/timelineview/) class.|
## Properties
| Name | Description |
| :- | :- |
...
|date_format|Gets or sets a value indicating how to format dates on the Timeline view.|
|display_overlapped|Gets or sets a value indicating whether to display overlapped tasks on multiple rows.|
|show_dates|Gets a value indicating whether to show dates.|
|show_pan_zoom|Gets or sets a value indicating whether to show pan and zoom control.|
|show_timescale|Gets or sets a value indicating whether to show timescale.|
|show_today|Gets or sets a value indicating whether to display a line representing today.|
|text_lines_count|Gets or sets a value indicating how many lines are used to display task in a timeline.|
## Methods
| Name | Description |
| :- | :- |
