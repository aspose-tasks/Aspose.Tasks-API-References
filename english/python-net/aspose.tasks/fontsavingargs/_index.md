...
type: docs
weight: 380
url: /tasks/python-net/aspose.tasks/fontsavingargs/
---

## FontSavingArgs class

This class represents set of data that related to external fonts file's saving that<br/>              occurs during conversion to HTML format.
