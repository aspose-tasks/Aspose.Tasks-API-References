...
type: docs
weight: 1030
url: /tasks/python-net/aspose.tasks/task/
---
...
|is_estimated|Gets or sets a value indicating whether IsEstimated is set or not.|
...
|is_expanded|Gets or sets a value indicating whether IsExpanded is set or not.|
