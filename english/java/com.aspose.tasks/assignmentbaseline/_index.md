...
type: docs
weight: 17
url: /java/com.aspose.tasks/assignmentbaseline/
---
...
| --- | --- | --- |
| other | [AssignmentBaseline](../../com.aspose.tasks/assignmentbaseline) | the specified Baseline object to compare this instance to. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| other | [AssignmentBaseline](../../com.aspose.tasks/assignmentbaseline) | the specified AssignmentBaseline object to compare with this instance. |
