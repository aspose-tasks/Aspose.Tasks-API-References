...
| [getWorkingTimes(Date dt)](#getWorkingTimes-java.util.Date-) | Returns [WorkingTimeCollection](../../com.aspose.tasks/workingtimecollection) of working times. |
| [hashCode()](#hashCode--) | Returns a hash code for the instance of the [Calendar](../../com.aspose.tasks/calendar) class. |
...
Gets the base calendar on which this calendar depends. Only applicable if the calendar is not a base calendar. Read/write [Calendar](../../com.aspose.tasks/calendar).
...
Sets the base calendar on which this calendar depends. Only applicable if the calendar is not a base calendar. Read/write [Calendar](../../com.aspose.tasks/calendar).
...
Returns [WorkingTimeCollection](../../com.aspose.tasks/workingtimecollection) of working times.
...
Returns a hash code for the instance of the [Calendar](../../com.aspose.tasks/calendar) class.
