...
--------------------
 ...
 lookupValue  should be previously added to the [ExtendedAttributeDefinition](../../com.aspose.tasks/extendedattributedefinition) using \#addLookupValue(Value).addLookupValue(Value) method. |
