...
| --- | --- |
| [Table()](#Table--) | Initializes a new instance of the [Table](../../com.aspose.tasks/table) class. |
## Methods
...
Initializes a new instance of the [Table](../../com.aspose.tasks/table) class.
...
**Returns:**
boolean - **True** if the specified object is a Table that has the same UID value as this instance; otherwise, **false**.
...
**Returns:**
int - the unique identifier of a table.
### hashCode() {#hashCode--}
```
public int hashCode()
```
