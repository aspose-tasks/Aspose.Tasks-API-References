...
| --- | --- | --- |
| e | [TaskBaseline](../../com.aspose.tasks/taskbaseline) | The item to add. |
...
**Returns:**
boolean - true if the item has been removed successfully; otherwise, false
### size() {#size--}
```
...
**Returns:**
int - the number of objects contained in this TaskBaselineCollection object.
### toList() {#toList--}
```
...
Converts the TaskBaselineCollection object to a list of [TaskBaseline](../../com.aspose.tasks/taskbaseline) objects.
