...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback) { get; set; } | Gets or sets a user-defined implementation callback which is used to get an output stream for each rendered page. |
