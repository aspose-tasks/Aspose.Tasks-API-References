...
description: AssignmentBaseline property. Gets or sets the scheduled start date of the resource assignment when the baseline was saved. The start date of the resource assignment when this baseline was saved
type: docs
weight: 30
