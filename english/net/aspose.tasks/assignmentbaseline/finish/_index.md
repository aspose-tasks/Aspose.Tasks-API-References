...
description: AssignmentBaseline property. Gets or sets the scheduled finish date of the resource assignment when the baseline was saved. The finish date of the resource assignment when this baseline was saved
type: docs
weight: 20
