...
description: TableField property. Gets or sets a value indicating whether the table column heading can wrap to multiple lines or if it should be truncated when it exceeds the column width
type: docs
weight: 70
