...
description: RateCollection method. Converts the RateCollection object to a list of Rate objects
type: docs
weight: 80
...
Converts the [`RateCollection`](../) object to a list of [`Rate`](../../rate/) objects.
...
Converts the [`RateCollection`](../) object to a list of [`Rate`](../../rate/) objects filtered by specified [`RateType`](../../ratetype/) type.
