...
description: RecurringTaskInfo property. Gets or sets a weekday of the yearly recurrence pattern when using ordinal day. Can be one of the values of DayOfWeek enumeration
type: docs
weight: 190
