...
description: ExtendedAttributeDefinitionCollection method. Removes the first occurrence of a specific object from this collection
type: docs
weight: 130
url: /net/aspose.tasks/extendedattributedefinitioncollection/remove/
---
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | the specified object to remove. |
