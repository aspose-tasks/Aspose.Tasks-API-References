...
| --- | --- | --- |
| array | TimephasedData[] | The one-dimensional Array that is the destination of the elements copied from [`TimephasedDataCollection`](../). The Array must have zero-based indexing. |
...
| ArgumentException | The number of elements in the source [`TimephasedDataCollection`](../) is greater than the available space from *arrayIndex* to the end of the destination *array*. |
