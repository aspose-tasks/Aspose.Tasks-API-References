...
| [Contact](../../aspose.tasks/task/contact/) { get; set; } | Gets or sets a value of Contact. |
...
| [IsExpanded](../../aspose.tasks/task/isexpanded/) { get; set; } | Gets or sets a value indicating whether IsExpanded is set or not. |
