...
description: WBSCodeMaskCollection method. Copies the elements of this collection to the specified array starting at the specified array index
type: docs
weight: 60
url: /net/aspose.tasks/wbscodemaskcollection/copyto/
---
...
| --- | --- | --- |
| array | WBSCodeMask[] | the specified one-dimensional array to copy elements to |
