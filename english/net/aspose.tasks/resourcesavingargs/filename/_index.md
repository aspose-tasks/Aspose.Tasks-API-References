...
description: ResourceSavingArgs property. Gets or sets the supposed file name that goes from converter to code of custom method. Can be use in custom code to decide how to process or where save that file
type: docs
weight: 20
