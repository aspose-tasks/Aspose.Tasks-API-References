...
description: ProjectDisplayOptions property. Gets or sets a value indicating whether to show suggestions when Project identifies a possible scheduling conflict with a manually scheduled task. This option is available for Project 2010 version and later
type: docs
weight: 80
