...
description: TaskTextStyleEventArgs property. Gets or sets TextStyle which will be used to draw the cells content. This object can be use to customize appearance of a table cell
type: docs
weight: 10
