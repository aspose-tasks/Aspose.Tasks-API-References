...
description: ITextStyleModificationCallback method. The method to be called before rendering of a table cell for a task row in the following views Gantt Chart Task Sheet Task Usage
type: docs
weight: 10
