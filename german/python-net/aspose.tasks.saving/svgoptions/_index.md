...
type: docs
weight: 170
url: /de/python-net/aspose.tasks.saving/svgoptions/
---
...
| Name | Beschreibung |
| :- | :- |
| SvgOptions() | Initialisiert eine neue Instanz der [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) Klasse, die verwendet werden kann, um das Projekt im SVG-Format zu speichern. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Bestimmt, ob beim Rendern des Projektlayouts ein Farbverlaufspinsel verwendet werden soll. |
...
| page_saving_callback | Ruft einen benutzerdefinierten Implementierungs‑Callback ab oder legt ihn fest, der verwendet wird, um für jede gerenderte Seite einen Ausgabestream zu erhalten. |
