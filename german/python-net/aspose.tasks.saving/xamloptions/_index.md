...
type: docs
weight: 180
url: /de/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// Ermöglicht das Angeben zusätzlicher Optionen beim Rendern von Projektseiten zu XAML.

Der Typ XamlOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| XamlOptions() | Initialisiert eine neue Instanz der Klasse [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/), die verwendet werden kann, um ein Projekt im XAML-Format zu speichern. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
