...
type: docs
weight: 40
url: /de/python-net/aspose.tasks.saving/imagesaveoptions/
---
...
Der Typ ImageSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ImageSaveOptions(save_format) | Initialisiert eine neue Instanz der [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) Klasse, die zum Speichern gerenderter Bilder im TIFF-, PNG-, BMP- oder JPEG-Format verwendet werden kann. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
...
| pages | Liest oder setzt eine Liste von Seitennummern, die beim Speichern des Projektlayouts in separate Dateien gespeichert werden sollen. |
| jpeg_quality | Liest oder setzt die JPEG-Qualität. Der zulässige Wertebereich ist 0..100. |
...
| tiff_compression | Liest oder setzt den Kompressionstyp, der beim Speichern erzeugter Bilder im TIFF-Format angewendet wird. |
| pixel_format | Liest oder setzt das Format der Farbdaten für jedes Pixel im Bild. |
| horizontal_resolution | Liest oder setzt die horizontale Auflösung in dpi. |
| vertical_resolution | Liest oder setzt die vertikale Auflösung in dpi. |
