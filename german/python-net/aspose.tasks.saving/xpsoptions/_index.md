...
type: docs
weight: 200
url: /de/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

Ermöglicht das Angeben zusätzlicher Optionen beim Rendern von Projektseiten zu XPS.

Der XpsOptions-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| XpsOptions() | Initialisiert eine neue Instanz der [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/) Klasse. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Ruft einen Wert ab oder legt ihn fest, der angibt, ob eine Metadatei als Bitmap gerendert werden soll. |
