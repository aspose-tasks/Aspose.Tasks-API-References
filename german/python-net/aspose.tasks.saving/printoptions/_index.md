...
type: docs
weight: 120
url: /de/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Ermöglicht das Angeben zusätzlicher Optionen beim Drucken des Projekts.

Der PrintOptions-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| PrintOptions() | Initialisiert eine neue Instanz der [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) Klasse, die verwendet werden kann, um verschiedene Optionen zum Drucken des Projekts festzulegen. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
