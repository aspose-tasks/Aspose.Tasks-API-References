...
type: docs
weight: 90
url: /de/python-net/aspose.tasks.saving/pdfsaveoptions/
---
...
Der Typ PdfSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| PdfSaveOptions() | Initialisiert eine neue Instanz der [PdfSaveOptions](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) Klasse, die zum Speichern eines Dokuments verwendet werden kann. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
| save_format |  |
...
| compliance | Liest oder setzt ein gewünschtes Konformitätsniveau für das erzeugte PDF-Dokument.<br/>            Standard ist [PDF15](/tasks/python-net/aspose.tasks.saving/pdfcompliance/). |
| encryption_details | Liest oder setzt die Verschlüsselungsdetails. Wenn nicht gesetzt, wird keine Verschlüsselung durchgeführt. |
| text_compression | Liest oder setzt einen Kompressionstyp, der für alle Inhaltsströme außer Bildern verwendet wird.<br/>            Standard ist [FLATE](/tasks/python-net/aspose.tasks.saving/pdftextcompression/). |
| digital_signature_details | Liest oder setzt die Details der digitalen Signatur. Wenn nicht gesetzt, wird keine Signatur durchgeführt. |
| save_to_separate_files | Liest oder setzt einen Wert, der angibt, ob Projektseiten in separate Dateien gespeichert werden sollen. |
| page_saving_callback | Liest oder setzt einen benutzerdefinierten Callback, der verwendet wird, um einen Ausgabestream für jede gerenderte Seite zu erhalten.<br/>            Gilt, wenn die Option [save_to_separate_files](/tasks/python-net/aspose.tasks.saving/pdfsaveoptions/) verwendet wird. |
| pages | Liest oder setzt die Liste der Seitennummern, die beim Speichern des Projektlayouts in separate Dateien gespeichert werden sollen. |
