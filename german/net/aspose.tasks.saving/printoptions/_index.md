...
description: Ermöglicht die Angabe zusätzlicher Optionen beim Drucken des Projekts.
type: docs
weight: 1890
...
| Name | Beschreibung |
| --- | --- |
| [PrintOptions](printoptions)() | Initialisiert eine neue Instanz von[`PrintOptions`](../printoptions) Klasse, die verwendet werden kann, um verschiedene Optionen zum Drucken des Projekts festzulegen. |
