...
description: Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in SVG.
type: docs
weight: 1940
...
| Name | Beschreibung |
| --- | --- |
| [SvgOptions](svgoptions)() | Initialisiert eine neue Instanz von[`SvgOptions`](../svgoptions) Klasse, die zum Speichern von Projekten im SVG-Format verwendet werden kann. |
