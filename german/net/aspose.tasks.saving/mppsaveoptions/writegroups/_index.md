...
description: "MPPSaveOptions-Eigenschaft. Gibt einen Wert zurück oder legt ihn fest, der angibt, ob Gruppendaten beim Speichern eines Projekts im MPP‑Format geschrieben werden sollen. Gruppendaten umfassen die Sammlungen Project.TaskGroups und Project.ResourceGroups."
type: docs
weight: 60
url: /de/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Gibt einen Wert zurück oder legt ihn fest, der angibt, ob Gruppendaten beim Speichern eines Projekts im MPP‑Format geschrieben werden sollen. Gruppendaten umfassen die Sammlungen Project.TaskGroups und Project.ResourceGroups.
...
Zeigt, wie Gruppen zu einem Projekt hinzugefügt werden.
