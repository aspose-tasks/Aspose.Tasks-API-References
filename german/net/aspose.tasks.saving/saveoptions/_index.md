...
description: Aspose.Tasks.Saving.SaveOptions klas. Dies ist eine abstrakte Basisklasse für Klassen die es dem Benutzer ermöglichen zusätzliche Optionen festzulegen wenn ein Projekt in einem bestimmten Format gespeichert wird.
type: docs
weight: 1920
url: /de/net/aspose.tasks.saving/saveoptions/
---
## SaveOptions class

Dies ist eine abstrakte Basisklasse für Klassen, die es dem Benutzer ermöglichen, zusätzliche Optionen festzulegen, wenn ein Projekt in einem bestimmten Format gespeichert wird.
...
| [PresentationFormat](../../aspose.tasks.saving/saveoptions/presentationformat/) { get; set; } | Ruft ab oder setzt die[`PresentationFormat`](./presentationformat/) in dem das Dokument gespeichert wird. |
...
| [Timescale](../../aspose.tasks.saving/saveoptions/timescale/) { get; set; } | Ruft ab oder setzt die[`Timescale`](./timescale/) Wert, der verwendet wird, um zu steuern, wie die Zeitskala (falls vorhanden) gerendert wird, wenn das Projekt im grafischen Format gespeichert wird. |
