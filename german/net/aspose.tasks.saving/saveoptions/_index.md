...
description: Dies ist eine abstrakte Basisklasse für Klassen die es dem Benutzer ermöglichen zusätzliche Optionen festzulegen wenn ein Projekt in einem bestimmten Format gespeichert wird.
type: docs
weight: 1910
...
Eine Instanz einer beliebigen von der SaveOptions-Klasse abgeleiteten Klasse wird an den Stream Save oder die Zeichenfolge Save überladen übergeben, damit der Benutzer beim Speichern eines Dokuments benutzerdefinierte Optionen definieren kann.
