...
description: Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in XPS.
type: docs
weight: 1980
...
| Name | Beschreibung |
| --- | --- |
| [XpsOptions](xpsoptions)() | Initialisiert eine neue Instanz von[`XpsOptions`](../xpsoptions) Klasse. |
