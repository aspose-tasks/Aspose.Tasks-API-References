...
description: Aspose.Tasks.Saving.PrimaveraXmlSaveOptions klas. Ermöglicht das Festlegen zusätzlicher Optionen beim Speichern des Projekts im PrimaveraXMLFormat.
type: docs
weight: 1890
url: /de/net/aspose.tasks.saving/primaveraxmlsaveoptions/
---
## PrimaveraXmlSaveOptions class

Ermöglicht das Festlegen zusätzlicher Optionen beim Speichern des Projekts im Primavera-XML-Format.
...
| Name | Beschreibung |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Initialisiert eine neue Instanz von`PrimaveraXmlSaveOptions` Klasse. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob eine Root-Aufgabe gespeichert werden soll oder nicht. |
