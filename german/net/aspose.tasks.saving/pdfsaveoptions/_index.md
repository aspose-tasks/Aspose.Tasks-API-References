...
description: Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in PDF.
type: docs
weight: 1850
...
| Name | Beschreibung |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions)() | Initialisiert eine neue Instanz von[`PdfSaveOptions`](../pdfsaveoptions)Klasse, die verwendet werden kann, um ein Dokument in der zu speichern[`Pdf`](../savefileformat) Format. |
