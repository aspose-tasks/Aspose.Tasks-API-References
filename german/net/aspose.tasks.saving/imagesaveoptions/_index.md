...
description: Aspose.Tasks.Saving.ImageSaveOptions klas. Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in Bilder.
type: docs
weight: 1770
...
| Name | Beschreibung |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | Initialisiert eine neue Instanz von`ImageSaveOptions` Klasse, die verwendet werden kann, um gerenderte Bilder in den Formaten TIFF, PNG, BMP oder JPEG zu speichern. |
