...
description: Aspose.Tasks.Saving.XamlOptions klas. /// Ermöglicht die Angabe zusätzlicher Optionen beim Rendern von Projektseiten in XAML.
type: docs
weight: 1970
...
| Name | Beschreibung |
| --- | --- |
| [XamlOptions](xamloptions/)() | Initialisiert eine neue Instanz von`XamlOptions` Klasse, die zum Speichern von Projekten im XAML-Format verwendet werden kann. |
