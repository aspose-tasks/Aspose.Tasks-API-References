...
description: Aspose.Tasks.Saving.CsvOptions klas. Ermöglicht die Angabe zusätzlicher Optionen beim Speichern des Projekts im CSVFormat.
type: docs
weight: 1720
url: /de/net/aspose.tasks.saving/csvoptions/
---
## CsvOptions class

Ermöglicht die Angabe zusätzlicher Optionen beim Speichern des Projekts im CSV-Format.
...
| Name | Beschreibung |
| --- | --- |
| [CsvOptions](csvoptions/)() | Initialisiert eine neue Instanz von`CsvOptions` Klasse, die zum Speichern des Projekts im CSV-Format verwendet werden kann. |
...
| [DataCategory](../../aspose.tasks.saving/csvoptions/datacategory/) { get; set; } | Ruft eine zu speichernde Datenkategorie ab oder legt sie fest. |
...
| [Encoding](../../aspose.tasks.saving/csvoptions/encoding/) { get; set; } | Ruft eine Codierung ab oder legt sie fest, um CSV mit zu speichern. |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob Header eingeschlossen werden sollen oder nicht (Standardwert ist TRUE). |
...
| [TextDelimiter](../../aspose.tasks.saving/csvoptions/textdelimiter/) { get; set; } | Ruft ein Texttrennzeichen ab oder legt es fest. |
