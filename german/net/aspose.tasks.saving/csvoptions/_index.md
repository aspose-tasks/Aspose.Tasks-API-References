...
description: Ermöglicht die Angabe zusätzlicher Optionen beim Speichern des Projekts im CSV-Format.
type: docs
weight: 1710
...
| Name | Beschreibung |
| --- | --- |
| [CsvOptions](csvoptions)() | Initialisiert eine neue Instanz von[`CsvOptions`](../csvoptions) Klasse, die zum Speichern des Projekts im CSV-Format verwendet werden kann. |
