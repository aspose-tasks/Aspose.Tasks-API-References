...
description: Aspose.Tasks.Saving.XlsxOptions klas. Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in XLSX.
type: docs
weight: 1980
url: /de/net/aspose.tasks.saving/xlsxoptions/
---
## XlsxOptions class

Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in XLSX.
...
| Name | Beschreibung |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Initialisiert eine neue Instanz von`XlsxOptions`Klasse, die zum Speichern von Projekten im XLSX-Format verwendet werden kann. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | Ruft eine Liste der zu rendernden Spalten der Zuordnungsansicht ab oder legt sie fest ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Ruft die Codierung der resultierenden XLSX-Datei ab oder legt sie fest. Der Standardwert istUTF8 . |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | Ruft eine Liste der zu rendernden Ressourcenansichtsspalten ab oder legt sie fest ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
