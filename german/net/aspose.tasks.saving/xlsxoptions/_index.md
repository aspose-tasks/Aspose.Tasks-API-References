...
description: Ermöglicht das Festlegen zusätzlicher Optionen beim Rendern von Projektseiten in XLSX.
type: docs
weight: 1970
...
| Name | Beschreibung |
| --- | --- |
| [XlsxOptions](xlsxoptions)() | Initialisiert eine neue Instanz von[`XlsxOptions`](../xlsxoptions)Klasse, die zum Speichern von Projekten im XLSX-Format verwendet werden kann. |
