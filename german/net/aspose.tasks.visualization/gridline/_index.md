...
description: Die horizontale oder vertikale Linie die in der Projektansicht erscheint.
type: docs
weight: 2750
...
| Name | Beschreibung |
| --- | --- |
| [Gridline](gridline)() | Initialisiert eine neue Instanz von[`Gridline`](../gridline) Klasse. |
...
| override [GetHashCode](../../aspose.tasks.visualization/gridline/gethashcode)() | Gibt einen Hashcodewert für die Instanz von zurück[`Gridline`](../gridline) Klasse. |
