...
description: Stellt Seiteneinrichtungsdaten dar die im MPP-Dateiformat vorliegen und zum Drucken verwendet werden.
type: docs
weight: 2840
...
| Name | Beschreibung |
| --- | --- |
| [PageInfo](pageinfo)() | Initialisiert eine neue Instanz von[`PageInfo`](../pageinfo) Klasse. Stellt Seiteneinrichtungsdaten dar, die im MPP-Dateiformat vorliegen und zum Drucken verwendet werden. |
