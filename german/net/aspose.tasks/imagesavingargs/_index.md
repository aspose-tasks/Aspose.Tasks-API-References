...
description: Diese Klasse stellt eine Reihe von Daten dar die sich auf das Speichern einer externen Bilddatei beziehen die während der Konvertierung in das HTML-Format erfolgt.
type: docs
weight: 810
...
| Name | Beschreibung |
| --- | --- |
| [ImageSavingArgs](imagesavingargs)() | Initialisiert eine neue Instanz von[`ImageSavingArgs`](../imagesavingargs) Klasse. |
