...
description: Aspose.Tasks.Rsc klas. Stellt unterstützte Eigenschaften von darResource Objekt.
type: docs
weight: 1700
url: /de/net/aspose.tasks/rsc/
---
## Rsc class

Stellt unterstützte Eigenschaften von dar[`Resource`](../resource/) Objekt.
...
| Name | Beschreibung |
| --- | --- |
| static readonly [AccrueAt](../../aspose.tasks/rsc/accrueat/) | Legt fest, wie und wann Ressourcenstandard- und Überstundenkosten mit den Kosten eines Vorgangs verrechnet oder aufgelaufen werden. |
| static readonly [ActiveDirectoryGuid](../../aspose.tasks/rsc/activedirectoryguid/) | Die Active Directory Guid für eine Ressource. |
| static readonly [ActualCost](../../aspose.tasks/rsc/actualcost/) | Kosten, die für Arbeit entstanden sind, die bereits von Ressourcen an ihren Aufgaben durchgeführt wurde, zusammen mit allen anderen erfassten Kosten im Zusammenhang mit der Aufgabe. |
| static readonly [ActualOvertimeCost](../../aspose.tasks/rsc/actualovertimecost/) | Kosten für Überstunden, die bereits für Aufgaben von zugewiesenen Ressourcen ausgeführt wurden. |
| static readonly [ActualOvertimeWork](../../aspose.tasks/rsc/actualovertimework/) | Die tatsächliche Menge an Überstunden, die bereits von der den Vorgängen zugewiesenen Ressource geleistet wurden. |
| static readonly [ActualOvertimeWorkProtected](../../aspose.tasks/rsc/actualovertimeworkprotected/) | Der Arbeitsumfang, durch den tatsächliche Überstunden geschützt werden. |
| static readonly [ActualWork](../../aspose.tasks/rsc/actualwork/) | Die Menge an Arbeit, die bereits von der den Vorgängen zugewiesenen Ressource erledigt wurde. |
| static readonly [ActualWorkProtected](../../aspose.tasks/rsc/actualworkprotected/) | Die Arbeitsmenge, durch die die tatsächliche Arbeit geschützt ist. |
| static readonly [ACWP](../../aspose.tasks/rsc/acwp/) | Die tatsächlichen Kosten einer Arbeit, die von einer Ressource für das Projekt bis heute ausgeführt wurde. |
| static readonly [AssignmentOwner](../../aspose.tasks/rsc/assignmentowner/) | Der Name eines Zuweisungsbesitzers. |
| static readonly [AssignmentOwnerGuid](../../aspose.tasks/rsc/assignmentownerguid/) | Die GUID eines Zuweisungsbesitzers. |
| static readonly [AvailableFrom](../../aspose.tasks/rsc/availablefrom/) | Das Anfangsdatum, an dem eine Ressource für die Arbeit in den für den aktuellen Zeitraum angegebenen Einheiten verfügbar ist. |
| static readonly [AvailableTo](../../aspose.tasks/rsc/availableto/) | Das Enddatum, an dem eine Ressource für die Arbeit in den für den aktuellen Zeitraum angegebenen Einheiten verfügbar ist. |
| static readonly [BCWP](../../aspose.tasks/rsc/bcwp/) | Die budgetierten Kosten einer Arbeit, die von einer Ressource für das Projekt bis dato durchgeführt wurde. |
| static readonly [BCWS](../../aspose.tasks/rsc/bcws/) | Die Budgetkosten einer für eine Ressource geplanten Arbeit. |
| static readonly [BookingType](../../aspose.tasks/rsc/bookingtype/) | Der Buchungstyp einer Ressource. |
| static readonly [BudgetCost](../../aspose.tasks/rsc/budgetcost/) | Budgetkosten für Budgetkostenressourcen. Budgetressourcen werden nur dem Projektsammelvorgang zugewiesen. |
| static readonly [BudgetWork](../../aspose.tasks/rsc/budgetwork/) | Budgetarbeit für Budgetarbeit und Sachmittel. Budgetressourcen werden nur dem Projektsammelvorgang zugewiesen. |
| static readonly [Calendar](../../aspose.tasks/rsc/calendar/) | Der Kalender einer Ressource. |
| static readonly [CanLevel](../../aspose.tasks/rsc/canlevel/) | Legt fest, ob der Ressourcenabgleich für eine Ressource durchgeführt werden kann. |
| static readonly [Code](../../aspose.tasks/rsc/code/) | Der Code oder andere Informationen zu einer Ressource. |
| static readonly [Cost](../../aspose.tasks/rsc/cost/) | Die geplanten oder prognostizierten Gesamtkosten für eine Ressource, basierend auf den bereits angefallenen Kosten für die Arbeit, die von den Aufgaben zugeordneten Ressourcen durchgeführt wurde, zusätzlich zu den geplanten Kosten für die verbleibende Arbeit. |
| static readonly [CostCenter](../../aspose.tasks/rsc/costcenter/) | Gibt an, welcher Kostenstelle die durch die Ressource angefallenen Kosten belastet werden sollen. |
| static readonly [CostPerUse](../../aspose.tasks/rsc/costperuse/) | Die Kosten, die jedes Mal anfallen, wenn eine Ressource verwendet wird. |
| static readonly [CostVariance](../../aspose.tasks/rsc/costvariance/) | Die Differenz zwischen den Basiskosten und den Gesamtkosten für eine Ressource. |
...
| static readonly [RemainingWork](../../aspose.tasks/rsc/remainingwork/) | Die Zeit, die noch benötigt wird, um eine Aufgabe oder eine Reihe von Aufgaben zu erledigen. |
