...
description: Repräsentiert eine Ansicht in Project.
type: docs
weight: 2540
url: /de/net/aspose.tasks/view/
---
## View class

Repräsentiert eine Ansicht in Project.
...
| Name | Beschreibung |
| --- | --- |
| [View](view#constructor)() | Initialisiert eine neue Instanz von[`View`](../view) Klasse. |
| [View](view#constructor_1)(ViewScreen) | Initialisiert eine neue Instanz von[`View`](../view) Klasse. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo) { get; } | Ruft eine Instanz von ab[`PageInfo`](./pageinfo)Klasse. Stellt Seiteneinrichtungsdaten dar, die im mpp-Dateiformat vorliegen. |
...
| [operator ==](../../aspose.tasks/view/op_equality) | Gibt einen Wert zurück, der angibt, ob diese Instanz gleich einem angegebenen Objekt ist. |
| [operator &gt;](../../aspose.tasks/view/op_greaterthan) | Gibt einen Wert zurück, der angibt, ob diese Instanz größer als ein angegebenes Objekt ist. |
| [operator &gt;=](../../aspose.tasks/view/op_greaterthanorequal) | Gibt einen Wert zurück, der angibt, ob diese Instanz größer oder gleich einem angegebenen Objekt ist. |
| [operator !=](../../aspose.tasks/view/op_inequality) | Gibt einen Wert zurück, der angibt, ob diese Instanz nicht gleich einem angegebenen Objekt ist. |
| [operator &lt;](../../aspose.tasks/view/op_lessthan) | Gibt einen Wert zurück, der angibt, ob diese Instanz kleiner als ein angegebenes Objekt ist. |
| [operator &lt;=](../../aspose.tasks/view/op_lessthanorequal) | Gibt einen Wert zurück, der angibt, ob diese Instanz kleiner oder gleich einem angegebenen Objekt ist. |
