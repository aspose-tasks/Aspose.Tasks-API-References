...
description: Repräsentiert eine Tabelle in Project
type: docs
weight: 2020
...
| Name | Beschreibung |
| --- | --- |
| [Table](table)() | Initialisiert eine neue Instanz von[`Table`](../table) Klasse. |
...
| [ParentProject](../../aspose.tasks/table/parentproject) { get; } | Ruft das übergeordnete Objekt des Tabellenobjekts ab. Schreibgeschützt[`Project`](../project) . |
