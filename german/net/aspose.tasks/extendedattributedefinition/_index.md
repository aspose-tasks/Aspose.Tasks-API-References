...
description: Aspose.Tasks.ExtendedAttributeDefinition klas. Stellt eine erweiterte Attributdefinition dar die einem Projekt zugeordnet ist.
type: docs
weight: 540
...
| [ParentProject](../../aspose.tasks/extendedattributedefinition/parentproject/) { get; } | Ruft das übergeordnete Projekt für die ab`ExtendedAttributeDefinition` Instanz. |
...
| override [GetHashCode](../../aspose.tasks/extendedattributedefinition/gethashcode/)() | Gibt einen Hashcode für die Instanz von zurück`ExtendedAttributeDefinition` Klasse. |
