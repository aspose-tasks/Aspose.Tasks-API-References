...
description: Stellt den Parametersatz dar der verwendet wird um eine wiederkehrende Aufgabe in einem Projekt zu erstellen.
type: docs
weight: 1470
...
| Name | Beschreibung |
| --- | --- |
| [RecurringTaskParameters](recurringtaskparameters)() | Initialisiert eine neue Instanz von[`RecurringTaskParameters`](../recurringtaskparameters) Klasse. |
