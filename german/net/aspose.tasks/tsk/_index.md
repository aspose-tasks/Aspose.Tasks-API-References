...
description: Repräsentiert Eigenschaften vonTask./task Objekt.
type: docs
weight: 2290
url: /de/net/aspose.tasks/tsk/
---
## Tsk class

Repräsentiert Eigenschaften von[`Task`](../task) Objekt.
...
| Name | Beschreibung |
| --- | --- |
| static readonly [ActivityId](../../aspose.tasks/tsk/activityid) | Repräsentiert das Aktivitäts-ID-Feld – die eindeutige Kennung einer Aufgabe, die von Primavera verwendet wird. (gilt nur für Primavera-Projekte). |
| static readonly [ActualCost](../../aspose.tasks/tsk/actualcost) | Kosten, die für Arbeit entstanden sind, die von Ressourcen bereits an ihren Aufgaben durchgeführt wurde, zusammen mit allen anderen erfassten Kosten, die mit der Aufgabe verbunden sind. |
| static readonly [ActualDuration](../../aspose.tasks/tsk/actualduration) | Die Spanne der tatsächlichen Arbeitszeit für eine Aufgabe, basierend auf der geplanten Dauer und der aktuellen verbleibenden Arbeit oder dem abgeschlossenen Prozentsatz. |
| static readonly [ActualFinish](../../aspose.tasks/tsk/actualfinish) | Das Datum, an dem eine Aufgabe abgeschlossen wurde. |
| static readonly [ActualOvertimeCost](../../aspose.tasks/tsk/actualovertimecost) | Kosten für Überstunden, die bereits für Aufgaben von zugewiesenen Ressourcen ausgeführt wurden. |
| static readonly [ActualOvertimeWork](../../aspose.tasks/tsk/actualovertimework) | Die tatsächliche Menge an Überstunden, die bereits von den Aufgaben zugewiesenen Ressourcen geleistet wurden. |
| static readonly [ActualOvertimeWorkProtected](../../aspose.tasks/tsk/actualovertimeworkprotected) | Die Dauer, während der tatsächliche Überstunden geschützt sind.  Lesen wird nur für das XML-Format unterstützt. [`Duration`](./duration) Typ. |
| static readonly [ActualStart](../../aspose.tasks/tsk/actualstart) | Datum und Uhrzeit des tatsächlichen Beginns einer Aufgabe. |
| static readonly [ActualWork](../../aspose.tasks/tsk/actualwork) | Die Menge an Arbeit, die bereits von den Aufgaben zugewiesenen Ressourcen erledigt wurde. |
| static readonly [ActualWorkProtected](../../aspose.tasks/tsk/actualworkprotected) | Die Dauer, während der die tatsächliche Arbeit geschützt ist.  Lesen wird nur für das XML-Format unterstützt. [`Duration`](./duration) Typ. |
| static readonly [ACWP](../../aspose.tasks/tsk/acwp) | Kosten, die für bereits geleistete Arbeit an einer Aufgabe bis zum Projektstatusdatum oder heutigen Datum angefallen sind. |
| static readonly [BCWP](../../aspose.tasks/tsk/bcwp) | Der kumulierte Wert des abgeschlossenen Vorgangs in Prozent multipliziert mit den Basiskosten in Zeitphasen. |
| static readonly [BCWS](../../aspose.tasks/tsk/bcws) | Die kumulierten Basiskosten in Zeitphasen bis zum Statusdatum oder dem heutigen Datum. |
| static readonly [BudgetCost](../../aspose.tasks/tsk/budgetcost) | Budgetkosten für Budgetkostenressourcen. Budgetressourcen werden nur dem Projektsammelvorgang zugewiesen. |
| static readonly [BudgetWork](../../aspose.tasks/tsk/budgetwork) | Budgetarbeit für Budgetarbeit und Sachmittel. Budgetressourcen werden nur dem Projektsammelvorgang zugewiesen. |
| static readonly [Calendar](../../aspose.tasks/tsk/calendar) | Der Aufgabenkalender. |
| static readonly [CommitmentFinish](../../aspose.tasks/tsk/commitmentfinish) | Das Enddatum einer Lieferung.  Lesen wird nur für das XML-Format unterstützt. DateTime Typ. |
| static readonly [CommitmentStart](../../aspose.tasks/tsk/commitmentstart) | Das Startdatum einer Lieferung.  Lesen wird nur für das XML-Format unterstützt. DateTime Typ. |
| static readonly [CommitmentType](../../aspose.tasks/tsk/commitmenttype) | Ermittelt, ob eine Aufgabe eine zugehörige Lieferung oder eine Abhängigkeit von einer zugehörigen Lieferung hat.  Lesen wird nur für das XML-Format unterstützt. Int32 Typ. |
| static readonly [ConstraintDate](../../aspose.tasks/tsk/constraintdate) | Das spezifische Datum, das dem Einschränkungstyp zugeordnet ist. |
| static readonly [ConstraintType](../../aspose.tasks/tsk/constrainttype) | Bietet Auswahlmöglichkeiten für die Art der Einschränkung, die für die Planung einer Aufgabe angewendet werden kann. |
| static readonly [Contact](../../aspose.tasks/tsk/contact) | Der Name einer Person, die für eine Aufgabe verantwortlich ist. |
| static readonly [Cost](../../aspose.tasks/tsk/cost) | Die geplanten oder prognostizierten Gesamtkosten für einen Vorgang, basierend auf Kosten, die bereits für Arbeiten entstanden sind, die von Ressourcen ausgeführt wurden, die den Vorgängen zugeordnet sind, zusätzlich zu den Kosten, die für die verbleibende Arbeit geplant sind. |
| static readonly [CostVariance](../../aspose.tasks/tsk/costvariance) | Die Differenz zwischen den Basiskosten und den Gesamtkosten für einen Vorgang, eine Ressource oder einen Auftrag. |
| static readonly [Created](../../aspose.tasks/tsk/created) | Das Datum, an dem eine Aufgabe erstellt wurde. |
...
| static readonly [DisplayAsSummary](../../aspose.tasks/tsk/displayassummary) | Legt fest, ob die Aufgabe als Sammelaufgabe angezeigt werden soll.  Lesen wird nur für das XML-Format unterstützt. Boolean Typ. |
...
| static readonly [IsExpanded](../../aspose.tasks/tsk/isexpanded) | Bestimmt, ob ein Sammelvorgang in der GanttChart-Ansicht erweitert wird oder nicht. |
...
| static readonly [RemainingCost](../../aspose.tasks/tsk/remainingcost) | Die verbleibenden geplanten Ausgaben, die für die Fertigstellung der verbleibenden geplanten Arbeit anfallen. |
