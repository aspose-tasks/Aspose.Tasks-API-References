...
description: Stellt eine Sammlung dar die enthältRate./rate Objekte.
type: docs
weight: 1370
...
| [ToList](../../aspose.tasks/ratecollection/tolist#tolist)() | Konvertiert die[`RateCollection`](../ratecollection) Widerspruch gegen eine Liste von[`Rate`](../rate) Objekte. |
| [ToList](../../aspose.tasks/ratecollection/tolist#tolist_1)(RateType) | Konvertiert die[`RateCollection`](../ratecollection) Widerspruch gegen eine Liste von[`Rate`](../rate) Objekte gefiltert nach angegeben[`RateType`](../ratetype) Typ. |
