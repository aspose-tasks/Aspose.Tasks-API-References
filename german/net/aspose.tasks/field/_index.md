...
| ResourceBaseline1Finish | `205521245` | Repräsentiert das Feld „Geplantes Ende 1 (Ressource)“. |
...
| ResourceBaseline7Start | `205521304` | Stellt das Feld Baseline7 Start (Ressource) dar. |
...
| ResourceCost6 | `205521064` | Repräsentiert das Feld Cost6 (Ressource). |
...
| ResourceEnterpriseCost10 | `205521351` | Stellt das Feld Enterprise Cost10 (Ressource) dar. |
...
| ResourceEnterpriseDate8 | `205521359` | Stellt das Feld Enterprise Date8 (Ressource) dar. |
...
| ResourceEnterpriseMultiValue21 | `205521598` | Repräsentiert das Feld Enterprise MultiValue21 (Ressource). |
...
| ResourceEnterpriseNumber34 | `205521475` | Repräsentiert das Feld Unternehmensnummer34 (Ressource). |
...
| ResourceEnterpriseOutlineCode5 | `205521490` | Repräsentiert das Feld Enterprise Outline Code5 (Ressource). |
...
| ResourceEnterpriseText36 | `205521577` | Repräsentiert das Feld Enterprise Text36 (Ressource). |
...
| ResourceFlag3 | `205521025` | Repräsentiert das Feld Flag3 (Ressource). |
...
| ResourceNumber19 | `205521114` | Repräsentiert das Feld Number19 (Ressource). |
...
| ResourceStart | `205521161` | Repräsentiert das Startfeld (Ressource). |
...
| ResourceText30 | `205521140` | Repräsentiert das Feld Text30 (Ressource). |
...
| TaskBaseline10DeliverableStart | `188744924` | Stellt das Feld „Geplanter Beginn der Lieferung (Aufgabe)“ dar. |
...
| TaskBaseline2Work | `188744176` | Repräsentiert das Feld Geplante Arbeit (Aufgabe)2. |
...
| TaskBaseline5Finish | `188744207` | Repräsentiert das Feld Geplantes Ende 5 (Aufgabe). |
...
| TaskBaseline8DeliverableFinish | `188744911` | Stellt das Feld „Geplantes Ende der zu liefernden Leistung (Aufgabe)“ dar. |
...
| TaskBaselineStartText | `188744979` | Repräsentiert das Feld Geplanter Starttext (Aufgabe). |
...
| TaskDate7 | `188743951` | Repräsentiert das Feld Date7 (Aufgabe). |
...
| TaskEarnedValueMethod | `188744802` | Repräsentiert das Feld Earned Value Method (Task). |
...
| TaskEnterpriseDate5 | `188744293` | Stellt das Feld Enterprise Date5 (Aufgabe) dar. |
...
| TaskEnterpriseNumber11 | `188744389` | Repräsentiert das Feld Unternehmensnummer11 (Aufgabe). |
...
| TaskEnterpriseNumber9 | `188744387` | Repräsentiert das Feld Unternehmensnummer9 (Aufgabe). |
...
| TaskEnterpriseProjectCost6 | `188744534` | Repräsentiert das Feld Enterprise Project Cost6 (Task). |
...
| TaskEnterpriseProjectDate26 | `188744564` | Stellt das Enterprise-Projektdatum26 (Aufgabe)-Feld dar. |
| TaskEnterpriseProjectDate27 | `188744565` | Stellt das Enterprise-Projektdatum27 (Aufgabe)-Feld dar. |
| TaskEnterpriseProjectDate28 | `188744566` | Stellt das Enterprise-Projektdatum28 (Aufgabe)-Feld dar. |
| TaskEnterpriseProjectDate29 | `188744567` | Stellt das Enterprise-Projektdatum29 (Aufgabe)-Feld dar. |
| TaskEnterpriseProjectDate3 | `188744541` | Stellt das Enterprise Project Date3 (Task)-Feld dar. |
| TaskEnterpriseProjectDate30 | `188744568` | Stellt das Enterprise-Projektdatum30 (Aufgabe)-Feld dar. |
| TaskEnterpriseProjectDate4 | `188744542` | Stellt das Enterprise Project Date4 (Task)-Feld dar. |
| TaskEnterpriseProjectDate5 | `188744543` | Stellt das Enterprise Project Date5 (Task)-Feld dar. |
| TaskEnterpriseProjectDate6 | `188744544` | Stellt das Enterprise Project Date6 (Task)-Feld dar. |
| TaskEnterpriseProjectDate7 | `188744545` | Stellt das Enterprise Project Date7 (Task)-Feld dar. |
| TaskEnterpriseProjectDate8 | `188744546` | Stellt das Enterprise Project Date8 (Task)-Feld dar. |
| TaskEnterpriseProjectDate9 | `188744547` | Stellt das Enterprise Project Date9 (Task)-Feld dar. |
| TaskEnterpriseProjectDuration1 | `188744569` | Stellt das Feld Enterprise-Projektdauer1 (Aufgabe) dar. |
| TaskEnterpriseProjectDuration10 | `188744578` | Stellt das Feld Enterprise Project Duration10 (Task) dar. |
| TaskEnterpriseProjectDuration2 | `188744570` | Stellt das Feld Enterprise Project Duration2 (Task) dar. |
| TaskEnterpriseProjectDuration3 | `188744571` | Stellt das Feld Enterprise Project Duration3 (Task) dar. |
| TaskEnterpriseProjectDuration4 | `188744572` | Stellt das Feld Enterprise Project Duration4 (Task) dar. |
| TaskEnterpriseProjectDuration5 | `188744573` | Stellt das Feld Enterprise Project Duration5 (Task) dar. |
| TaskEnterpriseProjectDuration6 | `188744574` | Stellt das Feld Enterprise-Projektdauer6 (Aufgabe) dar. |
| TaskEnterpriseProjectDuration7 | `188744575` | Stellt das Feld Enterprise Project Duration7 (Task) dar. |
| TaskEnterpriseProjectDuration8 | `188744576` | Stellt das Feld Enterprise-Projektdauer8 (Aufgabe) dar. |
| TaskEnterpriseProjectDuration9 | `188744577` | Stellt das Feld Enterprise Project Duration9 (Task) dar. |
| TaskEnterpriseProjectFlag1 | `188744649` | Repräsentiert das Feld Enterprise Project Flag1 (Task). |
| TaskEnterpriseProjectFlag10 | `188744658` | Repräsentiert das Feld Enterprise Project Flag10 (Task). |
| TaskEnterpriseProjectFlag11 | `188744659` | Repräsentiert das Feld Enterprise Project Flag11 (Task). |
| TaskEnterpriseProjectFlag12 | `188744660` | Repräsentiert das Feld Enterprise Project Flag12 (Task). |
| TaskEnterpriseProjectFlag13 | `188744661` | Repräsentiert das Feld Enterprise Project Flag13 (Task). |
| TaskEnterpriseProjectFlag14 | `188744662` | Repräsentiert das Feld Enterprise Project Flag14 (Task). |
| TaskEnterpriseProjectFlag15 | `188744663` | Repräsentiert das Feld Enterprise Project Flag15 (Task). |
| TaskEnterpriseProjectFlag16 | `188744664` | Repräsentiert das Feld Enterprise Project Flag16 (Task). |
| TaskEnterpriseProjectFlag17 | `188744665` | Repräsentiert das Feld Enterprise Project Flag17 (Task). |
| TaskEnterpriseProjectFlag18 | `188744666` | Repräsentiert das Feld Enterprise Project Flag18 (Task). |
| TaskEnterpriseProjectFlag19 | `188744667` | Repräsentiert das Feld Enterprise Project Flag19 (Task). |
| TaskEnterpriseProjectFlag2 | `188744650` | Repräsentiert das Feld Enterprise Project Flag2 (Task). |
| TaskEnterpriseProjectFlag20 | `188744668` | Repräsentiert das Feld Enterprise Project Flag20 (Task). |
| TaskEnterpriseProjectFlag3 | `188744651` | Repräsentiert das Feld Enterprise Project Flag3 (Task). |
| TaskEnterpriseProjectFlag4 | `188744652` | Repräsentiert das Feld Enterprise Project Flag4 (Task). |
| TaskEnterpriseProjectFlag5 | `188744653` | Repräsentiert das Feld Enterprise Project Flag5 (Task). |
| TaskEnterpriseProjectFlag6 | `188744654` | Repräsentiert das Feld Enterprise Project Flag6 (Task). |
| TaskEnterpriseProjectFlag7 | `188744655` | Repräsentiert das Feld Enterprise Project Flag7 (Task). |
| TaskEnterpriseProjectFlag8 | `188744656` | Repräsentiert das Feld Enterprise Project Flag8 (Task). |
| TaskEnterpriseProjectFlag9 | `188744657` | Repräsentiert das Feld Enterprise Project Flag9 (Task). |
| TaskEnterpriseProjectNumber1 | `188744689` | Repräsentiert das Feld Enterprise Project Number1 (Task). |
| TaskEnterpriseProjectNumber10 | `188744698` | Repräsentiert das Feld Enterprise-Projektnummer10 (Aufgabe). |
| TaskEnterpriseProjectNumber11 | `188744699` | Repräsentiert das Feld Enterprise-Projektnummer11 (Aufgabe). |
| TaskEnterpriseProjectNumber12 | `188744700` | Repräsentiert das Feld Enterprise-Projektnummer12 (Aufgabe). |
| TaskEnterpriseProjectNumber13 | `188744701` | Repräsentiert das Feld Enterprise-Projektnummer13 (Aufgabe). |
| TaskEnterpriseProjectNumber14 | `188744702` | Repräsentiert das Feld Enterprise-Projektnummer14 (Aufgabe). |
| TaskEnterpriseProjectNumber15 | `188744703` | Repräsentiert das Feld Enterprise-Projektnummer15 (Aufgabe). |
| TaskEnterpriseProjectNumber16 | `188744704` | Repräsentiert das Feld Enterprise-Projektnummer16 (Aufgabe). |
| TaskEnterpriseProjectNumber17 | `188744705` | Repräsentiert das Feld Enterprise-Projektnummer17 (Aufgabe). |
| TaskEnterpriseProjectNumber18 | `188744706` | Repräsentiert das Feld Enterprise-Projektnummer18 (Aufgabe). |
| TaskEnterpriseProjectNumber19 | `188744707` | Repräsentiert das Feld Enterprise-Projektnummer19 (Aufgabe). |
| TaskEnterpriseProjectNumber2 | `188744690` | Repräsentiert das Feld Enterprise Project Number2 (Task). |
| TaskEnterpriseProjectNumber20 | `188744708` | Repräsentiert das Feld Enterprise-Projektnummer20 (Aufgabe). |
| TaskEnterpriseProjectNumber21 | `188744709` | Repräsentiert das Feld Enterprise-Projektnummer21 (Aufgabe). |
| TaskEnterpriseProjectNumber22 | `188744710` | Repräsentiert das Feld Enterprise-Projektnummer22 (Aufgabe). |
| TaskEnterpriseProjectNumber23 | `188744711` | Repräsentiert das Feld Enterprise-Projektnummer23 (Aufgabe). |
| TaskEnterpriseProjectNumber24 | `188744712` | Repräsentiert das Feld Enterprise-Projektnummer24 (Aufgabe). |
| TaskEnterpriseProjectNumber25 | `188744713` | Repräsentiert das Feld Enterprise-Projektnummer25 (Aufgabe). |
| TaskEnterpriseProjectNumber26 | `188744714` | Repräsentiert das Feld Enterprise-Projektnummer26 (Aufgabe). |
| TaskEnterpriseProjectNumber27 | `188744715` | Repräsentiert das Feld Enterprise-Projektnummer27 (Aufgabe). |
| TaskEnterpriseProjectNumber28 | `188744716` | Repräsentiert das Feld Enterprise-Projektnummer28 (Aufgabe). |
| TaskEnterpriseProjectNumber29 | `188744717` | Repräsentiert das Feld Enterprise-Projektnummer29 (Aufgabe). |
| TaskEnterpriseProjectNumber3 | `188744691` | Repräsentiert das Feld Enterprise-Projektnummer3 (Aufgabe). |
| TaskEnterpriseProjectNumber30 | `188744718` | Stellt das Enterprise-Projektnummer30-Feld (Aufgabe) dar. |
| TaskEnterpriseProjectNumber31 | `188744719` | Repräsentiert das Feld Enterprise-Projektnummer31 (Aufgabe). |
| TaskEnterpriseProjectNumber32 | `188744720` | Repräsentiert das Feld Enterprise-Projektnummer32 (Aufgabe). |
| TaskEnterpriseProjectNumber33 | `188744721` | Stellt das Enterprise-Projektnummer33-Feld (Aufgabe) dar. |
| TaskEnterpriseProjectNumber34 | `188744722` | Stellt das Enterprise-Projektnummer34-Feld (Aufgabe) dar. |
| TaskEnterpriseProjectNumber35 | `188744723` | Repräsentiert das Feld Enterprise-Projektnummer35 (Aufgabe). |
| TaskEnterpriseProjectNumber36 | `188744724` | Repräsentiert das Feld Enterprise-Projektnummer36 (Aufgabe). |
| TaskEnterpriseProjectNumber37 | `188744725` | Repräsentiert das Feld Enterprise-Projektnummer37 (Aufgabe). |
| TaskEnterpriseProjectNumber38 | `188744726` | Repräsentiert das Feld Enterprise-Projektnummer38 (Aufgabe). |
| TaskEnterpriseProjectNumber39 | `188744727` | Repräsentiert das Feld Enterprise-Projektnummer39 (Aufgabe). |
| TaskEnterpriseProjectNumber4 | `188744692` | Repräsentiert das Feld Enterprise Project Number4(Task). |
| TaskEnterpriseProjectNumber40 | `188744728` | Repräsentiert das Feld Enterprise-Projektnummer40 (Aufgabe). |
| TaskEnterpriseProjectNumber5 | `188744693` | Repräsentiert das Feld Enterprise-Projektnummer5 (Aufgabe). |
| TaskEnterpriseProjectNumber6 | `188744694` | Repräsentiert das Feld Enterprise-Projektnummer6 (Aufgabe). |
| TaskEnterpriseProjectNumber7 | `188744695` | Repräsentiert das Feld Enterprise-Projektnummer7 (Aufgabe). |
| TaskEnterpriseProjectNumber8 | `188744696` | Repräsentiert das Feld Enterprise-Projektnummer8 (Aufgabe). |
| TaskEnterpriseProjectNumber9 | `188744697` | Repräsentiert das Feld Enterprise-Projektnummer9 (Aufgabe). |
| TaskEnterpriseProjectOutlineCode1 | `188744589` | Repräsentiert das Enterprise Project OutlineCode1 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode10 | `188744598` | Repräsentiert das Feld Enterprise Project OutlineCode10 (Task). |
| TaskEnterpriseProjectOutlineCode11 | `188744599` | Repräsentiert das Feld Enterprise Project OutlineCode11 (Task). |
| TaskEnterpriseProjectOutlineCode12 | `188744600` | Repräsentiert das Feld Enterprise Project OutlineCode12 (Task). |
| TaskEnterpriseProjectOutlineCode13 | `188744601` | Repräsentiert das Feld Enterprise Project OutlineCode13 (Task). |
| TaskEnterpriseProjectOutlineCode14 | `188744602` | Repräsentiert das Feld Enterprise Project OutlineCode14 (Task). |
| TaskEnterpriseProjectOutlineCode15 | `188744603` | Repräsentiert das Feld Enterprise Project OutlineCode15 (Task). |
| TaskEnterpriseProjectOutlineCode16 | `188744604` | Stellt das Enterprise Project OutlineCode16 (Task)-Feld dar. |
| TaskEnterpriseProjectOutlineCode17 | `188744605` | Repräsentiert das Feld Enterprise Project OutlineCode17 (Task). |
| TaskEnterpriseProjectOutlineCode18 | `188744606` | Repräsentiert das Feld Enterprise Project OutlineCode18 (Task). |
| TaskEnterpriseProjectOutlineCode19 | `188744607` | Repräsentiert das Feld Enterprise Project OutlineCode19 (Task). |
| TaskEnterpriseProjectOutlineCode2 | `188744590` | Repräsentiert das Enterprise Project OutlineCode2 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode20 | `188744608` | Repräsentiert das Enterprise Project OutlineCode2 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode21 | `188744609` | Repräsentiert das Feld Enterprise Project OutlineCode21 (Task). |
| TaskEnterpriseProjectOutlineCode22 | `188744610` | Repräsentiert das Feld Enterprise Project OutlineCode22 (Task). |
| TaskEnterpriseProjectOutlineCode23 | `188744611` | Repräsentiert das Feld Enterprise Project OutlineCode23 (Task). |
| TaskEnterpriseProjectOutlineCode24 | `188744612` | Repräsentiert das Enterprise Project OutlineCode24 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode25 | `188744613` | Repräsentiert das Feld Enterprise Project OutlineCode25 (Task). |
| TaskEnterpriseProjectOutlineCode26 | `188744614` | Repräsentiert das Feld Enterprise Project OutlineCode26 (Task). |
| TaskEnterpriseProjectOutlineCode27 | `188744615` | Repräsentiert das Feld Enterprise Project OutlineCode27 (Task). |
| TaskEnterpriseProjectOutlineCode28 | `188744616` | Repräsentiert das Feld Enterprise Project OutlineCode28 (Task). |
| TaskEnterpriseProjectOutlineCode29 | `188744617` | Repräsentiert das Enterprise Project OutlineCode29 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode3 | `188744591` | Repräsentiert das Enterprise Project OutlineCode3 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode30 | `188744618` | Stellt das Enterprise Project OutlineCode30 (Task)-Feld dar. |
| TaskEnterpriseProjectOutlineCode4 | `188744592` | Repräsentiert das Enterprise Project OutlineCode4 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode5 | `188744593` | Stellt das Enterprise Project OutlineCode5 (Task)-Feld dar. |
| TaskEnterpriseProjectOutlineCode6 | `188744594` | Repräsentiert das Enterprise Project OutlineCode6 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode7 | `188744595` | Stellt das Enterprise Project OutlineCode7 (Task)-Feld dar. |
| TaskEnterpriseProjectOutlineCode8 | `188744596` | Repräsentiert das Enterprise Project OutlineCode8 (Task)-Feld. |
| TaskEnterpriseProjectOutlineCode9 | `188744597` | Repräsentiert das Feld Enterprise Project OutlineCode9 (Task). |
| TaskEnterpriseProjectText1 | `188744729` | Repräsentiert das Feld Enterprise Project Text1 (Task). |
| TaskEnterpriseProjectText10 | `188744738` | Repräsentiert das Feld Enterprise Project Text10 (Task). |
| TaskEnterpriseProjectText11 | `188744739` | Repräsentiert das Feld Enterprise Project Text11 (Task). |
| TaskEnterpriseProjectText12 | `188744740` | Repräsentiert das Feld Enterprise Project Text12 (Task). |
| TaskEnterpriseProjectText13 | `188744741` | Repräsentiert das Feld Enterprise Project Text13 (Task). |
| TaskEnterpriseProjectText14 | `188744742` | Repräsentiert das Feld Enterprise Project Text14 (Task). |
| TaskEnterpriseProjectText15 | `188744743` | Repräsentiert das Feld Enterprise Project Text15 (Task). |
| TaskEnterpriseProjectText16 | `188744744` | Repräsentiert das Feld Enterprise Project Text16 (Task). |
| TaskEnterpriseProjectText17 | `188744745` | Repräsentiert das Feld Enterprise Project Text17 (Task). |
| TaskEnterpriseProjectText18 | `188744746` | Repräsentiert das Feld Enterprise Project Text18 (Task). |
| TaskEnterpriseProjectText19 | `188744747` | Repräsentiert das Feld Enterprise Project Text19 (Task). |
| TaskEnterpriseProjectText2 | `188744730` | Repräsentiert das Feld Enterprise Project Text2 (Task). |
| TaskEnterpriseProjectText20 | `188744748` | Repräsentiert das Feld Enterprise Project Text20 (Task). |
| TaskEnterpriseProjectText21 | `188744749` | Repräsentiert das Feld Enterprise Project Text21 (Task). |
| TaskEnterpriseProjectText22 | `188744750` | Repräsentiert das Feld Enterprise Project Text22 (Task). |
| TaskEnterpriseProjectText23 | `188744751` | Repräsentiert das Feld Enterprise Project Text23 (Task). |
| TaskEnterpriseProjectText24 | `188744752` | Repräsentiert das Feld Enterprise Project Text24 (Task). |
| TaskEnterpriseProjectText25 | `188744753` | Repräsentiert das Feld Enterprise Project Text25 (Task). |
| TaskEnterpriseProjectText26 | `188744754` | Repräsentiert das Feld Enterprise Project Text26 (Task). |
| TaskEnterpriseProjectText27 | `188744755` | Repräsentiert das Feld Enterprise Project Text27 (Task). |
| TaskEnterpriseProjectText28 | `188744756` | Repräsentiert das Feld Enterprise Project Text28 (Task). |
| TaskEnterpriseProjectText29 | `188744757` | Repräsentiert das Feld Enterprise Project Text29 (Task). |
| TaskEnterpriseProjectText3 | `188744731` | Repräsentiert das Feld Enterprise Project Text3 (Task). |
| TaskEnterpriseProjectText30 | `188744758` | Repräsentiert das Feld Enterprise Project Text30 (Task). |
| TaskEnterpriseProjectText31 | `188744759` | Repräsentiert das Feld Enterprise Project Text31 (Task). |
| TaskEnterpriseProjectText32 | `188744760` | Repräsentiert das Feld Enterprise Project Text32 (Task). |
| TaskEnterpriseProjectText33 | `188744761` | Repräsentiert das Feld Enterprise Project Text33 (Task). |
| TaskEnterpriseProjectText34 | `188744762` | Repräsentiert das Feld Enterprise Project Text34 (Task). |
| TaskEnterpriseProjectText35 | `188744763` | Repräsentiert das Feld Enterprise Project Text35 (Task). |
| TaskEnterpriseProjectText36 | `188744764` | Repräsentiert das Feld Enterprise Project Text36 (Task). |
| TaskEnterpriseProjectText37 | `188744765` | Repräsentiert das Feld Enterprise Project Text37 (Task). |
| TaskEnterpriseProjectText38 | `188744766` | Repräsentiert das Feld Enterprise Project Text38 (Task). |
| TaskEnterpriseProjectText39 | `188744767` | Repräsentiert das Feld Enterprise Project Text39 (Task). |
| TaskEnterpriseProjectText4 | `188744732` | Repräsentiert das Feld Enterprise Project Text4 (Task). |
| TaskEnterpriseProjectText40 | `188744768` | Repräsentiert das Feld Enterprise Project Text40 (Task). |
| TaskEnterpriseProjectText5 | `188744733` | Repräsentiert das Feld Enterprise Project Text5 (Task). |
| TaskEnterpriseProjectText6 | `188744734` | Repräsentiert das Feld Enterprise Project Text6 (Task). |
| TaskEnterpriseProjectText7 | `188744735` | Repräsentiert das Feld Enterprise Project Text7 (Task). |
| TaskEnterpriseProjectText8 | `188744736` | Repräsentiert das Feld Enterprise Project Text8 (Task). |
| TaskEnterpriseProjectText9 | `188744737` | Repräsentiert das Feld Enterprise Project Text9(Task). |
| TaskEnterpriseText1 | `188744479` | Repräsentiert das Feld Enterprise Text1 (Task). |
| TaskEnterpriseText10 | `188744488` | Repräsentiert das Feld Enterprise Text10 (Task). |
| TaskEnterpriseText11 | `188744489` | Repräsentiert das Feld Enterprise Text11 (Task). |
| TaskEnterpriseText12 | `188744490` | Repräsentiert das Feld Enterprise Text12 (Task). |
| TaskEnterpriseText13 | `188744491` | Repräsentiert das Feld Enterprise Text13 (Task). |
| TaskEnterpriseText14 | `188744492` | Repräsentiert das Feld Enterprise Text14 (Task). |
| TaskEnterpriseText15 | `188744493` | Repräsentiert das Feld Enterprise Text15 (Task). |
| TaskEnterpriseText16 | `188744494` | Repräsentiert das Feld Enterprise Text16 (Task). |
| TaskEnterpriseText17 | `188744495` | Repräsentiert das Feld Enterprise Text17 (Task). |
| TaskEnterpriseText18 | `188744496` | Repräsentiert das Feld Enterprise Text18 (Task). |
| TaskEnterpriseText19 | `188744497` | Repräsentiert das Feld Enterprise Text19 (Task). |
| TaskEnterpriseText2 | `188744480` | Repräsentiert das Enterprise-Text2-Feld (Aufgabe). |
| TaskEnterpriseText20 | `188744498` | Repräsentiert das Feld Enterprise Text20 (Task). |
| TaskEnterpriseText21 | `188744499` | Repräsentiert das Feld Enterprise Text21 (Task). |
| TaskEnterpriseText22 | `188744500` | Repräsentiert das Feld Enterprise Text22 (Task). |
| TaskEnterpriseText23 | `188744501` | Repräsentiert das Feld Enterprise Text23 (Task). |
| TaskEnterpriseText24 | `188744502` | Repräsentiert das Feld Enterprise Text24 (Task). |
| TaskEnterpriseText25 | `188744503` | Repräsentiert das Feld Enterprise Text25 (Task). |
| TaskEnterpriseText26 | `188744504` | Repräsentiert das Feld Enterprise Text26 (Task). |
| TaskEnterpriseText27 | `188744505` | Repräsentiert das Feld Enterprise Text27 (Task). |
| TaskEnterpriseText28 | `188744506` | Repräsentiert das Feld Enterprise Text28 (Task). |
| TaskEnterpriseText29 | `188744507` | Repräsentiert das Feld Enterprise Text29 (Task). |
| TaskEnterpriseText3 | `188744481` | Repräsentiert das Enterprise-Text3-Feld (Aufgabe). |
| TaskEnterpriseText30 | `188744508` | Repräsentiert das Enterprise-Text30-Feld (Aufgabe). |
| TaskEnterpriseText31 | `188744509` | Repräsentiert das Feld Enterprise Text31 (Task). |
| TaskEnterpriseText32 | `188744510` | Repräsentiert das Feld Enterprise Text32 (Task). |
| TaskEnterpriseText33 | `188744511` | Repräsentiert das Feld Enterprise Text33 (Task). |
| TaskEnterpriseText34 | `188744512` | Repräsentiert das Feld Enterprise Text34 (Task). |
| TaskEnterpriseText35 | `188744513` | Repräsentiert das Feld Enterprise Text35 (Task). |
| TaskEnterpriseText36 | `188744514` | Repräsentiert das Feld Enterprise Text36 (Task). |
| TaskEnterpriseText37 | `188744515` | Repräsentiert das Feld Enterprise Text37 (Task). |
| TaskEnterpriseText38 | `188744516` | Repräsentiert das Enterprise-Text38-Feld (Aufgabe). |
| TaskEnterpriseText39 | `188744517` | Repräsentiert das Feld Enterprise Text39 (Task). |
| TaskEnterpriseText4 | `188744482` | Repräsentiert das Feld Enterprise Text4 (Task). |
| TaskEnterpriseText40 | `188744518` | Repräsentiert das Feld Enterprise Text40 (Task). |
| TaskEnterpriseText5 | `188744483` | Repräsentiert das Feld Enterprise Text5 (Task). |
| TaskEnterpriseText6 | `188744484` | Repräsentiert das Feld Enterprise Text6 (Task). |
| TaskEnterpriseText7 | `188744485` | Repräsentiert das Feld Enterprise Text7 (Task). |
| TaskEnterpriseText8 | `188744486` | Repräsentiert das Feld Enterprise Text8 (Task). |
| TaskEnterpriseText9 | `188744487` | Repräsentiert das Feld Enterprise Text9 (Task). |
| TaskErrorMessage | `188744847` | Stellt das Feld Fehlermeldung (Aufgabe) dar. |
| TaskEstimated | `188744076` | Repräsentiert das Feld Geschätzt (Aufgabe). |
| TaskExternalTask | `188743912` | Repräsentiert das Feld Externe Aufgabe (Aufgabe). |
| TaskFinish | `188743716` | Repräsentiert das Feld Ende (Aufgabe). |
| TaskFinish1 | `188743733` | Repräsentiert das Feld Finish1 (Task). |
| TaskFinish10 | `188743971` | Repräsentiert das Feld Finish10 (Task). |
| TaskFinish2 | `188743736` | Repräsentiert das Feld Finish2 (Task). |
| TaskFinish3 | `188743739` | Repräsentiert das Feld Finish3 (Task). |
| TaskFinish4 | `188743742` | Repräsentiert das Feld Finish4 (Task). |
| TaskFinish5 | `188743745` | Repräsentiert das Feld Finish5 (Task). |
| TaskFinish6 | `188743963` | Repräsentiert das Feld Finish6 (Task). |
| TaskFinish7 | `188743965` | Repräsentiert das Feld Finish7 (Task). |
| TaskFinish8 | `188743967` | Repräsentiert das Feld Finish8 (Task). |
| TaskFinish9 | `188743969` | Repräsentiert das Feld Finish9 (Task). |
| TaskFinishSlack | `188744119` | Repräsentiert das Feld Pufferzeit beenden (Aufgabe). |
| TaskFinishText | `188744966` | Repräsentiert das Feld Task Finish Text (Task). |
| TaskFinishVariance | `188743726` | Repräsentiert das Feld Endabweichung (Vorgang). |
| TaskFixedCost | `188743688` | Stellt das Feld Fixkosten (Vorgang) dar. |
| TaskFixedCostAccrual | `188743880` | Stellt das Feld Fixkostenabgrenzung (Vorgang) dar. |
| TaskFixedDuration | `188743714` | Repräsentiert das Feld Feste Dauer (Aufgabe). |
| TaskFlag1 | `188743752` | Repräsentiert das Feld Flag1 (Task). |
| TaskFlag10 | `188743761` | Repräsentiert das Feld Flag10 (Task). |
| TaskFlag11 | `188743972` | Repräsentiert das Feld Flag11 (Task). |
| TaskFlag12 | `188743973` | Repräsentiert das Feld Flag12 (Task). |
| TaskFlag13 | `188743974` | Repräsentiert das Feld Flag13 (Task). |
| TaskFlag14 | `188743975` | Repräsentiert das Feld Flag14 (Task). |
| TaskFlag15 | `188743976` | Repräsentiert das Feld Flag15 (Task). |
| TaskFlag16 | `188743977` | Repräsentiert das Feld Flag16 (Task). |
| TaskFlag17 | `188743978` | Repräsentiert das Feld Flag17 (Task). |
| TaskFlag18 | `188743979` | Repräsentiert das Feld Flag18 (Task). |
| TaskFlag19 | `188743980` | Repräsentiert das Feld Flag19 (Task). |
| TaskFlag2 | `188743753` | Repräsentiert das Feld Flag2 (Task). |
| TaskFlag20 | `188743981` | Repräsentiert das Feld Flag20 (Task). |
| TaskFlag3 | `188743754` | Repräsentiert das Feld Flag3 (Task). |
| TaskFlag4 | `188743755` | Repräsentiert das Feld Flag4 (Task). |
| TaskFlag5 | `188743756` | Repräsentiert das Feld Flag5 (Task). |
| TaskFlag6 | `188743757` | Repräsentiert das Feld Flag6 (Task). |
| TaskFlag7 | `188743758` | Repräsentiert das Feld Flag7 (Task). |
| TaskFlag8 | `188743759` | Repräsentiert das Feld Flag8 (Task). |
| TaskFlag9 | `188743760` | Repräsentiert das Feld Flag9 (Task). |
| TaskFreeSlack | `188743701` | Repräsentiert das Feld Freie Pufferzeit (Aufgabe). |
| TaskGroupBySummary | `188744126` | Repräsentiert das Feld Gruppieren nach Zusammenfassung (Aufgabe). |
| TaskGuid | `188744823` | Stellt das Aufgaben-GUID-Feld (Aufgabe) dar. |
| TaskHideBar | `188743789` | Repräsentiert das Feld Leiste ausblenden (Aufgabe). |
| TaskHyperlinkId | `188743895` | Repräsentiert das Feld Hyperlink-ID (Aufgabe). |
| TaskHyperlink | `188743897` | Repräsentiert das Feld Hyperlink (Aufgabe). |
| TaskHyperlinkAddress | `188743898` | Repräsentiert das Feld Hyperlink-Adresse (Aufgabe). |
| TaskHyperlinkHref | `188743900` | Repräsentiert das Feld Hyperlink HRef (Task). |
| TaskHyperlinkScreenTip | `188744132` | Repräsentiert das Feld Hyperlink-QuickInfo (Aufgabe). |
| TaskHyperlinkSubAddress | `188743899` | Repräsentiert das Feld Hyperlink Sub Address (Task). |
| TaskID | `188743703` | Repräsentiert das Feld ID (Aufgabe). |
| TaskIgnoreResourceCalendar | `188744079` | Repräsentiert das Feld "Ressourcenkalender ignorieren (Aufgabe)". |
| TaskIgnoreWarnings | `188745012` | Repräsentiert das Feld Task Ignore Warnings (Task). |
| TaskIndex | `188744040` | Repräsentiert das Feld Index (Aufgabe). |
| TaskIndicators | `188743885` | Repräsentiert das Feld Indikatoren (Aufgabe). |
| TaskIsAssignment | `188743904` | Stellt das Feld „Ist Zuweisung (Aufgabe)“ dar. |
| TaskIsDurationValid | `188744977` | Stellt das Feld dar, das anzeigt, ob die Aufgabendauer gültig ist, wenn von einer manuellen zu einer automatisch geplanten Aufgabe konvertiert wird. |
| TaskIsFinishValid | `188744976` | Stellt das Feld dar, das anzeigt, ob das Enddatum der Aufgabe gültig ist, wenn von einer manuellen zu einer automatisch geplanten Aufgabe konvertiert wird. |
| TaskIsStartValid | `188744975` | Stellt das Feld dar, das anzeigt, ob das Startdatum der Aufgabe gültig ist, wenn von einer manuellen zu einer automatisch geplanten Aufgabe konvertiert wird. |
| TaskIsPublished | `188744845` | Stellt das Feld „Ist veröffentlicht (Aufgabe)“ dar. |
| TaskLateFinish | `188743720` | Repräsentiert das Feld Spätes Ende (Aufgabe). |
| TaskLateStart | `188743719` | Repräsentiert das Feld Spätstart (Aufgabe). |
| TaskLevelAssignments | `188743933` | Repräsentiert das Feld Ebenenzuweisungen (Aufgabe). |
| TaskLevelCanSplit | `188743932` | Repräsentiert das Feld Level Can Split (Task). |
| TaskLevelDelay | `188743700` | Repräsentiert das Feld „Ebenenverzögerung (Aufgabe)“. |
| TaskLinkedFields | `188743778` | Repräsentiert das Feld Verknüpfte Felder (Aufgabe). |
| TaskManual | `188744960` | Repräsentiert das Feld Task Manual (TASK). |
| TaskMarked | `188743751` | Repräsentiert das Feld Markiert (Aufgabe). |
| TaskMilestone | `188743704` | Repräsentiert das Feld Meilenstein (Aufgabe). |
| TaskName | `188743694` | Repräsentiert das Feld Name (Aufgabe). |
| TaskNotes | `188743695` | Repräsentiert das Feld Notizen (Aufgabe). |
| TaskNumber1 | `188743767` | Repräsentiert das Feld Nummer1 (Aufgabe). |
| TaskNumber10 | `188743986` | Repräsentiert das Feld Number10 (Task). |
| TaskNumber11 | `188743987` | Repräsentiert das Feld Nummer11 (Aufgabe). |
| TaskNumber12 | `188743988` | Repräsentiert das Feld Number12 (Task). |
| TaskNumber13 | `188743989` | Repräsentiert das Feld Number13 (Task). |
| TaskNumber14 | `188743990` | Repräsentiert das Feld Number14 (Task). |
| TaskNumber15 | `188743991` | Repräsentiert das Feld Number15 (Task).. |
| TaskNumber16 | `188743992` | Repräsentiert das Feld Number16 (Task). |
| TaskNumber17 | `188743993` | Repräsentiert das Feld Nummer17 (Aufgabe). |
| TaskNumber18 | `188743994` | Repräsentiert das Feld Number18 (Task). |
| TaskNumber19 | `188743995` | Repräsentiert das Feld Number19 (Task). |
| TaskNumber2 | `188743768` | Repräsentiert das Feld Nummer2 (Aufgabe). |
| TaskNumber20 | `188743996` | Repräsentiert das Feld Number20 (Task). |
| TaskNumber3 | `188743769` | Repräsentiert das Feld Nummer3 (Aufgabe). |
| TaskNumber4 | `188743770` | Repräsentiert das Feld Number4 (Task). |
| TaskNumber5 | `188743771` | Repräsentiert das Feld Nummer5 (Aufgabe). |
| TaskNumber6 | `188743982` | Repräsentiert das Feld Nummer6 (Aufgabe). |
| TaskNumber7 | `188743983` | Repräsentiert das Feld Number7 (Task). |
| TaskNumber8 | `188743984` | Repräsentiert das Feld Number8 (Task). |
| TaskNumber9 | `188743985` | Repräsentiert das Feld Number9 (Task). |
| TaskObjects | `188743777` | Repräsentiert das Feld Objekte (Aufgabe). |
| TaskOutlineCode1 | `188744096` | Repräsentiert das Feld Gliederungscode1 (Aufgabe). |
| TaskOutlineCode10 | `188744114` | Repräsentiert das Feld Gliederungscode10 (Aufgabe). |
| TaskOutlineCode2 | `188744098` | Repräsentiert das Feld Gliederungscode2 (Aufgabe). |
| TaskOutlineCode3 | `188744100` | Repräsentiert das Feld Gliederungscode3 (Aufgabe). |
| TaskOutlineCode4 | `188744102` | Repräsentiert das Feld Gliederungscode4 (Aufgabe). |
| TaskOutlineCode5 | `188744104` | Repräsentiert das Feld Gliederungscode5 (Aufgabe). |
| TaskOutlineCode6 | `188744106` | Repräsentiert das Feld Gliederungscode6 (Aufgabe). |
| TaskOutlineCode7 | `188744108` | Repräsentiert das Feld Gliederungscode7 (Aufgabe). |
| TaskOutlineCode8 | `188744110` | Repräsentiert das Feld Gliederungscode8 (Aufgabe). |
| TaskOutlineCode9 | `188744112` | Repräsentiert das Feld Gliederungscode9 (Aufgabe). |
| TaskOutlineLevel | `188743765` | Repräsentiert das Feld Gliederungsebene (Aufgabe). |
| TaskOutlineNumber | `188743782` | Repräsentiert das Feld Gliederungscode (Aufgabe). |
| TaskOverallocated | `188743905` | Repräsentiert das Feld „Überlastet (Aufgabe)“. |
| TaskOvertimeCost | `188743848` | Repräsentiert das Feld Überstundenkosten (Aufgabe). |
| TaskOvertimeWork | `188743843` | Repräsentiert das Feld Überstundenarbeit (Aufgabe). |
| TaskPathDrivenSuccessor | `188745063` | Das getriebene Nachfolgerfeld für einen Aufgabenpfad. Siehe die Task.PathDrivenSuccessor-Eigenschaft. |
| TaskPathDrivingPredecessor | `188745061` | Das treibende Vorgängerfeld für einen Aufgabenpfad. Siehe die Task.PathDrivingPredecessor-Eigenschaft. |
| TaskPathPredecessor | `188745062` | Das Vorgängerfeld für einen Aufgabenpfad. Siehe die Task.PathPredecessor-Eigenschaft. |
| TaskPathSuccessor | `188745064` | Das Nachfolgefeld für einen Aufgabenpfad. Siehe die Task.PathSuccessor-Eigenschaft. |
| TaskSummaryName | `188745085` | Der Name des Sammelvorgangs, der dem Vorgang zugeordnet ist. |
| TaskParentTask | `188743815` | Repräsentiert das übergeordnete Aufgabenfeld (Aufgabe). |
| TaskPercentComplete | `188743712` | Stellt das Feld „Prozent abgeschlossen (Aufgabe)“ dar. |
| TaskPercentWorkComplete | `188743713` | Stellt das Feld „Prozent Arbeit abgeschlossen (Aufgabe)“ dar. |
| TaskPhysicalPercentComplete | `188744799` | Repräsentiert das Feld "Physischer Prozentsatz abgeschlossen (Aufgabe)". |
| TaskPlaceholder | `188744961` | Repräsentiert das Aufgabenplatzhalterfeld (Aufgabe). |
| TaskPredecessors | `188743727` | Repräsentiert das Feld Predecessors (Task). Die Aufgaben-ID-Nummern für die Vorgängeraufgaben, von denen die Aufgabe abhängig ist, bevor sie gestartet oder beendet werden kann. |
| TaskPreleveledFinish | `188744050` | Repräsentiert das Feld Vorab abgeglichenes Ende (Aufgabe). |
| TaskPreleveledStart | `188744049` | Repräsentiert das Feld Vorab abgeglichener Start (Aufgabe). |
| TaskPriority | `188743705` | Repräsentiert das Feld Priorität (Aufgabe). |
| TaskProject | `188743764` | Repräsentiert das Feld Projekt (Aufgabe). |
| TaskRecalcFlags | `188744930` | Repräsentiert das Feld Neuberechnungs-Flags (Task). |
| TaskRecurring | `188743809` | Repräsentiert das Feld Wiederkehrend (Aufgabe). |
| TaskRegularWork | `188743846` | Repräsentiert das Feld Reguläre Arbeit (Aufgabe). |
| TaskRemainingCost | `188743690` | Stellt das Feld Verbleibende Kosten (Aufgabe) dar. |
| TaskRemainingDuration | `188743711` | Repräsentiert das Feld Verbleibende Dauer (Aufgabe). |
| TaskRemainingOvertimeCost | `188743850` | Stellt das Feld Verbleibende Überstundenkosten (Vorgang) dar. |
| TaskRemainingOvertimeWork | `188743845` | Repräsentiert das Feld Verbleibende Überstundenarbeit (Vorgang). |
| TaskRemainingWork | `188743684` | Repräsentiert das Feld Verbleibende Arbeit (Vorgang). |
| TaskResourceEnterpriseMultiValueCode20 | `188744809` | Repräsentiert das Feld Enterprise Resource MultiValue Code20 (Task). |
| TaskResourceEnterpriseMultiValueCode21 | `188744810` | Repräsentiert das Feld Enterprise Resource MultiValue Code21 (Task). |
| TaskResourceEnterpriseMultiValueCode22 | `188744811` | Repräsentiert das Feld Enterprise Resource MultiValue Code22 (Task). |
| TaskResourceEnterpriseMultiValueCode23 | `188744812` | Repräsentiert das Feld Enterprise Resource MultiValue Code23 (Task). |
| TaskResourceEnterpriseMultiValueCode24 | `188744813` | Repräsentiert das Feld Enterprise Resource MultiValue Code24 (Task). |
| TaskResourceEnterpriseMultiValueCode25 | `188744814` | Repräsentiert das Feld Enterprise Resource MultiValue Code25 (Task). |
| TaskResourceEnterpriseMultiValueCode26 | `188744815` | Repräsentiert das Feld Enterprise Resource MultiValue Code26 (Task). |
| TaskResourceEnterpriseMultiValueCode27 | `188744816` | Repräsentiert das Feld Enterprise Resource MultiValue Code27 (Task). |
| TaskResourceEnterpriseMultiValueCode28 | `188744817` | Repräsentiert das Feld Enterprise Resource MultiValue Code28 (Task). |
| TaskResourceEnterpriseMultiValueCode29 | `188744818` | Repräsentiert das Feld Enterprise Resource MultiValue Code29 (Task). |
| TaskResourceEnterpriseOutlineCode1 | `188744769` | Repräsentiert das Feld Enterprise Resource Outline Code1 (Task). |
| TaskResourceEnterpriseOutlineCode10 | `188744778` | Repräsentiert das Feld Enterprise Resource Outline Code10 (Task). |
| TaskResourceEnterpriseOutlineCode11 | `188744779` | Repräsentiert das Feld Enterprise Resource Outline Code11 (Task). |
| TaskResourceEnterpriseOutlineCode12 | `188744780` | Repräsentiert das Feld Enterprise Resource Outline Code12 (Task). |
| TaskResourceEnterpriseOutlineCode13 | `188744781` | Repräsentiert das Feld Enterprise Resource Outline Code13 (Task). |
| TaskResourceEnterpriseOutlineCode14 | `188744782` | Repräsentiert das Feld Enterprise Resource Outline Code14 (Task). |
| TaskResourceEnterpriseOutlineCode15 | `188744783` | Repräsentiert das Feld Enterprise Resource Outline Code15 (Task). |
| TaskResourceEnterpriseOutlineCode16 | `188744784` | Repräsentiert das Feld Enterprise Resource Outline Code16 (Task). |
| TaskResourceEnterpriseOutlineCode17 | `188744785` | Repräsentiert das Feld Enterprise Resource Outline Code17 (Task). |
| TaskResourceEnterpriseOutlineCode18 | `188744786` | Repräsentiert das Feld Enterprise Resource Outline Code18 (Task). |
| TaskResourceEnterpriseOutlineCode19 | `188744787` | Repräsentiert das Feld Enterprise Resource Outline Code19 (Task). |
| TaskResourceEnterpriseOutlineCode2 | `188744770` | Repräsentiert das Feld Enterprise Resource Outline Code2 (Task). |
| TaskResourceEnterpriseOutlineCode20 | `188744788` | Repräsentiert das Feld Enterprise Resource Outline Code20 (Task). |
| TaskResourceEnterpriseOutlineCode21 | `188744789` | Repräsentiert das Feld Enterprise Resource Outline Code21 (Task). |
| TaskResourceEnterpriseOutlineCode22 | `188744790` | Repräsentiert das Feld Enterprise Resource Outline Code22 (Task). |
| TaskResourceEnterpriseOutlineCode23 | `188744791` | Repräsentiert das Feld Enterprise Resource Outline Code23 (Task). |
| TaskResourceEnterpriseOutlineCode24 | `188744792` | Repräsentiert das Feld Enterprise Resource Outline Code24 (Task). |
| TaskResourceEnterpriseOutlineCode25 | `188744793` | Repräsentiert das Feld Enterprise Resource Outline Code25 (Task). |
| TaskResourceEnterpriseOutlineCode26 | `188744794` | Repräsentiert das Feld Enterprise Resource Outline Code26 (Task). |
| TaskResourceEnterpriseOutlineCode27 | `188744795` | Repräsentiert das Feld Enterprise Resource Outline Code27 (Task). |
| TaskResourceEnterpriseOutlineCode28 | `188744796` | Repräsentiert das Feld Enterprise Resource Outline Code28 (Task). |
| TaskResourceEnterpriseOutlineCode29 | `188744797` | Repräsentiert das Feld Enterprise Resource Outline Code29 (Task). |
| TaskResourceEnterpriseOutlineCode3 | `188744771` | Repräsentiert das Feld Enterprise Resource Outline Code3 (Task). |
| TaskResourceEnterpriseOutlineCode4 | `188744772` | Repräsentiert das Feld Enterprise Resource Outline Code4 (Task). |
| TaskResourceEnterpriseOutlineCode5 | `188744773` | Repräsentiert das Feld Enterprise Resource Outline Code5 (Task). |
| TaskResourceEnterpriseOutlineCode6 | `188744774` | Repräsentiert das Feld Enterprise Resource Outline Code6 (Task). |
| TaskResourceEnterpriseOutlineCode7 | `188744775` | Repräsentiert das Feld Enterprise Resource Outline Code7 (Task). |
| TaskResourceEnterpriseOutlineCode8 | `188744776` | Repräsentiert das Feld Enterprise Resource Outline Code8 (Task). |
| TaskResourceEnterpriseOutlineCode9 | `188744777` | Repräsentiert das Feld Enterprise Resource Outline Code9 (Task). |
| TaskResourceEnterpriseRBS | `188744798` | Repräsentiert das Enterprise-Ressourcen-RBS-Feld (Task). |
| TaskResourceGroup | `188743793` | Repräsentiert das Feld Ressourcengruppe (Aufgabe). |
| TaskResourceInitials | `188743730` | Repräsentiert das Feld Ressourceninitialen (Aufgabe). |
| TaskResourceNames | `188743729` | Repräsentiert das Feld Ressourcennamen (Aufgabe). |
| TaskResourcePhonetics | `188744029` | Repräsentiert das Feld Ressourcenphonetik (Aufgabe). |
| TaskResourceType | `188744131` | Repräsentiert das Feld Ressourcentyp (Aufgabe). |
| TaskResponsePending | `188743930` | Stellt das Feld Antwort ausstehend (Aufgabe) dar. |
| TaskResume | `188743779` | Repräsentiert das Feld Lebenslauf (Aufgabe). |
| TaskResumeNoEarlierThan | `188743781` | Repräsentiert das Feld Lebenslauf nicht früher als (Aufgabe). |
| TaskRollup | `188743762` | Repräsentiert das Rollup-Feld (Aufgabe). |
| TaskScheduledDuration | `188745020` | Repräsentiert das Feld Task Scheduled Duration (Task). |
| TaskScheduledFinish | `188745019` | Repräsentiert das Feld Task Scheduled Finish (Task). |
| TaskScheduledStart | `188745018` | Repräsentiert das Feld Task Scheduled Start (Task). |
| TaskSheetNotes | `188743774` | Repräsentiert das Feld Blattnotizen (Aufgabe). |
| TaskSPI | `188744218` | Repräsentiert das SPI-Feld (Task). |
| TaskStart | `188743715` | Repräsentiert das Startfeld (Aufgabe). |
| TaskStart1 | `188743732` | Repräsentiert das Feld Start1 (Task). |
| TaskStart10 | `188743970` | Repräsentiert das Feld Start10 (Task). |
| TaskStart2 | `188743735` | Repräsentiert das Feld Start2 (Aufgabe). |
| TaskStart3 | `188743738` | Repräsentiert das Feld Start3 (Task). |
| TaskStart4 | `188743741` | Repräsentiert das Feld Start4 (Task). |
| TaskStart5 | `188743744` | Repräsentiert das Feld Start5 (Task). |
| TaskStart6 | `188743962` | Repräsentiert das Feld Start6 (Aufgabe). |
| TaskStart7 | `188743964` | Repräsentiert das Feld Start7 (Task). |
| TaskStart8 | `188743966` | Repräsentiert das Feld Start8 (Task). |
| TaskStart9 | `188743968` | Repräsentiert das Feld Start9 (Task). |
| TaskStartSlack | `188744118` | Repräsentiert das Feld Start Slack (Task). |
| TaskStartText | `188744965` | Repräsentiert das Feld Aufgabenstarttext (Aufgabe). |
| TaskStartVariance | `188743725` | Stellt das Feld Anfangsabweichung (Vorgang) dar. |
| TaskStatus | `188744223` | Repräsentiert das Feld Status (Aufgabe). |
| TaskStatusIndicator | `188744801` | Repräsentiert das Feld Statusanzeige (Aufgabe). |
| TaskStatusManagerName | `188744846` | Repräsentiert das Feld Status Manager Name (Task). |
| TaskStop | `188743780` | Repräsentiert das Feld Stopp (Aufgabe). |
| TaskSubproject | `188743706` | Repräsentiert das Feld Unterprojekt (Aufgabe). |
| TaskSubprojectReadOnly | `188743926` | Stellt das Feld „Schreibgeschützt (Aufgabe)“ des Teilprojekts dar. |
| TaskSuccessors | `188743728` | Repräsentiert das Feld Nachfolger (Aufgabe). Die Aufgaben-ID-Nummern für die Nachfolgeaufgaben einer Aufgabe. |
| TaskSummary | `188743772` | Repräsentiert das Feld Zusammenfassung (Aufgabe). |
| TaskSV | `188743693` | Repräsentiert das Feld SV (Task). |
| TaskSVPercent | `188744220` | Repräsentiert das Feld SV Prozent (Aufgabe). |
| TaskTCPI | `188744222` | Repräsentiert das Feld TCPI (Task). |
| TaskTeamStatusPending | `188743931` | Stellt das Feld „Teamstatus ausstehend (Aufgabe)“ dar. |
| TaskText1 | `188743731` | Repräsentiert das Feld Text1 (Task). |
| TaskText10 | `188743750` | Repräsentiert das Feld Text10 (Task). |
| TaskText11 | `188743997` | Repräsentiert das Feld Text11 (Task). |
| TaskText12 | `188743998` | Repräsentiert das Feld Text12 (Task). |
| TaskText13 | `188743999` | Repräsentiert das Feld Text13 (Task). |
| TaskText14 | `188744000` | Repräsentiert das Feld Text14 (Task). |
| TaskText15 | `188744001` | Repräsentiert das Feld Text15 (Task). |
| TaskText16 | `188744002` | Repräsentiert das Feld Text16 (Task). |
| TaskText17 | `188744003` | Repräsentiert das Feld Text17 (Task). |
| TaskText18 | `188744004` | Repräsentiert das Feld Text18 (Task). |
| TaskText19 | `188744005` | Repräsentiert das Feld Text19 (Task). |
| TaskText2 | `188743734` | Repräsentiert das Feld Text2 (Task). |
| TaskText20 | `188744006` | Repräsentiert das Feld Text20 (Task). |
| TaskText21 | `188744007` | Repräsentiert das Feld Text21 (Task). |
| TaskText22 | `188744008` | Repräsentiert das Feld Text22 (Task). |
| TaskText23 | `188744009` | Repräsentiert das Feld Text23 (Task). |
| TaskText24 | `188744010` | Repräsentiert das Feld Text24 (Task). |
| TaskText25 | `188744011` | Repräsentiert das Feld Text25 (Task). |
| TaskText26 | `188744012` | Repräsentiert das Feld Text26 (Task). |
| TaskText27 | `188744013` | Repräsentiert das Feld Text27 (Task). |
| TaskText28 | `188744014` | Repräsentiert das Feld Text28 (Task). |
| TaskText29 | `188744015` | Repräsentiert das Feld Text29 (Task). |
| TaskText3 | `188743737` | Repräsentiert das Feld Text3 (Task). |
| TaskText30 | `188744016` | Repräsentiert das Feld Text30 (Task). |
| TaskText4 | `188743740` | Repräsentiert das Feld Text4 (Task). |
| TaskText5 | `188743743` | Repräsentiert das Feld Text5 (Task). |
| TaskText6 | `188743746` | Repräsentiert das Feld Text6 (Task). |
| TaskText7 | `188743747` | Repräsentiert das Feld Text7 (Task). |
| TaskText8 | `188743748` | Repräsentiert das Feld Text8 (Task). |
| TaskText9 | `188743749` | Repräsentiert das Feld Text9 (Task). |
| TaskTotalSlack | `188743702` | Stellt das Feld Total Slack (Task) dar. |
| TaskType | `188743808` | Repräsentiert das Feld Typ (Aufgabe). |
| TaskUniqueID | `188743766` | Repräsentiert das Feld Eindeutige ID (Aufgabe). |
| TaskUniquePredecessors | `188743775` | Repräsentiert das Feld Unique ID Predecessors (Task). |
| TaskUniqueSuccessors | `188743776` | Repräsentiert das Feld Unique ID Successors (Task). |
| TaskUpdateNeeded | `188743791` | Stellt das Feld Aktualisierung erforderlich (Aufgabe) dar. |
| TaskVAC | `188744121` | Repräsentiert das Feld VAC (Aufgabe). |
| TaskWarning | `188744962` | Repräsentiert das Feld Aufgabenwarnung (Aufgabe). |
| TaskWBS | `188743696` | Repräsentiert das PSP-Feld (Vorgang). |
| TaskWBSPredecessors | `188744129` | Repräsentiert das Feld PSP-Vorgänger (Vorgang). |
| TaskWBSSuccessors | `188744130` | Repräsentiert das Feld PSP-Nachfolger (Vorgang). |
| TaskWork | `188743680` | Repräsentiert das Feld Arbeit (Aufgabe). |
| TaskWorkContour | `188743936` | Repräsentiert das Feld Arbeitskontur (Aufgabe). |
| TaskWorkVariance | `188743683` | Repräsentiert das Feld Arbeitsabweichung (Aufgabe). |
| TaskCompleteThrough | `188743799` | Nur im Dialogfeld Balkenstile in MSP verfügbar und wird im Gantt-Diagramm als Balken dargestellt. |
| TaskBaseLineFixedCost | `188744160` | Stellt das Feld Geplante Fixkosten (Vorgang) dar. |
| ResourceAssignmentGuid | `255853180` | Repräsentiert das Feld GUID (Zuweisung). |
| ResourceAssignmentBaseLineStart | `255852690` | Stellt das Feld Geplanter Start (Zuweisung) dar. |
| ResourceAssignmentBaseLineFinish | `255852691` | Stellt das Feld Geplantes Ende (Aufgabe) dar. |
| ResourceAssignmentBaseLineCost | `255852576` | Stellt das Feld Geplante Kosten (Zuweisung) dar. |
| ResourceAssignmentBaseLineWork | `255852560` | Stellt das Feld Geplante Arbeit (Zuweisung) dar. |
| ResourceAssignmentBaseLineCostPerUse | `255852811` | Stellt das Feld Geplante Kosten pro Verwendung (Zuweisung) dar. |
