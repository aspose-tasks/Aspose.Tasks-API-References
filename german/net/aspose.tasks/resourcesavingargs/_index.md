...
description: Diese Klasse stellt eine Reihe von Daten dar die sich auf das Speichern einer externen Ressourcendatei beziehen die während der Konvertierung in das HTML-Format erfolgt.
type: docs
weight: 1530
url: /de/net/aspose.tasks/resourcesavingargs/
---
## ResourceSavingArgs class

Diese Klasse stellt eine Reihe von Daten dar, die sich auf das Speichern einer externen Ressourcendatei beziehen, die während der Konvertierung in das HTML-Format erfolgt.
