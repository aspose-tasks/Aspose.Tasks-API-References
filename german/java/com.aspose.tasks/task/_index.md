...
type: docs
weight: 289
url: /de/java/com.aspose.tasks/task/
---
...
Die **Task** stellt ein einzelnes atomares Arbeitselement dar.

Man kann **Task** verwenden, um ein Projekt zu planen, indem man Aufgaben erstellt und geeignete Ressourcen zuweist. Aufgaben in einem Projekt sind als baumartige hierarchische Struktur mit einer Wurzelaufgabe und Unterbäumen von Kindaufgaben organisiert.

Um einen Aufgabenbaum zu erstellen, kann man eine spezialisierte Sammlung [TaskCollection](../../com.aspose.tasks/taskcollection) verwenden, indem man auf die `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) Eigenschaft zugreift, z.B.:
...
Task task1 = project.RootTask.Children.Add(); // ein übergeordneter Task mit leerem Namen wird hinzugefügt
...
Task childTask2 = task1.Children.Add("Child 2", 2); // fügt eine Aufgabe vor childTask3 ein
