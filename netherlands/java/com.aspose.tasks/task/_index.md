...
description: "Stelt een taak in een project voor."
type: docs
weight: 289
url: /nl/java/com.aspose.tasks/task/
---
...
Stelt een taak in een project voor.
...
Om een boom van taken op te bouwen kan men een gespecialiseerde collectie [TaskCollection](../../com.aspose.tasks/taskcollection) gebruiken door de eigenschap `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) te benaderen, bijvoorbeeld:
...
Task task1 = project.RootTask.Children.Add(); // een bovenliggende taak met een lege naam wordt toegevoegd
...
Task childTask2 = task1.Children.Add("Child 2", 2); // voegt een taak toe vóór de childTask3
