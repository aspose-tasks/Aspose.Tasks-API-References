...
type: docs
weight: 287
url: /nl/java/com.aspose.tasks/tablefieldcollection/
---
...
Bevat een lijst met [TableField](../../com.aspose/tasks/tablefield) objecten. Implementeert de IList&lt;TableField&gt; interface.
## Methoden
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | Retourneert de index van het opgegeven item in deze collectie. |
...
Retourneert de index van het opgegeven item in deze collectie.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | het opgegeven item. |

**Returns:**
int - index van het item.
### indexOf(Object o) {#indexOf-java.lang.Object-}
```
