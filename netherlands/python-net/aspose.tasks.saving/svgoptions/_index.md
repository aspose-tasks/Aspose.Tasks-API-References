...
type: docs
weight: 170
url: /nl/python-net/aspose.tasks.saving/svgoptions/
---

## SvgOptions class

Staat toe om extra opties op te geven bij het renderen van projectpagina's naar SVG.

Het type SvgOptions biedt de volgende leden weer:
## Constructors
| Naam | Beschrijving |
| :- | :- |
| SvgOptions() | Initialiseert een nieuw exemplaar van de [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) klasse die kan worden gebruikt om een project op te slaan in SVG-formaat. |
## Eigenschappen
| Naam | Beschrijving |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Bepaalt of een gradientkwast moet worden gebruikt bij het renderen van de projectlay-out. |
...
| page_saving_callback | Haalt of stelt een door de gebruiker gedefinieerde implementatie-callback in die wordt gebruikt om een uitvoer-stream voor elke gerenderde pagina te verkrijgen. |
