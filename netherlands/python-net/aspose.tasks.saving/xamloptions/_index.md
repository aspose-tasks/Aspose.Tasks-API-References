...
type: docs
weight: 180
url: /nl/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// Stelt toe om extra opties op te geven bij het renderen van projectpagina's naar XAML.

Het type XamlOptions bevat de volgende leden:
## Constructors
| Naam | Beschrijving |
| :- | :- |
| XamlOptions() | Initialiseert een nieuw exemplaar van de [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) klasse die kan worden gebruikt om een project op te slaan in XAML‑formaat. |
## Eigenschappen
| Naam | Beschrijving |
| :- | :- |
| save_format |  |
