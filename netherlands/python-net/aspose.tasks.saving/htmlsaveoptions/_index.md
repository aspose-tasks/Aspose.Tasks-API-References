...
type: docs
weight: 20
url: /nl/python-net/aspose.tasks.saving/htmlsaveoptions/
---

## HtmlSaveOptions class

Staat toe om extra opties op te geven bij het renderen van projectpagina's naar HTML.

Het HtmlSaveOptions-type geeft de volgende leden weer:
## Constructors
| Naam | Beschrijving |
| :- | :- |
| HtmlSaveOptions() | Initialiseert een nieuw exemplaar van de [HtmlSaveOptions](/tasks/python-net/aspose.tasks.saving/htmlsaveoptions/) klasse. |
## Eigenschappen
| Naam | Beschrijving |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Haalt op of stelt een waarde in die aangeeft of een gradientborstel moet worden gebruikt bij het renderen van de projectlay-out. |
...
| css_style_prefix | Haalt op of stelt CSS-stijlvoorvoegsel in. |
...
| include_project_name_in_page_header | Haalt op of stelt een waarde in die aangeeft of de projectnaam moet worden opgenomen in de HTML-paginakop. |
| include_project_name_in_title | Haalt op of stelt een waarde in die aangeeft of de projectnaam moet worden opgenomen in de HTML-titel. |
| pages | Haalt op of stelt een lijst met paginanummers in die moeten worden opgeslagen bij het renderen van de projectlay-out. |
| export_css | Haalt op of stelt de manier in waarop CSS wordt geëxporteerd. |
| export_images | Haalt op of stelt de manier in waarop afbeeldingen worden geëxporteerd. |
| export_fonts | Haalt op of stelt de manier in waarop lettertypen worden geëxporteerd. |
| css_saving_callback | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken voor het opslaan van CSS. |
| font_saving_callback | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken voor het opslaan van lettertype. |
| image_saving_callback | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken voor het opslaan van lettertype. |
| font_face_types | Haalt of stelt de lettertype-typen in. |
