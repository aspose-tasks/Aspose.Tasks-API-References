...
type: docs
weight: 120
url: /nl/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Staat toe om extra opties op te geven bij het afdrukken van een project.

Het type PrintOptions biedt de volgende leden weer:
## Constructors
| Naam | Beschrijving |
| :- | :- |
| PrintOptions() | Initialiseert een nieuw exemplaar van de [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) klasse die kan worden gebruikt om verschillende opties voor het afdrukken van een project in te stellen. |
## Eigenschappen
| Naam | Beschrijving |
| :- | :- |
| save_format |  |
