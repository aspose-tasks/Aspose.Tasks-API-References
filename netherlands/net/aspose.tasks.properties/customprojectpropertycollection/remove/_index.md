...
description: "CustomProjectPropertyCollection method. Verwijdert een eigenschap met de opgegeven naam uit de collectie"
type: docs
weight: 50
...
Verwijdert een eigenschap met de opgegeven naam uit de verzameling.
...
| --- | --- | --- |
| name | String | De hoofdletterongevoelige naam van de eigenschap. |
