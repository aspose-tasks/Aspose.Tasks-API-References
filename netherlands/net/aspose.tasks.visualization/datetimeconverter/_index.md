...
description: "Stelt een convertermethode voor om een datum naar string te converteren in weergave-tijdschalenniveaus."
type: docs
weight: 2990
...
Stelt een convertermethode voor om datum naar tekenreeks te converteren in weergave‑tijdschalenniveaus.
...
| --- | --- | --- |
| datum | DateTime | de instantie van de DateTime-klasse om naar string te converteren. |
