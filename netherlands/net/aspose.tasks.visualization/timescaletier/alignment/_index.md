...
description: "TimescaleTier-eigenschap. Haalt op of stelt in hoe labels binnen elke tijdsperiode van de tier worden uitgelijnd HorizontalStringAlignment."
type: docs
weight: 20
...
Haalt op of stelt in hoe labels binnen elke tijdsperiode van de tier worden uitgelijnd ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
