...
Aangepaste converter van taak‑gegevens naar balktekst.
...
| --- | --- | --- |
| taak | Taak | Taak waarvoor de tekst van de taakbalk wordt gerenderd. |

### Retourwaarde

Tekst om te renderen voor een balk die overeenkomt met de opgegeven taak.
