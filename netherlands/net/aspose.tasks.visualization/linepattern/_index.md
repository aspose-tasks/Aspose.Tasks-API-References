...
description: "Aspose.Tasks.Visualization.LinePattern enum. Lijnpatroon"
type: docs
weight: 3190
...
| --- | --- | --- |
| None | `0` | Geeft aan dat een lijn niet wordt weergegeven. |
| Solid | `1` | Geeft een solide lijnpatroon aan. |
| CloseDot | `3` | Geeft een gesloten stippenlijnpatroon aan. |
| Dotted | `4` | Geeft een gestippeld lijnpatroon aan. |
| Dashed | `2` | Geeft een gestreept lijnpatroon aan. |
