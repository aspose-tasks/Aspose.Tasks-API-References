...
description: "ITextStyleModificationCallback-methode. De methode die moet worden aangeroepen vóór het renderen van een tabelcel voor een taakrij in de volgende weergaven Gantt Chart, Task Sheet, Task Usage"
type: docs
weight: 10
...
| --- | --- | --- |
| args | TaskTextStyleEventArgs | Het [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/) object. |
