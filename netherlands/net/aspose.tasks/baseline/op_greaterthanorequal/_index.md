...
description: "Baseline methode. Retourneert een waarde die aangeeft of deze instantie groter dan of gelijk is aan een opgegeven object."
type: docs
weight: 120
...
| --- | --- | --- |
| een | Baseline | De eerste baseline. |
| b | Baseline | De tweede baseline. |

### Retourwaarde

een waarde die aangeeft of deze instantie groter dan of gelijk is aan een opgegeven object
