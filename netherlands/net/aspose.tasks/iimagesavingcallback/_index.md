...
description: "Aspose.Tasks.IImageSavingCallback interface. Vertegenwoordigt een callback die wordt aangeroepen om een bron te maken om afbeeldingen op te slaan."
type: docs
weight: 870
...
Stelt een callback voor die wordt aangeroepen om een bron te maken om afbeeldingen op te slaan.
...
| Naam | Beschrijving |
| --- | --- |
| [ImageSaving](../../aspose.tasks/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | De methode die moet worden aangeroepen tijdens het opslaan van afbeeldingen. |

## Voorbeelden

Toont hoe te werken met callbacks voor het opslaan van afbeeldingen.
