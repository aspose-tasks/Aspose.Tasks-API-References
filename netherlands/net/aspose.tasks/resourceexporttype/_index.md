...
description: "Aspose.Tasks.ResourceExportType enum. Specificeert het resource‑exporttype voor HTML-formaat"
type: docs
weight: 1780
...
Specificeert het exporttype van resources voor HTML-indeling.
...
| AsFile | `1` | Exporteren als een bestand. |
| AsEmbedded | `2` | Geëxporteerd als een ingebedde resource. |
