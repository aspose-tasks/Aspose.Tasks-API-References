...
description: "Value-eigenschap. Haalt op of stelt de werkelijke waarde in die wordt gebruikt om een Duur weer te geven."
type: docs
weight: 40
...
Haalt op of stelt de werkelijke waarde in die wordt gebruikt om Duur weer te geven.
...
Geef de voorkeur aan deze eigenschap boven de [`Val`](../val/), wanneer je de Duurwaarde moet instellen.
