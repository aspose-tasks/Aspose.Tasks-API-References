...
description: "Value-eigenschap. Haalt op of stelt de werkelijke waarde in interne representatie in. Geef de voorkeur aan het gebruik van sterk getypeerde eigenschappen die hieronder worden vermeld."
type: docs
weight: 90
...
Haalt op of stelt de werkelijke waarde in in interne representatie. Geef de voorkeur aan het gebruik van sterk getypeerde eigenschappen die hieronder worden vermeld.
...
Als je een Tekstwaarde wilt instellen, geef dan de voorkeur aan het gebruik van de sterk getypeerde [`StringValue`](../stringvalue/) eigenschap.

Als je een Nummer- of Kostwaarde wilt instellen, geef dan de voorkeur aan het gebruik van de sterk getypeerde [`NumericValue`](../numericvalue/) eigenschap.

Als je Datum/Start/Eind-waarden wilt instellen, geef dan de voorkeur aan het gebruik van de sterk getypeerde [`DateTimeValue`](../datetimevalue/) eigenschap.

Als je een Duurwaarde wilt instellen, geef dan de voorkeur aan het gebruik van de sterk getypeerde [`Duration`](../duration/) eigenschap.

Als je type niet wordt vermeld, gebruik dan de `Val` eigenschap.
