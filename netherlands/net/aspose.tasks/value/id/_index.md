...
description: "Value-eigenschap. Haalt de unieke identifier op of stelt deze in van een waarde binnen een project"
type: docs
weight: 50
...
Haalt op of stelt de unieke identifier van een waarde binnen een project in.

Het is belangrijk om niet dezelfde identifiers te hebben voor verschillende [`Value`](../) instanties.

Minimale `Id`-waarde is `1`.
