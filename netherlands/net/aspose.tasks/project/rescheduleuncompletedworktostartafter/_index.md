...
description: "Project-methode. Plant onvoltooide projectwerk opnieuw in om te starten na een opgegeven datum."
type: docs
weight: 1190
...
Plant onvoltooide projectwerk opnieuw in om te starten na een opgegeven datum.
...
| --- | --- | --- |
| na | DateTime | De datum waarna onvoltooide werkzaamheden opnieuw ingepland moeten worden. |
...
Plant onvoltooide werkzaamheden voor een opgegeven lijst met taken opnieuw in om te starten na een opgegeven datum.
...
| --- | --- | --- |
| na | DateTime | De datum waarna onvoltooide werkzaamheden opnieuw ingepland moeten worden. |
| taskCollection | List`1 | List&lt;Task&gt; van taken waarvoor onvoltooid werk moet worden verplaatst. |
