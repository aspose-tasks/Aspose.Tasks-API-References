...
description: "TimephasedDataCollection methode. Verwijdert TimephasedData‑instantie uit dit collectie‑object"
type: docs
weight: 100
...
Verwijdert [`TimephasedData`](../../timephaseddata/)‑instantie uit dit collectie‑object.
...
| --- | --- | --- |
| item | TimephasedData | Het item om te verwijderen. |

### Retourwaarde

true als *item* succesvol is verwijderd uit de [`TimephasedDataCollection`](../); anders false. Deze methode geeft ook false terug als *item* niet wordt gevonden in de [`TimephasedDataCollection`](../).
