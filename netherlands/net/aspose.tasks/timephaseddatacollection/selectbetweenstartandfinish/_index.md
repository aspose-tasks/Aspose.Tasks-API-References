...
description: "TimephasedDataCollection methode. Selecteert alle tijdsfases tussen startTime en finishTime. Heeft Olog n complexiteit in het gemiddelde geval."
type: docs
weight: 110
...
Selecteert alle tijdfasen tussen *startTime* en *finishTime*. Heeft een O(log n)-complexiteit in het gemiddelde geval.
...
| --- | --- | --- |
| timephasedDataType | TimephasedDataType | Type tijdsfases om te selecteren. |
| startTime | DateTime | Start van interval. |
| finishTime | DateTime | Einde van interval. |

### Retourwaarde

Retourneert een nieuw lijstinstance van [`TimephasedDataCollection`](../)-gegevens gesorteerd op de Start-eigenschap.
