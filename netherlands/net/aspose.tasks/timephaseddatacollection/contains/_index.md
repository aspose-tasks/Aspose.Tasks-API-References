...
description: "TimephasedDataCollection methode. Bepaalt of de TimephasedDataCollection een specifieke waarde bevat"
type: docs
weight: 70
...
Bepaalt of de [`TimephasedDataCollection`](../) een specifieke waarde bevat.
...
| --- | --- | --- |
| item | TimephasedData | Het object om te zoeken in de collectie. |
