...
description: "TimephasedData eigenschap. Haalt de waarde per tijdseenheid op of stelt deze in voor een tijdgephaseerde gegevensperiode"
type: docs
weight: 100
...
Haalt op of stelt de waarde per tijdseenheid in voor een tijdsfasegegevensperiode.
...
| exceptie | conditie |
| --- | --- |
| [TasksException](../../tasksexception/) | Wanneer de waarde onjuist is voor het opgegeven [`TimephasedDataType`](../timephaseddatatype/) of een negatieve waarde heeft. |
