...
description: "TimephasedData-methode. Maakt en initialiseert een nieuw exemplaar van de TimephasedData-klasse voor eenheidgebaseerde tijdgephaseerde gegevens van een toewijzing van een materiële resource"
type: docs
weight: 30
...
Maakt en initialiseert een nieuw exemplaar van de [`TimephasedData`](../)-klasse voor eenheid-gebaseerde tijdgephaseerde gegevens van een toewijzing van een materiële resource.
...
| exceptie | conditie |
| --- | --- |
| ArgumentException | Als een negatieve hoeveelheid eenheden werd gespecificeerd. |
