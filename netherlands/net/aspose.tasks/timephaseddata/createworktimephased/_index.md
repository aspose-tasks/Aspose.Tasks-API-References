...
description: "TimephasedData methode. Maakt en initialiseert een nieuw exemplaar van de TimephasedData‑klasse voor werkgebaseerde tijdgephaseerde data"
type: docs
weight: 40
...
Maakt en initialiseert een nieuw exemplaar van de [`TimephasedData`](../)‑klasse voor werkgebaseerde tijdgephaseerde data.
...
| value | TimeSpan | Tijdsduurwaarde. |
| timeUnit | TimeUnitType | Tijdseenheidstype. |
| type | TimephasedDataType | Tijdgephaseerd gegevenstype. |

### Retourwaarde

Een exemplaar van de [`TimephasedData`](../)‑klasse voor werkgebaseerde tijdgephaseerde data.

### Uitzonderingen

| exceptie | conditie |
| --- | --- |
| ArgumentException | Als een negatieve werkwaarde werd opgegeven. |
