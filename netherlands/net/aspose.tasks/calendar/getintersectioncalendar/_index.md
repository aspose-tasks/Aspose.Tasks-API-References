...
description: "Calendar-methode. Haalt ICalendar instance op die kan worden gebruikt om berekeningen uit te voeren op de intersectie van werkschema's van 2 agenda's"
type: docs
weight: 280
url: /nl/net/aspose.tasks/calendar/getintersectioncalendar/
---
## Calendar.GetIntersectionCalendar method

Haalt [`ICalendar`](../../icalendar/) instance op die kan worden gebruikt om berekeningen uit te voeren op de intersectie van werkschema's van 2 agenda's.
...
| --- | --- | --- |
| calendar1 | Calendar | Eerste agenda. |
| calendar2 | Calendar | Tweede agenda. |

### Retourwaarde

Implementatie van ICalendar-interface.

### Uitzonderingen

| exceptie | conditie |
| --- | --- |
| ArgumentNullException | Wanneer een van de argumenten null is. |
