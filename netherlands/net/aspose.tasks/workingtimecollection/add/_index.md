...
description: "WorkingTimeCollection-methode. Voegt een nieuw WorkingTime‑exemplaar toe aan deze collectie."
type: docs
weight: 30
...
Voegt een nieuw WorkingTime‑exemplaar toe aan deze verzameling.
...
| --- | --- | --- |
| item | WorkingTime | Het item om toe te voegen. |

### Retourwaarde

true als het WorkingTime‑object succesvol is toegevoegd; anders false.
