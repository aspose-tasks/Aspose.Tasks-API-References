...
description: "ExtendedAttributeDefinition-eigenschap. Haalt een Guid op van de opzoektabel die aan een aangepast veld is gekoppeld."
type: docs
weight: 180
...
Haalt de GUID van de opzoektabel op die aan een aangepast veld is gekoppeld.
...
Om een aangepast veld met opzoekfunctie te maken, gebruik een van de fabrieksmethoden: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) of [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
