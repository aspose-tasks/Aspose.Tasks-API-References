...
description: "ExtendedAttributeDefinition eigenschap. Haalt een waarde op of stelt deze in die aangeeft of de waarden van het aangepaste veld beperkt zijn tot waarden in de ValueList"
type: docs
weight: 220
...
Haalt een waarde op of stelt deze in die aangeeft of de waarden van het aangepaste veld beperkt zijn tot waarden in de [`ValueList`](../valuelist/).
