...
description: "ExtendedAttributeDefinition-methode. Voegt een waarde toe aan de interne lookup‑lijst. Dit is een voorkeursmethode voor manipulaties met de ValueList"
type: docs
weight: 300
...
Voegt een waarde toe aan de interne lookup‑lijst. Dit is een voorkeursmethode voor manipulaties met de [`ValueList`](../valuelist/).
...
| --- | --- | --- |
| value | Waarde | Waarde om toe te voegen aan de lookup. |
...
Gebruik deze code om een nieuwe waarde toe te voegen aan de lookup‑lijst:
