...
description: "ExtendedAttributeDefinition eigenschap. Haalt of stelt overeen met de project‑ID van een aangepast veld. Gebruik de tekenreeksrepresentatie van een constante uit de ExtendedAttributeTask‑klasse om de FieldId‑eigenschap op te geven."
type: docs
weight: 130
...
Haalt of stelt overeen met de project‑ID van een aangepast veld. Gebruik de tekenreeksrepresentatie van een constante uit de [`ExtendedAttributeTask`](../../extendedattributetask/) klasse om de `FieldId`‑eigenschap op te geven.
...
De voorkeur manier om de `FieldId`‑eigenschap in te stellen is om een [`ExtendedAttributeDefinition`](../) te maken met behulp van een van de speciale factory‑methoden zoals [`CreateTaskDefinition`](../createtaskdefinition/) of [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/).
