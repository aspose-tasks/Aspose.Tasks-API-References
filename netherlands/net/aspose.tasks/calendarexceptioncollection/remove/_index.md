...
description: "CalendarExceptionCollection methode. Verwijdert CalendarException‑instantie uit deze collectie"
type: docs
weight: 80
...
| --- | --- | --- |
| item | CalendarException | Het item om te verwijderen. |

### Retourwaarde

true als de opgegeven uitzondering succesvol is verwijderd.
