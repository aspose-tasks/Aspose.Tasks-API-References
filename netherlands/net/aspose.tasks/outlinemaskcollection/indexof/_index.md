...
description: "OutlineMaskCollection methode. Bepaalt de index van het opgegeven item in deze collectie"
type: docs
weight: 90
...
| --- | --- | --- |
| item | OutlineMask | het opgegeven item om te vinden in deze collectie. |
