...
description: "OutlineValue eigenschap. Haalt of stelt de duur in als Type Duration is"
type: docs
weight: 30
...
Haalt de duur op of stelt deze in als Type Duration is.
...
Geef de voorkeur aan deze eigenschap boven de [`Value`](../value/), wanneer je de waarde moet instellen voor OutlineValues met Duration-type.
