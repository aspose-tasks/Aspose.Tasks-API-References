...
description: "Aspose.Tasks.ViewScreen enum. Specificeert het schermtype voor een weergave."
type: docs
weight: 2910
...
| ResourceForm | `6` | Resource‑formulierweergave. |
| ResourceGraph | `8` | Resource‑grafiekweergave. |
| ResourceNameForm | `12` | Resource‑naamformulierweergave. |
| ResourceSheet | `7` | Resource‑bladweergave. |
| ResourceUsage | `15` | Resource‑gebruikweergave. |
| TaskDetailsForm | `10` | Taak‑detailsformulierweergave. |
| TaskForm | `4` | Taak‑formulierweergave. |
| TaskNameForm | `11` | Taak‑naamformulierweergave. |
| TaskSheet | `5` | Taak‑bladweergave. |
| TaskUsage | `14` | Taak‑gebruikweergave. |
