...
description: "ExtendedAttributeDefinitionCollection methode. Bepaalt de index van het opgegeven item in deze collectie"
type: docs
weight: 110
...
| --- | --- | --- |
| item | ExtendedAttributeDefinition | het opgegeven item om te vinden in deze collectie. |
