...
description: "ExtendedAttributeCollection methode. Bepaalt de index van het opgegeven item in deze collectie"
type: docs
weight: 90
...
| --- | --- | --- |
| item | ExtendedAttribute | het opgegeven item om te vinden in deze collectie. |
