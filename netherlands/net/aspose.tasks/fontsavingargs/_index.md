---
title: "Klasse FontSavingArgs"
second_title: "Aspose.Tasks for .NET API-referentie"
description: "Aspose.Tasks.FontSavingArgs klasse. Deze klasse vertegenwoordigt een set gegevens die verband houden met het opslaan van externe lettertypebestanden dat plaatsvindt tijdens de conversie naar HTML‑indeling."
type: docs
weight: 680
url: /nl/net/aspose.tasks/fontsavingargs/
---
## FontSavingArgs class

Deze klasse stelt een set gegevens voor die gerelateerd zijn aan het opslaan van externe fontbestanden dat plaatsvindt tijdens de conversie naar HTML-indeling.
...
| Naam | Beschrijving |
| --- | --- |
| [FontSavingArgs](fontsavingargs/)() | De standaardconstructor. |
...
Toont hoe te werken met font‑opslaan‑argumenten.
