...
description: "DayTypeCollection methode. Bepaalt de index van het opgegeven item in deze collectie"
type: docs
weight: 90
...
| --- | --- | --- |
| item | DayType | het opgegeven item om te vinden in deze collectie. |
