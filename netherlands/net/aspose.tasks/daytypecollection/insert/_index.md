...
description: "DayTypeCollection-methode. Voegt het opgegeven item in op de opgegeven index."
type: docs
weight: 100
...
| item | DayType | het opgegeven item om in deze collectie in te voegen. |
