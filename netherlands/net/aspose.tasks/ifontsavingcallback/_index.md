...
description: "Aspose.Tasks.IFontSavingCallback interface. Vertegenwoordigt een callback die wordt aangeroepen om een bron te maken om lettertypen op te slaan"
type: docs
weight: 860
...
Stelt een callback voor die wordt aangeroepen om een bron te maken om lettertypen op te slaan.
...
| Naam | Beschrijving |
| --- | --- |
| [FontSaving](../../aspose.tasks/ifontsavingcallback/fontsaving/)(FontSavingArgs) | De methode die wordt aangeroepen tijdens het opslaan van lettertypen. |

## Voorbeelden

Toont hoe te werken met callbacks voor het opslaan van lettertypen.
