...
description: "RateCollection methode. Converteert het RateCollection-object naar een lijst van Rate-objecten"
type: docs
weight: 80
...
Converteert het [`RateCollection`](../) object naar een lijst van [`Rate`](../../rate/) objecten.
...
Converteert het [`RateCollection`](../) object naar een lijst van [`Rate`](../../rate/) objecten gefilterd op het opgegeven [`RateType`](../../ratetype/) type.
...
| --- | --- | --- |
| type | RateType | Het type om op te filteren. |

### Retourwaarde

een lijst van [`Rate`](../../rate/) objecten.
