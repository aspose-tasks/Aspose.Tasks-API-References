...
description: "RateCollection methode. Verwijdert Rate-instantie uit deze collectie"
type: docs
weight: 70
...
Verwijdert Rate instance uit deze collectie.
...
| --- | --- | --- |
| item | Rate | Het item om te verwijderen. |

### Retourwaarde

true als de opgegeven Rate succesvol is verwijderd; anders false.
