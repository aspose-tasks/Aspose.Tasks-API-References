...
description: "WeekDay methode. Maakt een standaardwerkdag aan."
type: docs
weight: 20
...
| --- | --- | --- |
| dayType | DayType | Het dagtype om een standaardwerkdag van te maken. |

### Retourwaarde

Een standaardwerkdag met werktijden 8-12 en 13-17.
