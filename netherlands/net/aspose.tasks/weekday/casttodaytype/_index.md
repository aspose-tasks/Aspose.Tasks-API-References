...
description: "WeekDay-methode. Zet .Nets DayOfWeek om naar DayType"
type: docs
weight: 120
...
Zet .Net's DayOfWeek om naar [`DayType`](../daytype/).
...
| --- | --- | --- |
| dw | DayOfWeek | De dag van de week om van te casten. |
