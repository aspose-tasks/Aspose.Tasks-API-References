...
description: "TaskCollection-methode. Geeft een taak terug met de opgegeven Uid waarvan de voorouder de bovenliggende taak van deze collectie is."
type: docs
weight: 80
...
geeft de instantie van de [`Task`](../../task/) klasse terug met de opgegeven uid waarvan de voorouder de bovenliggende taak van deze collectie is.
