...
description: "AvailabilityPeriodCollection methode. Bepaalt de index van het opgegeven item in deze collectie"
type: docs
weight: 100
...
| --- | --- | --- |
| item | AvailabilityPeriod | het opgegeven item om te vinden in deze collectie. |
