...
description: "WeekDayCollection methode. Retourneert de index van de opgegeven WeekDay"
type: docs
weight: 80
...
Retourneert de index van de opgegeven [`WeekDay`](../../weekday/).
...
| --- | --- | --- |
| item | WeekDay | Het item om tegen te controleren. |

### Retourwaarde

Nulgebaseerde index van de opgegeven [`WeekDay`](../../weekday/), indien aanwezig, of -1 anders.
