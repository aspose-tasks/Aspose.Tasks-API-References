...
description: "WeekDayCollection-methode. Kopieert de inhoud van de collectie naar een array op de opgegeven index"
type: docs
weight: 60
...
Kopieert de inhoud van de collectie naar een array op de opgegeven index.
...
| --- | --- | --- |
| array | WeekDay[] | Doel‑array van [`WeekDay`](../../weekday/) om naar te kopiëren |
| arrayIndex | Int32 | Startindex voor de kopieerbewerking. |
