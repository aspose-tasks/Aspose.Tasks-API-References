...
description: "OutlineCodeCollection-methode. Voegt het opgegeven item in op de opgegeven index."
type: docs
weight: 100
...
| item | OutlineCode | het opgegeven item om in deze collectie in te voegen. |
