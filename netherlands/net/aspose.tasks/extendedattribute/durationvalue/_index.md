...
description: "ExtendedAttribute property. Haalt op of stelt een waarde in voor attributen met het type Duration"
type: docs
weight: 30
...
Haalt op of stelt een waarde in voor attributen met het type 'Duration'.
...
| exceptie | conditie |
| --- | --- |
| InvalidOperationException | Wordt gegooid als de [`AttributeDefinition`](../attributedefinition/) property niet is geïnitialiseerd of het aangepaste veldtype van de [`AttributeDefinition`](../attributedefinition/) property geen [`Duration`](../../duration/) instantie is. |
