...
description: "RecurringTaskInfo eigenschap. Haalt of stelt een dag in van het maandelijkse herhalingspatroon bij gebruik van een ordinale dag. Kan een van de waarden van de DayOfWeek-enumeratie zijn."
type: docs
weight: 60
...
Haalt een dag op of stelt deze in voor het maandelijkse terugkeerpatroon bij gebruik van een ordinale dag. Kan een van de waarden van de DayOfWeek-enumeratie zijn.
