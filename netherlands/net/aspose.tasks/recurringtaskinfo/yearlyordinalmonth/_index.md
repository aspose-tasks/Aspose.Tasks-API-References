...
description: "RecurringTaskInfo eigenschap. Haalt een maand op of stelt deze in van het jaarlijkse terugkeerpatroon bij gebruik van een ordinale dag. Kan een van de waarden van de Month-enumeratie zijn"
type: docs
weight: 200
...
Haalt een maand op of stelt deze in van het jaarlijkse terugkeerpatroon bij gebruik van een ordinale dag. Kan een van de waarden van de [`Month`](../../month/) enumeratie zijn.
