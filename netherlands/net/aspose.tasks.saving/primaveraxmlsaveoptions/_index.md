...
description: Maakt het mogelijk om extra opties te specificeren bij het opslaan van een project in Primavera xmlformaat.
type: docs
weight: 1890
...
Maakt het mogelijk om extra opties te specificeren bij het opslaan van een project in Primavera xml-formaat.
...
| Naam | Beschrijving |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Initialiseert een nieuw exemplaar van het`PrimaveraXmlSaveOptions` klasse. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | Haalt of stelt een waarde in die aangeeft of een roottaak moet worden opgeslagen of niet. |
