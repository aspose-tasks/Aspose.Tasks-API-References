...
description: /// Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpaginas naar XAML.
type: docs
weight: 1970
...
/// Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpagina's naar XAML.
...
| Naam | Beschrijving |
| --- | --- |
| [XamlOptions](xamloptions/)() | Initialiseert een nieuw exemplaar van het`XamlOptions` klasse die kan worden gebruikt om projecten op te slaan in XAML-indeling. |
