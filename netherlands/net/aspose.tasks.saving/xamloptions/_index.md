---
title: "Klasse XamlOptions"
second_title: "Aspose.Tasks for .NET API-referentie"
description: "Aspose.Tasks.Saving.XamlOptions klasse. /// Stelt toe extra opties op te geven bij het renderen van projectpagina's naar XAML"
type: docs
weight: 2260
url: /nl/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// Stelt toe extra opties op te geven bij het renderen van projectpagina's naar XAML.
...
| Naam | Beschrijving |
| --- | --- |
| [XamlOptions](xamloptions/)() | Initialiseert een nieuw exemplaar van de `XamlOptions` klasse die kan worden gebruikt om een project op te slaan in XAML-indeling. |
