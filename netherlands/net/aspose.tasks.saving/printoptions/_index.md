...
description: Maakt het mogelijk om extra opties op te geven bij het afdrukken van een project.
type: docs
weight: 1900
...
Maakt het mogelijk om extra opties op te geven bij het afdrukken van een project.
...
| Naam | Beschrijving |
| --- | --- |
| [PrintOptions](printoptions/)() | Initialiseert een nieuw exemplaar van het`PrintOptions` klasse die kan worden gebruikt om verschillende opties in te stellen om project af te drukken. |
