...
description: Maakt het mogelijk om extra opties te specificeren bij het opslaan van projecten in Primavera XERformaat.
type: docs
weight: 1880
...
Maakt het mogelijk om extra opties te specificeren bij het opslaan van projecten in Primavera XER-formaat.
...
| Naam | Beschrijving |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | Initialiseert een nieuw exemplaar van het`PrimaveraSaveOptions` klasse. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | Haalt of stelt de toename in die wordt gebruikt bij het opnieuw nummeren van activiteit-ID's. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | Haalt of stelt het voorvoegsel in dat wordt gebruikt bij het hernummeren van activiteits-ID's. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | Haalt of stelt het achtervoegsel in dat wordt gebruikt bij het opnieuw nummeren van activiteit-ID's. |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids/) { get; set; } | Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of activiteit-ID's opnieuw moeten worden genummerd. |
