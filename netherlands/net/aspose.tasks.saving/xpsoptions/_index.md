---
title: "Klasse XpsOptions"
second_title: "Aspose.Tasks for .NET API-referentie"
description: "Aspose.Tasks.Saving.XpsOptions klasse. Stelt toe om extra opties op te geven bij het renderen van projectpagina's naar XPS"
type: docs
weight: 2280
...
Staat toe extra opties op te geven bij het renderen van projectpagina's naar XPS.
...
| Naam | Beschrijving |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Initialiseert een nieuw exemplaar van de `XpsOptions` klasse. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Haalt op of stelt een waarde in die aangeeft of een metafile als bitmap moet worden gerenderd. |
