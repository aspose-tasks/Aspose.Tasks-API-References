---
title: "Klasse HtmlSaveOptions"
second_title: "Aspose.Tasks for .NET API-referentie"
description: "Aspose.Tasks.Saving.HtmlSaveOptions klasse. Stelt toe om extra opties te specificeren bij het renderen van projectpagina's naar HTML"
type: docs
weight: 2010
url: /nl/net/aspose.tasks.saving/htmlsaveoptions/
---
...
| Naam | Beschrijving |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | Initialiseert een nieuw exemplaar van de `HtmlSaveOptions` klasse. |
...
| [CssSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/csssavingcallback/) { get; set; } | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken om CSS op te slaan. |
| [CssStylePrefix](../../aspose.tasks.saving/htmlsaveoptions/cssstyleprefix/) { get; set; } | Haalt op of stelt het CSS-stijlprefix in. |
...
| [ExportCss](../../aspose.tasks.saving/htmlsaveoptions/exportcss/) { get; set; } | Haalt op of stelt de manier in waarop CSS wordt geëxporteerd. |
| [ExportFonts](../../aspose.tasks.saving/htmlsaveoptions/exportfonts/) { get; set; } | Haalt op of stelt de manier in waarop lettertypen worden geëxporteerd. |
| [ExportImages](../../aspose.tasks.saving/htmlsaveoptions/exportimages/) { get; set; } | Haalt op of stelt de manier in waarop afbeeldingen worden geëxporteerd. |
...
| [FontFaceTypes](../../aspose.tasks.saving/htmlsaveoptions/fontfacetypes/) { get; set; } | Haalt op of stelt de lettertype‑familietypen in. |
| [FontSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/fontsavingcallback/) { get; set; } | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken om het lettertype op te slaan. |
| [FontSettings](../../aspose.tasks.saving/htmlsaveoptions/fontsettings/) { get; } | Specificeert de fontinstellingen die worden gebruikt bij het renderen van de projectweergave. |
...
| [ImageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/imagesavingcallback/) { get; set; } | Haalt op of stelt de callback in die wordt aangeroepen om een bron te maken om het lettertype op te slaan. |
| [IncludeProjectNameInPageHeader](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameinpageheader/) { get; set; } | Haalt op of stelt een waarde in die aangeeft of de projectnaam moet worden opgenomen in de HTML‑pagina‑header. |
| [IncludeProjectNameInTitle](../../aspose.tasks.saving/htmlsaveoptions/includeprojectnameintitle/) { get; set; } | Haalt op of stelt een waarde in die aangeeft of de projectnaam moet worden opgenomen in de HTML‑titel. |
...
| [Pages](../../aspose.tasks.saving/htmlsaveoptions/pages/) { get; set; } | Haalt op of stelt een lijst van paginanummers in die moeten worden opgeslagen bij het renderen van de projectlay-out. Alle projectpagina's worden opgeslagen als deze lijst leeg is. |
| [PageSavingCallback](../../aspose.tasks.saving/htmlsaveoptions/pagesavingcallback/) { get; set; } | Haalt op of stelt een door de gebruiker gedefinieerde callback in die wordt gebruikt om een uitvoerstroom te verkrijgen voor elke gerenderde pagina. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/htmlsaveoptions/reducefootergap/) { get; set; } | Haalt op of stelt een waarde in die aangeeft of de ruimte tussen de laatste taak en de voettekst moet worden verkleind. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/htmlsaveoptions/usegradientbrush/) { get; set; } | Haalt op of stelt een waarde in die aangeeft of een gradient‑kwast moet worden gebruikt bij het renderen van de projectlay-out. Het gebruik van een gradient‑kwast wordt momenteel niet ondersteund bij het renderen naar HTML. |
