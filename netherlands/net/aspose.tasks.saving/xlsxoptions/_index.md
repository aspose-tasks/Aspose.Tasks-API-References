...
description: Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpaginas naar XLSX.
type: docs
weight: 1980
...
Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpagina's naar XLSX.
...
| Naam | Beschrijving |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Initialiseert een nieuw exemplaar van het`XlsxOptions`klasse die kan worden gebruikt om projecten in XLSX-indeling op te slaan. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/xlsxoptions/assignmentview/) { get; set; } | Haalt of stelt een lijst in van de toewijzingsweergavekolommen die moeten worden weergegeven ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | Haalt de codering van het resulterende XLSX-bestand op of stelt deze in. De standaardwaarde isUTF8 . |
...
| [ResourceView](../../aspose.tasks.saving/xlsxoptions/resourceview/) { get; set; } | Krijgt of stelt een lijst in van de resourceweergavekolommen die moeten worden weergegeven ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
