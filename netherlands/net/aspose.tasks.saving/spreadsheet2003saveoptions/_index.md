...
description: Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpaginas naar Spreadsheet2003.
type: docs
weight: 1940
...
Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpagina's naar Spreadsheet2003.
...
| Naam | Beschrijving |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | Initialiseert een nieuw exemplaar van het`Spreadsheet2003SaveOptions` klas. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | Haalt of stelt een lijst in van de toewijzingsweergavekolommen die moeten worden weergegeven ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) ). |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | Krijgt of stelt een lijst in van de resourceweergavekolommen die moeten worden weergegeven ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) ). |
