...
description: Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpaginas naar SVG.
type: docs
weight: 1950
url: /nl/net/aspose.tasks.saving/svgoptions/
---
## SvgOptions class

Maakt het mogelijk om extra opties te specificeren bij het renderen van projectpagina's naar SVG.
...
| Naam | Beschrijving |
| --- | --- |
| [SvgOptions](svgoptions/)() | Initialiseert een nieuw exemplaar van het`SvgOptions` klasse die kan worden gebruikt om projecten in SVG-indeling op te slaan. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Haalt of stelt een door de gebruiker gedefinieerde implementatie-callback in die wordt gebruikt om een uitvoerstroom voor elke weergegeven pagina op te halen. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Bepaalt of het verlooppenseel moet worden gebruikt bij het renderen van de projectlay-out. Momenteel wordt het gebruik van een verlooppenseel niet ondersteund voor weergave naar SVG. |
