---
title: "Klasse SvgOptions"
second_title: "Aspose.Tasks for .NET API-referentie"
description: "Aspose.Tasks.Saving.SvgOptions klasse. Stelt u in staat om extra opties op te geven bij het renderen van projectpagina's naar SVG."
type: docs
weight: 2230
...
| Naam | Beschrijving |
| --- | --- |
| [SvgOptions](svgoptions/)() | Initialiseert een nieuw exemplaar van de `SvgOptions` klasse die kan worden gebruikt om een project op te slaan in SVG-formaat. |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | Haalt op of stelt een door de gebruiker gedefinieerde implementatie‑callback in die wordt gebruikt om een output‑stream te verkrijgen voor elke gerenderde pagina. |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | Bepaalt of een gradient‑kwast moet worden gebruikt bij het renderen van de projectlay-out. Het gebruik van een gradient‑kwast wordt momenteel niet ondersteund voor het renderen naar SVG. |
