...
description: "MPPSaveOptions‑eigenschap. Haalt een waarde op of stelt deze in die aangeeft of groepsgegevens moeten worden weggeschreven bij het opslaan van een project naar MPP‑formaat. Groepsgegevens omvatten de collecties Project.TaskGroups en Project.ResourceGroups."
type: docs
weight: 60
url: /nl/net/aspose.tasks.saving/mppsaveoptions/writegroups/
---
## MPPSaveOptions.WriteGroups property

Haalt op of stelt een waarde in die aangeeft of groepsgegevens moeten worden weggeschreven bij het opslaan van een project naar MPP-formaat. Groepsgegevens omvatten de collecties Project.TaskGroups en Project.ResourceGroups.
