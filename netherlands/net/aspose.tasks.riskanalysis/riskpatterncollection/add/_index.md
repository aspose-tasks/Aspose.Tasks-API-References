...
description: "RiskPatternCollection-methode. Voegt een instantie van de RiskPattern-klasse toe aan deze collectie."
type: docs
weight: 40
...
Voegt een instantie van de [`RiskPattern`](../../riskpattern/) klasse toe aan deze collectie.
...
| --- | --- | --- |
| item | RiskPattern | een instantie van de [`RiskPattern`](../../riskpattern/) klasse om toe te voegen aan deze collectie. |

### Uitzonderingen

| exceptie | conditie |
| --- | --- |
| ArgumentNullException | *item* taak is null. |
