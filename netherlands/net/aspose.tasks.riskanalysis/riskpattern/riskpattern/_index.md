...
description: "RiskPattern constructor. Initialiseert een nieuw exemplaar van de RiskPattern-klasse"
type: docs
weight: 10
...
Initialiseert een nieuw exemplaar van de [`RiskPattern`](../) klasse.
...
| --- | --- | --- |
| taak | Taak | de opgegeven projecttaak waarvoor dit risico zal worden toegepast in Monte Carlo-simulatie. |
