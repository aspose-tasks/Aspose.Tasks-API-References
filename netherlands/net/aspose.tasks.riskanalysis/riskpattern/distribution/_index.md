...
description: "RiskPattern eigenschap. Haalt of stelt de kansverdeling in die wordt gebruikt in Monte Carlo-simulatie. De standaardwaarde is ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
Kan een van de waarden zijn die zijn gedefinieerd in de [`ProbabilityDistributionType`](../../probabilitydistributiontype/) enumeratie.
