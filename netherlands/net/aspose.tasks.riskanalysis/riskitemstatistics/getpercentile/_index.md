...
description: "RiskItemStatistics methode. Haalt een waarde op waaronder een opgegeven percentage van de gegenereerde monsters valt"
type: docs
weight: 60
...
| --- | --- | --- |
| percentage | Int32 | het opgegeven percentage tussen 0 en 100. |

### Retourwaarde

een waarde waaronder een opgegeven percentage van de gegenereerde monsters valt.
