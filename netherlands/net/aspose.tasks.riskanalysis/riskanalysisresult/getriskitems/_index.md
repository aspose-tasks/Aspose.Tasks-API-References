...
description: "RiskAnalysisResult methode. Retourneert een instantie van de RiskItemStatisticsCollection voor het opgegeven risico‑type."
type: docs
weight: 10
...
Retourneert een instantie van de [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) voor het opgegeven risicotype.
...
| --- | --- | --- |
| itemType | RiskItemType | het opgegeven risicotype; kan een van de waarden van de [`RiskItemType`](../../riskitemtype/) enumeratie zijn. |

### Retourwaarde

een instantie van de [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) voor het opgegeven risicotype.
