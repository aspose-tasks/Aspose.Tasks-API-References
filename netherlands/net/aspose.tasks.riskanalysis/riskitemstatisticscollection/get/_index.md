...
description: "RiskItemStatisticsCollection-methode. Retourneert een instantie van de RiskItemStatistics-klasse die zich in deze collectie bevindt en geassocieerd is met het opgegeven Task-object, null als het item niet wordt gevonden."
type: docs
weight: 10
...
Retourneert een instantie van de [`RiskItemStatistics`](../../riskitemstatistics/) klasse die zich in deze collectie bevindt en geassocieerd is met het opgegeven Task-object; null als het item niet wordt gevonden.
...
| --- | --- | --- |
| task | Task | de opgegeven instantie van de [`Task`](../../../aspose.tasks/task/) klasse. |

### Retourwaarde

risk item die geassocieerd is met het opgegeven task-object indien gevonden; anders null.
