---
title: "Clase XamlOptions"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.Saving.XamlOptions. /// Permite especificar opciones adicionales al renderizar páginas del proyecto a XAML"
type: docs
weight: 2260
url: /es/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// Permite especificar opciones adicionales al renderizar páginas de proyecto a XAML.
...
| Nombre | Descripción |
| --- | --- |
| [XamlOptions](xamloptions/)() | Inicializa una nueva instancia de la clase `XamlOptions` que puede usarse para guardar el proyecto en formato XAML. |
