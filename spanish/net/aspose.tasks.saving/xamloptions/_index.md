...
description: Aspose.Tasks.Saving.XamlOptions clase. /// Permite especificar opciones adicionales al representar páginas de proyecto en XAML.
type: docs
weight: 1970
...
/// Permite especificar opciones adicionales al representar páginas de proyecto en XAML.
...
| Nombre | Descripción |
| --- | --- |
| [XamlOptions](xamloptions/)() | Inicializa una nueva instancia del`XamlOptions` clase que se puede usar para guardar el proyecto en formato XAML. |
