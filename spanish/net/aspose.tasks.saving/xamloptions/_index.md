...
description: /// Permite especificar opciones adicionales al representar páginas de proyecto en XAML.
type: docs
weight: 1960
...
| Nombre | Descripción |
| --- | --- |
| [XamlOptions](xamloptions)() | Inicializa una nueva instancia del[`XamlOptions`](../xamloptions) clase que se puede usar para guardar el proyecto en formato XAML. |
