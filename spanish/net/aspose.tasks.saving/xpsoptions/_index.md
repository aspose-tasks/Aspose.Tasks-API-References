...
description: Permite especificar opciones adicionales al renderizar páginas de proyecto a XPS.
type: docs
weight: 1980
...
| Nombre | Descripción |
| --- | --- |
| [XpsOptions](xpsoptions)() | Inicializa una nueva instancia del[`XpsOptions`](../xpsoptions) clase. |
