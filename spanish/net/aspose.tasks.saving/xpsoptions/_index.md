---
title: "Clase XpsOptions"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.Saving.XpsOptions. Permite especificar opciones adicionales al renderizar páginas del proyecto a XPS"
type: docs
weight: 2280
url: /es/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Permite especificar opciones adicionales al renderizar páginas de proyecto a XPS.
...
| Nombre | Descripción |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Inicializa una nueva instancia de la clase `XpsOptions`. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Obtiene o establece un valor que indica si un metafile debe renderizarse como bitmap. |
