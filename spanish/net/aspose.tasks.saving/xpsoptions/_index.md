...
description: Aspose.Tasks.Saving.XpsOptions clase. Permite especificar opciones adicionales al renderizar páginas de proyecto a XPS.
type: docs
weight: 1990
...
| Nombre | Descripción |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Inicializa una nueva instancia del`XpsOptions` clase. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Obtiene o establece un valor que indica si un metarchivo debe representarse como mapa de bits. |
