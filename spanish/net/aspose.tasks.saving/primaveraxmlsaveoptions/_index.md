...
description: Aspose.Tasks.Saving.PrimaveraXmlSaveOptions clase. Permite especificar opciones adicionales al guardar el proyecto en formato Primavera xml.
type: docs
weight: 1890
...
| Nombre | Descripción |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Inicializa una nueva instancia del`PrimaveraXmlSaveOptions` clase. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | Obtiene o establece un valor que indica si se debe guardar o no una tarea raíz. |
