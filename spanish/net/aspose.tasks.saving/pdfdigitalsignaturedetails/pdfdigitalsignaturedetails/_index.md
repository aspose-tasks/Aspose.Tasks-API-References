...
description: Inicializa una nueva instancia delPdfDigitalSignatureDetailsaspose.tasks.saving/pdfdigitalsignaturedetails clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`PdfDigitalSignatureDetails`](../../pdfdigitalsignaturedetails) clase.
...
| --- | --- | --- |
| certificate | X509Certificate2 | losX509Certificate2 instancia con la que firmar. |
| reason | String | El motivo de la firma. |
| location | String | El lugar de la firma. |
| signatureDate | DateTime | La fecha de la firma. |
| hashAlgorithm | PdfDigitalSignatureHashAlgorithm | El algoritmo hash de firma. |
