---
title: "Clase PrintOptions"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.Saving.PrintOptions. Permite especificar opciones adicionales al imprimir el proyecto."
type: docs
weight: 2170
...
| Nombre | Descripción |
| --- | --- |
| [PrintOptions](printoptions/)() | Inicializa una nueva instancia de la clase `PrintOptions` que puede usarse para establecer diferentes opciones para imprimir el proyecto. |
