...
description: Aspose.Tasks.Saving.PrintOptions clase. Permite especificar opciones adicionales al imprimir proyecto.
type: docs
weight: 1900
...
| Nombre | Descripción |
| --- | --- |
| [PrintOptions](printoptions/)() | Inicializa una nueva instancia del`PrintOptions` clase que se puede usar para configurar diferentes opciones para imprimir project. |
