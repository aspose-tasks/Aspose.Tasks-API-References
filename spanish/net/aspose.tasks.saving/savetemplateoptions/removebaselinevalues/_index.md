...
description: "Propiedad SaveTemplateOptions. Obtiene o establece un valor que indica si se deben eliminar todos los valores de línea base de una plantilla de proyecto"
type: docs
weight: 30
...
Obtiene o establece un valor que indica si se deben eliminar todos los valores de referencia de una plantilla de proyecto.
