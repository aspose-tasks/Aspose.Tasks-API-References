...
description: Aspose.Tasks.Saving.HtmlSaveOptions clase. Permite especificar opciones adicionales al renderizar páginas de proyecto a HTML.
type: docs
weight: 1750
...
| Nombre | Descripción |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions/)() | Inicializa una nueva instancia del`HtmlSaveOptions` clase. |
