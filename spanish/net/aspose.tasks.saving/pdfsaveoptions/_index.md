...
description: Permite especificar opciones adicionales al renderizar páginas de proyecto a PDF.
type: docs
weight: 1850
...
| Nombre | Descripción |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions)() | Inicializa una nueva instancia del[`PdfSaveOptions`](../pdfsaveoptions)clase que se puede utilizar para guardar un documento en el[`PDF`](../savefileformat) formato. |
