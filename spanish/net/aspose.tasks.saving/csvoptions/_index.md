...
description: Aspose.Tasks.Saving.CsvOptions clase. Permite especificar opciones adicionales al guardar el proyecto en CSV.
type: docs
weight: 1720
...
| Nombre | Descripción |
| --- | --- |
| [CsvOptions](csvoptions/)() | Inicializa una nueva instancia del`CsvOptions` clase que se puede utilizar para guardar el proyecto en formato CSV. |
...
| [DataCategory](../../aspose.tasks.saving/csvoptions/datacategory/) { get; set; } | Obtiene o establece una categoría de datos para guardar. |
...
| [Encoding](../../aspose.tasks.saving/csvoptions/encoding/) { get; set; } | Obtiene o establece una codificación para guardar CSV con. |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | Obtiene o establece un valor que indica si incluir encabezados o no (el valor predeterminado es VERDADERO). |
