...
description: Aspose.Tasks.Properties.CustomProjectPropertyCollection clase. Representa una colección de propiedades de proyecto personalizadas.
type: docs
weight: 1300
...
| Nombre | Descripción |
| --- | --- |
| [CustomProjectPropertyCollection](customprojectpropertycollection/)() | Inicializa una nueva instancia del`CustomProjectPropertyCollection` clase. |
