...
description: "CustomProjectPropertyCollection method. Crea una nueva custom property"
type: docs
weight: 30
url: /es/net/aspose.tasks.properties/customprojectpropertycollection/add/
---
...
| value | Cadena | El valor del objeto property recién creado. |

### Valor devuelto

El objeto property recién creado.
...
| --- | --- | --- |
| nombre | Cadena | El nombre de la propiedad. |
| value | Boolean | El valor del objeto property recién creado. |
...
| --- | --- | --- |
| nombre | Cadena | El nombre de la propiedad. |
| value | Double | El valor del objeto property recién creado. |
...
| --- | --- | --- |
| nombre | Cadena | El nombre de la propiedad. |
| value | DateTime | El valor del objeto property recién creado. |
