...
description: "Constructor de GenericProperty. Inicializa una nueva instancia de la estructura GenericProperty"
type: docs
weight: 10
...
Inicializa una nueva instancia de la estructura [`GenericProperty`](../).
...
| --- | --- | --- |
| nombre | Cadena | El nombre de la propiedad. |
