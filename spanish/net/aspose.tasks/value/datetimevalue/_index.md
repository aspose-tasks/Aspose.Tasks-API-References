...
description: "Propiedad Value. Obtiene o establece el valor real si puede representarse como DateTime. El valor predeterminado es MinValue"
type: docs
weight: 20
...
Obtiene o establece el valor real si puede representarse como DateTime. El valor predeterminado es MinValue.
...
Prefiere esta propiedad sobre [`Val`](../val/), cuando necesites establecer el valor DateTime.
