...
description: "Propiedad Value. Obtiene o establece el valor real que se utiliza para representar la cadena de texto"
type: docs
weight: 80
...
Obtiene o establece el valor real que se usa para representar una cadena de texto.
...
Prefiere esta propiedad sobre [`Val`](../val/), cuando necesites establecer el valor de texto.
