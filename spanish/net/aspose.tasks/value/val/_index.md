...
description: "Propiedad Value. Obtiene o establece el valor real en representación interna. Prefiere usar propiedades tipadas fuertemente que se enumeran a continuación"
type: docs
weight: 90
url: /es/net/aspose.tasks/value/val/
---
## Value.Val property

Obtiene o establece el valor real en representación interna. Prefiera usar propiedades fuertemente tipadas que se enumeran a continuación.
...
Si deseas establecer el valor de Texto, prefiere usar la propiedad tipada fuertemente [`StringValue`](../stringvalue/).

Si deseas establecer el valor de Número o Costo, prefiere usar la propiedad tipada fuertemente [`NumericValue`](../numericvalue/).

Si deseas establecer valores de Fecha/Inicio/Fin, prefiere usar la propiedad tipada fuertemente [`DateTimeValue`](../datetimevalue/).

Si deseas establecer el valor de Duración, prefiere usar la propiedad tipada fuertemente [`Duration`](../duration/).

Si tu tipo no estaba en la lista, usa la propiedad `Val`.
