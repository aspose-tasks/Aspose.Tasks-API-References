...
description: "Propiedad Value. Obtiene o establece el valor real que se utiliza para representar la Duración"
type: docs
weight: 40
...
Obtiene o establece el valor real que se usa para representar Duration.
...
Prefiere esta propiedad sobre el [`Val`](../val/), cuando necesites establecer el valor de Duración.
