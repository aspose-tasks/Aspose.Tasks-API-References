...
description: "Propiedad Value. Obtiene o establece el identificador único de un valor en todo el proyecto"
type: docs
weight: 50
...
Obtiene o establece el identificador único de un valor en todo el proyecto.

Es importante no tener los mismos identificadores para diferentes instancias de [`Value`](../).

El valor mínimo de `Id` es `1`.
