...
description: "Propiedad Value. Obtiene o establece el valor real que se utiliza para representar un número o un valor de costo"
type: docs
weight: 60
...
Obtiene o establece el valor real que se usa para representar un número o valor de costo.
...
Prefiere esta propiedad sobre el [`Val`](../val/), cuando necesites establecer el valor de Número o Costo.
