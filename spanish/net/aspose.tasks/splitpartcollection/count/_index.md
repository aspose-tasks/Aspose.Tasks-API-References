...
description: "Propiedad SplitPartCollection. Obtiene el número de partes en la colección"
type: docs
weight: 10
url: /es/net/aspose.tasks/splitpartcollection/count/
---
## SplitPartCollection.Count property

Obtiene el número de partes en la colección.
