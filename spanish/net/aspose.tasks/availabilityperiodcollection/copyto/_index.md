...
description: "AvailabilityPeriodCollection método. Copia los elementos de esta colección al arreglo especificado comenzando en el índice de arreglo especificado"
type: docs
weight: 80
url: /es/net/aspose.tasks/availabilityperiodcollection/copyto/
---
...
| --- | --- | --- |
| arreglo | AvailabilityPeriod[] | el arreglo unidimensional especificado al que copiar los elementos |
