...
description: "AvailabilityPeriodCollection método. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false"
type: docs
weight: 70
url: /es/net/aspose.tasks/availabilityperiodcollection/contains/
---
...
| --- | --- | --- |
| elemento | AvailabilityPeriod | el elemento especificado para buscar. |
