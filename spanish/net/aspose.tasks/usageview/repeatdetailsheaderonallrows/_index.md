...
description: "Propiedad UsageView. Obtiene o establece un valor que indica si se debe repetir el encabezado de detalles en todas las filas de asignación o no"
type: docs
weight: 60
...
Obtiene o establece un valor que indica si se repite el encabezado de detalles en todas las filas de asignación o no.
