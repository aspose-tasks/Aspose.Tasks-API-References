...
description: Baseline método. Devuelve un valor que indica si esta instancia no es igual a un objeto especificado.
type: docs
weight: 130
url: /es/net/aspose.tasks/baseline/op_inequality/
---
