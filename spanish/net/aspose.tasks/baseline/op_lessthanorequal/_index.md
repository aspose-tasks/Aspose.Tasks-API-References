...
description: Baseline método. Devuelve un valor que indica si esta instancia es menor o igual que un objeto especificado.
type: docs
weight: 150
url: /es/net/aspose.tasks/baseline/op_lessthanorequal/
---
