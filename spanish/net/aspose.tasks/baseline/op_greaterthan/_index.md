...
description: Baseline método. Devuelve un valor que indica si esta instancia es mayor que un objeto especificado.
type: docs
weight: 110
url: /es/net/aspose.tasks/baseline/op_greaterthan/
---
