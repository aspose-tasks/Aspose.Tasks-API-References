...
description: "Baseline método. Implementación de la interfaz IComparable. Compara esta instancia con el objeto Baseline especificado"
type: docs
weight: 70
...
| --- | --- | --- |
| otro | Baseline | el objeto Baseline especificado con el que comparar esta instancia. |
