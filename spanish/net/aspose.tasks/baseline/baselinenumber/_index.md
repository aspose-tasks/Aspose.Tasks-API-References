...
description: "Baseline propiedad. Obtiene o establece el número único de un registro de datos baseline"
type: docs
weight: 20
...
Obtiene o establece el número único de un registro de datos de línea base.
