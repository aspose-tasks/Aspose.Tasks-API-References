...
description: "Método TimephasedDataCollection. Determina si el TimephasedDataCollection contiene un valor específico"
type: docs
weight: 70
...
| --- | --- | --- |
| elemento | TimephasedData | El objeto a localizar en la colección. |
