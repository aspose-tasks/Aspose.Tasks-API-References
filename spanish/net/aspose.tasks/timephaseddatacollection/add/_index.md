...
description: "Método TimephasedDataCollection. Añade una instancia de TimephasedData a este objeto de colección."
type: docs
weight: 40
...
Añade una instancia de [`TimephasedData`](../../timephaseddata/) a este objeto de colección.
...
| --- | --- | --- |
| elemento | TimephasedData | El elemento a añadir. |
