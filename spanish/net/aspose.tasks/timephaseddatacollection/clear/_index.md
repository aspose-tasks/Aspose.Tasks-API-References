...
description: "TimephasedDataCollection método. Elimina todos los elementos de la TimephasedDataCollection"
type: docs
weight: 60
...
Elimina todos los elementos de la [`TimephasedDataCollection`](../).
