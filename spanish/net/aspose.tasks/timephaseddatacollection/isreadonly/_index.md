...
description: "Propiedad TimephasedDataCollection. Obtiene un valor que indica si la ICollection es de solo lectura."
type: docs
weight: 20
...
Obtiene un valor que indica si la ICollection es de solo lectura.
...
true si la ICollection es de solo lectura; de lo contrario, false.
