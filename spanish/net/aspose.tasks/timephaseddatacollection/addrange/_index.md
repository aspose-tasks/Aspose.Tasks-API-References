...
description: "Método TimephasedDataCollection. Añade una colección de instancias de TimephasedData a este objeto de colección"
type: docs
weight: 50
...
Añade una colección de instancias de [`TimephasedData`](../../timephaseddata/) a este objeto de colección.
...
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | Una colección de objetos [`TimephasedData`](../../timephaseddata/) para añadir. |
