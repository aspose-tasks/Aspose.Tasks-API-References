...
description: "TimephasedDataCollection propiedad. Obtiene el número de objetos contenidos en este objeto TimephasedDataCollection"
type: docs
weight: 10
...
Obtiene el número de objetos contenidos en este objeto [`TimephasedDataCollection`](../).
