...
description: "TimephasedDataCollection método. Selecciona todas las fases de tiempo entre startTime y finishTime. Tiene complejidad Olog n en el caso promedio."
type: docs
weight: 110
...
Selecciona todas las fases de tiempo entre *startTime* y *finishTime*. Tiene una complejidad O(log n) en el caso promedio.
...
Devuelve una nueva instancia de lista de datos [`TimephasedDataCollection`](../) ordenados por la propiedad Start.
