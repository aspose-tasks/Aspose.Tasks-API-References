...
description: "TimephasedDataCollection método. Elimina la instancia de TimephasedData de este objeto de colección."
type: docs
weight: 100
...
Elimina la instancia [`TimephasedData`](../../timephaseddata/) de este objeto de colección.
...
| --- | --- | --- |
| elemento | TimephasedData | El elemento a eliminar. |

### Valor devuelto

true si *item* se eliminó correctamente de la [`TimephasedDataCollection`](../); de lo contrario, false. Este método también devuelve false si *item* no se encuentra en la [`TimephasedDataCollection`](../).
