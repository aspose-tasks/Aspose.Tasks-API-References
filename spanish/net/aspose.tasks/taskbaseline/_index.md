...
description: Aspose.Tasks.TaskBaseline clase. Representa la línea base de una tarea.
type: docs
weight: 2080
...
| Nombre | Descripción |
| --- | --- |
| [TaskBaseline](taskbaseline/)(Task) | Inicializa una nueva instancia del`TaskBaseline` clase. |
...
| override [GetHashCode](../../aspose.tasks/taskbaseline/gethashcode/)() | Devuelve un valor de código hash para la instancia del`TaskBaseline` clase. |
