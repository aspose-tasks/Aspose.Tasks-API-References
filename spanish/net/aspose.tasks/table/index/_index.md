...
description: "Propiedad Table. Obtiene el índice de un objeto Table en el objeto que contiene las Tables"
type: docs
weight: 40
...
Obtiene el índice de un objeto Table en el objeto que contiene las Tables.
