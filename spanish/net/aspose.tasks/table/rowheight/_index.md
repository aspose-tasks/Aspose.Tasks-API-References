...
description: "Propiedad Table. Obtiene o establece la altura de fila en una tabla, donde la altura de fila es el número de líneas de texto"
type: docs
weight: 60
...
Obtiene o establece la altura de la fila en una tabla, donde la altura de la fila es el número de líneas de texto.
