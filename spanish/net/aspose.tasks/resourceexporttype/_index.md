...
description: "Aspose.Tasks.ResourceExportType enum. Especifica el tipo de exportación de recursos para el formato HTML"
type: docs
weight: 1780
...
Especifica el tipo de exportación de recursos para formato HTML.
