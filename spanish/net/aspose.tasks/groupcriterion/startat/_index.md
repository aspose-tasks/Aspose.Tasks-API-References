...
description: "Propiedad GroupCriterion. Obtiene o establece el inicio de los intervalos para un campo usado como criterio en una definición de grupo"
type: docs
weight: 100
url: /es/net/aspose.tasks/groupcriterion/startat/
---
## GroupCriterion.StartAt property

Obtiene o establece el inicio de los intervalos para un campo utilizado como criterio en una definición de grupo.
