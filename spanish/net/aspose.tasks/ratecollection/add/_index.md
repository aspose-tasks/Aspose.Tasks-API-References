...
description: "Método RateCollection. Añade una nueva instancia de Rate a esta colección"
type: docs
weight: 50
url: /es/net/aspose.tasks/ratecollection/add/
---
## Add(DateTime) {#add}

Añade una nueva instancia de [`Rate`](../../rate/) a esta colección.
...
| --- | --- | --- |
| ratesFrom | DateTime | La fecha en que la nueva tarifa entra en vigor. |

### Valor devuelto

Instancia de [`Rate`](../../rate/) añadida.
...
| --- | --- | --- |
| ratesFrom | DateTime | La fecha en que la nueva tarifa entra en vigor. |
| tipo | RateType | La tabla de tarifas en la que se añadirá. |
