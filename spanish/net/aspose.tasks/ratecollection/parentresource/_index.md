...
description: "Propiedad RateCollection. Obtiene el objeto Resource padre para esta colección"
type: docs
weight: 40
...
Obtiene el objeto [`Resource`](../../resource/) padre para esta colección.
