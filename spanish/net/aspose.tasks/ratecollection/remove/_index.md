...
description: "Método RateCollection. Elimina la instancia Rate de esta colección"
type: docs
weight: 70
...
| --- | --- | --- |
| elemento | Rate | El elemento a eliminar. |

### Valor devuelto

true si la Rate especificada se eliminó correctamente; de lo contrario, false.
