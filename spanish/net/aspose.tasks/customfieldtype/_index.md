...
description: Especifica el tipo de un campo personalizado.
type: docs
weight: 370
...
| Finish | `4` | Indica Finalizar tipo de campo personalizado. |
| Flag | `5` | Indica el tipo de campo personalizado Marcar. |
| Number | `6` | Indica el tipo de campo personalizado Número. |
| Start | `7` | Indica el tipo de campo personalizado de inicio. |
