...
description: "Propiedad ProjectDisplayOptions. Obtiene o establece un valor que indica si se deben mostrar sugerencias cuando Project identifica un posible conflicto de programación con una tarea programada manualmente. Esta opción está disponible para la versión Project 2010 y posteriores"
type: docs
weight: 80
...
Obtiene o establece un valor que indica si se deben mostrar sugerencias cuando Project identifica un posible conflicto de programación con una tarea programada manualmente. Esta opción está disponible para la versión Project 2010 y posteriores.
