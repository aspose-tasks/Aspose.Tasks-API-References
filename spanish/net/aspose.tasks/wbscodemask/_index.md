...
description: Aspose.Tasks.WBSCodeMask clase. Representa la máscara de código WBS.
type: docs
weight: 3140
...
| Nombre | Descripción |
| --- | --- |
| [WBSCodeMask](wbscodemask/)() | Inicializa una nueva instancia del`WBSCodeMask` clase. |
