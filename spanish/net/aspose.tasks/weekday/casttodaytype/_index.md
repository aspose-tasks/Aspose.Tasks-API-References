...
description: "Método WeekDay. Convierte DayOfWeek de .Net a DayType"
type: docs
weight: 120
...
Convierte DayOfWeek de .Net a [`DayType`](../daytype/).
...
| --- | --- | --- |
| dw | DayOfWeek | El día de la semana del cual convertir. |

### Valor devuelto

Un tipo de día convertido.
