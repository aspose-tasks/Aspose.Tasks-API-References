...
description: "Clase Aspose.Tasks.Group. Representa una definición de grupo. Un objeto Group es miembro de la colección ResourceGroups o de la colección TaskGroups"
type: docs
weight: 770
...
Representa una definición de grupo. Un objeto Group es miembro de la colección ResourceGroups o de la colección TaskGroups.
...
| Nombre | Descripción |
| --- | --- |
| [Group](group/)() | Inicializa una nueva instancia de la clase `Group`. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [GroupAssignments](../../aspose.tasks/group/groupassignments/) { get; set; } | Obtiene o establece un valor que indica si las asignaciones deben agruparse en lugar de las tareas. |
...
| [MaintainHierarchy](../../aspose.tasks/group/maintainhierarchy/) { get; set; } | Obtiene o establece un valor que indica si se deben mostrar todos los niveles de tareas de resumen para subtareas dentro del grupo. |
| [Name](../../aspose.tasks/group/name/) { get; set; } | Obtiene o establece un nombre de un objeto Group. |
| [ShowInMenu](../../aspose.tasks/group/showinmenu/) { get; set; } | Obtiene o establece un valor que indica si Project muestra el nombre del grupo en la lista desplegable Group en la cinta de opciones. |
