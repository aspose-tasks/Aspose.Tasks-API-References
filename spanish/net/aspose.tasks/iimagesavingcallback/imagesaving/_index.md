...
description: "Método IImageSavingCallback. El método que se llama al guardar imágenes"
type: docs
weight: 10
...
El método que se llamará al guardar imágenes.
...
| --- | --- | --- |
| args | ImageSavingArgs | Los argumentos de guardado de imágenes. |
