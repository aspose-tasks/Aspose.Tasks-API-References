---
title: "Interfaz IImageSavingCallback"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Interfaz Aspose.Tasks.IImageSavingCallback. Representa una devolución de llamada que se invoca para crear un recurso donde almacenar imágenes"
type: docs
weight: 870
...
Representa una devolución de llamada que se invoca para crear un recurso que almacene imágenes.
...
| Nombre | Descripción |
| --- | --- |
| [ImageSaving](../../aspose.tasks/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | El método que se llamará al guardar imágenes. |

## Ejemplos

Muestra cómo trabajar con devoluciones de llamada de guardado de imágenes.
