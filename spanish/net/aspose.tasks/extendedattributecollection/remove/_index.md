...
description: "Método ExtendedAttributeCollection. Elimina la primera aparición de un objeto específico de esta colección"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | ExtendedAttribute | el objeto especificado para eliminar. |
