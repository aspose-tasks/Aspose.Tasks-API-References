...
description: Contiene una lista deTableField./tablefield objects. Implementa la interfaz IListltTableFieldgt.
type: docs
weight: 2050
...
Contiene una lista de[`TableField`](../tablefield) objects. Implementa la interfaz IList&lt;TableField&gt;.
...
| [ParentProject](../../aspose.tasks/tablefieldcollection/parentproject) { get; } | Obtiene el padre del objeto TableFields. Solo lectura[`Project`](../project) . |
...
| [Contains](../../aspose.tasks/tablefieldcollection/contains)(TableField) | Devuelve verdadero si el elemento especificado se encuentra en esta colección; de lo contrario, false. |
| [CopyTo](../../aspose.tasks/tablefieldcollection/copyto)(TableField[], int) | Copia los elementos de esta colección en la matriz especificada, comenzando en el índice de matriz especificado. |
