...
description: "TableFieldCollection método. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false"
type: docs
weight: 60
...
| --- | --- | --- |
| elemento | TableField | el elemento especificado para buscar. |
