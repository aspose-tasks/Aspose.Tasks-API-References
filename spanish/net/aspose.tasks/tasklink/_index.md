...
description: Representa un vínculo anterior.
type: docs
weight: 2110
...
Representa un vínculo anterior.
...
| [LagFormat](../../aspose.tasks/tasklink/lagformat) { get; set; } | Obtiene o establece el formato para expresar el formato de retraso. |
| [LinkLag](../../aspose.tasks/tasklink/linklag) { get; set; } | Obtiene o establece la cantidad de retraso en décimas de minuto. |
...
| override [GetHashCode](../../aspose.tasks/tasklink/gethashcode)() | Devuelve un valor de código hash para la instancia del[`TaskLink`](../tasklink) clase. |
| override [ToString](../../aspose.tasks/tasklink/tostring)() | Devuelve la representación de cadena de un TaskLink. Los detalles exactos de la representación no se especifican y están sujetos a cambios. |
