...
description: "Propiedad GanttChartView. Obtiene una lista de estilos de barra comunes padre de la vista de diagrama de Gantt. GanttBarStyle"
type: docs
weight: 50
...
Obtiene una lista de estilos de barra (comunes) padre de la vista de diagrama de Gantt. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
