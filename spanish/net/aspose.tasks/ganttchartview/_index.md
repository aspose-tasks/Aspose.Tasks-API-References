...
description: Aspose.Tasks.GanttChartView clase. Representa una vista de GanttChart.
type: docs
weight: 700
...
| Nombre | Descripción |
| --- | --- |
| [GanttChartView](ganttchartview/)() | Inicializa una nueva instancia del`GanttChartView` clase. |
...
| [BarRounding](../../aspose.tasks/ganttchartview/barrounding/) { get; set; } | Obtiene o establece un valor que indica si las barras se redondean al día más próximo. El valor predeterminado es Verdadero. |
