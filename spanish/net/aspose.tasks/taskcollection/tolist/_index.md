...
description: "Método TaskCollection. Convierte el objeto TaskCollection en una lista de objetos Task."
type: docs
weight: 120
...
Convierte el objeto TaskCollection en una lista de objetos [`Task`](../../task/).
...
devuelve una lista que contiene las instancias de la clase [`Task`](../../task/) de esta colección.
