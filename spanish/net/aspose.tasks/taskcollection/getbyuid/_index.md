...
description: "Método TaskCollection. Devuelve una tarea con el Uid especificado cuyo ancestro es la tarea padre de esta colección."
type: docs
weight: 80
...
devuelve la instancia de la clase [`Task`](../../task/) con el uid especificado cuyo ancestro es la tarea padre de esta colección.
