...
description: "Aspose.Tasks.FontFaceType enum. Enumera los tipos de fuente"
type: docs
weight: 650
...
Enumera los tipos de tipografía.
...
| --- | --- | --- |
| NotSpecified | `0` | El tipo de fuente no está especificado. |
| Ttf | `1` | La fuente TrueType. |
| Eot | `2` | La fuente EOT. |
