...
description: "Método ViewCollection. Elimina la primera aparición de un objeto específico de esta colección"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | View | el objeto especificado para eliminar. |
