...
description: "Método GroupCriterionCollection. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false"
type: docs
weight: 50
...
| --- | --- | --- |
| elemento | GroupCriterion | el elemento especificado para buscar. |
