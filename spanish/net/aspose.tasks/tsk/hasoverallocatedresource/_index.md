...
description: "Campo Tsk. Indica si la tarea tiene un recurso asignado que tiene más trabajo en tareas asignadas del que puede completarse dentro de la capacidad de trabajo normal"
type: docs
weight: 470
url: /es/net/aspose.tasks/tsk/hasoverallocatedresource/
---
...
Muestra cómo leer Tsk.IsOverallocated, Tsk.HasOverallocatedResource,

```csharp
// propiedades Rsc.Overallocated y Asn.Overallocated.
