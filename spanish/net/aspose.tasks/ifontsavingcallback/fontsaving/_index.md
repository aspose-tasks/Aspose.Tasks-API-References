...
description: "Método IFontSavingCallback. El método que se llamará al guardar fuentes"
type: docs
weight: 10
url: /es/net/aspose.tasks/ifontsavingcallback/fontsaving/
---
## IFontSavingCallback.FontSaving method

El método que se llamará al guardar fuentes.
...
| --- | --- | --- |
| args | FontSavingArgs | Los argumentos de guardado de fuentes. |
