---
title: "Interfaz IFontSavingCallback"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Interfaz Aspose.Tasks.IFontSavingCallback. Representa una devolución de llamada que se invoca para crear un recurso donde almacenar fuentes"
type: docs
weight: 860
...
Representa una devolución de llamada que se invoca para crear un recurso que almacene fuentes.
...
| Nombre | Descripción |
| --- | --- |
| [FontSaving](../../aspose.tasks/ifontsavingcallback/fontsaving/)(FontSavingArgs) | El método que se llamará al guardar fuentes. |

## Ejemplos

Muestra cómo trabajar con devoluciones de llamada de guardado de fuentes.
