...
description: "Propiedad WorkingTimeCollection. Obtiene el número de objetos contenidos en este objeto WorkingTimeCollection"
type: docs
weight: 10
...
Obtiene el número de objetos contenidos en este objeto [`WorkingTimeCollection`](../).
