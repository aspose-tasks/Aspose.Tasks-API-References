...
description: "Método WorkingTimeCollection. Convierte el objeto WorkingTimeCollection en una lista de objetos WorkingTime"
type: docs
weight: 90
...
Convierte el objeto WorkingTimeCollection en una lista de objetos [`WorkingTime`](../../workingtime/).
...
Lista de objetos [`WorkingTime`](../../workingtime/).
