...
description: Aspose.Tasks.ResourceUsageView clase. Representa la vista de uso de recursos en un proyecto.
type: docs
weight: 1560
url: /es/net/aspose.tasks/resourceusageview/
---
## ResourceUsageView class

Representa la vista de uso de recursos en un proyecto.
...
| Nombre | Descripción |
| --- | --- |
| [AlignDetailsData](../../aspose.tasks/usageview/aligndetailsdata/) { get; set; } | Obtiene o establece la alineación de datos de detalles. |
| [BottomTimescaleTier](../../aspose.tasks/usageview/bottomtimescaletier/) { get; set; } | Obtiene o establece la configuración del nivel de escala de tiempo inferior de la vista. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) |
| [DisplayDetailsHeaderColumn](../../aspose.tasks/usageview/displaydetailsheadercolumn/) { get; set; } | Obtiene o establece un valor que indica si mostrar o no la columna de encabezado de detalles en la vista. |
| [DisplayShortDetailHeaderNames](../../aspose.tasks/usageview/displayshortdetailheadernames/) { get; set; } | Obtiene o establece un valor que indica si se muestran o no los nombres de encabezado de detalles breves. |
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | Obtiene el[`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) objeto de este ResourceUsageView. |
...
| [MiddleTimescaleTier](../../aspose.tasks/usageview/middletimescaletier/) { get; set; } | Obtiene o establece la configuración del nivel de escala de tiempo medio de la vista. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) . |
...
| [RepeatDetailsHeaderOnAllRows](../../aspose.tasks/usageview/repeatdetailsheaderonallrows/) { get; set; } | Obtiene o establece un valor que indica si se debe repetir el encabezado de detalles en todas las filas de asignación o no. |
| [Screen](../../aspose.tasks/view/screen/) { get; } | Obtiene el tipo de pantalla para la vista única. Solo lectura[`ViewScreen`](../viewscreen/) . |
| [ShowInMenu](../../aspose.tasks/view/showinmenu/) { get; set; } | Obtiene o establece un valor que indica si Microsoft Project muestra el nombre de la vista única en las listas desplegables Vista u Otras vistas en la cinta. |
...
| [TopTimescaleTier](../../aspose.tasks/usageview/toptimescaletier/) { get; set; } | Obtiene o establece la configuración del nivel de escala de tiempo superior de la vista. [`TimescaleTier`](../../aspose.tasks.visualization/timescaletier/) . |
