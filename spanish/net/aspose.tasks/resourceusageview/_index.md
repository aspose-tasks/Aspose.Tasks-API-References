---
title: "Clase ResourceUsageView"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.ResourceUsageView. Representa la vista de uso de recursos en un proyecto"
type: docs
weight: 1810
...
| [FieldCollection](../../aspose.tasks/resourceusageview/fieldcollection/) { get; } | Obtiene el objeto [`ResourceUsageViewFieldCollection`](../resourceusageviewfieldcollection/) de este ResourceUsageView. |
...
Muestra cómo renderizar la vista de uso de recursos.

```csharp
var project = new Project(DataDir + "ResourceUsageView.mpp");

// Defina las SaveOptions con la configuración requerida de TimeScale como Días
SaveOptions options = new PdfSaveOptions
{
    Timescale = Timescale.Days,

    // Establezca el formato de Presentation a ResourceUsage
