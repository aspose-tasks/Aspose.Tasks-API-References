...
description: La variación del costo del valor ganado hasta la fecha de estado del proyecto. CV es la diferencia entre el BCWP costo presupuestado del trabajo realizado y el ACWP costo real del trabajo realizado de la tarea.
type: docs
weight: 270
