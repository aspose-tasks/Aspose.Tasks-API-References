...
description: Representar periodos de tiempo excepcionales en un calendario.
type: docs
weight: 240
...
| Nombre | Descripción |
| --- | --- |
| [CalendarException](calendarexception)() | Inicializa una nueva instancia del[`CalendarException`](../calendarexception) clase. |
