...
description: Define los criterios que deben cumplir las tareas o los recursos para que se muestren en la vista MSP.
type: docs
weight: 620
...
| Nombre | Descripción |
| --- | --- |
| override [ToString](../../aspose.tasks/filtercriteria/tostring)() | Devuelve la representación de cadena de la instancia del[`FilterCriteria`](../filtercriteria) clase. |
