...
description: "Propiedad ExtendedAttribute. Obtiene o establece un valor para atributos con tipo Texto"
type: docs
weight: 80
...
Obtiene o establece un valor para atributos con tipo 'Text'.
...
| excepción | condición |
| --- | --- |
| InvalidOperationException | Se lanza si la propiedad [`AttributeDefinition`](../attributedefinition/) no está inicializada o el atributo actual no es un atributo de texto. |
