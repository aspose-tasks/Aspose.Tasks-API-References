...
description: Representa un patrón que se basa en la posición del día de la semana en un mes.
type: docs
weight: 170
...
| Nombre | Descripción |
| --- | --- |
| [ByMonthWeekDayRepetition](bymonthweekdayrepetition)() | Inicializa una nueva instancia del[`ByMonthWeekDayRepetition`](../bymonthweekdayrepetition) clase. |
