...
description: "WBSCodeMaskCollection método. Elimina la primera aparición de un objeto específico de esta colección"
type: docs
weight: 80
...
| --- | --- | --- |
| elemento | WBSCodeMask | el objeto especificado para eliminar. |
