...
description: "Método de WBSCodeMaskCollection. Convierte una WBSCodeMaskCollection en una lista de objetos WBSCodeMask"
type: docs
weight: 90
...
Convierte una WBSCodeMaskCollection en una lista de objetos [`WBSCodeMask`](../../wbscodemask/).
...
Lista genérica de objetos [`WBSCodeMask`](../../wbscodemask/).
