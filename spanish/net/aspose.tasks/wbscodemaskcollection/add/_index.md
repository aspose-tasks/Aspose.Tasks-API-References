...
description: "WBSCodeMaskCollection método. Agrega el elemento especificado a esta colección"
type: docs
weight: 30
...
| --- | --- | --- |
| elemento | WBSCodeMask | el elemento especificado para añadir a esta colección. |
