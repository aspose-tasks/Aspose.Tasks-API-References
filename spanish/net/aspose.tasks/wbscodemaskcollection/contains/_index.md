...
description: "Método de WBSCodeMaskCollection. Devuelve true si el elemento especificado se encuentra en esta colección; de lo contrario, false"
type: docs
weight: 50
...
| --- | --- | --- |
| elemento | WBSCodeMask | el elemento especificado para buscar. |
