...
description: "propiedad OleObject. Obtiene un valor que indica si el archivo del proyecto contiene solo un enlace a los datos reales almacenados en la fuente del enlace"
type: docs
weight: 90
url: /es/net/aspose.tasks/oleobject/linked/
---
## OleObject.Linked property

Obtiene un valor que indica si el archivo del proyecto contiene solo un enlace a los datos reales almacenados en la fuente del enlace.
