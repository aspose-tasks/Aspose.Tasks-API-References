...
description: Aspose.Tasks.Filter clase. Representa un filtro en Project.
type: docs
weight: 600
...
| [Index](../../aspose.tasks/filter/index/) { get; } | Obtiene el índice de un`Filter` objeto en los filtros que contienen object. |
...
| Nombre | Descripción |
| --- | --- |
| [CompareTo](../../aspose.tasks/filter/compareto/)(Filter) | Compara esta instancia con la instancia especificada del`Filter` clase y devuelve una indicación de su orden relativo. |
