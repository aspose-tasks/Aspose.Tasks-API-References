...
description: Representa una colección deOutlineCodeDefinition./outlinecodedefinition objetos.
type: docs
weight: 1040
...
Representa una colección de[`OutlineCodeDefinition`](../outlinecodedefinition) objetos.
...
| [Contains](../../aspose.tasks/outlinecodedefinitioncollection/contains)(OutlineCodeDefinition) | Devuelve verdadero si el elemento especificado se encuentra en esta colección; de lo contrario, false. |
| [CopyTo](../../aspose.tasks/outlinecodedefinitioncollection/copyto)(OutlineCodeDefinition[], int) | Copia los elementos de esta colección en la matriz especificada, comenzando en el índice de matriz especificado. |
...
| [ToList](../../aspose.tasks/outlinecodedefinitioncollection/tolist)() | Convierte este objeto OutlineCodeDefinitionCollection en una lista de[`OutlineCodeDefinition`](../outlinecodedefinition) objetos. |
