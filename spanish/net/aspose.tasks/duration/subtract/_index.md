...
description: Duration método. Resta la duración especificada de esta instancia de duración.
type: docs
weight: 100
...
| --- | --- | --- |
| d | Duration | el especificado[`Duration`](../) instancia a restar de esta instancia. |
