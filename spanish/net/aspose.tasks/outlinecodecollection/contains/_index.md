...
description: "OutlineCodeCollection método. Devuelve verdadero si el elemento especificado se encuentra en esta colección, de lo contrario falso"
type: docs
weight: 60
...
| --- | --- | --- |
| elemento | OutlineCode | el elemento especificado para buscar. |
