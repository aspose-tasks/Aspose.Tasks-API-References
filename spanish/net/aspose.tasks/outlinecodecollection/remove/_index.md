...
description: "OutlineCodeCollection método. Elimina la primera aparición de un objeto específico de esta colección"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | OutlineCode | el objeto especificado para eliminar. |
