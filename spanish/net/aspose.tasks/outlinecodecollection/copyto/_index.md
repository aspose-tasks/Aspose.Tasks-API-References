...
description: "OutlineCodeCollection método. Copia los elementos de esta colección al arreglo especificado comenzando en el índice de arreglo especificado"
type: docs
weight: 70
...
| --- | --- | --- |
| arreglo | OutlineCode[] | el arreglo unidimensional especificado al que copiar los elementos |
