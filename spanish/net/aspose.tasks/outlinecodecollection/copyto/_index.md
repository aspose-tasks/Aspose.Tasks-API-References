...
description: OutlineCodeCollection método. Copia los elementos de esta colección en la matriz especificada comenzando en el índice de matriz especificado.
type: docs
weight: 70
url: /es/net/aspose.tasks/outlinecodecollection/copyto/
---
...
| --- | --- | --- |
| array | OutlineCode[] | la matriz unidimensional especificada para copiar elementos a |
