...
description: Aspose.Tasks.ProjectInfo clase. Breve información sobre el proyecto publicado disponible en Project Online.
type: docs
weight: 1220
...
| Nombre | Descripción |
| --- | --- |
| [ProjectInfo](projectinfo/)() | Inicializa una nueva instancia del`ProjectInfo` clase. |
