...
description: "Propiedad de CalendarExceptionCollection. Obtiene el número de objetos contenidos en este objeto CalendarExceptionCollection"
type: docs
weight: 10
...
Obtiene el número de objetos contenidos en este objeto [`CalendarExceptionCollection`](../).
