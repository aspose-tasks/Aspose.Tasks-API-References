...
description: "Método de CalendarExceptionCollection. Elimina la instancia de CalendarException de esta colección"
type: docs
weight: 80
...
Elimina la instancia [`CalendarException`](../../calendarexception/) de esta colección.
...
| --- | --- | --- |
| elemento | CalendarException | El elemento a eliminar. |
