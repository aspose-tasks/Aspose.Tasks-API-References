...
description: "Método de CalendarExceptionCollection. Añade una instancia de CalendarException a este objeto de colección"
type: docs
weight: 40
...
| --- | --- | --- |
| elemento | CalendarException | El elemento a añadir. |
