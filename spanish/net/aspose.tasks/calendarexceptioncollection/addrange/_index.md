...
description: "Método CalendarExceptionCollection. Añade un rango de excepciones a la lista interna"
type: docs
weight: 50
...
Agrega un rango de excepciones a la lista interna.
...
| --- | --- | --- |
| exceptionList | IEnumerable`1 | Rango de excepciones a añadir. |
