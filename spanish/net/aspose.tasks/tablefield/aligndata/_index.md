...
description: "Propiedad TableField. Obtiene o establece la alineación de los datos en un campo de tabla"
type: docs
weight: 20
url: /es/net/aspose.tasks/tablefield/aligndata/
---
## TableField.AlignData property

Obtiene o establece la alineación de los datos en un campo de tabla.
