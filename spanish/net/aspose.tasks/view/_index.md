...
| Nombre | Descripción |
| --- | --- |
| [View](view#constructor)() | Inicializa una nueva instancia del[`View`](../view) clase. |
| [View](view#constructor_1)(ViewScreen) | Inicializa una nueva instancia del[`View`](../view) clase. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo) { get; } | Obtiene una instancia del[`PageInfo`](./pageinfo)clase. Representa datos de configuración de página que están presentes en formato de archivo mpp. |
