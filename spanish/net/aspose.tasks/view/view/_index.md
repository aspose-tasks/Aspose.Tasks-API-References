...
description: "Constructor View. Inicializa una nueva instancia de la clase View."
type: docs
weight: 10
...
Inicializa una nueva instancia de la clase [`View`](../).
...
| --- | --- | --- |
| viewScreen | ViewScreen | El tipo de pantalla para el cual se puede mostrar la vista. |
