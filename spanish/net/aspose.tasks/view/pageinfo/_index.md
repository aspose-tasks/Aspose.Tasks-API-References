...
description: "Propiedad View. Obtiene una instancia de la clase PageInfo. Representa los datos de configuración de página que están presentes en el formato de archivo mpp."
type: docs
weight: 60
...
Obtiene una instancia de la clase `PageInfo`. Representa los datos de configuración de página que están presentes en el formato de archivo mpp.
