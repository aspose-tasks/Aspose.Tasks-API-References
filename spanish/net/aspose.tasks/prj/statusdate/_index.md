...
description: la fecha de estado para mostrar el progreso o calcular los totales del valor ganado. La fecha de estado es la misma que la fecha actual fecha de hoy a menos que se especifique una fecha de estado diferente.
type: docs
weight: 680
