...
description: "Método WeekDayCollection. Inserta WeekDay en el índice especificado"
type: docs
weight: 90
...
Inserta [`WeekDay`](../../weekday/) en el índice especificado.
...
| --- | --- | --- |
| índice | Int32 | Índice donde insertar. |
| elemento | WeekDay | El elemento a insertar. |
