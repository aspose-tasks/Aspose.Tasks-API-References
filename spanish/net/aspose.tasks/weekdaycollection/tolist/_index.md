...
description: "Método WeekDayCollection. Convierte el objeto WeekDayCollection en una lista de objetos WeekDay"
type: docs
weight: 120
...
Convierte el objeto WeekDayCollection en una lista de objetos [`WeekDay`](../../weekday/).
...
Lista de objetos [`WeekDay`](../../weekday/).
