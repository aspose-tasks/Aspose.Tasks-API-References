...
description: "Método WeekDayCollection. Copia el contenido de la colección a un arreglo en el índice especificado"
type: docs
weight: 60
...
| --- | --- | --- |
| array | WeekDay[] | Arreglo de destino de [`WeekDay`](../../weekday/) al que copiar |
| arrayIndex | Int32 | Índice inicial para la operación de copia. |
