...
description: "Método WeekDayCollection. Verifica si la colección contiene el WeekDay especificado"
type: docs
weight: 50
...
Verifica si la colección contiene [`WeekDay`](../../weekday/).specified.
...
| --- | --- | --- |
| elemento | WeekDay | El elemento contra el cual comprobar. |

### Valor devuelto

true, si la colección contiene el elemento especificado, o false en caso contrario.
