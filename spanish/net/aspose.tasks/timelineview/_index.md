...
description: Representa una vista de línea de tiempo de un proyecto.
type: docs
weight: 2250
...
| Nombre | Descripción |
| --- | --- |
| [TimelineView](timelineview)() | Inicializa una nueva instancia del[`TimelineView`](../timelineview) clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [DateFormat](../../aspose.tasks/timelineview/dateformat) { get; set; } | Obtiene o establece un valor que indica cómo dar formato a las fechas en la vista de línea de tiempo. |
| [DisplayOverlapped](../../aspose.tasks/timelineview/displayoverlapped) { get; set; } | Obtiene o establece un valor que indica si mostrar tareas superpuestas en varias filas. |
...
| [ShowDates](../../aspose.tasks/timelineview/showdates) { get; } | Obtiene un valor que indica si mostrar fechas. |
...
| [ShowPanZoom](../../aspose.tasks/timelineview/showpanzoom) { get; set; } | Obtiene o establece un valor que indica si se muestra el control de panorámica y zoom. |
| [ShowTimescale](../../aspose.tasks/timelineview/showtimescale) { get; set; } | Obtiene o establece un valor que indica si mostrar la escala de tiempo. |
| [ShowToday](../../aspose.tasks/timelineview/showtoday) { get; set; } | Obtiene o establece un valor que indica si se debe mostrar una línea que represente el día de hoy. |
| [Table](../../aspose.tasks/view/table) { get; set; } | Obtiene o establece una tabla de la vista única. |
| [TextLinesCount](../../aspose.tasks/timelineview/textlinescount) { get; set; } | Obtiene o establece un valor que indica cuántas líneas se utilizan para mostrar la tarea en una escala de tiempo. |
