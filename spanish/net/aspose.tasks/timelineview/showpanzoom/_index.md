...
description: "Propiedad TimelineView. Obtiene o establece un valor que indica si se muestra el control de desplazamiento y zoom"
type: docs
weight: 50
...
Obtiene o establece un valor que indica si se debe mostrar el control de panorámica y zoom.
