...
description: Inicializa una nueva instancia delProjectServerCredentialsaspose.tasks/projectservercredentials class usando la URL del sitio de SharePoint y el token de autorización SPOIDCRL válido para el sitio PWA Project Web Access de SharePoint.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`ProjectServerCredentials`](../../projectservercredentials) class usando la URL del sitio de SharePoint y el token de autorización SPOIDCRL válido para el sitio PWA (Project Web Access) de SharePoint.
...
Inicializa una nueva instancia del[`ProjectServerCredentials`](../../projectservercredentials) clase usando la URL del sitio de SharePoint, nombre de usuario y contraseña.
...
Inicializa una nueva instancia del[`ProjectServerCredentials`](../../projectservercredentials) class usando la URL del extremo de Project Web Access y las credenciales de red.
