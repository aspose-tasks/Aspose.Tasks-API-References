...
description: "Método de TimephasedData. Crea e inicializa una nueva instancia de la clase TimephasedData para datos con fase temporal basados en trabajo."
type: docs
weight: 40
...
Crea e inicializa una nueva instancia de la clase [`TimephasedData`](../) para datos con fase temporal basados en trabajo.
...
| finalizar | DateTime | fecha y hora de finalización. |
| value | TimeSpan | Valor de Timespan. |
| timeUnit | TimeUnitType | Tipo de unidad de tiempo. |
| tipo | TimephasedDataType | Tipo de datos con fase temporal. |

### Valor devuelto

Una instancia de la clase [`TimephasedData`](../) para datos con fase temporal basados en trabajo.
