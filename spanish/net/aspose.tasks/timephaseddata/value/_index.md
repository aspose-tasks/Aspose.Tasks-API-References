...
description: "Propiedad TimephasedData. Obtiene o establece el valor por unidad de tiempo para un período de datos faseado en el tiempo"
type: docs
weight: 100
...
Obtiene o establece el valor por unidad de tiempo para un período de datos con fases de tiempo.
...
| excepción | condición |
| --- | --- |
| [TasksException](../../tasksexception/) | Cuando el valor es incorrecto para el [`TimephasedDataType`](../timephaseddatatype/) especificado o tiene un valor negativo. |
