...
description: "Propiedad TimephasedData. Obtiene o establece la fecha de inicio de un período de datos faseado en el tiempo"
type: docs
weight: 60
...
Obtiene o establece la fecha de inicio de un período de datos con fases de tiempo.
