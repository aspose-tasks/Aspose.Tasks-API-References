...
description: "Propiedad TimephasedData. Obtiene o establece el identificador único de un dato faseado en el tiempo"
type: docs
weight: 80
url: /es/net/aspose.tasks/timephaseddata/uid/
---
## TimephasedData.Uid property

Obtiene o establece el identificador único de un dato con fases de tiempo
