...
description: "Método TimephasedData. Crea e inicializa una nueva instancia de la clase TimephasedData para datos temporales basados en unidades de una asignación de un recurso material"
type: docs
weight: 30
...
Crea e inicializa una nueva instancia de la clase [`TimephasedData`](../) para datos temporales basados en unidades de una asignación de un recurso material.
...
Una instancia de la clase [`TimephasedData`](../) para datos con fase temporal basados en costos.
