...
description: "Método AssignmentBaseline. Devuelve un valor que indica si esta instancia es igual a un objeto especificado."
type: docs
weight: 60
url: /es/net/aspose.tasks/assignmentbaseline/equals/
---
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| otro | AssignmentBaseline | el objeto AssignmentBaseline especificado para comparar con esta instancia. |
