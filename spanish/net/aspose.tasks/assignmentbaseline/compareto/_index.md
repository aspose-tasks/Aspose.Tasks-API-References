...
description: "Método AssignmentBaseline. Implementación de la interfaz IComparable. Compara esta instancia con el objeto Baseline especificado."
type: docs
weight: 50
url: /es/net/aspose.tasks/assignmentbaseline/compareto/
---
...
| --- | --- | --- |
| otro | AssignmentBaseline | el objeto Baseline especificado con el que comparar esta instancia. |
