...
description: "Método DayTypeCollection. Elimina la primera aparición de un objeto específico de esta colección"
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | DayType | el objeto especificado para eliminar. |
