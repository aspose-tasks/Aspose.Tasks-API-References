...
description: "Método DayTypeCollection. Determina el índice del elemento especificado en esta colección"
type: docs
weight: 90
url: /es/net/aspose.tasks/daytypecollection/indexof/
---
...
| --- | --- | --- |
| elemento | DayType | el elemento especificado para localizar en esta colección. |
