...
description: "Método DayTypeCollection. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false"
type: docs
weight: 60
url: /es/net/aspose.tasks/daytypecollection/contains/
---
...
| --- | --- | --- |
| elemento | DayType | el elemento especificado para buscar. |
