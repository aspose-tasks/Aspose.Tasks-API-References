...
description: "Método WorkWeekCollection. Convierte el objeto WorkWeekCollection en una lista de objetos WorkWeek"
type: docs
weight: 60
...
Convierte el objeto WorkWeekCollection en una lista de objetos [`WorkWeek`](../../workweek/).
...
Lista de objetos [`WorkWeek`](../../workweek/).
