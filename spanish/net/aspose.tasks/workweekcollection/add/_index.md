...
description: "Método WorkWeekCollection. Añade una instancia de WorkWeek a este objeto de colección."
type: docs
weight: 40
url: /es/net/aspose.tasks/workweekcollection/add/
---
## WorkWeekCollection.Add method

Agrega una instancia de WorkWeek a este objeto de colección.
...
| --- | --- | --- |
| elemento | WorkWeek | El elemento a añadir. |
