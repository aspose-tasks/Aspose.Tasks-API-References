...
description: "Método TableCollection. Convierte una colección de tablas en una lista de objetos Table"
type: docs
weight: 90
...
Convierte una colección de tablas en una lista de objetos [`Table`](../../table/).
...
Lista genérica de objetos [`Table`](../../table/).
