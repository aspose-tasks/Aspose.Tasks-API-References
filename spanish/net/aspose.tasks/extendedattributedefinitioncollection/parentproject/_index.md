...
description: "ExtendedAttributeDefinitionCollection propiedad. Obtiene un proyecto padre para la instancia de ExtendedAttributeDefinitionCollection. devuelve un proyecto padre para esta colección"
type: docs
weight: 40
...
Obtiene un proyecto padre para la instancia de [`ExtendedAttributeDefinitionCollection`](../). devuelve un proyecto padre para esta colección.
