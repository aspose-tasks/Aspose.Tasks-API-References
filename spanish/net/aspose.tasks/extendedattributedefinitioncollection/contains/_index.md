...
description: "Método ExtendedAttributeDefinitionCollection. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false"
type: docs
weight: 70
...
| --- | --- | --- |
| elemento | ExtendedAttributeDefinition | el elemento especificado para buscar. |
