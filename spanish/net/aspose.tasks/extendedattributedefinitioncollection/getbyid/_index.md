...
description: "ExtendedAttributeDefinitionCollection método. Devuelve una definición de atributo extendido por id"
type: docs
weight: 90
...
Devuelve una definición de atributo extendido por id
...
| --- | --- | --- |
| id | Int32 | identificador especificado |

### Valor devuelto

ExtendedAttributeDefinition con identificador especificado.
