...
description: "Método ExtendedAttributeDefinitionCollection. Convierte este objeto ExtendedAttributeDefinitionCollection en una lista que contiene instancias de la clase ExtendedAttributeDefinition"
type: docs
weight: 150
...
Convierte este objeto ExtendedAttributeDefinitionCollection en una lista que contiene instancias de la clase [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
...
Lista que contiene instancias de la clase [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
