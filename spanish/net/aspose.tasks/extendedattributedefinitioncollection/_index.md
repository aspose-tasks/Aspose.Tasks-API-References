...
description: Representa una colección deExtendedAttributeDefinition./extendedattributedefinition objetos.
type: docs
weight: 540
...
Representa una colección de[`ExtendedAttributeDefinition`](../extendedattributedefinition) objetos.
...
| [ParentProject](../../aspose.tasks/extendedattributedefinitioncollection/parentproject) { get; } | Obtiene un proyecto principal para el[`ExtendedAttributeDefinitionCollection`](../extendedattributedefinitioncollection) instancia. devuelve un proyecto principal para esta colección. |
...
| [Contains](../../aspose.tasks/extendedattributedefinitioncollection/contains)(ExtendedAttributeDefinition) | Devuelve verdadero si el elemento especificado se encuentra en esta colección; de lo contrario, false. |
| [CopyTo](../../aspose.tasks/extendedattributedefinitioncollection/copyto)(ExtendedAttributeDefinition[], int) | Copia los elementos de esta colección en la matriz especificada, comenzando en el índice de matriz especificado. |
| [GetById](../../aspose.tasks/extendedattributedefinitioncollection/getbyid)(int) | Devuelve una definición de atributo extendida por id |
...
| [ToList](../../aspose.tasks/extendedattributedefinitioncollection/tolist)() | Convierte este objeto ExtendedAttributeDefinitionCollection en una lista que contiene instancias del[`ExtendedAttributeDefinition`](../extendedattributedefinition) clase. |
