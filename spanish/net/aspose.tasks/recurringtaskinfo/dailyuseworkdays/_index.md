...
description: "Propiedad RecurringTaskInfo. Obtiene o establece un valor que indica si se deben usar días laborables para el patrón de recurrencia diaria"
type: docs
weight: 20
url: /es/net/aspose.tasks/recurringtaskinfo/dailyuseworkdays/
---
## RecurringTaskInfo.DailyUseWorkdays property

Obtiene o establece un valor que indica si se deben usar días laborables para el patrón de recurrencia diario.
