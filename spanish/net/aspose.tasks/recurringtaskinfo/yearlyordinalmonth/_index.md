...
description: "Propiedad RecurringTaskInfo. Obtiene o establece un mes del patrón de recurrencia anual al usar el día ordinal. Puede ser uno de los valores de la enumeración Month"
type: docs
weight: 200
...
Obtiene o establece un mes del patrón de recurrencia anual al usar el día ordinal. Puede ser uno de los valores de la enumeración [`Month`](../../month/)
