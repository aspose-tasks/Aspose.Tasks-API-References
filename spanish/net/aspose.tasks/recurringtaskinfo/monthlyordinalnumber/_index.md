...
description: "Propiedad RecurringTaskInfo. Obtiene o establece un número ordinal del patrón de recurrencia mensual. Puede ser uno de los valores de la enumeración OrdinalNumber"
type: docs
weight: 70
...
Obtiene o establece un número ordinal del patrón de recurrencia mensual. Puede ser uno de los valores de la enumeración [`OrdinalNumber`](../../ordinalnumber/)
