...
description: "Propiedad RecurringTaskInfo. Obtiene o establece un valor que indica si se debe usar la fecha de finalización o un número de ocurrencias para la tarea recurrente"
type: docs
weight: 150
...
Obtiene o establece un valor que indica si se debe usar la fecha de finalización o un número de ocurrencias para la tarea recurrente.
