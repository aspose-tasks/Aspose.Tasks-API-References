...
description: "Propiedad ResourceSavingArgs. Obtiene o establece un valor que indica si el flujo permanecerá abierto después de que finalice el guardado de recursos"
type: docs
weight: 30
url: /es/net/aspose.tasks/resourcesavingargs/keepstreamopen/
---
## ResourceSavingArgs.KeepStreamOpen property

Obtiene o establece un valor que indica si el flujo permanecerá abierto después de que finalice el guardado del recurso.
