...
description: "Propiedad ResourceSavingArgs. Obtiene o establece el nombre de archivo supuesto que pasa del convertidor al código del método personalizado. Puede usarse en código personalizado para decidir cómo procesar o dónde guardar ese archivo"
type: docs
weight: 20
url: /es/net/aspose.tasks/resourcesavingargs/filename/
---
## ResourceSavingArgs.FileName property

Obtiene o establece el nombre de archivo supuesto que pasa del convertidor al código del método personalizado. Puede usarse en código personalizado para decidir cómo procesar o dónde guardar ese archivo.
...
Muestra cómo configurar el uso de devoluciones de llamada de guardado de CSS.
