...
description: Representa una clave de propiedad de una clase del tipo especificado. Se utiliza una instancia de esta clase al obtener o establecer la propiedad de un contenedor.
type: docs
weight: 840
