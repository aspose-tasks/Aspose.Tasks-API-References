...
description: "Propiedad OutlineValue. Obtiene o establece el Id de un nodo padre de un código de esquema"
type: docs
weight: 50
...
Obtiene o establece el Id de un nodo padre de un código de esquema.
