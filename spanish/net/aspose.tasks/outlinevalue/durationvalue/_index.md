...
description: "Propiedad OutlineValue. Obtiene o establece la duración si Type es Duration"
type: docs
weight: 30
url: /es/net/aspose.tasks/outlinevalue/durationvalue/
---
## OutlineValue.DurationValue property

Obtiene o establece la duración si el Tipo es Duration.
...
Prefiera esta propiedad sobre el [`Value`](../value/), cuando necesite establecer el valor para OutlineValues con tipo Duration.
