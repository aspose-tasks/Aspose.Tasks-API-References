...
description: Inicializa una nueva instancia delWorkingTimeaspose.tasks/workingtime clase con un intervalo con las horas de inicio y finalización especificadas.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`WorkingTime`](../../workingtime) clase con un intervalo con las horas de inicio y finalización especificadas.
...
Inicializa una nueva instancia del[`WorkingTime`](../../workingtime) clase con un elemento de intervalo con las horas de inicio y finalización especificadas.
