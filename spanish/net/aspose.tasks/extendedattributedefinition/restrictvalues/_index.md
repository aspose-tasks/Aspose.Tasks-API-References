...
description: "Propiedad ExtendedAttributeDefinition. Obtiene o establece un valor que indica si los valores del campo personalizado están restringidos a los valores en la ValueList"
type: docs
weight: 220
...
Obtiene o establece un valor que indica si los valores del campo personalizado están restringidos a los valores en la [`ValueList`](../valuelist/).
