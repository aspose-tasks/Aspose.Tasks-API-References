...
description: Aspose.Tasks.ExtendedAttributeDefinition clase. Representa una definición de atributo extendida asociada con un proyecto.
type: docs
weight: 540
...
| [ParentProject](../../aspose.tasks/extendedattributedefinition/parentproject/) { get; } | Obtiene el proyecto padre para el`ExtendedAttributeDefinition` instancia. |
...
| override [GetHashCode](../../aspose.tasks/extendedattributedefinition/gethashcode/)() | Devuelve un código hash para la instancia del`ExtendedAttributeDefinition` clase. |
