...
description: "Propiedad ExtendedAttributeDefinition. Obtiene o establece un valor que indica si está habilitado un descenso automático a asignaciones"
type: docs
weight: 70
url: /es/net/aspose.tasks/extendedattributedefinition/autorolldown/
---
## ExtendedAttributeDefinition.AutoRollDown property

Obtiene o establece un valor que indica si se habilita una propagación automática a asignaciones.
