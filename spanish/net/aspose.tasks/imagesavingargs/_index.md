---
title: "Clase ImageSavingArgs"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Aspose.Tasks.ImageSavingArgs clase. Esta clase representa un conjunto de datos relacionados con el guardado de archivos de imagen externos que ocurre durante la conversión al formato HTML"
type: docs
weight: 900
url: /es/net/aspose.tasks/imagesavingargs/
---
## ImageSavingArgs class

Esta clase representa un conjunto de datos relacionados con el guardado de archivos de imagen externos que ocurre durante la conversión al formato HTML.
...
| Nombre | Descripción |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | Inicializa una nueva instancia de la clase `ImageSavingArgs`. |
...
| [ImageType](../../aspose.tasks/imagesavingargs/imagetype/) { get; } | Obtiene un tipo de imagen HTML. |
...
Muestra cómo trabajar con los argumentos de guardado de imágenes.
