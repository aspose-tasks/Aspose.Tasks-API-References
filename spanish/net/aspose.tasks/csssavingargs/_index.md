---
title: "Clase CssSavingArgs"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.CssSavingArgs. Esta clase representa un conjunto de datos relacionados con el guardado de archivos CSS externos que ocurre durante la conversión al formato HTML"
type: docs
weight: 360
...
Esta clase representa un conjunto de datos relacionados con el guardado de archivos CSS externos que ocurre durante la conversión al formato HTML.
...
| Nombre | Descripción |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Inicializa una nueva instancia de la clase `CssSavingArgs`. |
...
Muestra cómo especificar los argumentos de guardado de CSS.
