...
description: "Método OutlineMaskCollection. Añade el elemento especificado a esta colección"
type: docs
weight: 40
...
| --- | --- | --- |
| elemento | OutlineMask | el elemento especificado para añadir a esta colección. |
