...
description: "Método de OutlineMaskCollection. Determina el índice del elemento especificado en esta colección"
type: docs
weight: 90
...
| --- | --- | --- |
| elemento | OutlineMask | el elemento especificado para localizar en esta colección. |
