...
description: "Método GroupCollection. Devuelve true si el elemento especificado se encuentra en esta colección, de lo contrario false."
type: docs
weight: 50
...
| --- | --- | --- |
| elemento | Group | el elemento especificado para buscar. |
