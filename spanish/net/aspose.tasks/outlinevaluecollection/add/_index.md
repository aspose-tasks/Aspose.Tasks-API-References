...
description: "OutlineValueCollection método. Añade el elemento especificado a esta colección"
type: docs
weight: 40
...
| --- | --- | --- |
| elemento | OutlineValue | el elemento especificado para añadir a esta colección. |
