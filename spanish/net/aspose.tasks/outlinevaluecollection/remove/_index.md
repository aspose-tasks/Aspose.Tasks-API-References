...
description: "Método OutlineValueCollection. Elimina la primera aparición de un objeto específico en esta colección."
type: docs
weight: 110
...
| --- | --- | --- |
| elemento | OutlineValue | el objeto especificado para eliminar. |
