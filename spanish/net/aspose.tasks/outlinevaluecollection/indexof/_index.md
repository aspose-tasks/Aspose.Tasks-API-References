...
description: "Método OutlineValueCollection. Determina el índice del elemento especificado en esta colección."
type: docs
weight: 90
url: /es/net/aspose.tasks/outlinevaluecollection/indexof/
---
...
| --- | --- | --- |
| elemento | OutlineValue | el elemento especificado para localizar en esta colección. |
