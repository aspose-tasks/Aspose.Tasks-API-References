...
description: Representa una colección deResourceAssignment./resourceassignment objetos.
type: docs
weight: 1500
...
Representa una colección de[`ResourceAssignment`](../resourceassignment) objetos.
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.tasks/resourceassignmentcollection/add#add_3)(ResourceAssignment) | Esta es la implementación stub del método Add de ICollection, que solo genera NotSupportedException |
...
| [ToList](../../aspose.tasks/resourceassignmentcollection/tolist)() | Convierte el objeto ResourceAssignmentCollection en una lista de[`ResourceAssignment`](../resourceassignment) objetos. |
