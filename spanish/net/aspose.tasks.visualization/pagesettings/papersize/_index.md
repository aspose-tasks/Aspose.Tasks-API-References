...
description: "Propiedad PageSettings. Obtiene o establece un tamaño de papel. Puede ser uno de los valores de la enumeración PrinterPaperSize"
type: docs
weight: 70
url: /es/net/aspose.tasks.visualization/pagesettings/papersize/
---
## PageSettings.PaperSize property

Obtiene o establece un tamaño de papel. Puede ser uno de los valores de la enumeración [`PrinterPaperSize`](../../printerpapersize/).
