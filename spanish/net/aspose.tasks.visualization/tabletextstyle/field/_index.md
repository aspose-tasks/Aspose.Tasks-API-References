...
description: "Propiedad TableTextStyle. Obtiene o establece un campo al que se aplicará el estilo. Field"
type: docs
weight: 20
...
Obtiene o establece un campo al que se aplicará el estilo. `Field`.
