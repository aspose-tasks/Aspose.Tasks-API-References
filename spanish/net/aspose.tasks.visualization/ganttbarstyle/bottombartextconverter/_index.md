...
description: "Propiedad GanttBarStyle. Obtiene o establece un convertidor definido por el usuario para obtener el texto que se mostrará en la parte inferior de la barra de tareas. Sobrescribe el valor de la propiedad BottomField"
type: docs
weight: 20
...
Obtiene o establece un convertidor definido por el usuario para obtener el texto que se mostrará en la parte inferior de la barra de la tarea. Sobrescribe el valor de la propiedad [`BottomField`](../bottomfield/).
