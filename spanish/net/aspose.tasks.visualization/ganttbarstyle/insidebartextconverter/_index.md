...
description: "Propiedad GanttBarStyle. Obtiene o establece un convertidor definido por el usuario para obtener el texto que se renderizará dentro de la barra de tareas. Anula el valor de la propiedad InsideField"
type: docs
weight: 80
...
Obtiene o establece un convertidor definido por el usuario para obtener el texto que se renderizará dentro de la barra de la tarea. Anula el valor de la propiedad [`InsideField`](../insidefield/).
