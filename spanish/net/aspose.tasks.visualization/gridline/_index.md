...
description: La línea horizontal o vertical que aparece en la vista del proyecto.
type: docs
weight: 2750
...
| Nombre | Descripción |
| --- | --- |
| [Gridline](gridline)() | Inicializa una nueva instancia del[`Gridline`](../gridline) clase. |
...
| Nombre | Descripción |
| --- | --- |
| override [Equals](../../aspose.tasks.visualization/gridline/equals)(object) | Devuelve un indicador que indica si esta instancia es igual al objeto especificado. |
| override [GetHashCode](../../aspose.tasks.visualization/gridline/gethashcode)() | Devuelve un valor de código hash para la instancia del[`Gridline`](../gridline) clase. |
