...
description: "Propiedad ProgressLines. Obtiene o establece la fecha a partir de la cual se mostrarán las líneas de progreso"
type: docs
weight: 20
...
Obtiene o establece la fecha desde la cual mostrar las líneas de progreso.
