...
description: "Propiedad ProgressLines. Obtiene la lista de fechas seleccionadas para las que se mostrarán las líneas de progreso"
type: docs
weight: 190
...
Obtiene la lista de fechas seleccionadas para mostrar líneas de progreso.
