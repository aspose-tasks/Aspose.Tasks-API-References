...
description: "Propiedad ProgressLines. Obtiene o establece un valor que indica si se muestra la fecha para cada línea de progreso"
type: docs
weight: 200
...
Obtiene o establece un valor que indica si se muestra la fecha para cada línea de progreso.
