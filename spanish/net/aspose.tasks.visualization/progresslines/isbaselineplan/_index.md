...
description: "Propiedad ProgressLines. Obtiene o establece un valor que indica si se muestran las líneas de progreso para el plan base o real"
type: docs
weight: 90
...
Obtiene o establece un valor que indica si se deben mostrar las líneas de progreso para el plan base o real.
