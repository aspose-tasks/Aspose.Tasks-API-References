...
description: "Propiedad TimescaleTier. Obtiene o establece la unidad de escala de tiempo TimescaleUnit para el nivel de escala de tiempo. El valor predeterminado es Days"
type: docs
weight: 80
...
Obtiene o establece la unidad de escala de tiempo [`TimescaleUnit`](../../timescaleunit/) para el nivel de escala de tiempo. El valor predeterminado es [`Days`](../../timescaleunit/).
