...
description: "Constructor TimescaleTier. Inicializa una nueva instancia de la clase TimescaleTier"
type: docs
weight: 10
...
Inicializa una nueva instancia de la clase [`TimescaleTier`](../).
...
| count | Int32 | El recuento de unidades [`TimescaleUnit`](../../timescaleunit/). |
