...
description: "Propiedad TimescaleTier. Obtiene o establece una función de devolución de llamada para manejar el renderizado de la marca de fecha en este nivel"
type: docs
weight: 40
url: /es/net/aspose.tasks.visualization/timescaletier/datetimeconverter/
---
## TimescaleTier.DateTimeConverter property

Obtiene o establece una función de devolución de llamada para manejar el renderizado de marcas de fecha en este nivel.
