...
description: "Propiedad BarStyle. Obtiene o establece un convertidor definido por el usuario para obtener el texto que se renderiza a la izquierda de la barra de tareas. Anula el valor de la propiedad LeftField"
type: docs
weight: 130
...
Obtiene o establece un convertidor definido por el usuario para obtener el texto que se renderiza a la izquierda de la barra de la tarea. Anula el valor de la propiedad [`LeftField`](../leftfield/).
