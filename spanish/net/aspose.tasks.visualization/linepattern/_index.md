---
title: "Enumeración LinePattern"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Enumeración Aspose.Tasks.Visualization.LinePattern. Patrón de línea"
type: docs
weight: 3190
...
| --- | --- | --- |
| None | `0` | Indica que una línea no se mostrará. |
| Solid | `1` | Indica patrón de línea sólido. |
| CloseDot | `3` | Indica patrón de línea de punto cerrado. |
| Dotted | `4` | Indica patrón de línea punteada. |
| Dashed | `2` | Indica patrón de línea discontinua. |
