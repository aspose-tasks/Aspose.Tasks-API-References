...
description: "Propiedad TaskTextStyleEventArgs. Obtiene ViewColumn al que pertenece la celda actualmente renderizada."
type: docs
weight: 20
...
Obtiene [`ViewColumn`](../../viewcolumn/) al que pertenece la celda actualmente renderizada.
