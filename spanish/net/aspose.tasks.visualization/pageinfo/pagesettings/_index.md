...
description: "Propiedad PageInfo. Obtiene una instancia de la clase PageSettings que especifica la configuración de impresión de página"
type: docs
weight: 70
...
Obtiene una instancia de la clase `PageSettings` que especifica la configuración de impresión de página.
