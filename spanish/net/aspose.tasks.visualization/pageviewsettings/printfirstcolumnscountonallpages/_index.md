...
description: "Propiedad PageViewSettings. Obtiene o establece un valor que indica si se imprime un número especificado de primeras columnas en todas las páginas"
type: docs
weight: 60
...
Obtiene o establece un valor que indica si se imprime un número especificado de primeras columnas en todas las páginas.
