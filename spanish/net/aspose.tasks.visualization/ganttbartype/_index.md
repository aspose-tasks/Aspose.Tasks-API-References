---
title: "Enumeración GanttBarType"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Enumeración Aspose.Tasks.Visualization.GanttBarType. Especifica el tipo de barra"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Indica el tipo de barra Gantt discontinuo. |
| Framed | `1` | Indica el tipo de barra Gantt enmarcado. |
| Solid | `0` | Indica el tipo de barra Gantt sólido. |
