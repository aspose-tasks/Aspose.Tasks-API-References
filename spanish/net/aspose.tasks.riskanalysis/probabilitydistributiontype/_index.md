---
title: "Enumeración ProbabilityDistributionType"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Enumeración Aspose.Tasks.RiskAnalysis.ProbabilityDistributionType. Especifica los tipos de distribuciones de probabilidad compatibles."
type: docs
weight: 1860
...
Especifica los tipos de distribuciones de probabilidad admitidas.
...
| --- | --- | --- |
| Uniform | `0` | La distribución cuando cada valor se elige con igual probabilidad. |
| Normal | `1` | La distribución que a veces se llama informalmente la curva de campana (distribución gaussiana). |
