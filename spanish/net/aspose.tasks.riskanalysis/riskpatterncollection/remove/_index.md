...
description: "Método RiskPatternCollection. Elimina la primera aparición de un objeto específico de esta colección."
type: docs
weight: 90
...
| --- | --- | --- |
| elemento | RiskPattern | el objeto especificado para eliminar. |
