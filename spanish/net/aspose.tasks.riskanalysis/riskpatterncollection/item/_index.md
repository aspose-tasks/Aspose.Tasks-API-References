...
description: "Propiedad RiskPatternCollection. Obtiene la instancia de la clase RiskPattern para la tarea especificada"
type: docs
weight: 30
...
Obtiene la instancia de la clase [`RiskPattern`](../../riskpattern/) para la tarea especificada.
