...
description: "Método RiskPatternCollection. Añade una instancia de la clase RiskPattern a esta colección."
type: docs
weight: 40
...
Añade una instancia de la clase [`RiskPattern`](../../riskpattern/) a esta colección.
...
| --- | --- | --- |
| item | RiskPattern | una instancia de la clase [`RiskPattern`](../../riskpattern/) para añadir a esta colección. |

### Excepciones

| excepción | condición |
| --- | --- |
| ArgumentNullException | *item* task es null. |
