---
title: "Clase RiskAnalyzer"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Clase Aspose.Tasks.RiskAnalysis.RiskAnalyzer. Realiza una simulación Monte Carlo basada en la configuración de análisis de riesgos especificada."
type: docs
weight: 1890
...
Ejecuta una simulación Monte Carlo basada en la configuración de análisis de riesgos especificada.
...
| Nombre | Descripción |
| --- | --- |
| [RiskAnalyzer](riskanalyzer/)(RiskAnalysisSettings) | Inicializa una nueva instancia de la clase `RiskAnalyzer`. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Settings](../../aspose.tasks.riskanalysis/riskanalyzer/settings/) { get; set; } | Obtiene o establece la instancia de la clase [`RiskAnalysisSettings`](../riskanalysissettings/) que define la configuración necesaria para el análisis de riesgos. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [Analyze](../../aspose.tasks.riskanalysis/riskanalyzer/analyze/)(Project) | Realiza un análisis de riesgos para el proyecto especificado. El análisis se basa en una simulación Monte Carlo y el resultado es una instancia de la clase [`RiskAnalysisResult`](../riskanalysisresult/). |
