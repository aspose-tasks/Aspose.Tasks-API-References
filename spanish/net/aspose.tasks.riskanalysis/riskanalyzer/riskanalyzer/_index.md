...
description: "Constructor RiskAnalyzer. Inicializa una nueva instancia de la clase RiskAnalyzer"
type: docs
weight: 10
...
Inicializa una nueva instancia de la clase [`RiskAnalyzer`](../).
...
| --- | --- | --- |
| settings | RiskAnalysisSettings | la instancia especificada de la clase [`RiskAnalysisSettings`](../../riskanalysissettings/). |
