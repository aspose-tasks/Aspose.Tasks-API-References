---
title: "Clase RiskItemStatisticsCollection"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Aspose.Tasks.RiskAnalysis.RiskItemStatisticsCollection class. Representa una colección que contiene las instancias de la clase RiskItemStatistics"
type: docs
weight: 1910
...
Representa una colección que contiene las instancias de la clase [`RiskItemStatistics`](../riskitemstatistics/).
...
| Nombre | Descripción |
| --- | --- |
| [Get](../../aspose.tasks.riskanalysis/riskitemstatisticscollection/get/)(Task) | Devuelve una instancia de la clase [`RiskItemStatistics`](../riskitemstatistics/) que contiene en esta colección y que está asociada con el objeto Task especificado; null si no se encuentra el elemento. |
