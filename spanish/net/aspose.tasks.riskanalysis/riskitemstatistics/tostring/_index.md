...
description: "Método RiskItemStatistics. Devuelve una representación de cadena corta de un elemento de riesgo. Los detalles exactos de la representación no están especificados y pueden cambiar"
type: docs
weight: 70
url: /es/net/aspose.tasks.riskanalysis/riskitemstatistics/tostring/
---
## RiskItemStatistics.ToString method

Devuelve una representación corta en cadena de un elemento de riesgo. Los detalles exactos de la representación no están especificados y pueden cambiar.
...
cadena corta que representa el objeto RiskItem.
