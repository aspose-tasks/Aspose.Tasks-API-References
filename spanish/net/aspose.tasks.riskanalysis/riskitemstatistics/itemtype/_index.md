...
description: "Propiedad RiskItemStatistics. Obtiene una instancia de la enumeración RiskItemType"
type: docs
weight: 20
...
Obtiene una instancia de la enumeración [`RiskItemType`](../../riskitemtype/).
