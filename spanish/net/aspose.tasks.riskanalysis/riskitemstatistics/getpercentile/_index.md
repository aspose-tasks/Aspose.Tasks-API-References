...
description: "Método RiskItemStatistics. Obtiene un valor por debajo del cual cae un porcentaje especificado de muestras generadas"
type: docs
weight: 60
...
Obtiene un valor por debajo del cual cae un porcentaje especificado de las muestras generadas.
...
| --- | --- | --- |
| porcentaje | Int32 | el porcentaje especificado entre 0 y 100. |

### Valor devuelto

un valor por debajo del cual cae un porcentaje especificado de muestras generadas.
