...
description: "Constructor RiskPattern. Inicializa una nueva instancia de la clase RiskPattern"
type: docs
weight: 10
...
Inicializa una nueva instancia de la clase [`RiskPattern`](../).
...
| --- | --- | --- |
| tarea | Tarea | la tarea del proyecto especificada para la cual se aplicará este riesgo en la simulación Monte Carlo. |
