...
description: "Propiedad RiskPattern. Obtiene o establece el nivel de confianza que corresponde al porcentaje de tiempo en que los valores generados realmente estarán dentro de las estimaciones optimista y pesimista. El valor predeterminado es CL99"
type: docs
weight: 20
...
Obtiene o establece el nivel de confianza que corresponde al porcentaje de tiempo en que los valores generados reales estarán dentro de las estimaciones optimistas y pesimistas. El valor predeterminado es CL99.
...
Puede ser uno de los valores definidos en la enumeración `ConfidenceLevel`.
