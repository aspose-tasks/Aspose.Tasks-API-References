...
description: "Propiedad RiskPattern. Obtiene o establece la distribución de probabilidad utilizada en la simulación Monte Carlo. El valor predeterminado es ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
Puede ser uno de los valores definidos en la enumeración [`ProbabilityDistributionType`](../../probabilitydistributiontype/).
