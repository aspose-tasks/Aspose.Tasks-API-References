...
description: Representa un patrón de riesgo para una tarea de proyecto.
type: docs
weight: 1660
...
| Nombre | Descripción |
| --- | --- |
| [RiskPattern](riskpattern)(Task) | Inicializa una nueva instancia del[`RiskPattern`](../riskpattern) clase. |
