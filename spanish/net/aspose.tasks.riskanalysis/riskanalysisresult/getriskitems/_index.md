...
description: "Método RiskAnalysisResult. Devuelve una instancia de la colección RiskItemStatisticsCollection para el tipo de riesgo especificado"
type: docs
weight: 10
...
Devuelve una instancia de la [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) para el tipo de riesgo especificado.
...
| --- | --- | --- |
| itemType | RiskItemType | el tipo de riesgo especificado; puede ser uno de los valores de la enumeración [`RiskItemType`](../../riskitemtype/). |
