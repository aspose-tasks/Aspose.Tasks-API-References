---
title: "Enumeración ConfidenceLevel"
second_title: "Referencia de API de Aspose.Tasks para .NET"
description: "Aspose.Tasks.RiskAnalysis.ConfidenceLevel enum. Especifica los niveles de confianza compatibles utilizados en el análisis de riesgos que corresponden al porcentaje de tiempo en que los valores reales estarán dentro de las estimaciones optimistas y pesimistas."
type: docs
weight: 1850
...
Especifica los niveles de confianza admitidos utilizados en el análisis de riesgos que corresponden al porcentaje de tiempo en que los valores reales estarán dentro de las estimaciones optimistas y pesimistas.
...
| --- | --- | --- |
| CL99 | `99` | Nivel de confianza del 99 %. |
| CL95 | `95` | Nivel de confianza del 95 %. |
| CL90 | `90` | Nivel de confianza del 90 %. |
| CL85 | `85` | Nivel de confianza del 85 %. |
| CL75 | `75` | Nivel de confianza del 75 %. |
