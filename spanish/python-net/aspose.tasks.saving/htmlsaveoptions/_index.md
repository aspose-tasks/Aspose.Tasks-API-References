...
type: docs
weight: 20
url: /es/python-net/aspose.tasks.saving/htmlsaveoptions/
---

## HtmlSaveOptions class

Permite especificar opciones adicionales al renderizar las páginas del proyecto en HTML.

El tipo HtmlSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| HtmlSaveOptions() | Inicializa una nueva instancia de la clase [HtmlSaveOptions](/tasks/python-net/aspose.tasks.saving/htmlsaveoptions/). |
## Propiedades
| Nombre | Descripción |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Obtiene o establece un valor que indica si se debe usar un pincel degradado al renderizar el diseño del proyecto. |
...
| css_style_prefix | Obtiene o establece el prefijo de estilo CSS. |
| font_settings | Especifica la configuración de fuentes utilizada al renderizar la vista del proyecto. |
| reduce_footer_gap | Obtiene o establece un valor que indica si se debe reducir el espacio entre la última tarea y el pie de página. |
| include_project_name_in_page_header | Obtiene o establece un valor que indica si se debe incluir el nombre del proyecto en el encabezado de la página HTML. |
| include_project_name_in_title | Obtiene o establece un valor que indica si se debe incluir el nombre del proyecto en el título HTML. |
| pages | Obtiene o establece una lista de números de página para guardar al renderizar el diseño del proyecto. |
| export_css | Obtiene o establece la forma en que se exporta el CSS. |
| export_images | Obtiene o establece la forma en que se exportan las imágenes. |
| export_fonts | Obtiene o establece la forma en que se exportan las fuentes. |
| css_saving_callback | Obtiene o establece la función de devolución de llamada que se llama para crear el recurso donde se almacena el CSS. |
| font_saving_callback | Obtiene o establece la función de devolución de llamada que se llama para crear el recurso donde se almacena la fuente. |
| image_saving_callback | Obtiene o establece la función de devolución de llamada que se llama para crear el recurso donde se almacena la fuente. |
| font_face_types | Obtiene o establece los tipos de fuente. |
| page_saving_callback | Obtiene o establece una devolución de llamada definida por el usuario que se utiliza para obtener un flujo de salida para cada página renderizada. |
