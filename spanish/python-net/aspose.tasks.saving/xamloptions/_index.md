...
type: docs
weight: 180
url: /es/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// Permite especificar opciones adicionales al renderizar las páginas del proyecto en XAML.

El tipo XamlOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| XamlOptions() | Inicializa una nueva instancia de la clase [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) que puede usarse para guardar el proyecto en formato XAML. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
| save_format |  |
