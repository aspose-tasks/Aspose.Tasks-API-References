...
type: docs
weight: 40
url: /es/python-net/aspose.tasks.saving/imagesaveoptions/
---

## ImageSaveOptions class

Permite especificar opciones adicionales al renderizar las páginas del proyecto en imágenes.

El tipo ImageSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ImageSaveOptions(save_format) | Inicializa una nueva instancia de la clase [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) que puede usarse para guardar imágenes renderizadas en formatos TIFF, PNG, BMP o JPEG. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
| save_format |  |
...
| pages | Obtiene o establece una lista de números de página para guardar al guardar el diseño del proyecto en archivos separados. |
| jpeg_quality | Obtiene o establece la calidad JPEG. El rango de valores permitido es 0..100. |
...
| tiff_compression | Obtiene o establece el tipo de compresión a aplicar al guardar imágenes generadas en formato TIFF. |
| pixel_format | Obtiene o establece el formato de los datos de color para cada píxel en la imagen. |
| horizontal_resolution | Obtiene o establece la resolución horizontal en dpi. |
| vertical_resolution | Obtiene o establece la resolución vertical en dpi. |
