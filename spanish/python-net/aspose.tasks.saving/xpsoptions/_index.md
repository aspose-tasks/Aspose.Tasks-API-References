...
type: docs
weight: 200
url: /es/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

Permite especificar opciones adicionales al renderizar las páginas del proyecto en XPS.

El tipo XpsOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| XpsOptions() | Inicializa una nueva instancia de la clase [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## Propiedades
| Nombre | Descripción |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Obtiene o establece un valor que indica si un metafile debe renderizarse como bitmap. |
