...
type: docs
weight: 120
url: /es/python-net/aspose.tasks.saving/printoptions/
---

## PrintOptions class

Permite especificar opciones adicionales al imprimir el proyecto.

El tipo PrintOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PrintOptions() | Inicializa una nueva instancia de la clase [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) que se puede usar para establecer diferentes opciones para imprimir el proyecto. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
| save_format |  |
