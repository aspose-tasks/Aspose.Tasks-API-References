...
type: docs
weight: 287
url: /es/java/com.aspose.tasks/tablefieldcollection/
---
...
Contiene una lista de objetos [TableField](../../com.aspose.tasks/tablefield). Implementa la interfaz IList&lt;TableField&gt;.
## Métodos
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | Devuelve el índice del elemento especificado en esta colección. |
...
Devuelve el índice del elemento especificado en esta colección.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | el elemento especificado. |
