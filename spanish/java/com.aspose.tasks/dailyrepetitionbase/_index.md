...
description: "Representa una clase base para repeticiones en un patrón de recurrencia diaria."
type: docs
weight: 65
url: /es/java/com.aspose.tasks/dailyrepetitionbase/
---
...
Representa una clase base para repeticiones en un patrón de recurrencia diaria.
## Métodos
...
| [getRepetitionInterval()](#getRepetitionInterval--) | Obtiene un número de días que representa el intervalo en días entre ocurrencias. |
| [getValidator(Calendar calendar)](#getValidator-com.aspose.tasks.Calendar-) | \{@inheritDoc\} |
| [setRepetitionInterval(int value)](#setRepetitionInterval-int-) | Establece un número de días que representa el intervalo en días entre ocurrencias. |
...
Obtiene un número de días que representa el intervalo en días entre ocurrencias.

**Returns:**
int - un número de días que representa el intervalo en días entre ocurrencias.
...
Establece un número de días que representa el intervalo en días entre ocurrencias.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | un número de días que representa el intervalo en días entre ocurrencias. |
