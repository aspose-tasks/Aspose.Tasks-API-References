...
description: "Spreadsheet2003SaveOptions 속성. AssignmentViewColumn을 렌더링하기 위한 할당 보기 열 목록을 가져오거나 설정합니다."
type: docs
weight: 20
...
할당 보기 열을 렌더링하기 위한 목록을 가져오거나 설정합니다 ([`AssignmentViewColumn`](../../../aspose.tasks.visualization/assignmentviewcolumn/)).
