...
description: "SaveOptions 속성. 프로젝트 뷰에 표시되는 BarStyle 클래스 인스턴스 목록을 가져오거나 설정합니다"
type: docs
weight: 10
...
프로젝트 뷰에 표시되는 [`BarStyle`](../../../aspose.tasks.visualization/barstyle/) 클래스 인스턴스 목록을 가져오거나 설정합니다.
