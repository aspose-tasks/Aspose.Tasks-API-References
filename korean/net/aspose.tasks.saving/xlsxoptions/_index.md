...
| 이름 | 설명 |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | 의 새 인스턴스를 초기화합니다.`XlsxOptions`프로젝트를 XLSX 형식으로 저장하는 데 사용할 수 있는 클래스입니다. |
...
| [Encoding](../../aspose.tasks.saving/xlsxoptions/encoding/) { get; set; } | 결과 XLSX 파일의 인코딩을 가져오거나 설정합니다. 기본값은UTF8 . |
