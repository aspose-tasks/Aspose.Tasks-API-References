...
description: "XlsxOptions 생성자. 프로젝트를 XLSX 형식으로 저장하는 데 사용할 수 있는 XlsxOptions 클래스의 새 인스턴스를 초기화합니다."
type: docs
weight: 10
...
새 인스턴스를 초기화합니다. [`XlsxOptions`](../) 클래스를 사용하면 프로젝트를 XLSX 형식으로 저장할 수 있습니다.
