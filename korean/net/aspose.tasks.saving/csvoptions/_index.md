...
| 이름 | 설명 |
| --- | --- |
| [CsvOptions](csvoptions/)() | 의 새 인스턴스를 초기화합니다.`CsvOptions` 프로젝트를 CSV 형식으로 저장하는 데 사용할 수 있는 클래스입니다. |
...
| [DataCategory](../../aspose.tasks.saving/csvoptions/datacategory/) { get; set; } | 저장할 데이터 범주를 가져오거나 설정합니다. |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | 헤더 포함 여부를 나타내는 값을 가져오거나 설정합니다(기본값은 TRUE). |
...
| [TextDelimiter](../../aspose.tasks.saving/csvoptions/textdelimiter/) { get; set; } | 텍스트 구분 기호를 가져오거나 설정합니다. |
