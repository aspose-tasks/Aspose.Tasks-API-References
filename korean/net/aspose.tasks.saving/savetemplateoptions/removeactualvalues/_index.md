...
description: "SaveTemplateOptions 속성. 프로젝트 템플릿의 모든 실제 값을 제거할지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 20
url: /ko/net/aspose.tasks.saving/savetemplateoptions/removeactualvalues/
---
## SaveTemplateOptions.RemoveActualValues property

프로젝트 템플릿의 모든 실제 값을 제거할지 여부를 나타내는 값을 가져오거나 설정합니다.
