---
title: "클래스 XpsOptions"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.Saving.XpsOptions 클래스. 프로젝트 페이지를 XPS로 렌더링할 때 추가 옵션을 지정할 수 있습니다."
type: docs
weight: 2280
url: /ko/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class
...
| 이름 | 설명 |
| --- | --- |
| [XpsOptions](xpsoptions/)() | `XpsOptions` 클래스의 새 인스턴스를 초기화합니다. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | 메타파일을 비트맵으로 렌더링할지 여부를 나타내는 값을 가져오거나 설정합니다. |
