...
| 이름 | 설명 |
| --- | --- |
| [XpsOptions](xpsoptions/)() | 의 새 인스턴스를 초기화합니다.`XpsOptions` 클래스. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | 메타파일을 비트맵으로 렌더링해야 하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
