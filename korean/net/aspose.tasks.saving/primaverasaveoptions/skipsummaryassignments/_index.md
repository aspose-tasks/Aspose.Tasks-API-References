...
description: "PrimaveraSaveOptions 속성. 내보내기 중에 리소스를 요약 작업에 할당하는 것이 건너뛰어야 하는지를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 60
url: /ko/net/aspose.tasks.saving/primaverasaveoptions/skipsummaryassignments/
---
