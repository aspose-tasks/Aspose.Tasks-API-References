...
type: docs
weight: 1770
url: /ko/net/aspose.tasks.saving/imagesaveoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | 의 새 인스턴스를 초기화합니다.`ImageSaveOptions` 렌더링된 이미지를 TIFF, PNG, BMP 또는 JPEG 형식으로 저장하는 데 사용할 수 있는 클래스입니다. |
...
| [DefaultFontName](../../aspose.tasks.saving/imagesaveoptions/defaultfontname/) { get; set; } | 렌더링을 위한 기본 글꼴을 가져오거나 설정합니다. |
...
| [FontResolveCallback](../../aspose.tasks.saving/imagesaveoptions/fontresolvecallback/) { get; set; } | 해결된 글꼴을 사용자 지정하는 데 사용할 수 있는 콜백을 가져오거나 설정합니다. |
...
| [HorizontalResolution](../../aspose.tasks.saving/imagesaveoptions/horizontalresolution/) { get; set; } | 수평 해상도를 dpi 단위로 가져오거나 설정합니다. |
| [JpegQuality](../../aspose.tasks.saving/imagesaveoptions/jpegquality/) { get; set; } | JPEG 품질을 가져오거나 설정합니다. 허용되는 값 범위는 0..100. 입니다. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | 프로젝트 레이아웃을 별도의 파일로 저장할 때 저장할 페이지 번호 목록을 가져오거나 설정합니다. 이 목록이 비어 있으면 모든 페이지가 저장됩니다. |
| [PageSavingCallback](../../aspose.tasks.saving/imagesaveoptions/pagesavingcallback/) { get; set; } | 렌더링된 각 페이지에 대한 출력 스트림을 가져오는 데 사용되는 사용자 정의 콜백을 가져오거나 설정합니다. |
| [PageSize](../../aspose.tasks.saving/saveoptions/pagesize/) { get; set; } | 렌더링할 페이지의 크기를 가져오거나 설정합니다(기본값은 PageSize.A4). |
| [PixelFormat](../../aspose.tasks.saving/imagesaveoptions/pixelformat/) { get; set; } | 이미지의 각 픽셀에 대한 색상 데이터의 형식을 가져오거나 설정합니다. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap/) { get; set; } | 마지막 작업과 바닥글 사이의 간격을 줄여야 하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [TiffCompression](../../aspose.tasks.saving/imagesaveoptions/tiffcompression/) { get; set; } | 생성된 이미지를 TIFF 형식으로 저장할 때 적용할 압축 유형을 가져오거나 설정합니다. |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/imagesaveoptions/useprojectdefaultfont/) { get; set; } | 렌더링에 기본 글꼴을 사용해야 하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution/) { get; set; } | 수직 해상도를 dpi로 가져오거나 설정합니다. |
