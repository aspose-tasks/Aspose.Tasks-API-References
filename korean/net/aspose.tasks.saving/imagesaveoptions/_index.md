---
title: "클래스 ImageSaveOptions"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.Saving.ImageSaveOptions 클래스. 프로젝트 페이지를 이미지로 렌더링할 때 추가 옵션을 지정할 수 있습니다."
type: docs
weight: 2030
...
| 이름 | 설명 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | `ImageSaveOptions` 클래스의 새 인스턴스를 초기화합니다. 이 인스턴스를 사용하여 렌더링된 이미지를 TIFF, PNG, BMP 또는 JPEG 형식으로 저장할 수 있습니다. |
...
| [FontSettings](../../aspose.tasks.saving/imagesaveoptions/fontsettings/) { get; } | 프로젝트 보기 렌더링 시 사용되는 글꼴 설정을 지정합니다. |
...
| [JpegQuality](../../aspose.tasks.saving/imagesaveoptions/jpegquality/) { get; set; } | JPEG 품질을 가져오거나 설정합니다. 허용값 범위는 0..100입니다. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | 프로젝트 레이아웃을 별도 파일로 저장할 때 저장할 페이지 번호 목록을 가져오거나 설정합니다. 이 목록이 비어 있으면 모든 페이지가 저장됩니다. |
| [PageSavingCallback](../../aspose.tasks.saving/imagesaveoptions/pagesavingcallback/) { get; set; } | 각 렌더링된 페이지에 대한 출력 스트림을 얻기 위해 사용되는 사용자 정의 콜백을 가져오거나 설정합니다. |
| [PageSize](../../aspose.tasks.saving/saveoptions/pagesize/) { get; set; } | 렌더링될 페이지 크기를 가져오거나 설정합니다 (기본값은 PageSize.A4). |
| [PixelFormat](../../aspose.tasks.saving/imagesaveoptions/pixelformat/) { get; set; } | 이미지의 각 픽셀에 대한 색상 데이터 형식을 가져오거나 설정합니다. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap/) { get; set; } | 마지막 작업과 푸터 사이의 간격을 줄일지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [VerticalResolution](../../aspose.tasks.saving/imagesaveoptions/verticalresolution/) { get; set; } | 수직 해상도를 dpi 단위로 가져오거나 설정합니다. |
