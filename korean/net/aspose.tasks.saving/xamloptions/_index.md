---
title: "클래스 XamlOptions"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.Saving.XamlOptions 클래스. /// 프로젝트 페이지를 XAML로 렌더링할 때 추가 옵션을 지정할 수 있습니다"
type: docs
weight: 2260
url: /ko/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// 프로젝트 페이지를 XAML로 렌더링할 때 추가 옵션을 지정할 수 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [XamlOptions](xamloptions/)() | XAML 형식으로 프로젝트를 저장하는 데 사용할 수 있는 새 `XamlOptions` 클래스 인스턴스를 초기화합니다. |
