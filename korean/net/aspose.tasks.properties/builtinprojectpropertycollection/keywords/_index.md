...
description: "BuiltInProjectPropertyCollection 속성. 프로젝트의 키워드를 가져오거나 설정합니다."
type: docs
weight: 70
url: /ko/net/aspose.tasks.properties/builtinprojectpropertycollection/keywords/
---
## BuiltInProjectPropertyCollection.Keywords property

프로젝트의 키워드를 가져오거나 설정합니다.
