...
description: "BuiltInProjectPropertyCollection 속성. 프로젝트의 하이퍼링크 기본값을 가져오거나 설정합니다."
type: docs
weight: 50
url: /ko/net/aspose.tasks.properties/builtinprojectpropertycollection/hyperlinkbase/
---
## BuiltInProjectPropertyCollection.HyperlinkBase property

프로젝트의 하이퍼링크 기본값을 가져오거나 설정합니다.
