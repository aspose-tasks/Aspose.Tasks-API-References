...
description: "TimescaleTier 속성. 티어의 각 시간 기간 내에서 레이블을 정렬하는 방법인 HorizontalStringAlignment을 가져오거나 설정합니다."
type: docs
weight: 20
...
티어의 각 시간 기간 내에서 레이블을 정렬하는 방법을 가져오거나 설정합니다 ([`HorizontalStringAlignment`](../../horizontalstringalignment/)).
