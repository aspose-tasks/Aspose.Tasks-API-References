...
description: "TimescaleTier 생성자. TimescaleTier 클래스의 새 인스턴스를 초기화합니다."
type: docs
weight: 10
...
`[`TimescaleTier`](../)` 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| unit | TimescaleUnit | 시간 눈금 단위 [`TimescaleUnit`](../../timescaleunit/). |
| count | Int32 | `[`TimescaleUnit`](../../timescaleunit/)` 단위의 개수. |
