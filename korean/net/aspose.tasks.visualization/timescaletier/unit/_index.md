...
description: "TimescaleTier 속성. 타임스케일 티어의 타임스케일 단위 TimescaleUnit을 가져오거나 설정합니다. 기본값은 Days입니다."
type: docs
weight: 80
...
타임스케일 티어의 타임스케일 단위 [`TimescaleUnit`](../../timescaleunit/)을 가져오거나 설정합니다. 기본값은 [`Days`](../../timescaleunit/)입니다.
