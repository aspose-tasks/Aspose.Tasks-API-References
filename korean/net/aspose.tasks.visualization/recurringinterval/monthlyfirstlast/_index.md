...
description: "RecurringInterval 속성. 첫 번째 또는 마지막 미리 정의된 날짜에 따라 진행 라인을 표시할지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 80
...
첫 번째 또는 마지막 미리 정의된 일에 따라 진행 라인을 표시할지 여부를 나타내는 값을 가져오거나 설정합니다.
