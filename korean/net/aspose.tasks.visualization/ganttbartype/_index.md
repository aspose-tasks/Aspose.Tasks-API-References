---
title: "열거형 GanttBarType"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.Visualization.GanttBarType 열거형. 바 유형을 지정합니다"
type: docs
weight: 3080
...
| 이름 | 값 | 설명 |
| --- | --- | --- |
| Dashed | `2` | 대시형 Gantt 바 유형을 나타냅니다. |
| Framed | `1` | 프레임형 Gantt 바 유형을 나타냅니다. |
| Solid | `0` | 솔리드형 Gantt 바 유형을 나타냅니다. |
