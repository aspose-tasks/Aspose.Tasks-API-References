---
title: "델리게이트 DateTimeConverter"
second_title: "Aspose.Tasks for .NET API 참조"
description: "보기 시간축 단계에서 날짜를 문자열로 변환하는 변환기 메서드를 나타냅니다."
type: docs
weight: 2990
...
보기 시간축 계층에서 날짜를 문자열로 변환하는 변환 메서드를 나타냅니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 날짜 | DateTime | 문자열로 변환할 DateTime 클래스의 인스턴스입니다. |
