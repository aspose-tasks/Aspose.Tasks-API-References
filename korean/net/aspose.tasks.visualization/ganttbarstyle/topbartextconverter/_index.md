...
description: "GanttBarStyle 속성. 작업 막대 상단에 표시할 텍스트를 가져오는 사용자 정의 변환기를 가져오거나 설정합니다. TopField 속성의 값을 재정의합니다."
type: docs
weight: 260
...
작업 막대 상단에 표시할 텍스트를 가져오는 사용자 정의 변환기를 가져오거나 설정합니다. [`TopField`](../topfield/) 속성의 값을 재정의합니다.
