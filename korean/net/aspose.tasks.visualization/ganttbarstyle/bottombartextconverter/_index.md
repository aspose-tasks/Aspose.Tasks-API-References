...
description: "GanttBarStyle 속성. 작업 막대 하단에 표시할 텍스트를 가져오기 위한 사용자 정의 변환기를 가져오거나 설정합니다. BottomField 속성의 값을 재정의합니다."
type: docs
weight: 20
...
작업 막대 하단에 표시할 텍스트를 가져오기 위한 사용자 정의 변환기를 가져오거나 설정합니다. [`BottomField`](../bottomfield/) 속성의 값을 재정의합니다.
