...
description: "PageSettings 속성. 용지 크기를 가져오거나 설정합니다. PrinterPaperSize 열거형의 값 중 하나일 수 있습니다."
type: docs
weight: 70
...
용지 크기를 가져오거나 설정합니다. [`PrinterPaperSize`](../../printerpapersize/) 열거형의 값 중 하나일 수 있습니다.
