...
description: "PageViewSettings 속성. 메모를 인쇄할지 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 70
url: /ko/net/aspose.tasks.visualization/pageviewsettings/printnotes/
---
## PageViewSettings.PrintNotes property

노트를 인쇄할지 여부를 나타내는 값을 가져오거나 설정합니다.
