---
title: "열거형 LinePattern"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.Visualization.LinePattern 열거형. 라인 패턴"
type: docs
weight: 3190
...
| 이름 | 값 | 설명 |
| --- | --- | --- |
| None | `0` | 라인이 표시되지 않음을 나타냅니다. |
| Solid | `1` | 솔리드 라인 패턴을 나타냅니다. |
| CloseDot | `3` | 닫힌 점 라인 패턴을 나타냅니다. |
| Dotted | `4` | 점선 라인 패턴을 나타냅니다. |
| Dashed | `2` | 대시 라인 패턴을 나타냅니다. |
