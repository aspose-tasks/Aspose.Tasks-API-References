...
description: "BarStyle 속성. 작업 막대 왼쪽에 표시할 텍스트를 가져오는 사용자 정의 변환기를 가져오거나 설정합니다. LeftField 속성의 값을 재정의합니다"
type: docs
weight: 130
...
사용자 정의 변환기를 가져오거나 설정하여 작업 막대의 왼쪽에 표시할 텍스트를 가져옵니다. [`LeftField`](../leftfield/) 속성의 값을 재정의합니다.
