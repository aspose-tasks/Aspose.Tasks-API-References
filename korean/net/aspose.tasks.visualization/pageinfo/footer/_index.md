...
description: "PageInfo 속성. 푸터 데이터를 나타내는 HeaderFooterInfo 클래스의 인스턴스를 가져오거나 설정합니다."
type: docs
weight: 20
...
[`HeaderFooterInfo`](../../headerfooterinfo/) 클래스의 인스턴스를 가져오거나 설정합니다. 이 클래스는 푸터 데이터를 나타냅니다.
