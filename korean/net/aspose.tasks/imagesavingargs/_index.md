---
title: "클래스 ImageSavingArgs"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.ImageSavingArgs 클래스. 이 클래스는 HTML 형식으로 변환하는 동안 발생하는 외부 이미지 파일 저장과 관련된 데이터 집합을 나타냅니다."
type: docs
weight: 900
url: /ko/net/aspose.tasks/imagesavingargs/
---
## ImageSavingArgs class

이 클래스는 HTML 형식으로 변환되는 동안 발생하는 외부 이미지 파일 저장과 관련된 데이터 집합을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ImageSavingArgs](imagesavingargs/)() | `ImageSavingArgs` 클래스의 새 인스턴스를 초기화합니다. |
...
| [ImageType](../../aspose.tasks/imagesavingargs/imagetype/) { get; } | HTML 이미지 유형을 가져옵니다. |
