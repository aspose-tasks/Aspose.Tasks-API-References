...
description: "Table 속성. 프로젝트가 리본의 보기 탭에 있는 Tables 드롭다운 목록에 테이블 이름을 표시하는지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 80
...
프로젝트가 리본의 보기 탭에 있는 Tables 드롭다운 목록에 테이블 이름을 표시할지 여부를 나타내는 값을 가져오거나 설정합니다.
