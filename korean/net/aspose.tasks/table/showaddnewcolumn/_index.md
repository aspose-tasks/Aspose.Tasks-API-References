...
description: "Table 속성. Add New Column 인터페이스를 표시할지 여부를 나타내는 값을 가져오거나 설정합니다. MSP 2010 버전 및 이후 버전에서 지원됩니다."
type: docs
weight: 70
...
'새 열 추가' 인터페이스를 표시할지 여부를 나타내는 값을 가져오거나 설정합니다. MSP 2010 버전 이후에서 지원됩니다.
