...
description: "Project 속성. 모든 리소스 기반 그룹 정의를 가져옵니다. ResourceGroups는 Group 객체의 컬렉션입니다."
type: docs
weight: 770
...
모든 리소스 기반 그룹 정의를 가져옵니다. ResourceGroups는 [`Group`](../../group/) 객체의 컬렉션입니다.
