...
description: MultipleCriticalPaths 설정 여부를 나타내는 값을 가져오거나 설정합니다.
type: docs
weight: 620
url: /ko/net/aspose.tasks/project/multiplecriticalpaths/
---
## Project.MultipleCriticalPaths property

MultipleCriticalPaths 설정 여부를 나타내는 값을 가져오거나 설정합니다.
