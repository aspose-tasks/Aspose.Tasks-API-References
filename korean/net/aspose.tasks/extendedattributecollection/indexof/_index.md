...
description: "ExtendedAttributeCollection 메서드. 이 컬렉션에서 지정된 항목의 인덱스를 결정합니다"
type: docs
weight: 90
url: /ko/net/aspose.tasks/extendedattributecollection/indexof/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | ExtendedAttribute | 이 컬렉션에서 찾을 지정된 항목. |
