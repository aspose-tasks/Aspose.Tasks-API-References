...
description: "ExtendedAttributeCollection 메서드. 지정된 항목이 이 컬렉션에 있으면 true를 반환하고, 그렇지 않으면 false를 반환합니다"
type: docs
weight: 60
url: /ko/net/aspose.tasks/extendedattributecollection/contains/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | ExtendedAttribute | 찾을 지정된 항목. |
