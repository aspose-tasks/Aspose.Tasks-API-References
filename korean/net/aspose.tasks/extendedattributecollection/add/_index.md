...
description: "ExtendedAttributeCollection 메서드. 지정된 항목을 이 컬렉션에 추가합니다"
type: docs
weight: 40
url: /ko/net/aspose.tasks/extendedattributecollection/add/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | ExtendedAttribute | 이 컬렉션에 추가할 지정된 항목. |
