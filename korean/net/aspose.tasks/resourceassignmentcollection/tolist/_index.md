...
description: "ResourceAssignmentCollection 메서드. ResourceAssignmentCollection 객체를 ResourceAssignment 객체 목록으로 변환합니다."
type: docs
weight: 100
...
ResourceAssignmentCollection 객체를 [`ResourceAssignment`](../../resourceassignment/) 객체 목록으로 변환합니다.
...
[`ResourceAssignment`](../../resourceassignment/) 객체 목록.
