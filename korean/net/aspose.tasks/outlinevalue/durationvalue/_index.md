...
description: "OutlineValue 속성. Type이 Duration인 경우 기간을 가져오거나 설정합니다."
type: docs
weight: 30
...
Type이 Duration인 경우 지속 시간을 가져오거나 설정합니다.
...
Duration 유형의 OutlineValues에 값을 설정해야 할 때, [`Value`](../value/)보다 이 속성을 사용하는 것이 좋습니다.
