...
description: "NullableBool 생성자. 지정된 부울 값으로 NullableBool 구조체의 새 인스턴스를 초기화합니다."
type: docs
weight: 10
...
지정된 부울 값으로 [`NullableBool`](../) 구조체의 새 인스턴스를 초기화합니다.
...
새로운 [`NullableBool`](../) 구조체 인스턴스를 초기화합니다.
...
| --- | --- | --- |
| value | Boolean | 현재 값. |
| isDefined | Boolean | 현재 값이 정의되었는지 여부를 나타내는 값. |
