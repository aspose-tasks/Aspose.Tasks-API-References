...
description: "ResourceSavingArgs 속성. 변환기에서 사용자 정의 메서드 코드로 전달되는 가정된 파일 이름을 가져오거나 설정합니다. 사용자 정의 코드에서 파일을 어떻게 처리하거나 어디에 저장할지 결정하는 데 사용할 수 있습니다."
type: docs
weight: 20
...
변환기에서 사용자 정의 메서드 코드로 전달되는 파일 이름을 가져오거나 설정합니다. 사용자 정의 코드에서 해당 파일을 어떻게 처리할지 또는 어디에 저장할지 결정하는 데 사용할 수 있습니다.
