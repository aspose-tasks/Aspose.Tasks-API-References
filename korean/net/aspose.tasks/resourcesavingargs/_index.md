---
title: "클래스 ResourceSavingArgs"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.ResourceSavingArgs 클래스. 이 클래스는 HTML 형식으로 변환하는 동안 발생하는 외부 리소스 파일 저장과 관련된 데이터 집합을 나타냅니다."
type: docs
weight: 1790
url: /ko/net/aspose.tasks/resourcesavingargs/
---
...
| 이름 | 설명 |
| --- | --- |
| [ResourceSavingArgs](resourcesavingargs/)() | 기본 생성자입니다. |
