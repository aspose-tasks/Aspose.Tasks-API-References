...
description: 컬렉션을 나타냅니다.OutlineMask./outlinemask/ 객체.
type: docs
weight: 1070
...
컬렉션을 나타냅니다.[`OutlineMask`](../outlinemask/) 객체.
...
| 이름 | 설명 |
| --- | --- |
| [Add](../../aspose.tasks/outlinemaskcollection/add/)(OutlineMask) | 이 컬렉션에 지정된 항목을 추가합니다. |
| [Clear](../../aspose.tasks/outlinemaskcollection/clear/)() | 이 컬렉션에서 모든 항목을 제거합니다. |
| [Contains](../../aspose.tasks/outlinemaskcollection/contains/)(OutlineMask) | 지정된 항목이 이 컬렉션에서 발견되면 true를 반환합니다. 그렇지 않으면 false. |
| [CopyTo](../../aspose.tasks/outlinemaskcollection/copyto/)(OutlineMask[], int) | 지정된 배열 인덱스에서 시작하여 이 컬렉션의 요소를 지정된 배열에 복사합니다. |
...
| [Remove](../../aspose.tasks/outlinemaskcollection/remove/)(OutlineMask) | 이 컬렉션에서 특정 개체의 첫 번째 항목을 제거합니다. |
| [RemoveAt](../../aspose.tasks/outlinemaskcollection/removeat/)(int) | 지정된 인덱스에서 항목을 제거합니다. |
