...
description: "Value 속성. 내부 표현에서 실제 값을 가져오거나 설정합니다. 아래에 나열된 강력히 형식화된 속성을 사용하는 것이 좋습니다."
type: docs
weight: 90
...
내부 표현에서 실제 값을 가져오거나 설정합니다. 아래에 나열된 강력히 형식화된 속성을 사용하는 것이 좋습니다.
...
텍스트 값을 설정하려면 강력히 형식화된 [`StringValue`](../stringvalue/) 속성을 사용하는 것이 좋습니다.

숫자 또는 비용 값을 설정하려면 강력히 형식화된 [`NumericValue`](../numericvalue/) 속성을 사용하는 것이 좋습니다.

날짜/시작/종료 값을 설정하려면 강력히 형식화된 [`DateTimeValue`](../datetimevalue/) 속성을 사용하는 것이 좋습니다.

기간 값을 설정하려면 강력히 형식화된 [`Duration`](../duration/) 속성을 사용하는 것이 좋습니다.

귀하의 유형이 목록에 없으면 `Val` 속성을 사용하십시오.
