...
description: "Aspose.Tasks.Value 클래스. 값 목록의 값을 나타냅니다"
type: docs
weight: 2800
...
| 이름 | 설명 |
| --- | --- |
| [Value](value/)() | `Value` 클래스의 새 인스턴스를 초기화합니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [DateTimeValue](../../aspose.tasks/value/datetimevalue/) { get; set; } | DateTime으로 표현될 수 있는 경우 실제 값을 가져오거나 설정합니다. 기본값은 MinValue입니다. |
| [Description](../../aspose.tasks/value/description/) { get; set; } | 값의 설명을 가져오거나 설정합니다. |
| [Duration](../../aspose.tasks/value/duration/) { get; set; } | Duration을 나타내는 실제 값을 가져오거나 설정합니다. |
| [Id](../../aspose.tasks/value/id/) { get; set; } | 프로젝트 전반에 걸친 값의 고유 식별자를 가져오거나 설정합니다. |
| [NumericValue](../../aspose.tasks/value/numericvalue/) { get; set; } | 숫자 또는 비용 값을 나타내는 실제 값을 가져오거나 설정합니다. |
| [Phonetic](../../aspose.tasks/value/phonetic/) { get; set; } | 사용자 정의 필드 이름에 대한 음성 정보를 가져오거나 설정합니다. |
| [StringValue](../../aspose.tasks/value/stringvalue/) { get; set; } | 텍스트 문자열을 나타내는 실제 값을 가져오거나 설정합니다. |
| [Val](../../aspose.tasks/value/val/) { get; set; } | 내부 표현에서 실제 값을 가져오거나 설정합니다. 아래에 나열된 강력히 형식화된 속성을 사용하는 것이 좋습니다. |
| [ValueGuid](../../aspose.tasks/value/valueguid/) { get; } | 전체 프로젝트에서 이 값을 다른 값들과 구분하는 GUID를 가져옵니다. |
