...
description: "Value 속성. 값이 DateTime으로 표현될 수 있는 경우 실제 값을 가져오거나 설정합니다. 기본값은 MinValue입니다."
type: docs
weight: 20
...
DateTime으로 표현될 수 있는 경우 실제 값을 가져오거나 설정합니다. 기본값은 MinValue입니다.
...
DateTime 값을 설정해야 할 때, [`Val`](../val/)보다 이 속성을 사용하는 것이 좋습니다.
