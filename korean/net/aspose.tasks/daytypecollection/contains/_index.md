...
description: "DayTypeCollection 메서드. 지정된 항목이 이 컬렉션에 있으면 true를 반환하고, 그렇지 않으면 false를 반환합니다."
type: docs
weight: 60
url: /ko/net/aspose.tasks/daytypecollection/contains/
---
