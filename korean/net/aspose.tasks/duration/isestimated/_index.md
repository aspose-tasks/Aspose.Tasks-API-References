...
description: "Duration 속성. 시간 단위가 추정되는지 여부를 나타내는 값을 가져옵니다. 이 Duration 인스턴스가 추정되는지 결정하는 플래그입니다."
type: docs
weight: 30
...
시간 단위가 추정되었는지 여부를 나타내는 값을 가져옵니다. 이 Duration 인스턴스가 추정되었는지 결정하는 플래그입니다.
