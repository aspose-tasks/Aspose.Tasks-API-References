...
description: "ExtendedAttribute 속성. Duration 유형 속성의 값을 가져오거나 설정합니다"
type: docs
weight: 30
...
'Duration' 유형을 가진 속성의 값을 가져오거나 설정합니다.
...
| 예외 | 조건 |
| --- | --- |
| InvalidOperationException | [`AttributeDefinition`](../attributedefinition/) 속성이 초기화되지 않았거나 [`AttributeDefinition`](../attributedefinition/) 속성의 사용자 정의 필드 유형이 [`Duration`](../../duration/) 인스턴스가 아닌 경우 발생합니다. |
