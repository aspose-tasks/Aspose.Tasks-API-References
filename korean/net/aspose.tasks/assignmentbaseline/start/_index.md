...
description: "AssignmentBaseline 속성. 기준선이 저장될 때 리소스 할당의 예정 시작 날짜를 가져오거나 설정합니다. 이 기준선이 저장될 때 리소스 할당의 시작 날짜."
type: docs
weight: 30
...
베이스라인이 저장될 때 리소스 할당의 예정 시작 날짜를 가져오거나 설정합니다. 이 베이스라인이 저장될 때 리소스 할당의 시작 날짜입니다.
