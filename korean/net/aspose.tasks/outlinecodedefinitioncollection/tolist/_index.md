...
description: "OutlineCodeDefinitionCollection 메서드. 이 OutlineCodeDefinitionCollection 객체를 OutlineCodeDefinition 객체 목록으로 변환합니다"
type: docs
weight: 130
...
이 OutlineCodeDefinitionCollection 객체를 [`OutlineCodeDefinition`](../../outlinecodedefinition/) 객체 목록으로 변환합니다.
...
[`OutlineCodeDefinition`](../../outlinecodedefinition/) 객체 목록.
