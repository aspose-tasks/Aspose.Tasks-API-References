...
description: "OutlineCodeDefinitionCollection 메서드. 지정된 인덱스에 지정된 항목을 삽입합니다."
type: docs
weight: 100
url: /ko/net/aspose.tasks/outlinecodedefinitioncollection/insert/
---
...
| 항목 | OutlineCodeDefinition | 이 컬렉션에 삽입할 지정된 항목. |
