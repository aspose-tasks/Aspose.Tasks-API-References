...
description: "RecurringTaskInfo 속성. 서수일을 사용할 때 연간 반복 패턴의 월을 가져오거나 설정합니다. Month 열거형의 값 중 하나일 수 있습니다."
type: docs
weight: 200
...
서수일을 사용할 때 연간 반복 패턴의 월을 가져오거나 설정합니다. [`Month`](../../month/) 열거형의 값 중 하나일 수 있습니다.
