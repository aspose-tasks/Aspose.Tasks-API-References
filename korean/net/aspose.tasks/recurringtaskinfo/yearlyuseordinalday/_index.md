...
description: "RecurringTaskInfo 속성. 연간 반복 패턴에 서수일을 사용할지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 220
url: /ko/net/aspose.tasks/recurringtaskinfo/yearlyuseordinalday/
---
## RecurringTaskInfo.YearlyUseOrdinalDay property

연간 반복 패턴에 서수 일자를 사용할지 여부를 나타내는 값을 가져오거나 설정합니다.
