...
description: "RecurringTaskInfo 속성. 서수 일자를 사용할 때 월간 반복 패턴의 반복 횟수를 가져오거나 설정합니다."
type: docs
weight: 80
url: /ko/net/aspose.tasks/recurringtaskinfo/monthlyordinalrepetitions/
---
## RecurringTaskInfo.MonthlyOrdinalRepetitions property

서수 일자를 사용할 때 월별 반복 패턴의 반복 횟수를 가져오거나 설정합니다.
