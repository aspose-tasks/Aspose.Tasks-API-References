...
description: "RecurringTaskInfo 속성. 연간 반복 패턴의 서수 번호를 가져오거나 설정합니다. OrdinalNumber 열거형의 값 중 하나일 수 있습니다."
type: docs
weight: 210
...
연간 반복 패턴의 서수 번호를 가져오거나 설정합니다. [`OrdinalNumber`](../../ordinalnumber/) 열거형의 값 중 하나일 수 있습니다.
