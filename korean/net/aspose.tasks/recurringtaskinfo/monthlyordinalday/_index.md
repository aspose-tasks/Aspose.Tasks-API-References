...
description: "RecurringTaskInfo 속성. 서수 일자를 사용할 때 월간 반복 패턴의 일자를 가져오거나 설정합니다. DayOfWeek 열거형의 값 중 하나일 수 있습니다."
type: docs
weight: 60
...
서수 일자를 사용할 때 월별 반복 패턴의 요일을 가져오거나 설정합니다. DayOfWeek 열거형의 값 중 하나일 수 있습니다.
