...
description: "RecurringTaskInfo 속성. 반복 작업의 반복 패턴을 가져오거나 설정합니다. RecurrencePattern 열거형의 값 중 하나일 수 있습니다"
type: docs
weight: 120
...
반복 작업의 반복 패턴을 가져오거나 설정합니다. `RecurrencePattern` 열거형의 값 중 하나일 수 있습니다.
