...
description: "RecurringTaskInfo 속성. 월별 반복 패턴의 서수 번호를 가져오거나 설정합니다. OrdinalNumber 열거형의 값 중 하나일 수 있습니다."
type: docs
weight: 70
url: /ko/net/aspose.tasks/recurringtaskinfo/monthlyordinalnumber/
---
## RecurringTaskInfo.MonthlyOrdinalNumber property

월별 반복 패턴의 서수 번호를 가져오거나 설정합니다. [`OrdinalNumber`](../../ordinalnumber/) 열거형의 값 중 하나일 수 있습니다.
