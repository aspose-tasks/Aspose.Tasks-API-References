---
title: "TaskUsageView 클래스"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.TaskUsageView 클래스. 프로젝트에서 작업 사용 보기를 나타냅니다."
type: docs
weight: 2480
url: /ko/net/aspose.tasks/taskusageview/
---
## TaskUsageView class

프로젝트의 작업 사용량 뷰를 나타냅니다.
...
| [FieldCollection](../../aspose.tasks/taskusageview/fieldcollection/) { get; } | 이 TaskUsageView의 [`TaskUsageViewFieldCollection`](../taskusageviewfieldcollection/) 객체를 가져옵니다. |
...
미리 정의된 시간축 설정으로 작업 사용 보기 렌더링 방법을 보여줍니다.

```csharp
var project = new Project(DataDir + "TaskUsageView.mpp");

// SaveOptions를 정의하고 미리 정의된 TimeScale 설정 'Days'를 지정합니다.
SaveOptions options = new PdfSaveOptions
{
    Timescale = Timescale.Days,

    // Presentation 형식을 TaskUsage로 설정합니다.
    PresentationFormat = PresentationFormat.TaskUsage
};
...
// Timescale 설정을 ThirdsOfMonths로 설정합니다.
options.Timescale = Timescale.ThirdsOfMonths;

outputProject = "TaskUsageView_result_thirdsOfMonths_out.pdf";
project.Save(OutDir + outputProject, options);

// Timescale 설정을 Months로 설정합니다.
