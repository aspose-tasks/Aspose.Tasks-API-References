...
description: 의 새 인스턴스를 만들고 초기화합니다.TimephasedDataaspose.tasks/timephaseddata/ 작업 기반 시간 단계별 데이터 클래스.
type: docs
weight: 40
...
의 새 인스턴스를 만들고 초기화합니다.[`TimephasedData`](../) 작업 기반 시간 단계별 데이터 클래스.
...
의 인스턴스[`TimephasedData`](../) 작업 기반 시간 단계별 데이터에 대한 클래스입니다.
