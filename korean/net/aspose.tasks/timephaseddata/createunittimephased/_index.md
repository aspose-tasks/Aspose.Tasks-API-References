...
description: "TimephasedData 메서드. 물자 리소스 할당의 단위 기반 시간 단계 데이터에 대한 TimephasedData 클래스의 새 인스턴스를 생성하고 초기화합니다."
type: docs
weight: 30
url: /ko/net/aspose.tasks/timephaseddata/createunittimephased/
---
## TimephasedData.CreateUnitTimephased method

물자 리소스 할당의 단위 기반 시간 단계 데이터에 대한 [`TimephasedData`](../) 클래스의 새 인스턴스를 생성하고 초기화합니다.
...
비용 기반 시간 단계 데이터를 위한 [`TimephasedData`](../) 클래스의 인스턴스.

### 예외

| 예외 | 조건 |
| --- | --- |
| ArgumentException | 단위 수가 음수로 지정된 경우. |
