...
description: 의 새 인스턴스를 만들고 초기화합니다.TimephasedDataaspose.tasks/timephaseddata/ 재료 자원 할당의 단위 기반 시간 단계별 데이터 클래스.
type: docs
weight: 30
...
의 새 인스턴스를 만들고 초기화합니다.[`TimephasedData`](../) 재료 자원 할당의 단위 기반 시간 단계별 데이터 클래스.
...
| 예외 | 상태 |
| --- | --- |
| ArgumentException | 음수 단위가 지정된 경우. |
