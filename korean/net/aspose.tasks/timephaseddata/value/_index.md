...
description: "TimephasedData 속성. 시간 단계 데이터 기간에 대한 단위 시간당 값을 가져오거나 설정합니다."
type: docs
weight: 100
...
시간 단계 데이터 기간의 시간 단위당 값을 가져오거나 설정합니다.
...
| 예외 | 조건 |
| --- | --- |
| [TasksException](../../tasksexception/) | 지정된 [`TimephasedDataType`](../timephaseddatatype/)에 대한 값이 올바르지 않거나 음수 값인 경우. |
