...
description: "GanttChartView 속성. Gantt 차트 보기의 상위 공통 바 스타일 목록을 가져옵니다. GanttBarStyle"
type: docs
weight: 50
...
Gantt 차트 보기의 상위 (공통) 바 스타일 목록을 가져옵니다. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
