...
description: "GanttChartView 속성. 보기의 상단 타임스케일 티어 설정을 가져오거나 설정합니다. TimescaleTier"
type: docs
weight: 190
...
보기의 상단 시간축 계층 설정을 가져오거나 설정합니다. [`TimescaleTier`](../../../aspose.tasks.visualization/timescaletier/).
