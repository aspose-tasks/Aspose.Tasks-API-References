...
description: "TaskCollection 메서드. 지정된 Id를 가진 작업을 반환하며, 해당 작업의 상위는 이 컬렉션의 부모 작업입니다."
type: docs
weight: 70
...
이 컬렉션의 상위 작업인 조상 작업이 지정된 Id인 작업을 반환합니다.
...
지정된 ID를 가진 [`Task`](../../task/) 클래스의 인스턴스를 반환하고, 해당 인스턴스의 조상은 이 컬렉션의 부모 작업입니다.
