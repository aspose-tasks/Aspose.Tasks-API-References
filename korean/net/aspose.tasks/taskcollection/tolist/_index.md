...
description: "TaskCollection 메서드. TaskCollection 객체를 Task 객체 목록으로 변환합니다."
type: docs
weight: 120
...
TaskCollection 객체를 [`Task`](../../task/) 객체 목록으로 변환합니다.
...
이 컬렉션의 [`Task`](../../task/) 클래스 인스턴스를 포함하는 목록을 반환합니다.
