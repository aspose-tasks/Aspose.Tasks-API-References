...
description: "DailyWorkRepetition 생성자. DailyWorkRepetition 클래스의 새 인스턴스를 초기화합니다."
type: docs
weight: 10
url: /ko/net/aspose.tasks/dailyworkrepetition/dailyworkrepetition/
---
## DailyWorkRepetition constructor

[`DailyWorkRepetition`](../) 클래스의 새 인스턴스를 초기화합니다.
