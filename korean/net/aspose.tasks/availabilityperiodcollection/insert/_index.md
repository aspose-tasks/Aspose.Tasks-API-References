...
description: "AvailabilityPeriodCollection 메서드. 지정된 항목을 지정된 인덱스에 삽입합니다."
type: docs
weight: 110
url: /ko/net/aspose.tasks/availabilityperiodcollection/insert/
---
...
| 항목 | AvailabilityPeriod | 이 컬렉션에 삽입할 지정된 항목. |
