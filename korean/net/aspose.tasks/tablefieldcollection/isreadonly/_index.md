...
description: "TableFieldCollection 속성. 이 컬렉션이 읽기 전용인지 여부를 나타내는 값을 가져옵니다(읽기 전용이면 true, 그렇지 않으면 false)."
type: docs
weight: 20
url: /ko/net/aspose.tasks/tablefieldcollection/isreadonly/
---
