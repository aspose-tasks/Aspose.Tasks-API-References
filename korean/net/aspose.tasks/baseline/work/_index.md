...
description: "Baseline 속성. 기준선이 저장될 때 리소스에 할당된 작업을 가져오거나 설정합니다. 기준선이 저장될 때 리소스에 할당된 작업량입니다."
type: docs
weight: 60
...
베이스라인이 저장될 때 리소스에 할당된 작업을 가져오거나 설정합니다. 베이스라인이 저장될 때 리소스에 할당된 작업량입니다.
