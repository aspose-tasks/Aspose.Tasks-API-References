---
title: "인터페이스 IFontSavingCallback"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.IFontSavingCallback 인터페이스. 폰트를 저장할 리소스를 생성하기 위해 호출되는 콜백을 나타냅니다"
type: docs
weight: 860
...
폰트를 저장할 리소스를 생성하기 위해 호출되는 콜백을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [FontSaving](../../aspose.tasks/ifontsavingcallback/fontsaving/)(FontSavingArgs) | 폰트를 저장하는 동안 호출되는 메서드입니다. |

## 예제

폰트 저장 콜백을 사용하는 방법을 보여줍니다.
