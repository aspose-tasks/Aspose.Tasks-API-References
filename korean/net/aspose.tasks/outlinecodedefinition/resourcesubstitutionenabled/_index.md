...
description: "OutlineCodeDefinition 속성. 사용자 정의 개요 코드가 Microsoft Project의 리소스 대체 마법사에서 사용될 수 있는지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 130
...
사용자 정의 개요 코드를 Microsoft Project의 리소스 대체 마법사에서 사용할 수 있는지 여부를 나타내는 값을 가져오거나 설정합니다.
