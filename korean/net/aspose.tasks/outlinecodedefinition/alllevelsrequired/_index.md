...
description: "OutlineCodeDefinition 속성. 새 코드가 모든 레벨을 가져야 하는지 여부를 나타내는 값을 가져오거나 설정합니다. 엔터프라이즈 코드에서는 사용할 수 없습니다"
type: docs
weight: 30
...
새 코드가 모든 레벨을 가져야 하는지 여부를 나타내는 값을 가져오거나 설정합니다. 엔터프라이즈 코드에는 사용할 수 없습니다.
