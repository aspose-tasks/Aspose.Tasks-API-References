...
description: "OutlineCodeDefinition 속성. OutlineMaskCollection 객체를 가져옵니다. 개요 코드 마스크를 정의하는 항목들의 테이블입니다. 읽기 전용 OutlineMaskCollection 인스턴스"
type: docs
weight: 100
...
OutlineMaskCollection 객체를 가져옵니다. 개요 코드 마스크를 정의하는 항목들의 테이블입니다. 읽기 전용 [`OutlineMaskCollection`](../../outlinemaskcollection/) 인스턴스.
