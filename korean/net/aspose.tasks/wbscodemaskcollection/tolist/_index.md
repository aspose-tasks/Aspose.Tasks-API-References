...
description: "WBSCodeMaskCollection 메서드. WBSCodeMaskCollection을 WBSCodeMask 객체 목록으로 변환합니다"
type: docs
weight: 90
...
WBSCodeMaskCollection을 [`WBSCodeMask`](../../wbscodemask/) 객체 목록으로 변환합니다.
...
[`WBSCodeMask`](../../wbscodemask/) 객체의 일반 목록.
