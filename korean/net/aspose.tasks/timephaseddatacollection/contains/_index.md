...
description: "TimephasedDataCollection 메서드. TimephasedDataCollection이 특정 값을 포함하는지 여부를 결정합니다."
type: docs
weight: 70
...
[`TimephasedDataCollection`](../)이 특정 값을 포함하는지 여부를 결정합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | TimephasedData | 컬렉션에서 찾을 객체. |

### 반환 값

컬렉션에서 *item*이 발견된 경우 true; 그렇지 않으면 false.
