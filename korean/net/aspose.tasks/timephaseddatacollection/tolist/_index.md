...
description: "TimephasedDataCollection 메서드. TimephasedDataCollection 객체를 TimephasedData 객체 리스트로 변환합니다."
type: docs
weight: 120
...
[`TimephasedDataCollection`](../) 객체를 [`TimephasedData`](../../timephaseddata/) 객체 리스트로 변환합니다.
...
[`TimephasedData`](../../timephaseddata/) 객체 리스트.
