...
description: "TimephasedDataCollection 메서드. TimephasedData 인스턴스 컬렉션을 이 컬렉션 객체에 추가합니다."
type: docs
weight: 50
...
[`TimephasedData`](../../timephaseddata/) 인스턴스 컬렉션을 이 컬렉션 객체에 추가합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | 추가할 [`TimephasedData`](../../timephaseddata/) 객체 컬렉션. |
