...
description: "TimephasedDataCollection 메서드. 이 컬렉션 객체에서 TimephasedData 인스턴스를 제거합니다."
type: docs
weight: 100
...
[`TimephasedData`](../../timephaseddata/) 인스턴스를 이 컬렉션 객체에서 제거합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | TimephasedData | 제거할 항목입니다. |

### 반환 값

*item*이(가) [`TimephasedDataCollection`](../)에서 성공적으로 제거된 경우 true; 그렇지 않으면 false. 이 메서드는 *item*이 [`TimephasedDataCollection`](../)에서 찾을 수 없는 경우에도 false를 반환합니다.
