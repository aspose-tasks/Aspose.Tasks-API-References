...
description: "TimephasedDataCollection 메서드. TimephasedData 인스턴스를 이 컬렉션 객체에 추가합니다."
type: docs
weight: 40
...
이 컬렉션 객체에 [`TimephasedData`](../../timephaseddata/) 인스턴스를 추가합니다.
