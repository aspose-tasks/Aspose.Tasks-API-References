...
description: "ProjectDisplayOptions 속성. 숫자 값과 시간 약어 1 wk 앞에 공백을 추가할지 여부를 나타내는 값을 가져오거나 설정합니다(1wk와 구분)."
type: docs
weight: 20
...
숫자 값과 시간 약어 앞에 공백을 추가할지 여부를 나타내는 값을 가져오거나 설정합니다 (예: 1 wk vs 1wk).
