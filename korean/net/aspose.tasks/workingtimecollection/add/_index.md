...
description: "WorkingTimeCollection 메서드. 새 WorkingTime 인스턴스를 이 컬렉션에 추가합니다"
type: docs
weight: 30
...
새 WorkingTime 인스턴스를 이 컬렉션에 추가합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | WorkingTime | 추가할 항목. |

### 반환 값

WorkingTime 객체가 성공적으로 추가된 경우 true; 그렇지 않으면 false.
