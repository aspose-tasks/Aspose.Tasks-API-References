...
description: "WorkingTimeCollection 메서드. WorkingTimeCollection 객체를 WorkingTime 객체 목록으로 변환합니다."
type: docs
weight: 90
...
WorkingTimeCollection 객체를 [`WorkingTime`](../../workingtime/) 객체 목록으로 변환합니다.
