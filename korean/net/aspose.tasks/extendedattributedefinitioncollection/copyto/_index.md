...
description: "ExtendedAttributeDefinitionCollection 메서드. 이 컬렉션의 요소를 지정된 배열에 복사하며, 지정된 배열 인덱스부터 시작합니다."
type: docs
weight: 80
url: /ko/net/aspose.tasks/extendedattributedefinitioncollection/copyto/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 배열 | ExtendedAttributeDefinition[] | 요소를 복사할 지정된 1차원 배열. |
