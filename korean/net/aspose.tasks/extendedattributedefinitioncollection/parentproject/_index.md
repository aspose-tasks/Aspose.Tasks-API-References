...
description: "ExtendedAttributeDefinitionCollection 속성. ExtendedAttributeDefinitionCollection 인스턴스에 대한 상위 프로젝트를 가져옵니다. 이 컬렉션에 대한 상위 프로젝트를 반환합니다."
type: docs
weight: 40
...
[`ExtendedAttributeDefinitionCollection`](../) 인스턴스에 대한 상위 프로젝트를 가져옵니다. 이 컬렉션에 대한 상위 프로젝트를 반환합니다.
