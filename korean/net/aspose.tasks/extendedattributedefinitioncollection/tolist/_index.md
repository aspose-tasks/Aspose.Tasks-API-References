...
description: "ExtendedAttributeDefinitionCollection 메서드. 이 ExtendedAttributeDefinitionCollection 객체를 ExtendedAttributeDefinition 클래스의 인스턴스를 포함하는 목록으로 변환합니다."
type: docs
weight: 150
...
이 ExtendedAttributeDefinitionCollection 객체를 [`ExtendedAttributeDefinition`](../../extendedattributedefinition/) 클래스의 인스턴스를 포함하는 목록으로 변환합니다.
...
`[`ExtendedAttributeDefinition`](../../extendedattributedefinition/)` 클래스의 인스턴스를 포함하는 목록.
