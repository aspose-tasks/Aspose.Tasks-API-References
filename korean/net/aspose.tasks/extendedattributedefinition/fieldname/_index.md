...
description: "ExtendedAttributeDefinition 속성. 사용자 정의 필드의 이름을 가져옵니다."
type: docs
weight: 140
...
직접 설정해서는 안 되며, 대신 Create*Definition()와 같은 강력히 형식화된 정적 팩터리 메서드를 사용하여 ExtendedAttributeDefinition을 생성하십시오.
