...
description: "ExtendedAttributeDefinition 속성. 사용자 정의 필드 값이 ValueList의 값으로 제한되는지 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 220
...
값을 가져오거나 설정합니다. 사용자 정의 필드 값이 [`ValueList`](../valuelist/)의 값으로 제한되는지 여부를 나타냅니다.
