...
description: "Aspose.Tasks.IImageSavingCallback 인터페이스. 이미지를 저장할 리소스를 생성하기 위해 호출되는 콜백을 나타냅니다."
type: docs
weight: 870
...
| 이름 | 설명 |
| --- | --- |
| [ImageSaving](../../aspose.tasks/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | 이미지를 저장하는 동안 호출되는 메서드입니다. |

## 예제

이미지 저장 콜백을 사용하는 방법을 보여줍니다.
