---
title: "인터페이스 ICssSavingCallback"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.ICssSavingCallback 인터페이스. CSS를 저장할 리소스를 생성하기 위해 호출되는 콜백을 나타냅니다."
type: docs
weight: 850
...
| 이름 | 설명 |
| --- | --- |
| [CssSaving](../../aspose.tasks/icsssavingcallback/csssaving/)(CssSavingArgs) | CSS 저장 중에 호출될 메서드입니다. |

## 예제

CSS 저장 콜백을 설정하는 방법을 보여줍니다.
