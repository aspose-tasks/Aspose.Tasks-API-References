...
description: "RiskItemStatistics 메서드. 생성된 샘플 중 지정된 백분율 이하가 되는 값을 가져옵니다."
type: docs
weight: 60
...
생성된 샘플 중 지정된 비율 이하가 떨어지는 값을 가져옵니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 백분율 | Int32 | 0과 100 사이의 지정된 백분율. |

### 반환 값

생성된 샘플 중 지정된 백분율 이하가 되는 값.
