...
description: "RiskAnalyzer 속성. 위험 분석에 필요한 설정을 정의하는 RiskAnalysisSettings 클래스의 인스턴스를 가져오거나 설정합니다."
type: docs
weight: 20
...
위험 분석에 필요한 설정을 정의하는 [`RiskAnalysisSettings`](../../riskanalysissettings/) 클래스의 인스턴스를 가져오거나 설정합니다.
