...
description: "RiskAnalyzer 생성자. RiskAnalyzer 클래스의 새 인스턴스를 초기화합니다."
type: docs
weight: 10
...
[`RiskAnalyzer`](../) 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| settings | RiskAnalysisSettings | 지정된 [`RiskAnalysisSettings`](../../riskanalysissettings/) 클래스의 인스턴스. |
