...
description: "RiskAnalyzer 메서드. 지정된 프로젝트에 대한 위험 분석을 수행합니다. 분석은 몬테카를로 시뮬레이션을 기반으로 하며 결과는 RiskAnalysisResult 클래스의 인스턴스입니다."
type: docs
weight: 30
...
지정된 프로젝트에 대한 위험 분석을 수행합니다. 분석은 몬테카를로 시뮬레이션을 기반으로 하며 결과는 [`RiskAnalysisResult`](../../riskanalysisresult/) 클래스의 인스턴스입니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| project | Project | 분석할 지정된 [`Project`](../../../aspose.tasks/project/) 클래스의 인스턴스. |

### 반환 값

분석 결과를 나타내는 [`RiskAnalysisResult`](../../riskanalysisresult/)의 인스턴스.
