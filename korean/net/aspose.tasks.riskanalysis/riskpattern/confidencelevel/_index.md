...
description: "RiskPattern 속성. 실제 생성된 값이 낙관적 및 비관적 추정치 내에 있을 확률을 나타내는 신뢰 수준을 가져오거나 설정합니다. 기본값은 CL99입니다."
type: docs
weight: 20
...
실제 생성된 값이 낙관적 및 비관적 추정치 범위 내에 있을 확률에 해당하는 신뢰 수준을 가져오거나 설정합니다. 기본값은 CL99입니다.
...
`ConfidenceLevel` 열거형에 정의된 값 중 하나일 수 있습니다.
