...
description: "RiskPattern 속성. 최악의 프로젝트 시나리오에서 발생할 수 있는 가장 가능성 높은 작업 기간의 비율을 가져오거나 설정합니다. 기본값은 125이며, 이는 추정된 작업 기간이 4일인 경우 비관적 기간이 5일이 됨을 의미합니다."
type: docs
weight: 50
...
가능한 최악의 프로젝트 시나리오에서 발생할 수 있는 가장 가능성 높은 작업 기간의 비율을 가져오거나 설정합니다. 기본값은 125이며, 이는 지정된 작업 기간이 4일로 추정될 경우 비관적 기간은 5일이 된다는 의미입니다.
