...
description: "RiskPattern 속성. 몬테카를로 시뮬레이션에 사용되는 확률 분포를 가져오거나 설정합니다. 기본값은 ProbabilityDistributionType.Normal입니다."
type: docs
weight: 30
...
몬테카를로 시뮬레이션에 사용되는 확률 분포를 가져오거나 설정합니다. 기본값은 ProbabilityDistributionType.Normal입니다.
...
[`ProbabilityDistributionType`](../../probabilitydistributiontype/) 열거형에 정의된 값 중 하나일 수 있습니다.
