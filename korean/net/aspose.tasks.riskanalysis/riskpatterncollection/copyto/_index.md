...
description: "RiskPatternCollection 메서드. 이 컬렉션의 요소를 지정된 배열에 복사하며, 지정된 배열 인덱스부터 시작합니다."
type: docs
weight: 70
url: /ko/net/aspose.tasks.riskanalysis/riskpatterncollection/copyto/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 배열 | RiskPattern[] | 요소를 복사할 지정된 1차원 배열. |
