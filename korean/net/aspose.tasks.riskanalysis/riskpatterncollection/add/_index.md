...
description: "RiskPatternCollection 메서드. RiskPattern 클래스의 인스턴스를 이 컬렉션에 추가합니다."
type: docs
weight: 40
...
이 컬렉션에 [`RiskPattern`](../../riskpattern/) 클래스의 인스턴스를 추가합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | RiskPattern | 이 컬렉션에 추가할 [`RiskPattern`](../../riskpattern/) 클래스의 인스턴스. |

### 예외

| 예외 | 조건 |
| --- | --- |
| ArgumentNullException | *item* task가 null입니다. |
