---
title: "클래스 RiskItemStatisticsCollection"
second_title: "Aspose.Tasks for .NET API 참조"
description: "Aspose.Tasks.RiskAnalysis.RiskItemStatisticsCollection 클래스. RiskItemStatistics 클래스의 인스턴스를 포함하는 컬렉션을 나타냅니다."
type: docs
weight: 1910
...
[`RiskItemStatistics`](../riskitemstatistics/) 클래스의 인스턴스를 포함하는 컬렉션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Get](../../aspose.tasks.riskanalysis/riskitemstatisticscollection/get/)(Task) | 이 컬렉션에 포함되어 지정된 Task 객체와 연결된 [`RiskItemStatistics`](../riskitemstatistics/) 클래스의 인스턴스를 반환합니다; 항목을 찾을 수 없으면 null을 반환합니다. |
