---
title: "Aspose::Tasks::BaselineCollection 클래스"
linktitle: "BaselineCollection"
articleTitle: "BaselineCollection"
second_title: "C++용 Aspose.Tasks"
description: "Baseline 객체의 컬렉션을 나타냅니다."
type: docs
weight: 10
url: /ko/cpp/aspose.tasks/baselinecollection/
---

## BaselineCollection class

Baseline 객체의 컬렉션을 나타냅니다.
...
| [get_Count](./get_count/) | 이 BaselineCollection 객체에 포함된 객체 수를 가져옵니다. |
| [get_ParentResource](./get_parentresource/) | 이 컬렉션의 상위 Resource를 가져옵니다. |
...
| [ToList](./tolist/) | BaselineCollection 객체를 Baseline 객체 목록으로 변환합니다. |
