...
description: "월별 일 위치에 대한 기본 패턴을 나타냅니다."
type: docs
weight: 159
url: /ko/java/com.aspose.tasks/monthlyrepetitionbase/
---
...
| [getRepetitionInterval()](#getRepetitionInterval--) | 발생 사이의 간격을 나타내는 개월 수를 가져옵니다. |
| [getValidator(Calendar calendar)](#getValidator-com.aspose.tasks.Calendar-) | \{@inheritDoc\} |
| [setRepetitionInterval(int value)](#setRepetitionInterval-int-) | 발생 사이의 간격을 나타내는 개월 수를 설정합니다. |
...
발생 사이의 간격을 나타내는 개월 수를 가져옵니다.

**Returns:**
int - 발생 사이의 간격을 나타내는 개월 수.
...
발생 사이의 간격을 나타내는 개월 수를 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | int | 발생 사이의 간격을 나타내는 개월 수. |
