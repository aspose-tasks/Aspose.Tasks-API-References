...
type: docs
weight: 287
url: /ko/java/com.aspose.tasks/tablefieldcollection/
---
...
[TableField](../../com.aspose/tasks/tablefield) 객체의 목록을 포함합니다. IList&lt;TableField&gt; 인터페이스를 구현합니다.
## 메서드
...
| [indexOf(TableField item)](#indexOf-com.aspose.tasks.TableField-) | 이 컬렉션에서 지정된 항목의 인덱스를 반환합니다. |
...
이 컬렉션에서 지정된 항목의 인덱스를 반환합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [TableField](../../com.aspose.tasks/tablefield) | 지정된 항목. |
