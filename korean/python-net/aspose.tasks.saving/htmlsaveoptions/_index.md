...
type: docs
weight: 20
url: /ko/python-net/aspose.tasks.saving/htmlsaveoptions/
---
...
| 이름 | 설명 |
| :- | :- |
| HtmlSaveOptions() | 새로운 [HtmlSaveOptions](/tasks/python-net/aspose.tasks.saving/htmlsaveoptions/) 클래스 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | 프로젝트 레이아웃을 렌더링할 때 그라디언트 브러시를 사용할지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| css_style_prefix | CSS 스타일 접두사를 가져오거나 설정합니다. |
| font_settings | 프로젝트 보기 렌더링 시 사용되는 글꼴 설정을 지정합니다. |
| reduce_footer_gap | 마지막 작업과 푸터 사이의 간격을 줄여야 하는지 여부를 가져오거나 설정합니다. |
| include_project_name_in_page_header | HTML 페이지 헤더에 프로젝트 이름을 포함할지 여부를 가져오거나 설정합니다. |
| include_project_name_in_title | HTML 제목에 프로젝트 이름을 포함할지 여부를 가져오거나 설정합니다. |
| pages | 프로젝트 레이아웃을 렌더링할 때 저장할 페이지 번호 목록을 가져오거나 설정합니다. |
| export_css | CSS 내보내기 방식을 가져오거나 설정합니다. |
| export_images | 이미지 내보내기 방식을 가져오거나 설정합니다. |
| export_fonts | 폰트 내보내기 방식을 가져오거나 설정합니다. |
| css_saving_callback | CSS를 저장할 리소스를 생성하기 위해 호출되는 콜백을 가져오거나 설정합니다. |
| font_saving_callback | 폰트를 저장할 리소스를 생성하기 위해 호출되는 콜백을 가져오거나 설정합니다. |
| image_saving_callback | 폰트를 저장할 리소스를 생성하기 위해 호출되는 콜백을 가져오거나 설정합니다. |
| font_face_types | 글꼴 유형을 가져오거나 설정합니다. |
| page_saving_callback | 렌더링된 각 페이지에 대한 출력 스트림을 가져오는 데 사용되는 사용자 정의 콜백을 가져오거나 설정합니다. |
