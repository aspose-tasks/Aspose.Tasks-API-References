...
type: docs
weight: 200
url: /ko/python-net/aspose.tasks.saving/xpsoptions/
---
...
| 이름 | 설명 |
| :- | :- |
| XpsOptions() | 새로운 [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/) 클래스 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | 메타파일을 비트맵으로 렌더링할지 여부를 나타내는 값을 가져오거나 설정합니다. |
