...
type: docs
weight: 120
url: /ko/python-net/aspose.tasks.saving/printoptions/
---
...
PrintOptions 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PrintOptions() | [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) 클래스의 새 인스턴스를 초기화합니다. 이 인스턴스는 프로젝트 인쇄를 위한 다양한 옵션을 설정하는 데 사용할 수 있습니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
| save_format |  |
