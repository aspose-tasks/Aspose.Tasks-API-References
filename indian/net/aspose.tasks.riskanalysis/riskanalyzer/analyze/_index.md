...
description: "RiskAnalyzer मेथड। निर्दिष्ट प्रोजेक्ट के लिए जोखिम विश्लेषण करता है। विश्लेषण Monte Carlo सिमुलेशन पर आधारित है और परिणाम RiskAnalysisResult क्लास का एक इंस्टेंस है।"
type: docs
weight: 30
...
निर्दिष्ट प्रोजेक्ट के लिए जोखिम विश्लेषण करता है। विश्लेषण Monte Carlo सिमुलेशन पर आधारित है और परिणाम [`RiskAnalysisResult`](../../riskanalysisresult/) क्लास का एक इंस्टेंस है।
...
| --- | --- | --- |
| project | Project | विश्लेषण करने के लिए निर्दिष्ट [`Project`](../../../aspose.tasks/project/) क्लास का इंस्टेंस। |

### रिटर्न वैल्यू

[`RiskAnalysisResult`](../../riskanalysisresult/) का इंस्टेंस जो विश्लेषण का परिणाम दर्शाता है।
