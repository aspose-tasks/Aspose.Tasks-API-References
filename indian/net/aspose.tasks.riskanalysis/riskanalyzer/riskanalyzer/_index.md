...
description: "RiskAnalyzer कंस्ट्रक्टर। RiskAnalyzer क्लास का नया इंस्टेंस इनिशियलाइज़ करता है"
type: docs
weight: 10
...
[`RiskAnalyzer`](../) क्लास का नया इंस्टेंस इनिशियलाइज़ करता है।
...
| --- | --- | --- |
| settings | RiskAnalysisSettings | निर्दिष्ट [`RiskAnalysisSettings`](../../riskanalysissettings/) क्लास का इंस्टेंस। |
