...
description: "RiskPattern प्रॉपर्टी। Monte Carlo सिमुलेशन में उपयोग किए जाने वाले probability distribution को प्राप्त या सेट करता है। डिफ़ॉल्ट मान ProbabilityDistributionType.Normal है।"
type: docs
weight: 30
...
Monte Carlo सिमुलेशन में उपयोग किए जाने वाले प्रायिकता वितरण को प्राप्त करता है या सेट करता है। डिफ़ॉल्ट मान ProbabilityDistributionType.Normal है।
...
[`ProbabilityDistributionType`](../../probabilitydistributiontype/) enumeration में परिभाषित मानों में से एक हो सकता है।
