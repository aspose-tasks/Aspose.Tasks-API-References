...
description: "RiskPatternCollection मेथड। इस संग्रह के तत्वों को निर्दिष्ट ऐरे में निर्दिष्ट ऐरे इंडेक्स से शुरू करके कॉपी करता है।"
type: docs
weight: 70
url: /hi/net/aspose.tasks.riskanalysis/riskpatterncollection/copyto/
---
...
| --- | --- | --- |
| एरे | RiskPattern[] | तत्वों को कॉपी करने के लिए निर्दिष्ट एक-आयामी एरे |
