...
description: "RiskPatternCollection मेथड। इस संग्रह से किसी विशिष्ट ऑब्जेक्ट की पहली उपस्थिति हटाता है।"
type: docs
weight: 90
url: /hi/net/aspose.tasks.riskanalysis/riskpatterncollection/remove/
---
...
| --- | --- | --- |
| आइटम | RiskPattern | हटाने के लिए निर्दिष्ट वस्तु। |
