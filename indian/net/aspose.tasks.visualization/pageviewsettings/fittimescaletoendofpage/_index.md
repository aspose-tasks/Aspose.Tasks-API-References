...
description: "PageViewSettings प्रॉपर्टी। प्रिंट करते समय टाइमस्केल को पेज के अंत तक फिट करने का संकेत देने वाले मान को प्राप्त करता है या सेट करता है"
type: docs
weight: 30
...
प्रिंट करते समय टाइमस्केल को पृष्ठ के अंत तक फिट करने का संकेत देने वाला मान प्राप्त करता है या सेट करता है।
