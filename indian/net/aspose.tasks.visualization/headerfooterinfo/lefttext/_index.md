...
description: "HeaderFooterInfo प्रॉपर्टी। बाएँ संरेखित टेक्स्ट को प्राप्त करता है या सेट करता है जिसे पैरेंट एलिमेंट में प्रदर्शित किया जाता है"
type: docs
weight: 70
...
पैरेंट एलिमेंट में प्रदर्शित करने के लिए बाएँ संरेखित पाठ को प्राप्त करता है या सेट करता है।
