...
description: "GanttBarStyle प्रॉपर्टी। कस्टम टास्क-विशिष्ट शैली के लिए पैरेंट या सामान्य शैली को प्राप्त करता है या सेट करता है।"
type: docs
weight: 160
...
कस्टम टास्क-विशिष्ट स्टाइल के लिए पैरेंट (या कॉमन) स्टाइल को प्राप्त करता है या सेट करता है।
...
टास्क में विभिन्न पैरेंट शैलियों के साथ कई कस्टम शैलियाँ हो सकती हैं। उदाहरण के लिए, एक टास्क को "Critical" पैरेंट शैली वाली कस्टम शैली और "Normal" पैरेंट शैली वाली दूसरी शैली मानें। सरल शब्दों में, यदि टास्क महत्वपूर्ण (critical) है, तो पहली शैली लागू होती है। यदि टास्क गैर-महत्वपूर्ण (non‑critical) हो जाता है, तो दूसरी शैली लागू होती है (यह तर्क Microsoft Project Professional से विरासत में मिला है)।
