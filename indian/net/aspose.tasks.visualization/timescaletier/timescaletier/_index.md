...
description: "TimescaleTier कंस्ट्रक्टर। TimescaleTier क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है"
type: docs
weight: 10
...
[`TimescaleTier`](../) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है।
...
| --- | --- | --- |
| unit | TimescaleUnit | समय स्केल यूनिट [`TimescaleUnit`](../../timescaleunit/)। |
| count | Int32 | [`TimescaleUnit`](../../timescaleunit/) इकाइयों की गिनती। |
