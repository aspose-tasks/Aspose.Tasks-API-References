...
description: यह उन वर्गं के लए एक सर आधर वर्ग है ज कस प्रजेक्ट क कस वशेष प्ररूप में सहेजते समय उपयगकर्त क अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1920
...
यह उन वर्गों के लिए एक सार आधार वर्ग है जो किसी प्रोजेक्ट को किसी विशेष प्रारूप में सहेजते समय उपयोगकर्ता को अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
...
| [PresentationFormat](../../aspose.tasks.saving/saveoptions/presentationformat/) { get; set; } | हो जाता है या सेट करता है[`PresentationFormat`](./presentationformat/) जिसमें दस्तावेज़ सहेजा जाएगा. |
...
| [Timescale](../../aspose.tasks.saving/saveoptions/timescale/) { get; set; } | हो जाता है या सेट करता है[`Timescale`](./timescale/) मूल्य जिसका उपयोग यह नियंत्रित करने के लिए किया जाता है कि प्रोजेक्ट को ग्राफिकल प्रारूप में सहेजे जाने पर टाइमस्केल (यदि मौजूद है) को कैसे प्रस्तुत किया जाता है। |
...
| [ViewSettings](../../aspose.tasks.saving/saveoptions/viewsettings/) { get; set; } | एक दृश्य प्राप्त करता है या सेट करता है ([`View`](./view/) ) सौंपने के लिए। आप इस विकल्प का उपयोग स्पष्ट रूप से निर्दिष्ट करने के लिए कर सकते हैं कि किस दृश्य को पीडीएफ, एचटीएमएल या छवि प्रारूपों में सहेजा जाना चाहिए। यदि यह संपत्ति सेट है,[`PresentationFormat`](../../aspose.tasks.visualization/presentationformat/) प्रोजेक्‍ट के सहेजे जाने पर गुण को अनदेखा कर दिया जाता है. दृश्‍य निम्‍न में से किसी एक स्‍क्रीन से होना चाहिए (([`Screen`](../../aspose.tasks/view/screen/) )): (गैंट, टास्कशीट, टास्कयूसेज, रिसोर्सशीट, रिसोर्सयूसेज) |

### टिप्पणियों

किसी दस्तावेज़ को सहेजते समय कस्टम विकल्पों को परिभाषित करने के लिए उपयोगकर्ता के लिए SaveOptions वर्ग से किसी भी व्युत्पन्न वर्ग का एक उदाहरण स्ट्रीम सेव या स्ट्रिंग सेव ओवरलोड्स को पास किया जाता है।
