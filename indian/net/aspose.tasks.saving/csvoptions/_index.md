...
description: प्रजेक्ट क CSV में सहेजते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1720
...
| नाम | विवरण |
| --- | --- |
| [CsvOptions](csvoptions/)() | का एक नया उदाहरण प्रारंभ करता है`CsvOptions` क्लास जिसका उपयोग सीएसवी प्रारूप में परियोजना को बचाने के लिए किया जा सकता है। |
...
| [DataCategory](../../aspose.tasks.saving/csvoptions/datacategory/) { get; set; } | सहेजे जाने के लिए डेटा श्रेणी प्राप्त या सेट करता है। |
...
| [Encoding](../../aspose.tasks.saving/csvoptions/encoding/) { get; set; } | CSV को के साथ सहेजने के लिए एक एन्कोडिंग प्राप्त या सेट करता है |
...
| [IncludeHeaders](../../aspose.tasks.saving/csvoptions/includeheaders/) { get; set; } | एक मान प्राप्त या सेट करता है जो इंगित करता है कि हेडर शामिल करना है या नहीं (डिफ़ॉल्ट मान TRUE है)। |
...
| [TextDelimiter](../../aspose.tasks.saving/csvoptions/textdelimiter/) { get; set; } | टेक्स्ट सीमांकक प्राप्त करता है या सेट करता है. |
