...
description: प्रमवेर XER प्ररूप में प्रजेक्ट सहेजते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1880
...
प्रिमावेरा XER प्रारूप में प्रोजेक्ट सहेजते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
...
| नाम | विवरण |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | का एक नया उदाहरण प्रारंभ करता है`PrimaveraSaveOptions` वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | गतिविधि आईडी के पुन: क्रमांकन में उपयोग की जाने वाली वृद्धि को प्राप्त या सेट करता है। |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | गतिविधि आईडी को फिर से क्रमांकित करने में उपयोग किए जाने वाले उपसर्ग को प्राप्त या सेट करता है। |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | गतिविधि आईडी को फिर से क्रमांकित करने में उपयोग किए गए प्रत्यय को प्राप्त या सेट करता है। |
...
| [RenumberActivityIds](../../aspose.tasks.saving/primaverasaveoptions/renumberactivityids/) { get; set; } | एक मान प्राप्त करता है या सेट करता है जो इंगित करता है कि गतिविधि आईडी को पुन: क्रमांकित करने की आवश्यकता है या नहीं। |
