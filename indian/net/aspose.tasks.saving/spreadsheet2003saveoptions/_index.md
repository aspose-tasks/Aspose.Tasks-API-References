...
description: स्प्रेडशट2003. में प्रजेक्ट पृष्ठं क प्रस्तुत करते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1940
...
स्प्रेडशीट2003. में प्रोजेक्ट पृष्ठों को प्रस्तुत करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है
...
| नाम | विवरण |
| --- | --- |
| [Spreadsheet2003SaveOptions](spreadsheet2003saveoptions/)() | का एक नया उदाहरण प्रारंभ करता है`Spreadsheet2003SaveOptions` कक्षा। |

## गुण

| नाम | विवरण |
| --- | --- |
| [AssignmentView](../../aspose.tasks.saving/spreadsheet2003saveoptions/assignmentview/) { get; set; } | रेंडर करने के लिए असाइनमेंट व्यू कॉलम की सूची प्राप्त या सेट करता है ([`AssignmentViewColumn`](../../aspose.tasks.visualization/assignmentviewcolumn/) . |
...
| [ResourceView](../../aspose.tasks.saving/spreadsheet2003saveoptions/resourceview/) { get; set; } | रेंडर करने के लिए संसाधन दृश्य कॉलम की सूची प्राप्त या सेट करता है ([`ResourceViewColumn`](../../aspose.tasks.visualization/resourceviewcolumn/) . |
