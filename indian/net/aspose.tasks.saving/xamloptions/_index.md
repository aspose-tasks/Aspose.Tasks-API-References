---
title: "क्लास XamlOptions"
second_title: "Aspose.Tasks .NET के लिए API संदर्भ"
description: "Aspose.Tasks.Saving.XamlOptions क्लास। /// प्रोजेक्ट पेजों को XAML में रेंडर करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है"
type: docs
weight: 2260
url: /hi/net/aspose.tasks.saving/xamloptions/
---
## XamlOptions class

/// XAML में प्रोजेक्ट पेज रेंडर करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
...
| नाम | विवरण |
| --- | --- |
| [XamlOptions](xamloptions/)() | `XamlOptions` क्लास का नया इंस्टेंस इनिशियलाइज़ करता है जिसे XAML फ़ॉर्मेट में प्रोजेक्ट को सेव करने के लिए उपयोग किया जा सकता है। |
