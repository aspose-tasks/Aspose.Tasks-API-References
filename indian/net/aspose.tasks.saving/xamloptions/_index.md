...
description: /// XAML. में प्रजेक्ट पेजं क प्रस्तुत करते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1970
...
/// XAML. में प्रोजेक्ट पेजों को प्रस्तुत करते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है
...
| नाम | विवरण |
| --- | --- |
| [XamlOptions](xamloptions/)() | का एक नया उदाहरण प्रारंभ करता है`XamlOptions` वर्ग जिसका उपयोग XAML प्रारूप में प्रोजेक्ट को सहेजने के लिए किया जा सकता है। |
