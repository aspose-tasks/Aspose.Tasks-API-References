...
description: प्रमवेर एक्सएमएल प्ररूप में प्रजेक्ट सहेजते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1890
...
प्रिमावेरा एक्सएमएल प्रारूप में प्रोजेक्ट सहेजते समय अतिरिक्त विकल्प निर्दिष्ट करने की अनुमति देता है।
...
| नाम | विवरण |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | का एक नया उदाहरण प्रारंभ करता है`PrimaveraXmlSaveOptions` वर्ग. |
...
| [SaveRootTask](../../aspose.tasks.saving/primaveraxmlsaveoptions/saveroottask/) { get; set; } | रूट कार्य को सहेजना है या नहीं, यह इंगित करने वाला मान प्राप्त करता है या सेट करता है। |
