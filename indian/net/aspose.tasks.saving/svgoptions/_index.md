...
description: SVG. में प्रजेक्ट पेज रेंडर करते समय अतरक्त वकल्प नर्दष्ट करने क अनुमत देत है
type: docs
weight: 1950
...
| नाम | विवरण |
| --- | --- |
| [SvgOptions](svgoptions/)() | का एक नया उदाहरण प्रारंभ करता है`SvgOptions` एसवीजी प्रारूप में परियोजना को बचाने के लिए इस्तेमाल किया जा सकता है। |
...
| [PageSavingCallback](../../aspose.tasks.saving/svgoptions/pagesavingcallback/) { get; set; } | उपयोगकर्ता-परिभाषित कार्यान्वयन कॉलबैक प्राप्त या सेट करता है जिसका उपयोग प्रत्येक प्रस्तुत पृष्ठ के लिए आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाता है। |
...
| override [UseGradientBrush](../../aspose.tasks.saving/svgoptions/usegradientbrush/) { get; set; } | निर्धारित करता है कि प्रोजेक्ट लेआउट को रेंडर करते समय ग्रेडिएंट ब्रश का उपयोग करना है या नहीं। वर्तमान में SVG को रेंडर करने के लिए ग्रेडिएंट ब्रश का उपयोग समर्थित नहीं है। |
