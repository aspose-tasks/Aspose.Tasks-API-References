...
description: "ExtendedAttribute प्रॉपर्टी। Duration प्रकार वाले एट्रिब्यूट्स के लिए मान प्राप्त करता है या सेट करता है"
type: docs
weight: 30
...
'Duration' प्रकार वाले गुणों के लिए मान प्राप्त करता है या सेट करता है।
...
| अपवाद | शर्त |
| --- | --- |
| InvalidOperationException | यदि [`AttributeDefinition`](../attributedefinition/) प्रॉपर्टी प्रारंभ नहीं की गई है या [`AttributeDefinition`](../attributedefinition/) प्रॉपर्टी का कस्टम फ़ील्ड प्रकार एक [`Duration`](../../duration/) इंस्टेंस नहीं है तो थ्रो किया जाता है। |
