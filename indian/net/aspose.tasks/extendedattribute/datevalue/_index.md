...
description: "ExtendedAttribute प्रॉपर्टी। तिथि प्रकार (Date, Start, Finish) वाले विशेषताओं के लिए मान प्राप्त या सेट करता है।"
type: docs
weight: 20
...
तारीख प्रकार (Date, Start, Finish) वाले गुणों के लिए मान प्राप्त करता है या सेट करता है।
...
| अपवाद | शर्त |
| --- | --- |
| InvalidOperationException | यदि [`AttributeDefinition`](../attributedefinition/) प्रॉपर्टी प्रारंभ नहीं की गई है या वर्तमान विशेषता तिथि विशेषता नहीं है तो फेंका जाता है। |
