...
description: "ExtendedAttribute प्रॉपर्टी। यह मान प्राप्त करता है जो दर्शाता है कि इस ExtendedAttribute इंस्टेंस का मान केवल-पढ़ने योग्य है या नहीं। यदि इस ऑब्जेक्ट के लिए ExtendedAttributeDefinition में कोई फ़ॉर्मूला या रोलअप परिभाषित है तो true लौटाता है।"
type: docs
weight: 100
...
यह मान प्राप्त करता है जो दर्शाता है कि इस [`ExtendedAttribute`](../) इंस्टेंस का मान केवल-पढ़ने योग्य है या नहीं। यदि इस ऑब्जेक्ट के लिए [`ExtendedAttributeDefinition`](../../extendedattributedefinition/) में कोई फ़ॉर्मूला या रोलअप परिभाषित है तो true लौटाता है।
