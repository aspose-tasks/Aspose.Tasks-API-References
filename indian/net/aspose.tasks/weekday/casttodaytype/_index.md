...
description: "WeekDay मेथड। .Net का DayOfWeek को DayType में कास्ट करता है।"
type: docs
weight: 120
...
`.Net` का DayOfWeek को [`DayType`](../daytype/) में कास्ट करता है।
...
| --- | --- | --- |
| dw | DayOfWeek | कास्ट करने के लिए सप्ताह का दिन। |

### रिटर्न वैल्यू

एक कास्ट किया गया दिन प्रकार।
