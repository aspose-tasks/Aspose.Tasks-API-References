...
description: "OutlineMaskCollection method. निर्दिष्ट आइटम को इस संग्रह में जोड़ता है"
type: docs
weight: 40
url: /hi/net/aspose.tasks/outlinemaskcollection/add/
---
...
| --- | --- | --- |
| आइटम | OutlineMask | इस संग्रह में जोड़ने के लिए निर्दिष्ट आइटम। |
