...
description: "ExtendedAttributeDefinition प्रॉपर्टी। कस्टम फ़ील्ड से जुड़ी लुकअप तालिका का Guid प्राप्त करता है।"
type: docs
weight: 180
...
कस्टम फ़ील्ड से जुड़ी लुकअप टेबल का GUID प्राप्त करता है।
...
लुकअप के साथ एक कस्टम फ़ील्ड बनाने के लिए, निम्नलिखित फैक्ट्री मेथड्स में से एक का उपयोग करें: [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) या [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
