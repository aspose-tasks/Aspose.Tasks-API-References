...
लुकअप के साथ एक विस्तारित एट्रिब्यूट परिभाषा बनाने वाली फ़ैक्टरी मेथड। इसमें [`CalculationType`](../calculationtype/) का मान Lookup है और यह केवल Tasks में उपयोग किया जा सकता है। इस मेथड को कॉल करते समय आपको *fieldId* और *alias* निर्दिष्ट करना आवश्यक है। फ़ील्ड प्रकार field id से अनुमानित किया जाता है।
...
लुकअप के साथ एक टास्क के लिए कस्टम फ़ील्ड परिभाषा बनाने और फिर उसे टेक्स्ट मानों से भरने के लिए इस उदाहरण का उपयोग करें:
...
लुकअप के साथ एक विस्तारित एट्रिब्यूट परिभाषा बनाने वाली फ़ैक्टरी मेथड। इसमें [`CalculationType`](../calculationtype/) का मान Lookup है और यह केवल Tasks में उपयोग किया जा सकता है। इस मेथड को कॉल करते समय आपको *customFieldType*, *fieldId* और *alias* निर्दिष्ट करना आवश्यक है।
