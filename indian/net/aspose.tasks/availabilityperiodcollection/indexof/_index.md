...
description: "AvailabilityPeriodCollection मेथड। इस संग्रह में निर्दिष्ट आइटम का इंडेक्स निर्धारित करता है"
type: docs
weight: 100
url: /hi/net/aspose.tasks/availabilityperiodcollection/indexof/
---
...
| --- | --- | --- |
| आइटम | AvailabilityPeriod | इस संग्रह में खोजने के लिए निर्दिष्ट आइटम। |
