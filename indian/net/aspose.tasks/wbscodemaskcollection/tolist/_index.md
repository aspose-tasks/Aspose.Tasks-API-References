...
description: "WBSCodeMaskCollection मेथड। एक WBSCodeMaskCollection को WBSCodeMask वस्तुओं की सूची में परिवर्तित करता है।"
type: docs
weight: 90
...
एक WBSCodeMaskCollection को [`WBSCodeMask`](../../wbscodemask/) वस्तुओं की सूची में परिवर्तित करता है।
...
सामान्य सूची में [`WBSCodeMask`](../../wbscodemask/) वस्तुएँ।
