...
description: "WBSCodeMaskCollection मेथड। इस कलेक्शन के तत्वों को निर्दिष्ट एरे में निर्दिष्ट एरे इंडेक्स से शुरू करके कॉपी करता है"
type: docs
weight: 60
url: /hi/net/aspose.tasks/wbscodemaskcollection/copyto/
---
...
| --- | --- | --- |
| एरे | WBSCodeMask[] | तत्वों को कॉपी करने के लिए निर्दिष्ट एक-आयामी एरे |
