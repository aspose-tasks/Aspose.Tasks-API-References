...
description: "WeekDayCollection मेथड। जांचता है कि संग्रह में WeekDay.specified मौजूद है या नहीं"
type: docs
weight: 50
...
जांचता है कि संग्रह में [`WeekDay`](../../weekday/).specified मौजूद है या नहीं।
...
| --- | --- | --- |
| आइटम | WeekDay | जाँच के लिए आइटम। |

### रिटर्न वैल्यू

सही, यदि संग्रह में निर्दिष्ट आइटम मौजूद है, अन्यथा गलत।
