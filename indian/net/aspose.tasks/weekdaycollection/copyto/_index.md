...
description: "WeekDayCollection मेथड। संग्रह की सामग्री को निर्दिष्ट इंडेक्स पर एक एरे में कॉपी करता है"
type: docs
weight: 60
...
निर्दिष्ट इंडेक्स पर संग्रह की सामग्री को एक एरे में कॉपी करता है।
...
| --- | --- | --- |
| array | WeekDay[] | कॉपी करने के लिए [`WeekDay`](../../weekday/) की गंतव्य एरे |
| arrayIndex | Int32 | कॉपी ऑपरेशन के लिए प्रारंभिक इंडेक्स। |
