...
description: "WeekDayCollection मेथड। निर्दिष्ट इंडेक्स पर WeekDay डालता है"
type: docs
weight: 90
...
निर्दिष्ट इंडेक्स पर [`WeekDay`](../../weekday/) डालता है।
...
| --- | --- | --- |
| इंडेक्स | Int32 | डालने के लिए इंडेक्स। |
| आइटम | WeekDay | इन्सर्ट करने के लिए आइटम। |
