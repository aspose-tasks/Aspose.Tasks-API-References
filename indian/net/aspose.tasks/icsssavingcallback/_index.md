---
title: "इंटरफ़ेस ICssSavingCallback"
second_title: "Aspose.Tasks .NET के लिए API संदर्भ"
description: "Aspose.Tasks.ICssSavingCallback इंटरफ़ेस। वह कॉलबैक दर्शाता है जिसे CSS संग्रहीत करने के लिए संसाधन बनाने हेतु बुलाया जाता है।"
type: docs
weight: 850
...
CSS को संग्रहीत करने के लिए संसाधन बनाने हेतु कॉल किया जाने वाला कॉलबैक का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [CssSaving](../../aspose.tasks/icsssavingcallback/csssaving/)(CssSavingArgs) | CSS सहेजते समय बुलाया जाने वाला मेथड। |
