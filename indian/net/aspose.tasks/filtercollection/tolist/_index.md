...
description: "FilterCollection मेथड। एक फ़िल्टर संग्रह को Filter ऑब्जेक्ट्स की सूची में परिवर्तित करता है"
type: docs
weight: 90
...
फ़िल्टर संग्रह को [`Filter`](../../filter/) ऑब्जेक्ट्स की सूची में परिवर्तित करता है।
...
[`Filter`](../../filter/) ऑब्जेक्ट्स की सामान्य सूची।
