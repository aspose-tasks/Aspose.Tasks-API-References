...
description: "TaskCollection मेथड। TaskCollection ऑब्जेक्ट को Task ऑब्जेक्ट्स की सूची में परिवर्तित करता है।"
type: docs
weight: 120
...
TaskCollection ऑब्जेक्ट को [`Task`](../../task/) ऑब्जेक्ट्स की सूची में परिवर्तित करता है।
...
वापस करता है एक सूची जिसमें इस संग्रह के [`Task`](../../task/) क्लास के इंस्टेंस शामिल हैं।
