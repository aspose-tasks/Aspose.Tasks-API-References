...
description: "OutlineCodeDefinition प्रॉपर्टी. OutlineMaskCollection ऑब्जेक्ट प्राप्त करता है। वह एंट्रीज़ की तालिका जो आउटलाइन कोड मास्क को परिभाषित करती है। केवल-पढ़ने योग्य OutlineMaskCollection इंस्टेंस।"
type: docs
weight: 100
...
OutlineMaskCollection ऑब्जेक्ट प्राप्त करता है। वह एंट्रीज़ की तालिका जो आउटलाइन कोड मास्क को परिभाषित करती है। केवल-पढ़ने योग्य [`OutlineMaskCollection`](../../outlinemaskcollection/) इंस्टेंस।
