...
description: "OutlineCodeDefinition प्रॉपर्टी. OutlineValueCollection ऑब्जेक्ट प्राप्त करता है। इस आउटलाइन कोड से जुड़ी तालिका के मान।"
type: docs
weight: 150
...
OutlineValueCollection ऑब्जेक्ट प्राप्त करता है। इस आउटलाइन कोड से जुड़ी तालिका के मान।
...
नए आउटलाइन कोड बनाने का तरीका दिखाता है।

```csharp
var project = new Project(DataDir + "project.mpp");

// आउटलाइन कोड और उसका आउटलाइन मास्क परिभाषित करें।
...
// प्रोजेक्ट में आउटलाइन कोड जोड़ें।
