...
description: "Value प्रॉपर्टी। टेक्स्ट स्ट्रिंग को दर्शाने के लिए उपयोग किए जाने वाले वास्तविक मान को प्राप्त या सेट करता है।"
type: docs
weight: 80
...
टेक्स्ट स्ट्रिंग को दर्शाने के लिए उपयोग किए जाने वाले वास्तविक मान को प्राप्त करता या सेट करता है।
...
जब आपको टेक्स्ट मान सेट करना हो, तो इस प्रॉपर्टी को [`Val`](../val/) के ऊपर प्राथमिकता दें।
