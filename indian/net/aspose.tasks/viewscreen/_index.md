---
title: "एनम ViewScreen"
second_title: "Aspose.Tasks .NET के लिए API संदर्भ"
description: "Aspose.Tasks.ViewScreen enum. एक दृश्य के लिए स्क्रीन प्रकार निर्दिष्ट करता है।"
type: docs
weight: 2910
...
व्यू के लिए स्क्रीन प्रकार को निर्दिष्ट करता है।
...
| नाम | मान | विवरण |
| --- | --- | --- |
| Calendar | `13` | कैलेंडर दृश्य। |
| Gantt | `1` | गैंट दृश्य। |
| NetworkDiagram | `2` | नेटवर्क डायग्राम दृश्य। |
| RelationshipDiagram | `3` | रिलेशनशिप डायग्राम दृश्य। |
| ResourceForm | `6` | रिसोर्स फ़ॉर्म दृश्य। |
| ResourceGraph | `8` | रिसोर्स ग्राफ़ दृश्य। |
| ResourceNameForm | `12` | रिसोर्स नाम फ़ॉर्म दृश्य। |
| ResourceSheet | `7` | रिसोर्स शीट दृश्य। |
| ResourceUsage | `15` | रिसोर्स उपयोग दृश्य। |
| TaskDetailsForm | `10` | टास्क विवरण फ़ॉर्म दृश्य। |
| TaskForm | `4` | टास्क फ़ॉर्म दृश्य। |
| TaskNameForm | `11` | टास्क नाम फ़ॉर्म दृश्य। |
| TaskSheet | `5` | टास्क शीट दृश्य। |
| TaskUsage | `14` | टास्क उपयोग दृश्य। |
