...
description: "AssignmentBaseline मेथड। IComparable इंटरफ़ेस कार्यान्वयन। इस इंस्टेंस की तुलना निर्दिष्ट Baseline ऑब्जेक्ट से करता है।"
type: docs
weight: 50
...
| --- | --- | --- |
| अन्य | AssignmentBaseline | निर्दिष्ट Baseline ऑब्जेक्ट जिससे इस इंस्टेंस की तुलना की जानी है। |
