...
description: "TimephasedDataCollection मेथड। startTime और finishTime के बीच सभी टाइम फेज़ चुनता है। औसत केस में Olog n जटिलता रखता है।"
type: docs
weight: 110
...
सभी time phases को *startTime* और *finishTime* के बीच चुनता है। औसत केस में O(log n) जटिलता है।
...
| --- | --- | --- |
| timephasedDataType | TimephasedDataType | चुनने के लिए टाइम फेज़ का प्रकार। |
| startTime | DateTime | इंटरवल की शुरुआत। |
| finishTime | DateTime | इंटरवल का अंत। |

### रिटर्न वैल्यू

Start प्रॉपर्टी के अनुसार क्रमबद्ध [`TimephasedDataCollection`](../) डेटा की नई सूची इंस्टेंस लौटाता है।
