...
description: "TimephasedDataCollection मेथड। यह निर्धारित करता है कि TimephasedDataCollection में कोई विशिष्ट मान मौजूद है या नहीं"
type: docs
weight: 70
...
निर्धारित करता है कि [`TimephasedDataCollection`](../) में कोई विशिष्ट मान मौजूद है या नहीं।
...
| --- | --- | --- |
| आइटम | TimephasedData | संग्रह में खोजने के लिए ऑब्जेक्ट। |
