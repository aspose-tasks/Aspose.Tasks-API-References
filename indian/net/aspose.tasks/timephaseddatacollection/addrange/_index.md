...
description: "TimephasedDataCollection मेथड। इस संग्रह ऑब्जेक्ट में TimephasedData इंस्टेंसेस का एक संग्रह जोड़ता है"
type: docs
weight: 50
...
इस संग्रह ऑब्जेक्ट में [`TimephasedData`](../../timephaseddata/) इंस्टेंसेस का एक संग्रह जोड़ता है।
...
| --- | --- | --- |
| timephasedCollection | IEnumerable`1 | जोड़ने के लिए [`TimephasedData`](../../timephaseddata/) ऑब्जेक्ट्स का एक संग्रह। |
