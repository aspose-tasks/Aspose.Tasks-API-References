...
description: "TimephasedDataCollection मेथड। यह TimephasedData instance को इस collection object में जोड़ता है।"
type: docs
weight: 40
...
इस collection object में [`TimephasedData`](../../timephaseddata/) instance जोड़ता है।
...
| --- | --- | --- |
| आइटम | TimephasedData | जोड़ने के लिए आइटम। |

### अपवाद

| अपवाद | शर्त |
| --- | --- |
| ArgumentNullException | यदि पैरामीटर td null है। |
