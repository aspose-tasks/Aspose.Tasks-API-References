...
description: "TimephasedDataCollection मेथड। इस कलेक्शन ऑब्जेक्ट से TimephasedData इंस्टेंस हटाता है।"
type: docs
weight: 100
...
इस कलेक्शन ऑब्जेक्ट से [`TimephasedData`](../../timephaseddata/) इंस्टेंस हटाता है।
...
| --- | --- | --- |
| आइटम | TimephasedData | हटाने के लिए आइटम। |

### रिटर्न वैल्यू

यदि *item* को सफलतापूर्वक [`TimephasedDataCollection`](../) से हटा दिया गया हो तो true; अन्यथा false। यह मेथड भी false लौटाता है यदि *item* को [`TimephasedDataCollection`](../) में नहीं पाया गया।
