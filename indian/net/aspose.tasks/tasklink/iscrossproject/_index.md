...
description: "TaskLink property. यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि क्या एक प्रीडेससर किसी अन्य प्रोजेक्ट का हिस्सा है"
type: docs
weight: 20
...
यह संकेत देने वाला मान प्राप्त करता है या सेट करता है कि क्या एक predecessor किसी अन्य प्रोजेक्ट का हिस्सा है।
...
क्रॉस प्रोजेक्ट टास्क लिंक खोजने का तरीका दिखाता है।

```csharp
var project = new Project(DataDir + "GetCrossProjectTaskLinks.mpp");

// क्रॉस प्रोजेक्ट टास्क लिंक जांचें
