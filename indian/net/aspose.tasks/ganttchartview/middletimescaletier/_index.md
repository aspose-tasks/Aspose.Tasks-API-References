...
description: "GanttChartView प्रॉपर्टी। दृश्य के मध्य टाइमस्केल टियर की सेटिंग्स प्राप्त करता है या सेट करता है। TimescaleTier"
type: docs
weight: 100
url: /hi/net/aspose.tasks/ganttchartview/middletimescaletier/
---
## GanttChartView.MiddleTimescaleTier property

प्राप्त करता है या सेट करता है व्यू के मध्य टाइमस्केल टियर की सेटिंग्स। [`TimescaleTier`](../../../aspose.tasks.visualization/timescaletier/).
