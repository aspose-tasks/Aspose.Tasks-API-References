...
description: "CalendarExceptionCollection मेथड। इस संग्रह ऑब्जेक्ट में CalendarException इंस्टेंस जोड़ता है"
type: docs
weight: 40
...
इस संग्रह ऑब्जेक्ट में CalendarException इंस्टेंस जोड़ता है।
...
| --- | --- | --- |
| आइटम | CalendarException | जोड़ने के लिए आइटम। |
