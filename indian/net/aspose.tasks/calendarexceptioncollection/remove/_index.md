...
description: "CalendarExceptionCollection मेथड। इस संग्रह से CalendarException इंस्टेंस हटाता है"
type: docs
weight: 80
...
[`CalendarException`](../../calendarexception/) इंस्टेंस को इस संग्रह से हटाता है।
...
| --- | --- | --- |
| आइटम | CalendarException | हटाने के लिए आइटम। |

### रिटर्न वैल्यू

यदि निर्दिष्ट अपवाद सफलतापूर्वक हटाया गया हो तो true।
