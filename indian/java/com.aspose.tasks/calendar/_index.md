...
description: "प्रोजेक्ट में उपयोग किए जाने वाले कैलेंडर का प्रतिनिधित्व करता है।"
type: docs
weight: 41
url: /hi/java/com.aspose.tasks/calendar/
---
...
&gt; ```
&gt; शुरू से सरल कैलेंडर कैसे बनाएं।
&gt; ``````
...
// कार्य समय सेट करता है। DateTime का केवल समय भाग महत्वपूर्ण है
