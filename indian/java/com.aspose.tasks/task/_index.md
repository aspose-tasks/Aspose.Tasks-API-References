...
type: docs
weight: 289
url: /hi/java/com.aspose.tasks/task/
---
...
यह **Task** एक एटॉमिक कार्य खंड का प्रतिनिधित्व करता है।

कोई **Task** का उपयोग करके प्रोजेक्ट की योजना बना सकता है, कार्य बनाकर और उन पर उपयुक्त संसाधन असाइन करके। प्रोजेक्ट में कार्य एक मूलभूत पदानुक्रमित वृक्ष संरचना के रूप में व्यवस्थित होते हैं, जिसमें एक रूट कार्य और बच्चों के कार्यों की उपवृक्ष होते हैं।

कार्य के वृक्ष को बनाने के लिए कोई एक विशिष्ट संग्रह [TaskCollection](../../com.aspose.tasks/taskcollection) का उपयोग कर सकता है, `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) प्रॉपर्टी तक पहुंचकर, उदाहरण के लिए:
...
// नए कार्य जोड़ें
Task task1 = project.RootTask.Children.Add(); // एक खाली नाम वाला पैरेंट टास्क जोड़ा गया है
...
Task childTask2 = task1.Children.Add("Child 2", 2); // childTask3 से पहले एक कार्य सम्मिलित करता है
childTask2.Set(Tsk.Start, new DateTime(2020, 2, 14, 8, 0, 0))
childTask2.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask2.Set(Tsk.Finish, new DateTime(2020, 2, 14, 17, 0, 0));

// उपलब्ध प्रारूपों में से एक में प्रोजेक्ट सहेजें
...
```
सार्वजनिक अंतिम ResourceAssignmentCollection getAssignments()
```
...
### getBCWP() {#getBCWP--}
```
सार्वजनिक अंतिम double getBCWP()
```
...
### getBCWS() {#getBCWS--}
```
सार्वजनिक अंतिम double getBCWS()
```
...
```
सार्वजनिक अंतिम TaskBaselineCollection getBaselines()
```
...
```
सार्वजनिक अंतिम BigDecimal getBudgetCost()
```
...
```
सार्वजनिक अंतिम Duration getBudgetWork()
```
...
```
सार्वजनिक अंतिम Calendar getCalendar()
```
...
```
सार्वजनिक अंतिम TaskCollection getChildren()
```
...
```
सार्वजनिक अंतिम Date getCommitmentFinish()
```
...
```
सार्वजनिक अंतिम Date getCommitmentStart()
```
...
```
सार्वजनिक अंतिम int getCommitmentType()
```
...
```
सार्वजनिक अंतिम Date getConstraintDate()
```
...
```
सार्वजनिक अंतिम int getConstraintType()
```
...
```
सार्वजनिक अंतिम String getContact()
```
...
### getCost() {#getCost--}
```
सार्वजनिक अंतिम BigDecimal getCost()
```
...
```
सार्वजनिक अंतिम double getCostVariance()
```
...
```
सार्वजनिक अंतिम Date getCreated()
```
...
```
सार्वजनिक अंतिम Date getDeadline()
```
...
```
सार्वजनिक अंतिम NullableBool getDisplayAsSummary()
```
...
```
सार्वजनिक अंतिम boolean getDisplayOnTimeline()
```
...
```
सार्वजनिक अंतिम Duration getDuration()
```
...
```
सार्वजनिक अंतिम byte getDurationFormat()
```
...
```
सार्वजनिक अंतिम String getDurationText()
```
...
```
सार्वजनिक अंतिम Duration getDurationVariance()
```
...
```
सार्वजनिक अंतिम Date getEarlyFinish()
```
...
```
सार्वजनिक अंतिम Date getEarlyStart()
```
...
```
सार्वजनिक अंतिम int getEarnedValueMethod()
```
...
```
सार्वजनिक अंतिम ExtendedAttributeCollection getExtendedAttributes()
```
...
```
सार्वजनिक अंतिम int getExternalId()
```
...
```
सार्वजनिक अंतिम String getExternalTaskProject()
```
...
```
सार्वजनिक अंतिम int getExternalUid()
```
...
### getFinish() {#getFinish--}
```
सार्वजनिक अंतिम Date getFinish()
```
...
```
सार्वजनिक अंतिम double getFinishSlack()
```
...
```
सार्वजनिक अंतिम String getFinishText()
```
...
```
सार्वजनिक अंतिम Duration getFinishVariance()
```
...
```
सार्वजनिक अंतिम double getFixedCost()
```
...
```
सार्वजनिक अंतिम int getFixedCostAccrual()
```
...
```
सार्वजनिक अंतिम double getFreeSlack()
```
...
```
सार्वजनिक अंतिम NullableBool getHideBar()
```
...
```
सार्वजनिक अंतिम String getHyperlink()
```
...
```
सार्वजनिक अंतिम String getHyperlinkAddress()
```
...
```
सार्वजनिक अंतिम String getHyperlinkSubAddress()
```
...
```
सार्वजनिक अंतिम NullableBool getIgnoreResourceCalendar()
```
...
```
सार्वजनिक अंतिम boolean getIgnoreWarnings()
```
...
### getItems() {#getItems--}
```
सार्वजनिक अंतिम Iterable<IExtendedAttributeParent> getItems()
```
...
```
सार्वजनिक अंतिम Date getLateFinish()
```
...
```
सार्वजनिक अंतिम Date getLateStart()
```
...
```
सार्वजनिक अंतिम NullableBool getLevelAssignments()
```
...
```
सार्वजनिक अंतिम बूलियन hasChildren()
```
...
### isActive() {#isActive--}
```
सार्वजनिक अंतिम NullableBool isActive()
```
...
```
सार्वजनिक अंतिम NullableBool isCritical()
```
...
```
सार्वजनिक अंतिम NullableBool isEffortDriven()
```
...
```
सार्वजनिक अंतिम NullableBool isEstimated()
```
...
```
सार्वजनिक अंतिम NullableBool isExpanded()
```
...
```
सार्वजनिक अंतिम बूलियन isExternalTask()
```
...
### isManual() {#isManual--}
```
सार्वजनिक अंतिम NullableBool isManual()
```
...
### isMarked() {#isMarked--}
```
सार्वजनिक अंतिम बूलियन isMarked()
```
...
```
सार्वजनिक अंतिम NullableBool isMilestone()
```
...
### isNull() {#isNull--}
```
सार्वजनिक अंतिम NullableBool isNull()
```
...
```
सार्वजनिक अंतिम NullableBool isOverallocated()
```
...
```
सार्वजनिक अंतिम NullableBool isPublished()
```
...
```
सार्वजनिक अंतिम NullableBool isRecurring()
```
...
```
सार्वजनिक अंतिम NullableBool isResumeValid()
```
...
### isRollup() {#isRollup--}
```
सार्वजनिक अंतिम NullableBool isRollup()
```
...
```
सार्वजनिक अंतिम बूलियन isSubproject()
```
...
```
सार्वजनिक अंतिम NullableBool isSubprojectReadOnly()
```
...
### isSummary() {#isSummary--}
```
सार्वजनिक अंतिम बूलियन isSummary()
```
...
```
सार्वजनिक अंतिम void moveToSibling(Task beforeTask)
```
...
```
सार्वजनिक अंतिम void moveToSibling(int beforeTaskId)
```
...
```
सार्वजनिक अंतिम void outlineIndent()
```
...
```
सार्वजनिक अंतिम void outlineOutdent()
```
...
```
सार्वजनिक अंतिम Iterable<Task> selectAllChildTasks()
```
...
```
सार्वजनिक अंतिम void setACWP(double value)
```
...
```
public final void setCreated(Date मान)
```
...
```
public final void setCritical(NullableBool मान)
```
...
```
public final void setDeadline(Date मान)
```
...
```
public final void setDisplayAsSummary(NullableBool मान)
```
...
```
public final void setDisplayOnTimeline(boolean मान)
```
...
```
public final void setDuration(Duration मान)
```
...
```
public final void setDurationText(String मान)
```
...
```
public final void setDurationVariance(Duration मान)
```
...
```
public final void setEarlyFinish(Date मान)
```
...
```
public final void setEarlyStart(Date मान)
```
...
```
public final void setEffortDriven(NullableBool मान)
```
...
```
public final void setEstimated(NullableBool मान)
```
...
```
public final void setExpanded(NullableBool मान)
```
...
```
public final void setExternalId(int मान)
```
...
```
public final void setExternalTask(boolean मान)
```
...
```
public final void setExternalTaskProject(String मान)
```
...
```
public final void setExternalUid(int मान)
```
...
```
public final void setFinish(Date मान)
```
...
```
public final void setFinishSlack(double मान)
```
...
```
public final void setFinishText(String मान)
```
...
```
public final void setFinishVariance(Duration मान)
```
...
```
public final void setFixedCost(double मान)
```
...
```
public final void setFixedCostAccrual(int मान)
```
...
```
public final void setFreeSlack(double मान)
```
...
```
public final void setGuid(String मान)
```
