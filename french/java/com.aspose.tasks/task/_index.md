...
type: docs
weight: 289
url: /fr/java/com.aspose.tasks/task/
---
...
La **Task** représente un fragment atomique de travail.

On peut utiliser **Task** pour planifier un projet en créant des tâches et en assignant les ressources appropriées à celles‑ci. Les tâches d'un projet sont organisées sous forme d'une structure arborescente hiérarchique enracinée, avec une tâche racine et des sous‑arbres de tâches enfants.

Pour construire un arbre de tâches, on peut utiliser une collection spécialisée [TaskCollection](../../com.aspose.tasks/taskcollection) en accédant à la propriété `Project.RootTask`([Project.getRootTask](../../com.aspose.tasks/project\#getRootTask)/[Project.setRootTask(Task)](../../com.aspose.tasks/project\#setRootTask-Task-)) par exemple :
...
Task childTask3 = task1.Children.Add("Enfant 3");
childTask3.Set(Tsk.Start, new DateTime(2020, 2, 13, 8, 0, 0))
childTask3.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask3.Set(Tsk.Finish, new DateTime(2020, 2, 13, 17, 0, 0));
Task childTask2 = task1.Children.Add("Enfant 2", 2); // insère une tâche avant le childTask3
childTask2.Set(Tsk.Start, new DateTime(2020, 2, 14, 8, 0, 0))
childTask2.Set(Tsk.Duration, project.GetDuration(8, TimeUnitType.Hour));
childTask2.Set(Tsk.Finish, new DateTime(2020, 2, 14, 17, 0, 0));

// enregistre le projet dans l'un des formats disponibles
project.Save("ProjetRempli.xml", SaveFileFormat.Mpp);
