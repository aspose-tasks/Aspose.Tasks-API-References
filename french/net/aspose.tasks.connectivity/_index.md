...
description: "Contient des classes pour travailler avec les bases de données"
type: docs
weight: 30
...
| Classe | Description |
| --- | --- |
| [DbSettings](./dbsettings/) | Permet de spécifier les paramètres pour lire à partir de la base de données du projet. |
