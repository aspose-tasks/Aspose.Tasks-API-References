...
description: Aspose.Tasks.Saving.CsvOptions classe. Permet de spécifier des options supplémentaires lors de lenregistrement du projet au format CSV.
type: docs
weight: 1720
...
| Nom | La description |
| --- | --- |
| [CsvOptions](csvoptions/)() | Initialise une nouvelle instance du`CsvOptions` classe qui peut être utilisée pour enregistrer le projet au format CSV. |
