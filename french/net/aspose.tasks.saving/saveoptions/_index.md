...
description: Il sagit dune classe de base abstraite pour les classes qui permettent à lutilisateur de spécifier des options supplémentaires lors de lenregistrement dun projet dans un format particulier.
type: docs
weight: 1910
