...
description: Aspose.Tasks.Saving.XlsxOptions classe. Permet de spécifier des options supplémentaires lors du rendu des pages de projet au format XLSX.
type: docs
weight: 1980
...
| Nom | La description |
| --- | --- |
| [XlsxOptions](xlsxoptions/)() | Initialise une nouvelle instance du`XlsxOptions`classe qui peut être utilisée pour enregistrer le projet au format XLSX. |
