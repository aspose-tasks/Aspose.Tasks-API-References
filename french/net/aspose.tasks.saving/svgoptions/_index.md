...
description: Permet de spécifier des options supplémentaires lors du rendu des pages du projet en SVG.
type: docs
weight: 1940
...
| Nom | La description |
| --- | --- |
| [SvgOptions](svgoptions)() | Initialise une nouvelle instance du[`SvgOptions`](../svgoptions) classe qui peut être utilisée pour enregistrer le projet au format SVG. |
