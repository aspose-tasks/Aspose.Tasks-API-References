...
description: Obtient ou définit un rappel dimplémentation défini par lutilisateur qui est utilisé pour obtenir un flux de sortie pour chaque page rendue.
type: docs
weight: 20
