...
description: Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XPS.
type: docs
weight: 1980
...
| Nom | La description |
| --- | --- |
| [XpsOptions](xpsoptions)() | Initialise une nouvelle instance du[`XpsOptions`](../xpsoptions) classe. |
