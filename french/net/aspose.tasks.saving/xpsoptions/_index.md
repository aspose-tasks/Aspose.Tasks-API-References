...
description: "Classe Aspose.Tasks.Saving.XpsOptions. Permet de spécifier des options supplémentaires lors du rendu des pages du projet en XPS"
type: docs
weight: 2280
url: /fr/net/aspose.tasks.saving/xpsoptions/
---
## XpsOptions class

Permet de spécifier des options supplémentaires lors du rendu des pages de projet au format XPS.
...
| Nom | Description |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Initialise une nouvelle instance de la classe `XpsOptions`. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Obtient ou définit une valeur indiquant si un métafichier doit être rendu en bitmap. |
