...
description: Aspose.Tasks.Saving.XpsOptions classe. Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XPS.
type: docs
weight: 1990
...
Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XPS.
...
| Nom | La description |
| --- | --- |
| [XpsOptions](xpsoptions/)() | Initialise une nouvelle instance du`XpsOptions` classe. |
...
| [RenderMetafileAsBitmap](../../aspose.tasks.saving/xpsoptions/rendermetafileasbitmap/) { get; set; } | Obtient ou définit une valeur indiquant si un métafichier doit être rendu en tant que bitmap. |
