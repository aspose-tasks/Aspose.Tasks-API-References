...
description: "Propriété HtmlSaveOptions. Obtient ou définit le callback qui est appelé pour créer la ressource où stocker la police"
type: docs
weight: 80
...
Obtient ou définit le rappel qui est appelé pour créer la ressource de stockage de la police.
...
Montre comment travailler avec les rappels d'enregistrement de polices.
