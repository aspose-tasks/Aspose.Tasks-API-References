...
description: Permet de spécifier des options supplémentaires lors du rendu des pages de projet au format HTML.
type: docs
weight: 1740
...
| Nom | La description |
| --- | --- |
| [HtmlSaveOptions](htmlsaveoptions)() | Initialise une nouvelle instance du[`HtmlSaveOptions`](../htmlsaveoptions) classe. |
