...
description: "Propriété HtmlSaveOptions. Obtient ou définit la manière dont les polices sont exportées."
type: docs
weight: 50
...
Obtient ou définit la façon dont les polices sont exportées.
