...
description: Aspose.Tasks.Saving.PrintOptions classe. Permet de spécifier des options supplémentaires lors de limpression du projet.
type: docs
weight: 1900
...
| Nom | La description |
| --- | --- |
| [PrintOptions](printoptions/)() | Initialise une nouvelle instance du`PrintOptions` classe qui peut être utilisée pour définir différentes options pour imprimer le projet. |
