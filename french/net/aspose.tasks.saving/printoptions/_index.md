...
description: "Aspose.Tasks.Saving.PrintOptions class. Permet de spécifier des options supplémentaires lors de l'impression du projet"
type: docs
weight: 2170
url: /fr/net/aspose.tasks.saving/printoptions/
---
## PrintOptions class

Permet de spécifier des options supplémentaires lors de l'impression du projet.
...
| Nom | Description |
| --- | --- |
| [PrintOptions](printoptions/)() | Initialise une nouvelle instance de la classe `PrintOptions` qui peut être utilisée pour définir différentes options d'impression du projet. |
