...
description: Permet de spécifier des options supplémentaires lors de limpression du projet.
type: docs
weight: 1890
...
| Nom | La description |
| --- | --- |
| [PrintOptions](printoptions)() | Initialise une nouvelle instance du[`PrintOptions`](../printoptions) classe qui peut être utilisée pour définir différentes options pour imprimer le projet. |
