...
description: Permet de spécifier des options supplémentaires lors de lenregistrement du projet au format Primavera XER.
type: docs
weight: 1870
...
| Nom | La description |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions)() | Initialise une nouvelle instance du[`PrimaveraSaveOptions`](../primaverasaveoptions) classe. |
