...
description: Aspose.Tasks.Saving.PrimaveraSaveOptions classe. Permet de spécifier des options supplémentaires lors de lenregistrement du projet au format Primavera XER.
type: docs
weight: 1880
...
| Nom | La description |
| --- | --- |
| [PrimaveraSaveOptions](primaverasaveoptions/)() | Initialise une nouvelle instance du`PrimaveraSaveOptions` classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [ActivityIdIncrement](../../aspose.tasks.saving/primaverasaveoptions/activityidincrement/) { get; set; } | Obtient ou définit l'incrément utilisé dans la renumérotation des ID d'activité. |
| [ActivityIdPrefix](../../aspose.tasks.saving/primaverasaveoptions/activityidprefix/) { get; set; } | Obtient ou définit le préfixe utilisé dans la renumérotation des ID d'activité. |
| [ActivityIdSuffix](../../aspose.tasks.saving/primaverasaveoptions/activityidsuffix/) { get; set; } | Obtient ou définit le suffixe utilisé dans la renumérotation des ID d'activité. |
