...
description: Obtient ou définit la liste des numéros de pages à enregistrer lors de lenregistrement de la mise en page du projet dans des fichiers séparés. Toutes les pages seront enregistrées si cette liste est vide.
type: docs
weight: 70
