...
description: Aspose.Tasks.Saving.PdfSaveOptions classe. Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format PDF.
type: docs
weight: 1860
...
Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format PDF.
...
| Nom | La description |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | Initialise une nouvelle instance du`PdfSaveOptions`classe qui peut être utilisée pour enregistrer un document dans le[`PDF`](../savefileformat/) format. |
...
| [Compliance](../../aspose.tasks.saving/pdfsaveoptions/compliance/) { get; set; } | Obtient ou définit un niveau de conformité souhaité pour le document PDF généré. La valeur par défaut estPdf15 . |
...
| [DefaultFontName](../../aspose.tasks.saving/pdfsaveoptions/defaultfontname/) { get; set; } | Obtient ou définit la police par défaut pour le rendu. |
| [DigitalSignatureDetails](../../aspose.tasks.saving/pdfsaveoptions/digitalsignaturedetails/) { get; set; } | Obtient ou définit les détails d'une signature numérique. S'il n'est pas défini, aucune signature ne sera effectuée. |
...
| [EncryptionDetails](../../aspose.tasks.saving/pdfsaveoptions/encryptiondetails/) { get; set; } | Obtient ou définit les détails d'un chiffrement. S'il n'est pas défini, aucun chiffrement ne sera effectué. |
...
| [FontResolveCallback](../../aspose.tasks.saving/pdfsaveoptions/fontresolvecallback/) { get; set; } | Obtient ou définit un rappel qui peut être utilisé pour personnaliser les polices résolues. |
...
| [Pages](../../aspose.tasks.saving/pdfsaveoptions/pages/) { get; set; } | Obtient ou définit la liste des numéros de pages à enregistrer lors de l'enregistrement de la mise en page du projet dans des fichiers séparés. Toutes les pages seront enregistrées si cette liste est vide. |
| [PageSavingCallback](../../aspose.tasks.saving/pdfsaveoptions/pagesavingcallback/) { get; set; } | Obtient ou définit un rappel défini par l'utilisateur qui est utilisé pour obtenir un flux de sortie pour chaque page rendue. S'applique lorsque[`SaveToSeparateFiles`](./savetoseparatefiles/) l'option est utilisée. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/pdfsaveoptions/reducefootergap/) { get; set; } | Obtient ou définit une valeur indiquant si un écart entre la dernière tâche et le pied de page doit être réduit. |
...
| [TextCompression](../../aspose.tasks.saving/pdfsaveoptions/textcompression/) { get; set; } | Obtient ou définit un type de compression à utiliser pour tous les flux de contenu à l'exception des images. La valeur par défaut estFlate . |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/pdfsaveoptions/useprojectdefaultfont/) { get; set; } | Obtient ou définit une valeur indiquant si la police par défaut doit être utilisée pour le rendu. |
