...
description: Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format PDF.
type: docs
weight: 1850
...
| Nom | La description |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions)() | Initialise une nouvelle instance du[`PdfSaveOptions`](../pdfsaveoptions)classe qui peut être utilisée pour enregistrer un document dans le[`PDF`](../savefileformat) format. |
