...
description: "Propriété SaveTemplateOptions. Obtient ou définit une valeur indiquant si tous les coûts fixes d'un modèle de projet doivent être supprimés"
type: docs
weight: 40
