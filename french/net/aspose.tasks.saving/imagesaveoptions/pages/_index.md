...
description: Obtient ou définit une liste de numéros de page à enregistrer lors de lenregistrement de la mise en page du projet dans des fichiers séparés. Toutes les pages seront enregistrées si cette liste est vide.
type: docs
weight: 60
