...
description: Aspose.Tasks.Saving.ImageSaveOptions classe. Permet de spécifier des options supplémentaires lors du rendu des pages du projet en images.
type: docs
weight: 1770
...
| Nom | La description |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFileFormat) | Initialise une nouvelle instance du`ImageSaveOptions` classe qui peut être utilisée pour enregistrer les images rendues aux formats TIFF, PNG, BMP ou JPEG. |
...
| [DefaultFontName](../../aspose.tasks.saving/imagesaveoptions/defaultfontname/) { get; set; } | Obtient ou définit la police par défaut pour le rendu. |
...
| [FontResolveCallback](../../aspose.tasks.saving/imagesaveoptions/fontresolvecallback/) { get; set; } | Obtient ou définit un rappel qui peut être utilisé pour personnaliser les polices résolues. |
...
| [JpegQuality](../../aspose.tasks.saving/imagesaveoptions/jpegquality/) { get; set; } | Obtient ou définit une qualité JPEG. La plage de valeurs autorisée est 0..100. |
...
| [Pages](../../aspose.tasks.saving/imagesaveoptions/pages/) { get; set; } | Obtient ou définit une liste de numéros de page à enregistrer lors de l'enregistrement de la mise en page du projet dans des fichiers séparés. Toutes les pages seront enregistrées si cette liste est vide. |
...
| [ReduceFooterGap](../../aspose.tasks.saving/imagesaveoptions/reducefootergap/) { get; set; } | Obtient ou définit une valeur indiquant si un écart entre la dernière tâche et le pied de page doit être réduit. |
...
| [UseProjectDefaultFont](../../aspose.tasks.saving/imagesaveoptions/useprojectdefaultfont/) { get; set; } | Obtient ou définit une valeur indiquant si la police par défaut doit être utilisée pour le rendu. |
