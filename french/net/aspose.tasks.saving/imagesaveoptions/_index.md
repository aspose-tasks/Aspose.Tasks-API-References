...
description: Permet de spécifier des options supplémentaires lors du rendu des pages du projet en images.
type: docs
weight: 1760
...
| Nom | La description |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFileFormat) | Initialise une nouvelle instance du[`ImageSaveOptions`](../imagesaveoptions) classe qui peut être utilisée pour enregistrer les images rendues aux formats TIFF, PNG, BMP ou JPEG. |
