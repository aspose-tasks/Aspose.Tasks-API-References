...
description: /// Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XAML.
type: docs
weight: 1960
...
| Nom | La description |
| --- | --- |
| [XamlOptions](xamloptions)() | Initialise une nouvelle instance du[`XamlOptions`](../xamloptions) classe qui peut être utilisée pour enregistrer le projet au format XAML. |
