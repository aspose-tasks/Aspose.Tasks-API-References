...
description: Aspose.Tasks.Saving.XamlOptions classe. /// Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XAML.
type: docs
weight: 1970
...
/// Permet de spécifier des options supplémentaires lors du rendu des pages de projet en XAML.
...
| Nom | La description |
| --- | --- |
| [XamlOptions](xamloptions/)() | Initialise une nouvelle instance du`XamlOptions` classe qui peut être utilisée pour enregistrer le projet au format XAML. |
