...
description: Aspose.Tasks.Saving.PrimaveraXmlSaveOptions classe. Permet de spécifier des options supplémentaires lors de lenregistrement du projet au format Primavera xml.
type: docs
weight: 1890
...
| Nom | La description |
| --- | --- |
| [PrimaveraXmlSaveOptions](primaveraxmlsaveoptions/)() | Initialise une nouvelle instance du`PrimaveraXmlSaveOptions` classe. |
