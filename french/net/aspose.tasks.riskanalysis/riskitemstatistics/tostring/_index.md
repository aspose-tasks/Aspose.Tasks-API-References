...
description: Renvoie la représentation sous forme de chaîne courte dun élément de risque. Les détails exacts de la représentation ne sont pas spécifiés et peuvent être modifiés.
type: docs
weight: 70
