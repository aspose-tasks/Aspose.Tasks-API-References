...
description: "Méthode RiskItemStatistics. Obtient une valeur en dessous de laquelle un pourcentage spécifié d’échantillons générés se situe"
type: docs
weight: 60
...
Obtient une valeur en dessous de laquelle un pourcentage spécifié d'échantillons générés se situe.
...
| --- | --- | --- |
| pourcentage | Int32 | le pourcentage spécifié entre 0 et 100. |

### Valeur de retour

une valeur en dessous de laquelle un pourcentage spécifié d’échantillons générés se situe.
