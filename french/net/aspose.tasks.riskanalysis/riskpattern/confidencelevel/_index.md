...
description: "Propriété RiskPattern. Obtient ou définit le niveau de confiance qui correspond au pourcentage du temps où les valeurs réellement générées seront comprises entre les estimations optimistes et pessimistes. La valeur par défaut est CL99"
type: docs
weight: 20
...
Obtient ou définit le niveau de confiance qui correspond au pourcentage du temps où les valeurs réellement générées seront comprises entre les estimations optimistes et pessimistes. La valeur par défaut est CL99.
...
Peut être l'une des valeurs définies dans l'énumération `ConfidenceLevel`.
