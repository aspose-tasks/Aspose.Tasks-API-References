...
description: "Constructeur RiskPattern. Initialise une nouvelle instance de la classe RiskPattern"
type: docs
weight: 10
...
Initialise une nouvelle instance de la classe [`RiskPattern`](../).
...
| --- | --- | --- |
| tâche | Tâche | la tâche de projet spécifiée pour laquelle ce risque sera appliqué dans la simulation Monte Carlo. |
