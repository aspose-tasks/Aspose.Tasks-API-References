...
description: Obtient ou définit le pourcentage de la durée de tâche la plus probable qui peut se produire dans le meilleur scénario de projet possible. La valeur par défaut est 75 ce qui signifie que si la durée estimée de la tâche spécifiée est de 4 jours la durée optimiste sera de 3 jours.
type: docs
weight: 40
