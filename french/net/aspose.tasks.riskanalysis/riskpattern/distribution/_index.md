...
description: "Propriété RiskPattern. Obtient ou définit la distribution de probabilité utilisée dans la simulation Monte Carlo. La valeur par défaut est ProbabilityDistributionType.Normal"
type: docs
weight: 30
...
Peut être l'une des valeurs définies dans l'énumération [`ProbabilityDistributionType`](../../probabilitydistributiontype/).
