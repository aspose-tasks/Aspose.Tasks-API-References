...
description: "Propriété RiskAnalysisSettings. Obtient ou définit le nombre d’itérations à utiliser dans la simulation de Monte Carlo. La valeur par défaut est 100"
type: docs
weight: 20
