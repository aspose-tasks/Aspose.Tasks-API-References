...
description: "Méthode RiskAnalyzer. Effectue une analyse des risques pour le projet spécifié. L'analyse est basée sur une simulation Monte Carlo et le résultat est une instance de la classe RiskAnalysisResult."
type: docs
weight: 30
...
Effectue une analyse des risques pour le projet spécifié. L'analyse est basée sur une simulation Monte Carlo et le résultat est une instance de la classe [`RiskAnalysisResult`](../../riskanalysisresult/).
...
| --- | --- | --- |
| project | Project | l'instance spécifiée de la classe [`Project`](../../../aspose.tasks/project/) à analyser. |

### Valeur de retour

l'instance de la classe [`RiskAnalysisResult`](../../riskanalysisresult/) qui représente le résultat de l'analyse.
