...
description: "Propriété RiskAnalyzer. Obtient ou définit l'instance de la classe RiskAnalysisSettings qui définit les paramètres nécessaires pour l'analyse des risques"
type: docs
weight: 20
...
Obtient ou définit l'instance de la classe [`RiskAnalysisSettings`](../../riskanalysissettings/) qui définit les paramètres nécessaires pour l'analyse des risques.
