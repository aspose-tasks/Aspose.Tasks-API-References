...
description: "RiskPatternCollection méthode. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 90
...
| --- | --- | --- |
| élément | RiskPattern | l'objet spécifié à supprimer. |
