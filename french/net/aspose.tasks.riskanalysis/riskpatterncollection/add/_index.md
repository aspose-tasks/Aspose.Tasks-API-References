...
description: "RiskPatternCollection méthode. Ajoute une instance de la classe RiskPattern à cette collection"
type: docs
weight: 40
...
Ajoute une instance de la classe [`RiskPattern`](../../riskpattern/) à cette collection.
...
| --- | --- | --- |
| item | RiskPattern | une instance de la classe [`RiskPattern`](../../riskpattern/) à ajouter à cette collection. |

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentNullException | *item* task est nul. |
