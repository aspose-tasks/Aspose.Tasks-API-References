...
description: "Méthode RiskAnalysisResult. Retourne une instance de la collection RiskItemStatisticsCollection pour le type de risque spécifié."
type: docs
weight: 10
...
Renvoie une instance de la [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) pour le type de risque spécifié.
...
| --- | --- | --- |
| itemType | RiskItemType | le type de risque spécifié ; peut être l’une des valeurs de l’énumération [`RiskItemType`](../../riskitemtype/) |

### Valeur de retour

une instance de la [`RiskItemStatisticsCollection`](../../riskitemstatisticscollection/) pour le type de risque spécifié.
