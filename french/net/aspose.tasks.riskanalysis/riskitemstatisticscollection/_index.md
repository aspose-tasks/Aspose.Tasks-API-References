---
title: "Classe RiskItemStatisticsCollection"
second_title: "Référence de l'API Aspose.Tasks for .NET"
description: "Aspose.Tasks.RiskAnalysis.RiskItemStatisticsCollection class. Représente une collection contenant les instances de la classe RiskItemStatistics"
type: docs
weight: 1910
...
Représente une collection contenant les instances de la classe [`RiskItemStatistics`](../riskitemstatistics/).
...
| Nom | Description |
| --- | --- |
| [Get](../../aspose.tasks.riskanalysis/riskitemstatisticscollection/get/)(Task) | Renvoie une instance de la classe [`RiskItemStatistics`](../riskitemstatistics/) contenue dans cette collection et associée à l'objet Task spécifié ; null si l'élément n'est pas trouvé. |
...
Montre comment travailler avec une collection de statistiques de risque.
...
// itérer sur tous les éléments statistiques
...
// ou obtenir des statistiques spécifiques
