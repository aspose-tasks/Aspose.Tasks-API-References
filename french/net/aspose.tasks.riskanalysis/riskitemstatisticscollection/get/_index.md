...
description: "RiskItemStatisticsCollection méthode. Retourne une instance de la classe RiskItemStatistics contenue dans cette collection et associée à l'objet Task spécifié, null si l'élément n'est pas trouvé."
type: docs
weight: 10
...
Retourne une instance de la classe [`RiskItemStatistics`](../../riskitemstatistics/) contenue dans cette collection et associée à l'objet Task spécifié ; null si l'élément n'est pas trouvé.
...
| --- | --- | --- |
| task | Task | l'instance spécifiée de la classe [`Task`](../../../aspose.tasks/task/). |

### Valeur de retour

élément de risque associé à l'objet task spécifié s'il est trouvé ; null sinon.
