---
title: "Énum LinePattern"
second_title: "Référence de l'API Aspose.Tasks for .NET"
description: "Aspose.Tasks.Visualization.LinePattern enum. Modèle de ligne"
type: docs
weight: 3190
...
| --- | --- | --- |
| None | `0` | Indique qu'aucune ligne ne sera affichée. |
| Solid | `1` | Indique un motif de ligne plein. |
| CloseDot | `3` | Indique un motif de ligne à points rapprochés. |
| Dotted | `4` | Indique un motif de ligne pointillée. |
| Dashed | `2` | Indique un motif de ligne en tirets. |
