...
description: "Propriété PageViewSettings. Obtient ou définit une valeur indiquant s'il faut ajuster l'échelle de temps jusqu'à la fin d'une page lors de l'impression"
type: docs
weight: 30
