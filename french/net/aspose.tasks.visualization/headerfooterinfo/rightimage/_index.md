...
description: "Propriété HeaderFooterInfo. Obtient ou définit l'image alignée à droite à afficher dans l'élément parent"
type: docs
weight: 80
...
Obtient ou définit l'image alignée à droite à afficher dans l'élément parent.
