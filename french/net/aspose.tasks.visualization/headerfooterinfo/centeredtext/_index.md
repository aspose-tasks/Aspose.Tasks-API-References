...
description: "Propriété HeaderFooterInfo. Obtient ou définit le texte centré à afficher dans l'élément parent"
type: docs
weight: 40
...
Obtient ou définit le texte centré à afficher dans l'élément parent.
