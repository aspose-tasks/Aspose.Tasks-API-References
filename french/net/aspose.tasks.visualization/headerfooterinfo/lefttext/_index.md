...
description: "Propriété HeaderFooterInfo. Obtient ou définit le texte aligné à gauche à afficher dans l'élément parent"
type: docs
weight: 70
...
Obtient ou définit le texte aligné à gauche à afficher dans l'élément parent.
