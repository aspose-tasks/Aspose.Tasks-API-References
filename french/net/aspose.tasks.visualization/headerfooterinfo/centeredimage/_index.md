...
description: "Propriété HeaderFooterInfo. Obtient ou définit l'image centrée à afficher dans l'élément parent"
type: docs
weight: 20
...
Obtient ou définit l'image centrée à afficher dans l'élément parent.
