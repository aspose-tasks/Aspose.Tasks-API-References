...
description: "Propriété HeaderFooterInfo. Obtient ou définit l'image alignée à gauche à afficher dans l'élément parent"
type: docs
weight: 50
...
Obtient ou définit l'image alignée à gauche à afficher dans l'élément parent.
