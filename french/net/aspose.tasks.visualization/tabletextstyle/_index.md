...
| Nom | La description |
| --- | --- |
| [TableTextStyle](tabletextstyle#constructor)(int) | Initialise une nouvelle instance du[`TableTextStyle`](../tabletextstyle) classe. |
| [TableTextStyle](tabletextstyle#constructor_1)(int, FontDescriptor) | Initialise une nouvelle instance du[`TableTextStyle`](../tabletextstyle) classe avec la police spécifiée. |
| [TableTextStyle](tabletextstyle#constructor_2)(int, FontStyles) | Initialise une nouvelle instance du[`TableTextStyle`](../tabletextstyle) classe avec les paramètres de police par défaut et le style de police spécifié. |
| [TableTextStyle](tabletextstyle#constructor_3)(int, float, FontStyles) | Initialise une nouvelle instance du[`TableTextStyle`](../tabletextstyle) classe avec la taille de police et le style de police spécifiés. |
