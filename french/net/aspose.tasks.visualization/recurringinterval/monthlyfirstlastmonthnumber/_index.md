...
description: "Propriété RecurringInterval. Obtient ou définit le numéro du mois des lignes de progression affichées par le premier ou le dernier jour prédéfini"
type: docs
weight: 100
...
Obtient ou définit le numéro du mois des lignes de progression, qui sont affichées par le premier ou le dernier jour prédéfini.
