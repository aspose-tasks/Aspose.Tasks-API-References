...
description: "Propriété RecurringInterval. Obtient ou définit une valeur indiquant s'il faut afficher les lignes de progression par le premier ou le dernier jour prédéfini"
type: docs
weight: 80
...
Obtient ou définit une valeur indiquant s'il faut afficher les lignes de progression par le premier ou le dernier jour prédéfini.
