...
description: Inclut lUID le nom de la ressource le type létiquette du matériau les initiales le groupe les unités maximales le taux standard  le taux des heures supplémentaires le coût par utilisation laccumulation le calendrier de base et les colonnes de ressource de code.
type: docs
weight: 40
