...
description: Forme dun marqueur au début ou à la fin du style de barre à rendre lors de lenregistrement des données de vue dans certains deSaveFileFormat../aspose.tasks.saving/savefileformat .
type: docs
weight: 2990
