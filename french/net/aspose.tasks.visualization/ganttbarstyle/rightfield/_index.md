...
description: "Propriété GanttBarStyle. Obtient ou définit les données à afficher à droite de la barre. Field"
type: docs
weight: 180
url: /fr/net/aspose.tasks.visualization/ganttbarstyle/rightfield/
---
## GanttBarStyle.RightField property

Obtient ou définit les données à afficher à droite de la barre. [`Field`](../../../aspose.tasks/field/).
