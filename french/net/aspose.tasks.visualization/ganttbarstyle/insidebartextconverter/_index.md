...
description: "Propriété GanttBarStyle. Obtient ou définit un convertisseur défini par l'utilisateur pour obtenir le texte à rendre à l'intérieur de la barre des tâches. Remplace la valeur de la propriété InsideField"
type: docs
weight: 80
...
Obtient ou définit un convertisseur défini par l'utilisateur pour obtenir le texte à rendre à l'intérieur de la barre de la tâche. Remplace la valeur de la propriété [`InsideField`](../insidefield/).
