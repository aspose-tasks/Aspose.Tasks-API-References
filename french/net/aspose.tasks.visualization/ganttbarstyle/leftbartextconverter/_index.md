...
description: "Propriété GanttBarStyle. Obtient ou définit un convertisseur défini par l'utilisateur pour obtenir le texte à afficher à gauche de la barre des tâches. Remplace la valeur de la propriété LeftField. N'est pas conservé dans le format MPP"
type: docs
weight: 100
...
Obtient ou définit un convertisseur défini par l'utilisateur pour obtenir le texte à afficher à gauche de la barre de la tâche. Remplace la valeur de la propriété [`LeftField`](../leftfield/). N'est pas conservé dans le format MPP.
