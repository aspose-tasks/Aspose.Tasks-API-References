...
description: "Propriété GanttBarStyle. Obtient ou définit un type de forme de fin. GanttBarType"
type: docs
weight: 60
...
Obtient ou définit un type de forme de fin. [`GanttBarType`](../../ganttbartype/).
