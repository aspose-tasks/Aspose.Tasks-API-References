...
description: "Propriété GanttBarStyle. Obtient ou définit un numéro de ligne. Peut être de 1 à 4, 1 étant la valeur par défaut"
type: docs
weight: 190
...
Obtient ou définit un numéro de ligne.  Peut être de 1 à 4 (1 est la valeur par défaut).
