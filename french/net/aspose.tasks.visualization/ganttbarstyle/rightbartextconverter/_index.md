...
description: "Propriété GanttBarStyle. Obtient ou définit le convertisseur défini par l'utilisateur pour obtenir le texte à afficher à droite de la barre des tâches. Remplace la valeur de la propriété RightField."
type: docs
weight: 170
...
Obtient ou définit le convertisseur défini par l'utilisateur pour obtenir le texte à afficher à droite de la barre de la tâche. Remplace la valeur de la propriété [`RightField`](../rightfield/).
