---
title: "Enumération GanttBarType"
second_title: "Référence de l'API Aspose.Tasks for .NET"
description: "Aspose.Tasks.Visualization.GanttBarType enum. Spécifie le type de barre"
type: docs
weight: 3080
...
| --- | --- | --- |
| Dashed | `2` | Indique le type de barre Gantt en pointillé. |
| Framed | `1` | Indique le type de barre Gantt encadrée. |
| Solid | `0` | Indique le type de barre Gantt solide. |
