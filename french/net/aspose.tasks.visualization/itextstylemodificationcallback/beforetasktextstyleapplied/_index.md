...
description: "Méthode ITextStyleModificationCallback. La méthode à appeler avant le rendu d’une cellule de tableau pour une ligne de tâche dans les vues suivantes : Gantt Chart, Task Sheet, Task Usage"
type: docs
weight: 10
url: /fr/net/aspose.tasks.visualization/itextstylemodificationcallback/beforetasktextstyleapplied/
---
...
| --- | --- | --- |
| args | TaskTextStyleEventArgs | L’objet [`TaskTextStyleEventArgs`](../../tasktextstyleeventargs/). |
