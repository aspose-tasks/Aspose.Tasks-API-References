...
description: Initialise une nouvelle instance de la classe GanttChartColumn.
type: docs
weight: 10
...
| converter | TaskToColumnTextConverter | Convertisseur de données de tâche en texte de colonne. |
