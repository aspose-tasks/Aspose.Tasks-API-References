...
description: "BarStyle propriété. Obtient ou définit le convertisseur défini par l'utilisateur pour obtenir le texte à afficher à gauche de la barre des tâches. Remplace la valeur de la propriété LeftField"
type: docs
weight: 130
...
Obtient ou définit le convertisseur défini par l'utilisateur pour obtenir le texte à afficher à gauche de la barre de la tâche. Remplace la valeur de la propriété [`LeftField`](../leftfield/).
