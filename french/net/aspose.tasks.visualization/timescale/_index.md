...
description: Définit les options qui spécifient comment rendre léchelle de temps dans les vues Diagramme de Gantt Utilisation des tâches ou Utilisation des ressources lorsque le projet est exporté vers un format graphique.
type: docs
weight: 3060
