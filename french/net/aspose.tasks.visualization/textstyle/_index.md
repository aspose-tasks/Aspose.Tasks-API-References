...
description: Modifier le style visuel du texte dun élément dans la vue du projet.
type: docs
weight: 3050
...
| Nom | La description |
| --- | --- |
| [TextStyle](textstyle#constructor)() | Initialise une nouvelle instance du[`TextStyle`](../textstyle)classe avec les paramètres par défaut. |
| [TextStyle](textstyle#constructor_1)(FontDescriptor) | Initialise une nouvelle instance du[`TextStyle`](../textstyle) classe avec les paramètres de police spécifiés. |
| [TextStyle](textstyle#constructor_2)(FontStyles) | Initialise une nouvelle instance du[`TextStyle`](../textstyle) classe avec la police par défaut et le style de police spécifié. |
| [TextStyle](textstyle#constructor_3)(float, FontStyles) | Initialise une nouvelle instance du[`TextStyle`](../textstyle) classe avec la police par défaut et la taille et le style de police spécifiés. |
