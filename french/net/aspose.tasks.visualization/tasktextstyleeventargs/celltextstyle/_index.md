...
description: "Propriété TaskTextStyleEventArgs. Obtient ou définit TextStyle qui sera utilisé pour dessiner le contenu des cellules. Cet objet peut être utilisé pour personnaliser l’apparence d’une cellule de tableau."
type: docs
weight: 10
