...
description: "Propriété ProgressLines. Obtient ou définit une valeur indiquant s'il faut afficher les lignes de progression pour le plan de référence ou réel"
type: docs
weight: 90
...
Obtient ou définit une valeur indiquant s’il faut afficher les lignes de progression pour le plan de référence ou réel.
