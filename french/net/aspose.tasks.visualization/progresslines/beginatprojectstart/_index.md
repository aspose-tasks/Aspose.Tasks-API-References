...
description: "Propriété ProgressLines. Obtient ou définit une valeur indiquant s’il faut afficher les lignes de progression depuis le début de la date de début du projet"
type: docs
weight: 30
...
Obtient ou définit une valeur indiquant s’il faut afficher les lignes de progression depuis le début de la date de début du projet.
