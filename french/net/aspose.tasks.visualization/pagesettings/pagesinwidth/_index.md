...
description: "Propriété PageSettings. Obtient ou définit un nombre de pages en largeur à imprimer"
type: docs
weight: 60
...
Obtient ou définit le nombre de pages en largeur à imprimer.
