...
description: "Propriété TimescaleTier. Obtient ou définit une fonction de rappel pour gérer le rendu du repère de date dans ce niveau."
type: docs
weight: 40
...
Obtient ou définit le libellé de date [`DateLabel`](../datelabel/) pour le niveau de l'échelle de temps.
