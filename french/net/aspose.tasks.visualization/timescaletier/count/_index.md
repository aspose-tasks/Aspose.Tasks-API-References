...
description: "Propriété TimescaleTier. Obtient ou définit l'intervalle d'unité de temps dans lequel afficher les libellés pour le niveau. La valeur par défaut est 1"
type: docs
weight: 30
...
Obtient ou définit une fonction de rappel pour gérer le rendu du repère de date dans ce niveau.
