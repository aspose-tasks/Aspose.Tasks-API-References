...
description: "Propriété TimescaleTier. Obtient ou définit le libellé de date DateLabel pour le niveau d'échelle de temps."
type: docs
weight: 50
...
Obtient ou définit le libellé de date [`DateLabel`](../../datelabel/) pour le niveau d'échelle de temps.
