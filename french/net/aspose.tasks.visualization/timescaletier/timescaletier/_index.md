...
description: "Constructeur TimescaleTier. Initialise une nouvelle instance de la classe TimescaleTier"
type: docs
weight: 10
...
Initialise une nouvelle instance de la classe [`TimescaleTier`](../).
...
| count | Int32 | Le nombre d'unités [`TimescaleUnit`](../../timescaleunit/). |
