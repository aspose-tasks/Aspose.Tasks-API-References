...
description: "Propriété TimescaleTier. Obtient ou définit une valeur indiquant s'il faut afficher les marques de graduation qui séparent les périodes de temps dans le niveau"
type: docs
weight: 70
...
Obtient ou définit l'unité d'échelle de temps [`TimescaleUnit`](../timescaleunit/) pour le niveau de l'échelle de temps. La valeur par défaut est [`Days`](../timescaleunit/).
