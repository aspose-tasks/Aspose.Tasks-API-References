...
description: "Constructeur PageInfo. Initialise une nouvelle instance de la classe PageInfo. Représente les données de configuration de page présentes dans le format de fichier MPP et utilisées pour l’impression"
type: docs
weight: 10
...
Initialise une nouvelle instance de la classe [`PageInfo`](../). Représente les données de configuration de page présentes dans le format de fichier MPP et utilisées pour l’impression.
