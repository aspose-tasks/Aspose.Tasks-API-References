...
description: Représente les données de mise en page qui sont présentes dans le format de fichier MPP et utilisées pour limpression.
type: docs
weight: 2840
...
| Nom | La description |
| --- | --- |
| [PageInfo](pageinfo)() | Initialise une nouvelle instance du[`PageInfo`](../pageinfo) classer. Représente les données de mise en page qui sont présentes dans le format de fichier MPP et utilisées pour l'impression. |
