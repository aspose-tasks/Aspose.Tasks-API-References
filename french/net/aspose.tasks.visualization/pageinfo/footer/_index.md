...
description: "Propriété PageInfo. Obtient ou définit une instance de la classe HeaderFooterInfo qui représente les données du pied de page"
type: docs
weight: 20
...
Obtient ou définit une instance de la classe [`HeaderFooterInfo`](../../headerfooterinfo/) qui représente les données du pied de page.
