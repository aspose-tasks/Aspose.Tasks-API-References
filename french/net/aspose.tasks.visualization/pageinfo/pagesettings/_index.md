...
description: "Propriété PageInfo. Obtient une instance de la classe PageSettings qui spécifie les paramètres d’impression de la page"
type: docs
weight: 70
...
Obtient une instance de la classe `PageSettings` qui spécifie les paramètres d’impression de la page.
