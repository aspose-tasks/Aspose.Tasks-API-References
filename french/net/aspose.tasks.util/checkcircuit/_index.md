...
description: Vérifie un arbre de tâches sil contient un circuit.
type: docs
weight: 2340
...
| Nom | La description |
| --- | --- |
| [CheckCircuit](checkcircuit)() | Initialise une nouvelle instance du[`CheckCircuit`](../checkcircuit) classe. |
