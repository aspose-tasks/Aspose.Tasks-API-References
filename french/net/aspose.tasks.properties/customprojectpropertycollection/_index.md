...
description: Représente une collection de propriétés de projet personnalisées.
type: docs
weight: 1290
...
| Nom | La description |
| --- | --- |
| [CustomProjectPropertyCollection](customprojectpropertycollection)() | Initialise une nouvelle instance du[`CustomProjectPropertyCollection`](../customprojectpropertycollection) classer. |
...
| override [IsReadOnly](../../aspose.tasks.properties/customprojectpropertycollection/isreadonly) { get; } | Obtient une valeur indiquant si cette collection est en lecture seule ; sinon, faux. |
...
| [Clear](../../aspose.tasks.properties/customprojectpropertycollection/clear)() | Efface la PropertyCollection. |
| [Contains](../../aspose.tasks.properties/propertykeyedcollection`1/contains)(string) |  |
| [Remove](../../aspose.tasks.properties/customprojectpropertycollection/remove)(string) | Supprime une propriété portant le nom spécifié de la collection. |
