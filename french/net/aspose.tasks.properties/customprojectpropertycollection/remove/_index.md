...
description: "Méthode CustomProjectPropertyCollection. Supprime une propriété avec le nom spécifié de la collection"
type: docs
weight: 50
...
| --- | --- | --- |
| name | Chaîne | Le nom de la propriété, insensible à la casse. |

### Valeur de retour

True si l'élément est trouvé et supprimé avec succès ; sinon, false.
