...
description: "Méthode PropertyKeyedCollection. Détermine si le PropertyCollection contient une propriété avec le nom spécifié"
type: docs
weight: 60
...
| --- | --- | --- |
| name | Chaîne | Le nom d'une propriété |

### Valeur de retour

true si le [`PropertyCollection`](../../propertycollection-1/) contient une propriété avec le nom spécifié ; sinon, false.
