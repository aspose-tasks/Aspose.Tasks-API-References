...
description: Représente une collection de propriétés de projet intégrées.
type: docs
weight: 1270
...
| [Company](../../aspose.tasks.properties/builtinprojectpropertycollection/company) { get; set; } | Obtient ou définit la société d'un projet. |
...
| override [IsReadOnly](../../aspose.tasks.properties/builtinprojectpropertycollection/isreadonly) { get; } | Obtient une valeur indiquant si cette collection est en lecture seule ; sinon, faux. |
...
| [Manager](../../aspose.tasks.properties/builtinprojectpropertycollection/manager) { get; set; } | Obtient ou définit le gestionnaire d'un projet. |
