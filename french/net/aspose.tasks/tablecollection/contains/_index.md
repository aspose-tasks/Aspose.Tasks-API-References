...
description: "Méthode TableCollection. Retourne true si l'élément spécifié est trouvé dans cette collection, sinon false"
type: docs
weight: 50
url: /fr/net/aspose.tasks/tablecollection/contains/
---
...
| --- | --- | --- |
| élément | Table | l'élément spécifié à trouver. |
