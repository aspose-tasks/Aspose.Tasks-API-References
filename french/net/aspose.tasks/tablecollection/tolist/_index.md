...
description: "Méthode TableCollection. Convertit une collection de tables en une liste d'objets Table"
type: docs
weight: 90
...
Convertit une collection de tables en une liste d'objets [`Table`](../../table/).
...
Liste générique d'objets [`Table`](../../table/).
