...
description: "Méthode TableCollection. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 80
...
| --- | --- | --- |
| élément | Table | l'objet spécifié à supprimer. |
