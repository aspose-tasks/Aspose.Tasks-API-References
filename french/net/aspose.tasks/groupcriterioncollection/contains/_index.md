...
description: "méthode GroupCriterionCollection. Retourne vrai si l'élément spécifié est trouvé dans cette collection, sinon faux"
type: docs
weight: 50
...
| --- | --- | --- |
| élément | GroupCriterion | l'élément spécifié à trouver. |
