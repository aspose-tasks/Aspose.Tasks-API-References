...
description: Aspose.Tasks.View classe. Représente une vue dans Project.
type: docs
weight: 2560
...
| Nom | La description |
| --- | --- |
| [View](view/#constructor)() | Initialise une nouvelle instance du`View` classe. |
| [View](view/#constructor_1)(ViewScreen) | Initialise une nouvelle instance du`View` classe. |
...
| [PageInfo](../../aspose.tasks/view/pageinfo/) { get; } | Obtient une instance de[`PageInfo`](./pageinfo/)classe. Représente les données de configuration de page qui sont présentes au format de fichier mpp. |
