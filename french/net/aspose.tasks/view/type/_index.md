...
description: "Propriété View. Obtient le type d'élément dans la vue unique, tel que les tâches ou les ressources. Lecture seule ItemType"
type: docs
weight: 110
...
Obtient le type d'élément dans la vue unique, tel que les tâches ou les ressources. Lecture seule [`ItemType`](../../itemtype/).
