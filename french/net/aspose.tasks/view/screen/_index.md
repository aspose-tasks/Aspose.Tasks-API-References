...
description: "Propriété View. Obtient le type d’écran pour la vue unique. ViewScreen en lecture seule."
type: docs
weight: 80
...
Obtient le type d’écran pour la vue unique. En lecture seule [`ViewScreen`](../../viewscreen/).
