...
description: "Baseline property. Obtient ou définit le numéro unique d'un enregistrement de données de ligne de base"
type: docs
weight: 20
...
Obtient ou définit le numéro unique d'un enregistrement de données de ligne de base.
