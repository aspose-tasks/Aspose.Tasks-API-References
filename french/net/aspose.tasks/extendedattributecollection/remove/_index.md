...
description: "Méthode ExtendedAttributeCollection. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 110
url: /fr/net/aspose.tasks/extendedattributecollection/remove/
---
...
| --- | --- | --- |
| élément | ExtendedAttribute | l'objet spécifié à supprimer. |
