...
description: "Méthode ExtendedAttributeCollection. Retourne vrai si l'élément spécifié est trouvé dans cette collection, sinon faux"
type: docs
weight: 60
...
| --- | --- | --- |
| élément | ExtendedAttribute | l'élément spécifié à trouver. |
