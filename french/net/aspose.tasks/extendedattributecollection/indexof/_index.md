...
description: "Méthode ExtendedAttributeCollection. Détermine l'index de l'élément spécifié dans cette collection"
type: docs
weight: 90
...
| --- | --- | --- |
| élément | ExtendedAttribute | l'élément spécifié à localiser dans cette collection. |
