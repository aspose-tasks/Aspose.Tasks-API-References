...
description: "Méthode ExtendedAttributeCollection. Copie les éléments de cette collection dans le tableau spécifié en commençant à l'index de tableau spécifié"
type: docs
weight: 70
url: /fr/net/aspose.tasks/extendedattributecollection/copyto/
---
...
| --- | --- | --- |
| tableau | ExtendedAttribute[] | le tableau unidimensionnel spécifié dans lequel copier les éléments |
