...
description: "OutlineMaskCollection méthode. Retourne true si l'élément spécifié est trouvé dans cette collection, sinon false"
type: docs
weight: 60
...
| --- | --- | --- |
| élément | OutlineMask | l'élément spécifié à trouver. |
