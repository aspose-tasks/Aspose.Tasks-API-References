...
description: "OutlineMaskCollection method. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 40
...
| --- | --- | --- |
| élément | OutlineMask | l'élément spécifié à ajouter à cette collection. |
