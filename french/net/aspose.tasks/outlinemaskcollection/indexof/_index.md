...
description: "OutlineMaskCollection méthode. Détermine l'index de l'élément spécifié dans cette collection"
type: docs
weight: 90
...
| --- | --- | --- |
| élément | OutlineMask | l'élément spécifié à localiser dans cette collection. |
