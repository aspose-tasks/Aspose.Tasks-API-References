...
description: Cette classe représente un ensemble de données liées à lenregistrement dun fichier CSS externe qui se produit lors de la conversion au format HTML.
type: docs
weight: 350
...
| Nom | La description |
| --- | --- |
| [CssSavingArgs](csssavingargs)() | Initialise une nouvelle instance du[`CssSavingArgs`](../csssavingargs) classe. |
