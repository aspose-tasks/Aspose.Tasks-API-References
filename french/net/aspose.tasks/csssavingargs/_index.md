...
description: "Classe Aspose.Tasks.CssSavingArgs. Cette classe représente un ensemble de données liées à l'enregistrement de fichiers CSS externes qui se produit lors de la conversion au format HTML."
type: docs
weight: 360
...
| Nom | Description |
| --- | --- |
| [CssSavingArgs](csssavingargs/)() | Initialise une nouvelle instance de la classe `CssSavingArgs`. |
...
Montre comment spécifier les arguments d'enregistrement CSS.
