...
description: "méthode FilterCollection. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 80
...
| --- | --- | --- |
| élément | Filter | l'objet spécifié à supprimer. |
