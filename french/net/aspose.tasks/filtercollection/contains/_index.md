...
description: "méthode FilterCollection. Retourne vrai si l'élément spécifié est trouvé dans cette collection, sinon faux"
type: docs
weight: 50
...
| --- | --- | --- |
| élément | Filter | l'élément spécifié à trouver. |
