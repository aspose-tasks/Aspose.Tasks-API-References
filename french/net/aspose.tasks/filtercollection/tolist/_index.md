...
description: "méthode FilterCollection. Convertit une collection de filtres en une liste d'objets Filter"
type: docs
weight: 90
...
Convertit une collection de filtres en une liste d'objets [`Filter`](../../filter/).
...
Liste générique d'objets [`Filter`](../../filter/).
