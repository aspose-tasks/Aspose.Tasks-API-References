...
description: "Méthode WorkWeekCollection. Convertit l'objet WorkWeekCollection en une liste d'objets WorkWeek"
type: docs
weight: 60
...
Convertit l'objet WorkWeekCollection en une liste d'objets [`WorkWeek`](../../workweek/).
...
Liste d'objets [`WorkWeek`](../../workweek/).
