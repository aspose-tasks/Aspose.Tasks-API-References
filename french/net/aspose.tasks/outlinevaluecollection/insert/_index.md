...
description: "OutlineValueCollection méthode. Insère l'élément spécifié à l'index spécifié"
type: docs
weight: 100
...
| élément | OutlineValue | l'élément spécifié à insérer dans cette collection. |
