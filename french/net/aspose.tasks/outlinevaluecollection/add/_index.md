...
description: "OutlineValueCollection méthode. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 40
...
| --- | --- | --- |
| élément | OutlineValue | l'élément spécifié à ajouter à cette collection. |
