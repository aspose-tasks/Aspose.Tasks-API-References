...
description: "OutlineValueCollection méthode. Retourne true si l'élément spécifié est trouvé dans cette collection sinon false"
type: docs
weight: 60
url: /fr/net/aspose.tasks/outlinevaluecollection/contains/
---
...
| --- | --- | --- |
| élément | OutlineValue | l'élément spécifié à trouver. |
