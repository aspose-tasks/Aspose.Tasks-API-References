...
description: "OutlineValueCollection méthode. Copie les éléments de cette collection dans le tableau spécifié en commençant à l'index de tableau spécifié"
type: docs
weight: 70
...
| --- | --- | --- |
| tableau | OutlineValue[] | le tableau unidimensionnel spécifié dans lequel copier les éléments |
