...
description: "OutlineValueCollection méthode. Détermine l'index de l'élément spécifié dans cette collection"
type: docs
weight: 90
...
| --- | --- | --- |
| élément | OutlineValue | l'élément spécifié à localiser dans cette collection. |
