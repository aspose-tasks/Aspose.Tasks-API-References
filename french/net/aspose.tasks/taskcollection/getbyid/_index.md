...
description: "Méthode TaskCollection. Renvoie une tâche avec l'Id spécifié dont l'ancêtre est la tâche parent de cette collection"
type: docs
weight: 70
url: /fr/net/aspose.tasks/taskcollection/getbyid/
---
...
| --- | --- | --- |
| id | Int32 | Identifiant TaskEntity |

### Valeur de retour

renvoie l'instance de la classe [`Task`](../../task/) avec l'identifiant spécifié dont l'ancêtre est la tâche parente de cette collection.
