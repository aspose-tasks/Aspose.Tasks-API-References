...
description: "Méthode TaskCollection. Convertit l'objet TaskCollection en une liste d'objets Task"
type: docs
weight: 120
url: /fr/net/aspose.tasks/taskcollection/tolist/
---
## TaskCollection.ToList method

Convertit l'objet TaskCollection en une liste d'objets [`Task`](../../task/).
...
renvoie une liste contenant les instances de la classe [`Task`](../../task/) de cette collection.
