...
description: "Méthode TaskCollection. Renvoie une tâche avec l'Uid spécifié dont l'ancêtre est la tâche parent de cette collection"
type: docs
weight: 80
...
| --- | --- | --- |
| uid | Int32 | Uid de TaskEntity. |

### Valeur de retour

renvoie l'instance de la classe [`Task`](../../task/) avec l'uid spécifié dont l'ancêtre est la tâche parent de cette collection.
