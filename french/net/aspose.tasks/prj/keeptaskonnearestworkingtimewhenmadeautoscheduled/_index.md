...
description: Détermine si les tâches manuelles doivent être conservées à lheure de travail la plus proche lorsquelles sont planifiées automatiquement.
type: docs
weight: 390
...
Détermine si les tâches manuelles doivent être conservées à l'heure de travail la plus proche lorsqu'elles sont planifiées automatiquement.
