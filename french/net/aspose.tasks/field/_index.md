...
| ResourceBaseline1Finish | `205521245` | Représente le champ Fin planifiée1 (Ressource). |
...
| ResourceBaseline7Start | `205521304` | Représente le champ Baseline7 Start (ressource). |
...
| ResourceCost6 | `205521064` | Représente le champ Coût6 (Ressource). |
...
| ResourceEnterpriseCost10 | `205521351` | Représente le champ Enterprise Cost10 (ressource). |
...
| ResourceEnterpriseDate8 | `205521359` | Représente le champ Entreprise Date8 (Ressource). |
...
| ResourceEnterpriseMultiValue21 | `205521598` | Représente le champ Enterprise MultiValue21 (ressource). |
...
| ResourceEnterpriseNumber34 | `205521475` | Représente le champ Enterprise Number34 (ressource). |
...
| ResourceEnterpriseOutlineCode5 | `205521490` | Représente le champ Enterprise Outline Code5 (ressource). |
...
| ResourceEnterpriseText36 | `205521577` | Représente le champ Enterprise Text36 (ressource). |
...
| ResourceFlag3 | `205521025` | Représente le champ Flag3 (ressource). |
...
| ResourceNumber19 | `205521114` | Représente le champ Number19 (ressource). |
...
| ResourceStart | `205521161` | Représente le champ Début (Ressource). |
...
| ResourceText30 | `205521140` | Représente le champ Text30 (ressource). |
...
| TaskBaseline10DeliverableStart | `188744924` | Représente le champ Début du livrable de référence10 (tâche). |
...
| TaskBaseline2Work | `188744176` | Représente le champ Travail de référence2 (tâche). |
...
| TaskBaseline5Finish | `188744207` | Représente le champ Baseline5 Finish (Task). |
...
| TaskBaseline8DeliverableFinish | `188744911` | Représente le champ Fin du livrable de référence8 (tâche). |
...
| TaskBaselineStartText | `188744979` | Représente le champ Texte de début de référence (tâche). |
...
| TaskDate7 | `188743951` | Représente le champ Date7 (Tâche). |
...
| TaskEarnedValueMethod | `188744802` | Représente le champ Méthode de la valeur acquise (tâche). |
...
| TaskEnterpriseDate5 | `188744293` | Représente le champ Entreprise Date5 (Tâche). |
...
| TaskEnterpriseNumber11 | `188744389` | Représente le champ Enterprise Number11 (Task). |
...
| TaskEnterpriseNumber9 | `188744387` | Représente le champ Numéro d'entreprise9 (Tâche). |
...
| TaskEnterpriseProjectCost6 | `188744534` | Représente le champ Enterprise Project Cost6 (Task). |
...
| TaskEnterpriseProjectDuration3 | `188744571` | Représente le champ Enterprise Project Duration3 (Task). |
...
| TaskEnterpriseProjectNumber19 | `188744707` | Représente le champ Enterprise Project Number19 (Task). |
...
| TaskEnterpriseProjectNumber32 | `188744720` | Représente le champ Enterprise Project Number32 (Task). |
| TaskEnterpriseProjectNumber33 | `188744721` | Représente le champ Enterprise Project Number33 (Tâche). |
| TaskEnterpriseProjectNumber34 | `188744722` | Représente le champ Enterprise Project Number34 (Task). |
| TaskEnterpriseProjectNumber35 | `188744723` | Représente le champ Enterprise Project Number35 (Task). |
| TaskEnterpriseProjectNumber36 | `188744724` | Représente le champ Enterprise Project Number36 (Task). |
| TaskEnterpriseProjectNumber37 | `188744725` | Représente le champ Enterprise Project Number37 (Tâche). |
| TaskEnterpriseProjectNumber38 | `188744726` | Représente le champ Enterprise Project Number38 (Tâche). |
| TaskEnterpriseProjectNumber39 | `188744727` | Représente le champ Enterprise Project Number39 (Tâche). |
| TaskEnterpriseProjectNumber4 | `188744692` | Représente le champ Enterprise Project Number4(Task). |
| TaskEnterpriseProjectNumber40 | `188744728` | Représente le champ Enterprise Project Number40 (Task). |
| TaskEnterpriseProjectNumber5 | `188744693` | Représente le champ Enterprise Project Number5 (Task). |
| TaskEnterpriseProjectNumber6 | `188744694` | Représente le champ Enterprise Project Number6 (Tâche). |
| TaskEnterpriseProjectNumber7 | `188744695` | Représente le champ Enterprise Project Number7 (Tâche). |
| TaskEnterpriseProjectNumber8 | `188744696` | Représente le champ Enterprise Project Number8 (Tâche). |
| TaskEnterpriseProjectNumber9 | `188744697` | Représente le champ Enterprise Project Number9 (Task). |
| TaskEnterpriseProjectOutlineCode1 | `188744589` | Représente le champ Enterprise Project OutlineCode1 (Task). |
| TaskEnterpriseProjectOutlineCode10 | `188744598` | Représente le champ Enterprise Project OutlineCode10 (Task). |
| TaskEnterpriseProjectOutlineCode11 | `188744599` | Représente le champ Enterprise Project OutlineCode11 (Task). |
| TaskEnterpriseProjectOutlineCode12 | `188744600` | Représente le champ Enterprise Project OutlineCode12 (Task). |
| TaskEnterpriseProjectOutlineCode13 | `188744601` | Représente le champ Enterprise Project OutlineCode13 (Task). |
| TaskEnterpriseProjectOutlineCode14 | `188744602` | Représente le champ Enterprise Project OutlineCode14 (Task). |
| TaskEnterpriseProjectOutlineCode15 | `188744603` | Représente le champ Enterprise Project OutlineCode15 (Task). |
| TaskEnterpriseProjectOutlineCode16 | `188744604` | Représente le champ Enterprise Project OutlineCode16 (Task). |
| TaskEnterpriseProjectOutlineCode17 | `188744605` | Représente le champ Enterprise Project OutlineCode17 (Task). |
| TaskEnterpriseProjectOutlineCode18 | `188744606` | Représente le champ Enterprise Project OutlineCode18 (Task). |
| TaskEnterpriseProjectOutlineCode19 | `188744607` | Représente le champ Enterprise Project OutlineCode19 (Task). |
| TaskEnterpriseProjectOutlineCode2 | `188744590` | Représente le champ Enterprise Project OutlineCode2 (Task). |
| TaskEnterpriseProjectOutlineCode20 | `188744608` | Représente le champ Enterprise Project OutlineCode2 (Task). |
| TaskEnterpriseProjectOutlineCode21 | `188744609` | Représente le champ Enterprise Project OutlineCode21 (Task). |
| TaskEnterpriseProjectOutlineCode22 | `188744610` | Représente le champ Enterprise Project OutlineCode22 (Task). |
| TaskEnterpriseProjectOutlineCode23 | `188744611` | Représente le champ Enterprise Project OutlineCode23 (Task). |
| TaskEnterpriseProjectOutlineCode24 | `188744612` | Représente le champ Enterprise Project OutlineCode24 (Task). |
| TaskEnterpriseProjectOutlineCode25 | `188744613` | Représente le champ Enterprise Project OutlineCode25 (Task). |
| TaskEnterpriseProjectOutlineCode26 | `188744614` | Représente le champ Enterprise Project OutlineCode26 (Task). |
| TaskEnterpriseProjectOutlineCode27 | `188744615` | Représente le champ Enterprise Project OutlineCode27 (Task). |
| TaskEnterpriseProjectOutlineCode28 | `188744616` | Représente le champ Enterprise Project OutlineCode28 (Task). |
| TaskEnterpriseProjectOutlineCode29 | `188744617` | Représente le champ Enterprise Project OutlineCode29 (Task). |
| TaskEnterpriseProjectOutlineCode3 | `188744591` | Représente le champ Enterprise Project OutlineCode3 (Task). |
| TaskEnterpriseProjectOutlineCode30 | `188744618` | Représente le champ Enterprise Project OutlineCode30 (Task). |
| TaskEnterpriseProjectOutlineCode4 | `188744592` | Représente le champ Enterprise Project OutlineCode4 (Task). |
| TaskEnterpriseProjectOutlineCode5 | `188744593` | Représente le champ Enterprise Project OutlineCode5 (Task). |
| TaskEnterpriseProjectOutlineCode6 | `188744594` | Représente le champ Enterprise Project OutlineCode6 (Task). |
| TaskEnterpriseProjectOutlineCode7 | `188744595` | Représente le champ Enterprise Project OutlineCode7 (Task). |
| TaskEnterpriseProjectOutlineCode8 | `188744596` | Représente le champ Enterprise Project OutlineCode8 (Task). |
| TaskEnterpriseProjectOutlineCode9 | `188744597` | Représente le champ Enterprise Project OutlineCode9 (Task). |
| TaskEnterpriseProjectText1 | `188744729` | Représente le champ Enterprise Project Text1 (Task). |
| TaskEnterpriseProjectText10 | `188744738` | Représente le champ Enterprise Project Text10 (Tâche). |
| TaskEnterpriseProjectText11 | `188744739` | Représente le champ Enterprise Project Text11 (Task). |
| TaskEnterpriseProjectText12 | `188744740` | Représente le champ Enterprise Project Text12 (Task). |
| TaskEnterpriseProjectText13 | `188744741` | Représente le champ Enterprise Project Text13 (Task). |
| TaskEnterpriseProjectText14 | `188744742` | Représente le champ Enterprise Project Text14 (Task). |
| TaskEnterpriseProjectText15 | `188744743` | Représente le champ Enterprise Project Text15 (Task). |
| TaskEnterpriseProjectText16 | `188744744` | Représente le champ Enterprise Project Text16 (Tâche). |
| TaskEnterpriseProjectText17 | `188744745` | Représente le champ Enterprise Project Text17 (Task). |
| TaskEnterpriseProjectText18 | `188744746` | Représente le champ Enterprise Project Text18 (Tâche). |
| TaskEnterpriseProjectText19 | `188744747` | Représente le champ Enterprise Project Text19 (Tâche). |
| TaskEnterpriseProjectText2 | `188744730` | Représente le champ Enterprise Project Text2 (Task). |
| TaskEnterpriseProjectText20 | `188744748` | Représente le champ Enterprise Project Text20 (Tâche). |
| TaskEnterpriseProjectText21 | `188744749` | Représente le champ Enterprise Project Text21 (Task). |
| TaskEnterpriseProjectText22 | `188744750` | Représente le champ Enterprise Project Text22 (Task). |
| TaskEnterpriseProjectText23 | `188744751` | Représente le champ Enterprise Project Text23 (Task). |
| TaskEnterpriseProjectText24 | `188744752` | Représente le champ Enterprise Project Text24 (Task). |
| TaskEnterpriseProjectText25 | `188744753` | Représente le champ Enterprise Project Text25 (Tâche). |
| TaskEnterpriseProjectText26 | `188744754` | Représente le champ Enterprise Project Text26 (Tâche). |
| TaskEnterpriseProjectText27 | `188744755` | Représente le champ Enterprise Project Text27 (Tâche). |
| TaskEnterpriseProjectText28 | `188744756` | Représente le champ Enterprise Project Text28 (Tâche). |
| TaskEnterpriseProjectText29 | `188744757` | Représente le champ Enterprise Project Text29 (Tâche). |
| TaskEnterpriseProjectText3 | `188744731` | Représente le champ Enterprise Project Text3 (Task). |
| TaskEnterpriseProjectText30 | `188744758` | Représente le champ Enterprise Project Text30 (Tâche). |
| TaskEnterpriseProjectText31 | `188744759` | Représente le champ Enterprise Project Text31 (Tâche). |
| TaskEnterpriseProjectText32 | `188744760` | Représente le champ Enterprise Project Text32 (Tâche). |
| TaskEnterpriseProjectText33 | `188744761` | Représente le champ Enterprise Project Text33 (Task). |
| TaskEnterpriseProjectText34 | `188744762` | Représente le champ Enterprise Project Text34 (Task). |
| TaskEnterpriseProjectText35 | `188744763` | Représente le champ Enterprise Project Text35 (Tâche). |
| TaskEnterpriseProjectText36 | `188744764` | Représente le champ Enterprise Project Text36 (Tâche). |
| TaskEnterpriseProjectText37 | `188744765` | Représente le champ Enterprise Project Text37 (Tâche). |
| TaskEnterpriseProjectText38 | `188744766` | Représente le champ Enterprise Project Text38 (Tâche). |
| TaskEnterpriseProjectText39 | `188744767` | Représente le champ Enterprise Project Text39 (Tâche). |
| TaskEnterpriseProjectText4 | `188744732` | Représente le champ Enterprise Project Text4 (Task). |
| TaskEnterpriseProjectText40 | `188744768` | Représente le champ Enterprise Project Text40 (Tâche). |
| TaskEnterpriseProjectText5 | `188744733` | Représente le champ Enterprise Project Text5 (Task). |
| TaskEnterpriseProjectText6 | `188744734` | Représente le champ Enterprise Project Text6 (Tâche). |
| TaskEnterpriseProjectText7 | `188744735` | Représente le champ Enterprise Project Text7 (Tâche). |
| TaskEnterpriseProjectText8 | `188744736` | Représente le champ Enterprise Project Text8 (Tâche). |
| TaskEnterpriseProjectText9 | `188744737` | Représente le champ Enterprise Project Text9(Task). |
| TaskEnterpriseText1 | `188744479` | Représente le champ Enterprise Text1 (Task). |
| TaskEnterpriseText10 | `188744488` | Représente le champ Entreprise Texte10 (Tâche). |
| TaskEnterpriseText11 | `188744489` | Représente le champ Entreprise Texte11 (Tâche). |
| TaskEnterpriseText12 | `188744490` | Représente le champ Enterprise Text12 (Task). |
| TaskEnterpriseText13 | `188744491` | Représente le champ Enterprise Text13 (Task). |
| TaskEnterpriseText14 | `188744492` | Représente le champ Enterprise Text14 (Task). |
| TaskEnterpriseText15 | `188744493` | Représente le champ Entreprise Texte15 (Tâche). |
| TaskEnterpriseText16 | `188744494` | Représente le champ Entreprise Texte16 (Tâche). |
| TaskEnterpriseText17 | `188744495` | Représente le champ Entreprise Texte17 (Tâche). |
| TaskEnterpriseText18 | `188744496` | Représente le champ Entreprise Texte18 (Tâche). |
| TaskEnterpriseText19 | `188744497` | Représente le champ Entreprise Texte19 (Tâche). |
| TaskEnterpriseText2 | `188744480` | Représente le champ Enterprise Text2 (Task). |
| TaskEnterpriseText20 | `188744498` | Représente le champ Entreprise Texte20 (Tâche). |
| TaskEnterpriseText21 | `188744499` | Représente le champ Entreprise Texte21 (Tâche). |
| TaskEnterpriseText22 | `188744500` | Représente le champ Entreprise Texte22 (Tâche). |
| TaskEnterpriseText23 | `188744501` | Représente le champ Entreprise Texte23 (Tâche). |
| TaskEnterpriseText24 | `188744502` | Représente le champ Entreprise Texte24 (Tâche). |
| TaskEnterpriseText25 | `188744503` | Représente le champ Entreprise Texte25 (Tâche). |
| TaskEnterpriseText26 | `188744504` | Représente le champ Entreprise Texte26 (Tâche). |
| TaskEnterpriseText27 | `188744505` | Représente le champ Entreprise Texte27 (Tâche). |
| TaskEnterpriseText28 | `188744506` | Représente le champ Entreprise Texte28 (Tâche). |
| TaskEnterpriseText29 | `188744507` | Représente le champ Entreprise Texte29 (Tâche). |
| TaskEnterpriseText3 | `188744481` | Représente le champ Entreprise Texte3 (Tâche). |
| TaskEnterpriseText30 | `188744508` | Représente le champ Entreprise Texte30 (Tâche). |
| TaskEnterpriseText31 | `188744509` | Représente le champ Entreprise Texte31 (Tâche). |
| TaskEnterpriseText32 | `188744510` | Représente le champ Entreprise Texte32 (Tâche). |
| TaskEnterpriseText33 | `188744511` | Représente le champ Entreprise Texte33 (Tâche). |
| TaskEnterpriseText34 | `188744512` | Représente le champ Entreprise Texte34 (Tâche). |
| TaskEnterpriseText35 | `188744513` | Représente le champ Entreprise Texte35 (Tâche). |
| TaskEnterpriseText36 | `188744514` | Représente le champ Entreprise Texte36 (Tâche). |
| TaskEnterpriseText37 | `188744515` | Représente le champ Entreprise Texte37 (Tâche). |
| TaskEnterpriseText38 | `188744516` | Représente le champ Entreprise Texte38 (Tâche). |
| TaskEnterpriseText39 | `188744517` | Représente le champ Entreprise Texte39 (Tâche). |
| TaskEnterpriseText4 | `188744482` | Représente le champ Entreprise Texte4 (Tâche). |
| TaskEnterpriseText40 | `188744518` | Représente le champ Entreprise Texte40 (Tâche). |
| TaskEnterpriseText5 | `188744483` | Représente le champ Entreprise Texte5 (Tâche). |
| TaskEnterpriseText6 | `188744484` | Représente le champ Texte d'entreprise6 (Tâche). |
| TaskEnterpriseText7 | `188744485` | Représente le champ Entreprise Texte7 (Tâche). |
| TaskEnterpriseText8 | `188744486` | Représente le champ Entreprise Texte8 (Tâche). |
| TaskEnterpriseText9 | `188744487` | Représente le champ Texte d'entreprise9 (Tâche). |
| TaskErrorMessage | `188744847` | Représente le champ Message d'erreur (tâche). |
| TaskEstimated | `188744076` | Représente le champ Estimé (Tâche). |
| TaskExternalTask | `188743912` | Représente le champ Tâche externe (Tâche). |
| TaskFinish | `188743716` | Représente le champ Terminer (tâche). |
| TaskFinish1 | `188743733` | Représente le champ Fin1 (Tâche). |
| TaskFinish10 | `188743971` | Représente le champ Fin10 (Tâche). |
| TaskFinish2 | `188743736` | Représente le champ Fin2 (Tâche). |
| TaskFinish3 | `188743739` | Représente le champ Fin3 (Tâche). |
| TaskFinish4 | `188743742` | Représente le champ Fin4 (Tâche). |
| TaskFinish5 | `188743745` | Représente le champ Fin5 (Tâche). |
| TaskFinish6 | `188743963` | Représente le champ Fin6 (Tâche). |
| TaskFinish7 | `188743965` | Représente le champ Terminer7 (Tâche). |
| TaskFinish8 | `188743967` | Représente le champ Fin8 (Tâche). |
| TaskFinish9 | `188743969` | Représente le champ Terminer9 (Tâche). |
| TaskFinishSlack | `188744119` | Représente le champ Marge de fin (tâche). |
| TaskFinishText | `188744966` | Représente le champ Texte de fin de tâche (tâche). |
| TaskFinishVariance | `188743726` | Représente le champ Écart de fin (tâche). |
| TaskFixedCost | `188743688` | Représente le champ Coût fixe (tâche). |
| TaskFixedCostAccrual | `188743880` | Représente le champ d'accumulation des coûts fixes (tâche). |
| TaskFixedDuration | `188743714` | Représente le champ Durée fixe (tâche). |
| TaskFlag1 | `188743752` | Représente le champ Flag1 (Tâche). |
| TaskFlag10 | `188743761` | Représente le champ Flag10 (Tâche). |
| TaskFlag11 | `188743972` | Représente le champ Flag11 (Tâche). |
| TaskFlag12 | `188743973` | Représente le champ Flag12 (Tâche). |
| TaskFlag13 | `188743974` | Représente le champ Flag13 (Tâche). |
| TaskFlag14 | `188743975` | Représente le champ Flag14 (Tâche). |
| TaskFlag15 | `188743976` | Représente le champ Flag15 (Tâche). |
| TaskFlag16 | `188743977` | Représente le champ Flag16 (Tâche). |
| TaskFlag17 | `188743978` | Représente le champ Flag17 (Tâche). |
| TaskFlag18 | `188743979` | Représente le champ Flag18 (Tâche). |
| TaskFlag19 | `188743980` | Représente le champ Flag19 (Tâche). |
| TaskFlag2 | `188743753` | Représente le champ Flag2 (Tâche). |
| TaskFlag20 | `188743981` | Représente le champ Flag20 (Tâche). |
| TaskFlag3 | `188743754` | Représente le champ Flag3 (Tâche). |
| TaskFlag4 | `188743755` | Représente le champ Flag4 (Tâche). |
| TaskFlag5 | `188743756` | Représente le champ Flag5 (Tâche). |
| TaskFlag6 | `188743757` | Représente le champ Flag6 (Tâche). |
| TaskFlag7 | `188743758` | Représente le champ Flag7 (Tâche). |
| TaskFlag8 | `188743759` | Représente le champ Flag8 (Tâche). |
| TaskFlag9 | `188743760` | Représente le champ Flag9 (Tâche). |
| TaskFreeSlack | `188743701` | Représente le champ Marge libre (tâche). |
| TaskGroupBySummary | `188744126` | Représente le champ Group By Summary (Task). |
| TaskGuid | `188744823` | Représente le champ GUID de tâche (tâche). |
| TaskHideBar | `188743789` | Représente le champ Masquer la barre (tâche). |
| TaskHyperlinkId | `188743895` | Représente le champ ID de lien hypertexte (tâche). |
| TaskHyperlink | `188743897` | Représente le champ Lien hypertexte (tâche). |
| TaskHyperlinkAddress | `188743898` | Représente le champ Adresse du lien hypertexte (tâche). |
| TaskHyperlinkHref | `188743900` | Représente le champ Hyperlien HRef (Tâche). |
| TaskHyperlinkScreenTip | `188744132` | Représente le champ Hyperlink ScreenTip (Task). |
| TaskHyperlinkSubAddress | `188743899` | Représente le champ de sous-adresse de lien hypertexte (tâche). |
| TaskID | `188743703` | Représente le champ ID (tâche). |
| TaskIgnoreResourceCalendar | `188744079` | Représente le champ Ignorer le calendrier des ressources (tâche). |
| TaskIgnoreWarnings | `188745012` | Représente le champ Ignorer les avertissements de tâche (tâche). |
| TaskIndex | `188744040` | Représente le champ Index (Tâche). |
| TaskIndicators | `188743885` | Représente le champ Indicateurs (Tâche). |
| TaskIsAssignment | `188743904` | Représente le champ Est une affectation (tâche). |
| TaskIsDurationValid | `188744977` | Représente le champ qui indique si la durée de la tâche est valide, lors de la conversion d'une tâche manuelle en une tâche planifiée automatiquement. |
| TaskIsFinishValid | `188744976` | Représente le champ qui indique si la date de fin de la tâche est valide, lors de la conversion d'une tâche manuelle en une tâche planifiée automatiquement. |
| TaskIsStartValid | `188744975` | Représente le champ qui indique si la date de début de la tâche est valide, lors de la conversion d'une tâche manuelle en une tâche planifiée automatiquement. |
| TaskIsPublished | `188744845` | Représente le champ Est publié (tâche). |
| TaskLateFinish | `188743720` | Représente le champ Fin tardive (tâche). |
| TaskLateStart | `188743719` | Représente le champ Début tardif (tâche). |
| TaskLevelAssignments | `188743933` | Représente le champ Affectations de niveau (tâche). |
| TaskLevelCanSplit | `188743932` | Représente le champ Le niveau peut fractionner (tâche). |
| TaskLevelDelay | `188743700` | Représente le champ Délai de niveau (tâche). |
| TaskLinkedFields | `188743778` | Représente le champ Champs liés (tâche). |
| TaskManual | `188744960` | Représente le champ Manuel de tâches (TASK). |
| TaskMarked | `188743751` | Représente le champ marqué (tâche). |
| TaskMilestone | `188743704` | Représente le champ Jalon (tâche). |
| TaskName | `188743694` | Représente le champ Nom (Tâche). |
| TaskNotes | `188743695` | Représente le champ Notes (Tâche). |
| TaskNumber1 | `188743767` | Représente le champ Numéro1 (Tâche). |
| TaskNumber10 | `188743986` | Représente le champ Numéro10 (Tâche). |
| TaskNumber11 | `188743987` | Représente le champ Numéro11 (Tâche). |
| TaskNumber12 | `188743988` | Représente le champ Numéro12 (Tâche). |
| TaskNumber13 | `188743989` | Représente le champ Numéro13 (Tâche). |
| TaskNumber14 | `188743990` | Représente le champ Numéro14 (Tâche). |
| TaskNumber15 | `188743991` | Représente le champ Numéro15 (Tâche).. |
| TaskNumber16 | `188743992` | Représente le champ Numéro16 (Tâche). |
| TaskNumber17 | `188743993` | Représente le champ Numéro17 (Tâche). |
| TaskNumber18 | `188743994` | Représente le champ Numéro18 (Tâche). |
| TaskNumber19 | `188743995` | Représente le champ Numéro19 (Tâche). |
| TaskNumber2 | `188743768` | Représente le champ Numéro2 (Tâche). |
| TaskNumber20 | `188743996` | Représente le champ Nombre20 (Tâche). |
| TaskNumber3 | `188743769` | Représente le champ Numéro3 (Tâche). |
| TaskNumber4 | `188743770` | Représente le champ Numéro4 (Tâche). |
| TaskNumber5 | `188743771` | Représente le champ Numéro5 (Tâche). |
| TaskNumber6 | `188743982` | Représente le champ Numéro6 (Tâche). |
| TaskNumber7 | `188743983` | Représente le champ Numéro7 (Tâche). |
| TaskNumber8 | `188743984` | Représente le champ Numéro8 (Tâche). |
| TaskNumber9 | `188743985` | Représente le champ Numéro9 (Tâche). |
| TaskObjects | `188743777` | Représente le champ Objets (Tâche). |
| TaskOutlineCode1 | `188744096` | Représente le champ Code hiérarchique1 (Tâche). |
| TaskOutlineCode10 | `188744114` | Représente le champ Code hiérarchique10 (tâche). |
| TaskOutlineCode2 | `188744098` | Représente le champ Code hiérarchique2 (tâche). |
| TaskOutlineCode3 | `188744100` | Représente le champ Code hiérarchique3 (tâche). |
| TaskOutlineCode4 | `188744102` | Représente le champ Code hiérarchique4 (Tâche). |
| TaskOutlineCode5 | `188744104` | Représente le champ Code hiérarchique5 (Tâche). |
| TaskOutlineCode6 | `188744106` | Représente le champ Code hiérarchique6 (tâche). |
| TaskOutlineCode7 | `188744108` | Représente le champ Code hiérarchique7 (Tâche). |
| TaskOutlineCode8 | `188744110` | Représente le champ Code hiérarchique8 (tâche). |
| TaskOutlineCode9 | `188744112` | Représente le champ Code hiérarchique9 (tâche). |
| TaskOutlineLevel | `188743765` | Représente le champ Niveau hiérarchique (tâche). |
| TaskOutlineNumber | `188743782` | Représente le champ Code hiérarchique (tâche). |
| TaskOverallocated | `188743905` | Représente le champ Surutilisé (tâche). |
| TaskOvertimeCost | `188743848` | Représente le champ Coût des heures supplémentaires (tâche). |
| TaskOvertimeWork | `188743843` | Représente le champ Heures supplémentaires (tâche). |
| TaskPathDrivenSuccessor | `188745063` | Le champ successeur piloté pour un chemin de tâche. Voir la propriété Task.PathDrivenSuccessor. |
| TaskPathDrivingPredecessor | `188745061` | Le champ du prédécesseur pilote pour un chemin de tâche. Voir la propriété Task.PathDrivingPredecessor. |
| TaskPathPredecessor | `188745062` | Le champ prédécesseur d'un chemin de tâche. Voir la propriété Task.PathPredecessor. |
| TaskPathSuccessor | `188745064` | Le champ successeur d'un chemin de tâche. Voir la propriété Task.PathSuccessor. |
| TaskSummaryName | `188745085` | Le nom de la tâche récapitulative associée à la tâche. |
| TaskParentTask | `188743815` | Représente le champ Tâche parent (Tâche). |
| TaskPercentComplete | `188743712` | Représente le champ Pourcentage achevé (tâche). |
| TaskPercentWorkComplete | `188743713` | Représente le champ Pourcentage de travail achevé (tâche). |
| TaskPhysicalPercentComplete | `188744799` | Représente le champ Pourcentage physique achevé (tâche). |
| TaskPlaceholder | `188744961` | Représente le champ Espace réservé de tâche (Tâche). |
| TaskPredecessors | `188743727` | Représente le champ Prédécesseurs (Tâche). Les numéros d'identification de tâche pour les tâches prédécesseurs dont dépend la tâche avant de pouvoir être démarrée ou terminée. |
| TaskPreleveledFinish | `188744050` | Représente le champ Fin pré-nivelée (tâche). |
| TaskPreleveledStart | `188744049` | Représente le champ Début pré-nivelé (tâche). |
| TaskPriority | `188743705` | Représente le champ Priorité (Tâche). |
| TaskProject | `188743764` | Représente le champ Projet (Tâche). |
| TaskRecalcFlags | `188744930` | Représente le champ Indicateurs de recalcul (tâche). |
| TaskRecurring | `188743809` | Représente le champ Récurrent (tâche). |
| TaskRegularWork | `188743846` | Représente le champ Travail régulier (tâche). |
| TaskRemainingCost | `188743690` | Représente le champ Coût restant (tâche). |
| TaskRemainingDuration | `188743711` | Représente le champ Durée restante (tâche). |
| TaskRemainingOvertimeCost | `188743850` | Représente le champ Coût des heures supplémentaires restant (tâche). |
| TaskRemainingOvertimeWork | `188743845` | Représente le champ Heures supplémentaires restantes (tâche). |
| TaskRemainingWork | `188743684` | Représente le champ Travail restant (tâche). |
| TaskResourceEnterpriseMultiValueCode20 | `188744809` | Représente le champ Enterprise Resource MultiValue Code20 (Task). |
| TaskResourceEnterpriseMultiValueCode21 | `188744810` | Représente le champ Enterprise Resource MultiValue Code21 (Task). |
| TaskResourceEnterpriseMultiValueCode22 | `188744811` | Représente le champ Enterprise Resource MultiValue Code22 (Task). |
| TaskResourceEnterpriseMultiValueCode23 | `188744812` | Représente le champ Enterprise Resource MultiValue Code23 (Task). |
| TaskResourceEnterpriseMultiValueCode24 | `188744813` | Représente le champ Enterprise Resource MultiValue Code24 (Task). |
| TaskResourceEnterpriseMultiValueCode25 | `188744814` | Représente le champ Enterprise Resource MultiValue Code25 (Task). |
| TaskResourceEnterpriseMultiValueCode26 | `188744815` | Représente le champ Enterprise Resource MultiValue Code26 (Task). |
| TaskResourceEnterpriseMultiValueCode27 | `188744816` | Représente le champ Enterprise Resource MultiValue Code27 (Task). |
| TaskResourceEnterpriseMultiValueCode28 | `188744817` | Représente le champ Enterprise Resource MultiValue Code28 (Task). |
| TaskResourceEnterpriseMultiValueCode29 | `188744818` | Représente le champ Enterprise Resource MultiValue Code29 (Task). |
| TaskResourceEnterpriseOutlineCode1 | `188744769` | Représente le champ Enterprise Resource Outline Code1 (Task). |
| TaskResourceEnterpriseOutlineCode10 | `188744778` | Représente le champ Code hiérarchique de ressource d'entreprise10 (tâche). |
| TaskResourceEnterpriseOutlineCode11 | `188744779` | Représente le champ Enterprise Resource Outline Code11 (Task). |
| TaskResourceEnterpriseOutlineCode12 | `188744780` | Représente le champ Enterprise Resource Outline Code12 (Task). |
| TaskResourceEnterpriseOutlineCode13 | `188744781` | Représente le champ Enterprise Resource Outline Code13 (Task). |
| TaskResourceEnterpriseOutlineCode14 | `188744782` | Représente le champ Enterprise Resource Outline Code14 (Task). |
| TaskResourceEnterpriseOutlineCode15 | `188744783` | Représente le champ Enterprise Resource Outline Code15 (Task). |
| TaskResourceEnterpriseOutlineCode16 | `188744784` | Représente le champ Enterprise Resource Outline Code16 (Task). |
| TaskResourceEnterpriseOutlineCode17 | `188744785` | Représente le champ Enterprise Resource Outline Code17 (Task). |
| TaskResourceEnterpriseOutlineCode18 | `188744786` | Représente le champ Enterprise Resource Outline Code18 (Task). |
| TaskResourceEnterpriseOutlineCode19 | `188744787` | Représente le champ Enterprise Resource Outline Code19 (Task). |
| TaskResourceEnterpriseOutlineCode2 | `188744770` | Représente le champ Enterprise Resource Outline Code2 (Task). |
| TaskResourceEnterpriseOutlineCode20 | `188744788` | Représente le champ Enterprise Resource Outline Code20 (Task). |
| TaskResourceEnterpriseOutlineCode21 | `188744789` | Représente le champ Enterprise Resource Outline Code21 (Task). |
| TaskResourceEnterpriseOutlineCode22 | `188744790` | Représente le champ Enterprise Resource Outline Code22 (Task). |
| TaskResourceEnterpriseOutlineCode23 | `188744791` | Représente le champ Enterprise Resource Outline Code23 (Task). |
| TaskResourceEnterpriseOutlineCode24 | `188744792` | Représente le champ Enterprise Resource Outline Code24 (Task). |
| TaskResourceEnterpriseOutlineCode25 | `188744793` | Représente le champ Enterprise Resource Outline Code25 (Task). |
| TaskResourceEnterpriseOutlineCode26 | `188744794` | Représente le champ Enterprise Resource Outline Code26 (Task). |
| TaskResourceEnterpriseOutlineCode27 | `188744795` | Représente le champ Enterprise Resource Outline Code27 (Task). |
| TaskResourceEnterpriseOutlineCode28 | `188744796` | Représente le champ Enterprise Resource Outline Code28 (Task). |
| TaskResourceEnterpriseOutlineCode29 | `188744797` | Représente le champ Enterprise Resource Outline Code29 (Task). |
| TaskResourceEnterpriseOutlineCode3 | `188744771` | Représente le champ Enterprise Resource Outline Code3 (Task). |
| TaskResourceEnterpriseOutlineCode4 | `188744772` | Représente le champ Enterprise Resource Outline Code4 (Task). |
| TaskResourceEnterpriseOutlineCode5 | `188744773` | Représente le champ Enterprise Resource Outline Code5 (Task). |
| TaskResourceEnterpriseOutlineCode6 | `188744774` | Représente le champ Code hiérarchique de ressource d'entreprise6 (tâche). |
| TaskResourceEnterpriseOutlineCode7 | `188744775` | Représente le champ Enterprise Resource Outline Code7 (Tâche). |
| TaskResourceEnterpriseOutlineCode8 | `188744776` | Représente le champ Enterprise Resource Outline Code8 (Tâche). |
| TaskResourceEnterpriseOutlineCode9 | `188744777` | Représente le champ Enterprise Resource Outline Code9 (Task). |
| TaskResourceEnterpriseRBS | `188744798` | Représente le champ Enterprise Resource RBS (tâche). |
| TaskResourceGroup | `188743793` | Représente le champ Groupe de ressources (tâche). |
| TaskResourceInitials | `188743730` | Représente le champ Initiales de la ressource (tâche). |
| TaskResourceNames | `188743729` | Représente le champ Noms des ressources (tâche). |
| TaskResourcePhonetics | `188744029` | Représente le champ Resource Phonetics (Task). |
| TaskResourceType | `188744131` | Représente le champ Type de ressource (tâche). |
| TaskResponsePending | `188743930` | Représente le champ Réponse en attente (tâche). |
| TaskResume | `188743779` | Représente le champ Reprendre (tâche). |
| TaskResumeNoEarlierThan | `188743781` | Représente le champ Reprendre au plus tôt le (tâche). |
| TaskRollup | `188743762` | Représente le champ Cumul (tâche). |
| TaskScheduledDuration | `188745020` | Représente le champ Durée planifiée de la tâche (tâche). |
| TaskScheduledFinish | `188745019` | Représente le champ Fin planifiée de la tâche (tâche). |
| TaskScheduledStart | `188745018` | Représente le champ Début planifié de la tâche (tâche). |
| TaskSheetNotes | `188743774` | Représente le champ Notes de feuille (tâche). |
| TaskSPI | `188744218` | Représente le champ SPI (Tâche). |
| TaskStart | `188743715` | Représente le champ Début (Tâche). |
| TaskStart1 | `188743732` | Représente le champ Start1 (Tâche). |
| TaskStart10 | `188743970` | Représente le champ Start10 (Tâche). |
| TaskStart2 | `188743735` | Représente le champ Start2 (Tâche). |
| TaskStart3 | `188743738` | Représente le champ Start3 (Tâche). |
| TaskStart4 | `188743741` | Représente le champ Start4 (Tâche). |
| TaskStart5 | `188743744` | Représente le champ Start5 (Tâche). |
| TaskStart6 | `188743962` | Représente le champ Start6 (Tâche). |
| TaskStart7 | `188743964` | Représente le champ Start7 (Tâche). |
| TaskStart8 | `188743966` | Représente le champ Start8 (Tâche). |
| TaskStart9 | `188743968` | Représente le champ Start9 (Tâche). |
| TaskStartSlack | `188744118` | Représente le champ Start Slack (Task). |
| TaskStartText | `188744965` | Représente le champ Texte de début de tâche (tâche). |
| TaskStartVariance | `188743725` | Représente le champ Start Variance (Task). |
| TaskStatus | `188744223` | Représente le champ Statut (Tâche). |
| TaskStatusIndicator | `188744801` | Représente le champ Indicateur d'état (tâche). |
| TaskStatusManagerName | `188744846` | Représente le champ Nom du gestionnaire d'état (tâche). |
| TaskStop | `188743780` | Représente le champ Arrêter (Tâche). |
| TaskSubproject | `188743706` | Représente le champ Sous-projet (tâche). |
| TaskSubprojectReadOnly | `188743926` | Représente le champ Sous-projet en lecture seule (tâche). |
| TaskSuccessors | `188743728` | Représente le champ Successeurs (Tâche). Les numéros d'ID de tâche pour les tâches qui succèdent à une tâche. |
| TaskSummary | `188743772` | Représente le champ Résumé (Tâche). |
| TaskSV | `188743693` | Représente le champ SV (Tâche). |
| TaskSVPercent | `188744220` | Représente le champ Pourcentage SV (Tâche). |
| TaskTCPI | `188744222` | Représente le champ TCPI (Tâche). |
| TaskTeamStatusPending | `188743931` | Représente le champ Statut de l'équipe en attente (tâche). |
| TaskText1 | `188743731` | Représente le champ Texte1 (Tâche). |
| TaskText10 | `188743750` | Représente le champ Texte10 (Tâche). |
| TaskText11 | `188743997` | Représente le champ Texte11 (Tâche). |
| TaskText12 | `188743998` | Représente le champ Texte12 (Tâche). |
| TaskText13 | `188743999` | Représente le champ Texte13 (Tâche). |
| TaskText14 | `188744000` | Représente le champ Texte14 (Tâche). |
| TaskText15 | `188744001` | Représente le champ Texte15 (Tâche). |
| TaskText16 | `188744002` | Représente le champ Texte16 (Tâche). |
| TaskText17 | `188744003` | Représente le champ Texte17 (Tâche). |
| TaskText18 | `188744004` | Représente le champ Texte18 (Tâche). |
| TaskText19 | `188744005` | Représente le champ Texte19 (Tâche). |
| TaskText2 | `188743734` | Représente le champ Texte2 (Tâche). |
| TaskText20 | `188744006` | Représente le champ Texte20 (Tâche). |
| TaskText21 | `188744007` | Représente le champ Texte21 (Tâche). |
| TaskText22 | `188744008` | Représente le champ Texte22 (Tâche). |
| TaskText23 | `188744009` | Représente le champ Texte23 (Tâche). |
| TaskText24 | `188744010` | Représente le champ Text24 (Tâche). |
| TaskText25 | `188744011` | Représente le champ Text25 (Tâche). |
| TaskText26 | `188744012` | Représente le champ Texte26 (Tâche). |
| TaskText27 | `188744013` | Représente le champ Texte27 (Tâche). |
| TaskText28 | `188744014` | Représente le champ Texte28 (Tâche). |
| TaskText29 | `188744015` | Représente le champ Texte29 (Tâche). |
| TaskText3 | `188743737` | Représente le champ Texte3 (Tâche). |
| TaskText30 | `188744016` | Représente le champ Text30 (Tâche). |
| TaskText4 | `188743740` | Représente le champ Texte4 (Tâche). |
| TaskText5 | `188743743` | Représente le champ Texte5 (Tâche). |
| TaskText6 | `188743746` | Représente le champ Texte6 (Tâche). |
| TaskText7 | `188743747` | Représente le champ Texte7 (Tâche). |
| TaskText8 | `188743748` | Représente le champ Texte8 (Tâche). |
| TaskText9 | `188743749` | Représente le champ Texte9 (Tâche). |
| TaskTotalSlack | `188743702` | Représente le champ Marge totale (tâche). |
| TaskType | `188743808` | Représente le champ Type (Tâche). |
| TaskUniqueID | `188743766` | Représente le champ ID unique (tâche). |
| TaskUniquePredecessors | `188743775` | Représente le champ Unique ID Predecessors (Task). |
| TaskUniqueSuccessors | `188743776` | Représente le champ Unique ID Successors (Task). |
| TaskUpdateNeeded | `188743791` | Représente le champ Mise à jour nécessaire (tâche). |
| TaskVAC | `188744121` | Représente le champ VAC (Tâche). |
| TaskWarning | `188744962` | Représente le champ Avertissement de tâche (Tâche). |
| TaskWBS | `188743696` | Représente le champ WBS (Tâche). |
| TaskWBSPredecessors | `188744129` | Représente le champ Prédécesseurs WBS (Tâche). |
| TaskWBSSuccessors | `188744130` | Représente le champ Successeurs WBS (tâche). |
| TaskWork | `188743680` | Représente le champ Travail (Tâche). |
| TaskWorkContour | `188743936` | Représente le champ Profil de travail (tâche). |
| TaskWorkVariance | `188743683` | Représente le champ Écart de travail (tâche). |
| TaskCompleteThrough | `188743799` | Disponible uniquement dans la boîte de dialogue Styles de barres dans MSP et est représenté sous forme de barre sur le diagramme de Gantt. |
| TaskBaseLineFixedCost | `188744160` | Représente le champ Coût fixe de référence (tâche). |
| ResourceAssignmentGuid | `255853180` | Représente le champ GUID (Affectation). |
| ResourceAssignmentBaseLineStart | `255852690` | Représente le champ Baseline Start (Affectation). |
| ResourceAssignmentBaseLineFinish | `255852691` | Représente le champ Fin planifiée (affectation). |
| ResourceAssignmentBaseLineCost | `255852576` | Représente le champ Coût de référence (affectation). |
| ResourceAssignmentBaseLineWork | `255852560` | Représente le champ Travail de référence (Affectation). |
| ResourceAssignmentBaseLineCostPerUse | `255852811` | Représente le champ Coût par utilisation de référence (affectation). |
