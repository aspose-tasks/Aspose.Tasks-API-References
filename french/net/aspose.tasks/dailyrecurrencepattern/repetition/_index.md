...
description: "Propriété DailyRecurrencePattern. Obtient ou définit le modèle de répétitions dans le modèle de récurrence quotidien"
type: docs
weight: 20
...
Obtient ou définit le modèle de répétitions dans le modèle de récurrence quotidien.
