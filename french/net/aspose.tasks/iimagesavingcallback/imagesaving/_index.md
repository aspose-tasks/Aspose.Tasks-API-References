...
description: "Méthode IImageSavingCallback. La méthode à appeler lors de l'enregistrement des images"
type: docs
weight: 10
...
| --- | --- | --- |
| args | ImageSavingArgs | Les arguments de l'enregistrement d'image. |
