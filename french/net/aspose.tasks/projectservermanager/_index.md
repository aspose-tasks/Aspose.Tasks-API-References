...
description: La classe qui fournit les méthodes pour lire et effectuer des opérations sur des projets dans le compte Project Online spécifié ou dans linstance Project Server sur site spécifiée les versions 2016 et 2019 de Project Server sont prises en charge.
type: docs
weight: 1240
...
| Nom | La description |
| --- | --- |
| [ProjectServerManager](projectservermanager)(ProjectServerCredentials) | Initialise une nouvelle instance du[`ProjectServerManager`](../projectservermanager) classe. |
