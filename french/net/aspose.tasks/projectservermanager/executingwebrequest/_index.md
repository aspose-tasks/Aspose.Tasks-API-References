...
description: Un événement déclenché lorsque la demande Web est envoyée à lAPI Web de Project Server.
type: docs
weight: 20
...
Un événement déclenché lorsque la demande Web est envoyée à l'API Web de Project Server.
