...
description: "TimephasedData propriété. Obtient ou définit la date de début d'une période de données à phases temporelles"
type: docs
weight: 60
...
Obtient ou définit la date de début d'une période de données à phases temporelles.
