...
description: "TimephasedData propriété. Obtient ou définit la valeur par unité de temps pour une période de données à phases temporelles"
type: docs
weight: 100
...
Obtient ou définit la valeur par unité de temps pour une période de données à phases temporelles.
...
| exception | condition |
| --- | --- |
| [TasksException](../../tasksexception/) | Lorsque la valeur est incorrecte pour le [`TimephasedDataType`](../timephaseddatatype/) spécifié ou qu'elle est négative. |
