...
description: "TimephasedData propriété. Obtient ou définit la date de fin d'une période de données à phases temporelles"
type: docs
weight: 50
...
Obtient ou définit la date de fin d'une période de données à phases temporelles.
