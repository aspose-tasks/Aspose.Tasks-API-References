...
description: "Méthode TimephasedData. Crée et initialise une nouvelle instance de la classe TimephasedData pour des données temporelles basées sur les unités d’une affectation d’une ressource matérielle"
type: docs
weight: 30
...
Crée et initialise une nouvelle instance de la classe [`TimephasedData`](../) pour des données temporelles basées sur les unités d’une affectation d’une ressource matérielle.
...
| début | DateTime | Date et heure de début. |
...
| exception | condition |
| --- | --- |
| ArgumentException | Si une quantité négative d’unités a été spécifiée. |
