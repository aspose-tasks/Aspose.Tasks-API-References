...
description: "Méthode TimephasedData. Crée et initialise une nouvelle instance de la classe TimephasedData pour des données temporelles phasées basées sur le travail"
type: docs
weight: 40
...
Crée et initialise une nouvelle instance de la classe [`TimephasedData`](../) pour des données temporelles phasées basées sur le travail.
...
| value | TimeSpan | Valeur Timespan. |
| timeUnit | TimeUnitType | Type d'unité de temps. |
| type | TimephasedDataType | Type de données temporelles phasées. |

### Valeur de retour

Une instance de la classe [`TimephasedData`](../) pour des données temporelles phasées basées sur le travail.
