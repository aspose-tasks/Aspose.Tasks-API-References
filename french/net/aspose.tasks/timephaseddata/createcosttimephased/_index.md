...
description: TimephasedData méthode. Crée et initialise une nouvelle instance duTimephasedData classe pour les données chronologiques basées sur les coûts.
type: docs
weight: 20
...
Crée et initialise une nouvelle instance du[`TimephasedData`](../) classe pour les données chronologiques basées sur les coûts.
