...
description: "TimephasedData propriété. Obtient une instance Double qui représente la valeur sous forme de chaîne de cet objet pour des données à phases temporelles basées sur l'unité"
type: docs
weight: 130
...
Obtient l'instance Double qui représente la valeur chaîne de cet objet pour des données à phases temporelles basées sur l'unité.
