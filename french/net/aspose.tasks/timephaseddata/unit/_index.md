...
description: "Propriété TimephasedData. Obtient ou définit l'unité de temps d'une période de données temporelles phasées"
type: docs
weight: 90
...
Obtient ou définit l'unité de temps d'une période de données à phases temporelles.
