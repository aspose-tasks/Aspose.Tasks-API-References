...
description: Représente quatre éléments dun masque qui définit un format de code hiérarchique.
type: docs
weight: 1050
...
| Nom | La description |
| --- | --- |
| [OutlineMask](outlinemask)() | Initialise une nouvelle instance du[`OutlineMask`](../outlinemask) classer. |
