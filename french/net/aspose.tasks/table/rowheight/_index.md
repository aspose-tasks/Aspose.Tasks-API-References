...
description: "Propriété Table. Obtient ou définit la hauteur de ligne dans une table où la hauteur de ligne correspond au nombre de lignes de texte"
type: docs
weight: 60
...
Obtient ou définit la hauteur des lignes dans un tableau, où la hauteur des lignes correspond au nombre de lignes de texte.
