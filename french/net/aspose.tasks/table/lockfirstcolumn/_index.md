...
description: "Propriété Table. Obtient ou définit une valeur indiquant si la première colonne d'une table est verrouillée ou modifiable"
type: docs
weight: 40
...
Obtient ou définit une valeur indiquant si la première colonne d'un tableau est verrouillée ou modifiable.
