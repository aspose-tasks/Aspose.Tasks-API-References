...
description: "Propriété Table. Obtient ou définit une valeur indiquant si le projet affiche le nom de la table dans la liste déroulante Tables de l'onglet Affichage du ruban"
type: docs
weight: 80
...
Obtient ou définit une valeur indiquant si le projet affiche le nom du tableau dans la liste déroulante Tables de l'onglet Affichage du ruban.
