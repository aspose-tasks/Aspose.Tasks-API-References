...
description: "Méthode WBSCodeMaskCollection. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 80
url: /fr/net/aspose.tasks/wbscodemaskcollection/remove/
---
...
| --- | --- | --- |
| élément | WBSCodeMask | l'objet spécifié à supprimer. |
