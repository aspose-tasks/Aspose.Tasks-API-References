...
description: "Méthode WBSCodeMaskCollection. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 30
...
| --- | --- | --- |
| élément | WBSCodeMask | l'élément spécifié à ajouter à cette collection. |
