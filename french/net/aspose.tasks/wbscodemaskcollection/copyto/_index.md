...
description: "Méthode WBSCodeMaskCollection. Copie les éléments de cette collection dans le tableau spécifié en commençant à l'index de tableau spécifié"
type: docs
weight: 60
...
| --- | --- | --- |
| tableau | WBSCodeMask[] | le tableau unidimensionnel spécifié dans lequel copier les éléments |
