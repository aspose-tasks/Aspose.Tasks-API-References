...
description: "Méthode WorkingTimeCollection. Supprime l'instance WorkingTime de cette collection"
type: docs
weight: 80
...
Supprime l'instance [`WorkingTime`](../../workingtime/) de cette collection.
...
| --- | --- | --- |
| élément | WorkingTime | L'élément à supprimer. |

### Valeur de retour

true si l'instance WorkingTime a été supprimée avec succès de cette collection ; sinon, false.
