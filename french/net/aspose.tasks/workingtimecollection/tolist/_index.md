...
description: "Méthode WorkingTimeCollection. Convertit l'objet WorkingTimeCollection en une liste d'objets WorkingTime"
type: docs
weight: 90
...
Convertit l'objet WorkingTimeCollection en une liste d'objets [`WorkingTime`](../../workingtime/).
...
Liste d'objets [`WorkingTime`](../../workingtime/).
