...
description: "Méthode WorkingTimeCollection. Ajoute une nouvelle instance de WorkingTime à cette collection"
type: docs
weight: 30
...
| --- | --- | --- |
| élément | WorkingTime | L'élément à ajouter. |

### Valeur de retour

true si l'objet WorkingTime a été ajouté avec succès ; sinon, false.
