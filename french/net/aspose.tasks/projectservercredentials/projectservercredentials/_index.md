...
description: Initialise une nouvelle instance duProjectServerCredentialsaspose.tasks/projectservercredentials classe utilisant lURL du site SharePoint et un jeton dautorisation SPOIDCRL valide pour le site PWA Project Web Access de SharePoint.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`ProjectServerCredentials`](../../projectservercredentials) classe utilisant l'URL du site SharePoint et un jeton d'autorisation SPOIDCRL valide pour le site PWA (Project Web Access) de SharePoint.
...
Initialise une nouvelle instance du[`ProjectServerCredentials`](../../projectservercredentials) classe en utilisant l'URL du site SharePoint, le nom d'utilisateur et le mot de passe.
...
Initialise une nouvelle instance du[`ProjectServerCredentials`](../../projectservercredentials) classe à l'aide de l'URL du point de terminaison Project Web Access et des informations d'identification réseau.
