...
description: "Méthode GroupCollection. Convertit une collection de groupes en une liste d'objets Group"
type: docs
weight: 90
...
Convertit une collection de groupes en une liste d'objets [`Group`](../../group/).
...
Liste générique d'objets [`Group`](../../group/).
