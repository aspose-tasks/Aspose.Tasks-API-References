...
description: "Propriété OleObject. Obtient ou définit le nom de l'application avec laquelle ouvrir l'objet incorporé"
type: docs
weight: 20
...
Obtient ou définit le nom de l'application avec laquelle ouvrir l'objet intégré.
