...
description: "Propriété OleObject. Obtient ou définit le format de fichier de l'objet incorporé"
type: docs
weight: 50
...
Obtient ou définit le format de fichier de l'objet intégré.
