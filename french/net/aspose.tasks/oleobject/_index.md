...
description: Représente un objet OLE qui peut être inséré dans la vue Diagramme de Gantt dun fichier MPP.
type: docs
weight: 980
...
| Nom | La description |
| --- | --- |
| [OleObject](oleobject)() | Initialise une nouvelle instance du[`OleObject`](../oleobject) classe. |
