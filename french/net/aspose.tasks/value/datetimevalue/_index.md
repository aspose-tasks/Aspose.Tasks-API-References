...
description: "Propriété Value. Obtient ou définit la valeur réelle si elle peut être représentée comme DateTime. La valeur par défaut est MinValue"
type: docs
weight: 20
...
Obtient ou définit la valeur réelle si elle peut être représentée comme DateTime. La valeur par défaut est MinValue.
...
Préférez cette propriété plutôt que le [`Val`](../val/), lorsque vous devez définir la valeur DateTime.
