...
description: "Propriété Value. Obtient ou définit l'identifiant unique d'une valeur dans un projet"
type: docs
weight: 50
...
Il est important de ne pas avoir les mêmes identifiants pour différentes instances de [`Value`](../).

La valeur minimale de `Id` est `1`.
