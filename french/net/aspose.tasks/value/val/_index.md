...
description: "Propriété Value. Obtient ou définit la valeur réelle dans la représentation interne. Préférez l'utilisation de propriétés fortement typées listées ci-dessous"
type: docs
weight: 90
...
Obtient ou définit la valeur réelle dans la représentation interne. Privilégiez l'utilisation des propriétés fortement typées listées ci-dessous.
...
Si vous souhaitez définir une valeur Texte, préférez utiliser la propriété fortement typée [`StringValue`](../stringvalue/).

Si vous souhaitez définir une valeur Numéro ou Coût, préférez utiliser la propriété fortement typée [`NumericValue`](../numericvalue/).

Si vous souhaitez définir des valeurs Date/Début/Fin, préférez utiliser la propriété fortement typée [`DateTimeValue`](../datetimevalue/).

Si vous souhaitez définir une valeur Durée, préférez utiliser la propriété fortement typée [`Duration`](../duration/).

Si votre type n'est pas répertorié, utilisez la propriété `Val`.
