...
description: "Propriété Value. Obtient ou définit la valeur réelle utilisée pour représenter la chaîne de texte"
type: docs
weight: 80
...
Obtient ou définit la valeur réelle utilisée pour représenter une chaîne de texte.
...
Préférez cette propriété plutôt que le [`Val`](../val/), lorsque vous devez définir la valeur du texte.
