...
description: "Propriété Value. Obtient ou définit la valeur réelle utilisée pour représenter une valeur numérique ou de coût"
type: docs
weight: 60
...
Obtient ou définit la valeur réelle utilisée pour représenter un nombre ou une valeur de coût.
...
Préférez cette propriété plutôt que [`Val`](../val/), lorsque vous devez définir la valeur Numéro ou Coût.
