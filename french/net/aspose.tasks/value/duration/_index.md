...
description: "Propriété Value. Obtient ou définit la valeur réelle utilisée pour représenter la Durée"
type: docs
weight: 40
...
Préférez cette propriété plutôt que [`Val`](../val/), lorsque vous devez définir la valeur Durée.
