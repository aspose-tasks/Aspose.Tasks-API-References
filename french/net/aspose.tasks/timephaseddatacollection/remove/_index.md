...
description: "TimephasedDataCollection méthode. Supprime l'instance TimephasedData de cet objet collection."
type: docs
weight: 100
...
Supprime l'instance [`TimephasedData`](../../timephaseddata/) de cet objet collection.
...
| --- | --- | --- |
| élément | TimephasedData | L'élément à supprimer. |

### Valeur de retour

true si *item* a été supprimé avec succès de la [`TimephasedDataCollection`](../) ; sinon, false. Cette méthode renvoie également false si *item* n'est pas trouvé dans la [`TimephasedDataCollection`](../).
