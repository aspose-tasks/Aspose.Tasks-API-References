...
description: "TimephasedDataCollection méthode. Copie les éléments de la TimephasedDataCollection dans un Array à partir d'un indice d'Array particulier"
type: docs
weight: 80
...
Copie les éléments du [`TimephasedDataCollection`](../) dans un Array, à partir d'un indice d'Array particulier.
...
| --- | --- | --- |
| array | TimephasedData[] | Le tableau unidimensionnel qui est la destination des éléments copiés depuis [`TimephasedDataCollection`](../). Le tableau doit être indexé à partir de zéro. |
| arrayIndex | Int32 | L'indice à base zéro dans *array* où la copie commence. |
...
| ArgumentException | Le nombre d'éléments dans la source [`TimephasedDataCollection`](../) est supérieur à l'espace disponible depuis *arrayIndex* jusqu'à la fin du *array* de destination. |
