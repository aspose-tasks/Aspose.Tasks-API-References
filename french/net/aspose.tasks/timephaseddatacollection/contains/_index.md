...
description: "Méthode TimephasedDataCollection. Détermine si le TimephasedDataCollection contient une valeur spécifique"
type: docs
weight: 70
...
Détermine si la [`TimephasedDataCollection`](../) contient une valeur spécifique.
...
| --- | --- | --- |
| élément | TimephasedData | L'objet à rechercher dans la collection. |
