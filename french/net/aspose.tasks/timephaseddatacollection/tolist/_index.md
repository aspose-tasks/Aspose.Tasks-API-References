...
description: "Méthode TimephasedDataCollection. Convertit l'objet TimephasedDataCollection en une liste d'objets TimePhasedData"
type: docs
weight: 120
...
Convertit l'objet [`TimephasedDataCollection`](../) en une liste d'objets [`TimephasedData`](../../timephaseddata/).
...
Liste d'objets [`TimephasedData`](../../timephaseddata/).
