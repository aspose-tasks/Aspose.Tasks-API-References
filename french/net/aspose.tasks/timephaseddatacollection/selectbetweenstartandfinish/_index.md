...
description: Sélectionne toutes les phases de temps entrestartTime etfinishTime . A une complexité O log n dans le cas moyen.
type: docs
weight: 120
...
Renvoie la nouvelle instance de liste de[`TimephasedDataCollection`](../../timephaseddatacollection) données triées par la propriété Start.
