...
description: "TimephasedDataCollection méthode. Sélectionne toutes les phases temporelles entre startTime et finishTime. Possède une complexité Olog n en moyenne."
type: docs
weight: 110
...
Sélectionne toutes les phases temporelles entre *startTime* et *finishTime*. Possède une complexité O(log n) en moyenne.
...
| --- | --- | --- |
| timephasedDataType | TimephasedDataType | Type de phases temporelles à sélectionner. |
| startTime | DateTime | Début de l'intervalle. |
| finishTime | DateTime | Fin de l'intervalle. |

### Valeur de retour

Renvoie une nouvelle instance de liste des données [`TimephasedDataCollection`](../) ordonnée par la propriété Start.
