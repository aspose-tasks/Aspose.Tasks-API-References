...
description: "Propriété GanttChartView. Obtient une liste des styles de barre communs parents de la vue du diagramme de Gantt. GanttBarStyle"
type: docs
weight: 50
...
Obtient une liste des styles de barre (communs) parents de la vue du diagramme de Gantt. [`GanttBarStyle`](../../../aspose.tasks.visualization/ganttbarstyle/).
