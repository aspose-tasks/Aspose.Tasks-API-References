...
description: "Propriété GanttChartView. Obtient ou définit les lignes de progression pour la vue Gantt Chart. ProgressLines"
type: docs
weight: 120
...
Obtient ou définit les lignes de progression pour la vue Gantt Chart. `ProgressLines`.
