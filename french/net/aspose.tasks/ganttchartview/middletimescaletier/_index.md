...
description: "Propriété GanttChartView. Obtient ou définit les paramètres du niveau intermédiaire de l’échelle de temps de la vue. TimescaleTier"
type: docs
weight: 100
...
Obtient ou définit les paramètres du niveau d'échelle de temps intermédiaire de la vue. [`TimescaleTier`](../../../aspose.tasks.visualization/timescaletier/).
