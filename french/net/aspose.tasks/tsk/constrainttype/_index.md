...
description: "Tsk field. Fournit des choix pour le type de contrainte qui peut être appliqué à la planification d'une tâche"
type: docs
weight: 210
...
Fournit des choix pour le type de contrainte qui peut être appliqué lors de la planification d'une tâche.
