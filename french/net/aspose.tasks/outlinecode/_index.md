...
description: Représente une valeur dun code hiérarchique.
type: docs
weight: 1010
...
| Nom | La description |
| --- | --- |
| [OutlineCode](outlinecode#constructor)() | Initialise une nouvelle instance du[`OutlineCode`](../outlinecode) classer. |
| [OutlineCode](outlinecode#constructor_1)(OutlineCodeDefinition, OutlineValue) | Initialise une nouvelle instance du[`OutlineCode`](../outlinecode) classe à l'aide du code hiérarchique spécifié et de l'une de ses valeurs. |
