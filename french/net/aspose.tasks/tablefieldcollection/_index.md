...
description: Contient une liste deTableField./tablefield objects. Implémente linterface IListltTableFieldgt.
type: docs
weight: 2050
...
| [ParentProject](../../aspose.tasks/tablefieldcollection/parentproject) { get; } | Obtient le parent de l'objet TableFields. Lecture seule[`Project`](../project) . |
