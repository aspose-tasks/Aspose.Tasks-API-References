...
description: "Méthode TableFieldCollection. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 40
...
| --- | --- | --- |
| élément | TableField | l'élément spécifié à ajouter à cette collection. |
