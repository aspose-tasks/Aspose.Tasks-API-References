...
description: "Méthode TableFieldCollection. Insère l'élément spécifié à l'index indiqué"
type: docs
weight: 100
...
| élément | TableField | l'élément spécifié à insérer dans cette collection. |
