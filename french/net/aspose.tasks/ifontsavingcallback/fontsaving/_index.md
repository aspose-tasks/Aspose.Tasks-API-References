...
description: "Méthode IFontSavingCallback. La méthode à appeler lors de l'enregistrement des polices"
type: docs
weight: 10
...
| --- | --- | --- |
| args | FontSavingArgs | Les arguments de sauvegarde de police. |
