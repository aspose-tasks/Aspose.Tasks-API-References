...
description: "Propriété GroupCriterion. Obtient ou définit l'intervalle d'un champ utilisé comme critère dans une définition de groupe"
type: docs
weight: 70
...
Obtient ou définit l'intervalle pour un champ utilisé comme critère dans une définition de groupe.
