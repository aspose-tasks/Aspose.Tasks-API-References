...
description: "Propriété GroupCriterion. Obtient ou définit la police pour un critère dans une définition de groupe"
type: docs
weight: 50
...
Obtient ou définit la police pour un critère dans une définition de groupe.
