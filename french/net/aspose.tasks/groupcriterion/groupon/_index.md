...
description: "Propriété GroupCriterion. Obtient ou définit le type de regroupement pour un champ utilisé comme critère dans une définition de groupe."
type: docs
weight: 80
...
Obtient ou définit le type de regroupement pour un champ utilisé comme critère dans une définition de groupe.
