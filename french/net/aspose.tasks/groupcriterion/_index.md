...
description: Représente un critère dans une définition de groupe. Lobjet GroupCriterion est membre duGroupCriterionCollection./groupcriterioncollection collection.
type: docs
weight: 720
...
| [Index](../../aspose.tasks/groupcriterion/index) { get; } | Obtient l'index d'un[`GroupCriterion`](../groupcriterion) objet dans le contenant[`GroupCriterionCollection`](../groupcriterioncollection) collection. |
| [ParentGroup](../../aspose.tasks/groupcriterion/parentgroup) { get; } | Obtient le parent du[`GroupCriterion`](../groupcriterion) objet. |
