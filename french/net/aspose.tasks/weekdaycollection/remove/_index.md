...
description: "Méthode WeekDayCollection. Supprime le WeekDay spécifié, le cas échéant"
type: docs
weight: 100
url: /fr/net/aspose.tasks/weekdaycollection/remove/
---
## WeekDayCollection.Remove method

Supprime le [`WeekDay`](../../weekday/) spécifié, le cas échéant.
...
| --- | --- | --- |
| élément | WeekDay | L'élément à supprimer. |

### Valeur de retour

Vrai, si le [`WeekDay`](../../weekday/) a été supprimé, faux si cet élément n'a pas été trouvé.
