...
description: Représente une collection deWeekDay./weekday objets.
type: docs
weight: 3170
...
| Nom | La description |
| --- | --- |
| [Count](../../aspose.tasks/weekdaycollection/count) { get; } | Obtient le nombre d'objets contenus dans ce[`WeekDayCollection`](../weekdaycollection) objet. |
