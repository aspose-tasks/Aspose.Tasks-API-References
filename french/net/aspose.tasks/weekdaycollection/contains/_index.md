...
description: "WeekDayCollection méthode. Vérifie si la collection contient le WeekDay spécifié"
type: docs
weight: 50
...
Vérifie si la collection contient le [`WeekDay`](../../weekday/).specified.
...
| --- | --- | --- |
| élément | WeekDay | L'élément à vérifier. |

### Valeur de retour

true, si la collection contient l'élément spécifié, ou false sinon.
