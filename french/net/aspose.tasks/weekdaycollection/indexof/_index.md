...
description: "WeekDayCollection méthode. Retourne l'index du WeekDay spécifié"
type: docs
weight: 80
...
Retourne l'index du [`WeekDay`](../../weekday/) spécifié.
...
Index basé sur zéro du [`WeekDay`](../../weekday/) spécifié, s'il est présent, ou -1 sinon.
