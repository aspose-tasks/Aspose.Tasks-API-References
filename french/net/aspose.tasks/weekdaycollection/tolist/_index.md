...
description: "WeekDayCollection méthode. Convertit l'objet WeekDayCollection en une liste d'objets WeekDay"
type: docs
weight: 120
...
Convertit l'objet WeekDayCollection en une liste d'objets [`WeekDay`](../../weekday/).
...
Liste d'objets [`WeekDay`](../../weekday/).
