...
description: "Project property. Obtient toutes les définitions de groupes basées sur les tâches. TaskGroups est une collection d'objets Group."
type: docs
weight: 920
...
Récupère toutes les définitions de groupes basés sur les tâches. TaskGroups est une collection d'objets [`Group`](../../group/).
...
Montre comment lire les groupes de tâches.
