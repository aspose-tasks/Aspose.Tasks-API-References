...
description: "Propriété du projet. Obtient ou définit si le coût d'affectation et le coût restant doivent être calculés automatiquement en utilisant le travail des affectations et les taux des ressources"
type: docs
weight: 70
url: /fr/net/aspose.tasks/project/autocalculateassignmentcosts/
---
## Project.AutoCalculateAssignmentCosts property

Obtient ou définit si le coût d'affectation et le coût restant doivent être calculés automatiquement en utilisant le travail de l'affectation et les tarifs des ressources.
