...
description: "Méthode Project. Replanifie le travail de projet non terminé pour commencer après une date spécifiée."
type: docs
weight: 1190
...
Replanifie le travail de projet non terminé pour commencer après une date spécifiée.
...
| --- | --- | --- |
| après | DateTime | La date après laquelle replanifier le travail non terminé. |
...
Replanifie le travail non terminé d’une liste de tâches spécifiée pour commencer après une date spécifiée.
...
| --- | --- | --- |
| après | DateTime | La date après laquelle replanifier le travail non terminé. |
| taskCollection | List`1 | List&lt;Task&gt; des tâches à replanifier le travail non terminé pour. |
