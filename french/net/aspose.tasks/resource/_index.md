...
description: "Classe Aspose.Tasks.Resource. Représente une ressource dans un projet"
type: docs
weight: 1740
...
| [AvailabilityPeriods](../../aspose.tasks/resource/availabilityperiods/) { get; } | Obtient l'instance de la classe [`AvailabilityPeriodCollection`](../availabilityperiodcollection/). La collection de périodes pendant lesquelles une ressource est disponible. |
...
| [Baselines](../../aspose.tasks/resource/baselines/) { get; } | Obtient une instance de BaselineCollection pour cet objet. Les valeurs de référence pour une ressource. |
...
| [Cost](../../aspose.tasks/resource/cost/) { get; set; } | Obtient ou définit une valeur de Cost. |
...
| [Created](../../aspose.tasks/resource/created/) { get; set; } | Obtient ou définit une valeur de Created. |
...
| [Hyperlink](../../aspose.tasks/resource/hyperlink/) { get; set; } | Obtient ou définit le titre ou le texte explicatif d'un hyperlien associé à une ressource. |
| [HyperlinkAddress](../../aspose.tasks/resource/hyperlinkaddress/) { get; set; } | Obtient ou définit l'adresse d'un hyperlien associé à une ressource. |
| [HyperlinkSubAddress](../../aspose.tasks/resource/hyperlinksubaddress/) { get; set; } | Obtient ou définit l'emplacement spécifique dans un document d'un hyperlien associé à une ressource. |
...
| virtual [IsRoot](../../aspose.tasks/resource/isroot/) { get; } | Obtient le drapeau indiquant si la ressource est une ressource racine. La ressource racine est une ressource spéciale destinée à prendre en charge les internes des formats de MS Project et n'est pas destinée à être utilisée directement dans le code de l'utilisateur. |
...
| [OutlineCode](../../aspose.tasks/resource/outlinecode/) { get; } | Obtient un objet OutlineCodeCollection. La valeur d'un code de contour. |
| [Overallocated](../../aspose.tasks/resource/overallocated/) { get; set; } | Obtient ou définit une valeur indiquant si Overallocated est défini ou non. |
...
| [PeakUnits](../../aspose.tasks/resource/peakunits/) { get; set; } | Obtient ou définit une valeur de PeakUnits. |
...
| [Rates](../../aspose.tasks/resource/rates/) { get; } | Obtient l'instance de la classe [`RateCollection`](../ratecollection/) pour cet objet. La collection de périodes et de taux associés à chacun. |
...
| [TimephasedData](../../aspose.tasks/resource/timephaseddata/) { get; set; } | Obtient ou définit une instance de la classe [`TimephasedDataCollection`](../timephaseddatacollection/) pour cet objet. |
...
| [Equals](../../aspose.tasks/resource/equals/#equals)(Resource) | Renvoie une valeur indiquant si cette instance est égale à une instance spécifiée de la classe `Resource`. |
| [Get&lt;T&gt;](../../aspose.tasks/resource/get/)(Key&lt;T, RscKey&gt;) | Renvoie la valeur à laquelle la propriété est mappée dans ce conteneur. |
| override [GetHashCode](../../aspose.tasks/resource/gethashcode/)() | Renvoie une valeur de code de hachage pour l'instance de la classe `Resource`. |
| [GetTimephasedData](../../aspose.tasks/resource/gettimephaseddata/#gettimephaseddata)(DateTime, DateTime) | Renvoie [`TimephasedDataCollection`](../timephaseddatacollection/) pour cet objet avec les valeurs [`TimephasedData`](./timephaseddata/) comprises entre les dates de début et de fin données. |
| [GetTimephasedData](../../aspose.tasks/resource/gettimephaseddata/#gettimephaseddata_1)(DateTime, DateTime, TimephasedDataType) | Renvoie une instance de la classe [`TimephasedDataCollection`](../timephaseddatacollection/) pour cet objet avec les valeurs [`TimephasedData`](./timephaseddata/) comprises entre les dates de début et de fin données du [`TimephasedDataType`](../timephaseddatatype/) spécifié. |
...
| override [ToString](../../aspose.tasks/resource/tostring/)() | Renvoie une représentation courte sous forme de chaîne de l'instance de la classe `Resource`. Les détails exacts de la représentation ne sont pas spécifiés et peuvent changer. |

## Exemples

Montre comment ajouter des ressources de projet.
