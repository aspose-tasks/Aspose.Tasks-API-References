...
description: "OutlineCodeDefinitionCollection méthode. Retourne vrai si l'élément spécifié est trouvé dans cette collection, sinon faux"
type: docs
weight: 60
url: /fr/net/aspose.tasks/outlinecodedefinitioncollection/contains/
---
...
| --- | --- | --- |
| élément | OutlineCodeDefinition | l'élément spécifié à trouver. |
