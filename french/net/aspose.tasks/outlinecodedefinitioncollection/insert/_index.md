...
description: "Méthode OutlineCodeDefinitionCollection. Insère l'élément spécifié à l'index spécifié."
type: docs
weight: 100
...
| élément | OutlineCodeDefinition | l'élément spécifié à insérer dans cette collection. |
