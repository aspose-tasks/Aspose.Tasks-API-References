...
description: "Méthode OutlineCodeDefinitionCollection. Ajoute l'élément spécifié à cette collection."
type: docs
weight: 40
...
| --- | --- | --- |
| élément | OutlineCodeDefinition | l'élément spécifié à ajouter à cette collection. |
