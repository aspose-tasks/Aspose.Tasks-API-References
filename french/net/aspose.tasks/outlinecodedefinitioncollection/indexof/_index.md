...
description: "OutlineCodeDefinitionCollection méthode. Détermine l'index de l'élément spécifié dans cette collection"
type: docs
weight: 90
url: /fr/net/aspose.tasks/outlinecodedefinitioncollection/indexof/
---
...
| --- | --- | --- |
| élément | OutlineCodeDefinition | l'élément spécifié à localiser dans cette collection. |
