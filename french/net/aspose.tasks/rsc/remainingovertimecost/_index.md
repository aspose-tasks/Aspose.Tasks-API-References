...
description: Le reste des dépenses dheures supplémentaires planifiées pour une ressource.
type: docs
weight: 600
...
Le reste des dépenses d'heures supplémentaires planifiées pour une ressource.
