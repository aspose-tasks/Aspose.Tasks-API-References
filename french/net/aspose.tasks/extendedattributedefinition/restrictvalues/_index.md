...
description: "Propriété ExtendedAttributeDefinition. Obtient ou définit une valeur indiquant si les valeurs du champ personnalisé sont limitées aux valeurs de la ValueList"
type: docs
weight: 220
...
Obtient ou définit une valeur indiquant si les valeurs du champ personnalisé sont limitées aux valeurs de la [`ValueList`](../valuelist/).
