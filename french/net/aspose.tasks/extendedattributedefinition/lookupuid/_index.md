...
description: "Propriété ExtendedAttributeDefinition. Obtient un GUID de la table de recherche associée à un champ personnalisé"
type: docs
weight: 180
...
Obtient le GUID de la table de recherche associée à un champ personnalisé.
...
Afin de créer un champ personnalisé avec recherche, utilisez l'une des méthodes d'usine : [`CreateLookupTaskDefinition`](../createlookuptaskdefinition/) ou [`CreateLookupResourceDefinition`](../createlookupresourcedefinition/).
