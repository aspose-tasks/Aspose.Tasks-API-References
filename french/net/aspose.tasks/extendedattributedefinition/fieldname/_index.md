...
description: "Propriété ExtendedAttributeDefinition. Obtient le nom d'un champ personnalisé"
type: docs
weight: 140
...
Ne doit pas être défini directement, créez plutôt ExtendedAttributeDefinition en utilisant des méthodes d'usine statiques fortement typées nommées comme Create*Definition().
