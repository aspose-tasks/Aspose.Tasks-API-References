...
description: Obtient ou définit une valeur indiquant si le texte de la colonne peut sétendre sur plusieurs lignes ou sil doit être tronqué lorsquil dépasse la largeur de la colonne. Pris en charge par la version MSP 2010 et ultérieure.
type: docs
weight: 80
