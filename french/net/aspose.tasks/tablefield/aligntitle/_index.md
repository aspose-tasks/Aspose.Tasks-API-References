...
description: "Propriété TableField. Obtient ou définit l'alignement du titre dans un champ de tableau"
type: docs
weight: 30
...
Obtient ou définit l'alignement du titre dans un champ de tableau.
