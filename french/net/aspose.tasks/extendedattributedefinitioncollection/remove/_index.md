...
description: "ExtendedAttributeDefinitionCollection méthode. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 130
...
| --- | --- | --- |
| élément | ExtendedAttributeDefinition | l'objet spécifié à supprimer. |
