...
description: "Méthode ExtendedAttributeDefinitionCollection. Convertit cet objet ExtendedAttributeDefinitionCollection en une liste contenant des instances de la classe ExtendedAttributeDefinition"
type: docs
weight: 150
...
Convertit cet objet ExtendedAttributeDefinitionCollection en une liste contenant des instances de la classe [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
...
Liste contenant des instances de la classe [`ExtendedAttributeDefinition`](../../extendedattributedefinition/).
