...
description: "Méthode ExtendedAttributeDefinitionCollection. Insère l'élément spécifié à l'index indiqué"
type: docs
weight: 120
...
| élément | ExtendedAttributeDefinition | l'élément spécifié à insérer dans cette collection. |
