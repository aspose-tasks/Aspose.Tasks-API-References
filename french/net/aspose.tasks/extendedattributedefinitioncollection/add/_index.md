...
description: "ExtendedAttributeDefinitionCollection méthode. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 50
...
| --- | --- | --- |
| élément | ExtendedAttributeDefinition | l'élément spécifié à ajouter à cette collection. |
