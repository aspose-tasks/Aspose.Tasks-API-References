...
description: "Méthode ExtendedAttributeDefinitionCollection. Renvoie true si l'élément spécifié est trouvé dans cette collection, sinon false"
type: docs
weight: 70
...
| --- | --- | --- |
| élément | ExtendedAttributeDefinition | l'élément spécifié à trouver. |
