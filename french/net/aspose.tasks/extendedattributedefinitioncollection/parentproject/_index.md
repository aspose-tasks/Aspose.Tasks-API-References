...
description: "ExtendedAttributeDefinitionCollection propriété. Obtient un projet parent pour l'instance ExtendedAttributeDefinitionCollection. retourne un projet parent pour cette collection"
type: docs
weight: 40
...
Obtient un projet parent pour l'instance [`ExtendedAttributeDefinitionCollection`](../). retourne un projet parent pour cette collection.
