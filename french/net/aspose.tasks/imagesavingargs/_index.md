...
description: Cette classe représente un ensemble de données liées à lenregistrement dun fichier image externe qui se produit lors de la conversion au format HTML.
type: docs
weight: 810
...
| Nom | La description |
| --- | --- |
| [ImageSavingArgs](imagesavingargs)() | Initialise une nouvelle instance du[`ImageSavingArgs`](../imagesavingargs) classe. |
