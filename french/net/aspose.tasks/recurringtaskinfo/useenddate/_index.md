...
description: "Propriété RecurringTaskInfo. Obtient ou définit une valeur indiquant s'il faut utiliser la date de fin ou un nombre d'occurrences pour la tâche récurrente"
type: docs
weight: 150
