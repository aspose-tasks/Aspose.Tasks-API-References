...
description: "Propriété RecurringTaskInfo. Obtient ou définit un jour de la semaine du modèle de récurrence annuel lors de l'utilisation du jour ordinal. Peut être l'une des valeurs de l'énumération DayOfWeek"
type: docs
weight: 190
url: /fr/net/aspose.tasks/recurringtaskinfo/yearlyordinalday/
---
## RecurringTaskInfo.YearlyOrdinalDay property

Obtient ou définit un jour de la semaine du modèle de récurrence annuel lorsqu'on utilise le jour ordinal. Peut être l'une des valeurs de l'énumération DayOfWeek.
