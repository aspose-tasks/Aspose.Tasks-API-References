...
description: "Propriété RecurringTaskInfo. Obtient ou définit un nombre ordinal du modèle de récurrence annuel. Peut être l'une des valeurs de l'énumération OrdinalNumber"
type: docs
weight: 210
...
Obtient ou définit un nombre ordinal du modèle de récurrence annuel. Peut être l'une des valeurs de l'énumération [`OrdinalNumber`](../../ordinalnumber/)
