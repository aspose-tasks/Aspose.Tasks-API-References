...
description: "Propriété RecurringTaskInfo. Obtient ou définit un nombre de répétitions pour le modèle de récurrence mensuel lorsqu'on utilise le jour ordinal"
type: docs
weight: 80
...
Obtient ou définit un nombre de répétitions pour le modèle de récurrence mensuel lorsqu'on utilise le jour ordinal.
