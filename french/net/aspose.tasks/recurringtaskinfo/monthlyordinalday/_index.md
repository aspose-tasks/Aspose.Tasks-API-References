...
description: "Propriété RecurringTaskInfo. Obtient ou définit un jour du modèle de récurrence mensuel lorsqu'on utilise le jour ordinal. Peut être l'une des valeurs de l'énumération DayOfWeek"
type: docs
weight: 60
url: /fr/net/aspose.tasks/recurringtaskinfo/monthlyordinalday/
---
## RecurringTaskInfo.MonthlyOrdinalDay property

Obtient ou définit un jour du modèle de récurrence mensuel lorsqu'on utilise le jour ordinal. Peut être l'une des valeurs de l'énumération DayOfWeek.
