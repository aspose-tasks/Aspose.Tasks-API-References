...
description: "Propriété RecurringTaskInfo. Obtient ou définit un modèle de récurrence de la tâche récurrente. Peut être l'une des valeurs de l'énumération RecurrencePattern"
type: docs
weight: 120
...
Obtient ou définit un modèle de récurrence de la tâche récurrente. Peut être l'une des valeurs de l'énumération `RecurrencePattern`.
