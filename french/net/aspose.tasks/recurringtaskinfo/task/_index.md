...
description: "Propriété RecurringTaskInfo. Obtient la tâche parente de cette instance de la classe RecurringTaskInfo"
type: docs
weight: 140
...
Obtient la tâche parente de cette instance de la classe [`RecurringTaskInfo`](../).
