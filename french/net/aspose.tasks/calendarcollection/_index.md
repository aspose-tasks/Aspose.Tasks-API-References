...
description: Représente une collection deCalendar./calendar objets.
type: docs
weight: 230
...
| Nom | La description |
| --- | --- |
| [Count](../../aspose.tasks/calendarcollection/count) { get; } | Obtient le nombre d'objets contenus dans ce[`CalendarCollection`](../calendarcollection) objet. |
| [ParentProject](../../aspose.tasks/calendarcollection/parentproject) { get; } | Obtient un parent[`Project`](../project)de cet objet. |
