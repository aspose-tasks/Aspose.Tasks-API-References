...
description: "Méthode AssignmentBaseline. Implémentation de l'interface IComparable. Compare cette instance à l'objet Baseline spécifié."
type: docs
weight: 50
...
| --- | --- | --- |
| autre | AssignmentBaseline | l'objet Baseline spécifié avec lequel comparer cette instance. |
