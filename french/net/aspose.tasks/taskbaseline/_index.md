...
description: Représente la ligne de base dune tâche.
type: docs
weight: 2070
...
| Nom | La description |
| --- | --- |
| [TaskBaseline](taskbaseline)(Task) | Initialise une nouvelle instance du[`TaskBaseline`](../taskbaseline) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [BaselineNumber](../../aspose.tasks/baseline/baselinenumber) { get; set; } | Obtient ou définit le numéro unique d'un enregistrement de données de référence. |
...
| override [GetHashCode](../../aspose.tasks/taskbaseline/gethashcode)() | Renvoie une valeur de code de hachage pour l'instance du[`TaskBaseline`](../taskbaseline) classe. |
