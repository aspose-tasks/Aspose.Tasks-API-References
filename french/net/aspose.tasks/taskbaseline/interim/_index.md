...
description: "Propriété TaskBaseline. Obtient ou définit une valeur indiquant s'il s'agit d'une ligne de base intérimaire"
type: docs
weight: 60
...
Obtient ou définit une valeur indiquant s’il s’agit d’une ligne de base intermédiaire.
