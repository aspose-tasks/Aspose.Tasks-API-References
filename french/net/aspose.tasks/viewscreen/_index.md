...
description: "enum Aspose.Tasks.ViewScreen. Spécifie le type d'écran pour une vue"
type: docs
weight: 2910
...
| --- | --- | --- |
| Calendar | `13` | Vue Calendrier. |
| Gantt | `1` | Vue Gantt. |
| NetworkDiagram | `2` | Vue Diagramme Réseau. |
| RelationshipDiagram | `3` | Vue Diagramme de Relation. |
| ResourceForm | `6` | Vue Formulaire Ressource. |
| ResourceGraph | `8` | Vue Graphique Ressource. |
| ResourceNameForm | `12` | Vue Formulaire Nom de Ressource. |
| ResourceSheet | `7` | Vue Feuille Ressource. |
| ResourceUsage | `15` | Vue Utilisation Ressource. |
| TaskDetailsForm | `10` | Vue Formulaire Détails de Tâche. |
| TaskForm | `4` | Vue Formulaire Tâche. |
| TaskNameForm | `11` | Vue Formulaire Nom de Tâche. |
| TaskSheet | `5` | Vue Feuille Tâche. |
| TaskUsage | `14` | Vue Utilisation Tâche. |
