...
description: "Propriété OutlineValue. Obtient ou définit l'Id unique d'une valeur de code de contour dans un projet"
type: docs
weight: 90
...
Obtient ou définit l'Id unique d'une valeur de code de contour dans un projet.
