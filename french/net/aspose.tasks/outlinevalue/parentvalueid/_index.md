...
description: "Propriété OutlineValue. Obtient ou définit l'Id d'un nœud parent d'un code de contour"
type: docs
weight: 50
...
Obtient ou définit l'Id d'un nœud parent d'un code de contour.
