...
description: "Propriété OutlineValue. Obtient ou définit la durée si le Type est Duration"
type: docs
weight: 30
...
Obtient ou définit la durée si le type est Duration.
...
Préférez cette propriété plutôt que le [`Value`](../value/), lorsque vous devez définir la valeur pour OutlineValues avec le type Duration.
