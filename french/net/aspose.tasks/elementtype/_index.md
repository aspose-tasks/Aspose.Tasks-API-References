---
title: "Énumération ElementType"
second_title: "Référence de l'API Aspose.Tasks for .NET"
description: "Énumération Aspose.Tasks.ElementType. Spécifie le type d'un élément"
type: docs
weight: 490
...
| --- | --- | --- |
| Null | `0` | Indique le type d'élément Null. |
| Task | `1` | Indique le type d'élément Tâche. |
| Resource | `2` | Indique le type d'élément Ressource. |
| Calendar | `3` | Indique le type d'élément Calendrier. |
| Assignment | `4` | Indique le type d'élément Affectation. |
