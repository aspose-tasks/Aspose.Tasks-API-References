...
description: "Propriété ExtendedAttribute. Obtient ou définit une valeur pour les attributs de type Texte"
type: docs
weight: 80
...
Obtient ou définit une valeur pour les attributs de type 'Text'.
...
| exception | condition |
| --- | --- |
| InvalidOperationException | Lancée si la propriété [`AttributeDefinition`](../attributedefinition/) n'est pas initialisée ou si l'attribut actuel n'est pas un attribut texte. |
