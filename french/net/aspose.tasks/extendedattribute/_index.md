...
| [ValueReadOnly](../../aspose.tasks/extendedattribute/valuereadonly) { get; } | Obtient une valeur indiquant si une valeur de ce[`ExtendedAttribute`](../extendedattribute) l'instance est en lecture seule.  renvoie true si une formule ou un cumul est défini dans le[`ExtendedAttributeDefinition`](../extendedattributedefinition) pour cet objet. |
