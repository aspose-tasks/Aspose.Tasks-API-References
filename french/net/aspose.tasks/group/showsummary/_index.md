...
description: "Propriété Group. Obtient ou définit une valeur indiquant si les lignes de résumé sont affichées pour le groupe"
type: docs
weight: 70
...
Obtient ou définit une valeur indiquant si les lignes de résumé sont affichées pour le groupe.
