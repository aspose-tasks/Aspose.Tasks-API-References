...
description: "CalendarException propriété. Obtient ou définit une valeur indiquant si la date ou le type de jour spécifié est ouvrable."
type: docs
weight: 30
...
Obtient ou définit une valeur indiquant si la date ou le type de jour spécifié est travaillé.
