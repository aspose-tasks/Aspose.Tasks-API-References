...
description: "Méthode WeekDay. Convertit le DayOfWeek de .Nets en DayType"
type: docs
weight: 120
...
Convertit le DayOfWeek de .Net en [`DayType`](../daytype/).
...
| --- | --- | --- |
| dw | DayOfWeek | Le jour de la semaine à convertir. |

### Valeur de retour

Un type de jour converti.
