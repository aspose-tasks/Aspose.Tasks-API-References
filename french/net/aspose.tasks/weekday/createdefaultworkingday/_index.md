...
description: "Méthode WeekDay. Crée un jour de travail par défaut"
type: docs
weight: 20
...
| --- | --- | --- |
| dayType | DayType | Le type de jour à partir duquel créer le jour de travail par défaut. |

### Valeur de retour

Un jour de travail par défaut avec des heures de travail de 8-12 et 13-17.
