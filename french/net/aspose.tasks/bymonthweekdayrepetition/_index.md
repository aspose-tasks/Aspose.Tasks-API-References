...
description: Représente un modèle basé sur la position du jour de la semaine dans un mois.
type: docs
weight: 170
...
| Nom | La description |
| --- | --- |
| [ByMonthWeekDayRepetition](bymonthweekdayrepetition)() | Initialise une nouvelle instance du[`ByMonthWeekDayRepetition`](../bymonthweekdayrepetition) classer. |
