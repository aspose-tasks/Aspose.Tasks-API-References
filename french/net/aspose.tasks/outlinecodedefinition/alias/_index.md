...
description: "OutlineCodeDefinition propriété. Obtient ou définit l'alias d'un code de contour personnalisé"
type: docs
weight: 20
...
Obtient ou définit l'alias d'un code de plan personnalisé.
