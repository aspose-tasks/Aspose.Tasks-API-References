...
description: "OutlineCodeDefinition propriété. Obtient ou définit le numéro de champ d'un code de plan"
type: docs
weight: 60
...
Obtient ou définit le numéro de champ d'un code de plan.
