...
description: "OutlineCodeDefinition propriété. Obtient ou définit une référence à un autre champ personnalisé pour lequel cette définition de code de plan est un alias"
type: docs
weight: 50
...
Obtient ou définit une référence à un autre champ personnalisé pour lequel cette définition de code de plan est un alias.
