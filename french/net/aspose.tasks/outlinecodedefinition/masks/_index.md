...
description: "OutlineCodeDefinition propriété. Obtient l'objet OutlineMaskCollection. Le tableau des entrées qui définissent le masque du code de contour. Instance OutlineMaskCollection en lecture seule"
type: docs
weight: 100
...
Obtient l'objet OutlineMaskCollection. Le tableau des entrées qui définissent le masque du code de contour. Instance en lecture seule [`OutlineMaskCollection`](../../outlinemaskcollection/).
