...
description: "Méthode AvailabilityPeriodCollection. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 120
...
| --- | --- | --- |
| élément | AvailabilityPeriod | l'objet spécifié à supprimer. |
