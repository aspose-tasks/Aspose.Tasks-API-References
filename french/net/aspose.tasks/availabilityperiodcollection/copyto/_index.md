...
description: "Méthode AvailabilityPeriodCollection. Copie les éléments de cette collection dans le tableau spécifié en commençant à l'index de tableau spécifié"
type: docs
weight: 80
...
| --- | --- | --- |
| tableau | AvailabilityPeriod[] | le tableau unidimensionnel spécifié dans lequel copier les éléments |
