...
description: "Propriété Rate. Obtient ou définit les unités utilisées par Microsoft Project pour afficher le tarif standard"
type: docs
weight: 80
...
Obtient ou définit les unités utilisées par Microsoft Project pour afficher le tarif standard.
