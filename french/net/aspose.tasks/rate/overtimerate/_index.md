...
description: "Propriété Rate. Obtient ou définit le tarif des heures supplémentaires par heure pour une ressource"
type: docs
weight: 20
...
Obtient ou définit le taux d’heures supplémentaires par heure pour une ressource.
