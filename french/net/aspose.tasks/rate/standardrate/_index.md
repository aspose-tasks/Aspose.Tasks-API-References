...
description: "Propriété Rate. Obtient ou définit le tarif standard par heure pour une ressource"
type: docs
weight: 70
...
Obtient ou définit le tarif standard par heure pour une ressource.
