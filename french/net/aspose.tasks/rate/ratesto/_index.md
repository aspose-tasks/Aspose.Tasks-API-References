...
description: "Propriété Rate. Obtient ou définit la dernière date à laquelle un tarif est effectif"
type: docs
weight: 50
...
Obtient ou définit la dernière date à laquelle un tarif est effectif.
