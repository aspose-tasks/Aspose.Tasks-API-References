...
description: "Méthode RateCollection. Convertit l'objet RateCollection en une liste d'objets Rate"
type: docs
weight: 80
...
Convertit l'objet [`RateCollection`](../) en une liste d'objets [`Rate`](../../rate/).
...
Convertit l'objet [`RateCollection`](../) en une liste d'objets [`Rate`](../../rate/) filtrée par le type [`RateType`](../../ratetype/) spécifié.
...
| --- | --- | --- |
| type | RateType | Le type à filtrer. |

### Valeur de retour

une liste d'objets [`Rate`](../../rate/).
