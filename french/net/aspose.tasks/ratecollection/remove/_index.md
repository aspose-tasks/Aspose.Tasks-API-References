...
description: "Méthode RateCollection. Supprime l'instance Rate de cette collection"
type: docs
weight: 70
...
| --- | --- | --- |
| élément | Rate | L'élément à supprimer. |

### Valeur de retour

true si le Rate spécifié a été supprimé avec succès ; sinon, false.
