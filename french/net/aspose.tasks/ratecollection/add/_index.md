...
description: "Méthode RateCollection. Ajoute une nouvelle instance de Rate à cette collection"
type: docs
weight: 50
...
Ajoute une nouvelle instance de [`Rate`](../../rate/) à cette collection.
...
| --- | --- | --- |
| ratesFrom | DateTime | La date à laquelle le nouveau tarif entre en vigueur. |

### Valeur de retour

Instance de [`Rate`](../../rate/) ajoutée.
...
| --- | --- | --- |
| ratesFrom | DateTime | La date à laquelle le nouveau tarif entre en vigueur. |
| type | RateType | Le tableau de tarifs dans lequel ajouter. |
