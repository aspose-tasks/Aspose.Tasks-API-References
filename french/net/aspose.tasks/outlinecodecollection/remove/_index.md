...
description: "OutlineCodeCollection méthode. Supprime la première occurrence d'un objet spécifique de cette collection"
type: docs
weight: 110
...
| --- | --- | --- |
| élément | OutlineCode | l'objet spécifié à supprimer. |
