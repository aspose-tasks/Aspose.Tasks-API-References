...
description: "OutlineCodeCollection méthode. Retourne vrai si l'élément spécifié est trouvé dans cette collection, sinon faux"
type: docs
weight: 60
...
| --- | --- | --- |
| élément | OutlineCode | l'élément spécifié à trouver. |
