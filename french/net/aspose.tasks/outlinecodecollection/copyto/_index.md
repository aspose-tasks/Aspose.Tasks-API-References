...
description: OutlineCodeCollection méthode. Copie les éléments de cette collection dans le tableau spécifié en commençant à lindex de tableau spécifié.
type: docs
weight: 70
...
| --- | --- | --- |
| array | OutlineCode[] | le tableau unidimensionnel spécifié pour y copier des éléments |
