...
description: "Méthode OutlineCodeCollection. Ajoute l'élément spécifié à cette collection"
type: docs
weight: 40
...
| --- | --- | --- |
| élément | OutlineCode | l'élément spécifié à ajouter à cette collection. |
