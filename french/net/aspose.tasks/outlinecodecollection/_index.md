...
description: Représente une collection deOutlineCode./outlinecode objets.
type: docs
weight: 1020
...
Représente une collection de[`OutlineCode`](../outlinecode) objets.
...
| [IsReadOnly](../../aspose.tasks/outlinecodecollection/isreadonly) { get; } | Obtient une valeur indiquant si cette collection est en lecture seule ; sinon, faux. |
...
| [Contains](../../aspose.tasks/outlinecodecollection/contains)(OutlineCode) | Renvoie vrai si l'élément spécifié se trouve dans cette collection ; sinon, faux. |
