...
description: "Interface Aspose.Tasks.ICssSavingCallback. Représente un rappel qui est appelé pour créer une ressource afin de stocker le CSS"
type: docs
weight: 850
...
Représente un rappel qui est appelé pour créer une ressource afin de stocker le CSS.
...
| Nom | Description |
| --- | --- |
| [CssSaving](../../aspose.tasks/icsssavingcallback/csssaving/)(CssSavingArgs) | La méthode à appeler lors de l'enregistrement du CSS. |
