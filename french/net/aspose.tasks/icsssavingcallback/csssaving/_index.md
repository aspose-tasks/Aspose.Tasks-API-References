...
description: "Méthode ICssSavingCallback. La méthode à appeler lors de l'enregistrement du CSS"
type: docs
weight: 10
...
La méthode à appeler lors de l'enregistrement du CSS.
...
| --- | --- | --- |
| args | CssSavingArgs | Les arguments d'enregistrement du CSS. |
