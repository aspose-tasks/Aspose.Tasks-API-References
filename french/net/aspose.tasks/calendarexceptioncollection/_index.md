...
description: Représente une collection deCalendarException./calendarexception objets.
type: docs
weight: 250
...
| Nom | La description |
| --- | --- |
| [Count](../../aspose.tasks/calendarexceptioncollection/count) { get; } | Obtient le nombre d'objets contenus dans ce[`CalendarExceptionCollection`](../calendarexceptioncollection) objet. |
...
| [Clear](../../aspose.tasks/calendarexceptioncollection/clear)() | Supprime tous les éléments de la[`CalendarExceptionCollection`](../calendarexceptioncollection) . |
