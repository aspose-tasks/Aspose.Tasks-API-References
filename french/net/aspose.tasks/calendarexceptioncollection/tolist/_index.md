...
description: "Méthode CalendarExceptionCollection. Convertit l'objet CalendarExceptionCollection en une liste d'objets CalendarException"
type: docs
weight: 90
...
Convertit l'objet CalendarExceptionCollection en une liste d'objets [`CalendarException`](../../calendarexception/).
...
Liste d'objets [`CalendarException`](../../calendarexception/).
