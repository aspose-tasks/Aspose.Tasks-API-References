...
description: Spécifie le type de données échelonnées dans le temps.
type: docs
weight: 2280
...
| AssignmentBaseline3Work | `28` | Travail de base de l'affectation 3. |
...
| AssignmentBaseline9Cost | `65` | Coût de base de l'affectation 9. |
