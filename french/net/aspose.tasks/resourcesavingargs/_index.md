...
description: Cette classe représente un ensemble de données liées à lenregistrement du fichier de ressources externes qui se produit lors de la conversion au format HTML.
type: docs
weight: 1530
