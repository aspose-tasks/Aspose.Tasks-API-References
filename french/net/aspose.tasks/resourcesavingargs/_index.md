...
description: "Classe Aspose.Tasks.ResourceSavingArgs. Cette classe représente un ensemble de données liées à l'enregistrement de fichiers de ressources externes qui se produit lors de la conversion au format HTML."
type: docs
weight: 1790
...
Cette classe représente un ensemble de données liées à l'enregistrement d'un fichier de ressource externe qui se produit lors de la conversion au format HTML.
...
| Nom | Description |
| --- | --- |
| [ResourceSavingArgs](resourcesavingargs/)() | Le constructeur par défaut. |
