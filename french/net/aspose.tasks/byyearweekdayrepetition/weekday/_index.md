...
description: "Propriété ByYearWeekDayRepetition. Obtient ou définit un type de jour de la semaine où la tâche doit être récurrente"
type: docs
weight: 40
...
Obtient ou définit le type de jour de la semaine auquel la tâche doit être récurrente.
