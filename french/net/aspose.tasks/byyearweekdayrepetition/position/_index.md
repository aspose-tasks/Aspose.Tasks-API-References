...
description: "Propriété ByYearWeekDayRepetition. Obtient ou définit une position du jour dans une semaine d'un mois où la tâche doit être récurrente"
type: docs
weight: 30
...
Obtient ou définit la position du jour dans une semaine d'un mois pendant lequel la tâche doit être récurrente.
