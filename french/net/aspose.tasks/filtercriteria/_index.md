...
description: Définit les critères que les tâches ou les ressources doivent remplir pour être affichées dans la vue MSP.
type: docs
weight: 620
...
| Nom | La description |
| --- | --- |
| [CriteriaRows](../../aspose.tasks/filtercriteria/criteriarows) { get; } | Obtient la liste des enfants[`FilterCriteria`](../filtercriteria) lignes. Si le filtre contient plus d'une ligne de critère, l'effet d'un opérateur Et est que les critères des deux lignes doivent être remplis pour que la tâche ou la ressource s'affiche à la suite de ce filtre. L'effet d'un Ou opérateur est que les critères pour l'une ou l'autre ligne doivent être remplis. |
...
| Nom | La description |
| --- | --- |
| override [ToString](../../aspose.tasks/filtercriteria/tostring)() | Renvoie la représentation sous forme de chaîne de l'instance du[`FilterCriteria`](../filtercriteria) classe. |
