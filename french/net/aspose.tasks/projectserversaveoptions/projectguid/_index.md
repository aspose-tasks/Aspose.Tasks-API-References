...
description: "Propriété ProjectServerSaveOptions. Obtient ou définit l'identifiant unique d'un projet. Doit être unique au sein de l'instance Project Server Project Online"
type: docs
weight: 30
...
Obtient ou définit l'identifiant unique d'un projet. Il doit être unique au sein de l'instance Project Server \ Project Online.
