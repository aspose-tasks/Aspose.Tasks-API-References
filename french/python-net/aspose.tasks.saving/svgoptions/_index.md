...
type: docs
weight: 170
url: /fr/python-net/aspose.tasks.saving/svgoptions/
---

## SvgOptions class

Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format SVG.

Le type SvgOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| SvgOptions() | Initialise une nouvelle instance de la classe [SvgOptions](/tasks/python-net/aspose.tasks.saving/svgoptions/) qui peut être utilisée pour enregistrer le projet au format SVG. |
## Propriétés
| Nom | Description |
| :- | :- |
| save_format |  |
...
| use_gradient_brush | Détermine s'il faut utiliser un pinceau dégradé lors du rendu de la mise en page du projet. |
...
| page_saving_callback | Obtient ou définit un rappel d'implémentation défini par l'utilisateur qui est utilisé pour obtenir un flux de sortie pour chaque page rendue. |
