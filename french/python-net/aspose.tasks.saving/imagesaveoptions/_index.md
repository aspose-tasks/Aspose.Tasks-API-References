...
type: docs
weight: 40
url: /fr/python-net/aspose.tasks.saving/imagesaveoptions/
---
...
| Nom | Description |
| :- | :- |
| ImageSaveOptions(save_format) | Initialise une nouvelle instance de la classe [ImageSaveOptions](/tasks/python-net/aspose.tasks.saving/imagesaveoptions/) qui peut être utilisée pour enregistrer des images rendues aux formats TIFF, PNG, BMP ou JPEG. |
## Propriétés
| Nom | Description |
| :- | :- |
| save_format |  |
...
| pages | Obtient ou définit une liste de numéros de pages à enregistrer lors de la sauvegarde de la mise en page du projet dans des fichiers séparés. |
| jpeg_quality | Obtient ou définit la qualité JPEG. La plage de valeurs autorisée est 0..100. |
...
| tiff_compression | Obtient ou définit le type de compression à appliquer lors de l'enregistrement des images générées au format TIFF. |
| pixel_format | Obtient ou définit le format des données de couleur pour chaque pixel de l'image. |
| horizontal_resolution | Obtient ou définit la résolution horizontale en dpi. |
| vertical_resolution | Obtient ou définit la résolution verticale en dpi. |
