...
type: docs
weight: 180
url: /fr/python-net/aspose.tasks.saving/xamloptions/
---

## XamlOptions class

/// Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format XAML.

Le type XamlOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| XamlOptions() | Initialise une nouvelle instance de la classe [XamlOptions](/tasks/python-net/aspose.tasks.saving/xamloptions/) qui peut être utilisée pour enregistrer le projet au format XAML. |
## Propriétés
| Nom | Description |
| :- | :- |
| save_format |  |
