...
type: docs
weight: 120
url: /fr/python-net/aspose.tasks.saving/printoptions/
---
...
Le type PrintOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| PrintOptions() | Initialise une nouvelle instance de la classe [PrintOptions](/tasks/python-net/aspose.tasks.saving/printoptions/) qui peut être utilisée pour définir différentes options d'impression du projet. |
## Propriétés
| Nom | Description |
| :- | :- |
| save_format |  |
