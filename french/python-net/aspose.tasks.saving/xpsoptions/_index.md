...
type: docs
weight: 200
url: /fr/python-net/aspose.tasks.saving/xpsoptions/
---

## XpsOptions class

Permet de spécifier des options supplémentaires lors du rendu des pages du projet au format XPS.

Le type XpsOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| XpsOptions() | Initialise une nouvelle instance de la classe [XpsOptions](/tasks/python-net/aspose.tasks.saving/xpsoptions/). |
## Propriétés
| Nom | Description |
| :- | :- |
| save_format |  |
...
| render_metafile_as_bitmap | Obtient ou définit une valeur indiquant si un métafichier doit être rendu sous forme de bitmap. |
